...
EXAMPLES-$(CONFIG_AV1_DECODER)     += scalable_decoder.c
scalable_decoder.GUID                 = D3BBF1E9-2427-450D-BBFF-B2843C1D44CC
scalable_decoder.SRCS                += ivfdec.h ivfdec.c
scalable_decoder.SRCS                += tools_common.h tools_common.c
scalable_decoder.SRCS                += video_common.h
scalable_decoder.SRCS                += video_reader.h video_reader.c
scalable_decoder.SRCS                += aom_ports/mem_ops.h
scalable_decoder.SRCS                += aom_ports/mem_ops_aligned.h
scalable_decoder.SRCS                += aom_ports/msvc.h
scalable_decoder.DESCRIPTION          = Scalable decoder loop
ifeq ($(CONFIG_OBU_NO_IVF),yes)
  scalable_decoder.SRCS                 += obudec.c obudec.h
endif
...
EXAMPLES-$(CONFIG_AV1_ENCODER)  += scalable_encoder.c
scalable_encoder.SRCS             += ivfenc.h ivfenc.c
scalable_encoder.SRCS             += tools_common.h tools_common.c
scalable_encoder.SRCS             += video_common.h
scalable_encoder.SRCS             += video_writer.h video_writer.c
scalable_encoder.SRCS             += aom_ports/msvc.h
scalable_encoder.GUID              = 4607D299-8A71-4D2C-9B1D-071899B6FBFD
scalable_encoder.DESCRIPTION       = Scalable encoder loop
