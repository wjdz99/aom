...
static const arg_def_t use_cfg =
    ARG_DEF("c", "cfg", 1, "Config file to use");
static const arg_def_t global_motion =
    ARG_DEF(NULL, "global-motion", 1, "corresponds to CONFIG_GLOBAL_MOTION");
static const arg_def_t warped_motion =
    ARG_DEF(NULL, "warped-motion", 1, "corresponds to CONFIG_WARPED_MOTION");
#endif
