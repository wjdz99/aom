...
static const arg_def_t cdf_update_rate =
    ARG_DEF(NULL, "cdf-update-rate", 1,
            "CDF update rate for entropy coding "
            "(0: off; 1: update on every symbol(default); "
            "2: update on every 2 symbols; "
            "3: update on every 4 symbols)");
