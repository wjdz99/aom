 ...
 */
#ifndef AOM_AOM_AOMCX_DEFINES_H_
#define AOM_AOM_AOMCX_DEFINES_H_
...
/*
 * Definitions used by aom codec interface that can be used externally.
 */
...
#endif  // AOM_AOM_AOMCX_DEFINES_H_
