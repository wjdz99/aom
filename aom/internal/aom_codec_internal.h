 ...
 * a pointer to the aom_codec_ctrl_fn_map_t.
 *
 * The special value {0, <non-null>} can be used as a catch-all
...
#define CTRL_MAP_END() \
  { 0, NULL }
// Macro to check if the aom_codec_ctrl_fn_map_t* points to the
// sentinel value, meaning we are at the end of the mapping.
