...
enum aome_enc_control_id {
  ...
  /*!\brief Codec control function to skip the application of in-loop
   * post-processing filters on reconstructed frame, unsigned int parameter
   *
   * - 0 = disable (default)
   * - 1 = enable
   *
   ...
   */
  AV1E_SET_SKIP_INLOOP_POSTPROC_FILTERING = 157,
...
AOM_CTRL_USE_TYPE(AV1E_SET_SKIP_INLOOP_POSTPROC_FILTERING, unsigned int)
#define AOM_CTRL_AV1E_SET_SKIP_INLOOP_POSTPROC_FILTERING
