...
enum aome_enc_control_id {
  ...
  */
  ...
  /*!\brief Codec control function to set CDF update rate.
   *
   *  0: no update                  1: update on every symbol (default)
   *  2: update on every 2 symbols  3: update on every 4 symbols
   */
