...
enum aome_enc_control_id {
  ...
  /*!\brief Codec control function to set number of enhancement layers.
   */
  AOME_SET_NUMBER_ENHANCEMENT_LAYERS,
...
AOM_CTRL_USE_TYPE(AOME_SET_NUMBER_ENHANCEMENT_LAYERS, int)
#define AOME_CTRL_AOME_SET_NUMBER_ENHANCEMENT_LAYERS
