...
enum aome_enc_control_id {
  ...
  /*!\brief Control to use default tx type only for inter modes */
...
AOM_CTRL_USE_TYPE(AV1E_SET_INTER_DEFAULT_TX_ONLY, unsigned int)
#define AOM_CTRL_AV1E_SET_INTER_DEFAULT_TX_ONLY
