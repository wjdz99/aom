...
enum aome_enc_control_id {
  ...
  /*!\brief Codec control function to set number of tempporal layers.
   */
...
typedef struct aom_svc_params {
  ...
  int layer_target_bitrate[AOM_MAX_LAYERS];  /**< Target bitrate for each layer
                                              */
  int framerate_factor[AOM_MAX_TS_LAYERS];   /**< Frame rate factor for each
                                                temporal layer */
} aom_svc_params_t;
