...
enum aome_enc_control_id {
   ...
   * qp sweep unit test in AV1 to ensure that end-to-end test runs well,
   * unsigned int parameter.
   *
   * - 0 = disable (default)
   * - 1 = enable
   ...
   */
  AV1E_ENABLE_SB_QP_SWEEP_UNIT_TEST = 158,
...
AOM_CTRL_USE_TYPE(AV1E_ENABLE_SB_QP_SWEEP_UNIT_TEST, unsigned int)
#define AOM_CTRL_AV1E_ENABLE_SB_QP_SWEEP_UNIT_TEST
