...
enum aome_enc_control_id {
  ...
  /*!\brief Codec control function to encode with dist_8x8, unsigned int
   * parameter
   *
   ...
   * Please note that this is only used in lightfield example test. unsigned int
   * parameter
   *
