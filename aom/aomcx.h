...
enum aome_enc_control_id {
   ...
   *  - AB: OP index.
   *  - xy: Target level index for the OP. Can be values 0~19 (corresponding to
   *    level 2.0 ~ 6.3, note levels 2.2, 2.3, 3.2, 3.3, 4.2 & 4.3 are
   *    undefined) or 24 (keep level stats only for level monitoring) or
