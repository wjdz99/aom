...
enum aome_enc_control_id {
  ...
  /*!\brief Codec control function to apply in-loop post-processing filters on
   * reconstructed frame, unsigned int parameter
   *
   * - 1 = enable (default)
   * - 0 = disable
   *
   ...
   */
  AV1E_SET_APPLY_INLOOP_POSTPROC_FILTERS = 157,
...
AOM_CTRL_USE_TYPE(AV1E_SET_APPLY_INLOOP_POSTPROC_FILTERS, unsigned int)
#define AOM_CTRL_AV1E_SET_APPLY_INLOOP_POSTPROC_FILTERS
