...
/*!brief Parameter type for SVC */
typedef struct aom_svc_ref_map_idx {
  int ref_map_idx[8]; /**< Reference buffer slot */
} aom_svc_ref_map_idx_t;
...
AOM_CTRL_USE_TYPE(AOME_SET_SVC_LAYER_ID, aom_svc_layer_id_t *)
#define AOME_CTRL_AOME_SET_SVC_LAYER_ID

AOM_CTRL_USE_TYPE(AOME_SET_SVC_PARAMS, aom_svc_params_t *)
#define AOME_CTRL_AOME_SET_SVC_PARAMS

AOM_CTRL_USE_TYPE(AOME_SET_SVC_REF_MAP_IDX, aom_svc_ref_map_idx_t *)
#define AOME_CTRL_AOME_SET_SVC_REF_MAP_IDX
