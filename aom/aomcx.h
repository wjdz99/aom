...
enum aome_enc_control_id {
   ...
   *
   * AV1 supports a delta q mode added on top of segment based quantization
   * feature, that allows modulating q per superblock. This control makes
   * encoder operate in one of the several DELTA_Q_modes supported:
   * 0: Not Supported
   * 1: Use modulation based on prediction efficiency tracking
   * 2: Use modulation based on perceptual spatial complexity
   *
