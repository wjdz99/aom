 ...
 */
typedef struct AomRefFrame {
  AomRefFrameTypeT frame_type; /**< which reference frame */
  AomImageT img;               /**< reference frame data in image format */
} AomRefFrameT;
 ...
 */
typedef struct Av1RefFrame {
  int idx;       /**< frame index to get (input) */
  AomImageT img; /**< img structure to populate (output) */
} Av1RefFrameT;
 ...
 */
AOM_CTRL_USE_TYPE(AOM_SET_REFERENCE, AomRefFrameT *)
#define AOM_CTRL_AOM_SET_REFERENCE
AOM_CTRL_USE_TYPE(AOM_COPY_REFERENCE, AomRefFrameT *)
#define AOM_CTRL_AOM_COPY_REFERENCE
AOM_CTRL_USE_TYPE(AOM_SET_POSTPROC, AomPostprocCfgT *)
...
AOM_CTRL_USE_TYPE(AV1_GET_REFERENCE, Av1RefFrameT *)
#define AOM_CTRL_AV1_GET_REFERENCE
AOM_CTRL_USE_TYPE(AV1_GET_NEW_FRAME_IMAGE, AomImageT *)
