...
} UENUM1BYTE(aom_transfer_characteristics_t); /**< alias for enum
...
} SENUM1BYTE(aom_matrix_coefficients_t); /**<enum type CICP Matrix Coefficients
                                          */
...
} UENUM1BYTE(aom_chroma_sample_position_t); /**< alias for enum
                                              aom_transfer_function */
