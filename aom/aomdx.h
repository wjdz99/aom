...
/*! Indicates the maximum number of tile columns supported. */
#define MAX_TILE_COLS 64
/*! Indicates the maximum number of tile rows supported. */
...
typedef struct aom_tile_info {
  ...
  int tile_rows;
  /*! Indicates the number of tile columns (for non uniform spacing) */
  int cols;
  /*! Indicates the number of tile rows (for non uniform spacing) */
  int rows;
