...
typedef struct cfg_options {
   ...
   *
   */
  unsigned int DisableABPartitionType;
   ...
   *
   */
  unsigned int DisableRefFrameMV;
  /*!\brief use reduced reference frame set
   *
   */
  unsigned int ReducedReferenceSet;
  /*!\brief use reduced transform type set
   *
   */
  unsigned int ReducedTxTypeSet;
} cfg_options_t;
