...
typedef struct cfg_options {
  ...
  unsigned int Disable1to4PartitionType;    // disable 1:4/4:1 partition type
  unsigned int DisableExtTx;                // disable extended trasnform type
  ...
  unsigned int DisableDistWtdComp;          // disable dist weighted compound
  unsigned int DisableDiffWtdComp;          // disable diff weighted compound
  unsigned int DisableInterIntraComp;       // disable inter/intra compound
  unsigned int DisableMaskedComp;           // disable masked compound
  unsigned int DisableOneSidedComp;         // disable one sided compound
  unsigned int DisablePalette;              // disable Palette
  unsigned int DisableIBC;                  // disable Intra Block Copy
  unsigned int DisableCFL;                  // disable chroma from luma
  unsigned int DisableSmoothIntra;          // disable intra smooth mode
  unsigned int DisableFilterIntra;          // disable filter intra
  unsigned int DisableDualFilter;           // disable dual filter
  unsigned int DisableIntraAngleDelta;      // disable intra angle delta
  unsigned int TxSizeSearchMethod;          // 0:FULLRD,1:FASTRD,2:USELARGEST
