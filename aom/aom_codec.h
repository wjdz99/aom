 ...
 *     returns the capabilities of the codec (see aom_encoder.h for more
 *     details)
 *   - aom_codec_enc_config_default(aom_codec_iface_t *iface,
 * aom_codec_enc_cfg_t *cfg, unsigned int usage): generate the default config to
