 ...
 * some data which will be passed back in the release function call. |fb| is
 * guaranteed to not be NULL. On success the callback must return 0. Any
 * failure the callback must return a value less than 0.
 *
