...
function(setup_aom_dsp_targets)
  ...
  if(HAVE_SSE2)
    target_sources(aom PRIVATE ${AOM_DSP_COMMON_ASM_SSE2})
    add_intrinsics_object_library("-msse2" "sse2" "aom_dsp_common"
                                  "AOM_DSP_COMMON_INTRIN_SSE2" "aom")

    if(CONFIG_AV1_ENCODER)
      target_sources(aom PRIVATE ${AOM_DSP_ENCODER_ASM_SSE2})
  ...
  if(HAVE_SSSE3)
    target_sources(aom PRIVATE ${AOM_DSP_COMMON_ASM_SSSE3})
    ...
    if(CONFIG_AV1_ENCODER)
      ...
      target_sources(aom PRIVATE ${AOM_DSP_ENCODER_ASM_SSSE3})
  ...
  if(HAVE_AVX AND "${AOM_TARGET_CPU}" STREQUAL "x86_64")
    if(CONFIG_AV1_ENCODER)
      target_sources(aom PRIVATE ${AOM_DSP_ENCODER_AVX_ASM_X86_64})
    endif()
  endif()
