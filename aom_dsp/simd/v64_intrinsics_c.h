...
SIMD_INLINE uint32_t c_v64_low_u32(CV64 a) { return a.u32[CONFIG_BIG_ENDIAN]; }

SIMD_INLINE uint32_t c_v64_high_u32(CV64 a) {
  return a.u32[!CONFIG_BIG_ENDIAN];
}

SIMD_INLINE int32_t c_v64_low_s32(CV64 a) { return a.s32[CONFIG_BIG_ENDIAN]; }

SIMD_INLINE int32_t c_v64_high_s32(CV64 a) { return a.s32[!CONFIG_BIG_ENDIAN]; }

SIMD_INLINE CV64 c_v64_from_32(uint32_t x, uint32_t y) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_from_64(uint64_t x) {
  CV64 t;
  t.u64 = x;
  return t;
}

SIMD_INLINE uint64_t c_v64_u64(CV64 x) { return x.u64; }

SIMD_INLINE CV64 c_v64_from_16(uint16_t a, uint16_t b, uint16_t c, uint16_t d) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_load_unaligned(const void *p) {
  CV64 t;
  uint8_t *pp = (uint8_t *)p;
  uint8_t *q = (uint8_t *)&t;
  int c;
...
SIMD_INLINE CV64 c_v64_load_aligned(const void *p) {
  if (SIMD_CHECK && (uintptr_t)p & 7) {
    fprintf(stderr, "Error: Unaligned CV64 load at %p\n", p);
    abort();
  }
  return c_v64_load_unaligned(p);
}

SIMD_INLINE void c_v64_store_unaligned(void *p, CV64 a) {
  uint8_t *q = (uint8_t *)p;
  uint8_t *r = (uint8_t *)&a;
  int c;
...
SIMD_INLINE void c_v64_store_aligned(void *p, CV64 a) {
  if (SIMD_CHECK && (uintptr_t)p & 7) {
    fprintf(stderr, "Error: Unaligned CV64 store at %p\n", p);
    abort();
  }
  c_v64_store_unaligned(p, a);
}

SIMD_INLINE CV64 c_v64_zero() {
  CV64 t;
  t.u64 = 0;
  return t;
}

SIMD_INLINE CV64 c_v64_dup_8(uint8_t x) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_dup_16(uint16_t x) {
  CV64 t;
  t.u16[0] = t.u16[1] = t.u16[2] = t.u16[3] = x;
  return t;
}

SIMD_INLINE CV64 c_v64_dup_32(uint32_t x) {
  CV64 t;
  t.u32[0] = t.u32[1] = x;
  return t;
}

SIMD_INLINE CV64 c_v64_add_8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_add_16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_sadd_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 4; c++)
...
SIMD_INLINE CV64 c_v64_add_32(CV64 a, CV64 b) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_sub_8(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 8; c++) t.u8[c] = a.u8[c] - b.u8[c];
  return t;
...
SIMD_INLINE CV64 c_v64_ssub_u8(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 8; c++)
...
SIMD_INLINE CV64 c_v64_ssub_s8(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 8; c++) {
...
SIMD_INLINE CV64 c_v64_sub_16(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 4; c++) t.u16[c] = a.u16[c] - b.u16[c];
  return t;
...
SIMD_INLINE CV64 c_v64_ssub_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 4; c++)
...
SIMD_INLINE CV64 c_v64_ssub_u16(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 4; c++)
    t.u16[c] =
...
SIMD_INLINE CV64 c_v64_sub_32(CV64 a, CV64 b) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_abs_s16(CV64 a) {
  CV64 t;
  int c;
  for (c = 0; c < 4; c++)
...
SIMD_INLINE CV64 c_v64_abs_s8(CV64 a) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 _c_v64_zip_8(CV64 a, CV64 b, int mode) {
  CV64 t;
  if (mode) {
    t.u8[7] = a.u8[7];
    t.u8[6] = b.u8[7];
...
SIMD_INLINE CV64 c_v64_ziplo_8(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_zip_8(b, a, 1) : _c_v64_zip_8(a, b, 0);
}

SIMD_INLINE CV64 c_v64_ziphi_8(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_zip_8(b, a, 0) : _c_v64_zip_8(a, b, 1);
}

SIMD_INLINE CV64 _c_v64_zip_16(CV64 a, CV64 b, int mode) {
  CV64 t;
  if (mode) {
    t.u16[3] = a.u16[3];
    t.u16[2] = b.u16[3];
...
SIMD_INLINE CV64 c_v64_ziplo_16(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_zip_16(b, a, 1) : _c_v64_zip_16(a, b, 0);
}

SIMD_INLINE CV64 c_v64_ziphi_16(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_zip_16(b, a, 0) : _c_v64_zip_16(a, b, 1);
}

SIMD_INLINE CV64 _c_v64_zip_32(CV64 a, CV64 b, int mode) {
  CV64 t;
  if (mode) {
    t.u32[1] = a.u32[1];
    t.u32[0] = b.u32[1];
...
SIMD_INLINE CV64 c_v64_ziplo_32(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_zip_32(b, a, 1) : _c_v64_zip_32(a, b, 0);
}

SIMD_INLINE CV64 c_v64_ziphi_32(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_zip_32(b, a, 0) : _c_v64_zip_32(a, b, 1);
}

SIMD_INLINE CV64 _c_v64_unzip_8(CV64 a, CV64 b, int mode) {
  CV64 t;
  if (mode) {
    t.u8[7] = b.u8[7];
    t.u8[6] = b.u8[5];
...
SIMD_INLINE CV64 c_v64_unziplo_8(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_unzip_8(a, b, 1) : _c_v64_unzip_8(a, b, 0);
}

SIMD_INLINE CV64 c_v64_unziphi_8(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_unzip_8(b, a, 0) : _c_v64_unzip_8(b, a, 1);
}

SIMD_INLINE CV64 _c_v64_unzip_16(CV64 a, CV64 b, int mode) {
  CV64 t;
  if (mode) {
    t.u16[3] = b.u16[3];
    t.u16[2] = b.u16[1];
...
SIMD_INLINE CV64 c_v64_unziplo_16(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_unzip_16(a, b, 1)
                           : _c_v64_unzip_16(a, b, 0);
}

SIMD_INLINE CV64 c_v64_unziphi_16(CV64 a, CV64 b) {
  return CONFIG_BIG_ENDIAN ? _c_v64_unzip_16(b, a, 0)
                           : _c_v64_unzip_16(b, a, 1);
}

SIMD_INLINE CV64 c_v64_unpacklo_u8_s16(CV64 a) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_unpackhi_u8_s16(CV64 a) {
  CV64 t;
  int endian = !!CONFIG_BIG_ENDIAN * 4;
...
SIMD_INLINE CV64 c_v64_unpacklo_s8_s16(CV64 a) {
  CV64 t;
  int endian = !!CONFIG_BIG_ENDIAN * 4;
...
SIMD_INLINE CV64 c_v64_unpackhi_s8_s16(CV64 a) {
  CV64 t;
  int endian = !!CONFIG_BIG_ENDIAN * 4;
...
SIMD_INLINE CV64 c_v64_pack_s32_s16(CV64 a, CV64 b) {
  CV64 t;
  if (CONFIG_BIG_ENDIAN) {
    CV64 u = a;
    a = b;
...
SIMD_INLINE CV64 c_v64_pack_s16_u8(CV64 a, CV64 b) {
  CV64 t;
  if (CONFIG_BIG_ENDIAN) {
    CV64 u = a;
    a = b;
...
SIMD_INLINE CV64 c_v64_pack_s16_s8(CV64 a, CV64 b) {
  CV64 t;
  if (CONFIG_BIG_ENDIAN) {
    CV64 u = a;
    a = b;
...
SIMD_INLINE CV64 c_v64_unpacklo_u16_s32(CV64 a) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_unpacklo_s16_s32(CV64 a) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_unpackhi_u16_s32(CV64 a) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_unpackhi_s16_s32(CV64 a) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_shuffle_8(CV64 a, CV64 pattern) {
  CV64 t;
  int c;
  for (c = 0; c < 8; c++) {
...
SIMD_INLINE uint32_t c_v64_sad_u8_sum(CSad64Internal s) { return s; }

typedef uint32_t CSsd64Internal;

/* Implementation dependent return value.  Result must be finalised with
 * v64_ssd_u8_sum(). */
SIMD_INLINE CSsd64Internal c_v64_ssd_u8_init() { return 0; }

SIMD_INLINE CSsd64Internal c_v64_ssd_u8(CSsd64Internal s, CV64 a, CV64 b) {
  int c;
  for (c = 0; c < 8; c++) s += (a.u8[c] - b.u8[c]) * (a.u8[c] - b.u8[c]);
  return s;
}

SIMD_INLINE uint32_t c_v64_ssd_u8_sum(CSsd64Internal s) { return s; }

SIMD_INLINE CV64 c_v64_or(CV64 a, CV64 b) {
  CV64 t;
  t.u64 = a.u64 | b.u64;
  return t;
}

SIMD_INLINE CV64 c_v64_xor(CV64 a, CV64 b) {
  CV64 t;
  t.u64 = a.u64 ^ b.u64;
  return t;
}

SIMD_INLINE CV64 c_v64_and(CV64 a, CV64 b) {
  CV64 t;
  t.u64 = a.u64 & b.u64;
  return t;
}

SIMD_INLINE CV64 c_v64_andn(CV64 a, CV64 b) {
  CV64 t;
  t.u64 = a.u64 & ~b.u64;
  return t;
}

SIMD_INLINE CV64 c_v64_mullo_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_mulhi_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_mullo_s32(CV64 a, CV64 b) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_madd_s16(CV64 a, CV64 b) {
  CV64 t;
...
SIMD_INLINE CV64 c_v64_madd_us8(CV64 a, CV64 b) {
  CV64 t;
  int32_t u;
...
SIMD_INLINE CV64 c_v64_avg_u8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_rdavg_u8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_avg_u16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_min_u8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_max_u8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_min_s8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_max_s8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_min_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_max_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_cmpgt_s8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_cmplt_s8(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 8; c++) t.s8[c] = -(a.s8[c] < b.s8[c]);
  return t;
...
SIMD_INLINE CV64 c_v64_cmpeq_8(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_cmpgt_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_cmplt_s16(CV64 a, CV64 b) {
  CV64 t;
  int c;
  for (c = 0; c < 4; c++) t.s16[c] = -(a.s16[c] < b.s16[c]);
  return t;
...
SIMD_INLINE CV64 c_v64_cmpeq_16(CV64 a, CV64 b) {
  CV64 t;
  int c;
...
SIMD_INLINE CV64 c_v64_shl_8(CV64 a, unsigned int n) {
  CV64 t;
  int c;
  if (SIMD_CHECK && n > 7) {
...
SIMD_INLINE CV64 c_v64_shr_u8(CV64 a, unsigned int n) {
  CV64 t;
  int c;
  if (SIMD_CHECK && n > 7) {
...
SIMD_INLINE CV64 c_v64_shr_s8(CV64 a, unsigned int n) {
  CV64 t;
  int c;
  if (SIMD_CHECK && n > 7) {
...
SIMD_INLINE CV64 c_v64_shl_16(CV64 a, unsigned int n) {
  CV64 t;
  int c;
  if (SIMD_CHECK && n > 15) {
...
SIMD_INLINE CV64 c_v64_shr_u16(CV64 a, unsigned int n) {
  CV64 t;
  int c;
  if (SIMD_CHECK && n > 15) {
...
SIMD_INLINE CV64 c_v64_shr_s16(CV64 a, unsigned int n) {
  CV64 t;
  int c;
  if (SIMD_CHECK && n > 15) {
...
SIMD_INLINE CV64 c_v64_shl_32(CV64 a, unsigned int n) {
  CV64 t;
  if (SIMD_CHECK && n > 31) {
...
SIMD_INLINE CV64 c_v64_shr_u32(CV64 a, unsigned int n) {
  CV64 t;
  if (SIMD_CHECK && n > 31) {
...
SIMD_INLINE CV64 c_v64_shr_s32(CV64 a, unsigned int n) {
  CV64 t;
  if (SIMD_CHECK && n > 31) {
...
SIMD_INLINE CV64 c_v64_shr_n_byte(CV64 x, unsigned int i) {
  CV64 t;
  t.u64 = x.u64 >> i * 8;
  return t;
}

SIMD_INLINE CV64 c_v64_shl_n_byte(CV64 x, unsigned int i) {
  CV64 t;
  t.u64 = x.u64 << i * 8;
  return t;
}

SIMD_INLINE CV64 c_v64_align(CV64 a, CV64 b, unsigned int c) {
  if (SIMD_CHECK && c > 7) {
...
SIMD_INLINE CV64 c_v64_shl_n_8(CV64 a, unsigned int c) {
  return c_v64_shl_8(a, c);
}

SIMD_INLINE CV64 c_v64_shr_n_u8(CV64 a, unsigned int c) {
  return c_v64_shr_u8(a, c);
}

SIMD_INLINE CV64 c_v64_shr_n_s8(CV64 a, unsigned int c) {
  return c_v64_shr_s8(a, c);
}

SIMD_INLINE CV64 c_v64_shl_n_16(CV64 a, unsigned int c) {
  return c_v64_shl_16(a, c);
}

SIMD_INLINE CV64 c_v64_shr_n_u16(CV64 a, unsigned int c) {
  return c_v64_shr_u16(a, c);
}

SIMD_INLINE CV64 c_v64_shr_n_s16(CV64 a, unsigned int c) {
  return c_v64_shr_s16(a, c);
}

SIMD_INLINE CV64 c_v64_shl_n_32(CV64 a, unsigned int c) {
  return c_v64_shl_32(a, c);
}

SIMD_INLINE CV64 c_v64_shr_n_u32(CV64 a, unsigned int c) {
  return c_v64_shr_u32(a, c);
}

SIMD_INLINE CV64 c_v64_shr_n_s32(CV64 a, unsigned int c) {
