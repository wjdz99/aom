...
SIMD_INLINE uint32_t c_v256_low_u32(Cv256 a) { return a.u32[0]; }

SIMD_INLINE CV64 c_v256_low_v64(Cv256 a) { return a.v64[0]; }

SIMD_INLINE Cv128 c_v256_low_v128(Cv256 a) { return a.v128[0]; }

SIMD_INLINE Cv128 c_v256_high_v128(Cv256 a) { return a.v128[1]; }

SIMD_INLINE Cv256 c_v256_from_v128(Cv128 hi, Cv128 lo) {
  Cv256 t;
  t.v128[1] = hi;
  t.v128[0] = lo;
  return t;
...
SIMD_INLINE Cv256 c_v256_from_64(uint64_t a, uint64_t b, uint64_t c,
                                 uint64_t d) {
  Cv256 t;
  t.u64[3] = a;
  t.u64[2] = b;
...
SIMD_INLINE Cv256 c_v256_from_v64(CV64 a, CV64 b, CV64 c, CV64 d) {
  Cv256 t;
  t.u64[3] = a.u64;
  t.u64[2] = b.u64;
  t.u64[1] = c.u64;
...
SIMD_INLINE Cv256 c_v256_load_unaligned(const void *p) {
  Cv256 t;
...
SIMD_INLINE Cv256 c_v256_load_aligned(const void *p) {
...
SIMD_INLINE void c_v256_store_unaligned(void *p, Cv256 a) {
  uint8_t *pp = (uint8_t *)p;
  uint8_t *q = (uint8_t *)&a;
  int c;
...
SIMD_INLINE void c_v256_store_aligned(void *p, Cv256 a) {
  if (SIMD_CHECK && (uintptr_t)p & 31) {
...
SIMD_INLINE Cv256 c_v256_zero() {
  Cv256 t;
  t.u64[3] = t.u64[2] = t.u64[1] = t.u64[0] = 0;
  return t;
}

SIMD_INLINE Cv256 c_v256_dup_8(uint8_t x) {
  Cv256 t;
  t.v64[3] = t.v64[2] = t.v64[1] = t.v64[0] = c_v64_dup_8(x);
  return t;
}

SIMD_INLINE Cv256 c_v256_dup_16(uint16_t x) {
  Cv256 t;
  t.v64[3] = t.v64[2] = t.v64[1] = t.v64[0] = c_v64_dup_16(x);
  return t;
}

SIMD_INLINE Cv256 c_v256_dup_32(uint32_t x) {
  Cv256 t;
  t.v64[3] = t.v64[2] = t.v64[1] = t.v64[0] = c_v64_dup_32(x);
  return t;
}

SIMD_INLINE int64_t c_v256_dotp_s16(Cv256 a, Cv256 b) {
  return c_v128_dotp_s16(a.v128[1], b.v128[1]) +
         c_v128_dotp_s16(a.v128[0], b.v128[0]);
}

SIMD_INLINE uint64_t c_v256_hadd_u8(Cv256 a) {
  return c_v128_hadd_u8(a.v128[1]) + c_v128_hadd_u8(a.v128[0]);
}

typedef uint32_t CSad256Internal;

SIMD_INLINE CSad128Internal c_v256_sad_u8_init() { return 0; }

/* Implementation dependent return value.  Result must be finalised with
   v256_sad_u8_sum().
   The result for more than 16 v256_sad_u8() calls is undefined. */
SIMD_INLINE CSad128Internal c_v256_sad_u8(CSad256Internal s, Cv256 a, Cv256 b) {
  int c;
  for (c = 0; c < 32; c++)
...
SIMD_INLINE Cv256 c_v256_unziplo_8(Cv256 a, Cv256 b) {
  return CONFIG_BIG_ENDIAN ? _c_v256_unzip_8(a, b, 1)
                           : _c_v256_unzip_8(a, b, 0);
}

SIMD_INLINE Cv256 c_v256_unziphi_8(Cv256 a, Cv256 b) {
  return CONFIG_BIG_ENDIAN ? _c_v256_unzip_8(b, a, 0)
                           : _c_v256_unzip_8(b, a, 1);
}

SIMD_INLINE Cv256 _c_v256_unzip_16(Cv256 a, Cv256 b, int mode) {
  Cv256 t;
  int i;
  if (mode) {
    for (i = 0; i < 8; i++) {
...
SIMD_INLINE Cv256 c_v256_unziplo_16(Cv256 a, Cv256 b) {
  return CONFIG_BIG_ENDIAN ? _c_v256_unzip_16(a, b, 1)
                           : _c_v256_unzip_16(a, b, 0);
}

SIMD_INLINE Cv256 c_v256_unziphi_16(Cv256 a, Cv256 b) {
  return CONFIG_BIG_ENDIAN ? _c_v256_unzip_16(b, a, 0)
                           : _c_v256_unzip_16(b, a, 1);
}

SIMD_INLINE Cv256 _c_v256_unzip_32(Cv256 a, Cv256 b, int mode) {
  Cv256 t;
  if (mode) {
    t.u32[7] = b.u32[7];
    t.u32[6] = b.u32[5];
...
SIMD_INLINE Cv256 c_v256_pshuffle_8(Cv256 a, Cv256 pattern) {
...
SIMD_INLINE Cv256 c_v256_shr_n_byte(Cv256 a, unsigned int n) {
  if (n < 16)
...
SIMD_INLINE Cv256 c_v256_align(Cv256 a, Cv256 b, unsigned int c) {
  if (SIMD_CHECK && c > 31) {
...
SIMD_INLINE Cv256 c_v256_shl_8(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shl_8(a.v128[1], c),
                          c_v128_shl_8(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shr_u8(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shr_u8(a.v128[1], c),
                          c_v128_shr_u8(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shr_s8(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shr_s8(a.v128[1], c),
                          c_v128_shr_s8(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shl_16(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shl_16(a.v128[1], c),
                          c_v128_shl_16(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shr_u16(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shr_u16(a.v128[1], c),
                          c_v128_shr_u16(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shr_s16(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shr_s16(a.v128[1], c),
                          c_v128_shr_s16(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shl_32(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shl_32(a.v128[1], c),
                          c_v128_shl_32(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shr_u32(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shr_u32(a.v128[1], c),
                          c_v128_shr_u32(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shr_s32(Cv256 a, unsigned int c) {
  return c_v256_from_v128(c_v128_shr_s32(a.v128[1], c),
                          c_v128_shr_s32(a.v128[0], c));
}

SIMD_INLINE Cv256 c_v256_shl_n_8(Cv256 a, unsigned int n) {
  return c_v256_shl_8(a, n);
}

SIMD_INLINE Cv256 c_v256_shl_n_16(Cv256 a, unsigned int n) {
  return c_v256_shl_16(a, n);
}

SIMD_INLINE Cv256 c_v256_shl_n_32(Cv256 a, unsigned int n) {
  return c_v256_shl_32(a, n);
}

SIMD_INLINE Cv256 c_v256_shr_n_u8(Cv256 a, unsigned int n) {
  return c_v256_shr_u8(a, n);
}

SIMD_INLINE Cv256 c_v256_shr_n_u16(Cv256 a, unsigned int n) {
  return c_v256_shr_u16(a, n);
}

SIMD_INLINE Cv256 c_v256_shr_n_u32(Cv256 a, unsigned int n) {
  return c_v256_shr_u32(a, n);
}

SIMD_INLINE Cv256 c_v256_shr_n_s8(Cv256 a, unsigned int n) {
  return c_v256_shr_s8(a, n);
}

SIMD_INLINE Cv256 c_v256_shr_n_s16(Cv256 a, unsigned int n) {
  return c_v256_shr_s16(a, n);
}

SIMD_INLINE Cv256 c_v256_shr_n_s32(Cv256 a, unsigned int n) {
