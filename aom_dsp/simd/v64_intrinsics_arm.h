...
typedef uint16x8_t Sad64Internal;

SIMD_INLINE Sad64Internal v64_sad_u8_init() { return vdupq_n_u16(0); }
...
typedef int64x1_t Ssd64Internal;

SIMD_INLINE Ssd64Internal v64_ssd_u8_init() {
  return (Ssd64Internal)(uint64_t)0;
}
