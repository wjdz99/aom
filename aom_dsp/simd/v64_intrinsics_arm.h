...
SIMD_INLINE v64 v64_align(v64 a, v64 b, unsigned int c) {
  ...
  return c ? vreinterpret_s64_s8(
           ...
           : b;
#else
  return c ? v64_from_64((vget_lane_u64(b, 0) >> c * 8) |
                         (vget_lane_u64(a, 0) << (8 - c) * 8))
           : b;
#endif
}
...
SIMD_INLINE int64_t v64_dotp_su8(v64 x, v64 y) {
  ...
  return vget_lane_u64(vadd_s64(vget_high_s64(r), vget_low_s64(r)), 0);
#endif
}
...
SIMD_INLINE int64_t v64_dotp_s16(v64 x, v64 y) {
  ...
  return vgetq_lane_s64(r, 0) + vgetq_lane_s64(r, 1);
#endif
}
...
SIMD_INLINE uint32_t v64_sad_u8_sum(sad64_internal s) {
  ...
  return (uint32_t)(vgetq_lane_u64(r, 0) + vgetq_lane_u64(r, 1));
#endif
}
