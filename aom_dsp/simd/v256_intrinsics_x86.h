...
// The _m256i type seems to cause problems for g++'s mangling of
// templates prior to version 5, but adding -fabi-version=0 does the
// trick in those cases, which enables some bugfixes.
