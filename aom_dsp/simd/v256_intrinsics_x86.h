...
SIMD_INLINE int64_t v256_dotp_s16(v256 a, v256 b) {
  ...
  r = _mm256_add_epi32(r, _mm256_srli_si256(r, 8));
  r = _mm256_add_epi32(r, _mm256_srli_si256(r, 4));
  return v128_low_u32(_mm_add_epi32(v256_low_v128(r), v256_high_v128(r)));
}
