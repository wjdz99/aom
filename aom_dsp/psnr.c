...
int64_t aom_highbd_get_u_sse_part(const YV12_BUFFER_CONFIG *a,
                                  ...
                                  int width, int vstart, int height) {
  return highbd_get_sse(
      a->u_buffer + vstart * a->uv_stride + hstart, a->uv_stride,
      b->u_buffer + vstart * b->uv_stride + hstart, b->uv_stride, width,
      height);
}
...
int64_t aom_highbd_get_v_sse_part(const YV12_BUFFER_CONFIG *a,
                                  ...
                                  int width, int vstart, int height) {
  return highbd_get_sse(
      a->v_buffer + vstart * a->uv_stride + hstart, a->uv_stride,
      b->v_buffer + vstart * b->uv_stride + hstart, b->uv_stride, width,
      height);
}
