...
static double calc_psnrhvs(const unsigned char *src, int _systride,
  ...
  DECLARE_ALIGNED(32, int16_t, dct_s[8 * 8]);
  DECLARE_ALIGNED(32, int16_t, dct_d[8 * 8]);
  DECLARE_ALIGNED(32, tran_low_t, dct_s_coef[8 * 8]);
  DECLARE_ALIGNED(32, tran_low_t, dct_d_coef[8 * 8]);
  double mask[8][8];
  int pixels;
  int x;
  int y;
