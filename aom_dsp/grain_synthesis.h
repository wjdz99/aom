...
//#include "defines.h"  //remove later
 ...
 */
void add_film_grain_run(aom_film_grain_t *grain_params, uint8_t *luma, uint8_t *cb,
                    uint8_t *cr, int height, int width, int luma_stride,
                    int chroma_stride);

void add_film_grain(aom_film_grain_t *grain_params, aom_image_t *src, aom_image_t *dst);
