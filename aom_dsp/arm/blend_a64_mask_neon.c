...
static INLINE void blend(int16x4_t mask, int16x4_t src_0, int16x4_t src_1,
                         const int16x4_t v_maxval, int32x4_t *res) {
  int16x4_t max_minus_mask;
  *res = vmull_s16(mask, src_0);
  max_minus_mask = vsub_s16(v_maxval, mask);
  *res = vmlal_s16(*res, max_minus_mask, src_1);
  *res = vshrq_n_s32(*res, AOM_BLEND_A64_ROUND_BITS);
}
...
static INLINE void blend_w8(uint8_t *dst, uint32_t dst_stride,
  ...
  int32x4_t mask_x_src_0_low, mask_x_src_1_low, mask_x_src_2_low,
      mask_x_src_3_low;
  int32x4_t mask_x_src_0_high, mask_x_src_1_high, mask_x_src_2_high,
      mask_x_src_3_high;
  ...
  blend(vget_low_s16(mask0), vget_low_s16(src0_0), vget_low_s16(src1_0),
        v_maxval, &mask_x_src_0_low);
  blend(vget_low_s16(mask1), vget_low_s16(src0_1), vget_low_s16(src1_1),
        v_maxval, &mask_x_src_1_low);
  blend(vget_low_s16(mask2), vget_low_s16(src0_2), vget_low_s16(src1_2),
        v_maxval, &mask_x_src_2_low);
  blend(vget_low_s16(mask3), vget_low_s16(src0_3), vget_low_s16(src1_3),
        v_maxval, &mask_x_src_3_low);

  blend(vget_high_s16(mask0), vget_high_s16(src0_0), vget_high_s16(src1_0),
        v_maxval, &mask_x_src_0_high);
  blend(vget_high_s16(mask1), vget_high_s16(src0_1), vget_high_s16(src1_1),
        v_maxval, &mask_x_src_1_high);
  blend(vget_high_s16(mask2), vget_high_s16(src0_2), vget_high_s16(src1_2),
        v_maxval, &mask_x_src_2_high);
  blend(vget_high_s16(mask3), vget_high_s16(src0_3), vget_high_s16(src1_3),
        v_maxval, &mask_x_src_3_high);

  int16x8_t im_res_0 =
      vcombine_s16(vmovn_s32(mask_x_src_0_low), vmovn_s32(mask_x_src_0_high));
  int16x8_t im_res_1 =
      vcombine_s16(vmovn_s32(mask_x_src_1_low), vmovn_s32(mask_x_src_1_high));
  int16x8_t im_res_2 =
      vcombine_s16(vmovn_s32(mask_x_src_2_low), vmovn_s32(mask_x_src_2_high));
  int16x8_t im_res_3 =
      vcombine_s16(vmovn_s32(mask_x_src_3_low), vmovn_s32(mask_x_src_3_high));
...
static INLINE void blend_w4(uint8_t *dst, uint32_t dst_stride,
  ...
  int32x4_t mask_x_src_0, mask_x_src_1, mask_x_src_2, mask_x_src_3;
  ...
  blend(mask0, vget_low_s16(src0_0), vget_low_s16(src1_0), v_maxval,
        &mask_x_src_0);
  blend(mask1, vget_high_s16(src0_0), vget_high_s16(src1_0), v_maxval,
        &mask_x_src_1);
  blend(mask2, vget_low_s16(src0_1), vget_low_s16(src1_1), v_maxval,
        &mask_x_src_2);
  blend(mask3, vget_high_s16(src0_1), vget_high_s16(src1_1), v_maxval,
        &mask_x_src_3);

  uint16x8_t im_res_0 = vreinterpretq_u16_s16(
      vcombine_s16(vmovn_s32(mask_x_src_0), vmovn_s32(mask_x_src_1)));
  uint16x8_t im_res_1 = vreinterpretq_u16_s16(
      vcombine_s16(vmovn_s32(mask_x_src_2), vmovn_s32(mask_x_src_3)));

  im_res_0 = vqsubq_u16(im_res_0, vec_round_offset);
  im_res_1 = vqsubq_u16(im_res_1, vec_round_offset);
