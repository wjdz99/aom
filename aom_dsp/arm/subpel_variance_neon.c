...
static void var_filter_block2d_bil_large(const uint8_t *src_ptr,
  ...
  do {
    ...
    do {
      ...
      uint8x16_t blend_u8 = vcombine_u8(vrshrn_n_u16(blend_l, 3),
                                        vrshrn_n_u16(blend_h, 3));
...
#define SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(w, h, padding)                   \
  unsigned int aom_sub_pixel_variance##w##x##h##_neon(                        \
      const uint8_t *src, int src_stride, int xoffset, int yoffset,           \
...
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(16, 16, 1)
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(16, 32, 1)

SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(32, 16, 1)
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(32, 32, 1)
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(32, 64, 1)

SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(64, 32, 1)
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(64, 64, 1)
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(64, 128, 1)

SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(128, 64, 1)
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(128, 128, 1)
...
SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(16, 64, 1)

SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(32, 8, 1)

SPECIALISED_SUBPEL_VARIANCE_WXH_NEON(64, 16, 1)

#endif  // !CONFIG_REALTIME_ONLY

#undef SUBPEL_VARIANCE_WXH_NEON
#undef SPECIALISED_SUBPEL_VARIANCE_WXH_NEON
