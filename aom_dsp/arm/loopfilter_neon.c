...
void aom_lpf_horizontal_14_neon(uint8_t *src, int stride, const uint8_t *blimit,
  ...
  p6q6 = vreinterpret_u8_u32(vld1_dup_u32((uint32_t *)(src - 7 * stride)));
  p5q5 = vreinterpret_u8_u32(vld1_dup_u32((uint32_t *)(src - 6 * stride)));
  p4q4 = vreinterpret_u8_u32(vld1_dup_u32((uint32_t *)(src - 5 * stride)));
  ...
  p4q4 = vreinterpret_u8_u32(vld1_lane_u32((uint32_t *)(src + 4 * stride),
                                           vreinterpret_u32_u8(p4q4), 1));
  p5q5 = vreinterpret_u8_u32(vld1_lane_u32((uint32_t *)(src + 5 * stride),
                                           vreinterpret_u32_u8(p5q5), 1));
  p6q6 = vreinterpret_u8_u32(vld1_lane_u32((uint32_t *)(src + 6 * stride),
                                           vreinterpret_u32_u8(p6q6), 1));

  lpf_14_neon(&p6q6, &p5q5, &p4q4, &p3q3, &p2q2, &p1q1, &p0q0, *blimit, *limit,
              *thresh);

  vst1_lane_u32((uint32_t *)(src - 6 * stride), vreinterpret_u32_u8(p5q5), 0);
  vst1_lane_u32((uint32_t *)(src - 5 * stride), vreinterpret_u32_u8(p4q4), 0);
  ...
  vst1_lane_u32((uint32_t *)(src + 4 * stride), vreinterpret_u32_u8(p4q4), 1);
  vst1_lane_u32((uint32_t *)(src + 5 * stride), vreinterpret_u32_u8(p5q5), 1);
}
