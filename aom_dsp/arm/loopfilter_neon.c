...
static void lpf_internal_14_neon(uint8x8_t *p6q6, uint8x8_t *p5q5,
                                 uint8x8_t *p4q4, uint8x8_t *p3q3,
                                 uint8x8_t *p2q2, uint8x8_t *p1q1,
                                 uint8x8_t *p0q0, const uint8_t *blimit,
                                 const uint8_t *limit, const uint8_t *thresh) {
  uint16x8_t out;
  int16x8_t p3q3_s16, p2q2_s16, p1q1_s16, p0q0_s16;
  const int16x8_t thresh_16x8 = vdupq_n_s16(1);
  ...
  p0q0_s16 = vreinterpretq_s16_u16(vmovl_u8(*p0q0));
  p1q1_s16 = vreinterpretq_s16_u16(vmovl_u8(*p1q1));
  p2q2_s16 = vreinterpretq_s16_u16(vmovl_u8(*p2q2));
  p3q3_s16 = vreinterpretq_s16_u16(vmovl_u8(*p3q3));
  {
    // Calculate mask values for four samples
    uint16x8_t mask_16x8, temp_16x8;
    const int16x8_t limit_16x8 =
        vreinterpretq_s16_u16(vmovl_u8(vdup_n_u8(*limit)));
    uint16x4_t mask_16x4;
    int16x4_t temp_16x4, p0_u16, p1_u16, q0_u16, q1_u16;
    const int16x4_t blimit_16x4 = vreinterpret_s16_u16(vdup_n_u16(*blimit));

    p0_u16 = vget_low_s16(p0q0_s16);
    q0_u16 = vget_high_s16(p0q0_s16);
    p1_u16 = vget_low_s16(p1q1_s16);
    q1_u16 = vget_high_s16(p1q1_s16);
    mask_16x8 = vcgtq_s16(vabdq_s16(p3q3_s16, p2q2_s16), limit_16x8);

    temp_16x8 = vcgtq_s16(vabdq_s16(p2q2_s16, p1q1_s16), limit_16x8);
    mask_16x8 = vorrq_u16(mask_16x8, temp_16x8);

    temp_16x8 = vcgtq_s16(vabdq_s16(p1q1_s16, p0q0_s16), limit_16x8);
    mask_16x8 = vorrq_u16(mask_16x8, temp_16x8);

    mask_16x4 = vorr_u16(vget_high_u16(mask_16x8), vget_low_u16(mask_16x8));

    temp_16x4 = vshl_n_s16(vabd_s16(p0_u16, q0_u16), 1);
    temp_16x4 = vadd_s16(temp_16x4, vshr_n_s16(vabd_s16(p1_u16, q1_u16), 1));
    mask_16x4 = vorr_u16(mask_16x4, vcgt_s16(temp_16x4, blimit_16x4));
    mask_16x4 = vmvn_u16(mask_16x4);
    mask_8x8 = vmovn_u16(vcombine_u16(mask_16x4, mask_16x4));
  }
  {
    // Calculate flat values for four samples
    uint16x8_t flat_16x8, temp_16x8;
    uint16x4_t flat_16x4;

    flat_16x8 = vcgtq_s16(vabdq_s16(p1q1_s16, p0q0_s16), thresh_16x8);
    temp_16x8 = vcgtq_s16(vabdq_s16(p2q2_s16, p0q0_s16), thresh_16x8);
    flat_16x8 = vorrq_u16(flat_16x8, temp_16x8);

    temp_16x8 = vcgtq_s16(vabdq_s16(p3q3_s16, p0q0_s16), thresh_16x8);
    flat_16x8 = vorrq_u16(flat_16x8, temp_16x8);

    flat_16x4 = vorr_u16(vget_high_u16(flat_16x8), vget_low_u16(flat_16x8));
    flat_16x4 = vmvn_u16(flat_16x4);
    flat_8x8 = vmovn_u16(vcombine_u16(flat_16x4, flat_16x4));
  }
  {
    // Calculate flat2 value for four samples
    uint16x8_t flat2_16x8, temp_16x8;
    int16x8_t p4q4_s16, p5q5_s16, p6q6_s16;
    uint16x4_t flat2_16x4;

    p4q4_s16 = vreinterpretq_s16_u16(vmovl_u8(*p4q4));
    p5q5_s16 = vreinterpretq_s16_u16(vmovl_u8(*p5q5));
    p6q6_s16 = vreinterpretq_s16_u16(vmovl_u8(*p6q6));
    flat2_16x8 = vcgtq_s16(vabdq_s16(p4q4_s16, p0q0_s16), thresh_16x8);
    temp_16x8 = vcgtq_s16(vabdq_s16(p5q5_s16, p0q0_s16), thresh_16x8);
    flat2_16x8 = vorrq_u16(flat2_16x8, temp_16x8);

    temp_16x8 = vcgtq_s16(vabdq_s16(p6q6_s16, p0q0_s16), thresh_16x8);
    flat2_16x8 = vorrq_u16(flat2_16x8, temp_16x8);

    flat2_16x4 = vorr_u16(vget_high_u16(flat2_16x8), vget_low_u16(flat2_16x8));
    flat2_16x4 = vmvn_u16(flat2_16x4);
    flat2_8x8 = vmovn_u16(vcombine_u16(flat2_16x4, flat2_16x4));
  }
  {
    // filter 4
    int16x8_t filter_s16, hev_16x8;
    const int16x8_t thresh_f4 = vdupq_n_s16((int16_t)*thresh);
    int16x4_t hev_16x4;
    ...
    int8x8_t hev_8x8;
    const int8x8_t xor_val = vdup_n_s8(0x80);
    const int8x8_t val_4 = vdup_n_s8(4);
    const int8x8_t val_3 = vdup_n_s8(3);

    pq_s0 = veor_s8(vreinterpret_s8_u8(*p0q0), xor_val);
    pq_s1 = veor_s8(vreinterpret_s8_u8(*p1q1), xor_val);
    ps0_s8 = vreinterpret_s8_s32(vdup_lane_s32(vreinterpret_s32_s8(pq_s0), 0));
    qs0_s8 = vreinterpret_s8_s32(vdup_lane_s32(vreinterpret_s32_s8(pq_s0), 1));
    ps1_s8 = vreinterpret_s8_s32(vdup_lane_s32(vreinterpret_s32_s8(pq_s1), 0));
    qs1_s8 = vreinterpret_s8_s32(vdup_lane_s32(vreinterpret_s32_s8(pq_s1), 1));

    // hev_mask
    hev_16x8 = vreinterpretq_s16_u16(
        vcgtq_s16(vabdq_s16(p0q0_s16, p1q1_s16), thresh_f4));
    hev_16x4 = vorr_s16(vget_high_s16(hev_16x8), vget_low_s16(hev_16x8));
    hev_16x8 = vcombine_s16(hev_16x4, hev_16x4);
    hev_8x8 = vmovn_s16(hev_16x8);
    ...
    oq0 = veor_s8(vqsub_s8(qs0_s8, filter1_s8), xor_val);
    op0 = veor_s8(vqadd_s8(ps0_s8, filter2_s8), xor_val);

    hev_8x8 = vmvn_s8(hev_8x8);
    filter_s8 = vrshr_n_s8(filter1_s8, 1);
    filter_s8 = vand_s8(filter_s8, hev_8x8);

    oq1 = veor_s8(vqsub_s8(qs1_s8, filter_s8), xor_val);
    op1 = veor_s8(vqadd_s8(ps1_s8, filter_s8), xor_val);
...
static void lpf_internal_8_neon(uint8x8_t *p3q3, uint8x8_t *p2q2,
...
void aom_lpf_vertical_14_neon(uint8_t *src, int stride, const uint8_t *blimit,
  ...
  lpf_internal_14_neon(&p6q6, &p5q5, &p4q4, &p3q3, &p2q2, &p1q1, &p0q0, blimit,
                       limit, thresh);
...
void aom_lpf_horizontal_8_neon(uint8_t *src, int stride, const uint8_t *blimit,
  ...
  lpf_internal_8_neon(&p3q3, &p2q2, &p1q1, &p0q0, blimit, limit, thresh);
