...
static INLINE uint8x8_t lpf_mask(uint8x8_t p3q3, uint8x8_t p2q2, uint8x8_t p1q1,
  ...
  mask_8x8 = vcgt_u8(vabd_u8(p3q3, p2q2), limit_8x8);

  temp_8x8 = vcgt_u8(vabd_u8(p2q2, p1q1), limit_8x8);
  mask_8x8 = vorr_u8(mask_8x8, temp_8x8);

  temp_8x8 = vcgt_u8(vabd_u8(p1q1, p0q0), limit_8x8);
  mask_8x8 = vorr_u8(mask_8x8, temp_8x8);
  ...
  temp0_16x4 = vcgt_u16(temp0_16x4, blimit_16x4);
  temp_8x8 = vmovn_u16(vcombine_u16(temp0_16x4, temp0_16x4));

  mask_8x8 = vorr_u8(mask_8x8, temp_8x8);
  mask_8x8 = vmvn_u8(mask_8x8);
...
static INLINE uint8x8_t lpf_flat_mask4(uint8x8_t p3q3, uint8x8_t p2q2,
  ...
  const uint8x8_t thresh_8x8 = vdup_n_u8(thresh);
  uint8x8_t flat_8x8, temp_8x8;

  flat_8x8 = vcgt_u8(vabd_u8(p1q1, p0q0), thresh_8x8);
  temp_8x8 = vcgt_u8(vabd_u8(p2q2, p0q0), thresh_8x8);
  flat_8x8 = vorr_u8(flat_8x8, temp_8x8);

  temp_8x8 = vcgt_u8(vabd_u8(p3q3, p0q0), thresh_8x8);
  flat_8x8 = vorr_u8(flat_8x8, temp_8x8);

  temp_8x8 = vreinterpret_u8_u32(vrev64_u32(vreinterpret_u32_u8(flat_8x8)));
  flat_8x8 = vorr_u8(flat_8x8, temp_8x8);
  flat_8x8 = vmvn_u8(flat_8x8);
...
static void lpf_14_neon(uint8x8_t *p6q6, uint8x8_t *p5q5, uint8x8_t *p4q4,
  ...
  flat_8x8 = lpf_flat_mask4(*p3q3, *p2q2, *p1q1, *p0q0, 1);
  flat2_8x8 = lpf_flat_mask4(*p6q6, *p5q5, *p4q4, *p0q0, 1);
  {
    // filter 4
