...
void aom_highbd_convolve8_vert_sve(const uint8_t *src8, ptrdiff_t src_stride,
  ...
  tran_concat_tbl[0] = vld1q_u8(dot_prod_tran_concat_tbl);
  tran_concat_tbl[1] = vld1q_u8(dot_prod_tran_concat_tbl + 16);
  uint8x16_t merge_block_tbl[3];
  merge_block_tbl[0] = vld1q_u8(dot_prod_merge_block_tbl);
  merge_block_tbl[1] = vld1q_u8(dot_prod_merge_block_tbl + 16);
  merge_block_tbl[2] = vld1q_u8(dot_prod_merge_block_tbl + 32);
