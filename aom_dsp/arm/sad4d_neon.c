...
static void sad_row4_neon(uint16x4_t *vec_src, const uint8x8_t q0, const uint8x8_t ref) {
  ...
  switch (width) {
    case 4:{
      ...
      for (int i = 0; i < height/2; i++) {
        ...
        uint32x2_t q8 = vset_lane_u32(src4,q8,0);
        uint32x2_t q4 = vset_lane_u32(ref40,q4,0);
        uint32x2_t q5 = vset_lane_u32(ref41,q5,0);
        uint32x2_t q6 = vset_lane_u32(ref42,q6,0);
        uint32x2_t q7 = vset_lane_u32(ref43,q7,0);
