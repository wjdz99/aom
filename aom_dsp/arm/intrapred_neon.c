...
void aom_dc_predictor_16x32_neon(uint8_t *dst, ptrdiff_t stride,
                                 const uint8_t *above, const uint8_t *left) {
  uint16x8_t sum_above = dc_load_sum_16(above);
  uint16x8_t sum_left = dc_load_sum_32(left);
...
void aom_dc_predictor_32x16_neon(uint8_t *dst, ptrdiff_t stride,
                                 const uint8_t *above, const uint8_t *left) {
  uint16x8_t sum_above = dc_load_sum_32(above);
  uint16x8_t sum_left = dc_load_sum_16(left);
  uint16x8_t sum_al = vaddq_u16(sum_left, sum_above);
  uint32_t sum = horizontal_add_u16x8(sum_al);
...
void aom_dc_predictor_64x16_neon(uint8_t *dst, ptrdiff_t stride,
                                 const uint8_t *above, const uint8_t *left) {
  uint16x8_t sum_above = dc_load_sum_64(above);
  uint16x8_t sum_left = dc_load_sum_16(left);
...
void aom_dc_128_predictor_4x8_neon(uint8_t *dst, ptrdiff_t stride,
                                   const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_4xh(dst, stride, 8, vdup_n_u8(128));
}

void aom_dc_128_predictor_8x4_neon(uint8_t *dst, ptrdiff_t stride,
                                   const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_8xh(dst, stride, 4, vdup_n_u8(128));
}

void aom_dc_128_predictor_8x16_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_8xh(dst, stride, 16, vdup_n_u8(128));
}

void aom_dc_128_predictor_16x8_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_16xh(dst, stride, 8, vdupq_n_u8(128));
}

void aom_dc_128_predictor_16x32_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_16xh(dst, stride, 32, vdupq_n_u8(128));
}

void aom_dc_128_predictor_32x16_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_32xh(dst, stride, 16, vdupq_n_u8(128));
}

void aom_dc_128_predictor_32x64_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_32xh(dst, stride, 64, vdupq_n_u8(128));
}

void aom_dc_128_predictor_64x32_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_64xh(dst, stride, 32, vdupq_n_u8(128));
}

void aom_dc_128_predictor_4x16_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_4xh(dst, stride, 16, vdup_n_u8(128));
}

void aom_dc_128_predictor_16x4_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_16xh(dst, stride, 4, vdupq_n_u8(128));
}

void aom_dc_128_predictor_8x32_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_8xh(dst, stride, 32, vdup_n_u8(128));
}

void aom_dc_128_predictor_32x8_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_32xh(dst, stride, 8, vdupq_n_u8(128));
}

void aom_dc_128_predictor_16x64_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_16xh(dst, stride, 64, vdupq_n_u8(128));
}

void aom_dc_128_predictor_64x16_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  (void)left;
  dc_store_64xh(dst, stride, 16, vdupq_n_u8(128));
}

void aom_dc_left_predictor_4x8_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  const uint16x8_t sum = dc_load_sum_8(left);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 3);
  dc_store_4xh(dst, stride, 8, vdup_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_8x4_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  const uint16x8_t sum = dc_load_sum_4(left);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 2);
  dc_store_8xh(dst, stride, 4, vdup_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_8x16_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_16(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 4);
  dc_store_8xh(dst, stride, 16, vdup_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_16x8_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  const uint16x8_t sum = dc_load_sum_8(left);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 3);
  dc_store_16xh(dst, stride, 8, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_16x32_neon(uint8_t *dst, ptrdiff_t stride,
                                      const uint8_t *above,
                                      const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_32(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 5);
  dc_store_16xh(dst, stride, 32, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_32x16_neon(uint8_t *dst, ptrdiff_t stride,
                                      const uint8_t *above,
                                      const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_16(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 4);
  dc_store_32xh(dst, stride, 16, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_32x64_neon(uint8_t *dst, ptrdiff_t stride,
                                      const uint8_t *above,
                                      const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_64(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 6);
  dc_store_32xh(dst, stride, 64, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_64x32_neon(uint8_t *dst, ptrdiff_t stride,
                                      const uint8_t *above,
                                      const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_32(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 5);
  dc_store_64xh(dst, stride, 32, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_4x16_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_16(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 4);
  dc_store_4xh(dst, stride, 16, vdup_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_16x4_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  const uint16x8_t sum = dc_load_sum_4(left);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 2);
  dc_store_16xh(dst, stride, 4, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_8x32_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_32(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 5);
  dc_store_8xh(dst, stride, 32, vdup_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_32x8_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)above;
  const uint16x8_t sum = dc_load_sum_8(left);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 3);
  dc_store_32xh(dst, stride, 8, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_16x64_neon(uint8_t *dst, ptrdiff_t stride,
                                      const uint8_t *above,
                                      const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_64(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 6);
  dc_store_16xh(dst, stride, 64, vdupq_lane_u8(dc0, 0));
}

void aom_dc_left_predictor_64x16_neon(uint8_t *dst, ptrdiff_t stride,
                                      const uint8_t *above,
                                      const uint8_t *left) {
  (void)above;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_16(left));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 4);
  dc_store_64xh(dst, stride, 16, vdupq_lane_u8(dc0, 0));
}

void aom_dc_top_predictor_4x8_neon(uint8_t *dst, ptrdiff_t stride,
                                   const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum = dc_load_sum_4(above);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 2);
  dc_store_4xh(dst, stride, 8, vdup_lane_u8(dc0, 0));
}

void aom_dc_top_predictor_8x4_neon(uint8_t *dst, ptrdiff_t stride,
                                   const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum = dc_load_sum_8(above);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 3);
  dc_store_8xh(dst, stride, 4, vdup_lane_u8(dc0, 0));
}

void aom_dc_top_predictor_8x16_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum = dc_load_sum_8(above);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 3);
...
void aom_dc_top_predictor_16x8_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_16(above));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 4);
  dc_store_16xh(dst, stride, 8, vdupq_lane_u8(dc0, 0));
}

void aom_dc_top_predictor_16x32_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
...
void aom_dc_top_predictor_32x16_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_32(above));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 5);
  dc_store_32xh(dst, stride, 16, vdupq_lane_u8(dc0, 0));
}

void aom_dc_top_predictor_32x64_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
...
void aom_dc_top_predictor_64x32_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_64(above));
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 6);
  dc_store_64xh(dst, stride, 32, vdupq_lane_u8(dc0, 0));
}

void aom_dc_top_predictor_4x16_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum = dc_load_sum_4(above);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 2);
...
void aom_dc_top_predictor_16x4_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_16(above));
...
void aom_dc_top_predictor_8x32_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum = dc_load_sum_8(above);
  const uint8x8_t dc0 = vrshrn_n_u16(sum, 3);
...
void aom_dc_top_predictor_32x8_neon(uint8_t *dst, ptrdiff_t stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
      horizontal_add_and_broadcast_u16x8(dc_load_sum_32(above));
...
void aom_dc_top_predictor_16x64_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
...
void aom_dc_top_predictor_64x16_neon(uint8_t *dst, ptrdiff_t stride,
                                     const uint8_t *above,
                                     const uint8_t *left) {
  (void)left;
  const uint16x8_t sum =
