...
static void dr_prediction_z2_Nx4_neon(int N, uint8_t *dst, ptrdiff_t stride,
  ...
  left_vals.val[0] = left_m2;
  left_vals.val[1] = left_14;
...
static void dr_prediction_z2_HxW_neon(int H, int W, uint8_t *dst,
  ...
  uint8x16x4_t left_vals0;
  uint8x16x4_t left_vals1;
  left_vals0.val[0] = left_m1;
  left_vals0.val[1] = left_15;
  left_vals0.val[2] = left_31;
  left_vals0.val[3] = left_47;
  left_vals1.val[0] = left_0;
  left_vals1.val[1] = left_16;
  left_vals1.val[2] = left_32;
  left_vals1.val[3] = left_48;
#endif  // defined(__aarch64__)
