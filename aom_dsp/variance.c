...
void aom_highbd_variance64_c(const uint8_t *a8, int a_stride, const uint8_t *b8,
...
uint64_t aom_highbd_sse_odd_size(const uint8_t *a, int a_stride,
  ...
  uint64_t sse;
  int64_t sum;
  aom_highbd_variance64(a, a_stride, b, b_stride, w, h, &sse, &sum);
  return sse;
}
...
static void highbd_8_variance(const uint8_t *a8, int a_stride,
  ...
  uint64_t sse_long = 0;
  int64_t sum_long = 0;
  aom_highbd_variance64(a8, a_stride, b8, b_stride, w, h, &sse_long, &sum_long);
