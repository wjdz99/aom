...
#define AV1_MADD(inp0, inp1, inp2, inp3, cst0, cst1, cst2, cst3, out0, out1,  \
  ...
  {                                                                           \
    ...
    v4i32 tmp0_madd, tmp1_m, tmp2_m, tmp3_m;                                  \
                                                                              \
    ...
    DOTP_SH4_SW(madd_s1_m, madd_s0_m, madd_s1_m, madd_s0_m, cst0, cst0, cst1, \
                cst1, tmp0_madd, tmp1_m, tmp2_m, tmp3_m);                     \
    SRARI_W4_SW(tmp0_madd, tmp1_m, tmp2_m, tmp3_m, DCT_CONST_BITS);           \
    PCKEV_H2_SH(tmp1_m, tmp0_madd, tmp3_m, tmp2_m, out0, out1);               \
    DOTP_SH4_SW(madd_s3_m, madd_s2_m, madd_s3_m, madd_s2_m, cst2, cst2, cst3, \
                cst3, tmp0_madd, tmp1_m, tmp2_m, tmp3_m);                     \
    SRARI_W4_SW(tmp0_madd, tmp1_m, tmp2_m, tmp3_m, DCT_CONST_BITS);           \
    PCKEV_H2_SH(tmp1_m, tmp0_madd, tmp3_m, tmp2_m, out2, out3);               \
  }
