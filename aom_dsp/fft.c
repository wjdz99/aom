...
void simple_transpose(const float *A, float *B, int n) {
  for (int y = 0; y < n; y++) {
    for (int x = 0; x < n; x++) {
      B[y * n + x] = A[x * n + y];
    }
...
GEN_FFT_8(void, float, float, float, *, store_float, (float));
GEN_FFT_16(void, float, float, float, *, store_float, (float));
GEN_FFT_32(void, float, float, float, *, store_float, (float));
...
GEN_IFFT_8(void, float, float, float, *, store_float, (float));
GEN_IFFT_16(void, float, float, float, *, store_float, (float));
GEN_IFFT_32(void, float, float, float, *, store_float, (float));
