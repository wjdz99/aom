...
unsigned int aom_avg_4x4_sse2(const uint8_t *s, int p) {
  ...
  unsigned int avg = 0;
  u0 = _mm_setzero_si128();
  s0 = _mm_unpacklo_epi32(_mm_loadu_si32((const __m128i *)(s)),
                          _mm_loadu_si32((const __m128i *)(s + p)));
  s1 = _mm_unpacklo_epi32(_mm_loadu_si32((const __m128i *)(s + 2 * p)),
                          _mm_loadu_si32((const __m128i *)(s + 3 * p)));
  s0 = _mm_sad_epu8(s0, u0);
  s1 = _mm_sad_epu8(s1, u0);
