...
static void blend_mask6_w4_sse4_1(uint8_t *dst, uint32_t dst_stride,
...
static void blend_mask6_w8_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                  uint8_t *src0, uint32_t src0_stride,
                                  uint8_t *src1, uint32_t src1_stride,
                                  const uint8_t *mask, uint32_t mask_stride,
                                  int h, int w) {
...
static void blend_mask6_w16n_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                    uint8_t *src0, uint32_t src0_stride,
                                    uint8_t *src1, uint32_t src1_stride,
                                    const uint8_t *mask, uint32_t mask_stride,
                                    int h, int w) {
...
static void blend_mask6_sx_w4_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                     uint8_t *src0, uint32_t src0_stride,
                                     uint8_t *src1, uint32_t src1_stride,
                                     const uint8_t *mask, uint32_t mask_stride,
                                     int h, int w) {
...
static void blend_mask6_sx_w8_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                     uint8_t *src0, uint32_t src0_stride,
                                     uint8_t *src1, uint32_t src1_stride,
                                     const uint8_t *mask, uint32_t mask_stride,
                                     int h, int w) {
...
static void blend_mask6_sx_w16n_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                       uint8_t *src0, uint32_t src0_stride,
                                       uint8_t *src1, uint32_t src1_stride,
                                       const uint8_t *mask,
...
static void blend_mask6_sy_w4_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                     uint8_t *src0, uint32_t src0_stride,
                                     uint8_t *src1, uint32_t src1_stride,
                                     const uint8_t *mask, uint32_t mask_stride,
                                     int h, int w) {
...
static void blend_mask6_sy_w8_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                     uint8_t *src0, uint32_t src0_stride,
                                     uint8_t *src1, uint32_t src1_stride,
                                     const uint8_t *mask, uint32_t mask_stride,
                                     int h, int w) {
...
static void blend_mask6_sy_w16n_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                       uint8_t *src0, uint32_t src0_stride,
                                       uint8_t *src1, uint32_t src1_stride,
                                       const uint8_t *mask,
                                       uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_sx_sy_w4_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                        uint8_t *src0, uint32_t src0_stride,
                                        uint8_t *src1, uint32_t src1_stride,
                                        const uint8_t *mask,
                                        uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_sx_sy_w8_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                        uint8_t *src0, uint32_t src0_stride,
                                        uint8_t *src1, uint32_t src1_stride,
                                        const uint8_t *mask,
                                        uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_sx_sy_w16n_sse4_1(uint8_t *dst, uint32_t dst_stride,
                                          uint8_t *src0, uint32_t src0_stride,
                                          uint8_t *src1, uint32_t src1_stride,
                                          const uint8_t *mask,
                                          uint32_t mask_stride, int h, int w) {
...
void aom_blend_mask6_sse4_1(uint8_t *dst, uint32_t dst_stride, uint8_t *src0,
                            uint32_t src0_stride, uint8_t *src1,
                            uint32_t src1_stride, const uint8_t *mask,
                            uint32_t mask_stride, int h, int w, int suby,
                            int subx) {
  typedef void (*blend_fn)(uint8_t *dst, uint32_t dst_stride, uint8_t *src0,
                           uint32_t src0_stride, uint8_t *src1,
                           uint32_t src1_stride, const uint8_t *mask,
                           uint32_t mask_stride, int h, int w);

  static blend_fn blend[3][2][2] = {
    // width_index X subx X suby
    { // w % 16 == 0
  ...
  blend[(w >> 2) & 3][subx != 0][suby != 0](dst, dst_stride, src0, src0_stride,
                                            src1, src1_stride, mask,
                                            mask_stride, h, w);
}
...
static INLINE void blend_mask6_bn_w4_sse4_1(
    uint16_t *dst, uint32_t dst_stride, uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride, const uint8_t *mask,
    uint32_t mask_stride, int h, blend_unit_fn blend) {
  const __m128i v_maxval_w = _mm_set1_epi16(1 << MASK_BITS);
...
static void blend_mask6_b10_w4_sse4_1(uint16_t *dst, uint32_t dst_stride,
...
static void blend_mask6_b12_w4_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                      uint16_t *src0, uint32_t src0_stride,
                                      uint16_t *src1, uint32_t src1_stride,
                                      const uint8_t *mask, uint32_t mask_stride,
                                      int h, int w) {
...
static inline void blend_mask6_bn_w8n_sse4_1(
    uint16_t *dst, uint32_t dst_stride, uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride, const uint8_t *mask,
    uint32_t mask_stride, int h, int w, blend_unit_fn blend) {
  const __m128i v_maxval_w = _mm_set1_epi16(1 << MASK_BITS);
...
static void blend_mask6_b10_w8n_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                       uint16_t *src0, uint32_t src0_stride,
                                       uint16_t *src1, uint32_t src1_stride,
                                       const uint8_t *mask,
                                       uint32_t mask_stride, int h, int w) {
  blend_mask6_bn_w8n_sse4_1(dst, dst_stride, src0, src0_stride, src1,
                            src1_stride, mask, mask_stride, h, w, blend_8_b10);
}

static void blend_mask6_b12_w8n_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                       uint16_t *src0, uint32_t src0_stride,
                                       uint16_t *src1, uint32_t src1_stride,
                                       const uint8_t *mask,
                                       uint32_t mask_stride, int h, int w) {
  blend_mask6_bn_w8n_sse4_1(dst, dst_stride, src0, src0_stride, src1,
                            src1_stride, mask, mask_stride, h, w, blend_8_b12);
}
...
static void blend_mask6_b10_sx_w4_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                         uint16_t *src0, uint32_t src0_stride,
                                         uint16_t *src1, uint32_t src1_stride,
                                         const uint8_t *mask,
                                         uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b12_sx_w4_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                         uint16_t *src0, uint32_t src0_stride,
                                         uint16_t *src1, uint32_t src1_stride,
                                         const uint8_t *mask,
                                         uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b10_sx_w8n_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                          uint16_t *src0, uint32_t src0_stride,
                                          uint16_t *src1, uint32_t src1_stride,
                                          const uint8_t *mask,
                                          uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b12_sx_w8n_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                          uint16_t *src0, uint32_t src0_stride,
                                          uint16_t *src1, uint32_t src1_stride,
                                          const uint8_t *mask,
                                          uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b10_sy_w4_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                         uint16_t *src0, uint32_t src0_stride,
                                         uint16_t *src1, uint32_t src1_stride,
                                         const uint8_t *mask,
                                         uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b12_sy_w4_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                         uint16_t *src0, uint32_t src0_stride,
                                         uint16_t *src1, uint32_t src1_stride,
                                         const uint8_t *mask,
                                         uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b10_sy_w8n_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                          uint16_t *src0, uint32_t src0_stride,
                                          uint16_t *src1, uint32_t src1_stride,
                                          const uint8_t *mask,
                                          uint32_t mask_stride, int h, int w) {
...
static void blend_mask6_b12_sy_w8n_sse4_1(uint16_t *dst, uint32_t dst_stride,
                                          uint16_t *src0, uint32_t src0_stride,
                                          uint16_t *src1, uint32_t src1_stride,
                                          const uint8_t *mask,
                                          uint32_t mask_stride, int h, int w) {
...
void aom_highbd_blend_mask6_sse4_1(uint8_t *dst_8, uint32_t dst_stride,
  ...
  typedef void (*blend_fn)(uint16_t *dst, uint32_t dst_stride, uint16_t *src0,
                           uint32_t src0_stride, uint16_t *src1,
                           uint32_t src1_stride, const uint8_t *mask,
                           uint32_t mask_stride, int h, int w);

  static blend_fn blend[2][2][2][2] = {
    // bd_index X width_index X subx X suby
    {   // bd == 8 or 10
      { // w % 8 == 0
  ...
  blend[bd == 12][(w >> 2) & 1][subx != 0][suby != 0](
      dst, dst_stride, src0, src0_stride, src1, src1_stride, mask, mask_stride,
      h, w);
}
