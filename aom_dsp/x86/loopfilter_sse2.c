...
void lpf_internal_14_sse2(__m128i* q6p6, __m128i* q5p5, __m128i* q4p4, __m128i* q3p3, __m128i* q2p2, __m128i* q1p1, __m128i* q0p0,
...
void aom_lpf_horizontal_14_sse2(unsigned char *s, int p,
  ...
  lpf_internal_14_sse2(&q6p6, &q5p5, &q4p4, &q3p3, &q2p2, &q1p1, &q0p0,
	  _blimit, _limit, _thresh);
...
void aom_lpf_horizontal_14_sse2_test(unsigned char *s, int p,
	const unsigned char *_blimit,
	const unsigned char *_limit,
	const unsigned char *_thresh, __m128i* q6p6_t, __m128i* q5p5_t, __m128i* q4p4_t, __m128i* q3p3_t, __m128i* q2p2_t, __m128i* q1p1_t, __m128i* q0p0_t, unsigned char *s_out) {
	...
	*q0p0_t = q0p0;
	...
	store_buffer_horz_8(q0p0, p, 0, s_out);
	store_buffer_horz_8(q1p1, p, 1, s_out);
	store_buffer_horz_8(q2p2, p, 2, s_out);
	store_buffer_horz_8(q3p3, p, 3, s_out);
	store_buffer_horz_8(q4p4, p, 4, s_out);
	store_buffer_horz_8(q5p5, p, 5, s_out);
}
...
static AOM_FORCE_INLINE void lpf_internal_8_sse2(
	__m128i *p3_8, __m128i *q3_8, __m128i *p2_8, __m128i *q2_8, __m128i *p1_8, __m128i *q1_8, __m128i *p0_8,
	__m128i *q0_8, __m128i *q1q0_out, __m128i *p1p0_out, __m128i *p2_out, __m128i *q2_out, const unsigned char *_blimit,
	const unsigned char *_limit, const unsigned char *_thresh) {
...
void aom_lpf_horizontal_8_sse2(unsigned char *s, int p,
  ...
  lpf_internal_8_sse2(&p3_8, &q3_8, &p2_8, &q2_8, &p1_8, &q1_8, &p0_8, &q0_8,  &q1q0, &p1p0, &p2, &q2,
	  _blimit, _limit, _thresh);
...
void aom_lpf_vertical_8_sse2(unsigned char *s, int p,
	...
	// Loop filtering
	lpf_internal_8_sse2(&d0d1, &d7, &d1, &d6d7, &d2d3, &d5, &d3, &d4d5, &q1q0, &p1p0, &p2, &q2,
		blimit, limit, thresh);
...
void aom_lpf_vertical_14_sse2(unsigned char *s, int p,
  ...
  transpose8x8_sse2(&p6, &p5, &p4, &p3, &p2, &p1, &p0, &q0, &d0d1, &d2d3, &d4d5, &d6d7);
  ...
  transpose8x8_sse2(&p6_2, &p5_2, &p4_2, &p3_2, &p2_2, &p1_2, &p0_2, &q0_2, &d0d1_2, &d2d3_2, &d4d5_2, &d6d7_2);
  ...
  transpose8x8_sse2(&d0d1,&d1,  &q5p5, &q4p4, &q3p3, &q2p2, &q1p1, &q0p0,   &d0d1, &d2d3, &d4d5, &d6d7);
  ...
  transpose8x8_sse2(&p0, &p1,  &p2, &p3, &p4, &p5, &p6, &d7_2,   &d0d1_2, &d2d3_2, &d4d5_2, &d6d7_2);
