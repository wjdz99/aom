...
static INLINE void transpose4x8_8x4_low_sse2(__m128i *x0, __m128i *x1, __m128i *x2,
...
AOM_FORCE_INLINE void filter_hev_mask4(__m128i *p1p0, __m128i *q1q0,
...
static AOM_FORCE_INLINE void lpf_internal_4_sse2(__m128i *p1, __m128i *p0, __m128i *q0, __m128i* q1, 
    __m128i *limit, __m128i *thresh, __m128i *q1q0_out, __m128i *p1p0_out) {
...
void aom_lpf_horizontal_4_sse2(uint8_t *s, int p /* pitch */,
 ...
 lpf_internal_4_sse2( &p1,  &p0,  &q0,  &q1,
                        &limit,  &thresh, &qs1qs0, &ps1ps0); 
...
static AOM_FORCE_INLINE void lpf_internal_8_sse2(
    ...
    __m128i *blimit, __m128i *limit,
    __m128i *thresh) {
  const __m128i zero = _mm_setzero_si128();
  __m128i mask, hev, flat;
  __m128i p2_16, q2_16, p1_16, p0_16, q0_16, q1_16, p3_16, q3_16, q3p3, flat_p1p0, flat_q0q1;
...
void aom_lpf_horizontal_8_dual_sse2(uint8_t *s, int p, const uint8_t *_blimit0,
  ...
  lpf_internal_8_sse2(&p3, &q3, &p2, &q2, &p1, &q1, &p0, &q0,
                      &q1q0, &p1p0, &p2_out, &q2_out, &blimit, &limit, &thresh);
...
void aom_lpf_horizontal_4_dual_sse2(unsigned char *s, int p,
 ...
 __m128i qs1qs0, ps1ps0;
  ...
  __m128i l =
      _mm_unpacklo_epi64(blimit, limit);
  ...
  __m128i t =
      _mm_unpacklo_epi64(thresh0, thresh1);
...
transpose8x8_low_sse2(&x0, &x1, &x2, &x3, &x4, &x5, &x6, &x7, 
                                 &p1, &p0, &q0, &q1);
  ...
  q1 = _mm_srli_si128(qs1qs0, 8);
   ...
   transpose4x8_8x4_sse2(&p1, &ps1ps0, &qs1qs0, &q1, &d0, &d1, &d2,
                                 &d3, &d4, &d5, &d6, &d7);
...
void aom_lpf_vertical_8_sse2(unsigned char *s, int p,
  ...
  transpose4x8_8x4_sse2(&x3, &x2, &x1, &x0, &d0, &d1, &d2, &d3, &d4, &d5, &d6,
                        &d7);
  // Loop filtering
  lpf_internal_8_sse2(&d0, &d7, &d1, &d6, &d2, &d5, &d3, &d4, &q1q0,
                      &p1p0, &p2, &q2, &blimit, &limit, &thresh);

  p0 = _mm_srli_si128(p1p0, 8);
  q0 = _mm_srli_si128(q1q0, 8);

  transpose8x8_low_sse2(&d0, &p2, &p0, &p1p0, &q1q0, &q0, &q2, &d7, &d0, &d1, &d2, &d3);
...
void aom_lpf_vertical_8_dual_sse2(uint8_t *s, int p, const uint8_t *_blimit0,
  ...
  transpose8x8_sse2(&x0, &x1, &x2, &x3, &x4, &x5, &x6, &x7, &d0d1,
                           &d2d3, &d4d5, &d6d7);
  ...
  lpf_internal_8_sse2(&d0d1, &d7, &d1, &d6d7, &d2d3, &d5, &d3, &d4d5, &q1q0, &p1p0, &p2,
