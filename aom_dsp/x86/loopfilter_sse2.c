...
static INLINE void transpose8x16_16x8_sse2(
    ...
    __m128i *d4d5, __m128i *d6d7, __m128i *d8d9, __m128i *d10d11, __m128i *d12d13, __m128i *d14d15) {
  __m128i w0, w1, w2, w3, w4, w5, w6, w7, w8, w9;
  __m128i w10, w11, w12, w13, w14, w15;
...
static AOM_FORCE_INLINE void lpf_internal_14_sse2(
    ...
    __m128i *q1p1, __m128i *q0p0, __m128i *blimit,
...
void aom_lpf_vertical_14_sse2(unsigned char *s, int p,
  ...
  transpose4x8_8x4_sse2(&x6, &x5, &x4, &x3,  &p0, &p1, &p2, &p3, &p4, &p5,
                    &p6, &p7);
  ...
  transpose4x8_8x4_sse2(&x6, &x5, &x4, &x3,
 ...
 transpose8x8_low_sse2(&p0, &p1, &q5p5, &q4p4, &q3p3, &q2p2, &q1p1, &q0p0, &p0_out,
  ...
  transpose8x8_low_sse2(&x0, &x1, &x2, &x3, &x4, &x5, &x6, &q7, &q0, &q1, &q2, &q3);
...
void aom_lpf_vertical_14_dual_sse2(
  ...
  transpose16x8_8x16_sse2(&d0d1, &q6p6, &q5p5, &q4p4, &q3p3, &q2p2,
                      &q1p1, &q0p0,&x0, &x1, &x2, &x3, &x4, &x5, &x6, &q7,
	  &p0p1,&p2p3,&p4p5,&p6p7,&q0,&q1,&q2,&q3);
