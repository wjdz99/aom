...
void AOM_FORCE_INLINE aom_lpf_internal_6_sse2(__m128i *p2, __m128i *q2, __m128i *p1, __m128i *q1, __m128i *p0, __m128i *q0, __m128i *q1q0, __m128i *p1p0,  
	const unsigned char *_blimit,
	const unsigned char *_limit,
	const unsigned char *_thresh) {
	const __m128i zero = _mm_setzero_si128();
...
void aom_lpf_horizontal_6_sse2(unsigned char *s, int p,
	...
	aom_lpf_internal_6_sse2(&p2, &q2, &p1, &q1, &p0, &q0, &q1q0, &p1p0,  _blimit, _limit,
		_thresh);
...
void aom_lpf_vertical_6_sse2(unsigned char *s, int p,
  ...
  // Loop filtering
  aom_lpf_internal_6_sse2(&d0d1, &d5, &d1,  &d4d5,  &d2d3, &d3,  &q1q0,  &p1p0,  blimit, limit, thresh);
