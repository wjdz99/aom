...
void AOM_FORCE_INLINE aom_lpf_internal_6_sse2(
...
void aom_lpf_horizontal_6_sse2(unsigned char *s, int p,
  ...
  aom_lpf_internal_6_sse2(&p2, &q2, &p1, &q1, &p0, &q0, &q1q0, &p1p0, _blimit,
                          _limit, _thresh);
...
void aom_lpf_vertical_6_sse2(unsigned char *s, int p,
  ...
  // Loop filtering
  aom_lpf_internal_6_sse2(&d0d1, &d5, &d1, &d4d5, &d2d3, &d3, &q1q0, &p1p0,
                          blimit, limit, thresh);
