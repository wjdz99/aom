...
; PROCESS_4x2x4 first, off_{first,second}_{src,ref},
;               {first, second}_extraline, line_ending
%macro PROCESS_4x2x4 8
  HANDLE_FIRST_OFFSET   %6, %2
  movd                  m0, [srcq + first_offset]
  HANDLE_SECOND_OFFSET  %6, %7, %4
%if %1 == 1
  movd                  m6, [ref1q+%3]
  movd                  m4, [ref2q+%3]
  movd                  m7, [ref3q+%3]
...
%endif
%if %8 > 0
  ADVANCE_END_OF_LINE %8
%endif
%endmacro

; PROCESS_8x2x4 first, off_{first,second}_{src,ref},
;               {first,second}_extraline, line_ending
...
; PROCESS_16x2x4 first, off_{first,second}_{src,ref},
;                {first,second}_extraline, line_ending
...
; PROCESS_32x2x4 first, off_{first,second}_{src,ref},
;                {first,second}_extraline, line_ending
%macro PROCESS_32x2x4 8
  PROCESS_16x2x4 %1, %2, %3, %2 + 16, %3 + 16, %6, %6, %7 - %6
  PROCESS_16x2x4  0, %4, %5, %4 + 16, %5 + 16, %7, %7, %8
%endmacro

; PROCESS_64x2x4 first, off_{first,second}_{src,ref},
;                {first,second}_extraline, line_ending
%macro PROCESS_64x2x4 8
  PROCESS_32x2x4 %1, %2, %3, %2 + 32, %3 + 32, %6, %6, %7 - %6
  PROCESS_32x2x4  0, %4, %5, %4 + 32, %5 + 32, %7, %7, %8
%endmacro

; PROCESS_128x2x4 first, off_{first,second}_{src,ref},
;                 {first,second}_extraline, line_ending
%macro PROCESS_128x2x4 8
  PROCESS_64x2x4 %1, %2, %3, %2 + 64, %3 + 64, %6, %6, %7 - %6
  PROCESS_64x2x4  0, %4, %5, %4 + 64, %5 + 64, %7, %7, %8
%endmacro
...
%endif
  ...
  PROCESS_%1x2x4 1, 0, 0, 0, ref_strideq, 0, 1, 2
...
%endif
%rep num_rep
  PROCESS_%1x2x4 0, 0, 0, 0, ref_strideq, 0, 1, 2
%endrep
%undef num_rep
  PROCESS_%1x2x4 0, 0, 0, 0, ref_strideq, 0, 1, 2
