...
void aom_jnt_comp_avg_pred_ssse3(uint8_t *comp_pred, const uint8_t *pred,
  ...
  // FIXME(chengchen): implementation:
  // C function at: aom_dsp/variance.c: aom_jnt_comp_avg_pred_c();
  int i;
...
void aom_jnt_comp_avg_upsampled_pred_ssse3(uint8_t *comp_pred,
                                           ...
                                           const JNT_COMP_PARAMS *jcp_param) {
  // FIXME(chengchen): implementation:
  // C function at: aom_dsp/variance.c: aom_jnt_comp_avg_upsampled_pred_c();
  int n;
  int i;
