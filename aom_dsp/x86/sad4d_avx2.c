...
void aom_sad16xNx4d_avx2(int N, const uint8_t *src, int src_stride,
                         const uint8_t *ref[8], int ref_stride,
                         uint32_t res[8]) {
  __m256i src_reg, ref0_reg, ref1_reg, ref2_reg, ref3_reg;
  __m256i sum_ref0, sum_ref1, sum_ref2, sum_ref3;
  __m128i srctmp0;
  __m256i ldtmp1, ldtmp2, ldtmp3, ldtmp0;
  int i, j;
  ...
  for (i = 0; i < N; i++) {
    ...
    srctmp0 = _mm_loadu_si128((const __m128i *)src);
    src_reg = _mm256_broadcastsi128_si256(srctmp0);  // src,src

    ref0_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref[0]));
    ref1_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref[1]));
    ref2_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref[2]));
    ref3_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref[3]));
  ...
  }
  {
    ...
    _mm_storeu_si128((__m128i *)(res), _mm256_castsi256_si128(sum_mlow));
  }
}
