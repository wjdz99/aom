...
void aom_sad16xNx4d_avx2(int N, const uint8_t *src, int src_stride,
  ...
  for (i = 0; i < N; i++) {
    ...
    src_reg = _mm256_castsi128_si256(_mm_load_si128((const __m128i *)src));
    ref0_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref0));
    ref1_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref1));
    ref2_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref2));
    ref3_reg = _mm256_castsi128_si256(_mm_loadu_si128((const __m128i *)ref3));
