...
void aom_highbd_lpf_horizontal_8_sse4(uint16_t *s, int p,
                                      const uint8_t *_blimit,
                                      const uint8_t *_limit,
                                      const uint8_t *_thresh, int bd) {
  const __m128i zero = _mm_setzero_si128();
...
void aom_highbd_lpf_horizontal_8_dual_sse2(
  ...
  aom_highbd_lpf_horizontal_8_sse4(s, p, _blimit0, _limit0, _thresh0, bd);
  aom_highbd_lpf_horizontal_8_sse4(s + 4, p, _blimit1, _limit1, _thresh1, bd);
}

void aom_highbd_lpf_horizontal_4_sse4(uint16_t *s, int p,
                                      const uint8_t *_blimit,
                                      const uint8_t *_limit,
                                      const uint8_t *_thresh, int bd) {
...
void aom_highbd_lpf_horizontal_4_dual_sse2(
    ...
    const uint8_t *_thresh0, const uint8_t *_blimit1, const uint8_t *_limit1,
    const uint8_t *_thresh1, int bd) {
  aom_highbd_lpf_horizontal_4_sse4(s, p, _blimit0, _limit0, _thresh0, bd);
  aom_highbd_lpf_horizontal_4_sse4(s + 4, p, _blimit1, _limit1, _thresh1, bd);
}
...
void aom_highbd_lpf_vertical_4_sse2(uint16_t *s, int p, const uint8_t *blimit,
  ...
  // Loop filtering
  aom_highbd_lpf_horizontal_4_sse4(t_dst + 4 * 8, 8, blimit, limit, thresh, bd);
...
void aom_highbd_lpf_vertical_8_sse2(uint16_t *s, int p, const uint8_t *blimit,
  ...
  // Loop filtering
  aom_highbd_lpf_horizontal_8_sse4(t_dst + 4 * 8, 8, blimit, limit, thresh, bd);
