...
static INLINE void convolve_lowbd_tmp(const __m256i *const s,
                                      ...
                                      __m256i *result) {
  DECLARE_ALIGNED(32, static const uint16_t, center_offset[16]) = {
    0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128, 0, 128
  };
  __m256i ctr_ofst = _mm256_load_si256((__m256i const *)center_offset);
  ...
  coeff[2] = _mm256_adds_epi16(coeff[2], ctr_ofst);
  coeff[3] = _mm256_adds_epi16(coeff[3], ctr_ofst);
