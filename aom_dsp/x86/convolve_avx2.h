...
static INLINE void convolve_lowbd_tmp(const __m256i *const s,
  ...
  ress[0] = _mm256_madd_epi16(ss[0], coeffs[0]);
  ress[1] = _mm256_madd_epi16(ss[1], coeffs[0]);
  ress[2] = _mm256_madd_epi16(ss[2], coeffs[1]);
  ress[3] = _mm256_madd_epi16(ss[3], coeffs[1]);
  ress[4] = _mm256_madd_epi16(ss[4], coeffs[2]);
  ress[5] = _mm256_madd_epi16(ss[5], coeffs[2]);
  ress[6] = _mm256_madd_epi16(ss[6], coeffs[3]);
  ress[7] = _mm256_madd_epi16(ss[7], coeffs[3]);
