...
// TODO(any): These variance functions are macro-fied so we don't have to
// manually optimize the individual for-loops. We could save some binary size by
// optimizing the loops more carefully without duplicating the codes with a
// macro.
