...
static void sad32x4(const uint16_t *src_ptr, int src_stride,
  ...
  while (row_sections < 2) {
    ...
    if (sec_ptr) {
      ...
      r1 = _mm256_avg_epu16(r1, _mm256_loadu_si256((const __m256i *)(sec_ptr + 16)));
      r2 = _mm256_avg_epu16(r2, _mm256_loadu_si256((const __m256i *)(sec_ptr + 32)));
      r3 = _mm256_avg_epu16(r3, _mm256_loadu_si256((const __m256i *)(sec_ptr + 48)));
    }
...
static void sad64x2(const uint16_t *src_ptr, int src_stride, const uint16_t *ref_ptr,
                        int ref_stride, const uint16_t *sec_ptr,
                        __m256i *sad_acc) {
  __m256i s[8], r[8];
  const __m256i zero = _mm256_setzero_si256();
  ...
  if (sec_ptr) {
    ...
    r[1] = _mm256_avg_epu16(r[1],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 16)));
    r[2] = _mm256_avg_epu16(r[2],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 32)));
    r[3] = _mm256_avg_epu16(r[3],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 48)));
    r[4] = _mm256_avg_epu16(r[4],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 64)));
    r[5] = _mm256_avg_epu16(r[5],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 80)));
    r[6] = _mm256_avg_epu16(r[6],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 96)));
    r[7] = _mm256_avg_epu16(r[7],
                            _mm256_loadu_si256((const __m256i *)(sec_ptr + 112)));
  }
