...
INLINE void highbd_sad16x4_core_avx2(__m256i *s, __m256i *r, __m256i *sad_acc) {
...
AOM_FORCE_INLINE void aom_highbd_sad16xNx4d_avx2(
  ...
  get_4d_sad_from_mm256_epi32(sad_vec, err, sad_array);
}

AOM_FORCE_INLINE void aom_highbd_sad32xNx4d_avx2(
    int N, const uint8_t *src, int src_stride, const uint8_t *ref_array[],
    int ref_stride, uint32_t *sad_array, uint32_t *err) {
  __m256i sad_vec[4];
  const uint16_t *refp[4];
...
AOM_FORCE_INLINE void aom_highbd_sad64xNx4d_avx2(
    int N, const uint8_t *src, int src_stride, const uint8_t *ref_array[],
    int ref_stride, uint32_t *sad_array, uint32_t *err) {
  __m256i sad_vec[4];
  const uint16_t *refp[4];
