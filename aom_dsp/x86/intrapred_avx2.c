...
void av1_highbd_dr_prediction_z1_c(uint16_t *dst, ptrdiff_t stride,
...
void predict_64x64_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[129];
  int_least32_t leftByDiff[129];
  __m256i a0, a1, diff, a32, a16;
  int c, x, y, base;
...
void predict_64x32_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[129];
  int_least32_t leftByDiff[129];
  __m256i a0, a1, diff, a32, a16;
...
void predict_64x16_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[129];
  int_least32_t leftByDiff[129];
  __m256i a0, a1, diff, a32, a16;
...
void predict_32x64_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[65];
  int_least32_t leftByDiff[65];
  __m256i a0, a1, diff, a32, a16;
  int c, x, y, base;
  const uint16_t *leftPtr = refPel - 1;
  const int frac_bits = 6 - upsample;
...
void predict_32x32_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[65];
  int_least32_t leftByDiff[65];
  __m256i a0, a1, diff, a32, a16;
...
void predict_32x16_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[65];
  int_least32_t leftByDiff[65];
  __m256i a0, a1, diff, a32, a16;
...
void predict_32x8_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                       int d, int upsample) {
  uint32_t leftBy32[65];
  int_least32_t leftByDiff[65];
  __m256i a0, a1, diff, a32, a16;
...
void predict_16x16_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[33];
  int_least32_t leftByDiff[33];
  __m256i a0, a1, diff, a32, a16;
  int c, x, y, base;
  const uint16_t *leftPtr = refPel - 1;
  const int frac_bits = 6 - upsample;
...
void predict_16x64_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[33];
  int_least32_t leftByDiff[33];
  __m256i a0, a1, diff, a32, a16;
...
void predict_16x32_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                        int d, int upsample) {
  uint32_t leftBy32[33];
  int_least32_t leftByDiff[33];
  __m256i a0, a1, diff, a32, a16;
...
void predict_16x8_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                       int d, int upsample) {
  uint32_t leftBy32[33];
  int_least32_t leftByDiff[33];
  __m256i a0, a1, diff, a32, a16;
...
void predict_16x4_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                       int d, int upsample) {
  uint32_t leftBy32[33];
  int_least32_t leftByDiff[33];
  __m256i a0, a1, diff, a32, a16;
...
void predict_8x32_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                       int d, int upsample) {
  __m256i a0, a1, diff, a32, a16;
  __m256i a, b, res1, res2, resLo;
  int c, x, y, base;
  ...
  uint32_t leftBy32[17];
  int_least32_t leftByDiff[17];
...
void predict_8x16_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                       int d, int upsample) {
  __m256i a0, a1, diff, a32, a16;
  __m256i a, b, res1, res2, resLo;
  int c, x, y, base;
...
void predict_8x8_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                      int d, int upsample) {
  __m256i a0, a1, diff, a32, a16;
  __m256i a, b, res1, res2, resLo;
  int c, x, y, base;
...
void predict_8x4_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                      int d, int upsample) {
  __m256i a0, a1, diff, a32, a16;
  __m256i a, b, res1, res2, resLo;
  int c, x, y, base;
...
void predict_4x4_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                      int d, int upsample) {
  int c, x, y, base;
  const uint16_t *leftPtr = refPel - 1;
  const int frac_bits = 6 - upsample;
...
void predict_4x8_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                      int d, int upsample) {
  int c, x, y, base;
  const uint16_t *leftPtr = refPel - 1;
  const int frac_bits = 6 - upsample;
...
void predict_4x16_avx2(const uint16_t *refPel, uint16_t *dst, ptrdiff_t pitch,
                       int d, int upsample) {
  uint32_t leftBy32[9];
  int_least32_t leftByDiff[9];
  __m128i a0, a1, diff, a32, a16;
...
void av1_highbd_dr_prediction_z2_4x4_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_4x4_avx2(above, dst, stride, dx, upsample_above);
  predict_4x4_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_8x8_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_8x8_avx2(above, dst, stride, dx, upsample_above);
  predict_8x8_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_4x8_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_4x8_avx2(above, dst, stride, dx, upsample_above);
  predict_8x4_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_8x4_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_8x4_avx2(above, dst, stride, dx, upsample_above);
  predict_4x8_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_8x16_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_8x16_avx2(above, dst, stride, dx, upsample_above);
  predict_16x8_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_4x16_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_4x16_avx2(above, dst, stride, dx, upsample_above);
  predict_16x4_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_16x4_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_16x4_avx2(above, dst, stride, dx, upsample_above);
  predict_4x16_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_16x8_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_16x8_avx2(above, dst, stride, dx, upsample_above);
  predict_8x16_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_8x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_8x32_avx2(above, dst, stride, dx, upsample_above);
  predict_32x8_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_32x8_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_32x8_avx2(above, dst, stride, dx, upsample_above);
  predict_8x32_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_16x16_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_16x16_avx2(above, dst, stride, dx, upsample_above);
  predict_16x16_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_32x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_32x32_avx2(above, dst, stride, dx, upsample_above);
  predict_32x32_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_64x64_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_64x64_avx2(above, dst, stride, dx, upsample_above);
  predict_64x64_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_16x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_16x32_avx2(above, dst, stride, dx, upsample_above);
  predict_32x16_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_32x16_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_32x16_avx2(above, dst, stride, dx, upsample_above);
  predict_16x32_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_32x64_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_32x64_avx2(above, dst, stride, dx, upsample_above);
  predict_64x32_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_64x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_64x32_avx2(above, dst, stride, dx, upsample_above);
  predict_32x64_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_16x64_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_16x64_avx2(above, dst, stride, dx, upsample_above);
  predict_64x16_avx2(left, dstTmp, strideTmp, dy, upsample_left);
...
void av1_highbd_dr_prediction_z2_64x16_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  predict_64x16_avx2(above, dst, stride, dx, upsample_above);
  predict_16x64_avx2(left, dstTmp, strideTmp, dy, upsample_left);
