...
static AOM_FORCE_INLINE void highbd_lpf_internal_14_sse2(
 ...
 if (0xffff != _mm_movemask_epi8(_mm_cmpeq_epi16(flat, zero)))
  ...
  work0_1 = _mm_add_epi16(
      sum_p6, _mm_add_epi16(pq[1], _mm_add_epi16(pq[2], pq[0])));
  ...
  flat_pq[2] = _mm_srli_epi16(_mm_unpacklo_epi64(flat_p[2], flat_q[2]), 3);
  	...
  	int flat2_mask = (0xffff != _mm_movemask_epi8(_mm_cmpeq_epi16(flat2, zero)));
  if (flat2_mask)
	{
    ...
    work0 = _mm_add_epi16(
        sum_p6, _mm_add_epi16(pq[2], _mm_add_epi16(pq[3], pq[1])));
    ...
    work0 = _mm_add_epi16(
        sum_p6, _mm_add_epi16(pq[3], _mm_add_epi16(pq[4], pq[2])));
    ...
    work0 = _mm_add_epi16(
        sum_p6, _mm_add_epi16(pq[4], _mm_add_epi16(pq[5], pq[3])));
    ...
    work0 = _mm_add_epi16(
        sum_p6, _mm_add_epi16(pq[5], _mm_add_epi16(pq[6], pq[4])));
