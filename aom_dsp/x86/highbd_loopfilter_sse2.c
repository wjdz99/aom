...
void aom_highbd_lpf_horizontal_4_dual_sse2(
  ...
  highbd_lpf_internal_4_dual_sse2(&p1, &p0, &q0, &q1, _blimit0, _limit0,
...
void aom_highbd_lpf_vertical_4_sse2(uint16_t *s, int p, const uint8_t *blimit,
  ...
  highbd_transpose4x8_8x4_sse2(&x0, &x1, &x2, &x3, &d0, &d1, 
                           &d2, &d3, &d4, &d5, &d6, &d7);
...
void aom_highbd_lpf_vertical_4_dual_sse2(
  ...
  highbd_lpf_internal_4_dual_sse2(&d2, &d3, &d4, &d5, blimit0, limit0, thresh0,
...
void aom_highbd_lpf_vertical_8_sse2(uint16_t *s, int p, const uint8_t *blimit,
  ...
  highbd_transpose4x8_8x4_sse2(&p3, &p2, &p1, &p0, &d0, &d1,
                           &d2, &d3, &d4, &d5, &d6, &d7);
...
void aom_highbd_lpf_vertical_14_sse2(uint16_t *s, int pitch,
  ...
  highbd_transpose4x8_8x4_sse2(&p6, &p5, &p4, &p3, &d0,
                               &p[6],
  ...
  highbd_transpose4x8_8x4_sse2(&p6_2, &p5_2, &p4_2, &p3_2, 
