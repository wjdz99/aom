...
void aom_highbd_lpf_horizontal_6_dual_sse2(
  ...
  q2 = _mm_loadu_si128((__m128i *)(s + 2 * p));
    ...
    highbd_lpf_internal_6_dual_sse2(&p2, &p1, &p0, &q0, &q1, &q2,
                             _blimit0, _limit0, _thresh0, _blimit1, _limit1, _thresh1, bd);
...
void aom_highbd_lpf_vertical_6_dual_sse2(
 ...
 __m128i p0, q0, p1, q1, p2, q2;
  ...
  highbd_transpose8x8_sse2(&x0, &x1, &x2, &x3, &x4, &x5, &x6, &x7, 
                           &p2, &p1, &p0, &q0, &q1, &q2, &d6, &d7);

  highbd_lpf_internal_6_dual_sse2(&p2, &p1, &p0, &q0, &q1, &q2, _blimit0, _limit0,
                                  _thresh0, _blimit1, _limit1, _thresh1, bd);

  highbd_transpose4x8_8x4_sse2(&p1, &p0, &q0, &q1, &d0, &d1, &d2, &d3, &d4,
                                   &d5, &d6, &d7);
