...
static INLINE void get_limit_dual(const uint8_t * _blimit0, const uint8_t * _limit0,
	const uint8_t * _thresh0, const uint8_t * _blimit1, const uint8_t * _limit1,
	const uint8_t * _thresh1, int bd, __m128i *blt_out,
	__m128i *lt_out, __m128i *thr_out, __m128i *t80_out) {

	const int shift = bd - 8;
	const __m128i zero = _mm_setzero_si128();

	__m128i x0 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit0), zero);
	__m128i x1 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit1), zero);
...
static INLINE void highbd_filter4_dual_sse2(__m128i *p, __m128i *q,
                                            ...
                                            __m128i *ps, __m128i *qs, __m128i *t80) {
...
static AOM_FORCE_INLINE void highbd_lpf_internal_14_dual_sse2(
  ...
  flat2 = _mm_and_si128(flat2, flat);
  __m128i ps[2], qs[2];
  highbd_filter4_dual_sse2(p, q, &mask, &thresh, bd, ps, qs, &t80);
  // flat and wide flat calculations
...
static AOM_FORCE_INLINE void highbd_lpf_internal_8_dual_sse2(
	__m128i *p3, __m128i *q3, __m128i *p2, __m128i *q2, __m128i *p1,
	__m128i *q1, __m128i *p0, __m128i *q0, 
	const unsigned char *_blimit0, const unsigned char *_limit0,
	const unsigned char *_thresh0, const unsigned char *_blimit1, const unsigned char *_limit1,
	...
	get_limit_dual(_blimit0, _limit0, _thresh0, _blimit1, _limit1, _thresh1, bd, &blimit0,
		&limit0, &thresh0, &t80);
	...
	work1 = _mm_max_epi16(abs_diff16(*p1, *p0),abs_diff16(*q1, *q0));//tbu 4 flat
	...
	__m128i ps[2], qs[2], p[2], q[2];
	{
			...
			q[0] = *q0; q[1] = *q1;
		// filter_mask and hev_mask
		highbd_filter4_dual_sse2(p, q, &mask, &thresh0, bd, ps, qs, &t80);
	}
...
void aom_highbd_lpf_horizontal_8_dual_sse2(
	...
	highbd_lpf_internal_8_dual_sse2(&p3, &q3, &p2, &q2, &p1, &q1, &p0, &q0, _blimit0, _limit0, _thresh0, _blimit1, _limit1, _thresh1, bd);
...
static AOM_FORCE_INLINE void highbd_lpf_internal_4_sse2(
    __m128i *p1, __m128i *p0, __m128i *q0, __m128i *q1, const uint8_t *_blimit,
    const uint8_t *_limit, const uint8_t *_thresh, int bd) {
  __m128i blimit, limit, thresh;
  __m128i mask, hev, flat;
  ...
  get_limit(_blimit, _limit, _thresh, bd, &blimit, &limit, &thresh, &t80);
  tff80 = _mm_slli_epi16(_mm_set1_epi16(0xff80),(bd-8));
  tffe0 = _mm_slli_epi16(_mm_set1_epi16(0xffe0),(bd-8));
  t1f = _mm_srli_epi16(_mm_set1_epi16(0x1fff), (16-bd));
  t7f = _mm_srli_epi16(_mm_set1_epi16(0x7fff), (16-bd));
...
static AOM_FORCE_INLINE void highbd_lpf_internal_4_dual_sse2(
	__m128i *p1, __m128i *p0, __m128i *q0, __m128i *q1, const uint8_t *_blimit0,
	const uint8_t *_limit0, const uint8_t *_thresh0, const uint8_t *_blimit1,
	const uint8_t *_limit1, const uint8_t *_thresh1, int bd) {
	__m128i blimit0, limit0, thresh0;
	__m128i blimit1, limit1, thresh1;
	__m128i mask, hev, flat;
	...
	if (bd == 8) {
		blimit0 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit0), zero);
		blimit1 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit1), zero);
		limit0 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_limit0), zero);
		limit1 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_limit1), zero);
		thresh0 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_thresh0), zero);
		thresh1 = _mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_thresh1), zero);
		...
		blimit0 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit0), zero), 2);
		blimit1 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit1), zero), 2);
		limit0 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_limit0), zero), 2);
		limit1 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_limit1), zero), 2);
		thresh0 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_thresh0), zero), 2);
		thresh1 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_thresh1), zero), 2);
		...
		blimit0 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit0), zero), 4);
		blimit1 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_blimit1), zero), 4);
		limit0 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_limit0), zero), 4);
		limit1 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_limit1), zero), 4);
		thresh0 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_thresh0), zero), 4);
		thresh1 = _mm_slli_epi16(
			_mm_unpacklo_epi8(_mm_load_si128((const __m128i *)_thresh1), zero), 4);
	...
	blimit0 = _mm_unpacklo_epi64(blimit0, blimit1);
	limit0 = _mm_unpacklo_epi64(limit0, limit1);
	thresh0 = _mm_unpacklo_epi64(thresh0, thresh1);
	...
	// filter_mask and hev_mask
	flat = _mm_max_epi16(abs_p1p0, abs_q1q0);
	hev = _mm_subs_epu16(flat, thresh0);
	hev = _mm_xor_si128(_mm_cmpeq_epi16(hev, zero), ffff);
...
void aom_highbd_lpf_horizontal_4_dual_sse2(
  ...
  highbd_lpf_internal_4_dual_sse2(&p1, &p0, &q0, &q1, _blimit0, _limit0, _thresh0, _blimit1, _limit1, _thresh1, bd);
...
void aom_highbd_lpf_vertical_4_sse2(uint16_t *s, int p, const uint8_t *blimit,
                                    ...
                                    int bd) {
  __m128i x0, x1, x2, x3, x4, x5, x6, x7, d0, d1, d2, d3, d4, d5, d6, d7;
  ...
  highbd_lpf_internal_4_sse2(&d2, &d3, &d4, &d5, blimit, limit, thresh, bd);

  // transpose from 8x4 to 4x8
  highbd_transpose8x8_low_sse2(&d0, &d1, &d2, &d3, &d4, &d5, &d6, &d7, &d0, &d1,
                               &d2, &d3);
...
void aom_highbd_lpf_vertical_4_dual_sse2(
  ...
  highbd_lpf_internal_4_dual_sse2(&d2, &d3, &d4, &d5, blimit0, limit0, thresh0, blimit1, limit1,
                             thresh1, bd);
...
void aom_highbd_lpf_vertical_8_dual_sse2(
  ...
  highbd_lpf_internal_8_dual_sse2(&d0, &d7, &d1, &d6, &d2, &d5, &d3, &d4,
                             blimit0, limit0, thresh0, blimit1, limit1, thresh1, bd);

  highbd_transpose8x8_sse2(&d0, &d1, &d2, &d3, &d4, &d5, &d6,
