...
static INLINE void highbd_filter4_dual_sse2(__m128i *p, __m128i *q, __m128i *ps, __m128i *qs,
                                            const __m128i *mask,
...
static AOM_FORCE_INLINE void highbd_lpf_internal_4_sse2(
    __m128i *p1, __m128i *p0, __m128i *q0, __m128i *q1, __m128i *q1q0_out, __m128i *p1p0_out,
     const uint8_t *_blimit,
    const uint8_t *_limit, const uint8_t *_thresh, int bd) {
  __m128i blimit, limit, thresh;
  __m128i mask, hev, flat;
  ...
  highbd_filter4_sse2(&p1p0, &q1q0, &hev, &mask, q1q0_out, p1p0_out,
                      &t80, bd);
...
void aom_highbd_lpf_horizontal_4_dual_sse2(
  ...
  __m128i ps[2], qs[2];
  highbd_lpf_internal_4_dual_sse2(&p1, &p0, &q0, &q1, ps,
                                  qs,
                                  _blimit0, _limit0,
...
void aom_highbd_lpf_vertical_4_sse2(uint16_t *s, int p, const uint8_t *blimit,
  ...
  highbd_transpose8x8_low_sse2(&d0, &d1, &p1, &p1p0, &q1q0, &q1, &d6, &d7, &d0, &d1,
                               &d2, &d3);
...
void aom_highbd_lpf_vertical_4_dual_sse2(
  ...
  highbd_lpf_internal_4_dual_sse2(&d2, &d3, &d4, &d5, ps, qs, blimit0, limit0, thresh0,
                                  blimit1, limit1, thresh1, bd);

  highbd_transpose8x8_sse2(&d0, &d1, &ps[1], &ps[0], &qs[0], &qs[1], &d6, &d7, &x0, &x1,
                           &x2, &x3, &x4, &x5, &x6, &x7);
