  ...
  switch (output_width) {
    case 8:
      for (i = 0; i < output_height; i += 2) {
        __m128i src00 = _mm_loadu_si128(src_ptr);
        src_ptr += pixel_step;
        __m128i src01 = _mm_loadu_si128(src_ptr);
        src_ptr += 8 - pixel_step;
        src_ptr += src_pixels_per_line - output_width;

        __m128i src02 = _mm_loadu_si128(src_ptr);
        src_ptr += pixel_step;
        __m128i src03 = _mm_loadu_si128(src_ptr);
        src_ptr += 8 - pixel_step;
        src_ptr += src_pixels_per_line - output_width;
        ...
        _mm256_storeu_si256((long long int *)output_ptr, opointer);
        output_ptr += 16;
      }
      break;
    case 16:
      for (i = 0; i < output_height; ++i) {
        __m256i src1 = _mm256_loadu_si256(src_ptr);
        src_ptr += pixel_step;
        __m256i src2 = _mm256_loadu_si256(src_ptr);
