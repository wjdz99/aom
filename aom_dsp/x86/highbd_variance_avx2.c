  ...
  switch (output_width) {
    case 8:
      for (i = 0; i < output_height; i += 2) {
        __m128i src00 = _mm_loadu_si128((const __m128 *)src_ptr);
        src_ptr += pixel_step;
        __m128i src01 = _mm_loadu_si128((const __m128 *)src_ptr);
        src_ptr += 8 - pixel_step;
        src_ptr += src_pixels_per_line - output_width;

        __m128i src02 = _mm_loadu_si128((const __m128 *)src_ptr);
        src_ptr += pixel_step;
        __m128i src03 = _mm_loadu_si128((const __m128 *)src_ptr);
        src_ptr += 8 - pixel_step;
        src_ptr += src_pixels_per_line - output_width;

        j = 0;
        __m256i src = _mm256_insertf128_si256(filter1, src00, j);
        j = 1;
        __m256i src1 = _mm256_insertf128_si256(src, src02, j);

        j = 0;
        src = _mm256_insertf128_si256(filter1, src01, j);
        j = 1;
        __m256i src2 = _mm256_insertf128_si256(src, src03, j);
        ...
        _mm256_storeu_si256(output_ptr, opointer);
        output_ptr += 16;
      }
      break;
    case 16:
      for (i = 0; i < output_height; ++i) {
        __m256i src1 = _mm256_loadu_si256((const __m256i *)src_ptr);
        src_ptr += pixel_step;
        __m256i src2 = _mm256_loadu_si256((const __m256i *)src_ptr);
