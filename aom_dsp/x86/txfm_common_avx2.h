...
static AOM_FORCE_INLINE __m256i pair_set_w16_epi16(int16_t a, int16_t b) {
  return _mm256_set1_epi32(
      (int32_t)(((uint16_t)(a)) | (((uint32_t)(b)) << 16)));
}

static AOM_FORCE_INLINE void btf_16_w16_avx2(const __m256i w0, const __m256i w1,
...
static AOM_FORCE_INLINE void btf_16_adds_subs_avx2(__m256i *in0, __m256i *in1) {
...
static AOM_FORCE_INLINE void btf_32_add_sub_avx2(__m256i *in0, __m256i *in1) {
  const __m256i _in0 = *in0;
  const __m256i _in1 = *in1;
...
static AOM_FORCE_INLINE void btf_16_adds_subs_out_avx2(__m256i *out0,
                                                       __m256i *out1,
                                                       __m256i in0,
                                                       __m256i in1) {
  const __m256i _in0 = in0;
...
static AOM_FORCE_INLINE void btf_32_add_sub_out_avx2(__m256i *out0,
                                                     __m256i *out1, __m256i in0,
                                                     __m256i in1) {
  const __m256i _in0 = in0;
  const __m256i _in1 = in1;
...
static AOM_FORCE_INLINE __m256i load_16bit_to_16bit_avx2(const int16_t *a) {
  return _mm256_load_si256((const __m256i *)a);
}

static AOM_FORCE_INLINE void load_buffer_16bit_to_16bit_avx2(const int16_t *in,
                                                             int stride,
                                                             __m256i *out,
                                                             int out_size) {
...
static AOM_FORCE_INLINE void load_buffer_16bit_to_16bit_flip_avx2(
    const int16_t *in, int stride, __m256i *out, int out_size) {
  for (int i = 0; i < out_size; ++i) {
    out[out_size - i - 1] = load_16bit_to_16bit_avx2(in + i * stride);
  }
}

static AOM_FORCE_INLINE __m256i load_32bit_to_16bit_w16_avx2(const int32_t *a) {
...
static AOM_FORCE_INLINE void load_buffer_32bit_to_16bit_w16_avx2(
    const int32_t *in, int stride, __m256i *out, int out_size) {
  for (int i = 0; i < out_size; ++i) {
...
static AOM_FORCE_INLINE void flip_buf_avx2(__m256i *in, __m256i *out,
                                           int size) {
...
static AOM_FORCE_INLINE void round_shift_16bit_w16_avx2(__m256i *in, int size,
                                                        int bit) {
  if (bit < 0) {
