...
void aom_hadamard_32x32_avx2(const int16_t *src_diff, ptrdiff_t src_stride,
  ...
  for (idx = 0; idx < 256; idx += 16) {
    ...
    __m256i coeff01_and = _mm256_and_si256(coeff0, coeff1);
    __m256i coeff01_xor =
        _mm256_srai_epi16(_mm256_xor_si256(coeff0, coeff1), 1);
    b0 = _mm256_srai_epi16(_mm256_add_epi16(coeff01_and, coeff01_xor), 1);

    coeff1 = _mm256_sign_epi16(coeff1, _mm256_set1_epi16(-1));
    coeff01_and = _mm256_and_si256(coeff0, coeff1);
    coeff01_xor = _mm256_srai_epi16(_mm256_xor_si256(coeff0, coeff1), 1);
    b1 = _mm256_srai_epi16(_mm256_add_epi16(coeff01_and, coeff01_xor), 1);

    __m256i coeff23_and = _mm256_and_si256(coeff2, coeff3);
    __m256i coeff23_xor =
        _mm256_srai_epi16(_mm256_xor_si256(coeff2, coeff3), 1);
    b2 = _mm256_srai_epi16(_mm256_add_epi16(coeff23_and, coeff23_xor), 1);

    coeff3 = _mm256_sign_epi16(coeff3, _mm256_set1_epi16(-1));
    coeff23_and = _mm256_and_si256(coeff2, coeff3);
    coeff23_xor = _mm256_srai_epi16(_mm256_xor_si256(coeff2, coeff3), 1);
    b3 = _mm256_srai_epi16(_mm256_add_epi16(coeff23_and, coeff23_xor), 1);
