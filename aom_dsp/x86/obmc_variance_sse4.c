...
#define OBMC_SUBPIX_VAR(W, H)                                         \
  uint32_t aom_obmc_sub_pixel_variance##W##x##H##_sse4_1(const uint8_t *pre, int pre_stride, int xoffset, int yoffset, const int32_t *wsrc, const int32_t *mask, unsigned int *sse) {    \
