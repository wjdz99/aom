...
AOM_VAR_NO_LOOP_SSE2(4, 32, 7, 128);
AOM_VAR_NO_LOOP_SSE2(4, 64, 8, 256);
AOM_VAR_NO_LOOP_SSE2(8, 64, 9, 512);
AOM_VAR_NO_LOOP_SSE2(32, 4, 7, 128);
AOM_VAR_NO_LOOP_SSE2(64, 4, 8, 256);
AOM_VAR_NO_LOOP_SSE2(64, 8, 9, 512);
...
#define FNS(opt)                                     \
  ...
  FN(64, 8, 16, 6, 3, opt, (int64_t), (int64_t));    \
  FN(8, 64, 8, 3, 6, opt, (int64_t), (int64_t));     \
  FN(32, 4, 16, 5, 2, opt, (int64_t), (int64_t));    \
  FN(4, 32, 4, 2, 5, opt, (int64_t), (int64_t));     \
  FN(64, 4, 16, 6, 2, opt, (int64_t), (int64_t));    \
  FN(4, 64, 4, 2, 6, opt, (int64_t), (int64_t))
#else
#define FNS(opt)                                     \
  FN(128, 128, 16, 7, 7, opt, (int64_t), (int64_t)); \
  FN(128, 64, 16, 7, 6, opt, (int64_t), (int64_t));  \
