...
static INLINE void obmc_variance_w8n(const uint8_t *pre, const int pre_stride,
  ...
  do {
    ...
    do {
      ...
      const __m256i v_m_d = _mm256_load_si256((__m256i const *)(mask + n));
      const __m256i v_w_d = _mm256_load_si256((__m256i const *)(wsrc + n));
...
static INLINE void obmc_variance_w16n(const uint8_t *pre, const int pre_stride,
  ...
  do {
    ...
    do {
      ...
      const __m256i v_m0_d = _mm256_load_si256((__m256i const *)(mask + n));
      const __m256i v_w0_d = _mm256_load_si256((__m256i const *)(wsrc + n));
      const __m256i v_m1_d = _mm256_load_si256((__m256i const *)(mask + n + 8));
      const __m256i v_w1_d = _mm256_load_si256((__m256i const *)(wsrc + n + 8));
