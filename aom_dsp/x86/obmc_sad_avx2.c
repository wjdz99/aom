...
static AOM_FORCE_INLINE unsigned int obmc_sad_w4_avx2(const uint8_t *pre,
  ...
  do {
    ...
    const __m256i v_m_d = _mm256_load_si256((__m256i *)(mask + n));
    const __m256i v_w_d = _mm256_load_si256((__m256i *)(wsrc + n));
...
static AOM_FORCE_INLINE unsigned int obmc_sad_w8n_avx2(
  ...
  do {
    ...
    const __m256i v_m0_d = _mm256_load_si256((__m256i *)(mask + n));
    const __m256i v_w0_d = _mm256_load_si256((__m256i *)(wsrc + n));
...
static AOM_FORCE_INLINE unsigned int hbd_obmc_sad_w4_avx2(const uint8_t *pre8,
                                                          const int pre_stride,
                                                          const int32_t *wsrc,
                                                          const int32_t *mask,
                                                          const int height) {
...
static AOM_FORCE_INLINE unsigned int hbd_obmc_sad_w8n_avx2(
  ...
  do {
    const __m128i v_p0_w = xx_loadu_128(pre + n);
    const __m256i v_m0_d = _mm256_load_si256((__m256i *)(mask + n));
    const __m256i v_w0_d = _mm256_load_si256((__m256i *)(wsrc + n));
