...
static INLINE unsigned int aom_masked_sad_avx2(
  ...
  if (!invert_mask) {
    switch (m) {
      case 4:
        sad = masked_sad4xh_ssse3(src, src_stride, ref, ref_stride, second_pred,
                                  m, msk, msk_stride, n);
        break;
      case 8:
        sad = masked_sad8xh_ssse3(src, src_stride, ref, ref_stride, second_pred,
                                  m, msk, msk_stride, n);
        break;
      case 16:
    ...
    switch (m) {
      case 4:
        sad = masked_sad4xh_ssse3(src, src_stride, second_pred, m, ref,
                                  ref_stride, msk, msk_stride, n);
        break;
      case 8:
        sad = masked_sad8xh_ssse3(src, src_stride, second_pred, m, ref,
                                  ref_stride, msk, msk_stride, n);
        break;
      case 16:
...
static INLINE unsigned int aom_highbd_masked_sad_avx2(
  ...
  if (!invert_mask) {
    switch (m) {
      case 4:
        sad = highbd_masked_sad4xh_ssse3(src, src_stride, ref, ref_stride,
    ...
    switch (m) {
      case 4:
        sad = highbd_masked_sad4xh_ssse3(src, src_stride, second_pred, m, ref,
                                         ref_stride, msk, msk_stride, n);
        break;
      case 8:
