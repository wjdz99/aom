...
#define AOM_SUB_PIXEL_VAR_AVX2(w, h, wf, wlog2, hlog2, cast_prod, cast)   \
  unsigned int aom_sub_pixel_variance##w##x##h##_avx2(                        \
    ...
    for (i = 0; i < (w / wf); ++i) {                                       \
      ...
      for (j = 0; j < (h / hf); ++j) {                                     \
        unsigned int sse2;                                                       \
        int se2 = aom_sub_pixel_variance##wf##xh_avx2(                        \
...
AOM_SUB_PIXEL_VAR_AVX2(128, 128, 32, 7, 7, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(128, 64, 32, 7, 6, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(64, 128, 32, 6, 7, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(64, 64, 32, 6, 6, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(64, 32, 32, 6, 5, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(32, 64, 32, 5, 6, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(32, 32, 32, 5, 5, (int64_t), (int64_t));
AOM_SUB_PIXEL_VAR_AVX2(32, 16, 32, 5, 4, (int64_t), (int64_t));

#define AOM_SUB_PIXEL_AVG_VAR_AVX2(w, h, wf, wlog2, hlog2, cast_prod, cast)   \
  unsigned int aom_sub_pixel_avg_variance##w##x##h##_avx2(                    \
    ...
    for (i = 0; i < (w / wf); ++i) {                                       \
      ...
      for (j = 0; j < (h / hf); ++j) {                                     \
        unsigned int sse2;                                                       \
        int se2 = aom_sub_pixel_avg_variance##wf##xh_avx2(src_ptr, src_stride, \
x_offset, y_offset, dst_ptr, dst_stride, sec_ptr, w, hf, &sse2);                \
        dst_ptr += hf*dst_stride;\
        src_ptr += hf*src_stride;\
        sec_ptr += hf*w;\
        se += se2;                                                             \
...
AOM_SUB_PIXEL_AVG_VAR_AVX2(128, 128, 32, 7, 7, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(128, 64, 32, 7, 6, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(64, 128, 32, 6, 7, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(64, 64, 32, 6, 6, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(64, 32, 32, 6, 5, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(32, 64, 32, 5, 6, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(32, 32, 32, 5, 5, (int64_t), (int64_t));
AOM_SUB_PIXEL_AVG_VAR_AVX2(32, 16, 32, 5, 4, (int64_t), (int64_t));
