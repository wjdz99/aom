...
static INLINE __m256i mm256_loadu2(const uint8_t *p0, const uint8_t *p1) {
  return _mm256_loadu2_m128i((const __m128i *)p0, (const __m128i *)p1);
}
...
static INLINE void comp_mask_pred_line_avx2(const __m256i s0, const __m256i s1,
  ...
  _mm256_store_si256((__m256i *)(comp_pred), roundA);
}
...
void aom_comp_mask_pred_avx2(uint8_t *comp_pred, const uint8_t *pred, int width,
  ...
  if (width == 8) {
    ...
    do {
      ...
      const __m256i aA = _mm256_load_si256((const __m256i *)(mask));
      ...
      const __m256i aB =
          _mm256_load_si256((const __m256i *)(mask + mask_stride));
