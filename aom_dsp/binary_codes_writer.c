...
void aom_write_primitive_symmetric(AomWriter *w, int16_t v,
...
void aom_write_primitive_refbilevel(AomWriter *w, uint16_t n, uint16_t p,
...
void aom_write_signed_primitive_refsubexpfin(AomWriter *w, uint16_t n,
