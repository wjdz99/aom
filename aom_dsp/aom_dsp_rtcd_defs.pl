...
if (aom_config("CONFIG_AOM_HIGHBITDEPTH") eq "yes") {
  ...
  add_proto qw/void aom_highbd_d45_predictor_2x2/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  specialize qw/aom_highbd_d45_predictor_2x2/;
