...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  if (aom_config("CONFIG_REALTIME_ONLY") ne "yes") {
    ...
    add_proto qw/double av1_compute_correlation/, "const unsigned char *frame1, int stride1, int x1, int y1, double mean1, double stddev1, const unsigned char *frame2, int stride2, int x2, int y2, double mean2, double stddev2";
    specialize qw/av1_compute_correlation sse4_1 avx2/;
