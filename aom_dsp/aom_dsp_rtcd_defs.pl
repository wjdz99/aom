...
specialize qw/aom_convolve8           ssse3 neon/;
specialize qw/aom_convolve_copy       neon dspr2 msa sse2 avx2/;
specialize qw/aom_convolve8_horiz     sse2 neon ssse3/, "$avx2_ssse3";
specialize qw/aom_convolve8_vert      sse2 neon ssse3/, "$avx2_ssse3";
