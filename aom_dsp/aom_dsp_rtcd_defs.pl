...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
	...
	add_proto qw/int64_t aom_var_2d_u8/, "const uint8_t *src, int stride, int width, int height";

	add_proto qw/int64_t aom_var_2d_u16/, "const uint8_t *src, int stride, int width, int height";
  }
