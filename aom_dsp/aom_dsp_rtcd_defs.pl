...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  add_proto qw/void aom_get8x8var_quad/, "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse, int *sum";
  specialize qw/aom_get8x8var_quad        avx2 sse2 neon/;
