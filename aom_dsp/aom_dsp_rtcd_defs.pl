...
if (aom_config("CONFIG_AV1") eq "yes") {
  ...
  add_proto qw/void aom_blend_a64_d32r4_mask/, "int32_t *dst, uint32_t dst_stride, const int32_t *src0, uint32_t src0_stride, const int32_t *src1, uint32_t src1_stride, const uint8_t *mask, uint32_t mask_stride, int h, int w, int suby, int subx";
