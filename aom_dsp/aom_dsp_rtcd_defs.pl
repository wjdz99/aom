...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_least_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_wcalic_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_isle_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_prdct_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  } else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_least_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_wcalic_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_isle_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_prdct_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  } else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_least_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_wcalic_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_isle_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_prdct_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  } else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_least_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_wcalic_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_isle_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  add_proto qw/void aom_prdct_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  } else {
...
if ((aom_config("CONFIG_TX64X64") eq "yes")) {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_least_predictor_64x64/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
    add_proto qw/void aom_wcalic_predictor_64x64/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
    add_proto qw/void aom_isle_predictor_64x64/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
    add_proto qw/void aom_prdct_predictor_64x64/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
 } else {
...
if (aom_config("CONFIG_AOM_HIGHBITDEPTH") eq "yes") {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_least_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_wcalic_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_isle_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_prdct_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
	} else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_least_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_wcalic_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_isle_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_prdct_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
	} else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_least_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_wcalic_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_isle_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_prdct_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_least_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_wcalic_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_isle_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_prdct_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((aom_config("CONFIG_TX64X64") eq "yes")) {
    ...
    if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
      ...
      add_proto qw/void aom_highbd_least_predictor_64x64/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
      add_proto qw/void aom_highbd_wcalic_predictor_64x64/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
      add_proto qw/void aom_highbd_isle_predictor_64x64/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
      add_proto qw/void aom_highbd_prdct_predictor_64x64/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
	  } else {
