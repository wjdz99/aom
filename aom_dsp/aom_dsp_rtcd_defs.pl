...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  if (aom_config("CONFIG_REALTIME_ONLY") ne "yes") {
    add_proto qw/double av1_compute_cross_correlation/, "const unsigned char *frm1, int stride1, int x1, int y1, const unsigned char *frm2, int stride2, int x2, int y2";
