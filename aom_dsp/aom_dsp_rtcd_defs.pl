...
if (aom_config("CONFIG_CDEF") eq "yes") {
  ...
  add_proto qw/void aom_clpf_block/, "const uint16_t *src, uint8_t *dst, int sstride, int dstride, int x0, int y0, int sizex, int sizey, unsigned int strength, unsigned int bd";
  add_proto qw/void aom_clpf_hblock/, "const uint16_t *src, uint8_t *dst, int sstride, int dstride, int x0, int y0, int sizex, int sizey, unsigned int strength, unsigned int bd";
