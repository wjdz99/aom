...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_smooth_v_predictor_2x2/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";  
  add_proto qw/void aom_smooth_h_predictor_2x2/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_smooth_v_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";  
  add_proto qw/void aom_smooth_h_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_smooth_v_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";  
  add_proto qw/void aom_smooth_h_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_smooth_v_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";  
  add_proto qw/void aom_smooth_h_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_smooth_v_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";  
  add_proto qw/void aom_smooth_h_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((aom_config("CONFIG_TX64X64") eq "yes")) {
  ...
  add_proto qw/void aom_smooth_v_predictor_64x64/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";  
  add_proto qw/void aom_smooth_h_predictor_64x64/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
  } else {
...
if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
  ...
  add_proto qw/void aom_highbd_smooth_v_predictor_2x2/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  add_proto qw/void aom_highbd_smooth_h_predictor_2x2/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
} else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_smooth_v_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_smooth_h_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_smooth_v_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_smooth_h_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_smooth_v_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_smooth_h_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
    ...
    add_proto qw/void aom_highbd_smooth_v_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    add_proto qw/void aom_highbd_smooth_h_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((aom_config("CONFIG_TX64X64") eq "yes")) {
    ...
    if ((aom_config("CONFIG_ALT_INTRA") eq "yes")) {
      ...
      add_proto qw/void aom_highbd_smooth_v_predictor_64x64/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
      add_proto qw/void aom_highbd_smooth_h_predictor_64x64/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
    } else {
