...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  #
  #
  add_proto qw/void aom_upsampled_pred/, "MACROBLOCKD *xd, const struct AV1Common *const cm,
int mi_row, int mi_col, const MV *const mv, uint8_t *comp_pred, int width, int height, int subpel_x_q3, int subpel_y_q3, 
                          const uint8_t *ref, int ref_offset, int ref_stride";
  specialize qw/aom_upsampled_pred sse2/;

  add_proto qw/void aom_comp_avg_upsampled_pred/, "MACROBLOCKD *xd,
  ...
  add_proto qw/void aom_jnt_comp_avg_upsampled_pred/, "MACROBLOCKD *xd,
                                   const struct AV1Common *const cm,
                                   int mi_row, int mi_col, const MV *const mv, uint8_t *comp_pred,
                        				   const uint8_t *pred, int width, int height, int subpel_x_q3,
                                   int subpel_y_q3, const uint8_t *ref, int ref_offset, int ref_stride,
