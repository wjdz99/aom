...
if (aom_config("CONFIG_CLPF") eq "yes") {
  ...
  add_proto qw/void aom_detect_clpf/, "const uint8_t *rec, const uint8_t *org,int x0, int y0, int width, int height, int so, int stride, int *sum0, int *sum1, unsigned int strength";
  specialize qw/aom_detect_clpf sse2 ssse3 sse4_1 neon/;
  add_proto qw/void aom_detect_multi_clpf/, "const uint8_t *rec, const uint8_t *org, int x0, int y0, int width, int height, int so, int stride, int *sum";
  specialize qw/aom_detect_multi_clpf sse2 ssse3 sse4_1 neon/;
}
