...
if (aom_config("CONFIG_LOOP_RESTORATION") eq "yes") {
  ...
  specialize qw/aom_convolve8_add_src      /, "$ssse3_x86_64";
  specialize qw/aom_convolve8_add_src_horiz/, "$ssse3_x86_64";
  specialize qw/aom_convolve8_add_src_vert /, "$ssse3_x86_64";
