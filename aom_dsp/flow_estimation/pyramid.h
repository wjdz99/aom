...
// Temporary flag to determine whether to use corner matching (0) or disflow (1)
// for global motion estimation
// Eventually this will be removed once a proper decision mechanism (speed
// features and/or a command line flag) are implemented
#define GM_USE_DISFLOW 0
