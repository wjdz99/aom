...
*/
double av1_compute_cross_correlation_avx2(const unsigned char *frm1,
  ...
  for (i = 0; i < MATCH_SZ; ++i) {
    v1 = _mm_and_si128(_mm_loadu_si128((__m128i *)&frm1[stride1_i]), mask);
    v1_1 = _mm256_cvtepu8_epi16(v1);
    v2 = _mm_and_si128(_mm_loadu_si128((__m128i *)&frm2[stride2_i]), mask);
