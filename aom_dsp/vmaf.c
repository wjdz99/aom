...
static void init_vmaf_context(VmafContext **vmaf_context, VmafModel *vmaf_model,
                              bool cal_vmaf_neg) {
...
static void close_vmaf_context(VmafContext *vmaf_context) {
...
void aom_calc_vmaf(VmafModel *vmaf_model, const YV12_BUFFER_CONFIG *source,
  ...
  init_vmaf_context(&vmaf_context, vmaf_model, cal_vmaf_neg);
  ...
  close_vmaf_context(vmaf_context);
}
