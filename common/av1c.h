...
// Attempts to parse an AV1 config from 'buffer'. Returns -1 when
// 'buffer_length' is less than 4, when passed NULL pointers, or when
// parsing of 'buffer' fails.
