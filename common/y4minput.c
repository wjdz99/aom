...
int y4m_input_open(y4m_input *_y4m, FILE *_fin, char *_skip, int _nskip,
   ...
   * already 420mpeg2. Likewise for 420paldv and colocated.
   */
  ...
  if (csp == AOM_CSP_COLOCATED && strcmp(_y4m->chroma_type, "420paldv") != 0) {
    fprintf(stderr,
            "Colocated chroma sample position only supported "
            "for 420paldv input\n");
    return -1;
  }
