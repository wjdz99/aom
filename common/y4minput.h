 ...
 * support the conversion from co-located to vertical. The skip buffer indicates
 * bytes that were previously read from the file, to do input-type
 * detection; the buffer will be read before the file is read, and *must*
 * be 8 or less characters in size.
 *
