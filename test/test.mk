...
LIBAOM_TEST_SRCS-yes                   += simd_test_defs.h
LIBAOM_TEST_SRCS-yes                   += simd_test.cc
LIBAOM_TEST_SRCS-$(HAVE_SSE2)          += simd_test_sse2.cc
LIBAOM_TEST_SRCS-$(HAVE_SSSE3)         += simd_test_ssse3.cc
LIBAOM_TEST_SRCS-$(HAVE_SSE4_1)        += simd_test_sse4.cc
LIBAOM_TEST_SRCS-$(HAVE_NEON)          += simd_test_arm.cc
