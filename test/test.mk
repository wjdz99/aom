...
LIBAOM_TEST_SRCS-yes                   += simd_test.h
LIBAOM_TEST_SRCS-yes                   += simd_test_arch.h
...
LIBAOM_TEST_SRCS-$(HAVE_NEON)          += simd_arm_test.cc
LIBAOM_TEST_SRCS-$(HAVE_SSE2)          += simd_test_arch_sse2.cc
LIBAOM_TEST_SRCS-$(HAVE_SSSE3)         += simd_test_arch_ssse3.cc
LIBAOM_TEST_SRCS-$(HAVE_SSE4_1)        += simd_test_arch_sse4.cc
LIBAOM_TEST_SRCS-$(HAVE_AVX2)          += simd_test_arch_avx2.cc
LIBAOM_TEST_SRCS-$(HAVE_NEON)          += simd_test_arch_arm.cc
