...
function (setup_aom_test_targets)
  ...
  if (num_test_shards EQUAL 0)
    ...
    # isn't available.
    message("----- num_test_shards defaulted to 10")
    set(num_test_shards 10)
  endif ()
  message("----- num_test_shards=${num_test_shards}")
  ...
  foreach (shard_index RANGE ${max_shard_index})
    message("----> Creating target for shard ${shard_index}/${max_shard_index}")
  ...
  add_custom_target(runtests
                    DEPENDS ${test_targets} test_libaom testdata)
endfunction ()
