...
return () endif() #AOM_TEST_TEST_CMAKE_ set(AOM_TEST_TEST_CMAKE_ 1)

    include(FindPythonInterp) include(ProcessorCount)

        include("${AOM_ROOT}/test/test_data_util.cmake")

            set(AOM_UNIT_TEST_DATA_LIST_FILE "${AOM_ROOT}/test/test-data.sha1")

                list(APPEND AOM_UNIT_TEST_WRAPPER_SOURCES
                    ...
                    list(APPEND AOM_UNIT_TEST_COMMON_SOURCES
                        ...
                        if (CONFIG_INTERNAL_STATS) list(
                            APPEND AOM_UNIT_TEST_COMMON_SOURCES
                            "${AOM_ROOT}/test/hbd_metrics_test.cc") endif()

                            list(
                                APPEND AOM_UNIT_TEST_DECODER_SOURCES
                                ...
                                list(
                                    APPEND AOM_UNIT_TEST_ENCODER_SOURCES
                                    ...
                                    list(APPEND AOM_DECODE_PERF_TEST_SOURCES
                                        ...
                                        list(
                                            APPEND AOM_ENCODE_PERF_TEST_SOURCES
                                            "${AOM_ROOT}/test/"
                                            "encode_perf_test.cc") list(APPEND
                                                ...
                                                if (NOT BUILD_SHARED_LIBS) list(
                                                    ...
                                                    if (CONFIG_ACCOUNTING) list(
                                                        APPEND
                                                            AOM_UNIT_TEST_COMMON_SOURCES
                                                        "${AOM_ROOT}/test/"
                                                        "accounting_test.cc") endif()

                                                        if (CONFIG_AV1_DECODER AND
                                                                CONFIG_AV1_ENCODER)
                                                            list(
                                                                APPEND
                                                                    AOM_UNIT_TEST_COMMON_SOURCES
                                                                ...
                                                                "temporal_"
                                                                "filter_yuv_"
                                                                "test.cc") if (CONFIG_REALTIME_ONLY)
                                                                list(
                                                                    REMOVE_ITEM
                                                                        AOM_UNIT_TEST_COMMON_SOURCES
                                                                    "${AOM_"
                                                                    ...
                                                                    "filter_"
                                                                    "yuv_test."
                                                                    "cc") endif() if (NOT CONFIG_AV1_HIGHBITDEPTH)
                                                                    list(
                                                                        REMOVE_ITEM
                                                                            AOM_UNIT_TEST_COMMON_SOURCES
                                                                        "${AOM_"
                                                                            ...
                                                                            list(
                                                                                ...
                                                                                "${AOM_ROOT}/test/simd_neon_test.cc")
                                                                                    ...
                                                                                    list(
                                                                                        ...
                                                                                        "${AOM_ROOT}/test/simd_cmp_sse2.cc") if (HAVE_SSE2)
                                                                                        list(
                                                                                            APPEND
                                                                                                AOM_UNIT_TEST_COMMON_SOURCES
                                                                                            "${AOM_ROOT}/test/simd_sse2_test.cc")
                                                                                                ...
                                                                                                list(
                                                                                                    ...
                                                                                                    "${AOM_ROOT}/test/simd_cmp_ssse3.cc") if (HAVE_SSSE3)
                                                                                                    list(
                                                                                                        APPEND
                                                                                                            AOM_UNIT_TEST_COMMON_SOURCES
                                                                                                                            ...
                                                                                                                            list(
                                                                                                                                ...
                                                                                                                                "${AOM_ROOT}/test/filterintra_test.cc")
                                                                                                                                    ...
                                                                                                                                    list(APPEND
                                                                                                                                         ...
                                                                                                                                         "${AOM_ROOT}/test/simd_cmp_avx2.cc") if (HAVE_AVX2) list(APPEND
                                                                                                                                                                                                      AOM_UNIT_TEST_COMMON_SOURCES
                                                                                                                                                                                                  "${AOM_ROOT}/test/simd_avx2_test.cc") endif()
                                                                                                                                        ...
                                                                                                                                        list(
                                                                                                                                            ...
                                                                                                                                            list(
                                                                                                                                                ...
                                                                                                                                                if (NOT CONFIG_AV1_HIGHBITDEPTH) list(
                                                                                                                                                    REMOVE_ITEM
                                                                                                                                                        AOM_UNIT_TEST_ENCODER_INTRIN_SSE4_1
                                                                                                                                                    "${AOM_ROOT}/test/av1_quantize_test.cc") endif()
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    message(
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        "make sure it's in your PATH.")
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if (BUILD_SHARED_LIBS
                                                                                                                                                                                                                    AND APPLE) #Silence an RPATH warning
                                                                                                                                                                                                                .set(
                                                                                                                                                                                                                    CMAKE_MACOSX_RPATH 1)
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        include_directories(
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            include_directories(
                                                                                                                                                                                                                                "${AOM_ROOT}/third_party/googletest/src/googletest") add_library(aom_gtest
                                                                                                                                                                                                                                                                                                     STATIC
                                                                                                                                                                                                                                                                                                 "${AOM_ROOT}/third_party/googletest/src/googletest/src/gtest-all.cc") if (MSVC OR
                                                                                                                                                                                                                                                                                                                                                                               WIN32) target_compile_definitions(aom_gtest PRIVATE
                                                                                                                                                                                                                                                                                                                                                                                                                     GTEST_OS_WINDOWS =
                                                                                                                                                                                                                                                                                                                                                                                                                         1)
                                                                                                                                                                                                                                elseif(
                                                                                                                                                                                                                                    CONFIG_MULTITHREAD
                                                                                                                                                                                                                                        AND CMAKE_USE_PTHREADS_INIT)
                                                                                                                                                                                                                                    target_compile_definitions(aom_gtest
                                                                                                                                                                                                                                                                   PRIVATE GTEST_HAS_PTHREAD = 1) else() target_compile_definitions(aom_gtest PRIVATE
                                                                                                                                                                                                                                                                                                                                        GTEST_HAS_PTHREAD =
                                                                                                                                                                                                                                                                                                                                            0)
                                                                                                                                                                                                                                        endif()
                                                                                                                                                                                                                                            endif()
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    add_library(test_aom_common
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        add_dependencies(
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if (CONFIG_AV1_DECODER)
                                                                                                                                                                                                                                                                add_library(test_aom_decoder OBJECT ${ AOM_UNIT_TEST_DECODER_SOURCES }) add_dependencies(
                                                                                                                                                                                                                                                                    test_aom_decoder
                                                                                                                                                                                                                                                                        aom) endif()

                                                                                                                                                                                                                                                                    if (CONFIG_AV1_ENCODER) add_library(test_aom_encoder OBJECT
                                                                                                                                                                                                                                                                                                            ${ AOM_UNIT_TEST_ENCODER_SOURCES })
                                                                                                                                                                                                                                                                        add_dependencies(
                                                                                                                                                                                                                                                                            test_aom_encoder
                                                                                                                                                                                                                                                                                aom)
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                add_executable(test_libaom ${
                                                                                                                                                                                                                                                                                                   AOM_UNIT_TEST_WRAPPER_SOURCES } $ <
                                                                                                                                                                                                                                                                                                   TARGET_OBJECTS
                                                                                                                                                                                                                                                                                               : aom_common_app_util >
                                                                                                                                                                                                                                                                                                     $ <
                                                                                                                                                                                                                                                                                                     TARGET_OBJECTS
                                                                                                                                                                                                                                                                                               : test_aom_common >) list(APPEND AOM_APP_TARGETS
                                                                                                                                                                                                                                                                                                                             test_libaom)

                                                                                                                                                                                                                                                                                    if (CONFIG_AV1_DECODER) target_sources(
                                                                                                                                                                                                                                                                                        test_libaom PRIVATE
                                                                                                                                                                                                                                                                                                $ <
                                                                                                                                                                                                                                                                                            TARGET_OBJECTS
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if (ENABLE_DECODE_PERF_TESTS
                                                                                                                                                                                                                                                                                                AND CONFIG_WEBM_IO)
                                                                                                                                                                                                                                                                                            target_sources(test_libaom PRIVATE ${ AOM_DECODE_PERF_TEST_SOURCES }) endif() endif()

                                                                                                                                                                                                                                                                                                if (CONFIG_AV1_ENCODER) target_sources(test_libaom PRIVATE
                                                                                                                                                                                                                                                                                                                                               $ <
                                                                                                                                                                                                                                                                                                                                           TARGET_OBJECTS
                                                                                                                                                                                                                                                                                                                                       : test_aom_encoder >
                                                                                                                                                                                                                                                                                                                                             $ <
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    if (ENABLE_ENCODE_PERF_TESTS) target_sources(test_libaom PRIVATE ${
                                                                                                                                                                                                                                                                                                        AOM_ENCODE_PERF_TEST_SOURCES })
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            if (NOT BUILD_SHARED_LIBS)
                                                                                                                                                                                                                                                                                                                add_executable(test_intra_pred_speed ${ AOM_TEST_INTRA_PRED_SPEED_SOURCES } $ <
                                                                                                                                                                                                                                                                                                                                   TARGET_OBJECTS
                                                                                                                                                                                                                                                                                                                               : aom_common_app_util >)
                                                                                                                                                                                                                                                                                                                    target_link_libraries(test_intra_pred_speed
                                                                                                                                                                                                                                                                                                                                              ${
                                                                                                                                                                                                                                                                                                                                                  AOM_LIB_LINK_TYPE } aom aom_gtest) list(APPEND AOM_APP_TARGETS
                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                target_link_libraries(
                                                                                                                                                                                                                                                                                                                                    test_libaom
                                                                                                                                                                                                                                                                                                                                        ${ AOM_LIB_LINK_TYPE } aom
                                                                                                                                                                                                                                                                                                                                            aom_gtest)

                                                                                                                                                                                                                                                                                                                                    if (CONFIG_LIBYUV)
                                                                                                                                                                                                                                                                                                                                        target_sources(test_libaom PRIVATE $ < TARGET_OBJECTS
                                                                                                                                                                                                                                                                                                                                                       : yuv >)
                                                                                                                                                                                                                                                                                                                                            endif() if (
                                                                                                                                                                                                                                                                                                                                                CONFIG_WEBM_IO)
                                                                                                                                                                                                                                                                                                                                                target_sources(
                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                        add_intrinsics_source_to_target(
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            "AOM_UNIT_TEST_COMMON_INTRIN_SSE2")
                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                add_intrinsics_source_to_target(
                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    "test_libaom"
                                                                                                                                                                                                                                                                                                                                                                    "AOM_UNIT_TEST_COMMON_INTRIN_SSSE3")
                                                                                                                                                                                                                                                                                                                                                                    endif() if (HAVE_SSE4_1) add_intrinsics_source_to_target(
                                                                                                                                                                                                                                                                                                                                                                        "-msse4.1"
                                                                                                                                                                                                                                                                                                                                                                        "test_libaom"
                                                                                                                                                                                                                                                                                                                                                                        "AOM_UNIT_TEST_COMMON_INTRIN_SSE4_1") if (CONFIG_AV1_ENCODER) if (AOM_UNIT_TEST_ENCODER_INTRIN_SSE4_1)
                                                                                                                                                                                                                                                                                                                                                                        add_intrinsics_source_to_target(
                                                                                                                                                                                                                                                                                                                                                                            "-msse4.1"
                                                                                                                                                                                                                                                                                                                                                                            "test_libaom"
                                                                                                                                                                                                                                                                                                                                                                            "AOM_UNIT_TEST_ENCODER_INTRIN_SSE4_1")
                                                                                                                                                                                                                                                                                                                                                                            endif() endif() endif() if (HAVE_AVX2)
                                                                                                                                                                                                                                                                                                                                                                                add_intrinsics_source_to_target(
                                                                                                                                                                                                                                                                                                                                                                                    "-mavx2"
                                                                                                                                                                                                                                                                                                                                                                                    "test_libaom"
                                                                                                                                                                                                                                                                                                                                                                                    "AOM_UNIT_TEST_COMMON_INTRIN_AVX2") endif() if (HAVE_NEON)
                                                                                                                                                                                                                                                                                                                                                                                    add_intrinsics_source_to_target(
                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                        "AOM_UNIT_TEST_COMMON_INTRIN_NEON")
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            if (ENABLE_TESTDATA) make_test_data_lists(
                                                                                                                                                                                                                                                                                                                                                                                                "${AOM_UNIT_TEST_DATA_LIST_FILE}" test_files
                                                                                                                                                                                                                                                                                                                                                                                                    test_file_checksums)
                                                                                                                                                                                                                                                                                                                                                                                                list(
                                                                                                                                                                                                                                                                                                                                                                                                    LENGTH test_files
                                                                                                                                                                                                                                                                                                                                                                                                        num_test_files)
                                                                                                                                                                                                                                                                                                                                                                                                    list(
                                                                                                                                                                                                                                                                                                                                                                                                        LENGTH test_file_checksums
...
#targets, and the test run takes hours.
                                                                                                                                                                                                                                                                                                                                                                                                                                if (((NOT MSVC)AND(NOT XCODE))
                                                                                                                                                                                                                                                                                                                                                                                                                                        OR ENABLE_IDE_TEST_HOSTING)

#Pick a reasonable number of targets(this controls parallelization).
                                                                                                                                                                                                                                                                                                                                                                                                                                    processorcount(
                                                                                                                                                                                                                                                                                                                                                                                                                                        num_test_targets) if (num_test_targets
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  EQUAL 0) #Just default to 10 targets when
                                                                                                                                                                                                                                                                                                                                                                                                                                        there's no
#processor count available.
    set(num_test_targets 10) endif()

        math(EXPR max_shard_index "${num_test_targets} - 1") foreach (
            shard_index RANGE ${ max_shard_index })
            set(test_name "test_${shard_index}") add_custom_target(
                ${ test_name } COMMAND ${ CMAKE_COMMAND } - DGTEST_SHARD_INDEX =
                    ${ shard_index } - DGTEST_TOTAL_SHARDS =
                        ${ num_test_targets } - DTEST_LIBAOM = $ < TARGET_FILE
                : test_libaom >
                      -P "${AOM_ROOT}/test/test_runner.cmake" DEPENDS testdata
                          test_libaom) list(APPEND test_targets ${ test_name })
                endforeach() add_custom_target(runtests) add_dependencies(
                    runtests ${ test_targets }) endif() endif()

#Collect all variables containing libaom test source files.
                    get_cmake_property(all_cmake_vars VARIABLES) foreach (
                        var ${ all_cmake_vars })

#https:  // github.com/cheshirekow/cmake_format/issues/34
#cmake - format : off
                        if (("${var}" MATCHES "_TEST_" AND NOT "${var}" MATCHES
                             "_DATA_\|_CMAKE_\|INTRA_PRED\|_COMPILED\|_"
                             "HOSTING\|_PERF_\|CODER_")
                                OR(CONFIG_AV1_ENCODER AND
                                       ENABLE_ENCODE_PERF_TESTS AND
                                   "${var}" MATCHES "_ENCODE_PERF_TEST_")
                                    OR(CONFIG_AV1_DECODER AND
                                           ENABLE_DECODE_PERF_TESTS AND
                                       "${var}" MATCHES "_DECODE_PERF_TEST_")
                                        OR(CONFIG_AV1_ENCODER AND
                                           "${var}" MATCHES "_TEST_ENCODER_")
                                            OR(CONFIG_AV1_DECODER AND
                                               "${var}" MATCHES
                                               "_TEST_DECODER_"))
                            list(APPEND aom_test_source_vars ${ var }) endif()
#cmake - format : on
                                endforeach()

#Libaom_test_srcs.txt generation.
                                    set(libaom_test_srcs_txt_file
                                        "${AOM_CONFIG_DIR}/"
                                        "libaom_test_srcs.txt") file(WRITE
                                                                     "${libaom_"
                                                                     "test_"
                                                                     "srcs_txt_"
                                                                     "file}"
...
#Static source file list first.
                                        foreach (aom_test_source_var ${
                                            aom_test_source_vars }) foreach (file ${
                                            ${ aom_test_source_var } }) if (NOT
                                                                            "${"
                                                                            "fi"
                                                                            "le"
                                                                            "}" MATCHES
                                            ...
                                            string(REPLACE
                                                   ...
                                                   "" file "${file}")
                                                file(APPEND
                                                     "${libaom_test_srcs_txt_"
                                                     "file}"
                                                     "${file}\n") endif()
                                                    endforeach() endforeach()

                                                        set(AOM_APP_TARGETS ${
                                                            AOM_APP_TARGETS } PARENT_SCOPE)
                                                            endfunction()
