...
if(ENABLE_TESTS)
  ...
  # The definition of GTEST_HAS_PTHREAD must be public, since it's checked
  # by interface headers, not just by the implementation.
  if(NOT (MSVC OR WIN32) AND CONFIG_MULTITHREAD AND CMAKE_USE_PTHREADS_INIT)
