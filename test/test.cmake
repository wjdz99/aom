...
if (NOT BUILD_SHARED_LIBS AND CONFIG_AV1_DECODER OR CONFIG_AV1_ENCODER)
  set(AOM_UNIT_TEST_COMMON_SOURCES
      ${AOM_UNIT_TEST_COMMON_SOURCES}
...
if (CONFIG_AV1_DECODER AND CONFIG_AV1_ENCODER AND NOT BUILD_SHARED_LIBS)
  set(AOM_UNIT_TEST_COMMON_SOURCES
      ${AOM_UNIT_TEST_COMMON_SOURCES}
...
function (setup_aom_test_targets)
  ...
  if (CONFIG_WEBM_IO)
    target_sources(test_libaom PUBLIC $<TARGET_OBJECTS:webm>)
  endif ()
  if (HAVE_SSE2)
  ...
  if (HAVE_AVX2)
    add_intrinsics_object_library("-mavx2" "avx2" "test_libaom"
                                  "AOM_UNIT_TEST_COMMON_INTRIN_AVX2")
  endif ()
  if (HAVE_NEON)
