...
class AV1OptFlowCopyPredTest : public AV1OptFlowTest<pred_buffer_copy> {
 public:
  AV1OptFlowCopyPredTest() {
    ...
    src_buf1_ = (uint8_t *)aom_memalign(32, bw * bh * sizeof(*src_buf1_));
    src_buf2_ = (uint8_t *)aom_memalign(32, bw * bh * sizeof(*src_buf2_));
    dst_buf1_ref_ =
        (int16_t *)aom_memalign(32, bw * bh * sizeof(*dst_buf1_ref_));
    dst_buf2_ref_ =
        (int16_t *)aom_memalign(32, bw * bh * sizeof(*dst_buf2_ref_));
    dst_buf1_test_ =
        (int16_t *)aom_memalign(32, bw * bh * sizeof(*dst_buf1_test_));
    dst_buf2_test_ =
        (int16_t *)aom_memalign(32, bw * bh * sizeof(*dst_buf2_test_));
...
TEST_P(AV1OptFlowCopyPredTest, Speed) { Run(1); }
...
class AV1OptFlowCopyPredHighbdTest
 ...
 public:
  AV1OptFlowCopyPredHighbdTest() {
    ...
    src_buf1_ = (uint16_t *)aom_memalign(32, bw * bh * sizeof(*src_buf1_));
    src_buf2_ = (uint16_t *)aom_memalign(32, bw * bh * sizeof(*src_buf2_));
    dst_buf1_ref_ =
        (int16_t *)aom_memalign(32, bw * bh * sizeof(*dst_buf1_ref_));
    dst_buf2_ref_ =
        (int16_t *)aom_memalign(32, bw * bh * sizeof(*dst_buf2_ref_));
  ...
  void Run(const int is_speed) {
    ...
    for (int oh_bits = oh_start_bits; oh_bits <= kMaxOrderHintBits; oh_bits++) {
      for (int count = 0; count < numIter; count++) {
        ...
        RandomInput16(src_buf1_, GetParam(), 12);
        RandomInput16(src_buf2_, GetParam(), 12);
        TestCopyPredArray(src_buf1_, src_buf2_, dst_buf1_ref_, dst_buf2_ref_,
                          dst_buf1_test_, dst_buf2_test_, d0, d1, is_speed);
      }
    }
    ...
    for (int oh_bits = oh_start_bits; oh_bits <= kMaxOrderHintBits; oh_bits++) {
      for (int count = 0; count < numIter; count++) {
        ...
        RandomInput16Extreme(src_buf1_, GetParam(), 12);
        RandomInput16Extreme(src_buf2_, GetParam(), 12);
        TestCopyPredArray(src_buf1_, src_buf2_, dst_buf1_ref_, dst_buf2_ref_,
                          dst_buf1_test_, dst_buf2_test_, d0, d1, 0);
      }
    }
...
TEST_P(AV1OptFlowCopyPredHighbdTest, Speed) { Run(1); }
