...
template <typename T>
::testing::internal::ParamGenerator<TestParam<T>> BuildOptFlowLowbdParams(
    T test_func) {
...
class AV1OptFlowRefineTest : public AV1OptFlowTest<opfl_mv_refinement> {
 ...
 private:
  ...
  // TODO(anyone): Modify kMaxOrderHintBits=8, after fixing overflow issue.
  static constexpr int kMaxOrderHintBits = 3;
...
TEST_P(AV1OptFlowRefineTest, Speed) { RunTest(1); }

INSTANTIATE_TEST_SUITE_P(
    C, AV1OptFlowRefineTest,
    BuildOptFlowLowbdParams(opfl_mv_refinement_nxn_lowbd_c));
#if HAVE_SSE4_1
INSTANTIATE_TEST_SUITE_P(
    SSE4_1, AV1OptFlowRefineTest,
    BuildOptFlowLowbdParams(opfl_mv_refinement_nxn_lowbd_sse4_1));
#endif
...
TEST_P(AV1OptFlowRefineHighbdTest, Speed) { RunTest(1); }
...
INSTANTIATE_TEST_SUITE_P(
    ...
    BuildOptFlowLowbdParams(opfl_mv_refinement_nxn_highbd_sse4_1));
#endif
...
INSTANTIATE_TEST_SUITE_P(
    C, AV1OptFlowBiCubicGradLowbdTest,
    BuildOptFlowLowbdParams(av1_bicubic_grad_interpolation_c));

#if HAVE_SSE4_1
INSTANTIATE_TEST_SUITE_P(
    SSE4_1, AV1OptFlowBiCubicGradLowbdTest,
    BuildOptFlowLowbdParams(av1_bicubic_grad_interpolation_sse4_1));
#endif
