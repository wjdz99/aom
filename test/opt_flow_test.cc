...
class AV1OptFlowBiCubicGradLowbdTest
 ...
 public:
  AV1OptFlowBiCubicGradLowbdTest() {
    ...
    pred_src_ = (int16_t *)aom_calloc(16, bw * bh * sizeof(int16_t));
    x_grad_ref_ = (int16_t *)aom_calloc(16, bw * bh * sizeof(int16_t));
    y_grad_ref_ = (int16_t *)aom_calloc(16, bw * bh * sizeof(int16_t));
    x_grad_test_ = (int16_t *)aom_calloc(16, bw * bh * sizeof(int16_t));
    y_grad_test_ = (int16_t *)aom_calloc(16, bw * bh * sizeof(int16_t));
  }
