...
// Initialize encoder with monochrome = 1, and encode 2nd frame with
// monochrome = 0. This will result in an error: see the following check
// in encoder_set_config() in av1/av1_cx_iface.c.
// TODO(marpan): Consider moving this test to another file,
// as it has nothing to do with film grain mode.
TEST(FilmGrainEncodeTest, InitMonochrome1_EncodeMonochrome0) {
