...
const QuantizeParam kQParamArrayAvx2[] = {
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_avx2, (uint8_t)TX_16X16,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_avx2, (uint8_t)TX_4X16,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_avx2, (uint8_t)TX_16X4,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_avx2, (uint8_t)TX_32X8,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_avx2, (uint8_t)TX_8X32,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_32x32_c, &av1_quantize_fp_32x32_avx2,
             (uint8_t)TX_32X32, TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_32x32_c, &av1_quantize_fp_32x32_avx2,
             (uint8_t)TX_16X64, TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_32x32_c, &av1_quantize_fp_32x32_avx2,
             (uint8_t)TX_64X16, TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_64x64_c, &av1_quantize_fp_64x64_avx2,
             (uint8_t)TX_64X64, TYPE_FP, AOM_BITS_8),
  make_tuple(&highbd_quan16x16_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan16x16_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_16X16, TYPE_FP, AOM_BITS_8),
  make_tuple(&highbd_quan16x16_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan16x16_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_16X16, TYPE_FP, AOM_BITS_10),
  make_tuple(&highbd_quan16x16_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan16x16_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_16X16, TYPE_FP, AOM_BITS_12),
  make_tuple(&highbd_quan32x32_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan32x32_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_32X32, TYPE_FP, AOM_BITS_8),
  make_tuple(&highbd_quan32x32_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan32x32_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_32X32, TYPE_FP, AOM_BITS_10),
  make_tuple(&highbd_quan32x32_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan32x32_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_32X32, TYPE_FP, AOM_BITS_12),
  make_tuple(&highbd_quan64x64_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan64x64_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_64X64, TYPE_FP, AOM_BITS_8),
  make_tuple(&highbd_quan64x64_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan64x64_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_64X64, TYPE_FP, AOM_BITS_10),
  make_tuple(&highbd_quan64x64_wrapper<av1_highbd_quantize_fp_c>,
             &highbd_quan64x64_wrapper<av1_highbd_quantize_fp_avx2>,
             (uint8_t)TX_64X64, TYPE_FP, AOM_BITS_12),
  make_tuple(&aom_highbd_quantize_b_c, &aom_highbd_quantize_b_avx2,
             (uint8_t)TX_16X16, TYPE_B, AOM_BITS_8),
  make_tuple(&aom_highbd_quantize_b_c, &aom_highbd_quantize_b_avx2,
             (uint8_t)TX_16X16, TYPE_B, AOM_BITS_10),
  make_tuple(&aom_highbd_quantize_b_c, &aom_highbd_quantize_b_avx2,
             (uint8_t)TX_16X16, TYPE_B, AOM_BITS_12),
  make_tuple(&aom_quantize_b_adaptive_c, &aom_quantize_b_adaptive_avx2,
             (uint8_t)TX_16X16, TYPE_B, AOM_BITS_8),
  make_tuple(&aom_quantize_b_adaptive_c, &aom_quantize_b_adaptive_avx2,
             (uint8_t)TX_8X8, TYPE_B, AOM_BITS_8),
  make_tuple(&aom_quantize_b_adaptive_c, &aom_quantize_b_adaptive_avx2,
             (uint8_t)TX_4X4, TYPE_B, AOM_BITS_8)
};
...
const QuantizeParam kQParamArraySSE2[] = {
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_sse2, (uint8_t)TX_16X16,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_sse2, (uint8_t)TX_4X16,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_sse2, (uint8_t)TX_16X4,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_sse2, (uint8_t)TX_8X32,
             TYPE_FP, AOM_BITS_8),
  make_tuple(&av1_quantize_fp_c, &av1_quantize_fp_sse2, (uint8_t)TX_32X8,
             TYPE_FP, AOM_BITS_8),
  ...
  make_tuple(&aom_quantize_b_32x32_adaptive_c,
             &aom_quantize_b_32x32_adaptive_sse2, (uint8_t)TX_32X16, TYPE_B,
             AOM_BITS_8),
  make_tuple(&aom_quantize_b_32x32_adaptive_c,
             &aom_quantize_b_32x32_adaptive_sse2, (uint8_t)TX_16X32, TYPE_B,
             AOM_BITS_8),
  make_tuple(&aom_quantize_b_32x32_adaptive_c,
             &aom_quantize_b_32x32_adaptive_sse2, (uint8_t)TX_32X32, TYPE_B,
             AOM_BITS_8),
  make_tuple(&aom_quantize_b_64x64_adaptive_c,
             &aom_quantize_b_64x64_adaptive_sse2, (uint8_t)TX_32X64, TYPE_B,
             AOM_BITS_8),
  make_tuple(&aom_quantize_b_64x64_adaptive_c,
             &aom_quantize_b_64x64_adaptive_sse2, (uint8_t)TX_64X32, TYPE_B,
             AOM_BITS_8),
  make_tuple(&aom_quantize_b_64x64_adaptive_c,
             &aom_quantize_b_64x64_adaptive_sse2, (uint8_t)TX_64X64, TYPE_B,
             AOM_BITS_8)
};
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(&aom_quantize_b_c, &aom_quantize_b_ssse3,
                      ...
                      make_tuple(&aom_quantize_b_32x32_c,
                                 &aom_quantize_b_32x32_ssse3, (uint8_t)TX_32X32,
                                 TYPE_B, AOM_BITS_8),
                      make_tuple(&aom_quantize_b_64x64_c,
                                 &aom_quantize_b_64x64_ssse3, (uint8_t)TX_64X64,
                                 TYPE_B, AOM_BITS_8)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(&aom_quantize_b_c, &aom_quantize_b_avx,
                                 (uint8_t)TX_16X16, TYPE_B, AOM_BITS_8),
                      make_tuple(&aom_quantize_b_32x32_c,
                                 &aom_quantize_b_32x32_avx, (uint8_t)TX_32X32,
                                 TYPE_B, AOM_BITS_8)));
