...
av1_enc_test() {
  ...
  if [ "${preset}" = "good" ]; then
    ...
    #TODO: Enable testing of high bit-depth clips after fixing C vs SIMD mismatches.
...
av1_c_vs_simd_enc_test () {
  ...
  ##TODO(BUG=aomedia:3479): Enable testing after mismatches between generic target
  # and x86 32-bit platform are resolved.
  # Test x86 (32 bit)
  ...
  ##TODO(BUG=aomedia:3474): Enable testing for ARM after fixing C vs NEON mismatches
  # Test ARM
