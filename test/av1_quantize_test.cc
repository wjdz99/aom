...
const QuantizeFuncParams qfps[4] = {
  { &av1_highbd_quantize_fp_sse4_1, &av1_highbd_quantize_fp_c, 16 },
  { &av1_highbd_quantize_fp_sse4_1, &av1_highbd_quantize_fp_c, 64 },
  { &av1_highbd_quantize_fp_sse4_1, &av1_highbd_quantize_fp_c, 256 },
  { &av1_highbd_quantize_fp_sse4_1, &av1_highbd_quantize_fp_c, 1024 },
};
