...
using SSI16Func = uint64_t (*)(const int16_t *, int, int, int);
...
using F1D = uint64_t (*)(const int16_t *, uint32_t);
...
using sse_func = int64_t (*)(const uint8_t *, int, const uint8_t *, int, int,
                             int);
using TestSSEFuncs = libaom_test::FuncParam<sse_func>;
...
using sse_sum_func = void (*)(const int16_t *, int, int, int, int *, int64_t *);
...
using Var2DFunc = uint64_t (*)(uint8_t *, int, int, int);
