...
TEST_P(U64_V256, TestIntrinsics) {
  test_simd1(iterations, mask, maskwidth, simd, ref_simd);
}
...
TEST_P(V256_V256, TestIntrinsics) {
  test_simd1(iterations, mask, maskwidth, simd, ref_simd);
}

TEST_P(V256_V128, TestIntrinsics) {
  test_simd1(iterations, mask, maskwidth, simd, ref_simd);
}
...
TEST_P(V256_V256V256, TestIntrinsics) {
  test_simd2(iterations, mask, maskwidth, simd, ref_simd);
}
...
TEST_P(U32_V256V256, TestIntrinsics) {
  test_simd2(iterations, mask, maskwidth, simd, ref_simd);
}

TEST_P(V256_V128V128, TestIntrinsics) {
  test_simd2(iterations, mask, maskwidth, simd, ref_simd);
}
...
TEST_P(V256_V256U32, TestIntrinsics) {
  test_simd2(iterations, mask, maskwidth, simd, ref_simd);
}
