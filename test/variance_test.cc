...
using MseWxH16bitFunc = uint64_t (*)(uint8_t *, int, uint16_t *, int, int, int);
using Mse16xH16bitFunc = uint64_t (*)(uint8_t *, int, uint16_t *, int, int);
using VarianceMxNFunc = unsigned int (*)(const uint8_t *, int, const uint8_t *,
                                         int, unsigned int *);
using GetSseSum8x8QuadFunc = void (*)(const uint8_t *, int, const uint8_t *,
                                      int, uint32_t *, int *, unsigned int *,
                                      int *, uint32_t *);
using GetSseSum16x16DualFunc = void (*)(const uint8_t *, int, const uint8_t *,
                                        int, uint32_t *, unsigned int *, int *,
                                        uint32_t *);
typedef unsigned in;
using SubpixVarMxNFunc = unsigned int (*)(const uint8_t *, int, int, int,
                                          const uint8_t *, int, unsigned int *);
using SubpixAvgVarMxNFunc = unsigned int (*)(const uint8_t *, int, int, int,
                                             const uint8_t *, int, uint32_t *,
                                             const uint8_t *);
using SumOfSquaresFunction = unsigned int (*)(const int16_t *);
using DistWtdSubpixAvgVarMxNFunc =
    unsigned int (*)(const uint8_t *, int, int, int, const uint8_t *, int,
                     uint32_t *, const uint8_t *, const DIST_WTD_COMP_PARAMS *);

#if !CONFIG_REALTIME_ONLY
using ObmcSubpelVarFunc = uint32_t (*)(const uint8_t *, int, int, int,
...
using AvxDistWtdSubpelAvgVarianceTest =
    SubpelVarianceTest<DistWtdSubpixAvgVarMxNFunc>;
#if !CONFIG_REALTIME_ONLY
...
using DistWtdSubpelAvgVarianceParams = TestParams<DistWtdSubpixAvgVarMxNFunc>;
