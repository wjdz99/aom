...
typedef unsigned int (*VarianceMxNFunc)(const uint8_t *a, int a_stride,
                                        ...
                                        unsigned int *sse);
typedef void (*GetVar8x8QuadFunc)(const uint8_t *a, int a_stride,
                                  const uint8_t *b, int b_stride,
...
template <typename GetVar8x8QuadFunctionType>
void MainTestClass<GetVar8x8QuadFunctionType>::RefTestSseSum() {
  for (int i = 0; i < 10; ++i) {
    for (int j = 0; j < block_size(); ++j) {
      src_[j] = rnd_.Rand8();
      ref_[j] = rnd_.Rand8();
    ...
    for (int i = 0; i < height(); i += 8) {
      for (int j = 0; j < width(); j += 32) {
        API_REGISTER_STATE_CHECK(params_.func(src_ + stride * i + j, stride,
                                              ...
                                              &sse1[k], &sum1[k]));
        aom_get8x8var_quad_c(src_ + stride * i + j, stride,
                             ref_ + stride * i + j, stride, &sse2[k], &sum2[k]);
        k += 4;
      }
    }
...
template <typename GetVar8x8QuadFunctionType>
void MainTestClass<GetVar8x8QuadFunctionType>::MinTestSseSum() {
  ...
  for (int i = 0; i < height(); i += 8) {
    for (int j = 0; j < width(); j += 32) {
      API_REGISTER_STATE_CHECK(params_.func(src_ + stride * i + j, stride,
                                            ref_ + stride * i + j, stride,
                                            &sse1[k], &sum1[k]));
      aom_get8x8var_quad_c(src_ + stride * i + j, stride, ref_ + stride * i + j,
                           stride, &sse2[k], &sum2[k]);
      k += 4;
    }
  }
...
template <typename GetVar8x8QuadFunctionType>
void MainTestClass<GetVar8x8QuadFunctionType>::MaxTestSseSum() {
  memset(src_, 255, block_size());
...
template <typename GetVar8x8QuadFunctionType>
void MainTestClass<GetVar8x8QuadFunctionType>::SseSum_SpeedTest() {
...
typedef MainTestClass<GetVar8x8QuadFunc> GetVar8x8QuadTest;
...
TEST_P(GetVar8x8QuadTest, RefMseSum) { RefTestSseSum(); }
TEST_P(GetVar8x8QuadTest, MinSseSum) { MinTestSseSum(); }
TEST_P(GetVar8x8QuadTest, MaxMseSum) { MaxTestSseSum(); }
TEST_P(GetVar8x8QuadTest, DISABLED_Speed) { SseSum_SpeedTest(); }
...
typedef TestParams<GetVar8x8QuadFunc> GetVarParams;
const GetVarParams kArrayGetVar8x8Level_c[] = {
  GetVarParams(7, 7, &aom_get8x8var_quad_c, 0),
  GetVarParams(6, 6, &aom_get8x8var_quad_c, 0),
  GetVarParams(5, 5, &aom_get8x8var_quad_c, 0),
  GetVarParams(5, 4, &aom_get8x8var_quad_c, 0)
};
INSTANTIATE_TEST_SUITE_P(C, GetVar8x8QuadTest,
                         ::testing::ValuesIn(kArrayGetVar8x8Level_c));
...
const GetVarParams kArrayGetVar8x8Level_sse2[] = {
  GetVarParams(7, 7, &aom_get8x8var_quad_sse2, 0),
  GetVarParams(6, 6, &aom_get8x8var_quad_sse2, 0),
  GetVarParams(5, 5, &aom_get8x8var_quad_sse2, 0),
  GetVarParams(5, 4, &aom_get8x8var_quad_sse2, 0)
};
INSTANTIATE_TEST_SUITE_P(SSE2, GetVar8x8QuadTest,
                         ::testing::ValuesIn(kArrayGetVar8x8Level_sse2));
