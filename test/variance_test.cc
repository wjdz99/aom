 ...
 public:
  virtual void SetUp() {
    ...
    dst_ = reinterpret_cast<uint8_t *>(
        aom_memalign(16, block_size() * sizeof(uint8_t)));
...
void MseWxHTestClass<MseWxHFunctionType>::SpeedTest() {
  ...
  for (int i = 0; i < run_time; i++) {
    aom_mse_wxh_16bit_c(dst8, dstride, src_, sstride, w, h);
  }
...
void MseWxHTestClass<MseWxHFunctionType>::RefMatchTestMse() {
  ...
  ASM_REGISTER_STATE_CHECK(
      mse_ref = aom_mse_wxh_16bit_c(dst8, dstride, src_, sstride, w, h));
  ASM_REGISTER_STATE_CHECK(
      mse_mod = params_.func(dst8, dstride, src_, sstride, w, h));
...
INSTANTIATE_TEST_SUITE_P(
    AVX2, AvxMseWxHTest,
    ::testing::Values(MseWxHParams(3, 3, &aom_mse_wxh_16bit_avx2, 0),
                      MseWxHParams(3, 2, &aom_mse_wxh_16bit_avx2, 0),
                      MseWxHParams(2, 3, &aom_mse_wxh_16bit_avx2, 0),
                      MseWxHParams(2, 2, &aom_mse_wxh_16bit_avx2, 0)));
