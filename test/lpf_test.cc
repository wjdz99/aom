...
TEST_P(Loop8Test6Param_hbd,
       OperationCheck){ OPCHECK(uint16_t, 16) } TEST_P(Loop8Test6Param_lbd,
                                                       OperationCheck) {
  OPCHECK(uint8_t, 8)
}
...
TEST_P(Loop8Test6Param_hbd,
       ValueCheck){ VALCHECK(uint16_t, 16) } TEST_P(Loop8Test6Param_lbd,
                                                    ValueCheck) {
  VALCHECK(uint8_t, 8)
}
...
TEST_P(Loop8Test6Param_hbd,
       DISABLED_Speed){ SPEEDCHECK(uint16_t, 16) } TEST_P(Loop8Test6Param_lbd,
                                                          DISABLED_Speed) {
...
TEST_P(Loop8Test9Param_hbd,
       OperationCheck){ OPCHECKd(uint16_t, 16) } TEST_P(Loop8Test9Param_lbd,
                                                        OperationCheck) {
  OPCHECKd(uint8_t, 8)
}
...
TEST_P(Loop8Test9Param_hbd,
       ValueCheck){ VALCHECKd(uint16_t, 16) } TEST_P(Loop8Test9Param_lbd,
                                                     ValueCheck) {
  VALCHECKd(uint8_t, 8)
}
...
TEST_P(Loop8Test9Param_hbd,
       DISABLED_Speed){ SPEEDCHECKd(uint16_t, 16) } TEST_P(Loop8Test9Param_lbd,
                                                           DISABLED_Speed) {
