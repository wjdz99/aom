...
using loop_op_t = void (*)(uint8_t *, int, const uint8_t *, const uint8_t *,
                           const uint8_t *);
using dual_loop_op_t = void (*)(uint8_t *, int, const uint8_t *,
                                const uint8_t *, const uint8_t *,
                                const uint8_t *, const uint8_t *,
                                const uint8_t *);
using hbdloop_op_t = void (*)(uint16_t *, int, const uint8_t *, const uint8_t *,
                              const uint8_t *, int);
using hbddual_loop_op_t = void (*)(uint16_t *, int, const uint8_t *,
                                   const uint8_t *, const uint8_t *,
                                   const uint8_t *, const uint8_t *,
                                   const uint8_t *, int);
