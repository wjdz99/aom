...
struct CornerMatchParam {
  CornerMatchParam(int mode, ComputeCrossCorrFunc func) : mode(mode), func(func) {}
  int mode;
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        CornerMatchParam(0, compute_cross_correlation_sse4_1),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        CornerMatchParam(0, compute_cross_correlation_avx2),
