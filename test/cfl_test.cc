...
const subsample_hbd_param subsample_hbd_sizes_avx2[] = {
  ALL_CFL_TX_SIZES_SUBSAMPLE(
      ...
      cfl_get_luma_subsampling_420_hbd_avx2,  // TODO(ltrudeau) replace with 422
                                              // when SIMD is available
      cfl_get_luma_subsampling_420_hbd_avx2)  // TODO(ltrudeau) replace with 444
                                              // when SIMD is available
};
...
const subsample_hbd_param subsample_hbd_sizes_neon[] = {
  ALL_CFL_TX_SIZES_SUBSAMPLE(
      ...
      cfl_get_luma_subsampling_420_hbd_neon,  // TODO(ltrudeau) replace with 422
                                              // when SIMD is available
      cfl_get_luma_subsampling_420_hbd_neon)  // TODO(ltrudeau) replace with 444
                                              // when SIMD is available
};

const predict_param predict_sizes_lbd_neon[] = { ALL_CFL_TX_SIZES(
...
INSTANTIATE_TEST_CASE_P(NEON, CFLPredictTest,
                        ::testing::ValuesIn(predict_sizes_lbd_neon));
