...
#define ALL_CFL_TX_SIZES(function)              \
      make_tuple((uint8_t)TX_4X4, &function),   \
      make_tuple((uint8_t)TX_4X8, &function),   \
      make_tuple((uint8_t)TX_4X16, &function),  \
      make_tuple((uint8_t)TX_8X4, &function),   \
      make_tuple((uint8_t)TX_8X8, &function),   \
      make_tuple((uint8_t)TX_8X16, &function),  \
      make_tuple((uint8_t)TX_8X32, &function),  \
      make_tuple((uint8_t)TX_16X4, &function),  \
      make_tuple((uint8_t)TX_16X8, &function),  \
      make_tuple((uint8_t)TX_16X16, &function), \
      make_tuple((uint8_t)TX_16X32, &function), \
      make_tuple((uint8_t)TX_32X8, &function),  \
      make_tuple((uint8_t)TX_32X16, &function), \
      make_tuple((uint8_t)TX_32X32, &function)
