...
const AV1InvTxfm2dParam av1_inv_txfm2d_param[] = {
#if CONFIG_EXT_TX
#if CONFIG_RECT_TX
  AV1InvTxfm2dParam(DCT_DCT, TX_4X8, 2, 0.005),
  ...
  AV1InvTxfm2dParam(DCT_DCT, TX_8X16, 2, 0.007),
  AV1InvTxfm2dParam(ADST_DCT, TX_8X16, 2, 0.015),
  AV1InvTxfm2dParam(DCT_ADST, TX_8X16, 2, 0.012),
  AV1InvTxfm2dParam(ADST_ADST, TX_8X16, 2, 0.023),
  AV1InvTxfm2dParam(FLIPADST_DCT, TX_8X16, 2, 0.015),
  AV1InvTxfm2dParam(DCT_FLIPADST, TX_8X16, 2, 0.015),
  AV1InvTxfm2dParam(FLIPADST_FLIPADST, TX_8X16, 2, 0.023),
  AV1InvTxfm2dParam(ADST_FLIPADST, TX_8X16, 2, 0.023),
  AV1InvTxfm2dParam(FLIPADST_ADST, TX_8X16, 2, 0.023),

  AV1InvTxfm2dParam(DCT_DCT, TX_16X8, 2, 0.005),
  AV1InvTxfm2dParam(ADST_DCT, TX_16X8, 2, 0.012),
  AV1InvTxfm2dParam(DCT_ADST, TX_16X8, 2, 0.016),
  AV1InvTxfm2dParam(ADST_ADST, TX_16X8, 2, 0.023),
  AV1InvTxfm2dParam(FLIPADST_DCT, TX_16X8, 2, 0.015),
  AV1InvTxfm2dParam(DCT_FLIPADST, TX_16X8, 2, 0.015),
  AV1InvTxfm2dParam(FLIPADST_FLIPADST, TX_16X8, 2, 0.023),
  AV1InvTxfm2dParam(ADST_FLIPADST, TX_16X8, 2, 0.023),
  AV1InvTxfm2dParam(FLIPADST_ADST, TX_16X8, 2, 0.023),
#endif
