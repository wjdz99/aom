...
TEST_F(CNNTest, TestValidPadding) {
  ...
  float expected_no_stride[] = {
    11, 63, 50, 0, 68, 25, -1,  48, -88, 63, 65, 19, 29,  -15, 37, -10, 16,  36,
    -2, 58, 2,  0, 48, 46, -33, 45, -29, 60, 6,  27, -56, -15, 50, -16, -29, 26,
  };
  ...
  RunCNNTest(image_width, image_height, input, expected_no_stride, cnn_config,
             image_width, INT_TOL, 0);
