...
const loop8_param_t hbd_loop8Test6[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test6Param,
                        ::testing::ValuesIn(hbd_loop8Test6));
#else
const loop8_param_t loop8Test6[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test6Param, ::testing::ValuesIn(loop8Test6));
#endif  // CONFIG_HIGHBITDEPTH
#endif
...
#if HAVE_SSE2
#if CONFIG_HIGHBITDEPTH
const dualloop8_param_t hbd_loop8Test9[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test9Param,
                        ::testing::ValuesIn(hbd_loop8Test9));
#else
const dualloop8_param_t loop8Test9[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test9Param, ::testing::ValuesIn(loop8Test9));
#endif  // CONFIG_HIGHBITDEPTH
#endif
