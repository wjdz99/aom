...
const loop8_param_t kHbdLloop8Test6[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test6Param,
                        ::testing::ValuesIn(kHbdLloop8Test6));
#else
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test6Param, ::testing::ValuesIn(kLoop8Test6));
#endif  // CONFIG_HIGHBITDEPTH
#endif
...
INSTANTIATE_TEST_CASE_P(SSE2, Loop8Test9Param, ::testing::ValuesIn(kLoop8Test9));
#endif  // CONFIG_HIGHBITDEPTH
#endif
