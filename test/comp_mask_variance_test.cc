...
void AV1CompMaskVarianceTest::SetUp() {
  ...
  comp_pred1_ = (uint8_t *)aom_memalign(32, MAX_SB_SQUARE);
  comp_pred2_ = (uint8_t *)aom_memalign(32, MAX_SB_SQUARE);
  pred_ = (uint8_t *)aom_memalign(32, MAX_SB_SQUARE);
  ref_buffer_ = (uint8_t *)aom_memalign(32, MAX_SB_SQUARE + (8 * MAX_SB_SIZE));
