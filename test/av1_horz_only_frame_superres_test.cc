...
using LowBDConvolveHorizRsFunc = void (*)(const uint8_t *, int, uint8_t *, int,
                                          int, int, const int16_t *, const int,
                                          const int);
...
using HighBDConvolveHorizRsFunc = void (*)(const uint16_t *, int, uint16_t *,
                                           int, int, int, const int16_t *,
