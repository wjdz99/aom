...
class DatarateTestCBRLarge
    : public ::libaom_test::CodecTestWith4Params<libaom_test::TestMode, int,
                                                 unsigned int, int>,
      public DatarateTest {
 public:
  DatarateTestCBRLarge() : DatarateTest(GET_PARAM(0)) {
    set_cpu_used_ = GET_PARAM(2);
    aq_mode_ = GET_PARAM(3);
  }

 protected:
  virtual ~DatarateTestCBRLarge() {}
...
TEST_P(DatarateTestCBRLarge, BasicRateTargetingVBR) {
  BasicRateTargetingVBRTest();
}

// Check basic rate targeting for CBR,
TEST_P(DatarateTestCBRLarge, BasicRateTargetingCBR) {
  BasicRateTargetingCBRTest();
}

// Check basic rate targeting for CBR.
TEST_P(DatarateTestCBRLarge, BasicRateTargeting444CBR) {
...
TEST_P(DatarateTestCBRLarge, ChangingDropFrameThresh) {
  ChangingDropFrameThreshTest();
}

class DatarateTestRealtime : public DatarateTestCBRLarge {};
...
AV1_INSTANTIATE_TEST_CASE(DatarateTestCBRLarge,
