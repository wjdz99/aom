...
<<<<<<< HEAD   (a289f0 Augment tx search pruning nn models f/ new txsizes)
  ...
  make_tuple(&aom_masked_sub_pixel_variance8x64_ssse3,
             &aom_masked_sub_pixel_variance8x64_c),
  make_tuple(&aom_masked_sub_pixel_variance32x4_ssse3,
             &aom_masked_sub_pixel_variance32x4_c),
  make_tuple(&aom_masked_sub_pixel_variance4x32_ssse3,
             &aom_masked_sub_pixel_variance4x32_c),
  make_tuple(&aom_masked_sub_pixel_variance64x4_ssse3,
             &aom_masked_sub_pixel_variance64x4_c),
