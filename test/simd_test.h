  ...
  for (unsigned int count = 0; count < iterations && !error; count++) {
    ...
    if (is_same<c_ret, c_v64>::value && is_same<c_arg1, c_v64>::value &&
      ...
      error = compare_simd2<ret, arg1, arg2, c_ret, c_arg1, c_arg2>(
          ...
          (void *)v64_load_aligned, (void *)simd, d,
          (void *)c_u64_store_aligned, (void *)c_v64_load_aligned,
          (void *)c_v64_load_aligned, (void *)ref_simd, ref_d, s1, s2);
      // U32_V128V128
    } else if (is_same<c_ret, uint32_t>::value &&
               is_same<c_arg1, c_v128>::value &&
...
MY_TEST_P(ARCH_PREFIX(S64_V64V64), TestIntrinsics) {
  test_simd2(iterations, mask, maskwidth, name, simd, ref_simd);
}
...
INSTANTIATE(ARCH, ARCH_PREFIX(S64_V64V64), SIMD_TUPLE(v64_dotp_s16, 0U, 0U));
...
INSTANTIATE(ARCH, ARCH_PREFIX(V256_V256V256),
            SIMD_TUPLE(v256_add_8, 0U, 0U),
            SIMD_TUPLE(v256_add_16, 0U, 0U),
            SIMD_TUPLE(v256_sadd_s16, 0U, 0U),
            SIMD_TUPLE(v256_add_32, 0U, 0U),
            SIMD_TUPLE(v256_sub_8, 0U, 0U),
            SIMD_TUPLE(v256_ssub_u8, 0U, 0U),
            SIMD_TUPLE(v256_ssub_s8, 0U, 0U),
            SIMD_TUPLE(v256_sub_16, 0U, 0U),
            SIMD_TUPLE(v256_ssub_s16, 0U, 0U),
            SIMD_TUPLE(v256_sub_32, 0U, 0U),
            SIMD_TUPLE(v256_ziplo_8, 0U, 0U),
            SIMD_TUPLE(v256_ziphi_8, 0U, 0U),
            SIMD_TUPLE(v256_ziplo_16, 0U, 0U),
            SIMD_TUPLE(v256_ziphi_16, 0U, 0U),
            SIMD_TUPLE(v256_ziplo_32, 0U, 0U),
            SIMD_TUPLE(v256_ziphi_32, 0U, 0U),
            SIMD_TUPLE(v256_ziplo_64, 0U, 0U),
            SIMD_TUPLE(v256_ziphi_64, 0U, 0U),
            SIMD_TUPLE(v256_unziphi_8, 0U, 0U),
            SIMD_TUPLE(v256_unziplo_8, 0U, 0U),
            SIMD_TUPLE(v256_unziphi_16, 0U, 0U),
            SIMD_TUPLE(v256_unziplo_16, 0U, 0U),
            SIMD_TUPLE(v256_unziphi_32, 0U, 0U),
            SIMD_TUPLE(v256_unziplo_32, 0U, 0U),
            SIMD_TUPLE(v256_pack_s32_s16, 0U, 0U),
            SIMD_TUPLE(v256_pack_s16_u8, 0U, 0U),
            SIMD_TUPLE(v256_pack_s16_s8, 0U, 0U),
            SIMD_TUPLE(v256_or, 0U, 0U),
            SIMD_TUPLE(v256_xor, 0U, 0U),
            SIMD_TUPLE(v256_and, 0U, 0U),
            SIMD_TUPLE(v256_andn, 0U, 0U),
            SIMD_TUPLE(v256_mullo_s16, 0U, 0U),
            SIMD_TUPLE(v256_mulhi_s16, 0U, 0U),
            SIMD_TUPLE(v256_mullo_s32, 0U, 0U),
            SIMD_TUPLE(v256_madd_s16, 0U, 0U),
            SIMD_TUPLE(v256_madd_us8, 0U, 0U),
            SIMD_TUPLE(v256_avg_u8, 0U, 0U),
            SIMD_TUPLE(v256_rdavg_u8, 0U, 0U),
            SIMD_TUPLE(v256_avg_u16, 0U, 0U),
            SIMD_TUPLE(v256_min_u8, 0U, 0U),
            SIMD_TUPLE(v256_max_u8, 0U, 0U),
            SIMD_TUPLE(v256_min_s8, 0U, 0U),
            SIMD_TUPLE(v256_max_s8, 0U, 0U),
            SIMD_TUPLE(v256_min_s16, 0U, 0U),
            SIMD_TUPLE(v256_max_s16, 0U, 0U),
            SIMD_TUPLE(v256_cmpgt_s8, 0U, 0U),
            SIMD_TUPLE(v256_cmplt_s8, 0U, 0U),
            SIMD_TUPLE(v256_cmpeq_8, 0U, 0U),
            SIMD_TUPLE(v256_cmpgt_s16, 0U, 0U),
...
INSTANTIATE(ARCH, ARCH_PREFIX(V256_V256V256_Part2),
            ...
            SIMD_TUPLE(v256_pshuffle_8, 15U, 8U),
            IMM_SIMD_TUPLE(v256_align, 1),
            IMM_SIMD_TUPLE(v256_align, 2),
            IMM_SIMD_TUPLE(v256_align, 3),
            IMM_SIMD_TUPLE(v256_align, 4),
            IMM_SIMD_TUPLE(v256_align, 5),
            IMM_SIMD_TUPLE(v256_align, 6),
            IMM_SIMD_TUPLE(v256_align, 7),
            IMM_SIMD_TUPLE(v256_align, 8),
            IMM_SIMD_TUPLE(v256_align, 9),
            IMM_SIMD_TUPLE(v256_align, 10),
            IMM_SIMD_TUPLE(v256_align, 11),
            IMM_SIMD_TUPLE(v256_align, 12),
            IMM_SIMD_TUPLE(v256_align, 13),
            IMM_SIMD_TUPLE(v256_align, 14),
            IMM_SIMD_TUPLE(v256_align, 15),
            IMM_SIMD_TUPLE(v256_align, 16),
            IMM_SIMD_TUPLE(v256_align, 17),
            IMM_SIMD_TUPLE(v256_align, 18),
            IMM_SIMD_TUPLE(v256_align, 19),
            IMM_SIMD_TUPLE(v256_align, 20),
            IMM_SIMD_TUPLE(v256_align, 21),
            IMM_SIMD_TUPLE(v256_align, 22),
            IMM_SIMD_TUPLE(v256_align, 23),
            IMM_SIMD_TUPLE(v256_align, 24),
            IMM_SIMD_TUPLE(v256_align, 25),
            IMM_SIMD_TUPLE(v256_align, 26),
            IMM_SIMD_TUPLE(v256_align, 27),
            IMM_SIMD_TUPLE(v256_align, 28),
            IMM_SIMD_TUPLE(v256_align, 29),
            IMM_SIMD_TUPLE(v256_align, 30),
            IMM_SIMD_TUPLE(v256_align, 31));

INSTANTIATE(ARCH, ARCH_PREFIX(V256_V128V128),
            SIMD_TUPLE(v256_from_v128, 0U, 0U),
            SIMD_TUPLE(v256_zip_8, 0U, 0U),
            SIMD_TUPLE(v256_zip_16, 0U, 0U),
            SIMD_TUPLE(v256_zip_32, 0U, 0U),
...
INSTANTIATE(ARCH, ARCH_PREFIX(V256_V256U32),
            SIMD_TUPLE(v256_shl_8, 7U, 32U),
            SIMD_TUPLE(v256_shr_u8, 7U, 32U),
            SIMD_TUPLE(v256_shr_s8, 7U, 32U),
...
INSTANTIATE(ARCH, ARCH_PREFIX(V256_V256),
            SIMD_TUPLE(v256_abs_s16, 0U, 0U),
            ...
            IMM_SIMD_TUPLE(v256_shr_n_byte, 1),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 2),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 3),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 4),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 5),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 6),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 7),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 8),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 9),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 10),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 11),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 12),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 13),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 14),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 15),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 16),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 17),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 18),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 19),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 20),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 21),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 22),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 23),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 24),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 25),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 26),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 27),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 28),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 29),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 30),
            IMM_SIMD_TUPLE(v256_shr_n_byte, 31),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 1),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 2),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 3),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 4),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 5),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 6),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 7),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 8),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 9),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 10),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 11),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 12),
              IMM_SIMD_TUPLE(v256_shl_n_byte, 13));
 
INSTANTIATE(ARCH, ARCH_PREFIX(V256_V256_Part2),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 14),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 15),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 16),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 17),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 18),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 19),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 20),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 21),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 22),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 23),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 24),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 25),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 26),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 27),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 28),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 29),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 30),
            IMM_SIMD_TUPLE(v256_shl_n_byte, 31),
            IMM_SIMD_TUPLE(v256_shl_n_8, 1),
            IMM_SIMD_TUPLE(v256_shl_n_8, 2),
            IMM_SIMD_TUPLE(v256_shl_n_8, 3),
            IMM_SIMD_TUPLE(v256_shl_n_8, 4),
            IMM_SIMD_TUPLE(v256_shl_n_8, 5),
            IMM_SIMD_TUPLE(v256_shl_n_8, 6),
            IMM_SIMD_TUPLE(v256_shl_n_8, 7),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 1),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 2),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 3),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 4),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 5),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 6),
            IMM_SIMD_TUPLE(v256_shr_n_u8, 7),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 1),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 2),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 3),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 4),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 5),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 6),
            IMM_SIMD_TUPLE(v256_shr_n_s8, 7),
            IMM_SIMD_TUPLE(v256_shl_n_16, 1),
            IMM_SIMD_TUPLE(v256_shl_n_16, 2),
            IMM_SIMD_TUPLE(v256_shl_n_16, 4),
            IMM_SIMD_TUPLE(v256_shl_n_16, 6),
            IMM_SIMD_TUPLE(v256_shl_n_16, 8),
            IMM_SIMD_TUPLE(v256_shl_n_16, 10),
            IMM_SIMD_TUPLE(v256_shl_n_16, 12),
            IMM_SIMD_TUPLE(v256_shl_n_16, 14),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 1),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 2),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 4));

INSTANTIATE(ARCH, ARCH_PREFIX(V256_V256_Part3),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 6),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 8),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 10),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 12),
            IMM_SIMD_TUPLE(v256_shr_n_u16, 14),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 1),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 2),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 4),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 6),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 8),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 10),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 12),
            IMM_SIMD_TUPLE(v256_shr_n_s16, 14),
            IMM_SIMD_TUPLE(v256_shl_n_32, 1),
            IMM_SIMD_TUPLE(v256_shl_n_32, 4),
            IMM_SIMD_TUPLE(v256_shl_n_32, 8),
            IMM_SIMD_TUPLE(v256_shl_n_32, 12),
            IMM_SIMD_TUPLE(v256_shl_n_32, 16),
            IMM_SIMD_TUPLE(v256_shl_n_32, 20),
            IMM_SIMD_TUPLE(v256_shl_n_32, 24),
            IMM_SIMD_TUPLE(v256_shl_n_32, 28),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 1),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 4),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 8),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 12),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 16),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 20),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 24),
            IMM_SIMD_TUPLE(v256_shr_n_u32, 28),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 1),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 4),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 8),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 12),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 16),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 20),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 24),
            IMM_SIMD_TUPLE(v256_shr_n_s32, 28));
