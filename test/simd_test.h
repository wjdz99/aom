...
#define MY_TEST_P(name, test) TEST_P(name, test)
  ...
  MY_TEST_P(ARCH_POSTFIX(V64_V64), TestIntrinsics) {
    test_simd1<c_v64, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(U64_V64), TestIntrinsics) {
    test_simd1<uint64_t, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(S64_V64), TestIntrinsics) {
    test_simd1<int64_t, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(U64_V128), TestIntrinsics) {
    test_simd1<uint64_t, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(U64_V256), TestIntrinsics) {
    test_simd1<uint64_t, c_v256>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V128_V128), TestIntrinsics) {
    test_simd1<c_v128, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V256_V256), TestIntrinsics) {
    test_simd1<c_v256, c_v256>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V256_V128), TestIntrinsics) {
    test_simd1<c_v256, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V128_V64), TestIntrinsics) {
    test_simd1<c_v128, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V64_V64V64), TestIntrinsics) {
    test_simd2<c_v64, c_v64, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V128_V128V128), TestIntrinsics) {
    test_simd2<c_v128, c_v128, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(S64_V64V64), TestIntrinsics) {
    test_simd2<int64_t, c_v64, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V256_V256V256), TestIntrinsics) {
    test_simd2<c_v256, c_v256, c_v256>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V256_V128V128), TestIntrinsics) {
    test_simd2<c_v256, c_v128, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(U32_V64V64), TestIntrinsics) {
    test_simd2<uint32_t, c_v64, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(U32_V256V256), TestIntrinsics) {
    test_simd2<uint32_t, c_v256, c_v256>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(U32_V128V128), TestIntrinsics) {
    test_simd2<uint32_t, c_v128, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(S64_V128V128), TestIntrinsics) {
    test_simd2<int64_t, c_v128, c_v128>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(S64_V256V256), TestIntrinsics) {
    test_simd2<int64_t, c_v256, c_v256>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V128_V64V64), TestIntrinsics) {
    test_simd2<c_v128, c_v64, c_v64>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V128_V128U32), TestIntrinsics) {
    test_simd2<c_v128, c_v128, uint32_t>(iterations, mask, maskwidth, name);
  }

  MY_TEST_P(ARCH_POSTFIX(V64_V64U32), TestIntrinsics) {
    test_simd2<c_v64, c_v64, uint32_t>(iterations, mask, maskwidth, name);
  }
  ...
  MY_TEST_P(ARCH_POSTFIX(V256_V256U32), TestIntrinsics) {
    test_simd2<c_v256, c_v256, uint32_t>(iterations, mask, maskwidth, name);
  }
...
#define SIMD_TUPLE(name, mask, maskwidth) \
  ...
  INSTANTIATE(
      ...
      SIMD_TUPLE(v128_unziplo_32, 0U, 0U),
      SIMD_TUPLE(v128_pack_s32_s16, 0U, 0U),
      SIMD_TUPLE(v128_pack_s16_u8, 0U, 0U),
      ...
      SIMD_TUPLE(v128_cmpgt_s16, 0U, 0U), SIMD_TUPLE(v128_cmpeq_16, 0U, 0U));
  ...
  INSTANTIATE(ARCH, ARCH_POSTFIX(V64_V64V64_Part2),
              SIMD_TUPLE(imm_v64_align<1>, 0U, 0U),
              SIMD_TUPLE(imm_v64_align<2>, 0U, 0U),
              SIMD_TUPLE(imm_v64_align<3>, 0U, 0U),
              SIMD_TUPLE(imm_v64_align<4>, 0U, 0U),
              SIMD_TUPLE(imm_v64_align<5>, 0U, 0U),
              SIMD_TUPLE(imm_v64_align<6>, 0U, 0U),
  ...
  INSTANTIATE(ARCH, ARCH_POSTFIX(V128_V64V64),
              SIMD_TUPLE(v128_from_v64, 0U, 0U), SIMD_TUPLE(v128_zip_8, 0U, 0U),
              SIMD_TUPLE(v128_zip_16, 0U, 0U), SIMD_TUPLE(v128_zip_32, 0U, 0U),
              SIMD_TUPLE(v128_mul_s16, 0U, 0U));
  ...
  INSTANTIATE(
      ARCH, ARCH_POSTFIX(V64_V64U32), SIMD_TUPLE(v64_shl_8, 7U, 32U),
      ...
      SIMD_TUPLE(v64_shr_u32, 31U, 32U), SIMD_TUPLE(v64_shr_s32, 31U, 32U));
  ...
  INSTANTIATE(
      ...
      SIMD_TUPLE(v256_cmplt_s8, 0U, 0U), SIMD_TUPLE(v256_cmpeq_8, 0U, 0U),
      SIMD_TUPLE(v256_cmpgt_s16, 0U, 0U), SIMD_TUPLE(v256_cmplt_s16, 0U, 0U));

  INSTANTIATE(
      ARCH, ARCH_POSTFIX(V256_V256V256_Part2), SIMD_TUPLE(v256_cmpeq_16, 0U, 0U),
      SIMD_TUPLE(v256_shuffle_8, 15U, 8U), SIMD_TUPLE(v256_pshuffle_8, 15U, 8U),
      SIMD_TUPLE(imm_v256_align<1>, 0U, 0U),
  ...
  INSTANTIATE(
      ARCH, ARCH_POSTFIX(V256_V128V128), SIMD_TUPLE(v256_from_v128, 0U, 0U),
      SIMD_TUPLE(v256_zip_8, 0U, 0U), SIMD_TUPLE(v256_zip_16, 0U, 0U),
      SIMD_TUPLE(v256_zip_32, 0U, 0U), SIMD_TUPLE(v256_mul_s16, 0U, 0U));
  ...
  INSTANTIATE(ARCH, ARCH_POSTFIX(V256_V256), SIMD_TUPLE(v256_abs_s16, 0U, 0U),
