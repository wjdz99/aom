...
#define MAX_NUM_THREADS_MINUS_1 7
namespace {
class AV1DecodeMultiThreadedTest
 ...
 protected:
  ...
  ::libaom_test::MD5 md5_single_thread_,
      md5_multi_thread_[MAX_NUM_THREADS_MINUS_1];
  ::libaom_test::Decoder *single_thread_dec_,
      *multi_thread_dec_[MAX_NUM_THREADS_MINUS_1];
...
class AV1DecodeMultiThreadedLSTest : public AV1DecodeMultiThreadedTest {};

TEST_P(AV1DecodeMultiThreadedLSTest, MD5Match) {
...
AV1_INSTANTIATE_TEST_CASE(AV1DecodeMultiThreadedLSTest,
