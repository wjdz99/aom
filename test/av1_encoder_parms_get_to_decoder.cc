...
class AVxEncoderParmsGetToDecoder
 ...
 protected:
  ...
  virtual bool HandleDecodeResult(const aom_codec_err_t res_dec,
    ...
    EXPECT_EQ(encode_parms.color_primaries, common->seq_params.color_primaries);
    EXPECT_EQ(encode_parms.transfer_characteristics,
              common->seq_params.transfer_characteristics);
    EXPECT_EQ(encode_parms.matrix_coefficients,
              common->seq_params.matrix_coefficients);
    EXPECT_EQ(encode_parms.chroma_sample_position,
              common->seq_params.chroma_sample_position);
    EXPECT_EQ(encode_parms.color_range, common->seq_params.color_range);
    if (encode_parms.render_size[0] > 0 && encode_parms.render_size[1] > 0) {
