...
using AllBitDepthParams =
    ::testing::Types<BitDepthParams<uint8_t, 8, false>,  // lowbd data (in
                                                         // 8-bit)
                     BitDepthParams<uint16_t, 8, true>,  // lowbd data in 16-bit
                     BitDepthParams<uint16_t, 10, true>,  // highbd data
                     BitDepthParams<uint16_t, 12, true>   // highbd data
                     >;
...
using LowBitDepthParams = ::testing::Types<BitDepthParams<uint8_t, 8, false>>;
