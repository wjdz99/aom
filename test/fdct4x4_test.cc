...
void iht4x4_10(const tran_low_t *in, uint8_t *out, int stride, int tx_type) {
  av1_inv_txfm2d_add_4x4(in, CONVERT_TO_SHORTPTR(out), stride, tx_type, 10);
}

void iht4x4_12(const tran_low_t *in, uint8_t *out, int stride, int tx_type) {
  av1_inv_txfm2d_add_4x4(in, CONVERT_TO_SHORTPTR(out), stride, tx_type, 12);
}
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&fht4x4_12, &iht4x4_12, 0, AOM_BITS_12, 16),
