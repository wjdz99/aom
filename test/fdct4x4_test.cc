...
TEST_P(Trans4x4FDCTTranLow, DISABLED_CoeffCheck) { RunCoeffCheck(); }
TEST_P(Trans4x4FDCTTranLow, DISABLED_MemCheck) { RunMemCheck(); }

using Trans4x4FDCTInt16 = Trans4x4FDCT<int16_t>;
TEST_P(Trans4x4FDCTInt16, DISABLED_CoeffCheck) { RunCoeffCheck(); }
TEST_P(Trans4x4FDCTInt16, DISABLED_MemCheck) { RunMemCheck(); }

using ::testing::make_tuple;

#if HAVE_NEON
INSTANTIATE_TEST_CASE_P(
    NEON, Trans4x4FDCTTranLow,
    ::testing::Values(
        make_tuple(&aom_fdct4x4_neon, &fdct4x4_ref, AOM_BITS_10, 16),
        make_tuple(&aom_fdct4x4_neon, &fdct4x4_ref, AOM_BITS_12, 16)));
...
#if HAVE_SSE2
INSTANTIATE_TEST_CASE_P(
    SSE2, Trans4x4FDCTTranLow,
    ::testing::Values(
        make_tuple(&aom_fdct4x4_sse2, &fdct4x4_ref, AOM_BITS_10, 16),
        make_tuple(&aom_fdct4x4_sse2, &fdct4x4_ref, AOM_BITS_12, 16)));
