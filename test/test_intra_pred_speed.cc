...
#if CONFIG_ALT_INTRA
  "SMOOTH_PRED", "LEAST_PRED", "ISLE_PRED", "PRDCT_PRED",
#if CONFIG_SMOOTH_HV
...
#define INTRA_PRED_TEST(arch, test_func, dc, dc_left, dc_top, dc_128, v, h, \
                        ...
                        least, isle, prdct, smooth_v, smooth_h)             \
  TEST(arch, test_func) {                                                   \
    static const AvxPredFunc aom_intra_pred[] = {                           \
      dc,   dc_left, dc_top, dc_128, v,  h,      d45e,     d135,            \
      d117, d153,    d207e,  d63e,   tm, smooth, least, isle, prdct,        \
      smooth_v, smooth_h       						    \
    };                                                                      \
...
#define isle_pred_func aom_isle_predictor_4x4_c
#define prdct_pred_func aom_prdct_predictor_4x4_c
#if CONFIG_SMOOTH_HV
...
INTRA_PRED_TEST(C, TestIntraPred4, aom_dc_predictor_4x4_c,
                ...
                least_pred_func, isle_pred_func, prdct_pred_func,
...
INTRA_PRED_TEST(SSE2, TestIntraPred4, aom_dc_predictor_4x4_sse2,
                ...
                tm_pred_func, NULL, NULL, NULL, NULL, NULL, NULL)
...
INTRA_PRED_TEST(SSSE3, TestIntraPred4, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                ...
                aom_d63e_predictor_4x4_ssse3, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
#endif  // HAVE_SSSE3
...
INTRA_PRED_TEST(DSPR2, TestIntraPred4, aom_dc_predictor_4x4_dspr2, NULL, NULL,
                ...
                NULL, NULL, tm_pred_func, NULL, NULL, NULL, NULL, NULL, NULL)
#undef tm_pred_func
#endif  // HAVE_DSPR2
...
INTRA_PRED_TEST(NEON, TestIntraPred4, aom_dc_predictor_4x4_neon,
                ...
                NULL, NULL, NULL, NULL, tm_pred_func, NULL, NULL, NULL, NULL, NULL, NULL)
#undef tm_pred_func
#endif  // HAVE_NEON
...
#define isle_pred_func aom_isle_predictor_8x8_c
#define prdct_pred_func aom_prdct_predictor_8x8_c
#if CONFIG_SMOOTH_HV
...
#define isle_pred_func aom_isle_predictor_16x16_c
#define prdct_pred_func aom_prdct_predictor_16x16_c
#if CONFIG_SMOOTH_HV
...
#define isle_pred_func aom_isle_predictor_32x32_c
#define prdct_pred_func aom_prdct_predictor_32x32_c
#if CONFIG_SMOOTH_HV
