...
INTRA_PRED_TEST(SSSE3_1, TX_16X16, NULL, NULL, NULL, NULL, NULL, NULL,
                ...
                aom_smooth_predictor_16x16_ssse3, aom_smooth_v_predictor_16x16,
                NULL)
