...
#if HAVE_SSE2
#if CONFIG_3WAY_PARTITIONS
HIGHBD_INTRA_PRED_TEST(SSE2_1, TX_16X16, NULL, aom_highbd_dc_left_predictor_16x16_sse2,
...
#if CONFIG_3WAY_PARTITIONS
HIGHBD_INTRA_PRED_TEST(SSE2_3, TX_16X32, NULL, aom_highbd_dc_left_predictor_16x32_sse2,
