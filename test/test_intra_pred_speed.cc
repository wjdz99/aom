...
void TestIntraPred32(AvxPredFunc const *pred_funcs) {
  static const char *const kSignatures[kNumAv1IntraFuncs] = {
    ...
    "ca5611db593093932296e5b8bacd6f05",
...
INTRA_PRED_TEST(SSE2, TestIntraPred4, aom_dc_predictor_4x4_sse2,
                ...
                aom_h_predictor_4x4_sse2, aom_d45e_predictor_4x4_sse2, NULL,
...
INTRA_PRED_TEST(NEON, TestIntraPred4, aom_dc_predictor_4x4_neon,
                ...
                aom_h_predictor_4x4_neon, aom_d45e_predictor_4x4_neon,
...
INTRA_PRED_TEST(SSE2, TestIntraPred8, aom_dc_predictor_8x8_sse2,
                ...
                aom_h_predictor_8x8_sse2, aom_d45e_predictor_8x8_sse2, NULL,
                NULL, NULL, NULL, NULL, tm_pred_func, NULL)
#undef tm_pred_func
#endif  // HAVE_SSE2
...
INTRA_PRED_TEST(SSSE3, TestIntraPred8, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
                NULL, NULL, aom_d153_predictor_8x8_ssse3, NULL,
                aom_d63e_predictor_8x8_ssse3, NULL, NULL)
#endif  // HAVE_SSSE3
...
INTRA_PRED_TEST(NEON, TestIntraPred8, aom_dc_predictor_8x8_neon,
                ...
                aom_h_predictor_8x8_neon, aom_d45e_predictor_8x8_neon, NULL,
                NULL, NULL, NULL, NULL, tm_pred_func, NULL)
#undef tm_pred_func
#endif  // HAVE_NEON
...
INTRA_PRED_TEST(SSSE3, TestIntraPred16, NULL, NULL, NULL, NULL, NULL, NULL,
                ...
                aom_d153_predictor_16x16_ssse3, NULL,
                aom_d63e_predictor_16x16_ssse3, NULL, NULL)
#endif  // HAVE_SSSE3
...
INTRA_PRED_TEST(NEON, TestIntraPred16, aom_dc_predictor_16x16_neon,
                ...
                aom_h_predictor_16x16_neon, aom_d45e_predictor_16x16_neon, NULL,
                NULL, NULL, NULL, NULL, tm_pred_func, NULL)
#undef tm_pred_func
#endif  // HAVE_NEON
...
INTRA_PRED_TEST(SSSE3, TestIntraPred32, NULL, NULL, NULL, NULL, NULL, NULL,
                ...
                aom_d153_predictor_32x32_ssse3, NULL,
                aom_d63e_predictor_32x32_ssse3, NULL, NULL)
#endif  // HAVE_SSSE3
