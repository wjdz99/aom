...
<<<<<<< HEAD   (a289f0 Augment tx search pruning nn models f/ new txsizes)
  ...
  TestFuncs(aom_obmc_sad32x4_c, aom_obmc_sad32x4_sse4_1),
  TestFuncs(aom_obmc_sad4x32_c, aom_obmc_sad4x32_sse4_1),
...
<<<<<<< HEAD   (a289f0 Augment tx search pruning nn models f/ new txsizes)
  ...
  TestFuncs(aom_obmc_sad32x4_c, aom_obmc_sad32x4_avx2),
  TestFuncs(aom_obmc_sad4x32_c, aom_obmc_sad4x32_avx2),
