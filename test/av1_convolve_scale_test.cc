...
int ntaps_to_int(NTaps ntaps) { return 8 + (int)ntaps * 2; }
...
TEST_P(LowBDConvolveScaleTest, DISABLED_TestSpeed) { SpeedTest(); }
...
TEST_P(HighBDConvolveScaleTest, DISABLED_TestSpeed) { SpeedTest(); }
