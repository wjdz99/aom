 ...
 protected:
  ...
  std::vector<ConvolveParams> GetConvParams() {
    ...
    ConvolveParams param_compound_avg =
        get_conv_params_no_round(1, 0, nullptr, 0, 0, bd_);
    convolve_params.push_back(param_no_compound);
