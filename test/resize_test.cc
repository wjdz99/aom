 ...
 protected:
  ResizeModeTestLarge()
      : EncoderTest(GET_PARAM(0)), encoding_mode_(GET_PARAM(1)),
        resize_mode_(GET_PARAM(2)), cpu_used_(GET_PARAM(3)),
        rc_end_usage_(GET_PARAM(4)) {}
  ...
  virtual void SetUp() {
    ...
    cfg_.rc_resize_denominator = 16;
    cfg_.rc_resize_kf_denominator = 16;
    init_flags_ = AOM_CODEC_USE_PSNR;
  }
...
AV1_INSTANTIATE_TEST_SUITE(ResizeModeTestLarge,
                           ...
                           ::testing::Values(1, 2), ::testing::Range(2, 9),
