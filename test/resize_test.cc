...
// Verify the dynamic resizer behavior for real time, 1 pass CBR mode  for screen
// content mode. Start at low target bitrate, raise the bitrate in the middle of
// the clip (at frame# = frame_change_bitrate_), scaling-up should occur after bitrate
// is increased.
