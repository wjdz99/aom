...
TEST_P(FrameSizeChangeTest, DecreaseThreads) { DoTest(1); }
TEST_P(FrameSizeChangeTest, IncreaseThreads) { DoTest(2); }

AV1_INSTANTIATE_TEST_SUITE(FrameSizeChangeTest, ::testing::ValuesIn(kUsage),
                           ::testing::Range(6, 7),
