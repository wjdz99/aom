 ...
 protected:
  AV1ExtTileTest()
      : EncoderTest(GET_PARAM(0)), encoding_mode_(GET_PARAM(1)),
        set_cpu_used_(GET_PARAM(2)), tile_encoding_mode_(GET_PARAM(3)) {
  ...
  virtual void PreEncodeFrameHook(::libaom_test::VideoSource *video,
    ...
    if (video->frame() == 0) {
      ...
      encoder->Control(AV1E_SET_TILE_ENCODING_MODE, tile_encoding_mode_);
  ...
  int set_cpu_used_;
  unsigned int tile_encoding_mode_;
...
AV1_INSTANTIATE_TEST_CASE(
    ...
    ::testing::Range(0, 4), ::testing::Values(1));
}  // namespace
