...
////////////////////////////////////////////////////////
using convolve_x_func = void (*)(const uint8_t *, int, uint8_t *, int, int, int,
...
/////////////////////////////////////////////////////////
using highbd_convolve_x_func = void (*)(const uint16_t *, int, uint16_t *, int,
                                        int, int, const InterpFilterParams *,
                                        const int, ConvolveParams *, int);
...
////////////////////////////////////////////////////////
using convolve_y_func = void (*)(const uint8_t *, int, uint8_t *, int, int, int,
                                 const InterpFilterParams *, const int);
...
/////////////////////////////////////////////////////////
using highbd_convolve_y_func = void (*)(const uint16_t *, int, uint16_t *, int,
                                        int, int, const InterpFilterParams *,
                                        const int, int);
...
//////////////////////////////////////////////////////////////
using convolve_copy_func = void (*)(const uint8_t *, ptrdiff_t, uint8_t *,
                                    ptrdiff_t, int, int);
...
///////////////////////////////////////////////////////////////
using highbd_convolve_copy_func = void (*)(const uint16_t *, ptrdiff_t,
                                           uint16_t *, ptrdiff_t, int, int);
...
/////////////////////////////////////////////////////////
using convolve_2d_func = void (*)(const uint8_t *, int, uint8_t *, int, int,
                                  int, const InterpFilterParams *,
                                  const InterpFilterParams *, const int,
                                  const int, ConvolveParams *);
...
using highbd_convolve_2d_func = void (*)(const uint16_t *, int, uint16_t *, int,
                                         int, int, const InterpFilterParams *,
                                         const InterpFilterParams *, const int,
                                         const int, ConvolveParams *, int);
...
//////////////////////////////////////////////////////
using compound_conv_2d_copy_func = void (*)(const uint8_t *, int, uint8_t *,
                                            int, int, int, ConvolveParams *);
...
///////////////////////////////////////////////////////
using highbd_compound_conv_2d_copy_func = void (*)(const uint16_t *, int,
