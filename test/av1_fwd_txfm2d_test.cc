...
class AV1FwdTxfm2dSimdTest
    : public ::testing::TestWithParam<LbdFwdTxfm2dParam> {};

TEST_P(AV1FwdTxfm2dSimdTest, match) {
...
INSTANTIATE_TEST_CASE_P(SSE2, AV1FwdTxfm2dSimdTest,
...
INSTANTIATE_TEST_CASE_P(SSE4_1, AV1FwdTxfm2dSimdTest,
