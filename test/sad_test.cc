...
#if !CONFIG_REALTIME_ONLY
const SadMxNx4AvgParam x4d_avg_neon_tests[] = {
  make_tuple(128, 128, &aom_sad128x128x4d_avg_neon, -1),
  make_tuple(128, 64, &aom_sad128x64x4d_avg_neon, -1),
  make_tuple(64, 128, &aom_sad64x128x4d_avg_neon, -1),
  make_tuple(64, 64, &aom_sad64x64x4d_avg_neon, -1),
  make_tuple(64, 32, &aom_sad64x32x4d_avg_neon, -1),
  make_tuple(32, 64, &aom_sad32x64x4d_avg_neon, -1),
  make_tuple(32, 32, &aom_sad32x32x4d_avg_neon, -1),
  make_tuple(32, 16, &aom_sad32x16x4d_avg_neon, -1),
  make_tuple(16, 32, &aom_sad16x32x4d_avg_neon, -1),
  make_tuple(16, 16, &aom_sad16x16x4d_avg_neon, -1),
  make_tuple(16, 8, &aom_sad16x8x4d_avg_neon, -1),
  make_tuple(8, 16, &aom_sad8x16x4d_avg_neon, -1),
  make_tuple(8, 8, &aom_sad8x8x4d_avg_neon, -1),
  make_tuple(8, 4, &aom_sad8x4x4d_avg_neon, -1),
  make_tuple(4, 8, &aom_sad4x8x4d_avg_neon, -1),
  make_tuple(4, 4, &aom_sad4x4x4d_avg_neon, -1),
  make_tuple(64, 16, &aom_sad64x16x4d_avg_neon, -1),
  make_tuple(16, 64, &aom_sad16x64x4d_avg_neon, -1),
  make_tuple(32, 8, &aom_sad32x8x4d_avg_neon, -1),
  make_tuple(8, 32, &aom_sad8x32x4d_avg_neon, -1),
  make_tuple(16, 4, &aom_sad16x4x4d_avg_neon, -1),
  make_tuple(4, 16, &aom_sad4x16x4d_avg_neon, -1),
};
INSTANTIATE_TEST_SUITE_P(NEON, SADx4AvgTest,
                         ::testing::ValuesIn(x4d_avg_neon_tests));
#endif  // !CONFIG_REALTIME_ONLY
