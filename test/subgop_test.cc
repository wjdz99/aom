...
static const SubgopTestParams InputParams[] = {
  ...
  { "def", "hantro_collage_w352h288.yuv", 0, 32, 352, 288, 3 },
  { "def", "desktop1.320_180.yuv", 0, 32, 320, 180, 5 },
  ...
  { "enh", "pixel_capture_w320h240.yuv", 0, 24, 320, 240, 3 },
  { "enh", "niklas_1280_720_30.y4m", 0, 11, 1280, 720, 5 },
  { "enh", "screendata.y4m", 0, 32, 640, 480, 5 },
...
class SubGopTestLarge
 ...
 protected:
  ...
  SubGOPCfg *DetermineSubgopConfig() {
    ...
    subgop_code_test_ = SUBGOP_IN_GOP_GENERIC;
    assert(cfg_count < MAX_SUBGOP_STATS_SIZE);
...
TEST_P(SubGopTestLarge, SubGopTest) {
  libaom_test::I420VideoSource video(
      ...
      subgop_test_params_.frame_h, cfg_.g_timebase.den, cfg_.g_timebase.num, 0,
      200);
