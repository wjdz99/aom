...
AOM_UNUSED static void yuvconfig2image(aom_image_t *img,
                                       const YV12_BUFFER_CONFIG *yv12,
                                       void *user_priv);
AOM_UNUSED static aom_codec_err_t image2yuvconfig(const aom_image_t *img,
...
static const SubgopTestParams SubGopTestVectors[] = {
  ...
  { "def", "hantro_collage_w352h288.yuv", 0, 16, 352, 288, 3 },
  { "def", "desktop1.320_180.yuv", 0, 16, 320, 180, 5 },
  { "def", "pixel_capture_w320h240.yuv", 0, 16, 320, 240, 3 },

  { "enh", "niklas_640_480_30.yuv", 0, 15, 640, 480, 5 },
  { "enh", "paris_352_288_30.y4m", 0, 6, 352, 288, 3 },
  { "enh", "hantro_collage_w352h288.yuv", 0, 16, 352, 288, 3 },
  { "enh", "pixel_capture_w320h240.yuv", 0, 12, 320, 240, 3 },
  { "enh", "niklas_1280_720_30.y4m", 0, 11, 1280, 720, 5 },
  { "enh", "screendata.y4m", 0, 16, 640, 480, 5 },
  { "enh", "pixel_capture_w320h240.yuv", 0, 14, 320, 240, 3 },
  { "enh", "desktop1.320_180.yuv", 0, 10, 320, 180, 3 },
  { "enh", "paris_352_288_30.y4m", 0, 13, 352, 288, 5 },
  { "enh", "pixel_capture_w320h240.yuv", 0, 8, 320, 240, 5 },

  { "asym", "pixel_capture_w320h240.yuv", 0, 16, 320, 240, 5 },
  { "asym", "desktop1.320_180.yuv", 0, 16, 320, 180, 3 },

  { "ts", "pixel_capture_w320h240.yuv", 0, 16, 320, 240, 3 },
  { "ts", "hantro_collage_w352h288.yuv", 0, 16, 352, 288, 5 },

  // TODO(vishnu) : enable ld config
  // { "ld", "paris_352_288_30.y4m", 0, 16, 352, 288, 5 },
  // { "ld", "desktop1.320_180.yuv", 0, 16, 320, 180, 3 },
...
// TODO(Aasaipriya): Uncomment when overlay frame movement from first step of
