...
#define ALL_TEST_MODES \
  ::testing::Values(::libaom_test::kRealTime, ::libaom_test::kOnePassGood, ::libaom_test::kTwoPassGood)

#define ONE_PASS_TEST_MODES ::testing::Values(::libaom_test::kRealTime, ::libaom_test::kOnePassGood)
