...
class LosslessTestAllIntraLarge : public LosslessTestLarge {};

TEST_P(LosslessTestAllIntraLarge, TestLossLessEncodingCtrl) {
  const aom_rational timebase = { 33333333, 1000000000 };
  cfg_.g_timebase = timebase;
  // Intentionally set Q > 0, to make sure control can be used to activate
  // lossless
...
AV1_INSTANTIATE_TEST_SUITE(LosslessTestAllIntraLarge,
