...
void LosslessTestLarge::TestLosslessEncodingVGA() {
  const aom_rational timebase = { 33333333, 1000000000 };
  cfg_.g_timebase = timebase;
  cfg_.rc_target_bitrate = 2000;
  cfg_.g_lag_in_frames = 25;
...
TEST_P(LosslessRealtimeTestLarge, TestLosslessEncodingVGA) {
  TestLosslessEncodingVGA();
}
