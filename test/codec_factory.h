...
class AV1Decoder : public Decoder {
 public:
  AV1Decoder(vpx_codec_dec_cfg_t cfg, unsigned long deadline)
      : Decoder(cfg, deadline) {}

  AV1Decoder(vpx_codec_dec_cfg_t cfg, const vpx_codec_flags_t flag,
...
class AV1Encoder : public Encoder {
 public:
  AV1Encoder(vpx_codec_enc_cfg_t cfg, unsigned long deadline,
