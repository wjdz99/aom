...
cat << EOF
  Usage: ${0##*/} [arguments]
    ...
    \$AOM_TEST_DATA_PATH and then the current directory.
EOF
}
...
AOM_TEST_DATA_PATH="${AOM_TEST_DATA_PATH:-.}"
...
VP8_IVF_FILE="${AOM_TEST_DATA_PATH}/vp80-00-comprehensive-001.ivf"
VP9_IVF_FILE="${AOM_TEST_DATA_PATH}/vp90-2-09-subpixel-00.ivf"

VP9_WEBM_FILE="${AOM_TEST_DATA_PATH}/vp90-2-00-quantizer-00.webm"
VP9_FPM_WEBM_FILE="${AOM_TEST_DATA_PATH}/vp90-2-07-frame_parallel-1.webm"
VP9_LT_50_FRAMES_WEBM_FILE="${AOM_TEST_DATA_PATH}/vp90-2-02-size-32x08.webm"

YUV_RAW_INPUT="${AOM_TEST_DATA_PATH}/hantro_collage_w352h288.yuv"
YUV_RAW_INPUT_WIDTH=352
YUV_RAW_INPUT_HEIGHT=288

Y4M_NOSQ_PAR_INPUT="${AOM_TEST_DATA_PATH}/park_joy_90p_8_420_a10-1.y4m"
Y4M_720P_INPUT="${AOM_TEST_DATA_PATH}/niklas_1280_720_30.y4m"
