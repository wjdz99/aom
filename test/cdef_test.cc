            ...
            for (dir = 0; dir < 8; dir++) {
              for (pristrength = 0; pristrength <= 19 << (depth - 8) && !error;
                ...
                for (secstrength = 0; secstrength <= 4 << (depth - 8) && !error;
                  ...
                  // speed
                  if (cdef.fn[0] != ref_cdef.fn[0])
                    API_REGISTER_STATE_CHECK(cdef.fn[strength_index](
                        d, size, s + CDEF_HBORDER + CDEF_VBORDER * CDEF_BSTRIDE,
                        pristrength, secstrength, dir, pridamping, secdamping,
                        depth - 8, block_width, block_height));
                  if (ref_cdef.fn[0] != cdef.fn[0]) {
...
static const CdefFilterBlockFunctions cdef_filter_func_c[] ={
  &cdef_filter_8_0_c, &cdef_filter_8_1_c, &cdef_filter_8_2_c, &cdef_filter_8_3_c
};

static const CdefFilterBlockFunctions cdef_filter_highbd_func_c[] = {
  &cdef_filter_16_0_c, &cdef_filter_16_0_c, &cdef_filter_16_0_c,
  &cdef_filter_16_0_c
};

#if HAVE_SSE2
static const CdefFilterBlockFunctions cdef_filter_func_sse2[] = {
  { &cdef_filter_8_0_sse2, &cdef_filter_8_1_sse2, &cdef_filter_8_2_sse2,
    &cdef_filter_8_3_sse2 }
};

static const CdefFilterBlockFunctions cdef_filter_highbd_func_sse2[] = {
...
INSTANTIATE_TEST_SUITE_P(
    SSE2, CDEFBlockTest,
    ::testing::Combine(::testing::ValuesIn(cdef_filter_func_sse2),
                       ::testing::ValuesIn(cdef_filter_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Values(8)));
INSTANTIATE_TEST_SUITE_P(
    SSE2, CDEFBlockHighbdTest,
    ::testing::Combine(::testing::ValuesIn(cdef_filter_highbd_func_sse2),
                       ::testing::ValuesIn(cdef_filter_highbd_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
...
#if HAVE_SSSE3
static const CdefFilterBlockFunctions cdef_filter_func_ssse3[] = {
  { &cdef_filter_8_0_ssse3, &cdef_filter_8_1_ssse3, &cdef_filter_8_2_ssse3,
    &cdef_filter_8_3_ssse3 }
};

static const CdefFilterBlockFunctions cdef_filter_highbd_func_ssse3[] = {
...
INSTANTIATE_TEST_SUITE_P(
    SSSE3, CDEFBlockTest,
    ::testing::Combine(::testing::ValuesIn(cdef_filter_func_ssse3),
                       ::testing::ValuesIn(cdef_filter_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Values(8)));
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::ValuesIn(cdef_filter_highbd_func_ssse3),
                       ::testing::ValuesIn(cdef_filter_highbd_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Range(10, 13, 2)));
...
#if HAVE_SSE4_1
static const CdefFilterBlockFunctions cdef_filter_func_sse4_1[] = {
  { &cdef_filter_8_0_sse4_1, &cdef_filter_8_1_sse4_1, &cdef_filter_8_2_sse4_1,
    &cdef_filter_8_3_sse4_1 }
};

static const CdefFilterBlockFunctions cdef_filter_highbd_func_sse4_1[] = {
  { &cdef_filter_16_0_sse4_1, &cdef_filter_16_1_sse4_1, &cdef_filter_16_2_sse4_1,
    &cdef_filter_16_3_sse4_1 }
};

INSTANTIATE_TEST_SUITE_P(
    SSE4_1, CDEFBlockTest,
    ::testing::Combine(::testing::ValuesIn(cdef_filter_func_sse4_1),
                       ::testing::ValuesIn(cdef_filter_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Values(8)));
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::ValuesIn(cdef_filter_highbd_func_sse4_1),
                       ::testing::ValuesIn(cdef_filter_highbd_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Range(10, 13, 2)));
...
#if HAVE_AVX2
static const CdefFilterBlockFunctions cdef_filter_func_avx2[] = {
  { &cdef_filter_8_0_avx2, &cdef_filter_8_1_avx2, &cdef_filter_8_2_avx2,
    &cdef_filter_8_3_avx2 }
};

static const CdefFilterBlockFunctions cdef_filter_highbd_func_avx2[] = {
...
INSTANTIATE_TEST_SUITE_P(
    AVX2, CDEFBlockTest,
    ::testing::Combine(::testing::ValuesIn(cdef_filter_func_avx2),
                       ::testing::ValuesIn(cdef_filter_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Values(8)));
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::ValuesIn(cdef_filter_highbd_func_avx2),
                       ::testing::ValuesIn(cdef_filter_highbd_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Range(10, 13, 2)));
...
#if HAVE_NEON
static const CdefFilterBlockFunctions cdef_filter_func_neon[] = {
  { &cdef_filter_8_0_neon, &cdef_filter_8_1_neon, &cdef_filter_8_2_neon,
    &cdef_filter_8_3_neon }
};

static const CdefFilterBlockFunctions cdef_filter_highbd_func_neon[] = {
...
INSTANTIATE_TEST_SUITE_P(
    NEON, CDEFBlockTest,
    ::testing::Combine(::testing::ValuesIn(cdef_filter_func_neon),
                       ::testing::ValuesIn(cdef_filter_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Values(8)));
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::ValuesIn(cdef_filter_highbd_func_neon),
                       ::testing::ValuesIn(cdef_filter_highbd_func_c),
                       ::testing::Values(BLOCK_4X4, BLOCK_4X8, BLOCK_8X4,
                                         BLOCK_8X8),
                       ::testing::Range(0, 16), ::testing::Range(10, 13, 2)));
