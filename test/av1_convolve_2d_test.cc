...
INSTANTIATE_TEST_CASE_P(AVX2, AV1Convolve2DTest,
                        libaom_test::AV1Convolve2D::BuildParams(
                            av1_convolve_2d_avx2, av1_jnt_convolve_2d_sse4_1));
#else
TEST_P(AV1Convolve2DTest, CheckOutput) { RunCheckOutput(GET_PARAM(2)); }
...
#if HAVE_SSE4_1
TEST_P(AV1HighbdConvolve2DTest, CheckOutput2) { RunCheckOutput2(GET_PARAM(4)); }
#endif

INSTANTIATE_TEST_CASE_P(SSE4_1, AV1HighbdConvolve2DTest,
