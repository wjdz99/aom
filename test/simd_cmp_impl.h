...
void s32_store_aligned(void *p, int32_t a) {
  u32_store_aligned(p, (uint32_t)a);
}
void s64_store_aligned(void *p, int64_t a) {
  v64_store_aligned(p, v64_from_64((uint64_t)a));
}
...
void c_s32_store_aligned(void *p, int32_t a) {
  c_u32_store_aligned(p, (uint32_t)a);
}

void c_s64_store_aligned(void *p, int64_t a) {
  c_v64_store_aligned(p, c_v64_from_64((uint64_t)a));
}

uint64_t u64_load_aligned(const void *p) {
  return v64_u64(v64_load_aligned(p));
}
uint16_t u16_load_aligned(const void *p) { return *((uint16_t *)p); }
uint8_t u8_load_aligned(const void *p) { return *((uint8_t *)p); }

uint64_t c_u64_load_aligned(const void *p) {
  return c_v64_u64(c_v64_load_aligned(p));
}
uint16_t c_u16_load_aligned(const void *p) { return *((uint16_t *)p); }
uint8_t c_u8_load_aligned(const void *p) { return *((uint8_t *)p); }
