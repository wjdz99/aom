...
int CompareSimd1Arg(const void *store, const void *load, const void *simd,
  ...
  void (*const my_store)(void *, Ret) =
      reinterpret_cast<void (*const)(void *, Ret)>(store);
  Arg (*const my_load)(const void *) =
      reinterpret_cast<Arg (*const)(const void *)>(load);
  Ret (*const my_simd)(Arg) = reinterpret_cast<Ret (*const)(Arg)>(simd);
  void (*const my_c_store)(void *, CRet) =
      reinterpret_cast<void (*const)(void *, CRet)>(c_store);
  CArg (*const my_c_load)(const void *) =
      reinterpret_cast<CArg (*const)(const void *)>(c_load);
  CRet (*const my_c_simd)(CArg) = reinterpret_cast<CRet (*const)(CArg)>(c_simd);
...
int CompareSimd2Args(const void *store, const void *load1, const void *load2,
  ...
  void (*const my_store)(void *, Ret) =
      reinterpret_cast<void (*const)(void *, Ret)>(store);
  Arg1 (*const my_load1)(const void *) =
      reinterpret_cast<Arg1 (*const)(const void *)>(load1);
  Arg2 (*const my_load2)(const void *) =
      reinterpret_cast<Arg2 (*const)(const void *)>(load2);
  Ret (*const my_simd)(Arg1, Arg2) =
      reinterpret_cast<Ret (*const)(Arg1, Arg2)>(simd);
  void (*const my_c_store)(void *, CRet) =
      reinterpret_cast<void (*const)(void *, CRet)>(c_store);
  CArg1 (*const my_c_load1)(const void *) =
      reinterpret_cast<CArg1 (*const)(const void *)>(c_load1);
  CArg2 (*const my_c_load2)(const void *) =
      reinterpret_cast<CArg2 (*const)(const void *)>(c_load2);
  CRet (*const my_c_simd)(CArg1, CArg2) =
      reinterpret_cast<CRet (*const)(CArg1, CArg2)>(c_simd);
