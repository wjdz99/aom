...
const HighbdMaskedSADParam hbd_msad_test[] = {
  ...
  make_tuple(&aom_highbd_masked_sad64x128_ssse3, aom_highbd_masked_sad64x128_c),
  make_tuple(&aom_highbd_masked_sad128x64_ssse3, aom_highbd_masked_sad128x64_c),
...
const HighbdMaskedSADParam hbd_msad_avx2_test[] = {
  ...
  make_tuple(&aom_highbd_masked_sad64x16_avx2, aom_highbd_masked_sad64x16_ssse3)
};
