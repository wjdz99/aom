...
#if HAVE_DSPR2 && !CONFIG_EMULATE_HARDWARE && !CONIFG_HIGHBITDEPTH
...
#endif  // HAVE_DSPR2 && !CONFIG_EMULATE_HARDWARE && !CONIFG_HIGHBITDEPTH

#if HAVE_MSA && !CONFIG_EMULATE_HARDWARE && !CONIFG_HIGHBITDEPTH
// 32x32_135_ is implemented using the 1024 version.
...
#endif  // HAVE_MSA && !CONFIG_EMULATE_HARDWARE && !CONIFG_HIGHBITDEPTH
