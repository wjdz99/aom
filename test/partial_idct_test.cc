...
#if CONFIG_HIGHBITDEPTH
// TODO(luoyi)
// Import the following NEON functions
// make_tuple(&aom_highbd_fdct32x32_c,
//            &highbd_wrapper<aom_highbd_idct32x32_1024_add_c>,
...
//     &aom_highbd_fdct32x32_c,
//     &highbd_wrapper<aom_highbd_idct32x32_1024_add_c>,
//     &highbd_wrapper<aom_highbd_idct32x32_135_add_neon>, TX_32X32, 135, 10,
//     2),
// make_tuple(
//     &aom_highbd_fdct32x32_c,
//     &highbd_wrapper<aom_highbd_idct32x32_1024_add_c>,
//     &highbd_wrapper<aom_highbd_idct32x32_135_add_neon>, TX_32X32, 135, 12,
//     2),
// make_tuple(
//     &aom_highbd_fdct32x32_c,
//     &highbd_wrapper<aom_highbd_idct32x32_1024_add_c>,
...
// make_tuple(
//     &aom_highbd_fdct16x16_c, &highbd_wrapper<aom_highbd_idct16x16_256_add_c>,
//     &highbd_wrapper<aom_highbd_idct16x16_256_add_neon>, TX_16X16, 256, 10,
//     2),
// make_tuple(
//     &aom_highbd_fdct16x16_c, &highbd_wrapper<aom_highbd_idct16x16_256_add_c>,
//     &highbd_wrapper<aom_highbd_idct16x16_256_add_neon>, TX_16X16, 256, 12,
//     2),
// make_tuple(
//     &aom_highbd_fdct16x16_c, &highbd_wrapper<aom_highbd_idct16x16_256_add_c>,
...
// make_tuple(&aom_highbd_fdct8x8_c,
//            &highbd_wrapper<aom_highbd_idct8x8_64_add_c>,
//            &highbd_wrapper<aom_highbd_idct8x8_64_add_neon>, TX_8X8, 64, 8,
//            2),
// make_tuple(
...
//            &highbd_wrapper<aom_highbd_idct8x8_12_add_neon>, TX_8X8, 12, 8,
//            2),
// make_tuple(
...
// make_tuple(&aom_highbd_fdct8x8_c,
// &highbd_wrapper<aom_highbd_idct8x8_1_add_c>,
...
// make_tuple(&aom_highbd_fdct4x4_c,
//            &highbd_wrapper<aom_highbd_idct4x4_16_add_c>,
//            &highbd_wrapper<aom_highbd_idct4x4_16_add_neon>, TX_4X4, 16, 8,
//            2),
// make_tuple(
...
const PartialInvTxfmParam sse2_partial_idct_tests[] = {
  ...
  // make_tuple(&aom_highbd_fdct8x8_c,
  //            &highbd_wrapper<aom_highbd_idct8x8_64_add_c>,
  //            &highbd_wrapper<aom_highbd_idct8x8_12_add_sse2>, TX_8X8, 12, 8,
  //            2),
  // make_tuple(
  //     &aom_highbd_fdct8x8_c, &highbd_wrapper<aom_highbd_idct8x8_64_add_c>,
