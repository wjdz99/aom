...
using GetNzMapContextsFunc = void (*)(const uint8_t *const,
                                      const int16_t *const, const uint16_t,
                                      const TX_SIZE, const TX_CLASS,
                                      int8_t *const);
...
using av1_txb_init_levels_func = void (*)(const tran_low_t *const, const int,
                                          const int, uint8_t *const);
