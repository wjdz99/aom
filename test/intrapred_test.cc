...
const IntraPredFunc<IntraPred> LowbdIntraPredTestVector[] = {
  lowbd_entry(dc, 4, 4, sse2),   lowbd_entry(dc, 4, 8, sse2),
  lowbd_entry(dc, 8, 4, sse2),   lowbd_entry(dc, 8, 8, sse2),
  lowbd_entry(dc, 8, 16, sse2),  lowbd_entry(dc, 16, 8, sse2),
  lowbd_entry(dc, 16, 16, sse2), lowbd_entry(dc, 16, 32, sse2),
  lowbd_entry(dc, 32, 16, sse2), lowbd_entry(dc, 32, 32, sse2),
};
