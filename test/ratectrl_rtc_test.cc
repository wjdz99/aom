...
class RcInterfaceTest : public ::libaom_test::EncoderTest,
 ...
 public:
  RcInterfaceTest()
      : EncoderTest(GET_PARAM(0)), aq_mode_(GET_PARAM(1)), key_interval_(3000),
        ...
        dynamic_spatial_layers_(false), num_drops_(0), max_consec_drop_time_(0),
 ...
 protected:
  ...
  void PreEncodeFrameHook(libaom_test::VideoSource *video,
    ...
    if (video->frame() == 0 && layer_frame_cnt_ == 0) {
      ...
      encoder->Control(AV1E_SET_MAX_CONSEC_FRAME_DROP_CBR,
                       max_consec_drop_time_);
    }
 ...
 private:
  void SetConfig() {
    ...
    rc_cfg_.max_consec_drop_time = max_consec_drop_time_;
