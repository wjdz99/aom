...
TEST_P(RcInterfaceTest, CreateAV1RateControlAV1Test) {
  TestCreateAV1RateControlAV1();
}

TEST_P(RcInterfaceTest, UpdateRateControllerAV1Test) {
  TestUpdateRateControlAV1();
}

TEST_P(RcInterfaceTest, GetQpRateControllerAV1Test) {
  TestGetQPRateControlAV1();
}

TEST_P(RcInterfaceTest, ComputeQPRateControllerAV1Test) {
  TestComputeQPRateControlAV1();
}

TEST_P(RcInterfaceTest, GetLoopFilterLevelRateControllerAV1Test) {
  TestGetLoopFilterLevelRateControlAV1();
}

TEST_P(RcInterfaceTest, PostEncodeUpdateRateControllerAV1Test) {
  TestPostEncodeUpdateRateControlAV1();
}

TEST_P(RcInterfaceTest, GetSegmenationDataRateControllerAV1Test) {
  TestGetSegmenationDataRateControlAV1();
}

TEST_P(RcInterfaceTest, GetCdedInfoRateControllerAV1Test) {
  TestGetCdedInfoRateControlAV1();
}

TEST_P(RcInterfaceTest, CreateAV1RateControlConfigAV1Test) {
  TestCreateAV1RateControlConfigAV1();
}

TEST_P(RcInterfaceTest, DestoryAV1RateControlRTCAV1Test) {
