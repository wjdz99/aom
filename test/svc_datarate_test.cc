...
class DatarateTestSVC
 ...
 protected:
  ...
  virtual int set_layer_pattern(
    ...
    if (comp_pred) {
      ref_frame_comp_pred->svc_use_comp_pred[0] = 1;  // GOLDEN_LAST
      ref_frame_comp_pred->svc_use_comp_pred[1] = 1;  // LAST2_LAST
      ref_frame_comp_pred->svc_use_comp_pred[2] = 1;  // ALTREF_LAST
    }
