 ...
 protected:
  ...
  void DoTest() {
    ...
    if (row_mt_ == 0) {
      ...
      DoTestExt(&video, single_thr_size_enc, single_thr_md5_enc,
                single_thr_md5_dec);
    } else if (row_mt_ == 1) {
      ...
      DoTestExt(&video, multi_thr2_row_mt_size_enc, multi_thr2_row_mt_md5_enc,
                multi_thr2_row_mt_md5_dec);
    }
  }

  virtual void DoTestExt(::libaom_test::YUVVideoSource *video,
