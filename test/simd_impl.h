...
MY_TEST_P(ArchPostfix(V64_U8), TestIntrinsics) {
  TestSimd1Arg<CV64, uint8_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_U16), TestIntrinsics) {
  TestSimd1Arg<CV64, uint16_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_U32), TestIntrinsics) {
  TestSimd1Arg<CV64, uint32_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_V64), TestIntrinsics) {
  TestSimd1Arg<CV64, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(U64_V64), TestIntrinsics) {
  TestSimd1Arg<uint64_t, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(S64_V64), TestIntrinsics) {
  TestSimd1Arg<int64_t, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(U32_V64), TestIntrinsics) {
  TestSimd1Arg<uint32_t, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(S32_V64), TestIntrinsics) {
  TestSimd1Arg<int32_t, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_U32U32), TestIntrinsics) {
  TestSimd2Args<CV64, uint32_t, uint32_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_V64V64), TestIntrinsics) {
  TestSimd2Args<CV64, CV64, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(S64_V64V64), TestIntrinsics) {
  TestSimd2Args<int64_t, CV64, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(U32_V64V64), TestIntrinsics) {
  TestSimd2Args<uint32_t, CV64, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_V64U32), TestIntrinsics) {
  TestSimd2Args<CV64, CV64, uint32_t>(kIterations, mask, maskwidth, name);
}
...
MY_TEST_P(ArchPostfix(U32_V128), TestIntrinsics) {
  TestSimd1Arg<uint32_t, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(U64_V128), TestIntrinsics) {
  TestSimd1Arg<uint64_t, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V64_V128), TestIntrinsics) {
  TestSimd1Arg<CV64, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_V128), TestIntrinsics) {
  TestSimd1Arg<Cv128, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_U8), TestIntrinsics) {
  TestSimd1Arg<Cv128, uint8_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_U16), TestIntrinsics) {
  TestSimd1Arg<Cv128, uint16_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_U32), TestIntrinsics) {
  TestSimd1Arg<Cv128, uint32_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_V64), TestIntrinsics) {
  TestSimd1Arg<Cv128, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_V128V128), TestIntrinsics) {
  TestSimd2Args<Cv128, Cv128, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(U32_V128V128), TestIntrinsics) {
  TestSimd2Args<uint32_t, Cv128, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(S64_V128V128), TestIntrinsics) {
  TestSimd2Args<int64_t, Cv128, Cv128>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_U64U64), TestIntrinsics) {
  TestSimd2Args<Cv128, uint64_t, uint64_t>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_V64V64), TestIntrinsics) {
  TestSimd2Args<Cv128, CV64, CV64>(kIterations, mask, maskwidth, name);
}

MY_TEST_P(ArchPostfix(V128_V128U32), TestIntrinsics) {
  TestSimd2Args<Cv128, Cv128, uint32_t>(kIterations, mask, maskwidth, name);
}
