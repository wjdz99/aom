...
INSTANTIATE(ARCH, ARCH_POSTFIX(V128_V128U32), SIMD_TUPLE(v128_shl_8, 7U, 32U),
            ...
            SIMD_TUPLE(v128_shl_64, 63U, 32U),
            SIMD_TUPLE(v128_shr_u64, 63U, 32U),
...
INSTANTIATE(
    ...
    SIMD_TUPLE(v256_pack_s32_u16, 0U, 0U), SIMD_TUPLE(v256_rdavg_u16, 0U, 0U),
...
INSTANTIATE(
    ...
    SIMD_TUPLE(v256_sadd_u8, 0U, 0U), SIMD_TUPLE(v256_pack_s32_s16, 0U, 0U),
    SIMD_TUPLE(v256_pack_s16_u8, 0U, 0U), SIMD_TUPLE(imm_v256_align<2>, 0U, 0U),
...
INSTANTIATE(ARCH, ARCH_POSTFIX(V256_V256U32), SIMD_TUPLE(v256_shl_8, 7U, 32U),
            ...
            SIMD_TUPLE(v256_shl_64, 63U, 32U),
            SIMD_TUPLE(v256_shr_u64, 63U, 32U),
