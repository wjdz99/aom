...
INSTANTIATE(
    ...
    SIMD_TUPLE(v256_ziphi_64, 0U, 0U), SIMD_TUPLE(v256_ziplo_128, 0U, 0U),
    SIMD_TUPLE(v256_ziphi_128, 0U, 0U), SIMD_TUPLE(v256_unziphi_8, 0U, 0U),
...
INSTANTIATE(ARCH, ARCH_POSTFIX(V256_U32), SIMD_TUPLE(v256_dup_8, 0xffU, 32U),
            SIMD_TUPLE(v256_dup_16, 0xffffU, 32U),
            SIMD_TUPLE(v256_dup_32, 0U, 0U));
