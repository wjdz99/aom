...
const FrameDimension kFrameDim[] = {
  ...
  make_tuple(256, 256),   make_tuple(112, 112),   make_tuple(272, 272),
  make_tuple(120, 120),   make_tuple(280, 280),   make_tuple(16, 16),
  make_tuple(24, 24),     make_tuple(42, 42),     make_tuple(50, 50),
};
