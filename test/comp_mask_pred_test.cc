...
class AV1PredTestBase : public ::testing::Test {
 public:
  ~AV1PredTestBase();
  void SetUp();
...
AV1PredTestBase::~AV1PredTestBase() {}

void AV1PredTestBase::SetUp() {
...
class AV1HighbdPredTestBase : public ::testing::Test {
 public:
  ~AV1HighbdPredTestBase();
  void SetUp();
...
AV1HighbdPredTestBase::~AV1HighbdPredTestBase() {}

void AV1HighbdPredTestBase::SetUp() {
  rnd_.Reset(libaom_test::ACMRandom::DeterministicSeed());
  av1_init_wedge_masks();
...
void AV1HighbdPredTestBase::TearDown() {
  aom_free(comp_pred1_);
  aom_free(comp_pred2_);
  aom_free(pred_);
  aom_free(ref_buffer_);
