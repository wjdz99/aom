...
static_assert(offsetof(DepthwiseConvParams, input_row_size) == OFFSET_INPUT_ROW_SIZE, "");
static_assert(offsetof(DepthwiseConvParams, output_depth) == OFFSET_OUTPUT_DEPTH, "");
static_assert(offsetof(DepthwiseConvParams, output_row_size) == OFFSET_OUTPUT_ROW_SIZE, "");
static_assert(offsetof(DepthwiseConvParams, filter_row_size) == OFFSET_FILTER_ROW_SIZE, "");
static_assert(offsetof(DepthwiseConvParams, input_offset) == OFFSET_INPUT_OFFSET, "");
static_assert(offsetof(DepthwiseConvParams, output_offset) == OFFSET_OUTPUT_OFFSET, "");
static_assert(offsetof(DepthwiseConvParams, output_multiplier) == OFFSET_OUTPUT_MULTIPLIER, "");
static_assert(offsetof(DepthwiseConvParams, output_activation_min) == OFFSET_OUTPUT_ACTIVATION_MIN,
              "");
static_assert(offsetof(DepthwiseConvParams, output_activation_max) == OFFSET_OUTPUT_ACTIVATION_MAX,
              "");
static_assert(offsetof(DepthwiseConvParams, output_right_shift) == OFFSET_OUTPUT_RIGHT_SHIFT, "");
static_assert(offsetof(DepthwiseConvParams, input_width) == OFFSET_INPUT_WIDTH, "");
static_assert(offsetof(DepthwiseConvParams, input_height) == OFFSET_INPUT_HEIGHT, "");
static_assert(offsetof(DepthwiseConvParams, stride_width) == OFFSET_STRIDE_WIDTH, "");
static_assert(offsetof(DepthwiseConvParams, stride_height) == OFFSET_STRIDE_HEIGHT, "");
static_assert(offsetof(DepthwiseConvParams, output_width) == OFFSET_OUTPUT_WIDTH, "");
static_assert(offsetof(DepthwiseConvParams, output_height) == OFFSET_OUTPUT_HEIGHT, "");

template <>
struct DepthwiseConvWindowPerChannel<DepthwiseConvOutputRounding::kUpward, 8, 1, 1> {
 public:
  static inline void Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr,
                         const int8* input_ptr, const int8* filter_ptr, const int32* bias_ptr,
                         int8* output_ptr, int64_t input_depth, int64_t input_row_size,
...
#define DEPTHWISECONV_LABEL_HEIGHT_1_END "11"
    ...
    asm volatile(
        ...
        // NOLINT
        "ldr w9, [%[params_ptr], #" STR(
            OFFSET_INPUT_OFFSET) "]\n"
                                 "ldr x3, [%[params_ptr], #" STR(
                                     OFFSET_OUTPUT_DEPTH) "]\n"
                                                          "cmp %w[output_window_height], #2\n"
                                                          "dup v26.8h, w9\n"
                                                          "ldr w2, [%[params_ptr], #" STR(
                                                              OFFSET_OUTPUT_OFFSET) "]\n"
                                                                                    ...
                                                                                    ", #" STR(
                                                                                        OFFSET_OUTPUT_ACTIVATION_MIN) "]\n"
                                                                                                                      "ldr w0, [%[params_ptr], #" STR(
                                                                                                                          OFFSET_OUTPUT_ACTIVATION_MAX) "]\n"
                                                                                                                                                        "add x10, %[bias_ptr], #16\n"
                                                                                                                                                        "ldr x1, [%[params_ptr], #" STR(
                                                                                                                                                            OFFSET_OUTPUT_ROW_SIZE) "]\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "blt " DEPTHWISECONV_LABEL_HEIGHT_2_AFTER_LOOP
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_LOOP ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "beq " DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LEFTOVER
                                                                                                                                                                                    "f\n"
                                                                                                                                                                                    "cmp w5, #1\n"
                                                                                                                                                                                    "beq " DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_1_LEFTOVER
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "bge " DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP
                                                                                                                                                                                    "b\n"

                                                                                                                                                                                    // At this point, there will be one of 2 width or 1 width leftover,
                                                                                                                                                                                    // not both.
                                                                                                                                                                                    "cmp w5, #2\n"
                                                                                                                                                                                    "blt " DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_1_LEFTOVER
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LEFTOVER ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "mov v23.d[0], v21.d[1]\n"
                                                                                                                                                                                    "st1 {v23.8b}, [x7], x3\n"
                                                                                                                                                                                    "b " DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_AFTER_LOOP
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_AFTER_LOOP ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "bge " DEPTHWISECONV_LABEL_HEIGHT_2_LOOP
                                                                                                                                                                                    "b\n"

        DEPTHWISECONV_LABEL_HEIGHT_2_AFTER_LOOP ":\n"
                                                                                                                                                                                    "cmp %w[output_window_height], #1\n"
                                                                                                                                                                                    "blt " DEPTHWISECONV_LABEL_HEIGHT_1_END
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_1 ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "beq " DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_2_LEFTOVER
                                                                                                                                                                                    "f\n"
                                                                                                                                                                                    "cmp w5, #1\n"
                                                                                                                                                                                    "beq " DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_1_LEFTOVER
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_2_LOOP ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "bge " DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_2_LOOP
                                                                                                                                                                                    "b\n"

                                                                                                                                                                                    // At this point, there will be one of 2 width or 1 width leftover,
                                                                                                                                                                                    // not both.
                                                                                                                                                                                    "cmp w5, #2\n"
                                                                                                                                                                                    "blt " DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_1_LEFTOVER
                                                                                                                                                                                    "f\n"
        ...
        DEPTHWISECONV_LABEL_HEIGHT_1_WIDTH_2_LEFTOVER ":\n"
                                                                                                                                                                                    ...
                                                                                                                                                                                    "mov v23.d[0], v21.d[1]\n"
                                                                                                                                                                                    "st1 {v23.8b}, [%[output_ptr]], x3\n"
                                                                                                                                                                                    "b " DEPTHWISECONV_LABEL_HEIGHT_1_END
                                                                                                                                                                                    "f\n"
        ...
        :
        // Outputs.
        [filter_ptr] "+r"(filter_ptr), [input_ptr] "+r"(input_ptr), [output_ptr] "+r"(output_ptr),
        [output_window_height] "+r"(output_window_height)
        :
        // Inputs.
        [output_multiplier_ptr] "r"(output_multiplier_ptr),
        [output_shift_ptr] "r"(output_shift_ptr), [bias_ptr] "r"(bias_ptr),
        [input_row_size] "r"(input_row_size), [input_depth] "r"(input_depth),
        ...
        [output_height_increment] "r"(output_height_increment), [params_ptr] "r"(params_ptr)
        :
        // Clobbers.
        "cc", "memory",
...
template <>
struct DepthwiseConvWindowPerChannel<DepthwiseConvOutputRounding::kUpward, 8, 2, 2> {
  static inline void Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr,
                         const int8* input_ptr, const int8* filter_ptr, const int32* bias_ptr,
                         int8* output_ptr, int64_t input_depth, int64_t input_row_size,
                         int32 output_window_height, int32 output_window_width,
...
#define DEPTHWISECONV_LABEL_HEIGHT_1_END "11"
    ...
    asm volatile(
        ...
        "v27", "v28", "v29", "v30", "v31",
        // We use these general-purpose registers.
        "x0", "x2", "x3", "x4", "x5", "x6", "x7", "x10", "x11", "x12", "x13", "x14", "x15", "x19",
        "x20");
#undef DEPTHWISECONV_LABEL_HEIGHT_2_LOOP
#undef DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_2_LOOP
#undef DEPTHWISECONV_LABEL_HEIGHT_2_WIDTH_1_LEFTOVER
...
template <>
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward, EdgeType::kCenter, 1,
                                      1> {
  static inline void Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr,
                         const int8* input_ptr, const int8* filter_ptr, const int32* bias_ptr,
                         int8* output_ptr, const DepthwiseConvParams* params_ptr) {
    TFLITE_DCHECK_EQ(params_ptr->filter_offset, 0);
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
                                                                                                                                                                         ...
                                                                                                                                                                         "ldr w9, [%[params_ptr], #" STR(OFFSET_OUTPUT_ACTIVATION_MIN) "]\n"
                                                                                                                                                                                                                                       "ldr w10, [%[params_ptr], #" STR(
                                                                                                                                                                                                                                           OFFSET_OUTPUT_ACTIVATION_MAX) "]\n"
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         "blt " DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP
                                                                                                                                                                                                                                                                         "f\n"
        ...
        DEPTHWISECONV_LABEL_DEPTH_8_LOOP ":\n"
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         "bge " DEPTHWISECONV_LABEL_DEPTH_8_LOOP
                                                                                                                                                                                                                                                                         "b\n"
        ...
        // Outputs.
        [filter_ptr] "+r"(filter_ptr), [input_ptr] "+r"(input_ptr), [output_ptr] "+r"(output_ptr),
        [bias_ptr] "+r"(bias_ptr), [output_multiplier_ptr] "+r"(output_multiplier_ptr),
        ...
        "cc", "memory",
        // We use these NEON registers.
        "v0", "v6", "v7", "v8", "v10", "v11", "v16", "v17", "v18", "v19", "v26", "v28", "v30",
        "v31",
        // We use these general-purpose registers.
        "x9", "x10", "x11");
...
template <>
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward, EdgeType::kCorner, 1,
                                      1> {
  static inline void Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr,
                         const int8* input_ptr, const int8* filter_ptr, const int32* bias_ptr,
                         int8* output_ptr, const DepthwiseConvParams* params_ptr) {
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
        ...
        "cc", "memory",
        // We use these NEON registers.
        "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v16", "v17",
        "v18", "v19", "v26", "v28", "v30", "v31",
        // We use these general-purpose registers.
...
template <>
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward, EdgeType::kHorizontal,
                                      1, 1> {
  static inline void Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr,
                         const int8* input_ptr, const int8* filter_ptr, const int32* bias_ptr,
                         int8* output_ptr, const DepthwiseConvParams* params_ptr) {
...
#define DEPTHWISECONV_LABEL_DEPTH_8_AFTER_LOOP "2"
    asm volatile(
        ...
        // Load input and filter values.
        "ldr x7, [%[params_ptr], #" STR(
            OFFSET_INPUT_DEPTH) "]\n"
                                "mov x12, %[input_ptr]\n"
                                "ldr x11, [%[params_ptr], #" STR(
                                    OFFSET_INPUT_ROW_SIZE) "]\n"
                                                           "mov x9, %[filter_ptr]\n"
                                                           "ldr x14, [%[params_ptr], #" STR(
        ...
        // We use these NEON registers.
        "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13",
        "v14", "v15", "v16", "v17", "v18", "v19", "v26", "v28", "v30", "v31",
        // We use these general-purpose registers.
...
template <>
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward, EdgeType::kVertical, 1,
                                      1> {
  static inline void Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr,
                         const int8* input_ptr, const int8* filter_ptr, const int32* bias_ptr,
                         int8* output_ptr, const DepthwiseConvParams* params_ptr) {
        ...
        "ldr x6, [%[params_ptr], #" STR(OFFSET_INPUT_DEPTH) "]\n"
                                                            ...
                                                            "ldr x11, [%[params_ptr], #" STR(
                                                                OFFSET_INPUT_ROW_SIZE) "]\n"
                                                                                       ...
                                                                                       "[%[params_"
                                                                                       "ptr], "
                                                                                       "#" STR(OFFSET_FILTER_ROW_SIZE) "]\n"
                                                                                                                       "add x13, x12, x11\n"
                                                                                                                       "ldr x15, [%[params_ptr], #" STR(
                                                                                                                           OFFSET_OUTPUT_DEPTH) "]\n"
                                                                                                                                                "add x14, x13, x11\n"
...
template <DepthwiseConvOutputRounding output_rounding, int32 kStrideWidth, int32 kStrideHeight>
struct DepthwiseConvThroughDepthPerChannel {
  ...
  Run(const int32* output_multiplier_ptr, const int32* output_shift_ptr, const int8* input_ptr,
      const int8* filter_ptr, const int32* bias_ptr, int8* output_ptr, int64_t start_depth,
      int64_t end_depth, int64_t input_depth, int64_t input_row_size, int32 output_window_height,
      int32 output_window_width, const DepthwiseConvParams& params) {
    for (; start_depth <= end_depth - 8; start_depth += 8) {
      DepthwiseConvWindowPerChannel<output_rounding, 8, kStrideWidth, kStrideHeight>::Run(
          output_multiplier_ptr, output_shift_ptr, input_ptr, filter_ptr, bias_ptr, output_ptr,
          input_depth, input_row_size, output_window_height, output_window_width, &params);
      input_ptr += 8;
      output_ptr += 8;
      filter_ptr += 8;
      bias_ptr += 8;
...
struct DepthwiseConvMultiRowPerChannel {
  using ConvKernel =
      DepthwiseConvThroughDepthPerChannel<output_rounding, kStrideWidth, kStrideHeight>;

  static inline void Run(const int32* output_multiplier, const int32* output_shift,
                         const int8* input_data, int32 start_x, int32 end_x,
                         const int8* filter_data, const int32* bias_data, int8* output_data,
                         const DepthwiseConvParams& params, const ShuffleParams& shuffle_params,
    ...
    TFLITE_DCHECK_LE(64 * shuffle_params.input_width * shuffle_params.input_height,
    ...
    if (params.output_depth > 64 || (params.output_depth <= 64 && params.input_width > 150)) {
      for (; out_x <= (end_x - shuffle_params.output_width); out_x += shuffle_params.output_width) {
        ...
        for (; depth <= params.output_depth - 64; depth += 64) {
          ...
          ShuffleInput(input_ptr, params.input_depth, params.input_width, params.input_height, 64,
                       shuffle_params.input_width, shuffle_params.input_height, shuffle_workspace);
          ConvKernel::Run(output_multiplier_ptr, output_shift_ptr, shuffle_workspace, filter_ptr,
                          bias_ptr, output_ptr, 0, 64, 64, shuffle_row_size,
                          shuffle_params.output_height, shuffle_params.output_width, params);
          input_ptr += 64;
          output_ptr += 64;
          filter_ptr += 64;
          bias_ptr += 64;
        ...
        ConvKernel::Run(output_multiplier_ptr, output_shift_ptr, input_ptr, filter_ptr, bias_ptr,
                        output_ptr, depth, params.output_depth, params.input_depth,
                        params.input_row_size, shuffle_params.output_height,
                        shuffle_params.output_width, params);

        input_data += shuffle_params.output_width * kStrideWidth * params.input_depth;
    ...
    if (output_leftover_width > 0) {
      ConvKernel::Run(output_multiplier, output_shift, input_data, filter_data, bias_data,
                      output_data, 0, params.output_depth, params.input_depth,
                      params.input_row_size, shuffle_params.output_height, output_leftover_width,
                      params);
    }
  }
};
...
inline void DepthwiseConvHandlePaddingPerChannel(const int32* output_multiplier_ptr,
                                                 const int32* output_shift_ptr,
                                                 const int8* input_data, const int8* filter_data,
                                                 const int32* bias_data, int8* output_data,
                                                 const DepthwiseConvParams& params) {
  if (params.input_width == 1 && params.input_height == 1) {
    const int8* filter_ptr = filter_data + params.filter_row_size + params.output_depth;
    DepthwiseConvPartialPerChannel<output_rounding, EdgeType::kCenter, 1, 1>::Run(
        output_multiplier_ptr, output_shift_ptr, input_data, filter_ptr, bias_data, output_data,
        &params);
    return;
  }
  ...
  DepthwiseConvPartialPerChannel<output_rounding, EdgeType::kCorner, 1, 1>::Run(
      output_multiplier_ptr, output_shift_ptr, input_ptr, filter_ptr, bias_data, output_ptr,
      &params);
  ...
  for (int32 out_x = out_x_start_corner + 1; out_x < out_x_end_corner; out_x++) {
    DepthwiseConvPartialPerChannel<output_rounding, EdgeType::kHorizontal, 1, 1>::Run(
        output_multiplier_ptr, output_shift_ptr, input_ptr, filter_ptr, bias_data, output_ptr,
        &params);
  ...
  for (int32 out_y = out_y_start_corner + 1; out_y < out_y_end_corner; out_y++) {
    DepthwiseConvPartialPerChannel<output_rounding, EdgeType::kVertical, 1, 1>::Run(
        output_multiplier_ptr, output_shift_ptr, input_ptr, filter_ptr, bias_data, output_ptr,
        &params);
  ...
  output_ptr =
      output_data + params.output_row_size + (params.output_width - 1) * params.output_depth;
...
inline void DepthwiseConv3x3FilterPerChannel(
    ...
    const int32* output_shift_ptr, const RuntimeShape& input_shape, const int8* input_data,
    const RuntimeShape& filter_shape, const int8* filter_data, const RuntimeShape& bias_shape,
    const int32* bias_data, const RuntimeShape& output_shape, int8* output_data, int thread_start,
  ...
  const int64_t output_batch_size = params.output_row_size * params.output_height;

  ShuffleParams one_row_shuffle_params, two_row_shuffle_params, four_row_shuffle_params,
      eight_row_shuffle_params;
  if (stride_width == 1) {
  ...
  if (stride_width == 2) {
    conv_multirow_func = DepthwiseConvMultiRowPerChannel<output_rounding, 2, 2>::Run;
  }
  ...
  for (int32 b = batch_start; b < batch_end; ++b) {
    ...
    if (pad_width == 1 && pad_height == 1) {
      DepthwiseConvHandlePaddingPerChannel<output_rounding>(output_multiplier_ptr, output_shift_ptr,
                                                            input_ptr, filter_data, bias_data,
                                                            output_ptr, params);
    ...
    if (params.input_width < four_row_shuffle_params.input_width) {
      for (; out_y <= end_y - 8; out_y += 8) {
        conv_multirow_func(output_multiplier_ptr, output_shift_ptr, input_ptr, out_x, end_x,
                           filter_data, bias_data, output_ptr, params, eight_row_shuffle_params,
                           shuffle_workspace);
    ...
    if (params.input_width < two_row_shuffle_params.input_width) {
      for (; out_y <= end_y - 4; out_y += 4) {
        conv_multirow_func(output_multiplier_ptr, output_shift_ptr, input_ptr, out_x, end_x,
                           filter_data, bias_data, output_ptr, params, four_row_shuffle_params,
                           shuffle_workspace);
    ...
    for (; out_y <= end_y - 2; out_y += 2) {
      conv_multirow_func(output_multiplier_ptr, output_shift_ptr, input_ptr, out_x, end_x,
                         filter_data, bias_data, output_ptr, params, two_row_shuffle_params,
                         shuffle_workspace);
    ...
    for (; out_y < end_y; out_y++) {
      conv_multirow_func(output_multiplier_ptr, output_shift_ptr, input_ptr, out_x, end_x,
                         filter_data, bias_data, output_ptr, params, one_row_shuffle_params,
                         shuffle_workspace);
