...
class MasteringMetadata {
 public:
  ...
  MasteringMetadata()
      : luminance_max(kValueNotPresent), luminance_min(kValueNotPresent),
 ...
 public:
  ...
  Colour()
      : matrix_coefficients(kValueNotPresent),
        ...
        chroma_siting_vert(kValueNotPresent), range(kValueNotPresent),
        transfer_characteristics(kValueNotPresent), primaries(kValueNotPresent),
        max_cll(kValueNotPresent), max_fall(kValueNotPresent),
