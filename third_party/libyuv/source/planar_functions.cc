...
// TODO(fbarchard): Mirror on mips handle unaligned memory.
  ...
  if (TestCpuFlag(kCpuHasMIPS_DSPR2) && IS_ALIGNED(src_y, 4) &&
...
int ARGBInterpolate(const uint8 *src_argb0, int src_stride_argb0,
  ...
  if (TestCpuFlag(kCpuHasMIPS_DSPR2) && IS_ALIGNED(src_argb0, 4) &&
      IS_ALIGNED(src_stride_argb0, 4) && IS_ALIGNED(src_argb1, 4) &&
      IS_ALIGNED(src_stride_argb1, 4) && IS_ALIGNED(dst_argb, 4) &&
...
static int ARGBSobelize(const uint8 *src_argb, int src_stride_argb,
                        ...
                        void (*SobelRow)(const uint8 *src_sobelx,
                                         const uint8 *src_sobely, uint8 *dst,
                                         int width)) {
  int y;
