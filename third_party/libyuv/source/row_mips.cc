...
void CopyRow_MIPS(const uint8 *src, uint8 *dst, int count) {
  __asm__ __volatile__(
      ...
      // past the "t0-32" address This means: for x=128 the last "safe" a1
      // address is "t0-160" Alternatively, for x=64 the last "safe" a1 address
      // is "t0-96" we will use "pref 30,128(a1)", so "t0-160" is the limit
      "subu      $t9, $t0, 160                     \n"
