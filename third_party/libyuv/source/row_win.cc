...
#if !defined(LIBYUV_DISABLE_X86) && defined(_M_X64) && defined(_MSC_VER) && \
    !defined(__clang__)
#include <emmintrin.h>
...
static YuvConstants SIMD_ALIGNED(kYuvJConstants) = {
  { UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0,
    UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0, UBJ, 0 },
  { UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ,
    VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ,
    UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ, UGJ, VGJ },
  { 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ,
    0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ, 0, VRJ },
  { BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ, BBJ,
    BBJ },
  { BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ, BGJ,
    BGJ },
  { BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ, BRJ,
    BRJ },
  { YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ, YGJ,
    YGJ }
};
...
void I422ToARGBRow_SSSE3(const uint8 *y_buf, const uint8 *u_buf,
                         const uint8 *v_buf, uint8 *dst_argb, int width) {
...
static const uvec8 kShuffleMaskRGB24ToARGB = { 0u, 1u,  2u,  12u, 3u, 4u,
                                               5u, 13u, 6u,  7u,  8u, 14u,
                                               9u, 10u, 11u, 15u };
...
static const uvec8 kShuffleMaskARGBToRGB24 = { 0u,   1u,   2u,   4u,  5u,  6u,
                                               8u,   9u,   10u,  12u, 13u, 14u,
                                               128u, 128u, 128u, 128u };

// Shuffle table for converting ARGB to RAW.
static const uvec8 kShuffleMaskARGBToRAW = { 2u,   1u,   0u,   6u,  5u,  4u,
                                             10u,  9u,   8u,   14u, 13u, 12u,
                                             128u, 128u, 128u, 128u };
...
// Shuffle table for converting ARGB to RAW.
static const uvec8 kShuffleMaskARGBToRAW_0 = { 2u,  1u,  0u,   6u,   5u,   4u,
                                               10u, 9u,  128u, 128u, 128u, 128u,
                                               8u,  14u, 13u,  12u };
...
__declspec(naked) void ARGBToUV422Row_SSSE3(const uint8 *src_argb0,
                                            uint8 *dst_u, uint8 *dst_v,
                                            int width) {
  __asm {
    push       edi
...
__declspec(naked) void I422ToARGBRow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
...
// 16 pixels
// 8 UV values upsampled to 16 UV, mixed with 16 Y producing 16 ARGB (64 bytes).
__declspec(naked) void J422ToARGBRow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
...
__declspec(naked) void I444ToARGBRow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
...
__declspec(naked) void I411ToARGBRow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
...
// 16 pixels.
// 8 UV values upsampled to 16 UV, mixed with 16 Y producing 16 ARGB (64 bytes).
__declspec(naked) void NV12ToARGBRow_AVX2(const uint8 *y_buf,
...
__declspec(naked) void NV21ToARGBRow_AVX2(const uint8 *y_buf,
                                          const uint8 *uv_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
    push       esi
...
__declspec(naked) void I422ToBGRARow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
...
// TODO(fbarchard): Use macros to reduce duplicate code.  See SSSE3.
__declspec(naked) void I422ToRGBARow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
...
// TODO(fbarchard): Use macros to reduce duplicate code.  See SSSE3.
__declspec(naked) void I422ToABGRRow_AVX2(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_argb,
                                          int width) {
  __asm {
...
#define YUVTORGB(YuvConstants) \
  __asm {                      \
    ...
    __asm psubw      xmm2, xmm3 /* Step 2: Find Y contribution to 8 R,G,B values */                        \
...
#define STORERGB24                                    \
  __asm { /* Step 3: Weave into RRGB */                                              \
    __asm punpcklbw  xmm0, xmm1 /* BG */                             \
    __asm punpcklbw  xmm2, xmm2 /* RR */                             \
    __asm movdqa     xmm1, xmm0                                                \
    __asm punpcklwd  xmm0, xmm2 /* BGRR first 4 pixels */            \
    __asm punpckhwd  xmm1, xmm2 /* BGRR next 4 pixels */ /* Step 4: RRGB -> RGB24 */                                                \
...
#define STORERAW                                      \
  __asm { /* Step 3: Weave into RRGB */                                              \
    ...
    __asm movdqa     xmm1, xmm0                                                \
    __asm punpcklwd  xmm0, xmm2 /* BGRR first 4 pixels */            \
    __asm punpckhwd  xmm1, xmm2 /* BGRR next 4 pixels */ /* Step 4: RRGB -> RAW */                                                  \
    __asm pshufb     xmm0, xmm5 /* Pack first 8 and last 4 bytes. */ \
    __asm pshufb     xmm1, xmm6 /* Pack first 12 bytes. */           \
    __asm palignr    xmm1, xmm0, 12 /* last 4 bytes of xmm0 + 12 xmm1 */ \
    __asm movq       qword ptr 0[edx], xmm0 /* First 8 bytes */               \
...
#define STORERGB565                                          \
  __asm { /* Step 3: Weave into RRGB */                                              \
    ...
    __asm movdqa     xmm1, xmm0                                                \
    __asm punpcklwd  xmm0, xmm2 /* BGRR first 4 pixels */            \
    __asm punpckhwd  xmm1, xmm2 /* BGRR next 4 pixels */ /* Step 4: RRGB -> RGB565 */                                               \
...
__declspec(naked) void I444ToARGBRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
                                           const uint8 *v_buf, uint8 *dst_argb,
                                           int width) {
  __asm {
...
__declspec(naked) void I422ToRGB24Row_SSSE3(const uint8 *y_buf,
                                            const uint8 *u_buf,
                                            const uint8 *v_buf,
...
__declspec(naked) void I422ToRAWRow_SSSE3(const uint8 *y_buf,
                                          const uint8 *u_buf,
                                          const uint8 *v_buf, uint8 *dst_raw,
                                          int width) {
  __asm {
    push       esi
    push       edi
...
__declspec(naked) void I422ToRGB565Row_SSSE3(const uint8 *y_buf,
                                             const uint8 *u_buf,
                                             const uint8 *v_buf,
...
__declspec(naked) void I422ToARGBRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
                                           const uint8 *v_buf, uint8 *dst_argb,
                                           int width) {
  __asm {
...
// 4 UV values upsampled to 8 UV, mixed with 8 Y producing 8 ARGB (32 bytes).
__declspec(naked) void J422ToARGBRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
                                           const uint8 *v_buf, uint8 *dst_argb,
                                           int width) {
  __asm {
...
__declspec(naked) void I411ToARGBRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
                                           const uint8 *v_buf, uint8 *dst_argb,
                                           int width) {
  __asm {
...
// 8 pixels.
// 4 UV values upsampled to 8 UV, mixed with 8 Y producing 8 ARGB (32 bytes).
__declspec(naked) void NV12ToARGBRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *uv_buf, uint8 *dst_argb,
                                           int width) {
  __asm {
    push       esi
...
__declspec(naked) void NV21ToARGBRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *uv_buf, uint8 *dst_argb,
                                           int width) {
  __asm {
    push       esi
...
__declspec(naked) void I422ToBGRARow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
...
__declspec(naked) void I422ToABGRRow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
...
__declspec(naked) void I422ToRGBARow_SSSE3(const uint8 *y_buf,
                                           const uint8 *u_buf,
...
__declspec(naked) void MirrorRow_SSE2(const uint8 *src, uint8 *dst, int width) {
  __asm {
    mov       eax, [esp + 4]  // src
    mov       edx, [esp + 8]  // dst
    mov       ecx, [esp + 12]  // width
...
__declspec(naked) void ARGBBlendRow_SSE2(const uint8 *src_argb0,
...
__declspec(naked) void ARGBAttenuateRow_SSE2(const uint8 *src_argb,
                                             uint8 *dst_argb, int width) {
  __asm {
...
// Shuffle table duplicating alpha.
static const uvec8 kUnattenShuffleAlpha_AVX2 = { 0u, 1u, 0u,  1u, 0u, 1u,
                                                 6u, 7u, 8u,  9u, 8u, 9u,
                                                 8u, 9u, 14u, 15u };
...
// Bilinear filter 16x2 -> 16x1
__declspec(naked) void InterpolateRow_SSE2(uint8 *dst_ptr, const uint8 *src_ptr,
                                           ptrdiff_t src_stride, int dst_width,
                                           int source_y_fraction) {
  __asm {
    push       esi
