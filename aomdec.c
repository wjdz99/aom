...
static const arg_def_t monochrome =
    ARG_DEF(NULL, "monochrome", 0, "Force monochrome output (constant chroma planes)");
#endif
...
static void write_image_file(const aom_image_t *img, const int *planes, const int num_planes,
                             FILE *file) {
  int i, y;
#if CONFIG_HIGHBITDEPTH
