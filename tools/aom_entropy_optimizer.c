...
int main(int argc, const char **argv) {
  ...
  cts_each_dim[1] = 2;
	optimize_cdf_table(&fc.use_ddtx[0][0], probsfile, 2, cts_each_dim,
      "static const aom-cdf_prob default_use_ddtx[EXT_TX_SIZES][CDF_SIZE(2)]");

  cts_each_dim[0] = EXT_TX_SIZES;
  cts_each_dim[1] = DDTX_TYPES;
  optimize_cdf_table(&fc.ddtx_type[0][0], probsfile, 2, cts_each_dim,
                     "static const aom_cdf_prob\n"
                     "default_ddtx_type[EXT_TX_SIZES][CDF_SIZE(DDTX_TYPES)]");
#endif
