...
/* nstx_type */
  ...
  optimize_cdf_table(
      ...
      "static const aom_cdf_prob default_use_nstx_intra[EXT_TX_SIZES]"
      "[CDF_SIZE(2)]");

  cts_each_dim[0] = EXT_TX_SIZES;
  cts_each_dim[1] = NSTX_TYPES_INTRA;
  optimize_cdf_table(&fc.nstx_type_intra[0][0], probsfile, 2, cts_each_dim,
                     "static const aom_cdf_prob\n"
                     "default_nstx_type_intra[EXT_TX_SIZES]"
