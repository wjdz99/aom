...
/* nstx_type */
  ...
  cts_each_dim[1] = 2;
  optimize_cdf_table(
      &fc.use_nstx_inter[0][0], probsfile, 2, cts_each_dim,
      "static const aom_cdf_prob default_use_nstx_inter[EXT_TX_SIZES]"
      "[CDF_SIZE(2)]");

  cts_each_dim[0] = EXT_TX_SIZES;
  cts_each_dim[1] = NSTX_TYPES_INTER;
  optimize_cdf_table(&fc.nstx_type_inter[0][0], probsfile, 2, cts_each_dim,
                     "static const aom_cdf_prob\n"
                     "default_nstx_type_inter[EXT_TX_SIZES]"
                     "[CDF_SIZE(NSTX_TYPES_INTER)]");
#endif
#if USE_NSTX_INTRA
  /* nstx_type */
  cts_each_dim[0] = EXT_TX_SIZES;
  cts_each_dim[1] = 2;
  optimize_cdf_table(
      &fc.use_nstx_intra[0][0], probsfile, 2, cts_each_dim,
      "static const aom_cdf_prob default_use_nstx_intra_cdf[EXT_TX_SIZES]"
      "[CDF_SIZE(2)]");

  cts_each_dim[0] = EXT_TX_SIZES;
  cts_each_dim[1] = INTRA_MODES;
  cts_each_dim[2] = NSTX_TYPES_INTRA;
  optimize_cdf_table(&fc.nstx_type_intra[0][0][0], probsfile, 3, cts_each_dim,
                     "static const aom_cdf_prob\n"
  ...
  cts_each_dim[2] = INTRA_MODES;
#if CONFIG_MODEDEP_TX
  cts_each_dim[3] = TX_TYPES_NONSTX;
#else
  ...
  cts_each_dim[1] = EXT_TX_SIZES;
#if CONFIG_MODEDEP_TX
  cts_each_dim[2] = TX_TYPES_NONSTX;
#else
