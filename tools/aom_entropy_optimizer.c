...
/* filter_intra experiment */
  ...
  optimize_entropy_table(&fc.coeff_lps[0][0][0][0][0], probsfile, 5,
                         cts_each_dim, NULL, 1,
                         "static const aom_prob "
                         "default_coeff_lps[TX_SIZES][PLANE_TYPES][BASE_RANGE_"
                         "SETS][LEVEL_CONTEXTS]");
  optimize_cdf_table(
      &fc.coeff_lps[0][0][0][0][0], probsfile, 5, cts_each_dim,
      "static const aom_cdf_prob "
      "default_coeff_lps_cdf[TX_SIZES][PLANE_TYPES][BASE_RANGE_SETS][LEVEL_"
      "CONTEXTS][CDF_SIZE(2)]");
