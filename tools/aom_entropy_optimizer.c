...
int main(int argc, const char **argv) {
  ...
  modes_each_ctx[5] = 7;
  modes_each_ctx[6] = 8;
  optimize_cdf_table_var_modes_3d(&fc.palette_y_color_index[0][0][0], probsfile,
      3, cts_each_dim, modes_each_ctx,
  ...
  modes_each_ctx[5] = 7;
  modes_each_ctx[6] = 8;
  optimize_cdf_table_var_modes_3d(&fc.palette_uv_color_index[0][0][0], probsfile,
      3, cts_each_dim, modes_each_ctx,
