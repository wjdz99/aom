...
1. Inside ./bin folder, make sure you have excutables for all external tools, such as vmafossexec, ffmpeg,
   HDRMetrics, encoder, decoder, etc. Currently, only executables built on Windows are available. If you need to
   run on Linux, you need to get the linux executables for those tools.
