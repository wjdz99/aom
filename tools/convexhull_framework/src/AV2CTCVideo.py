...
"""
Python file for definiation of AV2 CTC testing conditions
"""
...
"hdr"           : ["cosmos_caterpillar_2048x858p24_hdr10.y4m", "cosmos_tree_trunk_2048x858p24_hdr10.y4m",
                 ...
                 #file_name,               class     width   height  fps_num fps_denom   bitdepth    fmt
YUV_CLIPS = {
"ClassA"    : [
                ["CrowdRun_1920x1080.yuv", "ClassA", 1920, 1080, 30, 1, 8, "420"],
              ],
}

#this dict defines the mapping between the downscaled video to its high resolution source file for adaptive streaming test
SRC_FILE = {
    "CrowdRun_1280x720.yuv": "CrowdRun_3840x2160",
}
