...
from Utils import GetShortContentName, CreateNewSubfolder,\
     SetupLogging, Cleanfolder, CreateClipList
import Utils
from Config import LogLevels, FrameNum, TEST_CONFIGURATIONS, QPs, \
     SummaryOutPath, WorkPath, Path_RDResults, LoggerName,ContentPath, \
     QualityList
from AV2CTCVideo import CTC_TEST_SET, AS_TEST_SET
...
if __name__ == "__main__":
    #sys.argv = ["", "-f", "encode", "-p","0"]
    #sys.argv = ["", "-f", "summary", "-p", "0"]
