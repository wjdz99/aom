...
def Run_ConvexHull_Test(EncodeMethod, CodecName, EncodePreset, clip, dnScalAlgo,
                        upScalAlgo, LogCmdOnly = False):
...
if __name__ == "__main__":
    ...
    if Function == 'clean':
        ...
        SaveScalingResultsToExcel(DnScalingAlgos, UpScalingAlgos, clip_list,
                                  Path_DnScaleYuv, Path_QualityLog)
    elif Function == 'encode':
        for clip in clip_list:
            for dnScalAlgo, upScalAlgo in zip(DnScalingAlgos, UpScalingAlgos):
                Run_ConvexHull_Test(EncodeMethod, CodecName, EncodePreset, clip,
                                    dnScalAlgo, upScalAlgo, LogCmdOnly)
