...
### Prerequisites {#prerequisites}
 ...
 3. A modern C99 compiler. gcc 6+, clang 7+, Microsoft Visual Studio 2019+ or
    mingw-w64-clang64 are recommended. A C++ compiler is necessary to build the
    unit tests and some features contained in the examples.
 4. [Perl](https://www.perl.org/).
 5. For x86 targets, [yasm](http://yasm.tortall.net/), which is preferred, or a
