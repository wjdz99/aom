...
After installing [libvmaf.a](https://github.com/Netflix/vmaf/blob/master/resource/doc/libvmaf.md),
...
Please note that the default VMAF model ("/usr/local/share/model/vmaf_v0.6.1.pkl")
will be used unless you set the following flag when running the encoder:

~~~
    # --vmaf_model_path=path/to/model
~~~
