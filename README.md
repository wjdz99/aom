...
generator. For most system the default generator is Unix Makefiles. The basic
...
Both types of option are set at the time CMake is run. The following example
