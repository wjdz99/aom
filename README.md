...
Output from clang-format varies by clang-format version, for best results the
your version should match the one used on Jenkins, which is v3.7.1 as of this
writing.
