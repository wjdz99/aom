...
function (setup_documentation_targets)
  ...
  foreach (example_file ${AOM_DOXYGEN_EXAMPLE_SOURCES})
    ...
    get_filename_component(example_basename ${example_file} NAME)
    get_filename_component(example_name ${example_basename} NAME_WE)
    set(example_file "${AOM_DOXYGEN_OUTPUT_DIR}/${example_name}.dox")
    set(dox_string "/*!\\page example_${example_name} ${example_name}\n")
    set(dox_string "${dox_string} \\includelineno ${example_basename}\n*/\n")
    file(WRITE "${example_file}" ${dox_string})
    set(AOM_DOXYGEN_SOURCES ${AOM_DOXYGEN_SOURCES} "${example_file}")
  endforeach ()
