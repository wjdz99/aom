...
class AV1RateControlQMode : public AV1RateControlQModeInterface {
 public:
  ...
  // gop_struct. The returned list will have n+1 entries for n frames. If this
  // is not the first GOP, ref_frame_table is used as the initial state;
  // otherwise ref_frame_table is ignored and all refs are assumed invalid.
