...
static INLINE void build_inter_predictors(AV1_COMMON *cm, MACROBLOCKD *xd,
...
static void build_inter_predictors_for_planes(AV1_COMMON *cm, MACROBLOCKD *xd,
...
static INLINE void build_prediction_by_above_pred(
  ...
  for (int j = 0; j < num_planes; ++j) {
    ...
    build_inter_predictors((AV1_COMMON *)ctxt->cm, xd, j, above_mbmi, 1, bw, bh,
                           mi_x, mi_y);
  }
...
static INLINE void build_prediction_by_left_pred(
  ...
  for (int j = 0; j < num_planes; ++j) {
    ...
    build_inter_predictors((AV1_COMMON *)ctxt->cm, xd, j, left_mbmi, 1, bw, bh,
                           mi_x, mi_y);
  }
