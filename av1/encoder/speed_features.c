...
static void set_allintra_speed_features_framesize_independent(
  ...
  if (speed >= 6) {
    ...
    sf->winner_mode_sf.disable_winner_mode_eval_level = 1;
  }
    ...
    sf->winner_mode_sf.motion_mode_for_winner_cand =
        boosted ? 0
                : gf_group->update_type[cpi->gf_frame_index] == INTNL_ARF_UPDATE
                      ? 1
                      : 2;
    sf->winner_mode_sf.disable_winner_mode_eval_level = boosted ? 0 : 2;
...
static AOM_INLINE void init_winner_mode_sf(
  ...
  winner_mode_sf->disable_winner_mode_eval_level = 0;
}
