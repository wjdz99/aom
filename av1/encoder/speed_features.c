...
static void set_allintra_speed_features_framesize_independent(
  ...
  sf->intra_sf.dv_cost_upd_level = INT_COST_UPD_OFF;
...
static void set_good_speed_feature_framesize_dependent(
  ...
  if (speed >= 6) {
    ...
    if (!is_720p_or_larger) {
      sf->inter_sf.mv_cost_upd_level = INT_COST_UPD_SBROW_SET;
    }
...
static void set_good_speed_features_framesize_independent(
  ...
  if (speed >= 3) {
    ...
    sf->inter_sf.mv_cost_upd_level = INT_COST_UPD_SBROW;
...
static AOM_INLINE void init_inter_sf(INTER_MODE_SPEED_FEATURES *inter_sf) {
  ...
  inter_sf->mv_cost_upd_level = INT_COST_UPD_SB;
...
static AOM_INLINE void init_intra_sf(INTRA_MODE_SPEED_FEATURES *intra_sf) {
  intra_sf->dv_cost_upd_level = INT_COST_UPD_SB;
...
void av1_set_speed_features_framesize_dependent(AV1_COMP *cpi, int speed) {
  ...
  if ((cpi->oxcf.row_mt == 1) && (cpi->oxcf.max_threads > 1)) {
    if (sf->inter_sf.mv_cost_upd_level < INT_COST_UPD_SBROW) {
