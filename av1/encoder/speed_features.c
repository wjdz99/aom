...
void av1_set_speed_features_framesize_independent(AV1_COMP *cpi, int speed) {
  ...
  cpi->coeff_opt_dist_threshold[0] =
      coeff_opt_dist_thresholds[cpi->sf.perform_coeff_opt][0];
  cpi->coeff_opt_dist_threshold[1] =
      coeff_opt_dist_thresholds[cpi->sf.perform_coeff_opt][1];
