...
static void av1_disable_ml_based_transform_sf(
    TX_SPEED_FEATURES *const tx_sf) {
  tx_sf->tx_type_search.prune_2d_txfm_mode = TX_TYPE_PRUNE0;
...
void av1_set_speed_features_framesize_dependent(AV1_COMP *cpi, int speed) {
  ...
  if (oxcf->part_cfg.disable_ml_transform_speed_features)
