...
static void set_good_speed_features_framesize_independent(
  ...
  if (speed >= 1) {
    ...
    //TODO(any): prune_comp_search_by_single_result speed feature is
    //incompatible with CONFIG_NEW_INTER_MODES. Fix it.
    sf->prune_comp_search_by_single_result = !CONFIG_NEW_INTER_MODES;
