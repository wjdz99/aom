...
static void set_good_speed_features_framesize_independent(AV1_COMP *cpi,
  ...
  sf->disable_wedge_search_var_thresh = CONFIG_VAR_WEDGE_DISABLE_SPEED0;
  sf->disable_wedge_search_edge_thresh = CONFIG_EDGE_WEDGE_DISABLE_SPEED0;
  ...
  if (speed >= 1) {
    ...
    sf->disable_wedge_search_var_thresh = CONFIG_VAR_WEDGE_DISABLE_SPEED1;
    sf->disable_wedge_search_edge_thresh = CONFIG_EDGE_WEDGE_DISABLE_SPEED1;
  }
  ...
  if (speed >= 2) {
    ...
    sf->disable_wedge_search_var_thresh = CONFIG_VAR_WEDGE_DISABLE_SPEED2;
    sf->disable_wedge_search_edge_thresh = CONFIG_EDGE_WEDGE_DISABLE_SPEED2;
