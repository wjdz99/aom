...
// Maximum scaling value for gating based on scaled value of rd thresholds
...
static double partition_rd_thresh_mul[2] = { 0., 28. };
static double partition_rd_thresh_rem_mul[2] = { 0., 24. };
...
static void set_good_speed_features_framesize_independent(
  ...
  if (speed >= 3) {
    ...
    sf->scale_rd_thresh_for_partition_search = boosted ? 0 : 1;
  }
...
void av1_set_speed_features_framesize_independent(AV1_COMP *cpi, int speed) {
  ...
  cpi->sub_partition_rd_thresh_mul_factor =
      partition_rd_thresh_mul[sf->scale_rd_thresh_for_partition_search];
  cpi->rem_partition_rd_thresh_mul_factor =
      partition_rd_thresh_rem_mul[sf->scale_rd_thresh_for_partition_search];
  cpi->partition_rd_thresh_div_factor = (double)PARTITION_RD_THRESHOLD_DIV;
