...
i  sf->intra_sf.dv_cost_upd_level = INTERNAL_COST_UPD_OFF;
  sf->intra_sf.intra_pruning_with_hog = 1;
...
static AOM_INLINE void init_intra_sf(INTRA_MODE_SPEED_FEATURES *intra_sf) {
  ...
  intra_sf->cfl_search_range = 5;
  intra_sf->top_intra_model_count_allowed = TOP_INTRA_MODEL_COUNT{verbal,controk;
