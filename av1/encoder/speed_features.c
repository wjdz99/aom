...
// (Eg : IntraBc) Index 1: Mode evaluation Index 2: Winner mode evaluation Index
// 1 and 2 are applicable when enable_winner_mode_for_coeff_opt speed feature is
// ON
static unsigned int coeff_opt_dist_thresholds[5][3] = {
...
// Index 0: Default mode evaluation, Winner mode processing is not applicable
// (Eg : IntraBc) Index 1: Mode evaluation Index 2: Winner mode evaluation Index
// 1 and 2 are applicable when enable_winner_mode_for_tx_size_srch speed feature
// is ON
static TX_SIZE_SEARCH_METHOD tx_size_search_methods[3][3] = {
...
// Index 0: Default mode evaluation, Winner mode processing is not applicable
// (Eg : IntraBc) Index 1: Mode evaluation Index 2: Winner mode evaluation Index
// 1 and 2 are applicable when enable_winner_mode_for_use_tx_domain_dist speed
// feature is ON
static unsigned int tx_domain_dist_types[3][3] = { { 0, 2, 0 },
                                                   { 1, 2, 0 },
                                                   { 2, 2, 0 } };
