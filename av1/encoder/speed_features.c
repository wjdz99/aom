...
static void set_good_speed_features_framesize_independent(
  ...
  if (speed >= 1) {
    ...
    sf->inter_sf.prune_interinter_wedge_newmv_search = boosted ? 0 : 1;
  ...
  if (speed >= 3) {
    ...
    sf->inter_sf.prune_interinter_wedge_newmv_search = boosted ? 0 : 2;
...
static AOM_INLINE void init_inter_sf(INTER_MODE_SPEED_FEATURES *inter_sf) {
  ...
  inter_sf->prune_interinter_wedge_newmv_search = 0;
