...
void av1_rd_pick_intra_mode_sb(const struct Av1Comp *cpi, struct macroblock *x,
                               struct RdCost *rd_cost, BLOCK_SIZE bsize,
...
void av1_rd_pick_inter_mode_sb_seg_skip(
    const struct Av1Comp *cpi, struct TileDataEnc *tile_data,
    struct macroblock *x, int mi_row, int mi_col, struct RdCost *rd_cost,
