...
// The size of static buffer used by FIRSTPASS_INFO.
 ...
 * \return status
 */
aom_codec_err_t av1_firstpass_info_move_cur(FIRSTPASS_INFO *firstpass_info);
 ...
 * \return status
 */
aom_codec_err_t av1_firstpass_info_move_cur_and_pop(
 ...
 * \param[in]  offset_from_curr  index offset from cur_index.
