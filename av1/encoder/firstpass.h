...
typedef struct {
  ...
  int ref_frame_disp_idx[MAX_STATIC_GF_GROUP_LENGTH + 1]
                        [INTER_REFS_PER_FRAME + 1];
  int ref_frame_gop_idx[MAX_STATIC_GF_GROUP_LENGTH + 1]
                       [INTER_REFS_PER_FRAME + 1];
  unsigned char frame_type[MAX_STATIC_GF_GROUP_LENGTH + 1];
