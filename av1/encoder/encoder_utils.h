...
static AOM_INLINE void update_subgop_ref_stats(
  ...
  subgop_stats->is_valid_ref_frame[stat_count][ref_frame] = is_valid_ref_frame;
  subgop_stats->ref_frame_pyr_level[stat_count][ref_frame] = pyramid_level;
  subgop_stats->ref_frame_disp_order[stat_count][ref_frame] = disp_order;
  subgop_stats->num_references[stat_count] = num_references;
}
