...
static const int default_obmc_probs[FRAME_UPDATE_TYPES][BLOCK_SIZES_ALL] = {
...
static const int default_warped_probs[FRAME_UPDATE_TYPES] = { 64, 64, 64, 64,
                                                              64, 64, 64 };

// TODO(yunqing): the default probs can be trained later from better
// performance.
static const int default_switchable_interp_probs[FRAME_UPDATE_TYPES]
...
static AOM_INLINE int is_frame_tpl_eligible(AV1_COMP *const cpi) {
#if ENABLE_KF_TPL
...
static AOM_INLINE void process_tpl_stats_frame(AV1_COMP *cpi) {
