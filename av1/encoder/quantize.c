...
void av1_init_quantizer(VP10_COMP *cpi) {
...
void av1_init_plane_quantizers(VP10_COMP *cpi, MACROBLOCK *x) {
...
void av1_frame_init_quantizer(VP10_COMP *cpi) {
  av1_init_plane_quantizers(cpi, &cpi->td.mb);
}

void av1_set_quantizer(VP10_COMMON *cm, int q) {
