...
double get_highbd_diff_mean(const uint8_t *src8, int src_stride,
                            const uint8_t *dst8, int dst_stride, int w, int h) {
...
double get_diff_mean(const uint8_t *src, int src_stride, const uint8_t *dst,
