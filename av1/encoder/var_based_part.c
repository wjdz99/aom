...
typedef struct {
  // TODO(kyslov): check the statement below!!!!!
...
// TODO(kyslov): bring the small SAD functionality back
    ...
    av1_build_inter_predictors_sb(cm, xd, mi_row, mi_col, NULL, BLOCK_128X128);
  ...
  // TODO(kyslov): for now always split 128x128 block. Reconsider this
