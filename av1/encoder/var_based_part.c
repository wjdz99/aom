...
static AOM_INLINE int64_t tune_base_thresh_content(AV1_COMP *cpi,
  ...
  if (cpi->oxcf.speed >= 10 && cpi->rc.prev_avg_source_sad > 35000 &&
      cpi->rc.avg_source_sad > 35000 && cpi->rc.avg_frame_low_motion < 60)
...
static AOM_INLINE void set_vbp_thresholds(
  ...
  threshold_base = tune_base_thresh_content(cpi, threshold_base,
