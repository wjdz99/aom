  ...
  if (pick_method == CDEF_PICK_FROM_Q) {
    ...
    if (!frame_is_intra_only(cm)) {
      const int predicted_y_f1 =
          clamp((int)roundf(-q * q * 0.00000235939456f + q * 0.0068615186f +
                            0.02709886f),
                0, 15);
      const int predicted_y_f2 =
          clamp((int)roundf(-q * q * 0.000000576297339f + q * 0.00139933452f +
                            0.03831067f),
                0, 3);
      const int predicted_uv_f1 =
          clamp((int)roundf(-q * q * 0.000000709506878f + q * 0.00346288458f +
                            0.00887099f),
                0, 15);
      const int predicted_uv_f2 =
          clamp((int)roundf(q * q * 0.000000238740853f + q * 0.000282235851f +
                            0.05576307f),
                0, 3);
      ...
      const int predicted_y_f1 =
          clamp((int)roundf(q * q * 0.00000337319739f + q * 0.0080705937f +
                            0.0187634f),
                0, 15);
      const int predicted_y_f2 =
          clamp((int)roundf(-q * q * -0.00000291673427f + q * 0.00277986238f +
                            0.0079405f),
                0, 3);
      const int predicted_uv_f1 =
          clamp((int)roundf(-q * q * 0.0000130790995f + q * 0.0128924046f -
                            0.00748388f),
                0, 15);
      const int predicted_uv_f2 =
          clamp((int)roundf(q * q * 0.00000326517829f + q * 0.000355201832f +
                            0.00228092f),
                0, 3);
      cdef_info->cdef_strengths[0] =
          predicted_y_f1 * CDEF_SEC_STRENGTHS + predicted_y_f2;
