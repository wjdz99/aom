...
// Fill the neighboring regions of the block with 0x4000, only if the region is
// outside frame boundary
static INLINE void fill_borders_for_fbs_on_frame_boundary(
  ...
  if (is_fb_on_frm_top_boundary || is_fb_on_frm_right_boundary) {
    ...
    fill_rect(&inbuf[hfilt_size + CDEF_HBORDER], CDEF_BSTRIDE, CDEF_VBORDER,
