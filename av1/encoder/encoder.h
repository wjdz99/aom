...
typedef struct {
  ...
  // If the value is 0, encoder may not use fixed QP offsets.
  // If the value is 1 (default), encoder will use fixed QP offsets, that are
  // either:
  ...
  // of q-step.
  //  <TBD : extend the derivation of factors also based on config (RA, LD)
  //  etc.>
