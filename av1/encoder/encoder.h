...
typedef struct AV1_COMP {
  ...
  /*!
   * Store the cm->width and cm->height in the last call of
   * alloc_compressor_data(). Help determine whether compressor data should be
   * reallocated when there is a change in cm->width and cm->height.
   */
