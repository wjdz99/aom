...
typedef struct {
   ...
   * per tile. During first pass/look-ahead stage this is one less than the
   * maximum number of macroblock columns in a tile. During encode stage,
   * this equals the maximum number of superblock columns in a tile minus 1.
   */
  int allocated_cols;
