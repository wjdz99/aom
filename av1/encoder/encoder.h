...
typedef struct AV1_COMP {
  ...
  /*!
   * Flag that indicates whether high_source_sad in scene detection
   * should be set to 1. The flag would be set to 1 when a new motion
   * comes in
   */
  int update_high_source_sad_for_new_motion;
} AV1_COMP;
