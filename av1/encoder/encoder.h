...
typedef struct AV1_COMP {
  ...
  // * 'remapped_ref_idx[i - 1]' maps reference type ‘i’ (range: 1 ...
  ...
  //      |                                           |
  //      v                                           v
  // remapped_ref_idx[LAST_FRAME - 1],  ...,  remapped_ref_idx[ALTREF_FRAME - 1]
  //      |                                           |
  //      v                                           v
  ...
  // - Indices 1 ... REF_FRAMES are used to store values for the REF_FRAMES
