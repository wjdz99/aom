...
static int construct_multi_layer_gf_structure(
  ...
  // This is a patch that fix BUG=aomedia:3163
  ...
  // become MAX_STATIC_GF_GROUP_LENGTH + 1, which cause memory error.
  // A cheap solution is to turn of kf_decomp here.
  // TODO(angiebird): Finx a systematic way to solve this issue.
