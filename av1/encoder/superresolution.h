...
#ifndef AOM_AV1_ENCODER_SUPERRESOLUTION_SEARCH_H_
#define AOM_AV1_ENCODER_SUPERRESOLUTION_SEARCH_H_
...
int superres_in_recode_allowed(const AV1_COMP *const cpi);
...
#endif  // AOM_AV1_ENCODER_SUPERRESOLUTION_SEARCH_H_
