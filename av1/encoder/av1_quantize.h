...
#define CHK_INT_RANGE(x, _min, _max)                                                        \
  if ((x) > (_max)) {                                                                       \
    printf("\nline %d in %s value %lld is higher than upper bound %lld",                    \
           __LINE__, __FILE__, (int64_t)(x), (int64_t)(_max));                              \
    __debugbreak();                                                                         \
  } else if ((x) < (_min)) {                                                                \
    printf("\nline %d in %s value %lld is lower than lower bound %lld",                     \
           __LINE__, __FILE__, (int64_t)(x), (int64_t)(_min));                              \
    __debugbreak();                                                                         \
  }
