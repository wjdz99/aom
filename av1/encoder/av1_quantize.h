 ...
 * dequantize parameters for all q indices. \param[in]  qindex Quantize index
 * used for the current superblock. \param[out]  x                       A
 * superblock data structure for encoder.
 */
