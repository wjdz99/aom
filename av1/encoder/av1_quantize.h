...
typedef struct {
  // Quantization related structure used for internal quantizer setup
  QUANTS quants;
  // Dequantization related structure used for internal quantizer setup
  Dequants dequants;
} QuantDequantInfo;
