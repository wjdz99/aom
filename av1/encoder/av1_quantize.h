...
typedef struct {
#if CONFIG_NEW_QUANT
  DECLARE_ALIGNED(16, cuml_bins_type_nuq,
                  y_cuml_bins_nuq[QUANT_PROFILES][QINDEX_RANGE][2]);
  DECLARE_ALIGNED(16, cuml_bins_type_nuq,
                  u_cuml_bins_nuq[QUANT_PROFILES][QINDEX_RANGE][2]);
  DECLARE_ALIGNED(16, cuml_bins_type_nuq,
                  v_cuml_bins_nuq[QUANT_PROFILES][QINDEX_RANGE][2]);
#endif  // CONFIG_NEW_QUANT
