 ...
 * Adjusts how the rate control system decides the quantizers per frame (sub)type */
...
/* FIXME <- I am sure those are not optimal for AV1, this is straight from Daala */
