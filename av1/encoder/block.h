...
#if !CONFIG_REALTIME_ONLY
  /*! \brief Indicates the transform depths for which RD evaluation is skipped.
   *
   * Used to signal the transform depth that should be pruned for an intra
   * prediction block. Value 0 indicates that the evaluation of largest
   * transform size for the current block should be skipped. Value 1 indicates
   * that the evaluation of split (depth >= 1) of largest transform size should
   * be skipped.
   */
