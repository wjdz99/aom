...
typedef struct macroblock {
  ...
  // nonrd_pickmode.
  int sb_me_partition;
  //! Flag to indicate test the superblock MV for the coding block in the
  // nonrd_pickmode.
  int sb_me_block;
  //! Column motion vector from superblock MV derived from int_pro_motion() in
  // the variance_partitioning.
  int sb_me_mv_col;
  //! Row motion vector from superblock MV derived from int_pro_motion() in
  // the variance_partitioning.
  int sb_me_mv_row;
