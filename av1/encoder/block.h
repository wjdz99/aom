...
typedef struct {
  ...
  uint8_t smooth_filter_ref0_count[REF_FRAMES];  // Counter for interpolation
                                                 // filter type for ref0
  uint8_t smooth_filter_ref1_count[REF_FRAMES];  // Counter for interpolation
                                                 // filter type for ref1
