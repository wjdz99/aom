...
typedef struct macroblock {
  ...
  /*! \brief The minimum of \ref pred_mv_sad for reference frames.
   *
   * Index 0 stores the minimum \ref pred_mv_sad across past frames.
   * Index 1 stores the minimum \ref pred_mv_sad across future frames.
   */
