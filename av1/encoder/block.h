...
typedef struct {
   ...
   *
   * Hash records of the transform search results based on the residue. These
   * record a whole *partition block*'s inter-mode txfm result. Since this
   * operates on the partition block level, this can give us a whole txfm
   * partition tree.
   */
  MB_RD_RECORD *mb_rd_records;
