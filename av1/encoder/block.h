...
typedef struct {
  ...
  uint8_t interintra_motion_mode_count[REF_FRAMES];  // Counter for interintra
                                                     // motion mode
  // Counter for interp filter type for ref0
  uint8_t interp_filter_count_ref0[REF_FRAMES][SWITCHABLE_FILTERS];
  // Counter for interp filter type for ref1
  uint8_t interp_filter_count_ref1[REF_FRAMES][SWITCHABLE_FILTERS];
