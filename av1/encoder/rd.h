...
static INLINE void av1_add_reg_stat(RD_STATS *rd_stats, int eob, int64_t rd,
  ...
  // being truncated.
  int scaling_factor =
      MAX_MIB_SIZE * MAX_MIB_SIZE / (crop_width_mi * crop_height_mi);

  // Update the stats
  rd_stats->eob = eob;
  rd_stats->eob_0 = eob * (height_in_0 * width_in_0) * scaling_factor;
  rd_stats->eob_1 = eob * (height_in_0 * width_not_in_0) * scaling_factor;
  rd_stats->eob_2 = eob * (height_not_in_0 * width_in_0) * scaling_factor;
  rd_stats->eob_3 = eob * (height_not_in_0 * width_not_in_0) * scaling_factor;

  rd_stats->rd = rd;
  rd_stats->rd_0 = rd * (height_in_0 * width_in_0) * scaling_factor;
  rd_stats->rd_1 = rd * (height_in_0 * width_not_in_0) * scaling_factor;
  rd_stats->rd_2 = rd * (height_not_in_0 * width_in_0) * scaling_factor;
  rd_stats->rd_3 = rd * (height_not_in_0 * width_not_in_0) * scaling_factor;

  rd_stats->y_sse = sse;
  rd_stats->sse_0 = sse * (height_in_0 * width_in_0) * scaling_factor;
  rd_stats->sse_1 = sse * (height_in_0 * width_not_in_0) * scaling_factor;
  rd_stats->sse_2 = sse * (height_not_in_0 * width_in_0) * scaling_factor;
  rd_stats->sse_3 = sse * (height_not_in_0 * width_not_in_0) * scaling_factor;
}
