...
DECLARE_ALIGNED(16, static const uint8_t, sliding_window_mask[]) = {
...
static void apply_temporal_filter(
  ...
  const uint8x16x2_t vmask = vld1q_u8_x2(sliding_window_mask);
...
DECLARE_ALIGNED(16, static const uint16_t, sliding_window_mask[]) = {
...
static void apply_temporal_filter(
  ...
  uint32_t acc_5x5_neon[BH][BW];
  const uint16x8x4_t vmask = vld1q_u16_x4(sliding_window_mask);
