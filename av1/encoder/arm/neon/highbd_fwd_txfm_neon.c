...
static INLINE fwd_transform_1d_neon
fwd_txfm_type_to_func0(TXFM_TYPE txfm_type) {
  switch (txfm_type) {
...
void av1_fwd_txfm2d_32x32_neon(const int16_t *input, int32_t *output,
  ...
  const fwd_transform_1d_neon col_txfm =
      fwd_txfm_type_to_func0(cfg.txfm_type_col);
  const fwd_transform_1d_neon row_txfm =
      fwd_txfm_type_to_func0(cfg.txfm_type_row);
