...
uint64_t av1_wedge_sse_from_residuals_neon(const int16_t *r1, const int16_t *d,
  ...
  do {
    ...
    int16x8_t r1_l = vld1q_s16(r1 + i);
    int16x8_t r1_h = vld1q_s16(r1 + i + 8);
    int16x8_t d_l = vld1q_s16(d + i);
    int16x8_t d_h = vld1q_s16(d + i + 8);
    ...
    uint8x16x2_t m_u16 = vzipq_u8(vld1q_u8(m + i), vdupq_n_u8(0));
    int16x8_t m_l = vreinterpretq_s16_u8(m_u16.val[0]);
    int16x8_t m_h = vreinterpretq_s16_u8(m_u16.val[1]);
