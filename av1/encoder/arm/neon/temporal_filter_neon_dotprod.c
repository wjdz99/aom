...
DECLARE_ALIGNED(16, static const uint8_t, load_pad[4][16]) = {
...
static void apply_temporal_filter(
  ...
  const uint8x16_t pad_tbl0 = vld1q_u8(load_pad[0]);
  const uint8x16_t pad_tbl1 = vld1q_u8(load_pad[1]);
  const uint8x16_t pad_tbl2 = vld1q_u8(load_pad[2]);
  const uint8x16_t pad_tbl3 = vld1q_u8(load_pad[3]);
