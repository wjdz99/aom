...
static inline void madd_neon_pairwise(int32x4_t *sum, const int16x8_t src,
                                      const int16x8_t dgd) {
  const int32x4_t sd =
      vpaddq_s32(vmull_s16(vget_low_s16(src), vget_low_s16(dgd)),
...
static inline void hadd_update_4_stats_neon(const int64_t *const src,
                                            ...
                                            int64_t *const dst) {
  int32x4_t delta01 = vpaddq_s32(deltas[0], deltas[1]);
  int32x4_t delta23 = vpaddq_s32(deltas[2], deltas[3]);
...
static inline void compute_stats_win5_highbd_neon(
  ...
  do {
    ...
    // Row 2: 3 points
    int32x4_t deltas45 = vpaddq_s32(deltas[4], deltas[5]);
    int32x4_t deltas78 = vpaddq_s32(deltas[7], deltas[8]);
    ...
    int32x4_t delta69 = vpaddq_s32(deltas[6], deltas[9]);
...
static inline void hadd_update_6_stats_neon(const int64_t *const src,
  ...
  int32x4_t delta01 = vpaddq_s32(deltas[0], deltas[1]);
  int32x4_t delta23 = vpaddq_s32(deltas[2], deltas[3]);
  int32x4_t delta45 = vpaddq_s32(deltas[4], deltas[5]);
...
static inline void compute_stats_win7_highbd_neon(
  ...
  do {
    ...
    int32x4_t delta1710 = vpaddq_s32(deltas[17], deltas[10]);
    int32x4_t delta1516 = vpaddq_s32(deltas[15], deltas[16]);
    ...
    int32x4_t delta1819 = vpaddq_s32(deltas[18], deltas[19]);

    int64x2_t delta1819_s64 = vpaddlq_s32(delta1819);
    int64_t delta20_s64 = vaddlvq_s32(deltas[20]);
