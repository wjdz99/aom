...
// 2) The reserved (1-bit) is positioned such that color_ctx occupies the most
// significant and token occupies least significant bits of the byte. Thus
// accesses to token and color_ctx are optimal.
// Otherwise, read of color_ctx requires extra left shift to facilitate sign
// extension and write of token requires extra masking.
