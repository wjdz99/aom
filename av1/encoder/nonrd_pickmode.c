...
static void estimate_single_ref_frame_costs(const AV1_COMMON *cm,
                                            ...
                                            const ModeEntropyCosts *mode_costs,
                                            int segment_id,
...
static void estimate_comp_ref_frame_costs(
    ...
    const ModeEntropyCosts *mode_costs, int segment_id,
...
static int cost_mv_ref(const ModeEntropyCosts *const mode_costs,
...
void av1_nonrd_pick_inter_mode_sb(AV1_COMP *cpi, TileDataEnc *tile_data,
  ...
  const ModeEntropyCosts *mode_costs = &x->mode_costs;
