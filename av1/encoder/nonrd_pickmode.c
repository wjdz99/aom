...
void av1_nonrd_pick_inter_mode_sb(AV1_COMP *cpi, TileDataEnc *tile_data,
  ...
  for (MV_REFERENCE_FRAME ref_frame_iter = LAST_FRAME;
    ...
    if (use_ref_frame_mask[ref_frame_iter]) {
      ...
      frame_mv_best[NEARESTMV][ref_frame_iter].as_int =
          frame_mv[NEARESTMV][ref_frame_iter].as_int;
      frame_mv_best[NEARMV][ref_frame_iter].as_int =
          frame_mv[NEARMV][ref_frame_iter].as_int;
      frame_mv_best[GLOBALMV][ref_frame_iter].as_int =
          frame_mv[GLOBALMV][ref_frame_iter].as_int;
    }
  }
