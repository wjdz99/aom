...
#define NUM_INTER_MODES_RT (9 + 3)
#define NUM_INTER_MODES_REDUCED 8

static const REF_MODE ref_mode_set_rt[NUM_INTER_MODES_RT] = {
  { LAST_FRAME, GLOBALMV },    { LAST_FRAME, GLOBALMV },
  { ALTREF_FRAME, GLOBALMV },  { LAST_FRAME, NEARESTMV },
  { LAST_FRAME, NEARMV },      { LAST_FRAME, NEWMV },
  { GOLDEN_FRAME, NEARESTMV }, { GOLDEN_FRAME, NEARMV },
  { GOLDEN_FRAME, NEWMV },     { ALTREF_FRAME, NEARESTMV },
