...
void set_color_sensitivity(const AV1_COMP *cpi, MACROBLOCK *x, MACROBLOCKD *xd,
  ...
  // If the per-pixel spatial source variance is high and the normalized y_sad
  // is low, then y-channel is likely good for mode estimation, and so keep
  // color_sensitivity off.
