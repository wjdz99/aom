...
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDLA,
  THR_COMP_SCALED_NEARESTLA,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDL2A,
  THR_COMP_SCALED_NEARESTL2A,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDL3A,
  THR_COMP_SCALED_NEARESTL3A,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDGA,
  THR_COMP_SCALED_NEARESTGA,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDLB,
  THR_COMP_SCALED_NEARESTLB,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDL2B,
  THR_COMP_SCALED_NEARESTL2B,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDL3B,
  THR_COMP_SCALED_NEARESTL3B,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDGB,
  THR_COMP_SCALED_NEARESTGB,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDLA2,
  THR_COMP_SCALED_NEARESTLA2,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDL2A2,
  THR_COMP_SCALED_NEARESTL2A2,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDL3A2,
  THR_COMP_SCALED_NEARESTL3A2,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDGA2,
  THR_COMP_SCALED_NEARESTGA2,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDLL2,
  THR_COMP_SCALED_NEARESTLL2,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDLL3,
  THR_COMP_SCALED_NEARESTLL3,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDLG,
  THR_COMP_SCALED_NEARESTLG,
#endif  // !CONFIG_NEW_INTER_MODES
...
#if CONFIG_SINGLE_MV_COMPOUND
#if !CONFIG_NEW_INTER_MODES
  THR_COMP_NEAREST_SCALEDBA,
  THR_COMP_SCALED_NEARESTBA,
#endif  // !CONFIG_NEW_INTER_MODES
