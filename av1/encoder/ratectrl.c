...
static void set_reference_structure_one_pass_rt(AV1_COMP *cpi) {
  ...
  // or always behind current by lag_gld (gld_fixed_slot = 0).
  int gld_fixed_slot = 0;
  unsigned int lag_alt = 3;
  int last_idx = 0;
