...
void av1_rc_update_rate_correction_factors(AV1_COMP *cpi, int is_encode_stage,
  ...
  // Dont update rate correction factors here on scene changes,
  // but reset variables rerlated to previous frame q and size.
  if (cpi->cyclic_refresh->counter_encode_maxq_scene_change == 0) {
