...
// Function to update the rc->decimation_factor for the frame dropper,
// which will set decimation_factor to 1, 2, 4,.., for framerate reduction
// 1/2, 1/3, 1/5,.. Current setting is based on the buffer_level (how far
// it is from optimal or drop_mark).
