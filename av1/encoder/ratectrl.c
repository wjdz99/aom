...
// set decimation_factor to 1, 2, 3, 7, for 1/2, 1/3, 1/4, 1/8, frame rate
// reduction. Current setting is based on the buffer_level (how far it is from
// optimal).
