...
printf("%d %d postencode: %d %d %d ** %d %d %d *** %d %d %d %d \n",
      cm->show_frame, current_frame->frame_type, cpi->common.current_frame.frame_number, cpi->svc.spatial_layer_id,
      cpi->gf_frame_index, qindex, rc->projected_frame_size, rc->avg_frame_bandwidth,
      cm->width, cm->height, cm->spatial_layer_id, cm->temporal_layer_id);
