...
// Update  decimation_factor for the frame dropper, which will set decimation
// factor to 1, 2, 3, .., for framerate reduction 1/2, 1/3, 1/4,...
...
static int update_decimation_factor(int64_t buffer_level,
  ...
  } else if (buffer_level < -2 * optimal_buffer_level) {
    new_decimation_factor = 10;
