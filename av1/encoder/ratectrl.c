...
static void set_reference_structure_one_pass_rt(AV1_COMP *cpi, int gf_update) {
  ...
  ExtRefreshFrameFlagsInfo *const refresh_frame = &ext_flags->refresh_frame;
  ...
  int gld_idx = 0;
  int alt_ref_idx = 0;
  refresh_frame->refresh_frame_flags_pending = 1;
  svc->external_ref_frame_config = 1;
  ext_flags->ref_frame_flags = 0;
  refresh_frame->last_frame = 1;
  refresh_frame->golden_frame = 0;
  refresh_frame->alt_ref_frame = 0;
