...
static AOM_INLINE unsigned int get_sby_perpixel_diff_variance(
    const AV1_COMP *const cpi, const struct buf_2d *ref, int mi_row, int mi_col,
    BLOCK_SIZE bs) {
...
static AOM_INLINE BLOCK_SIZE get_rd_var_based_fixed_partition(AV1_COMP *cpi,
                                                              MACROBLOCK *x,
                                                              int mi_row,
                                                              int mi_col) {
...
static AOM_INLINE int get_hier_tpl_rdmult(const AV1_COMP *const cpi,
                                          MACROBLOCK *const x,
...
static AOM_INLINE void copy_mbmi_ext_frame_to_mbmi_ext(
...
static AOM_INLINE int is_leaf_split_partition(AV1_COMMON *cm, int mi_row,
                                              int mi_col, BLOCK_SIZE bsize) {
...
static AOM_INLINE int active_h_edge(const AV1_COMP *cpi, int mi_row,
                                    int mi_step) {
  int top_edge = 0;
...
// In most cases this is the "real" edge unless there are formatting
// bars embedded in the stream.
static AOM_INLINE int active_v_edge(const AV1_COMP *cpi, int mi_col,
                                    int mi_step) {
  int left_edge = 0;
...
static AOM_INLINE int get_rdmult_delta(AV1_COMP *cpi, BLOCK_SIZE bsize,
...
static AOM_INLINE void get_tpl_stats_sb(AV1_COMP *cpi, BLOCK_SIZE bsize,
                                        int mi_row, int mi_col,
...
//                  predictor chosen
static AOM_INLINE int get_q_for_deltaq_objective(AV1_COMP *const cpi,
...
static AOM_INLINE void source_content_sb(AV1_COMP *cpi, MACROBLOCK *x,
                                         int offset) {
...
static AOM_INLINE void reset_mbmi(CommonModeInfoParams *const mi_params,
...
static AOM_INLINE void backup_sb_state(SB_FIRST_PASS_STATS *sb_fp_stats,
...
static AOM_INLINE void restore_sb_state(const SB_FIRST_PASS_STATS *sb_fp_stats,
