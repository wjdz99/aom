...
static NN_CONFIG_v2 av1_tx_type_nnconfig_4x4_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_4x4_hor_layer1_out,          // logits (!!same as output of the last layer)
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_4x4_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_4x4_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_4x8_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_4x8_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_4x8_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_4x8_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_8x4_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_8x4_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_8x4_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_8x4_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_8x8_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_8x8_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_8x8_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_8x8_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_8x16_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_8x16_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_8x16_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_8x16_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_16x8_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_16x8_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_16x8_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_16x8_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_16x16_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_16x16_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_4x16_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_4x16_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_4x16_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_4x16_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_16x4_hor_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_16x4_hor_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
...
static NN_CONFIG_v2 av1_tx_type_nnconfig_16x4_ver_v2 = {
  ...
  4,          // num_outputs
  av1_tx_type_nn_16x4_ver_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_4x8_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_4x8_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_8x8_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_8x8_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_8x16_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_8x16_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_16x16_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_16x16_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_32x32_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_32x32_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_64x64_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_64x64_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_4x16_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_4x16_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_16x32_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_16x32_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_32x64_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_32x64_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_8x32_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_8x32_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
...
static NN_CONFIG_v2 av1_tx_split_nnconfig_16x64_v2 = {
  ...
  1,          // num_outputs
  av1_tx_split_nn_16x64_layer1_out,          // logits (!!same as output of the last layer)
  softmax_cross_entropy,
};
#endif
/******************************************************************************/
