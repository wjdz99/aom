...
static float av1_tx_split_nn_4x8_layer0_weights[8 * 16] = {
...
static float av1_tx_split_nn_4x8_layer0_bias[16] = {
...
static float av1_tx_split_nn_4x8_layer1_weights[16] = {
...
static float av1_tx_split_nn_4x8_layer1_bias[1] = {
  0.20586078f,
};

static float av1_tx_split_nn_4x8_in[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_4x8 = {
  0,                       // counter (!!Initialize to 0)
  1,                       // num_hidden_layers
  av1_tx_split_nn_4x8_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                   // num_inputs
          16,                                  // num_outputs
          av1_tx_split_nn_4x8_layer0_weights,  // weights
          av1_tx_split_nn_4x8_layer0_bias,     // bias
          RELU,                                // activation
          av1_tx_split_nn_4x8_layer0_out,      // output
          av1_tx_split_nn_4x8_layer0_dout,     // d_out
      ...
      },
      {
          16,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_4x8_layer1_weights,
          av1_tx_split_nn_4x8_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_8x8_layer0_weights[144] = {
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_8x8 = {
  0,                       // counter (!!Initialize to 0)
  1,                       // num_hidden_layers
  av1_tx_split_nn_8x8_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          12,                                  // num_inputs
          12,                                  // num_outputs
          av1_tx_split_nn_8x8_layer0_weights,  // weights
          av1_tx_split_nn_8x8_layer0_bias,     // bias
          RELU,                                // activation
          av1_tx_split_nn_8x8_layer0_out,      // output
          av1_tx_split_nn_8x8_layer0_dout,     // d_out
      ...
      },
      {
          ...
          1,
          av1_tx_split_nn_8x8_layer1_weights,
          av1_tx_split_nn_8x8_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_8x16_layer0_weights[8 * 64] = {
...
static float av1_tx_split_nn_8x16_layer0_bias[64] = {
...
static float av1_tx_split_nn_8x16_layer1_weights[64] = {
...
static float av1_tx_split_nn_8x16_layer1_bias[1] = {
  0.14910713f,
};

static float av1_tx_split_nn_8x16_in[8] = { 0 };
static float av1_tx_split_nn_8x16_layer0_out[8] = { 0 };
static float av1_tx_split_nn_8x16_layer0_dout[8] = { 0 };
static float av1_tx_split_nn_8x16_layer0_dW[8 * 64] = { 0 };
static float av1_tx_split_nn_8x16_layer0_db[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_8x16 = {
  0,                        // counter (!!Initialize to 0)
  1,                        // num_hidden_layers
  av1_tx_split_nn_8x16_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                    // num_inputs
          64,                                   // num_outputs
          av1_tx_split_nn_8x16_layer0_weights,  // weights
          av1_tx_split_nn_8x16_layer0_bias,     // bias
          RELU,                                 // activation
          av1_tx_split_nn_8x16_layer0_out,      // output
          av1_tx_split_nn_8x16_layer0_dout,     // d_out
      ...
      },
      {
          ...
          1,
          av1_tx_split_nn_8x16_layer1_weights,
          av1_tx_split_nn_8x16_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_16x16_layer0_weights[12 * 24] = {
...
static float av1_tx_split_nn_16x16_layer0_bias[24] = {
...
static float av1_tx_split_nn_16x16_layer1_weights[24] = {
...
static float av1_tx_split_nn_16x16_layer1_bias[1] = {
  0.184803f,
};

static float av1_tx_split_nn_16x16_in[12] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_16x16 = {
  0,                         // counter (!!Initialize to 0)
  1,                         // num_hidden_layers
  av1_tx_split_nn_16x16_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          12,                                    // num_inputs
          24,                                    // num_outputs
          av1_tx_split_nn_16x16_layer0_weights,  // weights
          av1_tx_split_nn_16x16_layer0_bias,     // bias
          RELU,                                  // activation
          av1_tx_split_nn_16x16_layer0_out,      // output
          av1_tx_split_nn_16x16_layer0_dout,     // d_out
      ...
      },
      {
          ...
          1,
          av1_tx_split_nn_16x16_layer1_weights,
          av1_tx_split_nn_16x16_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_32x32_layer0_weights[12 * 32] = {
...
static float av1_tx_split_nn_32x32_layer0_bias[32] = {
...
static float av1_tx_split_nn_32x32_layer1_weights[32] = {
...
static float av1_tx_split_nn_32x32_layer1_bias[1] = {
  0.316622f,
};

static float av1_tx_split_nn_32x32_in[12] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_32x32 = {
  0,                         // counter (!!Initialize to 0)
  1,                         // num_hidden_layers
  av1_tx_split_nn_32x32_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          12,                                    // num_inputs
          32,                                    // num_outputs
          av1_tx_split_nn_32x32_layer0_weights,  // weights
          av1_tx_split_nn_32x32_layer0_bias,     // bias
          RELU,                                  // activation
          av1_tx_split_nn_32x32_layer0_out,      // output
          av1_tx_split_nn_32x32_layer0_dout,     // d_out
      ...
      },
      {
          ...
          1,
          av1_tx_split_nn_32x32_layer1_weights,
          av1_tx_split_nn_32x32_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_64x64_layer0_weights[12 * 32] = {
...
static float av1_tx_split_nn_64x64_layer0_bias[32] = {
...
static float av1_tx_split_nn_64x64_layer1_weights[32] = {
...
static float av1_tx_split_nn_64x64_layer1_bias[1] = { -0.2307045f };

static float av1_tx_split_nn_64x64_in[12] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_64x64 = {
  0,                         // counter (!!Initialize to 0)
  1,                         // num_hidden_layers
  av1_tx_split_nn_64x64_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          12,                                    // num_inputs
          32,                                    // num_outputs
          av1_tx_split_nn_64x64_layer0_weights,  // weights
          av1_tx_split_nn_64x64_layer0_bias,     // bias
          RELU,                                  // activation
          av1_tx_split_nn_64x64_layer0_out,      // output
          av1_tx_split_nn_64x64_layer0_dout,     // d_out
      ...
      },
      {
          32,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_64x64_layer1_weights,
          av1_tx_split_nn_64x64_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_4x16_layer0_weights[8 * 16] = {
...
static float av1_tx_split_nn_4x16_layer0_bias[16] = {
...
static float av1_tx_split_nn_4x16_layer1_weights[16] = {
...
static float av1_tx_split_nn_4x16_layer1_bias[1] = {
  0.8205083f,
};

static float av1_tx_split_nn_4x16_in[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_4x16 = {
  0,                        // counter (!!Initialize to 0)
  1,                        // num_hidden_layers
  av1_tx_split_nn_4x16_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                    // num_inputs
          16,                                   // num_outputs
          av1_tx_split_nn_4x16_layer0_weights,  // weights
          av1_tx_split_nn_4x16_layer0_bias,     // bias
          RELU,                                 // activation
          av1_tx_split_nn_4x16_layer0_out,      // output
          av1_tx_split_nn_4x16_layer0_dout,     // d_out
      ...
      },
      {
          16,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_4x16_layer1_weights,
          av1_tx_split_nn_4x16_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_16x32_layer0_weights[8 * 32] = {
...
static float av1_tx_split_nn_16x32_layer0_bias[32] = {
...
static float av1_tx_split_nn_16x32_layer1_weights[32] = {
...
static float av1_tx_split_nn_16x32_layer1_bias[1] = {
  -0.29233751f,
};

static float av1_tx_split_nn_16x32_in[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_16x32 = {
  0,                         // counter (!!Initialize to 0)
  1,                         // num_hidden_layers
  av1_tx_split_nn_16x32_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                     // num_inputs
          32,                                    // num_outputs
          av1_tx_split_nn_16x32_layer0_weights,  // weights
          av1_tx_split_nn_16x32_layer0_bias,     // bias
          RELU,                                  // activation
          av1_tx_split_nn_16x32_layer0_out,      // output
          av1_tx_split_nn_16x32_layer0_dout,     // d_out
      ...
      },
      {
          32,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_16x32_layer1_weights,
          av1_tx_split_nn_16x32_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_32x64_layer0_weights[8 * 32] = {
...
static float av1_tx_split_nn_32x64_layer0_bias[32] = {
...
static float av1_tx_split_nn_32x64_layer1_weights[32] = {
...
static float av1_tx_split_nn_32x64_layer1_bias[1] = {
  -0.18160765f,
};

static float av1_tx_split_nn_32x64_in[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_32x64 = {
  0,                         // counter (!!Initialize to 0)
  1,                         // num_hidden_layers
  av1_tx_split_nn_32x64_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                     // num_inputs
          32,                                    // num_outputs
          av1_tx_split_nn_32x64_layer0_weights,  // weights
          av1_tx_split_nn_32x64_layer0_bias,     // bias
          RELU,                                  // activation
          av1_tx_split_nn_32x64_layer0_out,      // output
          av1_tx_split_nn_32x64_layer0_dout,     // d_out
      ...
      },
      {
          32,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_32x64_layer1_weights,
          av1_tx_split_nn_32x64_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_8x32_layer0_weights[8 * 24] = {
...
static float av1_tx_split_nn_8x32_layer0_bias[24] = {
...
static float av1_tx_split_nn_8x32_layer1_weights[24] = {
...
static float av1_tx_split_nn_8x32_layer1_bias[1] = {
  0.13435879f,
};

static float av1_tx_split_nn_8x32_in[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_8x32 = {
  0,                        // counter (!!Initialize to 0)
  1,                        // num_hidden_layers
  av1_tx_split_nn_8x32_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                    // num_inputs
          24,                                   // num_outputs
          av1_tx_split_nn_8x32_layer0_weights,  // weights
          av1_tx_split_nn_8x32_layer0_bias,     // bias
          RELU,                                 // activation
          av1_tx_split_nn_8x32_layer0_out,      // output
          av1_tx_split_nn_8x32_layer0_dout,     // d_out
      ...
      },
      {
          24,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_8x32_layer1_weights,
          av1_tx_split_nn_8x32_layer1_bias,
          NONE,
...
static float av1_tx_split_nn_16x64_layer0_weights[8 * 16] = {
...
static float av1_tx_split_nn_16x64_layer0_bias[16] = {
...
static float av1_tx_split_nn_16x64_layer1_weights[16] = {
...
static float av1_tx_split_nn_16x64_layer1_bias[1] = {
  0.04230947f,
};

static float av1_tx_split_nn_16x64_in[8] = { 0 };
...
static NN_CONFIG_V2 av1_tx_split_nnconfig_16x64 = {
  0,                         // counter (!!Initialize to 0)
  1,                         // num_hidden_layers
  av1_tx_split_nn_16x64_in,  // feature
  {
      // fc layer setting
      {
          // layer 0
          8,                                     // num_inputs
          16,                                    // num_outputs
          av1_tx_split_nn_16x64_layer0_weights,  // weights
          av1_tx_split_nn_16x64_layer0_bias,     // bias
          RELU,                                  // activation
          av1_tx_split_nn_16x64_layer0_out,      // output
          av1_tx_split_nn_16x64_layer0_dout,     // d_out
      ...
      },
      {
          16,  // num_inputs (!!same as num_outputs of last layer)
          1,
          av1_tx_split_nn_16x64_layer1_weights,
          av1_tx_split_nn_16x64_layer1_bias,
          NONE,
...
static NN_CONFIG_V2 *av1_tx_split_nnconfig_map[TX_SIZES_ALL] = {
  NULL,                          // TX_4X4,
