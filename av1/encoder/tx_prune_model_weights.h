...
static const float *prune_tx_split_thresholds[6] = {
  /* BLOCK_4X8 */
  (float[]){ 1.68f, 1.28f, 1.13f, 1.00f },
  /* BLOCK_8X4 */
  (float[]){ 1.83f, 1.54f, 1.36f, 1.22f },
  /* BLOCK_8X8 */
  (float[]){ 2.04f, 1.59f, 1.40f, 1.26f },
  /* BLOCK_8X16 */
  (float[]){ 1.02f, 0.63f, 0.44f, 0.28f },
  /* BLOCK_16X8 */
  (float[]){ 1.24f, 0.84f, 0.67f, 0.52f },
  /* BLOCK_16X16 */
  (float[]){ 1.52f, 1.04f, 0.83f, 0.65f },
};
