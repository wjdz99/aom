...
static const int prune_2D_num_hidden_units_hor[9] = { 8,  8,  16, 16, 16,
                                                      16, 16, 16, 32 };
static const float *prune_2D_learned_weights_hor[9] = {
  /* BLOCK_4X4 */
...
static const int prune_2D_num_hidden_units_ver[9] = { 8,  16, 8,  16, 16,
                                                      16, 16, 32, 16 };
static const float *prune_2D_learned_weights_ver[9] = {
  /* BLOCK_4X4 */
  (float[]){ 0.72406f,  -0.40019f, 0.51795f,  -0.43881f, -0.49746f, -0.41780f,
             -0.39409f, -0.16183f, -1.00135f, -0.41733f, -0.96534f, 0.93272f,
             1.06229f,  0.04188f,  0.60919f,  0.92405f,  -0.39359f, 0.70570f,
...
static const float *prune_2D_adaptive_thresholds[9] = {
  /* BLOCK_4X4 */
...
static const int prune_tx_split_num_hidden_units[6] = {
  16, 16, 16, 32, 32, 64
};
static const float *prune_tx_split_learned_weights[6] = {
  /* BLOCK_4X8 */
...
static const float *prune_tx_split_thresholds[6] = {
  /* BLOCK_4X8 */
  (float[]){ 2.68862f, 1.68786f, 1.00424f, -10000.0f },
  /* BLOCK_8X4 */
  (float[]){ 2.93633f, 1.83372f, 1.22791f, -10000.0f },
  /* BLOCK_8X8 */
  (float[]){ 3.33629f, 2.04254f, 1.26196f, -10000.0f },
  /* BLOCK_8X16 */
  (float[]){ 1.91318f, 1.02075f, 0.28527f, -10000.0f },
  /* BLOCK_16X8 */
  (float[]){ 2.31167f, 1.24521f, 0.52802f, -10000.0f },
  /* BLOCK_16X16 */
  (float[]){ 2.61510f, 1.52140f, 0.65175f, -10000.0f },
};
