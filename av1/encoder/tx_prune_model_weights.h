...
static const float av1_tx_type_nn_weights_4x4_layer0[32] = {
    0.72406f,  -0.40019f, 0.51795f,  -0.43881f, -0.49746f, -0.41780f,
...
static const NN_CONFIG av1_tx_type_nnconfig_4x4 = {
    ...
    1,            // num_hidden_layers
    { 8, },       // num_hidden_nodes
    { av1_tx_type_nn_weights_4x4_layer0, av1_tx_type_nn_weights_4x4_layer1, },
    { av1_tx_type_nn_bias_4x4_layer0, av1_tx_type_nn_bias_4x4_layer1, },
};
/******************************************************************************/

// Tx type model for 4x8 block.
static const float av1_tx_type_nn_weights_4x8_hor_layer0[32] = {
    0.68355f,  -0.06887f, 0.68525f,  -0.86048f, -0.35906f, -0.28597f,
...
static const float av1_tx_type_nn_weights_4x8_ver_layer0[128] = {
    0.88859f,  1.02796f,  1.15509f,  0.61719f,  0.85804f,  1.17581f,
...
static const float av1_tx_type_nn_bias_4x8_ver_layer0[16] = {
    -0.89131f, 0.09124f,  -0.71678f, -1.19929f,
...
static const float av1_tx_type_nn_weights_4x8_ver_layer1[64] = {
    ...
    -0.31783f, -0.19655f, 0.64619f,  0.50359f,
};

static const float av1_tx_type_nn_bias_4x8_ver_layer1[4] = {
    0.39274f,  1.27276f, 0.30322f,  2.55238f,
};
...
static const float av1_tx_type_nn_weights_8x4_hor_layer0[128] = {
    0.64828f,  0.61618f,  0.98975f,  -0.14562f, 0.26957f,  1.80872f,
...
static const float av1_tx_type_nn_bias_8x4_hor_layer0[16] = {
    -0.54227f, 0.08599f,  -0.77447f, -1.10920f,
...
static const float av1_tx_type_nn_weights_8x4_hor_layer1[64] = {
    ...
    0.67358f,  -0.20053f, 0.95830f,  0.44232f,
};

static const float av1_tx_type_nn_bias_8x4_hor_layer1[4] = {
    0.14889f,  1.74197f, 0.53696f,  2.87574f,
};
...
static const float av1_tx_type_nn_weights_8x4_ver_layer0[32] = {
    0.81919f,  0.15527f,  0.60055f,  -0.54617f, -0.35510f, -0.28223f,
...
static const float av1_tx_type_nn_weights_8x8_layer0[128] = {
    0.98214f,  1.05643f,  0.91173f,  0.24165f,  0.39961f,  0.25736f,
...
static const float av1_tx_type_nn_bias_8x8_layer0[16] = {
    0.75780f,  0.25628f,  0.19911f,  -0.41384f,
...
static const float av1_tx_type_nn_weights_8x8_layer1[64] = {
    ...
    -1.48232f, 0.00766f,  0.94016f,  -1.11974f,
};

static const float av1_tx_type_nn_bias_8x8_layer1[4] = {
    0.53574f,  1.57736f, -0.13698f, 2.64613f,
};
...
static const NN_CONFIG av1_tx_type_nnconfig_8x8 = {
    ...
    1,            // num_hidden_layers
    { 16, },       // num_hidden_nodes
    { av1_tx_type_nn_weights_8x8_layer0, av1_tx_type_nn_weights_8x8_layer1, },
    { av1_tx_type_nn_bias_8x8_layer0, av1_tx_type_nn_bias_8x8_layer1, },
};
/******************************************************************************/

// Tx type model for 8x16 block.
static const float av1_tx_type_nn_weights_8x16_hor_layer0[128] = {
    1.36274f,  1.37313f,  1.26859f,  1.26459f,  1.37979f,  1.47217f,
...
static const float av1_tx_type_nn_bias_8x16_hor_layer0[16] = {
    -1.30434f, -1.19259f, -0.43467f, -0.85386f,
...
static const float av1_tx_type_nn_weights_8x16_hor_layer1[64] = {
    ...
    1.33315f,  -0.09175f, 0.48747f,  1.16772f,
};

static const float av1_tx_type_nn_bias_8x16_hor_layer1[4] = {
    1.25783f,  1.19452f, 0.69964f,  2.41982f,
};
...
static const float av1_tx_type_nn_weights_8x16_ver_layer0[128] = {
    0.90888f,  0.86305f,  0.81674f,  0.75352f,  1.07834f,  0.99048f,
...
static const float av1_tx_type_nn_bias_8x16_ver_layer0[16] = {
    -0.83370f, -0.20704f, -0.60437f, -0.81664f,
...
static const float av1_tx_type_nn_weights_8x16_ver_layer1[64] = {
    ...
    0.42345f,  -0.10031f, 0.80871f,  0.44198f,
};

static const float av1_tx_type_nn_bias_8x16_ver_layer1[4] = {
    0.68329f,  1.33555f, 0.25943f,  3.23439f,
};
...
static const float av1_tx_type_nn_weights_16x8_hor_layer0[128] = {
    0.89821f,  0.90804f,  1.13052f,  0.74855f,  1.02053f,  0.91260f,
...
static const float av1_tx_type_nn_bias_16x8_hor_layer0[16] = {
    -0.87643f, 0.36754f,  -0.86409f, 1.37761f,
...
static const float av1_tx_type_nn_weights_16x8_hor_layer1[64] = {
    ...
    0.60707f,  -0.06110f, 0.74085f,  0.63304f,
};

static const float av1_tx_type_nn_bias_16x8_hor_layer1[4] = {
    0.71765f,  1.40400f, 0.32221f,  3.07234f,
};
...
static const float av1_tx_type_nn_weights_16x8_ver_layer0[128] = {
    1.20497f,  1.23691f,  1.23738f,  1.07773f,  1.15264f,  1.31959f,
...
static const float av1_tx_type_nn_bias_16x8_ver_layer0[16] = {
    -1.15644f, -0.31062f, 0.20697f,  -0.60304f,
...
static const float av1_tx_type_nn_weights_16x8_ver_layer1[64] = {
    ...
    0.44219f,  -0.09502f, 0.75745f,  0.99208f,
};

static const float av1_tx_type_nn_bias_16x8_ver_layer1[4] = {
    0.68774f,  0.88572f, 0.77462f,  3.05667f,
};
...
static const float av1_tx_type_nn_weights_16x16_layer0[128] = {
    1.26592f,  1.36313f,  1.30956f,  1.29926f,  1.48816f,  1.68851f,
...
static const float av1_tx_type_nn_bias_16x16_layer0[16] = {
    -1.31834f, 0.14346f,  -0.10062f, 0.84489f,
...
static const float av1_tx_type_nn_weights_16x16_layer1[64] = {
    ...
    0.54215f,  -0.07894f, 0.48274f,  1.08829f,
};

static const float av1_tx_type_nn_bias_16x16_layer1[4] = {
    0.81986f,  1.26865f, 0.11118f,  2.48404f,
};
...
static const NN_CONFIG av1_tx_type_nnconfig_16x16 = {
    ...
    1,            // num_hidden_layers
    { 16, },       // num_hidden_nodes
    { av1_tx_type_nn_weights_16x16_layer0, av1_tx_type_nn_weights_16x16_layer1, },
    { av1_tx_type_nn_bias_16x16_layer0, av1_tx_type_nn_bias_16x16_layer1, },
};
/******************************************************************************/
...
static const float av1_tx_type_nn_weights_16x32_ver_layer0[512] = {
    -0.01219f, 0.51494f,  0.25450f,  0.45788f,  -0.87277f, 0.32954f,
...
static const float av1_tx_type_nn_bias_16x32_ver_layer0[32] = {
    1.02458f,  -1.02185f, -0.18978f, 0.05981f,
...
static const float av1_tx_type_nn_weights_32x16_hor_layer0[512] = {
    -0.07289f, 0.30798f,  0.41881f,  0.33434f,  -0.01599f, 0.85307f,
...
static const float av1_tx_type_nn_bias_32x16_hor_layer0[32] = {
    1.53781f,  -0.49320f, -0.31646f, 0.02826f,
...
static const float av1_tx_type_nn_weights_32x16_ver_layer0[128] = {
    1.30219f,  1.30548f,  1.33334f,  1.20560f,  1.01572f,  1.38100f,
...
static const float av1_tx_type_nn_bias_32x16_ver_layer0[16] = {
    -1.19673f, 0.33043f,  0.24408f,  0.46221f,
...
static const float av1_tx_type_nn_weights_32x16_ver_layer1[64] = {
    ...
    0.75229f,  -0.06112f, 1.77282f,  1.01058f,
};

static const float av1_tx_type_nn_bias_32x16_ver_layer1[4] = {
    0.83082f,  2.03845f, 0.59627f,  2.31341f,
};
...
static const float av1_tx_split_nn_weights_4x8_layer0[48] = {
    0.32030f,  1.52126f,  1.14809f,  -2.14866f, -0.08888f, -0.22737f,
...
static const float av1_tx_split_nn_bias_4x8_layer1[1] = { -1.23037f, };
...
static const NN_CONFIG av1_tx_split_nnconfig_4x8 = {
    ...
    1,             // num_hidden_layers
    { 16, },       // num_hidden_nodes
    { av1_tx_split_nn_weights_4x8_layer0, av1_tx_split_nn_weights_4x8_layer1, },
    { av1_tx_split_nn_bias_4x8_layer0, av1_tx_split_nn_bias_4x8_layer1, },
};
/******************************************************************************/

// Tx split model for 8x4 block.
static const float av1_tx_split_nn_weights_8x4_layer0[48] = {
    -0.34959f, 3.09285f,  0.78709f,  -2.43502f, -0.10261f, -0.07371f,
...
static const float av1_tx_split_nn_bias_8x4_layer1[1] = { -0.26996f, };
...
static const NN_CONFIG av1_tx_split_nnconfig_8x4 = {
    ...
    1,             // num_hidden_layers
    { 16, },       // num_hidden_nodes
    { av1_tx_split_nn_weights_8x4_layer0, av1_tx_split_nn_weights_8x4_layer1, },
    { av1_tx_split_nn_bias_8x4_layer0, av1_tx_split_nn_bias_8x4_layer1, },
};
/******************************************************************************/

// Tx split model for 8x8 block.
static const float av1_tx_split_nn_weights_8x8_layer0[80] = {
    -2.47727f, 2.02291f,  0.50872f,  0.08612f,  -0.50731f, -4.17997f,
...
static const float av1_tx_split_nn_bias_8x8_layer0[16] = {
    0.67772f,  -1.06375f, 0.29005f,  -3.82750f,
...
static const float av1_tx_split_nn_bias_8x8_layer1[1] = { -3.58924f, };
...
static const NN_CONFIG av1_tx_split_nnconfig_8x8 = {
    ...
    1,             // num_hidden_layers
    { 16, },       // num_hidden_nodes
    { av1_tx_split_nn_weights_8x8_layer0, av1_tx_split_nn_weights_8x8_layer1, },
    { av1_tx_split_nn_bias_8x8_layer0, av1_tx_split_nn_bias_8x8_layer1, },
};
/******************************************************************************/

// Tx split model for 8x16 block.
static const float av1_tx_split_nn_weights_8x16_layer0[288] = {
    -0.21895f, -0.45677f, 2.41986f,  0.45214f,  -2.74380f, -1.00732f,
...
static const float av1_tx_split_nn_weights_8x16_layer1[32] = {
    -2.47039f, 6.28151f,  2.51358f,  2.96845f,
...
static const float av1_tx_split_nn_bias_8x16_layer1[1] = { -3.72500f, };
...
static const NN_CONFIG av1_tx_split_nnconfig_8x16 = {
    ...
    1,             // num_hidden_layers
    { 32, },       // num_hidden_nodes
    { av1_tx_split_nn_weights_8x16_layer0, av1_tx_split_nn_weights_8x16_layer1, },
    { av1_tx_split_nn_bias_8x16_layer0, av1_tx_split_nn_bias_8x16_layer1, },
};
/******************************************************************************/

// Tx split model for 16x8 block.
static const float av1_tx_split_nn_weights_16x8_layer0[288] = {
    -0.30988f, 0.89705f,  0.69177f,  0.00918f,  -0.44076f, 0.78649f,
...
static const float av1_tx_split_nn_weights_16x8_layer1[32] = {
    0.95524f,  0.31578f,  0.27905f,  2.52514f,
...
static const float av1_tx_split_nn_bias_16x8_layer1[1] = { -1.87185f, };
...
static const NN_CONFIG av1_tx_split_nnconfig_16x8 = {
    ...
    1,             // num_hidden_layers
    { 32, },       // num_hidden_nodes
    { av1_tx_split_nn_weights_16x8_layer0, av1_tx_split_nn_weights_16x8_layer1, },
    { av1_tx_split_nn_bias_16x8_layer0, av1_tx_split_nn_bias_16x8_layer1, },
};
/******************************************************************************/

// Tx split model for 16x16 block.
static const float av1_tx_split_nn_weights_16x16_layer0[1088] = {
    -2.33512f, -3.31371f, -1.76911f, -0.09432f, -0.77541f, -1.24532f,
...
static const float av1_tx_split_nn_bias_16x16_layer0[64] = {
    0.65312f,  -0.83098f, 0.39323f,  -2.75927f,
...
static const float av1_tx_split_nn_weights_16x16_layer1[64] = {
    ...
    -1.31273f, 3.65086f,  0.06778f,  -0.43647f,
};

static const float av1_tx_split_nn_bias_16x16_layer1[1] = { -3.21793f, };
...
static const NN_CONFIG av1_tx_split_nnconfig_16x16 = {
    ...
    1,             // num_hidden_layers
    { 64, },       // num_hidden_nodes
    { av1_tx_split_nn_weights_16x16_layer0, av1_tx_split_nn_weights_16x16_layer1, },
    { av1_tx_split_nn_bias_16x16_layer0, av1_tx_split_nn_bias_16x16_layer1, },
};
/******************************************************************************/
