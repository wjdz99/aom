...
static const NN_CONFIG *av1_intra_tx_split_nnconfig_map[TX_SIZES_ALL] = {
  NULL,                              // TX_4X4,
  &av1_intra_tx_split_nnconfig_8x8,  // TX_8X8,
  NULL,                              // TX_16X16,
  NULL,                              // TX_32X32,
  NULL,                              // TX_64X64,
  NULL,                              // TX_4X8,
...
static const float av1_intra_tx_prune_nn_thresh[TX_SIZES_ALL][2] = {
  { -1.0f, -1.0f },           // TX_4X4,
  { -0.405465f, 0.405465f },  // TX_8X8,
  { -1.0f, -1.0f },           // TX_16X16,
  { -1.0f, -1.0f },           // TX_32X32,
  { -1.0f, -1.0f },           // TX_64X64,
  { -1.0f, -1.0f },           // TX_4X8,
