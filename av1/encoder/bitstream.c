...
#if EXPT_U
    aom_wb_write_literal(wb, cm->u_min_val, cm->bit_depth);
    aom_wb_write_literal(wb, cm->u_max_val, cm->bit_depth);
#endif
  } else {
    write_min_max_delta(cm->min_val, cm->last_min_val, wb);
    write_min_max_delta(cm->max_val, cm->last_max_val, wb);
#if EXPT_U
    write_min_max_delta(cm->u_min_val, cm->last_u_min_val, wb);
    write_min_max_delta(cm->u_max_val, cm->last_u_max_val, wb);
#endif
  }
}
#endif
