...
static AOM_INLINE void write_ccso(AV1_COMMON *cm, MACROBLOCKD *const xd,
  ...
  if (!(mi_row & ((1 << CCSO_BLK_SIZE >> (2 - xd->plane[1].subsampling_y)) -
                  (MI_SIZE_LOG2 - 1))) &&
      !(mi_col & ((1 << CCSO_BLK_SIZE >> (2 - xd->plane[1].subsampling_x)) -
                  (MI_SIZE_LOG2 - 1))) &&
  ...
  if (!(mi_row & ((1 << CCSO_BLK_SIZE >> (2 - xd->plane[2].subsampling_y)) -
                  (MI_SIZE_LOG2 - 1))) &&
      !(mi_col & ((1 << CCSO_BLK_SIZE >> (2 - xd->plane[2].subsampling_x)) -
                  (MI_SIZE_LOG2 - 1))) &&
