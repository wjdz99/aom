...
void write_last_tile_info(AV1LevelParams *const level_params,
                          ...
                          int num_tg_hdrs, int error_resilient_mode,
  ...
  *tile_data_start += length_field_size;
  ...
  if (!(*is_first_tg) && error_resilient_mode) {
    ...
    *largest_tile_id = 0;
    ...
    curr_tg_start += fh_info->total_length;
  ...
  for (int tile_row = 0; tile_row < tile_rows; tile_row++) {
    for (int tile_col = 0; tile_col < tile_cols; tile_col++) {
      ...
      if (is_last_tile_in_tg)
        write_last_tile_info(&cpi->level_params, fh_info, saved_wb,
                             &curr_tg_data_size, tile_data_curr, total_size,
                             tile_data_start, largest_tile_id, &is_first_tg,
                             num_tg_hdrs, cm->features.error_resilient_mode,
