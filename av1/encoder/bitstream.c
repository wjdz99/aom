...
// write current tile group size
        ...
        if (num_tg_hdrs == 1) {
          fprintf(stderr, "obu_payload_size:%d curr_tg_size:%d obu_header_size:%d\n", obu_payload_size, curr_tg_data_size, obu_header_size);
        ...
        fprintf(stderr, "lfs:%d tds:%p\n", (int)length_field_size, tile_data_start);
