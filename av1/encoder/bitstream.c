...
static inline void write_drl_idx(
...
static inline void write_is_inter(const AV1_COMMON *cm,
...
static inline void write_delta_qindex(const MACROBLOCKD *xd,
...
static inline void pack_map_tokens(aom_writer *w, const TokenExtra **tp,
...
static inline void write_ref_frames(const AV1_COMMON *cm,
...
static inline void write_filter_intra_mode_info(
...
static inline void write_mb_interp_filter(AV1_COMMON *const cm,
...
// delta encoding.
static inline void write_palette_colors_y(
...
static inline void write_palette_colors_uv(
    const MACROBLOCKD *const xd, const PALETTE_MODE_INFO *const pmi,
    int bit_depth, aom_writer *w) {
...
static inline void write_cfl_alphas(FRAME_CONTEXT *const ec_ctx,
...
static inline void write_inter_segment_id(
...
static inline void write_modes_sb(
...
static inline void encode_restoration_mode(
...
static inline void write_delta_q(struct aom_write_bit_buffer *wb,
                                     int delta_q) {
  if (delta_q != 0) {
    aom_wb_write_bit(wb, 1);
...
static inline void write_frame_interp_filter(
...
static inline void write_tile_info_max_tile(
...
static inline void write_ext_tile_info(
...
static inline void write_frame_size_with_refs(
    const AV1_COMMON *const cm, struct aom_write_bit_buffer *wb) {
  int found = 0;
...
static inline void write_color_config(
...
static inline void write_sequence_header(
    const SequenceHeader *const seq_params, struct aom_write_bit_buffer *wb) {
