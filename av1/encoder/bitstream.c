...
static void write_inter_mode(aom_writer *w, PREDICTION_MODE mode,
  ...
  // TODO(kslu): check if second ref is available first to save bits
  // TODO(kslu): add mode as context
  aom_write_symbol(w, is_optflow_mode(mode), ec_ctx->is_opfl_mode_cdf, 2);
