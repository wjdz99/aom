...
#if CONFIG_SDP
      write_modes_sb(cpi, tile, w, tok, tok_end, NULL, mi_row, mi_col, subsize);
      write_modes_sb(cpi, tile, w, tok, tok_end, NULL, mi_row, mi_col + hbs,
                     subsize);
      write_modes_sb(cpi, tile, w, tok, tok_end, NULL, mi_row + hbs, mi_col,
                     subsize);
      write_modes_sb(cpi, tile, w, tok, tok_end, NULL, mi_row + hbs,
                     mi_col + hbs, subsize);
#else
