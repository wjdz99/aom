...
static INLINE uint32_t pack_tiles_in_tg_obus(
  ...
  // source alt-ref frames. This behavior is due setup time overhead of
  // multithread function would be more than to write the smaller bitstream of
  // source alt-ref frames.
  const int enable_mt =
