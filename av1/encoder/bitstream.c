...
static void write_global_motion(AV1_COMP *cpi,
  ...
  for (frame = LAST_FRAME; frame <= ALTREF_FRAME; ++frame) {
    ...
    write_global_motion_params(&cm->global_motion[frame], &default_warp_params/*ref_params*/, wb,
    ...
    printf("Frame %d/%d: Enc Ref %d: %d %d %d %d pass: %d\n",
           cm->current_video_frame, cm->show_frame, frame,
           ref_params.wmmat[0],
           ref_params.wmmat[1], ref_params.wmmat[2],
           ref_params.wmmat[3], cpi->oxcf.pass);
    */
