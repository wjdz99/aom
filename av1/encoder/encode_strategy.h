 ...
 * stacks \param[out]   remapped_ref_idx  An array for storing indices of
 * reference frames. The index is used to retrieve reference frame buffer from
 * ref_frame_map in AV1Common.
 */
