...
static AOM_INLINE void ref_match_found(MACROBLOCKD *xd, int rel_mi_row,
                                       int rel_mi_col, uint8_t op_mi_size,
                                       int dir, MB_MODE_INFO *nb_mbmi,
                                       void *ref_match_found,
...
static INLINE void get_tpl_stats_for_pruning(
