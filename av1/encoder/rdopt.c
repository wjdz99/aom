 ...
 * \param[in]    cur_mv            Current motion vector.
 * \param[in]    bsize             Current block size.
 * \param[in]    compmode_interinter_cost  RD of the selected interinter 
                                   compound mode.
 ...
 * information to the current mode: MB_MODE_INFO struct, cur_mv, 
 * compound_interinter_cost, rd_stats, rd_buffers,
 * skip_rd, skip_build_pred.
 */
