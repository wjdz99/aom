 ...
 * \param[in]    ref_skip_rd       An array of length 2, where skip_rd[0] is the
 ...
 * \param[in]    rate_mv           The rate assiciated with the motion vectors.
 ...
 * information to the current mode: MB_MODE_INFO struct, rd_stats, rd_stats_y,
 * rd_stats_uv, ref_skip_rd, rate_mv, orig_dst, best_est_rd.
 */
