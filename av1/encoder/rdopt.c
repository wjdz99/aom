...
static INLINE int is_intra_hash_match(const AV1_COMP *cpi, MACROBLOCK *x, int plane,
                               int blk_row, int blk_col, BLOCK_SIZE plane_bsize,
                               TX_SIZE tx_size, const TXB_CTX *const txb_ctx,
                               TXB_RD_INFO **intra_txb_rd_info,
                               int within_border, const int tx_type_map_idx,
