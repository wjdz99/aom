...
static int skip_inter_mode(AV1_COMP *cpi, MACROBLOCK *x, const BLOCK_SIZE bsize, 
                           ...
                           int midx, InterModeSFArgs *args, int tmp) {
...
void av1_rd_pick_inter_mode_sb(AV1_COMP *cpi, TileDataEnc *tile_data,
  ...
  // frames.
  const int last_single_ref_mode_idx =
      find_last_single_ref_mode_idx(av1_default_mode_order);//sarahparker
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (skip_inter_mode(cpi, x, bsize, ref_frame_rd, midx, &sf_args, sf_args.prune_cpd_using_sr_stats_ready)) continue;
