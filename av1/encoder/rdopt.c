  ...
  for (int ref_mv_idx = 0; ref_mv_idx < ref_set; ++ref_mv_idx) {
    ...
    if (ret_val != INT64_MAX) {
      ...
      store_winner_mode_stats(
          ...
          tmp_rd, cpi->sf.winner_mode_sf.multi_winner_mode_type, do_tx_search);
      if (tmp_rd < best_rd) {
        best_yrd = this_yrd;
    ...
    *mbmi = best_motion_mode_cands->motion_mode_cand[cand].mbmi;
    ...
    if (ret_value != INT64_MAX) {
      ...
      store_winner_mode_stats(&cpi->common, x, mbmi, &rd_stats, &rd_stats_y,
                              &rd_stats_uv, mode_enum, rd_stats.rdcost,
...
static AOM_INLINE void search_intra_modes_in_interframe(
  ...
  *mbmi = best_mbmi;
  ...
  store_winner_mode_stats(
      ...
      &intra_rd_stats_uv, best_mode_enum, intra_rd_stats.rdcost,
