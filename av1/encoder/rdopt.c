...
static int64_t motion_mode_rd(
  ...
  *yrd = INT64_MAX;
  ...
  if (cpi->sf.inter_sf.motion_mode_agg_txfm_rd_gating && txfm_rd_gate_level &&
      !eval_motion_mode && num_pels_log2_lookup[bsize] > 8)
    txfm_rd_gate_level = AOMMIN(txfm_rd_gate_level + 1, MAX_TX_RD_GATE_LEVEL);
