...
typedef struct TPL_SPEED_FEATURES {
  ...
  // (base+2) layer decide whether a shorter gf interval is better. If set
  // to 2, tpl stats of ARFs from base layer, (base+1) layer and GF boost
  // decide whether a shorter gf interval is better. If set to 3, gop length
  // adaptive decision is disabled.
