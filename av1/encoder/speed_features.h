...
typedef struct WINNER_MODE_SPEED_FEATURES {
  ...
  // 0: No pruning
  // 1: Disabling happens for blocks with low source variance.
  // 2: Disabling happens for blocks with transform is resulted in skip from the
  // MODE_EVAL stage.
  int disable_winner_mode_eval_level;
