...
typedef struct REAL_TIME_SPEED_FEATURES {
  ...
  //
  // For allintra encode, this speed feature reduces instruction count by 4.96%
  // for speed 9 with coding performance change less than 0.38%.
  // For AVIF image encode, this speed feature reduces encode time by 3.39% for
  // speed 9 on a typical image dataset with coding performance change less than
  // -0.06%.
  bool enable_intra_mode_pruning_using_nb_info;
