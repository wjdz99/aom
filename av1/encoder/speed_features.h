...
typedef struct INTRA_MODE_SPEED_FEATURES {
  ...
  // For allintra encode, this sf reduces instruction count by 4.461%,
  // 3.699% and 3.536% for speed 6, 7 and 8 on a typical video dataset with
  // coding performance change less than 0.26%. For AVIF image encode, this sf
  // reduces encode time by 2.849%, 2.471%, and 2.051% for speed 6, 7 and 8 on a
  // typical image dataset with coding performance change less than 0.27%.
