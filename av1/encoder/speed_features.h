...
// This enumeration defines the different levels of aggressiveness in using
// transform domain distortion during the R-D evaluation.
enum {
  TX_DOMAIN_DIST_LVL_0,
  TX_DOMAIN_DIST_LVL_1,
  TX_DOMAIN_DIST_LVL_2,
  TX_DOMAIN_DIST_LVL_3,
  TX_DOMAIN_DIST_LEVELS
} UENUM1BYTE(TX_DOMAIN_DIST_LEVEL);
/*!\endcond */
...
typedef struct RD_CALC_SPEED_FEATURES {
  ...
  // TX_DOMAIN_DIST_LVL_0  :    Method 0    Method 2    Method 0
  // TX_DOMAIN_DIST_LVL_1  :    Method 1    Method 2    Method 0
  // TX_DOMAIN_DIST_LVL_2  :    Method 2    Method 2    Method 0
  // TX_DOMAIN_DIST_LVL_3  :    Method 2    Method 2    Method 2
  TX_DOMAIN_DIST_LEVEL tx_domain_dist_level;
