...
typedef struct INTER_MODE_SPEED_FEATURES {
  ...
  // GLOBALMV and skip NEARMV or GLOBALMV if a duplicate is found
  // TODO(any): Instead of skipping repeated ref mv, Experiment to reuse the
  // distortion of mode with same ref mvs and recalculate the rate
