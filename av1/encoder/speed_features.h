...
typedef struct PARTITION_SPEED_FEATURES {
  ...
  // for speed 6 with coding performance change less than 0.18 %. For AVIF image
  // encode, this speed feature reduces encode time by 8.1% for speed 6 on a
  // typical image dataset with coding performance change less than 0.15%. This
  // speed feature is not applicable for speed >= 7.
  bool prune_rect_part_based_on_4x4_var_deviation;
