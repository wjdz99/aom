...
typedef struct SPEED_FEATURES {
  ...
  // Level 0: Full RD for default, mode and winner mode tx eval
  // Level 1: Fast RD for default, mode and winner mode tx eval
  // Level 2: Largest allowed tx for default, mode and winner mode tx eval
  // Level 3: Full RD for default and winner mode tx eval, Largest allowed tx
  // for mode eval Level 4: Largest allowed tx for default and mode eval, Full
  // RD for winner mode tx eval
