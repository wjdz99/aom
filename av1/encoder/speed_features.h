...
enum {
  ...
  PRUNE_NEARMV_LEVEL1 = 1,  // Prune nearmv for qindex (0-85) in level 1
  PRUNE_NEARMV_LEVEL2 = 2,  // Prune nearmv for qindex (0-170) in level 2
  PRUNE_NEARMV_LEVEL3 = 3,  // More aggressive nearmv mode pruning
