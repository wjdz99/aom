...
typedef struct INTRA_MODE_SPEED_FEATURES {
  ...
  // For allintra encode, this sf reduces instruction count by 1.07%
  // and 2.76% for speed 1 and 2 on screen
  // content set with coding performance change less than 0.01%.
  // For AVIF image encode, this sf reduces instruction count by 1.13%
  // and 1.29% for speed 1 and 2 on a typical image
  // dataset with coding performance change less than 0.01%.
