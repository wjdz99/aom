...
typedef struct INTER_MODE_SPEED_FEATURES {
  ...
  // This speed feature equalling 0 means no skipping.
  ...
  //     other ref_mv.
  // The speed feature equalling 1 means using subpel mv in the comparison.
  // The speed feature equalling 2 means using fullpel mv in the comparison.
