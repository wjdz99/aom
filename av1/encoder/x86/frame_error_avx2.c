...
int64_t av1_calc_highbd_frame_error_avx2(const uint16_t *const ref,
                                         ...
                                         int p_height, int bd) {
  const int b = bd - 8;
  __m128i shift = _mm_cvtsi32_si128(b);
  __m256i bmask = _mm256_set1_epi16((1 << b) - 1);
  __m256i v = _mm256_set1_epi16(1 << b);
  ...
  __m256i dup_257 = _mm256_set1_epi16(257);
  col_error = zero;
  for (i = 0; i < (p_height / 2); i++) {
    row_error = _mm256_setzero_si256();
    for (j = 0; j < (p_width / 16); j++) {
      __m256i ref_1_16 = _mm256_load_si256(
          (__m256i *)(ref + (j * 16) + (((i * 2) + 0) * ref_stride)));
      __m256i dst_1_16 = _mm256_load_si256(
          (__m256i *)(dst + (j * 16) + (((i * 2) + 0) * dst_stride)));
      __m256i ref_2_16 = _mm256_load_si256(
          (__m256i *)(ref + (j * 16) + (((i * 2) + 1) * ref_stride)));
      __m256i dst_2_16 = _mm256_load_si256(
          (__m256i *)(dst + (j * 16) + (((i * 2) + 1) * dst_stride)));

      __m256i diff_1 = _mm256_sub_epi16(dst_1_16, ref_1_16);
      __m256i diff_2 = _mm256_sub_epi16(dst_2_16, ref_2_16);

      __m256i e1_1 = _mm256_sra_epi16(diff_1, shift);
      __m256i e2_1 = _mm256_and_si256(diff_1, bmask);
      __m256i e1_2 = _mm256_sra_epi16(diff_2, shift);
      __m256i e2_2 = _mm256_and_si256(diff_2, bmask);
      ...
      __m256i idx1_1 = _mm256_add_epi16(e1_1, dup_256);
      __m256i idx2_1 = _mm256_add_epi16(e1_1, dup_257);
      __m256i idx1_2 = _mm256_add_epi16(e1_2, dup_256);
      __m256i idx2_2 = _mm256_add_epi16(e1_2, dup_257);

      __m256i idx1_lo_1 = _mm256_unpacklo_epi16(idx1_1, zero);
      __m256i idx1_hi_1 = _mm256_unpackhi_epi16(idx1_1, zero);
      __m256i idx2_lo_1 = _mm256_unpacklo_epi16(idx2_1, zero);
      __m256i idx2_hi_1 = _mm256_unpackhi_epi16(idx2_1, zero);

      __m256i idx1_lo_2 = _mm256_unpacklo_epi16(idx1_2, zero);
      __m256i idx1_hi_2 = _mm256_unpackhi_epi16(idx1_2, zero);
      __m256i idx2_lo_2 = _mm256_unpacklo_epi16(idx2_2, zero);
      __m256i idx2_hi_2 = _mm256_unpackhi_epi16(idx2_2, zero);

      __m256i error_1_lo_1 =
          _mm256_i32gather_epi32(error_measure_lut, idx1_lo_1, 4);
      __m256i error_1_hi_1 =
          _mm256_i32gather_epi32(error_measure_lut, idx1_hi_1, 4);
      __m256i error_2_lo_1 =
          _mm256_i32gather_epi32(error_measure_lut, idx2_lo_1, 4);
      __m256i error_2_hi_1 =
          _mm256_i32gather_epi32(error_measure_lut, idx2_hi_1, 4);
      __m256i error_1_lo_2 =
          _mm256_i32gather_epi32(error_measure_lut, idx1_lo_2, 4);
      __m256i error_1_hi_2 =
          _mm256_i32gather_epi32(error_measure_lut, idx1_hi_2, 4);
      __m256i error_2_lo_2 =
          _mm256_i32gather_epi32(error_measure_lut, idx2_lo_2, 4);
      __m256i error_2_hi_2 =
          _mm256_i32gather_epi32(error_measure_lut, idx2_hi_2, 4);

      __m256i error_1_1 = _mm256_packus_epi32(error_1_lo_1, error_1_hi_1);
      __m256i error_2_1 = _mm256_packus_epi32(error_2_lo_1, error_2_hi_1);
      __m256i error_1_2 = _mm256_packus_epi32(error_1_lo_2, error_1_hi_2);
      __m256i error_2_2 = _mm256_packus_epi32(error_2_lo_2, error_2_hi_2);
      ...
      __m256i e2_inv_1 = _mm256_sub_epi16(v, e2_1);
      __m256i e2_inv_2 = _mm256_sub_epi16(v, e2_2);

      __m256i error_lo_1 = _mm256_unpacklo_epi16(error_1_1, error_2_1);
      __m256i error_hi_1 = _mm256_unpackhi_epi16(error_1_1, error_2_1);
      __m256i mul_lo_1 = _mm256_unpacklo_epi16(e2_inv_1, e2_1);
      __m256i mul_hi_1 = _mm256_unpackhi_epi16(e2_inv_1, e2_1);

      __m256i error_lo_2 = _mm256_unpacklo_epi16(error_1_2, error_2_2);
      __m256i error_hi_2 = _mm256_unpackhi_epi16(error_1_2, error_2_2);
      __m256i mul_lo_2 = _mm256_unpacklo_epi16(e2_inv_2, e2_2);
      __m256i mul_hi_2 = _mm256_unpackhi_epi16(e2_inv_2, e2_2);

      __m256i result_lo_1 = _mm256_madd_epi16(error_lo_1, mul_lo_1);
      __m256i result_hi_1 = _mm256_madd_epi16(error_hi_1, mul_hi_1);
      __m256i result_lo_2 = _mm256_madd_epi16(error_lo_2, mul_lo_2);
      __m256i result_hi_2 = _mm256_madd_epi16(error_hi_2, mul_hi_2);
