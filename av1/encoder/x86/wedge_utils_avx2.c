...
uint64_t av1_wedge_sse_from_residuals_avx2(const int16_t *r1, const int16_t *d,
  ...
  do {
    const __m256i v_r0_w = _mm256_load_si256((__m256i *)(r1 + n));
    const __m256i v_d0_w = _mm256_load_si256((__m256i *)(d + n));
...
int av1_wedge_sign_from_residuals_avx2(const int16_t *ds, const uint8_t *m,
  ...
  do {
    const __m256i v_m01_b = _mm256_load_si256((__m256i *)(m));
    const __m256i v_m23_b = _mm256_load_si256((__m256i *)(m + 32));

    const __m256i v_d0_w = _mm256_load_si256((__m256i *)(ds));
    const __m256i v_d1_w = _mm256_load_si256((__m256i *)(ds + 16));
    const __m256i v_d2_w = _mm256_load_si256((__m256i *)(ds + 32));
    const __m256i v_d3_w = _mm256_load_si256((__m256i *)(ds + 48));
  ...
  v_acc_q_0 = _mm_add_epi64(v_acc_q_0, v_acc_q_1);
  int64_t acc = (uint64_t)_mm_extract_epi64(v_acc_q_0, 0);
...
void av1_wedge_compute_delta_squares_avx2(int16_t *d, const int16_t *a,
  ...
  do {
    const __m256i v_a0_w = _mm256_load_si256((__m256i *)(a));
    const __m256i v_b0_w = _mm256_load_si256((__m256i *)(b));
    const __m256i v_a1_w = _mm256_load_si256((__m256i *)(a + 16));
    const __m256i v_b1_w = _mm256_load_si256((__m256i *)(b + 16));
    const __m256i v_a2_w = _mm256_load_si256((__m256i *)(a + 32));
    const __m256i v_b2_w = _mm256_load_si256((__m256i *)(b + 32));
    const __m256i v_a3_w = _mm256_load_si256((__m256i *)(a + 48));
    const __m256i v_b3_w = _mm256_load_si256((__m256i *)(b + 48));
