...
static AOM_FORCE_INLINE void xx_load_and_pad_left(uint32_t *src, __m256i *v256tmp) {
...
static AOM_FORCE_INLINE void xx_load_and_pad_right(uint32_t *src, __m256i *v256tmp) {
  *v256tmp = _mm256_loadu_si256((__m256i *)src);
    // For the last column, replicate the last element twice to the right
    __m256i v256tmp1 = _mm256_shuffle_epi32(*v256tmp, 0x54);
    *v256tmp =
        _mm256_inserti128_si256(*v256tmp, _mm256_extracti128_si256(v256tmp1,1), 1);
}
