...
static AOM_FORCE_INLINE __m256i av1_round_shift_32_avx2(__m256i vec, int bit) {
  __m256i tmp, round;
...
// out0 = in0*w0 + in1*w1
// out1 = -in1*w0 + in0*w1
static AOM_FORCE_INLINE btf_32_avx2_type0(const int32_t w0, const int32_t w1,
...
static AOM_FORCE_INLINE btf_32_avx2_type1(const int32_t w0, const int32_t w1,
                                          __m256i *in0, __m256i *in1,
                                          const __m256i _r,
                                          const int32_t cos_bit) {
  __m256i _in0 = *in0;
...
// out0 = in0*w0 + in1*w1
// out1 = -in1*w0 + in0*w1
static AOM_FORCE_INLINE btf_32_avx2_type0_new(const __m256i ww0,
                                              const __m256i ww1, __m256i *in0,
                                              __m256i *in1, const __m256i _r,
                                              const int32_t cos_bit) {
  __m256i _in0 = *in0;
  __m256i _in1 = *in1;
  const __m256i in0_w0 = _mm256_mullo_epi32(_in0, ww0);
...
// out0 = in0*w0 + in1*w1
// out1 = in1*w0 - in0*w1
static AOM_FORCE_INLINE btf_32_avx2_type1_new(const __m256i ww0,
                                              const __m256i ww1, __m256i *in0,
                                              __m256i *in1, const __m256i _r,
                                              const int32_t cos_bit) {
  __m256i _in0 = *in0;
