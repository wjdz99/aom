...
static INLINE void init_qp(const int16_t *round_ptr, const int16_t *quant_ptr,
  ...
  qp[0] = _mm256_set_epi32(round1, round1, round1, round1, round1, round1, round1, round0);

  const int quant1 = quant_ptr[1];
  const int quant0 = quant_ptr[0];
  qp[1] = _mm256_set_epi32(quant1, quant1, quant1, quant1, quant1, quant1, quant1, quant0);

  const int dequant1 = dequant_ptr[1];
  const int dequant0 = dequant_ptr[0];
  qp[2] = _mm256_set_epi32(dequant1, dequant1, dequant1, dequant1, dequant1, dequant1, dequant1, dequant0);
#else
