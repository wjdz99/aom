...
int64_t av1_calc_highbd_frame_error_sse2(const uint16_t *const ref,
  ...
  __m128i bmask = _mm_set1_epi16((1 << b) - 1);
  __m128i v = _mm_set1_epi16(1 << b);
  ...
  __m128i dup_257 = _mm_set1_epi16(257);
  col_error = zero;
  for (i = 0; i < (p_height); i++) {
    ...
    for (j = 0; j < (p_width / 16); j++) {
      ...
      __m128i diff_1 = _mm_sub_epi16(dst_1, ref_1);
      __m128i diff_2 = _mm_sub_epi16(dst_2, ref_2);

      __m128i e1_1 = _mm_sra_epi16(diff_1, shift);
      __m128i e2_1 = _mm_and_si128(diff_1, bmask);
      __m128i e1_2 = _mm_sra_epi16(diff_2, shift);
      __m128i e2_2 = _mm_and_si128(diff_2, bmask);
      ...
      __m128i idx1_1 = _mm_add_epi16(e1_1, dup_256);
      __m128i error1_1 =
      ...
      __m128i idx2_1 = _mm_add_epi16(e1_1, dup_257);
      __m128i error2_1 =
      ...
      __m128i error_lo_1 = _mm_unpacklo_epi16(error1_1, error2_1);
      __m128i error_hi_1 = _mm_unpackhi_epi16(error1_1, error2_1);

      __m128i idx1_2 = _mm_add_epi16(e1_2, dup_256);
      __m128i error1_2 =
      ...
      __m128i idx2_2 = _mm_add_epi16(e1_2, dup_257);
      __m128i error2_2 =
      ...
      __m128i error_lo_2 = _mm_unpacklo_epi16(error1_2, error2_2);
      __m128i error_hi_2 = _mm_unpackhi_epi16(error1_2, error2_2);

      // Compute multipliers
      __m128i e2_inv_1 = _mm_sub_epi16(v, e2_1);
      __m128i mul_lo_1 = _mm_unpacklo_epi16(e2_inv_1, e2_1);
      __m128i mul_hi_1 = _mm_unpackhi_epi16(e2_inv_1, e2_1);

      __m128i e2_inv_2 = _mm_sub_epi16(v, e2_2);
      __m128i mul_lo_2 = _mm_unpacklo_epi16(e2_inv_2, e2_2);
      __m128i mul_hi_2 = _mm_unpackhi_epi16(e2_inv_2, e2_2);

      // Multiply and accumulate
      __m128i result1_1 = _mm_madd_epi16(error_lo_1, mul_lo_1);
      __m128i result2_1 = _mm_madd_epi16(error_hi_1, mul_hi_1);
      __m128i result1_2 = _mm_madd_epi16(error_lo_2, mul_lo_2);
      __m128i result2_2 = _mm_madd_epi16(error_hi_2, mul_hi_2);

      __m128i partial_sum = _mm_add_epi32(_mm_add_epi32(result1_1, result2_1),
