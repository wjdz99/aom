...
void av1_fwd_txfm2d_4x4_sse4_1(const int16_t *input, int32_t *coeff,
  ...
  switch (tx_type) {
    case DCT_DCT:
      ...
      fdct4x4_sse4_1(in, col_cfg->cos_bit);
      fdct4x4_sse4_1(in, row_cfg->cos_bit);
    ...
    case ADST_DCT:
      ...
      load_buffer_4x4(input, in, input_stride, 0, 0, row_cfg->shift[0]);
      fadst4x4_sse4_1(in, col_cfg->cos_bit);
      fdct4x4_sse4_1(in, row_cfg->cos_bit);
      write_buffer_4x4(in, coeff);
      break;
    case DCT_ADST:
      ...
      load_buffer_4x4(input, in, input_stride, 0, 0, row_cfg->shift[0]);
      fdct4x4_sse4_1(in, col_cfg->cos_bit);
      fadst4x4_sse4_1(in, row_cfg->cos_bit);
      write_buffer_4x4(in, coeff);
      break;
    case ADST_ADST:
      row_cfg = &fwd_txfm_1d_row_cfg_adst_4;
...
void av1_fwd_txfm2d_8x8_sse4_1(const int16_t *input, int32_t *coeff, int stride,
  ...
  switch (tx_type) {
    case DCT_DCT:
      ...
      fdct8x8_sse4_1(in, out, col_cfg->cos_bit);
      col_txfm_8x8_rounding(out, -row_cfg->shift[1]);
      transpose_8x8(out, in);
      fdct8x8_sse4_1(in, out, row_cfg->cos_bit);
      transpose_8x8(out, in);
    ...
    case ADST_DCT:
      ...
      load_buffer_8x8(input, in, stride, 0, 0, row_cfg->shift[0]);
      fadst8x8_sse4_1(in, out, col_cfg->cos_bit);
      col_txfm_8x8_rounding(out, -row_cfg->shift[1]);
      transpose_8x8(out, in);
      fdct8x8_sse4_1(in, out, row_cfg->cos_bit);
      transpose_8x8(out, in);
    ...
    case DCT_ADST:
      ...
      col_txfm_8x8_rounding(out, -row_cfg->shift[1]);
      transpose_8x8(out, in);
      fadst8x8_sse4_1(in, out, row_cfg->cos_bit);
      transpose_8x8(out, in);
      write_buffer_8x8(in, coeff);
      break;
    case ADST_ADST:
...
void av1_fwd_txfm2d_16x16_sse4_1(const int16_t *input, int32_t *coeff,
  ...
  switch (tx_type) {
    case DCT_DCT:
      ...
      fdct16x16_sse4_1(in, out, col_cfg->cos_bit);
      col_txfm_16x16_rounding(out, -row_cfg->shift[1]);
      transpose_16x16(out, in);
      fdct16x16_sse4_1(in, out, row_cfg->cos_bit);
      transpose_16x16(out, in);
    ...
    case ADST_DCT:
      ...
      load_buffer_16x16(input, in, stride, 0, 0, row_cfg->shift[0]);
      fadst16x16_sse4_1(in, out, col_cfg->cos_bit);
      col_txfm_16x16_rounding(out, -row_cfg->shift[1]);
      transpose_16x16(out, in);
      fdct16x16_sse4_1(in, out, row_cfg->cos_bit);
      transpose_16x16(out, in);
    ...
    case DCT_ADST:
      ...
      col_txfm_16x16_rounding(out, -row_cfg->shift[1]);
      transpose_16x16(out, in);
      fadst16x16_sse4_1(in, out, row_cfg->cos_bit);
      transpose_16x16(out, in);
      write_buffer_16x16(in, coeff);
      break;
    case ADST_ADST:
