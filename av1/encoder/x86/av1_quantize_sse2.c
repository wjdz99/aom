...
static INLINE void quantize(const int16_t *iscan_ptr,
  ...
  const __m128i mask0 = _mm_or_si128(_mm_cmpgt_epi16(qcoeff0, *thr),
                                     _mm_cmpeq_epi16(qcoeff0, *thr));
  const __m128i mask1 = _mm_or_si128(_mm_cmpgt_epi16(qcoeff1, *thr),
                                     _mm_cmpeq_epi16(qcoeff1, *thr));
