...
static INLINE void fdct16x16_new_avx2(const __m256i *input, __m256i *output,
  ...
  btf_16_w16_avx2(cospi_p48_p16, cospi_m16_p48, x1[2], x1[3], x1[2], x1[3]);
  ...
  // stage 5
  btf_16_w16_avx2(cospi_p56_p08, cospi_m08_p56, x1[4], x1[7], x1[4], x1[7]);
  btf_16_w16_avx2(cospi_p24_p40, cospi_m40_p24, x1[5], x1[6], x1[5], x1[6]);
  ...
  // stage 6
  btf_16_w16_avx2(cospi_p60_p04, cospi_m04_p60, x1[8], x1[15], x1[8], x1[15]);
  btf_16_w16_avx2(cospi_p28_p36, cospi_m36_p28, x1[9], x1[14], x1[9], x1[14]);
  btf_16_w16_avx2(cospi_p44_p20, cospi_m20_p44, x1[10], x1[13], x1[10], x1[13]);
  btf_16_w16_avx2(cospi_p12_p52, cospi_m52_p12, x1[11], x1[12], x1[11], x1[12]);
...
static INLINE void fdct16x32_new_avx2(const __m256i *input, __m256i *output,
  ...
  // stage 8
  btf_16_w16_avx2(cospi_p62_p02, cospi_m02_p62, x1[16], x1[31], x1[16], x1[31]);
  btf_16_w16_avx2(cospi_p30_p34, cospi_m34_p30, x1[17], x1[30], x1[17], x1[30]);
  btf_16_w16_avx2(cospi_p46_p18, cospi_m18_p46, x1[18], x1[29], x1[18], x1[29]);
  btf_16_w16_avx2(cospi_p14_p50, cospi_m50_p14, x1[19], x1[28], x1[19], x1[28]);
  btf_16_w16_avx2(cospi_p54_p10, cospi_m10_p54, x1[20], x1[27], x1[20], x1[27]);
  btf_16_w16_avx2(cospi_p22_p42, cospi_m42_p22, x1[21], x1[26], x1[21], x1[26]);
  btf_16_w16_avx2(cospi_p38_p26, cospi_m26_p38, x1[22], x1[25], x1[22], x1[25]);
  btf_16_w16_avx2(cospi_p06_p58, cospi_m58_p06, x1[23], x1[24], x1[23], x1[24]);
...
static INLINE void fdct16x64_new_avx2(const __m256i *input, __m256i *output,
  ...
  // stage 10
  btf_16_w16_avx2(cospi_p63_p01, cospi_m01_p63, x1[32], x1[63], x1[32], x1[63]);
  btf_16_w16_avx2(cospi_p31_p33, cospi_m33_p31, x1[33], x1[62], x1[33], x1[62]);
  btf_16_w16_avx2(cospi_p47_p17, cospi_m17_p47, x1[34], x1[61], x1[34], x1[61]);
  btf_16_w16_avx2(cospi_p15_p49, cospi_m49_p15, x1[35], x1[60], x1[35], x1[60]);
  btf_16_w16_avx2(cospi_p55_p09, cospi_m09_p55, x1[36], x1[59], x1[36], x1[59]);
  btf_16_w16_avx2(cospi_p23_p41, cospi_m41_p23, x1[37], x1[58], x1[37], x1[58]);
  btf_16_w16_avx2(cospi_p39_p25, cospi_m25_p39, x1[38], x1[57], x1[38], x1[57]);
  btf_16_w16_avx2(cospi_p07_p57, cospi_m57_p07, x1[39], x1[56], x1[39], x1[56]);
  btf_16_w16_avx2(cospi_p59_p05, cospi_m05_p59, x1[40], x1[55], x1[40], x1[55]);
  btf_16_w16_avx2(cospi_p27_p37, cospi_m37_p27, x1[41], x1[54], x1[41], x1[54]);
  btf_16_w16_avx2(cospi_p43_p21, cospi_m21_p43, x1[42], x1[53], x1[42], x1[53]);
  btf_16_w16_avx2(cospi_p11_p53, cospi_m53_p11, x1[43], x1[52], x1[43], x1[52]);
  btf_16_w16_avx2(cospi_p51_p13, cospi_m13_p51, x1[44], x1[51], x1[44], x1[51]);
  btf_16_w16_avx2(cospi_p19_p45, cospi_m45_p19, x1[45], x1[50], x1[45], x1[50]);
  btf_16_w16_avx2(cospi_p35_p29, cospi_m29_p35, x1[46], x1[49], x1[46], x1[49]);
  btf_16_w16_avx2(cospi_p03_p61, cospi_m61_p03, x1[47], x1[48], x1[47], x1[48]);
...
static INLINE void av1_fdct32_new_avx2(const __m256i *input, __m256i *output,
  ...
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[20], x1[27], x1[20], x1[27]);
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[21], x1[26], x1[21], x1[26]);
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[22], x1[25], x1[22], x1[25]);
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[23], x1[24], x1[23], x1[24]);
  ...
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[10], x1[13], x1[10], x1[13]);
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[11], x1[12], x1[11], x1[12]);
  ...
  btf_32_sub_add_avx2(x1[31], x1[24]);
  btf_32_sub_add_avx2(x1[30], x1[25]);
  btf_32_sub_add_avx2(x1[29], x1[26]);
  btf_32_sub_add_avx2(x1[28], x1[27]);

  // stage 4
  btf_32_add_sub_avx2(x1[0], x1[3]);
  btf_32_add_sub_avx2(x1[1], x1[2]);
  btf_32_avx2_type0(-cospi[32], cospi[32], x1[5], x1[6], x1[5], x1[6]);
  btf_32_add_sub_avx2(x1[8], x1[11]);
  btf_32_add_sub_avx2(x1[9], x1[10]);
  btf_32_sub_add_avx2(x1[15], x1[12]);
  btf_32_sub_add_avx2(x1[14], x1[13]);
  btf_32_avx2_type0(-cospi[16], cospi[48], x1[18], x1[29], x1[18], x1[29]);
  btf_32_avx2_type0(-cospi[16], cospi[48], x1[19], x1[28], x1[19], x1[28]);
  btf_32_avx2_type0(-cospi[48], -cospi[16], x1[20], x1[27], x1[20], x1[27]);
  btf_32_avx2_type0(-cospi[48], -cospi[16], x1[21], x1[26], x1[21], x1[26]);

  // stage 5
  btf_32_avx2_type0(cospi[32], cospi[32], x1[0], x1[1], x1[0], x1[1]);
  btf_32_avx2_type1(cospi[48], cospi[16], x1[2], x1[3], x1[2], x1[3]);
  btf_32_add_sub_avx2(x1[4], x1[5]);
  btf_32_sub_add_avx2(x1[7], x1[6]);
  btf_32_avx2_type0(-cospi[16], cospi[48], x1[9], x1[14], x1[9], x1[14]);
  btf_32_avx2_type0(-cospi[48], -cospi[16], x1[10], x1[13], x1[10], x1[13]);
  btf_32_add_sub_avx2(x1[16], x1[19]);
  btf_32_add_sub_avx2(x1[17], x1[18]);
  btf_32_sub_add_avx2(x1[23], x1[20]);
  btf_32_sub_add_avx2(x1[22], x1[21]);
  btf_32_add_sub_avx2(x1[24], x1[27]);
  btf_32_add_sub_avx2(x1[25], x1[26]);
  btf_32_sub_add_avx2(x1[31], x1[28]);
  btf_32_sub_add_avx2(x1[30], x1[29]);

  // stage 6
  btf_32_avx2_type1(cospi[56], cospi[8], x1[4], x1[7], x1[4], x1[7]);
  btf_32_avx2_type1(cospi[24], cospi[40], x1[5], x1[6], x1[5], x1[6]);
  btf_32_add_sub_avx2(x1[8], x1[9]);
  btf_32_sub_add_avx2(x1[11], x1[10]);
  btf_32_add_sub_avx2(x1[12], x1[13]);
  btf_32_sub_add_avx2(x1[15], x1[14]);
  btf_32_avx2_type0(-cospi[8], cospi[56], x1[17], x1[30], x1[17], x1[30]);
  btf_32_avx2_type0(-cospi[56], -cospi[8], x1[18], x1[29], x1[18], x1[29]);
  btf_32_avx2_type0(-cospi[40], cospi[24], x1[21], x1[26], x1[21], x1[26]);
  btf_32_avx2_type0(-cospi[24], -cospi[40], x1[22], x1[25], x1[22], x1[25]);

  // stage 7
  btf_32_avx2_type1(cospi[60], cospi[4], x1[8], x1[15], x1[8], x1[15]);
  btf_32_avx2_type1(cospi[28], cospi[36], x1[9], x1[14], x1[9], x1[14]);
  btf_32_avx2_type1(cospi[44], cospi[20], x1[10], x1[13], x1[10], x1[13]);
  btf_32_avx2_type1(cospi[12], cospi[52], x1[11], x1[12], x1[11], x1[12]);
  btf_32_add_sub_avx2(x1[16], x1[17]);
  btf_32_sub_add_avx2(x1[19], x1[18]);
  btf_32_add_sub_avx2(x1[20], x1[21]);
  btf_32_sub_add_avx2(x1[23], x1[22]);
  btf_32_add_sub_avx2(x1[24], x1[25]);
  btf_32_sub_add_avx2(x1[27], x1[26]);
  btf_32_add_sub_avx2(x1[28], x1[29]);
  btf_32_sub_add_avx2(x1[31], x1[30]);

  // stage 8
  btf_32_avx2_type1(cospi[62], cospi[2], x1[16], x1[31], x1[16], x1[31]);
  btf_32_avx2_type1(cospi[30], cospi[34], x1[17], x1[30], x1[17], x1[30]);
  btf_32_avx2_type1(cospi[46], cospi[18], x1[18], x1[29], x1[18], x1[29]);
  btf_32_avx2_type1(cospi[14], cospi[50], x1[19], x1[28], x1[19], x1[28]);
  btf_32_avx2_type1(cospi[54], cospi[10], x1[20], x1[27], x1[20], x1[27]);
  btf_32_avx2_type1(cospi[22], cospi[42], x1[21], x1[26], x1[21], x1[26]);
  btf_32_avx2_type1(cospi[38], cospi[26], x1[22], x1[25], x1[22], x1[25]);
  btf_32_avx2_type1(cospi[6], cospi[58], x1[23], x1[24], x1[23], x1[24]);
...
static INLINE void av1_fdct64_new_avx2(const __m256i *input, __m256i *output,
  ...
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[40], x1[55], x1[40], x1[55]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[41], x1[54], x1[41], x1[54]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[42], x1[53], x1[42], x1[53]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[43], x1[52], x1[43], x1[52]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[44], x1[51], x1[44], x1[51]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[45], x1[50], x1[45], x1[50]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[46], x1[49], x1[46], x1[49]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[47], x1[48], x1[47], x1[48]);
  ...
  btf_32_add_sub_avx2(x1[6], x1[9]);
  btf_32_add_sub_avx2(x1[7], x1[8]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[20], x1[27], x1[20], x1[27]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[21], x1[26], x1[21], x1[26]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[22], x1[25], x1[22], x1[25]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[23], x1[24], x1[23], x1[24]);
  ...
  btf_32_sub_add_avx2(x1[63], x1[48]);
  btf_32_sub_add_avx2(x1[62], x1[49]);
  btf_32_sub_add_avx2(x1[61], x1[50]);
  btf_32_sub_add_avx2(x1[60], x1[51]);
  btf_32_sub_add_avx2(x1[59], x1[52]);
  btf_32_sub_add_avx2(x1[58], x1[53]);
  btf_32_sub_add_avx2(x1[57], x1[54]);
  btf_32_sub_add_avx2(x1[56], x1[55]);
  ...
  btf_32_add_sub_avx2(x1[2], x1[5]);
  btf_32_add_sub_avx2(x1[3], x1[4]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[10], x1[13], x1[10], x1[13]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[11], x1[12], x1[11], x1[12]);
  btf_32_add_sub_avx2(x1[16], x1[23]);
  btf_32_add_sub_avx2(x1[17], x1[22]);
  btf_32_add_sub_avx2(x1[18], x1[21]);
  btf_32_add_sub_avx2(x1[19], x1[20]);
  ...
  btf_32_sub_add_avx2(x1[29], x1[26]);
  btf_32_sub_add_avx2(x1[28], x1[27]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[36], x1[59], x1[36], x1[59]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[37], x1[58], x1[37], x1[58]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[38], x1[57], x1[38], x1[57]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[39], x1[56], x1[39], x1[56]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[40], x1[55], x1[40], x1[55]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[41], x1[54], x1[41], x1[54]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[42], x1[53], x1[42], x1[53]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[43], x1[52], x1[43], x1[52]);

  // stage 5
  btf_32_add_sub_avx2(x1[0], x1[3]);
  btf_32_add_sub_avx2(x1[1], x1[2]);
  btf_32_type0_avx2_new(cospi_m32, cospi_p32, x1[5], x1[6], x1[5], x1[6]);
  btf_32_add_sub_avx2(x1[8], x1[11]);
  btf_32_add_sub_avx2(x1[9], x1[10]);
  btf_32_sub_add_avx2(x1[15], x1[12]);
  btf_32_sub_add_avx2(x1[14], x1[13]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[18], x1[29], x1[18], x1[29]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[19], x1[28], x1[19], x1[28]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[20], x1[27], x1[20], x1[27]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[21], x1[26], x1[21], x1[26]);
  ...
  btf_32_sub_add_avx2(x1[47], x1[40]);
  btf_32_sub_add_avx2(x1[46], x1[41]);
  btf_32_sub_add_avx2(x1[45], x1[42]);
  btf_32_sub_add_avx2(x1[44], x1[43]);
  ...
  btf_32_sub_add_avx2(x1[63], x1[56]);
  btf_32_sub_add_avx2(x1[62], x1[57]);
  btf_32_sub_add_avx2(x1[61], x1[58]);
  btf_32_sub_add_avx2(x1[60], x1[59]);

  // stage 6
  btf_32_type0_avx2_new(cospi_p32, cospi_p32, x1[0], x1[1], x1[0], x1[1]);
  btf_32_type1_avx2_new(cospi_p48, cospi_p16, x1[2], x1[3], x1[2], x1[3]);
  btf_32_add_sub_avx2(x1[4], x1[5]);
  btf_32_sub_add_avx2(x1[7], x1[6]);
  btf_32_type0_avx2_new(cospi_m16, cospi_p48, x1[9], x1[14], x1[9], x1[14]);
  btf_32_type0_avx2_new(cospi_m48, cospi_m16, x1[10], x1[13], x1[10], x1[13]);
  btf_32_add_sub_avx2(x1[16], x1[19]);
  btf_32_add_sub_avx2(x1[17], x1[18]);
  btf_32_sub_add_avx2(x1[23], x1[20]);
  btf_32_sub_add_avx2(x1[22], x1[21]);
  ...
  btf_32_sub_add_avx2(x1[31], x1[28]);
  btf_32_sub_add_avx2(x1[30], x1[29]);
  btf_32_type0_avx2_new(cospi_m08, cospi_p56, x1[34], x1[61], x1[34], x1[61]);
  btf_32_type0_avx2_new(cospi_m08, cospi_p56, x1[35], x1[60], x1[35], x1[60]);
  btf_32_type0_avx2_new(cospi_m56, cospi_m08, x1[36], x1[59], x1[36], x1[59]);
  btf_32_type0_avx2_new(cospi_m56, cospi_m08, x1[37], x1[58], x1[37], x1[58]);
  btf_32_type0_avx2_new(cospi_m40, cospi_p24, x1[42], x1[53], x1[42], x1[53]);
  btf_32_type0_avx2_new(cospi_m40, cospi_p24, x1[43], x1[52], x1[43], x1[52]);
  btf_32_type0_avx2_new(cospi_m24, cospi_m40, x1[44], x1[51], x1[44], x1[51]);
  btf_32_type0_avx2_new(cospi_m24, cospi_m40, x1[45], x1[50], x1[45], x1[50]);

  // stage 7
  btf_32_type1_avx2_new(cospi_p56, cospi_p08, x1[4], x1[7], x1[4], x1[7]);
  btf_32_type1_avx2_new(cospi_p24, cospi_p40, x1[5], x1[6], x1[5], x1[6]);
  btf_32_add_sub_avx2(x1[8], x1[9]);
  btf_32_sub_add_avx2(x1[11], x1[10]);
  btf_32_add_sub_avx2(x1[12], x1[13]);
  btf_32_sub_add_avx2(x1[15], x1[14]);
  btf_32_type0_avx2_new(cospi_m08, cospi_p56, x1[17], x1[30], x1[17], x1[30]);
  btf_32_type0_avx2_new(cospi_m56, cospi_m08, x1[18], x1[29], x1[18], x1[29]);
  btf_32_type0_avx2_new(cospi_m40, cospi_p24, x1[21], x1[26], x1[21], x1[26]);
  btf_32_type0_avx2_new(cospi_m24, cospi_m40, x1[22], x1[25], x1[22], x1[25]);
  btf_32_add_sub_avx2(x1[32], x1[35]);
  btf_32_add_sub_avx2(x1[33], x1[34]);
  btf_32_sub_add_avx2(x1[39], x1[36]);
  btf_32_sub_add_avx2(x1[38], x1[37]);
  btf_32_add_sub_avx2(x1[40], x1[43]);
  btf_32_add_sub_avx2(x1[41], x1[42]);
  btf_32_sub_add_avx2(x1[47], x1[44]);
  btf_32_sub_add_avx2(x1[46], x1[45]);
  btf_32_add_sub_avx2(x1[48], x1[51]);
  btf_32_add_sub_avx2(x1[49], x1[50]);
  btf_32_sub_add_avx2(x1[55], x1[52]);
  btf_32_sub_add_avx2(x1[54], x1[53]);
  btf_32_add_sub_avx2(x1[56], x1[59]);
  btf_32_add_sub_avx2(x1[57], x1[58]);
  btf_32_sub_add_avx2(x1[63], x1[60]);
  btf_32_sub_add_avx2(x1[62], x1[61]);

  // stage 8
  btf_32_type1_avx2_new(cospi_p60, cospi_p04, x1[8], x1[15], x1[8], x1[15]);
  btf_32_type1_avx2_new(cospi_p28, cospi_p36, x1[9], x1[14], x1[9], x1[14]);
  btf_32_type1_avx2_new(cospi_p44, cospi_p20, x1[10], x1[13], x1[10], x1[13]);
  btf_32_type1_avx2_new(cospi_p12, cospi_p52, x1[11], x1[12], x1[11], x1[12]);
  btf_32_add_sub_avx2(x1[16], x1[17]);
  btf_32_sub_add_avx2(x1[19], x1[18]);
  btf_32_add_sub_avx2(x1[20], x1[21]);
  btf_32_sub_add_avx2(x1[23], x1[22]);
  ...
  btf_32_add_sub_avx2(x1[28], x1[29]);
  btf_32_sub_add_avx2(x1[31], x1[30]);
  btf_32_type0_avx2_new(cospi_m04, cospi_p60, x1[33], x1[62], x1[33], x1[62]);
  btf_32_type0_avx2_new(cospi_m60, cospi_m04, x1[34], x1[61], x1[34], x1[61]);
  btf_32_type0_avx2_new(cospi_m36, cospi_p28, x1[37], x1[58], x1[37], x1[58]);
  btf_32_type0_avx2_new(cospi_m28, cospi_m36, x1[38], x1[57], x1[38], x1[57]);
  btf_32_type0_avx2_new(cospi_m20, cospi_p44, x1[41], x1[54], x1[41], x1[54]);
  btf_32_type0_avx2_new(cospi_m44, cospi_m20, x1[42], x1[53], x1[42], x1[53]);
  btf_32_type0_avx2_new(cospi_m52, cospi_p12, x1[45], x1[50], x1[45], x1[50]);
  btf_32_type0_avx2_new(cospi_m12, cospi_m52, x1[46], x1[49], x1[46], x1[49]);

  // stage 9
  btf_32_type1_avx2_new(cospi_p62, cospi_p02, x1[16], x1[31], x1[16], x1[31]);
  btf_32_type1_avx2_new(cospi_p30, cospi_p34, x1[17], x1[30], x1[17], x1[30]);
  btf_32_type1_avx2_new(cospi_p46, cospi_p18, x1[18], x1[29], x1[18], x1[29]);
  btf_32_type1_avx2_new(cospi_p14, cospi_p50, x1[19], x1[28], x1[19], x1[28]);
  btf_32_type1_avx2_new(cospi_p54, cospi_p10, x1[20], x1[27], x1[20], x1[27]);
  btf_32_type1_avx2_new(cospi_p22, cospi_p42, x1[21], x1[26], x1[21], x1[26]);
  btf_32_type1_avx2_new(cospi_p38, cospi_p26, x1[22], x1[25], x1[22], x1[25]);
  btf_32_type1_avx2_new(cospi_p06, cospi_p58, x1[23], x1[24], x1[23], x1[24]);
  btf_32_add_sub_avx2(x1[32], x1[33]);
  btf_32_sub_add_avx2(x1[35], x1[34]);
  btf_32_add_sub_avx2(x1[36], x1[37]);
  btf_32_sub_add_avx2(x1[39], x1[38]);
  btf_32_add_sub_avx2(x1[40], x1[41]);
  btf_32_sub_add_avx2(x1[43], x1[42]);
  btf_32_add_sub_avx2(x1[44], x1[45]);
  btf_32_sub_add_avx2(x1[47], x1[46]);
  btf_32_add_sub_avx2(x1[48], x1[49]);
  btf_32_sub_add_avx2(x1[51], x1[50]);
  btf_32_add_sub_avx2(x1[52], x1[53]);
  btf_32_sub_add_avx2(x1[55], x1[54]);
  btf_32_add_sub_avx2(x1[56], x1[57]);
  btf_32_sub_add_avx2(x1[59], x1[58]);
  btf_32_add_sub_avx2(x1[60], x1[61]);
  btf_32_sub_add_avx2(x1[63], x1[62]);

  // stage 10
  btf_32_type1_avx2_new(cospi_p63, cospi_p01, x1[32], x1[63], x1[32], x1[63]);
  btf_32_type1_avx2_new(cospi_p31, cospi_p33, x1[33], x1[62], x1[33], x1[62]);
  btf_32_type1_avx2_new(cospi_p47, cospi_p17, x1[34], x1[61], x1[34], x1[61]);
  btf_32_type1_avx2_new(cospi_p15, cospi_p49, x1[35], x1[60], x1[35], x1[60]);
  btf_32_type1_avx2_new(cospi_p55, cospi_p09, x1[36], x1[59], x1[36], x1[59]);
  btf_32_type1_avx2_new(cospi_p23, cospi_p41, x1[37], x1[58], x1[37], x1[58]);
  btf_32_type1_avx2_new(cospi_p39, cospi_p25, x1[38], x1[57], x1[38], x1[57]);
  btf_32_type1_avx2_new(cospi_p07, cospi_p57, x1[39], x1[56], x1[39], x1[56]);
  btf_32_type1_avx2_new(cospi_p59, cospi_p05, x1[40], x1[55], x1[40], x1[55]);
  btf_32_type1_avx2_new(cospi_p27, cospi_p37, x1[41], x1[54], x1[41], x1[54]);
  btf_32_type1_avx2_new(cospi_p43, cospi_p21, x1[42], x1[53], x1[42], x1[53]);
  btf_32_type1_avx2_new(cospi_p11, cospi_p53, x1[43], x1[52], x1[43], x1[52]);
  btf_32_type1_avx2_new(cospi_p51, cospi_p13, x1[44], x1[51], x1[44], x1[51]);
  btf_32_type1_avx2_new(cospi_p19, cospi_p45, x1[45], x1[50], x1[45], x1[50]);
  btf_32_type1_avx2_new(cospi_p35, cospi_p29, x1[46], x1[49], x1[46], x1[49]);
  btf_32_type1_avx2_new(cospi_p03, cospi_p61, x1[47], x1[48], x1[47], x1[48]);
