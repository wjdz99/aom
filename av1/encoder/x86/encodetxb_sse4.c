...
void av1_txb_init_levels_sse4_1(const tran_low_t *const coeff, const int width,
  ...
  if (width == 4) {
    do {
      const __m128i coeffA = _mm_loadu_si128((__m128i *)(cf));
      const __m128i coeffB = _mm_loadu_si128((__m128i *)(cf + width));
    ...
    do {
      const __m128i coeffA = _mm_loadu_si128((__m128i *)(cf));
      const __m128i coeffB = _mm_loadu_si128((__m128i *)(cf + 4));
      const __m128i coeffAB = _mm_packs_epi32(coeffA, coeffB);
      const __m128i absAB = _mm_abs_epi16(coeffAB);
      const __m128i absAB8 = _mm_packs_epi16(absAB, zeros);
    ...
    do {
      ...
      do {
        const __m128i coeffA = _mm_loadu_si128((__m128i *)(cf));
        const __m128i coeffB = _mm_loadu_si128((__m128i *)(cf + 4));
        const __m128i coeffC = _mm_loadu_si128((__m128i *)(cf + 8));
        const __m128i coeffD = _mm_loadu_si128((__m128i *)(cf + 12));
        const __m128i coeffAB = _mm_packs_epi32(coeffA, coeffB);
