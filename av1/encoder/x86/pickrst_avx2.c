...
int64_t lowbd_pixel_proj_error_avx2(const uint8_t *src8, int width, int height,
  ...
  err += _mm256_extract_epi64(sum64, 0) + _mm256_extract_epi64(sum64, 1) +
         _mm256_extract_epi64(sum64, 2) + _mm256_extract_epi64(sum64, 3);
  return err;
}
