...
// Write the current GOP information into the second pass file.
void av1_write_second_pass_gop_info(struct AV1_COMP *cpi);

// Read the next GOP information from the second pass file.
...
// Get the adjusted MVs of this_mi, associated with reference frame frame. If no
...
// Get the adjusted mi position in the third pass frame, of a given tp_mi.
// Location is returned in mi_row and mi_col.
