...
enum {
  ...
  FAST_BIGDIA = 9,
  // NSTEP_8PT with up to 15 stages.
  FAST_NSTEP_8PT = 10,
...
// Sets up configs for fullpixel clamped diamond search method.
...
// Sets up configs for NSTEP motion search method.
void av1_init_motion_compensation_nstep(search_site_config *cfg, int stride);
// Sets up configs for NSTEP_8PT motion search method
void av1_init_motion_compensation_nstep8pt(search_site_config *cfg, int stride);
