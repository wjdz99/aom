...
static AOM_INLINE void av1_alloc_obmc_buffers(OBMCBuffer *obmc_buffer,
                                              AV1_COMMON *cm) {
  CHECK_MEM_ERROR(
      cm, obmc_buffer->wsrc,
...
static AOM_INLINE void av1_alloc_compound_type_rd_buffers(
...
static AOM_INLINE void av1_release_compound_type_rd_buffers(
