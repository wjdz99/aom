...
static void cfl_compute_alpha_ind(MACROBLOCK *const x, FRAME_CONTEXT *ec_ctx,
  ...
  const int dc_pred_u = cfl->dc_pred_q6[CFL_PRED_U];
  const int dc_pred_v = cfl->dc_pred_q6[CFL_PRED_V];
