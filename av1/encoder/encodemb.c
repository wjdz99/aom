...
#if CONFIG_MODE_DEP_TX || CONFIG_REDUCED_SEPTX_SET
...
#if CONFIG_MODE_DEP_TX
  if (plane == 0 && txfm_param.tx_set_type == EXT_TX_SET_DTT4_IDTX_1DDCT_MDTX3)
#else
  if (plane == 0 && txfm_param.tx_set_type == EXT_TX_SET_DTT4_IDTX_1DDCT)
#endif
