...
#error "CONFIG_PVQ currently requires CONFIG_DAALA_EC."
  ...
  for (i = 0; i < tx_blk_size * tx_blk_size; i++) {
    ...
    in_int32[i] = AOM_SIGNED_SHL(coeff_pvq[i], OD_COEFF_SHIFT - coeff_shift) >> quantizer_downshift;
  }
  ...
  ac_dc_coded = od_pvq_encode(
      ...
      quant[0] << (OD_COEFF_SHIFT - 3) >> quantizer_downshift,  // scale/quantizer
      quant[1] << (OD_COEFF_SHIFT - 3) >> quantizer_downshift,  // scale/quantizer
