...
int av1_dering_search(YV12_BUFFER_CONFIG *frame, const YV12_BUFFER_CONFIG *ref,
  ...
  double (*mse)[DERING_STRENGTHS][CLPF_STRENGTHS] = aom_malloc(sizeof(*mse) * nvsb * nhsb);
  ...
  int i;
  int lev[DERING_REFINEMENT_LEVELS] = {0, 12, 14, 16};
  int best_lev[DERING_REFINEMENT_LEVELS] = {0, 12, 14, 16};
  int str[CLPF_REFINEMENT_LEVELS] = {0, 2};
  int best_str[CLPF_REFINEMENT_LEVELS] = {0, 2};
  best_tot_mse = 1e100;
  {
    int l0;
