...
static double get_dynamic_range(AV1_COMP *const cpi, double *mscn_map,
                                const int sb_step) {
...
void av1_set_mb_wiener_variance(AV1_COMP *cpi) {
  ...
  const int sb_step = mi_size_wide[cm->seq_params->sb_size];
  ...
  cpi->dynamic_range_upper_bound = get_dynamic_range(cpi, mscn_map, sb_step);
