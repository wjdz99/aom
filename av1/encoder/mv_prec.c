...
void av1_pick_and_set_high_precision_mv(const AV1_COMP *cpi,
                                                      int q) {
	MvSubpelPrecision precision =
			cpi->common.cur_frame_force_integer_mv ?
					MV_SUBPEL_NONE : determine_frame_mv_precision(cpi, q, 0);
	assert(
			IMPLIES(!cpi->common.cur_frame_force_integer_mv,
