...
void av1_frame_init_quantizer(struct VP10_COMP *cpi);

void av1_init_plane_quantizers(struct VP10_COMP *cpi, MACROBLOCK *x);

void av1_init_quantizer(struct VP10_COMP *cpi);

void av1_set_quantizer(struct VP10Common *cm, int q);
