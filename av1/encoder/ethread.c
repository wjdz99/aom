...
static void tpl_accumulate_txfm_stats(AV1_COMP *cpi, int num_workers) {
  TplTxfmStats *tpl_txfm_stats = &cpi->td.tpl_txfm_stats;
  double *total_abs_coeff_sum = tpl_txfm_stats->abs_coeff_sum;
  int *txfm_block_count = &tpl_txfm_stats->txfm_block_count;
