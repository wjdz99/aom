...
void av1_row_mt_sync_read_dummy(AV1EncRowMultiThreadSync *const row_mt_sync,
                                int r, int c) {
  (void)row_mt_sync;
  (void)r;
  (void)c;
...
void av1_row_mt_sync_write_dummy(AV1EncRowMultiThreadSync *const row_mt_sync,
...
void av1_row_mt_sync_read(AV1EncRowMultiThreadSync *const row_mt_sync, int r,
                          int c) {
...
void av1_row_mt_sync_write(AV1EncRowMultiThreadSync *const row_mt_sync, int r,
...
void av1_row_mt_sync_mem_alloc(AV1EncRowMultiThreadSync *const row_mt_sync,
...
void av1_row_mt_sync_mem_dealloc(AV1EncRowMultiThreadSync *const row_mt_sync) {
  if (row_mt_sync != NULL) {
#if CONFIG_MULTITHREAD
    int i;
