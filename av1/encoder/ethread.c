...
void av1_tpl_row_mt_sync_read(AV1TplRowMultiThreadSync *const tpl_row_mt_sync,
                              int r, int c) {
#if CONFIG_MULTITHREAD
  const int nsync = tpl_row_mt_sync->sync_range;
...
void av1_tpl_row_mt_sync_write(AV1TplRowMultiThreadSync *const tpl_row_mt_sync,
...
static int tpl_worker_hook(void *arg1, void *unused) {
  ...
  const int num_active_workers = mt_info->num_workers;
