...
// energy which is among a bunch of zeros. NOTE: This algorithm is not as
...
//   qindex: Quantization factor used for target block. In general, all blocks
//           in a same plane share the same quantization factor. This field is
