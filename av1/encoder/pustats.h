...
static const float av1_pustats_rate_hiddenlayer_0_kernel[20 * 10] = {
  13.8498f,  19.6630f,  13.3036f,  5.2448f,   -18.0270f, 21.6671f,   -0.2135f,
  -0.0060f,  0.1211f,   -0.3549f,  -0.3550f,  0.0190f,   0.0167f,    -0.1192f,
  0.2003f,   8.6663f,   32.0264f,  9.9558f,   9.0935f,   -110.4994f, 51.8056f,
  64.8041f,  58.5392f,  53.0189f,  -61.6300f, 4.7540f,   -0.0140f,   0.0185f,
  -15.8050f, 0.0790f,   0.0707f,   0.0784f,   0.0766f,   -0.3030f,   0.0392f,
  49.3312f,  63.3326f,  61.4025f,  54.2723f,  -62.2769f, -147.1736f, -84.9432f,
  -82.5422f, -70.4857f, 46.7622f,  -1.0285f,  -0.4809f,  0.0068f,    1.0888f,
  -0.0515f,  -0.0384f,  -0.0232f,  -0.0396f,  0.2429f,   0.2040f,    -144.4016f,
  -88.0868f, -80.3134f, -70.6685f, 66.8528f,  -53.8097f, -45.4011f,  -52.8680f,
  -58.7226f, 99.7830f,  2.3728f,   0.0229f,   0.0002f,   -0.3288f,   -0.0563f,
  -0.0550f,  -0.0552f,  -0.0563f,  0.2214f,   0.0139f,   -60.8965f,  -45.5251f,
  -50.4188f, -51.5623f, 85.7369f,  77.3415f,  47.4930f,  53.8120f,   58.2311f,
  -45.9650f, -2.4938f,  0.1639f,   -0.5270f,  -75.4622f, -0.0026f,   0.0031f,
  0.0047f,   0.0015f,   0.0092f,   0.0654f,   75.6402f,  54.7447f,   54.8156f,
  52.6834f,  -9.1246f,  -34.0108f, -35.6423f, -34.2911f, -38.5444f,  72.1123f,
  10.9750f,  -0.1595f,  0.1983f,   22.5724f,  -0.0556f,  -0.0618f,   -0.0571f,
  -0.0608f,  0.2439f,   -0.0805f,  -32.5107f, -28.9688f, -33.7284f,  -48.1365f,
  61.5297f,  39.2492f,  -35.1928f, -11.5000f, 7.7038f,   -94.2469f,  13.5586f,
  0.7541f,   0.0105f,   4.4041f,   0.1799f,   0.1339f,   0.1567f,    -0.6668f,
  -0.7384f,  0.2185f,   17.1700f,  -26.4601f, -1.8970f,  38.9635f,   -30.1916f,
  31.8139f,  14.6157f,  10.0565f,  3.3340f,   -40.6985f, -2.1186f,   0.0116f,
  0.0962f,   0.7115f,   -1.4071f,  -1.3701f,  -1.4728f,  -1.3404f,   -1.7286f,
  5.5632f,   28.4998f,  5.4087f,   16.2668f,  11.8693f,  -39.4153f,  106.3281f,
  38.3075f,  39.4933f,  47.3805f,  -15.0514f, -21.2421f, -0.2358f,   -0.0024f,
  0.3505f,   -0.0429f,  -0.0377f,  -0.0322f,  -0.0344f,  0.2020f,    0.1417f,
  99.6711f,  35.3896f,  43.1117f,  59.8879f,  -17.8250f, -16.6976f,  18.5100f,
  6.3383f,   25.3020f,  -55.8824f, 25.1027f,  -0.9926f,  -0.0738f,   -1.4892f,
  0.0269f,   -0.0051f,  -5.8168f,  -0.0579f,  -0.1500f,  0.7224f,    8.3066f,
  -3.8805f,  -12.1482f, 14.3492f,  -20.8118f,
};

static const float av1_pustats_rate_hiddenlayer_0_bias[10] = {
  17.6566f,  62.2217f, -107.2644f, -56.2255f, 68.2252f,
  -37.5662f, 9.587f,   18.5206f,   69.6873f,  4.3903f,
};

static const float av1_pustats_rate_hiddenlayer_1_kernel[10 * 10] = {
...
static const float av1_pustats_dist_hiddenlayer_0_kernel[20 * 10] = {
...
static const float av1_pustats_dist_hiddenlayer_0_bias[10] = {
  -175.6918f, 43.4519f,  154.196f, -81.1015f,  -0.0758f,
  136.5695f,  110.8713f, 142.029f, -153.0901f, -145.2688f
};

static const float av1_pustats_dist_hiddenlayer_1_kernel[10 * 10] = {
