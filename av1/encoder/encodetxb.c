...
#endif
      if (allow_update_cdf) {
        update_cdf(ec_ctx->eob_flag_cdf16[txb_ctx->eob_ctx][plane][eob_multi_ctx],
                   eob_pt - 1, 5);
      }
      break;
    case 1:
...
#endif
      if (allow_update_cdf) {
        update_cdf(ec_ctx->eob_flag_cdf32[txb_ctx->eob_ctx][plane][eob_multi_ctx],
                   eob_pt - 1, 6);
      }
      break;
    case 2:
...
#endif
      if (allow_update_cdf)
        update_cdf(ec_ctx->eob_flag_cdf64[txb_ctx->eob_ctx][plane][eob_multi_ctx], eob_pt - 1, 7);
      break;
    case 3:
#if CONFIG_ENTROPY_STATS
...
#endif
      if (allow_update_cdf) {
        update_cdf(ec_ctx->eob_flag_cdf128[txb_ctx->eob_ctx][plane][eob_multi_ctx], eob_pt - 1,
                   8);
      }
      break;
    case 4:
...
#endif
      if (allow_update_cdf) {
        update_cdf(ec_ctx->eob_flag_cdf256[txb_ctx->eob_ctx][plane][eob_multi_ctx], eob_pt - 1,
                   9);
      }
      break;
    case 5:
...
#endif
      if (allow_update_cdf) {
        update_cdf(ec_ctx->eob_flag_cdf512[txb_ctx->eob_ctx][plane][eob_multi_ctx], eob_pt - 1,
                   10);
      }
      break;
    case 6:
...
#endif
      if (allow_update_cdf) {
        update_cdf(ec_ctx->eob_flag_cdf1024[txb_ctx->eob_ctx][plane][eob_multi_ctx], eob_pt - 1,
                   11);
      }
      break;
  }
...
void av1_write_coeffs_txb(const AV1_COMMON *const cm, MACROBLOCKD *xd,
  ...
  switch (eob_multi_size) {
    ...
    case 1:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf32[txb_ctx->eob_ctx][plane_type][eob_multi_ctx], 6);
      break;
    case 2:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf64[txb_ctx->eob_ctx][plane_type][eob_multi_ctx], 7);
      break;
    case 3:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf128[txb_ctx->eob_ctx][plane_type][eob_multi_ctx], 8);
      break;
    case 4:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf256[txb_ctx->eob_ctx][plane_type][eob_multi_ctx], 9);
      break;
    case 5:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf512[txb_ctx->eob_ctx][plane_type][eob_multi_ctx], 10);
      break;
    default:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf1024[txb_ctx->eob_ctx][plane_type][eob_multi_ctx], 11);
      break;
  }
#else
  switch (eob_multi_size) {
    case 0:
      aom_write_symbol(w, eob_pt - 1,
                       ec_ctx->eob_flag_cdf16[plane_type][eob_multi_ctx],
                       5);
      break;
    case 1:
      aom_write_symbol(w, eob_pt - 1,
