...
static inline void hybrid_intra_mode_search(AV1_COMP *cpi,
                                                MACROBLOCK *const x,
                                                RD_STATS *rd_cost,
                                                BLOCK_SIZE bsize,
...
static inline void wait_for_top_right_sb(
...
static inline bool is_neighbor_blk_larger_than_cur_blk(
...
static inline void set_sms_tree_partitioning(
