...
static INLINE bool have_deltaq_params_changed(const DeltaQuantParams *prev_deltaq_params,
...
void av1_init_quantizer(EncQuantDequantParams *const enc_quant_dequant_params,
  ...
  // change.
  if (!have_deltaq_params_changed(prev_deltaq_params, quant_params)) return;
  ...
  // Book keep the state of deltaq parameters.
