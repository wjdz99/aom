...
int av1_quantize_fp_simple(const int16_t quant_ptr[2],
...
static void quantize_fp_helper_c(
  ...
  if (qm_ptr == NULL && iqm_ptr == NULL) {
    *eob_ptr = av1_quantize_fp_simple(quant_ptr, dequant_ptr, round_ptr,
                                      log_scale, scan, (int)n_coeffs, coeff_ptr,
