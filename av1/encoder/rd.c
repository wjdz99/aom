      ...
      for (int plane = 0; plane < nplanes; ++plane) {
        ...
        for (int tx_class_ctx = 0; tx_class_ctx < 2; ++tx_class_ctx) {
          ...
          switch (eob_multi_size) {
            case 0: pcdf = fc->eob_flag_cdf16[eob_ctx][plane][tx_class_ctx]; break;
            case 1: pcdf = fc->eob_flag_cdf32[eob_ctx][plane][tx_class_ctx]; break;
            case 2: pcdf = fc->eob_flag_cdf64[eob_ctx][plane][tx_class_ctx]; break;
            case 3: pcdf = fc->eob_flag_cdf128[eob_ctx][plane][tx_class_ctx]; break;
            case 4: pcdf = fc->eob_flag_cdf256[eob_ctx][plane][tx_class_ctx]; break;
            case 5: pcdf = fc->eob_flag_cdf512[eob_ctx][plane][tx_class_ctx]; break;
            case 6:
            default: pcdf = fc->eob_flag_cdf1024[eob_ctx][plane][tx_class_ctx]; break;
          }
