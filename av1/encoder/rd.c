...
static void set_block_thresholds(const AV1_COMMON *cm, RD_OPT *rd,
  ...
  const int intra_modes = sizeof(intra_mode_list) / sizeof(PREDICTION_MODE);
  const int inter_modes = sizeof(inter_mode_list) / sizeof(PREDICTION_MODE);
