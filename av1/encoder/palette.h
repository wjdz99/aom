...
void av1_rd_pick_palette_intra_sby(
    const struct AV1_COMP *const cpi, struct macroblock *x, BLOCK_SIZE bsize,
 ...
 * This function is used in both inter and intra frame coding.
 */
void av1_rd_pick_palette_intra_sbuv(const struct AV1_COMP *const cpi,
...
void av1_restore_uv_color_map(const struct AV1_COMP *const cpi,
                              struct macroblock *x);
