...
static void init_tf_ctx(AV1_COMP *cpi, int filter_frame_lookahead_idx,
                        int gf_frame_index, int check_show_existing, YV12_BUFFER_CONFIG *output_frame) {
  TemporalFilterCtx *tf_ctx = &cpi->tf_ctx;
...
void av1_temporal_filter(AV1_COMP *cpi, const int filter_frame_lookahead_idx,
  ...
  init_tf_ctx(cpi, filter_frame_lookahead_idx, gf_frame_index, check_show_existing, output_frame);
