...
//   is_high_bitdepth: Whether the frames are high-bitdepth or not.
// Returns:
...
static AOM_INLINE void tf_setup_macroblockd(ThreadData *td,
                                            const struct scale_factors *scale) {
  MACROBLOCKD *mbd = &td->mb.e_mbd;
  mbd->block_ref_scale_factors[0] = scale;
  mbd->block_ref_scale_factors[1] = scale;
  mbd->mi = &td->tf_data.tmp_mbmi;
