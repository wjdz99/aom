...
int av1_get_unit_rows_in_tile(const TileInfo *tile,
  ...
  const int mi_rows_aligned_to_unit = ALIGN_POWER_OF_TWO(
      tile->mi_row_end - tile->mi_row_start, unit_height_log2);
...
int av1_get_unit_cols_in_tile(const TileInfo *tile,
  ...
  const int mi_cols_aligned_to_unit = ALIGN_POWER_OF_TWO(
      tile->mi_col_end - tile->mi_col_start, unit_width_log2);
