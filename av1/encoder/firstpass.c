...
#define LVL_3_BOOST_FACTOR 0.8
#define LVL_2_BOOST_FACTOR 0.7
  ...
  for (i = 0; i < rc->baseline_gf_interval - rc->source_alt_ref_pending; ++i) {
    ...
    if (gf_group->update_type[frame_index] == BRF_UPDATE) {
      ...
      float_t lvl_budget[3] = {
        budget * LVL_3_BOOST_FACTOR,
        budget * (1 - LVL_3_BOOST_FACTOR) * LVL_2_BOOST_FACTOR,
        budget * (1 - LVL_3_BOOST_FACTOR) * (1 - LVL_2_BOOST_FACTOR)
      };
