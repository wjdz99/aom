...
#define MIN_ARF_GF_BOOST 300
#define MIN_KF_TOT_BOOST 1000
#define MAX_KF_TOT_BOOST 7000
#define KF_MAX_FRAME_BOOST 96.0
#define KF_MIN_FRAME_BOOST 72.0
...
static void find_next_key_frame(AV1_COMP *cpi, FIRSTPASS_STATS *this_frame) {
  ...
  const double kf_max_frame_boost = AOMMIN(
      AOMMAX(rc->frames_to_key * 0.9, KF_MIN_FRAME_BOOST), KF_MAX_FRAME_BOOST);
