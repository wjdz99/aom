...
void av1_accumulate_stats(FIRSTPASS_STATS *section,
  ...
  section->log_intra_error += frame->intra_error ? log(frame->intra_error) : 0;
  section->log_coded_error += frame->coded_error ? log(frame->coded_error) : 0;
...
static void normalize_firstpass_stats(FIRSTPASS_STATS *fps,
  ...
  fps->log_coded_error = fps->coded_error ? log(fps->coded_error) : 0;
  fps->log_intra_error = fps->intra_error ? log(fps->intra_error) : 0;
  fps->MVr /= f_h;
  fps->mvr_abs /= f_h;
  fps->MVc /= f_w;
  fps->mvc_abs /= f_w;
