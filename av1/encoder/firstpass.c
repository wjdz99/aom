...
#define SECTION_NOISE_DEF 300.0
...
#define MIN_ARF_GF_BOOST 200
#define MIN_KF_TOT_BOOST 250
#define MAX_KF_TOT_BOOST 5000
#define KF_MAX_FRAME_BOOST 60.0
#define GF_MAX_FRAME_BOOST 60.0
