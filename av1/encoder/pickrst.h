...
//  (see separate function calls below)
...
// Exposed for testing purposes - subsets = true.
...
//    I I I] // dst
static INLINE double min_cost_type_path(int node_idx, int dest_idx,
                                        int max_out_nodes, const double *graph,
                                        Vector *best_path,
                                        graph_edge_cost_t cost_fn, void *info) {
  return min_cost_graphsearch(node_idx, dest_idx, max_out_nodes, graph,
                              best_path, true, cost_fn, info);
}

// Exposed for testing purposes - subsets = false.
...
static INLINE double min_cost_path(int node_idx, int dest_idx,
                                   int max_out_nodes, const double *graph,
                                   Vector *best_path, graph_edge_cost_t cost_fn,
                                   void *info) {
  return min_cost_graphsearch(node_idx, dest_idx, max_out_nodes, graph,
