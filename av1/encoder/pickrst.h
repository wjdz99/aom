 ...
 *
 * \param[in]    sd           The pointer to source frame buffer
 ...
 * inside "cpi->common:"
 * \arg \c rst_info[0]: Chosen parameters for Y plane
 * \arg \c rst_info[1]: Chosen parameters for U plane if it exists
 * \arg \c rst_info[2]: Chosen parameters for V plane if it exists
 * \par
 ...
 *      \c rst_info[ \c p].\c unit_info[ \c u].\c sgrproj_info,
 *      depending on \c restoration_type.
 *
 */
