...
static INLINE void predict_dc_only_block(
    const AV1_COMP *cpi, MACROBLOCK *x, int plane, BLOCK_SIZE plane_bsize,
    TX_SIZE tx_size, int block, int blk_row, int blk_col,
    RD_STATS *best_rd_stats, int64_t *block_sse, unsigned int *block_mse_q8,
...
static void search_tx_type(const AV1_COMP *cpi, MACROBLOCK *x, int plane,
  ...
  if (predict_dc_block) {
    predict_dc_only_block(cpi, x, plane, plane_bsize, tx_size, block, blk_row,
