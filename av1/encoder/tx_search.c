...
#if 0
    if (!is_col_tx) {
      fprintf(stderr, "    k=%d, |%d, %d, %d, %d|, nes[k]=%d, wops[k]=%d,"
              "sc_fac=%d, xsx0=%d, xsx=%d\n",
              k, operator[0], operator[1], operator[2], operator[3], nes[k],
              wops[k], sc_fac, xsx0, *xsx);
    }
#endif
  }
...
static uint16_t prune_operators(MACROBLOCK *x, BLOCK_SIZE bsize,
  ...
  switch (bw) {
    case 4:
      get_xsx(diff, stride, bh, nbd4, Bd4s, wd4s, &xlx_h[DCT_1D], nedges_bd4,
              soc[0], 0);
      break;
    case 8:
      get_xsx(diff, stride, bh, nbd8, Bd8s, wd8s, &xlx_h[DCT_1D], nedges_bd8,
              soc[1], 0);
      break;
    case 16:
      get_xsx(diff, stride, bh, nbd16, Bd16s, wd16s, &xlx_h[DCT_1D],
              nedges_bd16, soc[2], 0);
      break;
    case 32:
      get_xsx(diff, stride, bh, nbd32, Bd32s, wd32s, &xlx_h[DCT_1D],
              nedges_bd32, soc[3], 0);
      break;
  ...
  switch (bh) {
    case 4:
      get_xsx(diff, stride, bw, nbd4, Bd4s, wd4s, &xlx_v[DCT_1D], nedges_bd4,
              soc[0], 1);
      break;
    case 8:
      get_xsx(diff, stride, bw, nbd8, Bd8s, wd8s, &xlx_v[DCT_1D], nedges_bd8,
              soc[1], 1);
      break;
    case 16:
      get_xsx(diff, stride, bw, nbd16, Bd16s, wd16s, &xlx_v[DCT_1D],
              nedges_bd16, soc[2], 1);
      break;
    case 32:
      get_xsx(diff, stride, bw, nbd32, Bd32s, wd32s, &xlx_v[DCT_1D],
              nedges_bd32, soc[3], 1);
      break;
    default: assert(0); break;
  }
