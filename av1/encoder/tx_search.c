...
static AOM_INLINE void choose_largest_tx_size(const AV1_COMP *const cpi,
  ...
  const int skip_trellis = 0;
  av1_txfm_rd_in_plane(x, cpi, rd_stats, ref_best_rd, AOMMIN(no_skip_rd, skip_rd),
...
int64_t av1_uniform_txfm_yrd(const AV1_COMP *const cpi, MACROBLOCK *x,
  ...
  av1_txfm_rd_in_plane(
      x, cpi, rd_stats, ref_best_rd, AOMMIN(no_this_rd, skip_rd), AOM_PLANE_Y,
      bs, tx_size, cpi->sf.rd_sf.use_fast_coef_costing, ftxs_mode,
      skip_trellis);
