...
static void foreach_rtile_in_tile(const struct rest_search_ctxt *ctxt,
  ...
  if (!av1_superres_unscaled(cm)) {
    ...
    tile_col_start = (int)(tile_col_start * x_upscale);
    tile_col_end = (int)(tile_col_end * x_upscale);
    tile_row_start = (int)(tile_row_start * y_upscale);
    tile_row_end = (int)(tile_row_end * y_upscale);
