...
static void foreach_rtile_in_tile(const struct rest_search_ctxt *ctxt,
  ...
  int rtile_size = rsi->restoration_tilesize;
  int rtile_col0 = (tile_col_start + rtile_size - 1) / rtile_size;
  int rtile_col1 = (tile_col_end + rtile_size - 1) / rtile_size;
  int rtile_row0 = (tile_row_start + rtile_size - 1) / rtile_size;
  int rtile_row1 = (tile_row_end + rtile_size - 1) / rtile_size;
  rtile_col1 = AOMMIN(rtile_col1, ctxt->nrtiles_x);
  rtile_row1 = AOMMIN(rtile_row1, ctxt->nrtiles_y);
