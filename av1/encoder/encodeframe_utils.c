...
void av1_set_ssim_rdmult(const AV1_COMP *const cpi, int *errorperbit,
  ...
  // geom_mean_of_scale can go up to 4.8322^256, which is within DBL_MAX(maximum
  // value a double datatype can hold). If bsize_base is modified to BLOCK_4X4
  // (minimum possible block size), geom_mean_of_scale can go up to 4.8322^1024
  // and exceed DBL_MAX, resulting in data overflow.
