...
void av1_fht4x4_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  if (tx_type == DCT_DCT) {
    ...
    int use_lgt_col = get_fwd_lgt4(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 4);
    int use_lgt_row = get_fwd_lgt4(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 4);
#endif
...
void av1_fht4x8_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  int use_lgt_col = get_fwd_lgt8(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 4);
  int use_lgt_row = get_fwd_lgt4(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 8);
#endif
...
void av1_fht8x4_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  const tran_high_t *lgtmtx_row[4];
  int use_lgt_col = get_fwd_lgt4(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 8);
  int use_lgt_row = get_fwd_lgt8(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 4);
#endif
...
void av1_fht4x16_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  int use_lgt_row = get_fwd_lgt4(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 16);
#endif
...
void av1_fht16x4_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  int use_lgt_col = get_fwd_lgt4(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 16);
#endif
...
#if CONFIG_LGT
  const tran_high_t *lgtmtx_row[16];
  int use_lgt_row = get_fwd_lgt8(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 16);
#endif
...
#if CONFIG_LGT
  const tran_high_t *lgtmtx_col[16];
  int use_lgt_col = get_fwd_lgt8(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 16);
#endif
...
void av1_fht8x32_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  int use_lgt_row = get_fwd_lgt8(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 32);
#endif
...
void av1_fht32x8_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  int use_lgt_col = get_fwd_lgt8(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 32);
#endif
...
void av1_fht8x8_c(const int16_t *input, tran_low_t *output, int stride,
  ...
  if (tx_type == DCT_DCT) {
    ...
    const tran_high_t *lgtmtx_col[8];
    const tran_high_t *lgtmtx_row[8];
    int use_lgt_col = get_fwd_lgt8(ht.cols, fwd_txfm_param, 1, lgtmtx_col, 8);
    int use_lgt_row = get_fwd_lgt8(ht.rows, fwd_txfm_param, 0, lgtmtx_row, 8);
#endif
