...
#if CONFIG_EXT_TX
void av1_fht32x32_c(const int16_t *input, tran_low_t *output,
...
void av1_fwd_idtx_c(const int16_t *src_diff,
...
void av1_highbd_fht32x32_c(const int16_t *input, tran_low_t *output,
                            int stride, int tx_type) {
