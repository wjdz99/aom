...
void av1_rd_pick_palette_intra_sby(
  ...
  unsigned int norm_color_dist =
      (unsigned int)(x->min_dist_inter_color >> (b_width_log2_lookup[bsize] +
                                                 b_height_log2_lookup[bsize]));
  if (cpi->sf.rt_sf.use_nonrd_pick_mode && cpi->rc.high_source_sad &&
      x->source_variance > 50 && norm_color_dist < 10000)
    color_thresh_palette = 96;
