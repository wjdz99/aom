...
double av1_estimate_gop_bitrate(unsigned char *q_val, int size, TplTxfmStats **stats) {
  ...
  for (int frame_index = 0; frame_index < size; frame_index++) {
    ...
    double frame_bitrate  = av1_laplace_estimate_frame_rate(q_index,
                                                    frame_stats->txfm_block_count,
                                                    frame_stats->abs_coeff_sum,
                                                    16);
