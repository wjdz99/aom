...
//init_ref_map_pair(cpi, ref_frame_map_pairs);
  printf("REF3\n");
    ...
    const int true_disp =
        (int)(tpl_frame->frame_display_index) - (gf_group->subgop_cfg != NULL && init_frame_params->show_frame);
  av1_get_ref_frames(cpi, &cpi->ref_buffer_stack, true_disp, ref_frame_map_pairs);
}
