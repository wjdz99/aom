...
int av1_tpl_setup_stats(AV1_COMP *cpi, int gop_eval,
  ...
  const int frame_idx_1 = AOMMIN(tpl_gf_group_frames - 1, gf_group->arf_index + 1);
...
double av1_tpl_get_frame_importance(const TplParams *tpl_data, int gf_frame_index) {
...
double av1_tpl_get_qstep_ratio(const TplParams *tpl_data, int gf_frame_index) {
  ...
  const double frame_importance = av1_tpl_get_frame_importance(tpl_data, gf_frame_index);
