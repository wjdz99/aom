...
double av1_estimate_gop_bitrate(const int *q_index_list, const int frame_count,
                                const TplTxfmStats *stats_list, double *bitrate_byframe_list) {
...
int av1_q_mode_estimate_base_q(const GF_GROUP *gf_group,
  ...
  double q_max_estimate =
      av1_estimate_gop_bitrate(q_index_list, gf_group->size, txfm_stats_list, NULL);
  ...
  // Update vbr_rc_info.
  av1_estimate_gop_bitrate(q_index_list, gf_group->size, txfm_stats_list, vbr_rc_info->estimated_bitrate_byframe);
