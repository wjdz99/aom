...
static INLINE int_mv compute_mv_difference(const TplDepFrame *tpl_frame,
                                           int row, int col, int step,
                                           int tpl_stride, int right_shift) {
...
double av1_tpl_compute_frame_mv_entropy(const TplDepFrame *tpl_frame,
  ...
  for (int row = 0; row < tpl_frame->mi_rows; row += step) {
    for (int col = 0; col < tpl_frame->mi_cols; col += step) {
      int_mv mv = compute_mv_difference(tpl_frame, row, col, step, tpl_stride,
                                        right_shift);
