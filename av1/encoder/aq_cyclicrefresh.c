...
int av1_cyclic_refresh_estimate_bits_at_q(const VP10_COMP *cpi,
...
int av1_cyclic_refresh_rc_bits_per_mb(const VP10_COMP *cpi, int i,
                                       double correction_factor) {
  const VP10_COMMON *const cm = &cpi->common;
...
void av1_cyclic_refresh_update_segment(VP10_COMP *const cpi,
...
void av1_cyclic_refresh_postencode(VP10_COMP *const cpi) {
...
void av1_cyclic_refresh_set_golden_update(VP10_COMP *const cpi) {
...
// ref.
void av1_cyclic_refresh_check_golden_update(VP10_COMP *const cpi) {
  VP10_COMMON *const cm = &cpi->common;
  CYCLIC_REFRESH *const cr = cpi->cyclic_refresh;
  int mi_row, mi_col;
...
void av1_cyclic_refresh_update_parameters(VP10_COMP *const cpi) {
  const RATE_CONTROL *const rc = &cpi->rc;
  const VP10_COMMON *const cm = &cpi->common;
  CYCLIC_REFRESH *const cr = cpi->cyclic_refresh;
...
void av1_cyclic_refresh_setup(VP10_COMP *const cpi) {
  VP10_COMMON *const cm = &cpi->common;
  const RATE_CONTROL *const rc = &cpi->rc;
  CYCLIC_REFRESH *const cr = cpi->cyclic_refresh;
...
void av1_cyclic_refresh_reset_resize(VP10_COMP *const cpi) {
  const VP10_COMMON *const cm = &cpi->common;
  CYCLIC_REFRESH *const cr = cpi->cyclic_refresh;
