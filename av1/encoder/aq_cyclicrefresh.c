...
void av1_cyclic_refresh_setup(AV1_COMP *const cpi) {
  ...
  if (!cr->apply_cyclic_refresh) {
    ...
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST1, SEG_LVL_ALT_LF_Y_V, -10);
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST1, SEG_LVL_ALT_LF_Y_H, -10);
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST1, SEG_LVL_ALT_LF_U, -10);
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST1, SEG_LVL_ALT_LF_V, -10);
    // Use smaller LF on segment 2, since it will have lower Q.
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST2, SEG_LVL_ALT_LF_Y_V, -20);
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST2, SEG_LVL_ALT_LF_Y_H, -20);
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST2, SEG_LVL_ALT_LF_U, -20);
    av1_set_segdata(seg, CR_SEGMENT_ID_BOOST2, SEG_LVL_ALT_LF_V, -20);
