...
// AV1 aligns frame size to a multiple of 8, so that if there is
// chroma subsampling, it is able to ensure the chroma is also
// on integer mi units. mi unit is 4x4, 8 = 4 * 2, and 2 luma mi
// units corresponds to 1 chroma mi unit if there is subsampling.
