...
static int search_filter_level(const YV12_BUFFER_CONFIG *sd, AV1_COMP *cpi,
  ...
  const int is_frame_kf = (cm->current_frame.frame_type == KEY_FRAME);
  static const int min_filter_step_lookup[2][2] = { { 0, 0 }, { 0, 2 } };
  ...
  const int min_filter_step_thesh =
      min_filter_step_lookup[use_coarse_search][!is_frame_kf];
