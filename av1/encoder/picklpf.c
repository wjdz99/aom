...
static int64_t try_filter_frame(const YV12_BUFFER_CONFIG *sd,
  ...
  int backup_filter_levels[4] = { cm->lf.filter_level[0],
                                  cm->lf.filter_level[1], cm->lf.filter_level_u,
  ...
  cm->lf.filter_level[0] = backup_filter_levels[0];
  cm->lf.filter_level[1] = backup_filter_levels[1];
  cm->lf.filter_level_u = backup_filter_levels[2];
  cm->lf.filter_level_v = backup_filter_levels[3];
