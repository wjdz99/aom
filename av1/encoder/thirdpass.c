...
// via various decoder APIs, and save into ctx->frame_info.
...
// Parse the frames in the gop and determin the last frame of the current GOP.
// Decode more frames if necessary.
