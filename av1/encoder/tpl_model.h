...
typedef struct {
  ...
  double scale_factors[7];     // Scale factors to improve the budget estimation
  double mv_scale_factors[7];  // Scale factors to improve MV entropy estimation
...
static INLINE void vbr_rc_init(VBR_RATECTRL_INFO *vbr_rc_info,
  ...
  double scale_factors[7] = { 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2 };
  double mv_scale_factors[7] = { 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0 };
  for (int i = 0; i < 7; i++) {
