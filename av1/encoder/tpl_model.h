...
static AOM_INLINE bool tpl_alloc_temp_buffers(TplBuffers *tpl_tmp_buffers,
  ...
  tpl_tmp_buffers->predictor8 = aom_memalign(
      32, tpl_block_pels * 2 * sizeof(*tpl_tmp_buffers->predictor8));
  tpl_tmp_buffers->src_diff =
      aom_memalign(32, tpl_block_pels * sizeof(*tpl_tmp_buffers->src_diff));
  tpl_tmp_buffers->coeff =
      aom_memalign(32, tpl_block_pels * sizeof(*tpl_tmp_buffers->coeff));
  tpl_tmp_buffers->qcoeff =
      aom_memalign(32, tpl_block_pels * sizeof(*tpl_tmp_buffers->qcoeff));
  tpl_tmp_buffers->dqcoeff =
      aom_memalign(32, tpl_block_pels * sizeof(*tpl_tmp_buffers->dqcoeff));
...
void av1_mc_flow_dispenser_row(struct AV1_COMP *cpi, struct ThreadData *td,
