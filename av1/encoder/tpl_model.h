 ...
 * \param[out]      vbr_rc_info       A struct to store rate control
 * information. This includes the q_index_list, the scale factor, and data
 * collection tools.
 *
 ...
 * \param[in]       gf_frame_index    Current frame index
 * \param[in]       vbr_rc_info       Struct containing the scale factor and GOP
