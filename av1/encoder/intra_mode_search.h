 ...
 * delta angles.
 * \param[in]    mode_idx                       mode index in intra mode
 *                                              decision process.
 * \param[in]    mbmi                           Pointer to structure holding the
 *                                              mode info for the current
 *                                              macroblock.
 * \param[in]    reorder_delta_angle_processing Indicates whether to reorder the
 *                                              processing of delta angle modes.
 */
