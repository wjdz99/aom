...
static void loopfilter_frame(AV1_COMP *cpi, AV1_COMMON *cm) {
  ...
  if (is_lossless_requested(&cpi->oxcf)) {
    ...
    av1_clpf_test_frame(cm->frame_to_show, cpi->Source, cm, &cm->clpf_strength_u, 0, AOM_PLANE_U);
    av1_clpf_test_frame(cm->frame_to_show, cpi->Source, cm, &cm->clpf_strength_v, 0, AOM_PLANE_V);
    cm->dering_level =
