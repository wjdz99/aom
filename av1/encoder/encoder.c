...
static void init_config(struct AV1_COMP *cpi, AV1EncoderConfig *oxcf) {
  AV1_COMMON *const cm = &cpi->common;
  SequenceHeader *const seq_params = &cm->seq_params;
  ResizeParams *resize_params = &cpi->resize_params;
  ...
  resize_params->resize_pending_width = 0;
  resize_params->resize_pending_height = 0;
...
static size_params_type calculate_next_size_params(AV1_COMP *cpi) {
  ...
  if (resize_params->resize_pending_width &&
      resize_params->resize_pending_height) {
    rsz.resize_width = resize_params->resize_pending_width;
    rsz.resize_height = resize_params->resize_pending_height;
    resize_params->resize_pending_width = resize_params->resize_pending_height =
        0;
  } else {
...
int av1_set_internal_size(AV1EncoderConfig *const oxcf,
  ...
  resize_params->resize_pending_width = (hs - 1 + oxcf->width * hr) / hs;
  resize_params->resize_pending_height = (vs - 1 + oxcf->height * vr) / vs;
