...
void av1_change_config(struct AV1_COMP *cpi, const AV1EncoderConfig *oxcf) {
  ...
  if ((cpi->subgop_config_path == NULL && oxcf->subgop_config_path != NULL) ||
      (cpi->subgop_config_path != NULL && oxcf->subgop_config_path == NULL) ||
      strcmp(cpi->subgop_config_path, oxcf->subgop_config_path)) {
  ...
  if ((cpi->subgop_config_str == NULL && oxcf->subgop_config_str != NULL) ||
      (cpi->subgop_config_str != NULL && oxcf->subgop_config_str == NULL) ||
