...
#if CONFIG_LOWDELAY_COMPOUND //Disable to be compliant with high delay unmodified
  /* Should be OK to do biprediction between two identical frame (e.g. bwd_is_last=1) */
  if (bwd_is_alt && (flags & AOM_BWD_FLAG))
#else
