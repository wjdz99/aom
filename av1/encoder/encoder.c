...
#if CONFIG_FLEX_PARTITION
        HIGHBD_BFP(BLOCK_64X8, aom_highbd_sad64x8_bits8,
                   aom_highbd_sad64x8_avg_bits8, aom_highbd_8_variance64x8,
                   aom_highbd_8_sub_pixel_variance64x8,
                   aom_highbd_8_sub_pixel_avg_variance64x8,
                   aom_highbd_sad64x8x4d_bits8,
                   aom_highbd_dist_wtd_sad64x8_avg_bits8,
                   aom_highbd_8_dist_wtd_sub_pixel_avg_variance64x8)

        HIGHBD_BFP(BLOCK_8X64, aom_highbd_sad8x64_bits8,
                   aom_highbd_sad8x64_avg_bits8, aom_highbd_8_variance8x64,
                   aom_highbd_8_sub_pixel_variance8x64,
                   aom_highbd_8_sub_pixel_avg_variance8x64,
                   aom_highbd_sad8x64x4d_bits8,
                   aom_highbd_dist_wtd_sad8x64_avg_bits8,
                   aom_highbd_8_dist_wtd_sub_pixel_avg_variance8x64)

        HIGHBD_BFP(BLOCK_32X4, aom_highbd_sad32x4_bits8,
                   aom_highbd_sad32x4_avg_bits8, aom_highbd_8_variance32x4,
                   aom_highbd_8_sub_pixel_variance32x4,
                   aom_highbd_8_sub_pixel_avg_variance32x4,
                   aom_highbd_sad32x4x4d_bits8,
                   aom_highbd_dist_wtd_sad32x4_avg_bits8,
                   aom_highbd_8_dist_wtd_sub_pixel_avg_variance32x4)

        HIGHBD_BFP(BLOCK_4X32, aom_highbd_sad4x32_bits8,
                   aom_highbd_sad4x32_avg_bits8, aom_highbd_8_variance4x32,
                   aom_highbd_8_sub_pixel_variance4x32,
                   aom_highbd_8_sub_pixel_avg_variance4x32,
                   aom_highbd_sad4x32x4d_bits8,
                   aom_highbd_dist_wtd_sad4x32_avg_bits8,
                   aom_highbd_8_dist_wtd_sub_pixel_avg_variance4x32)

        HIGHBD_BFP(BLOCK_64X4, aom_highbd_sad64x4_bits8,
                   aom_highbd_sad64x4_avg_bits8, aom_highbd_8_variance64x4,
                   aom_highbd_8_sub_pixel_variance64x4,
                   aom_highbd_8_sub_pixel_avg_variance64x4,
                   aom_highbd_sad64x4x4d_bits8,
                   aom_highbd_dist_wtd_sad64x4_avg_bits8,
                   aom_highbd_8_dist_wtd_sub_pixel_avg_variance64x4)

        HIGHBD_BFP(BLOCK_4X64, aom_highbd_sad4x64_bits8,
                   aom_highbd_sad4x64_avg_bits8, aom_highbd_8_variance4x64,
                   aom_highbd_8_sub_pixel_variance4x64,
                   aom_highbd_8_sub_pixel_avg_variance4x64,
                   aom_highbd_sad4x64x4d_bits8,
                   aom_highbd_dist_wtd_sad4x64_avg_bits8,
