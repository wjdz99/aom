...
AV1_COMP *av1_create_compressor(AV1EncoderConfig *oxcf,
  ...
  cpi->od_rc.goldenframe_rate = cpi->rc.baseline_gf_interval;
...
// off.
  ...
  drop_this_frame = od_enc_rc_update_state(&cpi->od_rc, *size << 3, cpi->refresh_golden_frame,
...
static void Pass0Encode(AV1_COMP *cpi, size_t *size, uint8_t *dest,
  ...
  frame_type = od_frame_type(&cpi->od_rc, cpi->od_rc.curr_coding_order,
                             &is_golden, &is_altref, &ip_count);
