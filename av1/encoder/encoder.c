...
void av1_set_screen_content_options(AV1_COMP *cpi, FeatureFlags *features) {
  ...
  // Screen content tools are not evaluated in non-RD encoding mode unless content type 
  // is not set explicitly, i.e., when cpi->oxcf.tune_cfg.content != AOM_CONTENT_SCREEN
