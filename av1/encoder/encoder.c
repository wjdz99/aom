...
static void init_level_info(AV1LevelInfo *level_info) {
  ...
  for (int i = 0; i < MAX_NUM_OPERATING_POINTS; ++i) {
    ...
    level_info[i].level_spec.min_cropped_tile_width = INT_MAX;
    level_info[i].level_spec.min_cropped_tile_height = INT_MAX;
    level_info[i].level_spec.tile_width_is_valid = 1;
  }
}
