...
static void fwd_txfm_2x2(const int16_t *src_diff, tran_low_t *coeff,
                         int diff_stride, TXFM_PARAM *txfm_param) {
...
void av1_fwd_txfm(const int16_t *src_diff, tran_low_t *coeff, int diff_stride,
  ...
  switch (tx_size) {
    ...
    case TX_16X16:
      ...
      break;
    case TX_8X8:
      fwd_txfm_8x8(src_diff, coeff, diff_stride, txfm_param);
      break;
    case TX_4X8:
      fwd_txfm_4x8(src_diff, coeff, diff_stride, txfm_param);
      break;
    case TX_8X4:
      fwd_txfm_8x4(src_diff, coeff, diff_stride, txfm_param);
      break;
    case TX_8X16:
    ...
    case TX_32X16:
      ...
      break;
    case TX_4X4:
      fwd_txfm_4x4(src_diff, coeff, diff_stride, txfm_param);
      break;
#if CONFIG_CHROMA_2X2
    case TX_2X2:
      fwd_txfm_2x2(src_diff, coeff, diff_stride, txfm_param);
      break;
#endif
#if CONFIG_EXT_TX && CONFIG_RECT_TX && CONFIG_RECT_TX_EXT
    case TX_4X16:
