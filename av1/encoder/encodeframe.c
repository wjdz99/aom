...
static AOM_INLINE void encode_nonrd_sb(AV1_COMP *cpi, ThreadData *td,
  ...
  PC_TREE *const pc_root = av1_alloc_pc_tree_node(mi_row, mi_col, sb_size, NULL,
    PARTITION_NONE, 0, 1, cm->seq_params.subsampling_x, cm->seq_params.subsampling_y);
...
static AOM_INLINE void encode_rd_sb(AV1_COMP *cpi, ThreadData *td,
  ...
  if (sf->part_sf.partition_search_type == VAR_BASED_PARTITION) {
    ...
    av1_set_offsets_without_segment_id(cpi, tile_info, x, mi_row, mi_col,
                                       sb_size);
    av1_choose_var_based_partitioning(cpi, tile_info, td, x, mi_row, mi_col);
    PC_TREE *const pc_root = av1_alloc_pc_tree_node(mi_row, mi_col, sb_size, NULL, PARTITION_NONE, 0, 1, ss_x, ss_y);
    ...
    if (num_passes == 1) {
      ...
      PC_TREE *const pc_root_p0 = av1_alloc_pc_tree_node(mi_row, mi_col, sb_size, NULL, PARTITION_NONE, 0, 1, ss_x, ss_y);
      av1_rd_pick_partition(cpi, td, tile_data, tp, mi_row, mi_col, sb_size,
      ...
      PC_TREE *const pc_root_p1 = av1_alloc_pc_tree_node(mi_row, mi_col, sb_size, NULL, PARTITION_NONE, 0, 1, ss_x, ss_y);
      av1_rd_pick_partition(cpi, td, tile_data, tp, mi_row, mi_col, sb_size,
