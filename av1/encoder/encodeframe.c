...
static void encode_superblock(AV1_COMP *cpi, ThreadData *td, TOKENEXTRA **t,
  ...
  // TODO(jingning): Remove this speed feature. The codec structure will
  // substantially change during the development. The benefit of this speed
  // feature shall be evaluated again.
  x->skip_recode = 0;
