  ...
  if (sf->part_sf.partition_search_type == VAR_BASED_PARTITION) {
    ...
    if (!frame_is_intra_only(cm)) {
      ...
      av1_rd_pick_partition(cpi, td, tile_data, tp, mi_row, mi_col, sb_size,
                            &rd_stats_dspl[0], rd_stats_dspl[0],
                            pc_root_dspl[0], sms_root, NULL, SB_DRY_PASS, NULL);
      ...
      av1_restore_sb_state(&sb_fp_stats, cpi, td, tile_data, mi_row, mi_col);
      av1_rd_pick_partition(cpi, td, tile_data, tp, mi_row, mi_col, sb_size,
                            &rd_stats_dspl[1], rd_stats_dspl[1],
                            pc_root_dspl[1], sms_root, NULL, SB_DRY_PASS, NULL);
