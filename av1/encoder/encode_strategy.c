...
static void add_ref_to_slot(MapIdxPair *ref, int *const remapped_ref_idx, int frame) {
  remapped_ref_idx[frame - LAST_FRAME] = ref->map_idx;
  ref->used = 1;
}

static void set_unmapped_ref(MapIdxPair *buffer_map, int n_bufs, int update_arf, int min_level) {
