...
void av1_prune_ab_partitions(
    ...
    const PC_TREE *const pc_tree, BLOCK_SIZE bsize, int pb_source_variance,
    int64_t best_rdcost, int64_t horz_rd[2], int64_t vert_rd[2],
    int64_t split_rd[4], const RD_RECT_PART_WIN_INFO *const rect_part_win_info,
    int ext_partition_allowed, int partition_horz_allowed,
    int partition_vert_allowed, int *horza_partition_allowed,
