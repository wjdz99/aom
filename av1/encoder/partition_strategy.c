...
void av1_simple_motion_search(AV1_COMP *const cpi,
...
// Get the features for firstpass_simple_motion_search_term_none.
...
void av1_firstpass_simple_motion_search_early_term(
    AV1_COMP *const cpi, const TileInfo *const tile_info, MACROBLOCK *x,
    PC_TREE *pc_tree, int mi_row, int mi_col, BLOCK_SIZE bsize,
