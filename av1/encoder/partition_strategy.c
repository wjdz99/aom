...
static void simple_motion_search_prune_part_features(
  ...
  if (features_to_get & FEATURE_SMS_NONE_FLAG) {
    features[f_idx++] = logf(1.0f + pc_tree->sms_none_feat[0]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_none_feat[1]);
  }

  if (features_to_get & FEATURE_SMS_SPLIT_FLAG) {
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[0]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[1]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[2]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[3]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[4]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[5]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[6]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_split_feat[7]);
  }

  if (features_to_get & FEATURE_SMS_RECT_FLAG) {
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[0]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[1]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[2]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[3]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[4]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[5]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[6]);
    features[f_idx++] = logf(1.0f + pc_tree->sms_rect_feat[7]);
  }
