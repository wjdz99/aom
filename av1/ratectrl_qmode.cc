...
TplFrameDepStats CreateTplFrameDepStatsEmpty(int frame_height, int frame_width,
                                             int min_block_size) {
  const int unit_rows =
...
TplFrameDepStats CreateTplFrameDepStatsWoPropagation(
    const TplFrameStats &frame_stats) {
  const int min_block_size = frame_stats.min_block_size;
  TplFrameDepStats frame_dep_stats = CreateTplFrameDepStatsEmpty(
...
TplGopDepStats ComputeTplGopDepStats(
  ...
  for (int coding_idx = 0; coding_idx < frame_count; coding_idx++) {
    tpl_gop_dep_stats.frame_dep_stats_list.push_back(
        CreateTplFrameDepStatsWoPropagation(
