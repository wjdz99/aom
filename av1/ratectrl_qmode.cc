...
void construct_gop_multi_layer(GopStruct *gop_struct,
                               ...
                               int order_end, int global_coding_idx_offset,
  ...
  if (depth < max_depth && num_frames >= kMinIntervalToAddArf) {
    ...
    construct_gop_multi_layer(
        ...
        order_mid, global_coding_idx_offset, global_order_idx_offset);
    ...
    construct_gop_multi_layer(
        ...
        order_end, global_coding_idx_offset, global_order_idx_offset);
  } else {
    // regular frame
...
GopStruct construct_gop(RefFrameManager *ref_frame_manager,
  ...
  construct_gop_multi_layer(&gop_struct, ref_frame_manager,
                            ...
                            order_start, order_arf, global_coding_idx_offset,
...
GopStructList AV1RateControlQMode::DetermineGopInfo(
  ...
  while (remaining_show_frame_count > 0) {
    ...
    global_order_idx_offset += static_cast<int>(gop.show_frame_count);
