...
// imitate the behavior of GET_MV_RAWPEL
...
GopEncodeInfo AV1RateControlQMode::GetGopEncodeInfo(
  ...
  gop_encode_info.ref_frame_table_snapshot_init = ref_frame_table_snapshot_init;
  gop_encode_info.ref_frame_table_snapshot_end =
      ref_frame_table_list[ref_frame_table_list.size() - 1];
