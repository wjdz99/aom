...
static std::vector<int> av1_calculate_gf_length(
    const RateControlParam &rc_param, FIRSTPASS_STATS *stats_in,
    FIRSTPASS_STATS *stats_in_start, FIRSTPASS_STATS *stats_in_end,
    const std::vector<REGIONS> &regions_list, int total_regions,
    int max_intervals, int min_gf_interval, int max_gf_interval,
