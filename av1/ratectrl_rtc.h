...
namespace {
#define AOM_RC_MAX_LAYERS 32
#define AOM_RC_MAX_TS_LAYERS 8
#define AOM_RC_MAX_SS_LAYERS 4
...
struct AV1RateControlRtcConfig {
 public:
  ...
  double framerate;
  int layer_target_bitrate[AOM_RC_MAX_LAYERS];
  int ts_rate_decimator[AOM_RC_MAX_TS_LAYERS];
  int aq_mode;
  // Number of spatial layers
  int ss_number_layers;
  // Number of temporal layers
  int ts_number_layers;
  int max_quantizers[AOM_RC_MAX_LAYERS];
  int min_quantizers[AOM_RC_MAX_LAYERS];
  int scaling_factor_num[AOM_RC_MAX_SS_LAYERS];
  int scaling_factor_den[AOM_RC_MAX_SS_LAYERS];
};
