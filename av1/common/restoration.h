...
// in which case bit_depth is the bit depth. ss_y is another flag which should
// be 1 if this is a plane with vertical subsampling.
//
...
// results will be written and has stride dst_stride. dst8 should point at the
// top-left corner of this restoration unit (not the frame), meaning you can
// filter a single restoration unit without needing a full frame as an output
// buffer.
//
...
void av1_loop_restoration_filter_unit(const RestorationTileLimits *limits,
                                      ...
                                      int highbd, int bit_depth, int ss_y,
