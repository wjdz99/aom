...
#define WIENER_FILT_TAP0_STEP_BITS 0
#define WIENER_FILT_TAP1_STEP_BITS 0
#define WIENER_FILT_TAP2_STEP_BITS 0
...
#define WIENER_FILT_TAP0_MINV \
  (WIENER_FILT_TAP0_MIDV -    \
   (1 << (WIENER_FILT_TAP0_BITS + WIENER_FILT_TAP0_STEP_BITS - 1)))
#define WIENER_FILT_TAP1_MINV \
  (WIENER_FILT_TAP1_MIDV -    \
   (1 << (WIENER_FILT_TAP1_BITS + WIENER_FILT_TAP1_STEP_BITS - 1)))
#define WIENER_FILT_TAP2_MINV \
  (WIENER_FILT_TAP2_MIDV -    \
   (1 << (WIENER_FILT_TAP2_BITS + WIENER_FILT_TAP2_STEP_BITS - 1)))

#define WIENER_FILT_TAP0_MAXV                                  \
  (WIENER_FILT_TAP0_MIDV - (1 << WIENER_FILT_TAP0_STEP_BITS) + \
   (1 << (WIENER_FILT_TAP0_BITS + WIENER_FILT_TAP0_STEP_BITS - 1)))
#define WIENER_FILT_TAP1_MAXV                                  \
  (WIENER_FILT_TAP1_MIDV - (1 << WIENER_FILT_TAP1_STEP_BITS) + \
   (1 << (WIENER_FILT_TAP1_BITS + WIENER_FILT_TAP1_STEP_BITS - 1)))
#define WIENER_FILT_TAP2_MAXV                                  \
  (WIENER_FILT_TAP2_MIDV - (1 << WIENER_FILT_TAP2_STEP_BITS) + \
   (1 << (WIENER_FILT_TAP2_BITS + WIENER_FILT_TAP2_STEP_BITS - 1)))

// Central values for the taps for chroma
#define WIENER_UV_FILT_TAP0_MIDV (3)
#define WIENER_UV_FILT_TAP1_MIDV (-7)
#define WIENER_UV_FILT_TAP2_MIDV (15)
#define WIENER_UV_FILT_TAP3_MIDV                              \
  (WIENER_FILT_STEP -                                         \
   2 * (WIENER_UV_FILT_TAP0_MIDV + WIENER_UV_FILT_TAP1_MIDV + \
        WIENER_UV_FILT_TAP2_MIDV))

#define WIENER_UV_FILT_TAP0_STEP_BITS 0
#define WIENER_UV_FILT_TAP1_STEP_BITS 0
#define WIENER_UV_FILT_TAP2_STEP_BITS 0

#define WIENER_UV_FILT_TAP0_BITS 4
#define WIENER_UV_FILT_TAP1_BITS 5
#define WIENER_UV_FILT_TAP2_BITS 6

#define WIENER_UV_FILT_TAP0_SUBEXP_K 1
#define WIENER_UV_FILT_TAP1_SUBEXP_K 2
#define WIENER_UV_FILT_TAP2_SUBEXP_K 3

#define WIENER_UV_FILT_TAP0_MINV \
  (WIENER_UV_FILT_TAP0_MIDV -    \
   (1 << (WIENER_UV_FILT_TAP0_BITS + WIENER_UV_FILT_TAP0_STEP_BITS - 1)))
#define WIENER_UV_FILT_TAP1_MINV \
  (WIENER_UV_FILT_TAP1_MIDV -    \
   (1 << (WIENER_UV_FILT_TAP1_BITS + WIENER_UV_FILT_TAP1_STEP_BITS - 1)))
#define WIENER_UV_FILT_TAP2_MINV \
  (WIENER_UV_FILT_TAP2_MIDV -    \
   (1 << (WIENER_UV_FILT_TAP2_BITS + WIENER_UV_FILT_TAP2_STEP_BITS - 1)))

#define WIENER_UV_FILT_TAP0_MAXV                                     \
  (WIENER_UV_FILT_TAP0_MIDV - (1 << WIENER_UV_FILT_TAP0_STEP_BITS) + \
   (1 << (WIENER_UV_FILT_TAP0_BITS + WIENER_UV_FILT_TAP0_STEP_BITS - 1)))
#define WIENER_UV_FILT_TAP1_MAXV                                     \
  (WIENER_UV_FILT_TAP1_MIDV - (1 << WIENER_UV_FILT_TAP1_STEP_BITS) + \
   (1 << (WIENER_UV_FILT_TAP1_BITS + WIENER_UV_FILT_TAP1_STEP_BITS - 1)))
#define WIENER_UV_FILT_TAP2_MAXV                                     \
  (WIENER_UV_FILT_TAP2_MIDV - (1 << WIENER_UV_FILT_TAP2_STEP_BITS) + \
   (1 << (WIENER_UV_FILT_TAP2_BITS + WIENER_UV_FILT_TAP2_STEP_BITS - 1)))

// Max of SGRPROJ_TMPBUF_SIZE, WIENER_TMPBUF_SIZE
