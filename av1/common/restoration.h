...
// of SGRPROJ_BORDER_VERT and WIENER_BORDER_VERT. Note the line buffer
// needed is twice the value of this macro.
...
#if (RESTORATION_BORDER_VERT < SGRPROJ_BORDER_VERT || \
     RESTORATION_BORDER_VERT < WIENER_BORDER_VERT)
#error "RESTORATION_NORDER_VERT < max(SGRPROJ_BORDER_VERT, WIENER_BORDER_VERT)"
#endif
#if (RESTORATION_BORDER_HORZ < SGRPROJ_BORDER_HORZ || \
     RESTORATION_BORDER_HORZ < WIENER_BORDER_HORZ)
#error "RESTORATION_NORDER_HORZ < max(SGRPROJ_BORDER_HORZ, WIENER_BORDER_HORZ)"
#endif
