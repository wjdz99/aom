 ...
 * This function apples the loop restoration filter to a single
 * loop restoration unit.
 *
 * \param[in]  limits        limits of the unit
 * \param[in]  rui           provides the parameters to use for this unit
 *                           and its coefficients
 * \param[in]  rsb           contains deblocked pixels to use for stripe
 *                           boundaries
 * \param[in]  rlbs          space to use as a scratch buffer
 * \param[in]  tile_rect     the limits of the tile containing this unit
 ...
 * \param[in]  data8         the frame data (pointing at the top-left corner of
 ...
 * \param[in]  tmpbuf        cratch buffer used by the sgrproj filter which
