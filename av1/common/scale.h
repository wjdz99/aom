...
struct ScaleFactors {
  ...
  int (*scale_value_x)(int val, const struct ScaleFactors *sf);
  int (*scale_value_y)(int val, const struct ScaleFactors *sf);

  ConvolveFnT predict[2][2][2];  // horiz, vert, avg
#if CONFIG_HIGHBITDEPTH
  HighbdConvolveFnT highbd_predict[2][2][2];  // horiz, vert, avg
