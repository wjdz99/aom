...
void aom_accounting_reset(Accounting *accounting) {
  ...
  accounting->syms.num_raw_syms = 0;
  accounting->syms.num_raw_binary_syms = 0;
...
void aom_accounting_dump(Accounting *accounting) {
  ...
  printf("----- Number of raw symbol calls = %d (%d binary) -----\n",
         accounting->syms.num_raw_syms, accounting->syms.num_raw_binary_syms);
