...
static uint8_t get_class_from_grad(int gx, int gy, int bd) {
  const int thresh[] = { 3 << (bd - 8), 6 << (bd - 8), 20 << (bd - 8) };
...
const int16_t stx64x64_filters[] = {
...
void av1_inv_txfm2d_add_64x64_c(const int32_t *input, uint16_t *output,
  ...
  if (is_constant_buffer(output_32x32, 32, 32, 32)) {
    ...
    NonsepFilterConfig nsfilter = { 10, 32, 0, stx64x64_config, 1 };
...
void av1_inv_txfm2d_add_32x64_c(const int32_t *input, uint16_t *output,
  ...
  if (is_constant_buffer(output_32x32, 32, 32, 32)) {
    ...
    NonsepFilterConfig nsfilter = { 10, 20, 0, stxnx64_config, 1 };
...
void av1_inv_txfm2d_add_64x32_c(const int32_t *input, uint16_t *output,
  ...
  if (is_constant_buffer(output_32x32, 32, 32, 32)) {
    ...
    DECLARE_ALIGNED(32, uint8_t, cls[32 * 64]);
    NonsepFilterConfig nsfilter = { 10, 20, 0, stx64xn_config, 1 };
