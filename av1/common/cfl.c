...
static cfl_subsample_lbd_fn subsample_lbd[2][2] = {
  { cfl_luma_subsampling_444_lbd, cfl_luma_subsampling_440_lbd },
  { cfl_luma_subsampling_422_lbd, cfl_luma_subsampling_420_lbd },
};
...
static cfl_subsample_hbd_fn subsample_hbd[2][2] = {
  { cfl_luma_subsampling_444_hbd, cfl_luma_subsampling_440_hbd },
  { cfl_luma_subsampling_422_hbd, cfl_luma_subsampling_420_hbd },
};
#endif  // CONFIG_HIGHBITDEPTH
...
static INLINE void cfl_store(CFL_CTX *cfl, const uint8_t *input,
  ...
  if (use_hbd) {
    ...
    subsample_hbd[sub_x][sub_y](input_16, input_stride, pred_buf_q3, width,
                                height);
    return;
  }
#endif  // CONFIG_HIGHBITDEPTH
  (void)use_hbd;
  subsample_lbd[sub_x][sub_y](input, input_stride, pred_buf_q3, width, height);
}
