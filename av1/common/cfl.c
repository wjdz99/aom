...
static void INLINE sum_above_row_lbd(const uint8_t *dst_u, int dst_u_stride,
...
static void INLINE sum_above_row_hbd(const uint16_t *dst_u, int dst_u_stride,
...
static void INLINE sum_above_row(const MACROBLOCKD *xd, int width,
...
static void INLINE sum_left_col_lbd(const uint8_t *dst_u, int dst_u_stride,
                                    const uint8_t *dst_v, int dst_v_stride,
...
#if CONFIG_HIGHBITDEPTH
static void INLINE sum_left_col_hbd(const uint16_t *dst_u, int dst_u_stride,
                                    const uint16_t *dst_v, int dst_v_stride,
                                    int height, int *out_sum_u,
                                    int *out_sum_v) {
...
#endif  // CONFIG_HIGHBITDEPTH
static void INLINE sum_left_col(const MACROBLOCKD *xd, int height,
                                int *out_sum_u, int *out_sum_v) {
  const struct macroblockd_plane *const pd_u = &xd->plane[AOM_PLANE_U];
  const struct macroblockd_plane *const pd_v = &xd->plane[AOM_PLANE_V];
