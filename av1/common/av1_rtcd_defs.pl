...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  if (aom_config("CONFIG_EXTQUANT") eq "yes") {
    ...
    add_proto qw/void av1_quantize_lp/, "const int16_t *coeff_ptr, intptr_t n_coeffs, const int32_t *round_ptr, const int32_t *quant_ptr, int16_t *qcoeff_ptr, int16_t *dqcoeff_ptr, const int32_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan";
