...
if (aom_config("CONFIG_LGT") ne "yes" && aom_config("CONFIG_DAALA_DCT4") ne "yes") {
...
if (aom_config("CONFIG_LGT") ne "yes") {
...
if (aom_config("CONFIG_LGT") ne "yes" && aom_config("CONFIG_DAALA_DCT8") ne "yes") {
  if (aom_config("CONFIG_HIGHBITDEPTH") ne "yes") {
