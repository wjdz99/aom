...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  add_proto qw/void av1_compute_stats/,  "int wiener_win, const uint8_t *dgd8, const uint8_t *src8, int h_start, int h_end, int v_start, int v_end, int dgd_stride, int src_stride,  void *M, void *H";
