...
if (aom_config("CONFIG_FILTER_INTRA") eq "yes") {
  add_proto qw/void filter_intra_predictor/, "uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left, int mode";
  specialize qw/filter_intra_predictor sse4_1/;
}
