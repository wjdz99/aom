...
add_proto qw/void resize_horz_dir/, "const uint8_t *const input, int in_stride, uint8_t *intbuf, int height, int filteredlength, int width2";
specialize qw/resize_horz_dir avx2/;
