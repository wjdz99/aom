...
if (aom_config("CONFIG_LOOP_RESTORATION") eq "yes") {
  ...
  add_proto qw/void av1_highpass_filter/, "uint8_t *dgd, int width, int height, int stride, int32_t *dst, int dst_stride, int bit_depth, int r, int eps, int32_t *tmpbuf";
  ...
  if (aom_config("CONFIG_AOM_HIGHBITDEPTH") eq "yes") {
    ...
    add_proto qw/void av1_highpass_filter_highbd/, "uint16_t *dgd, int width, int height, int stride, int32_t *dst, int dst_stride, int bit_depth, int r, int eps, int32_t *tmpbuf";
