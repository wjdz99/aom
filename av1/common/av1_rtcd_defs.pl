...
struct Macroblock;
struct AomVarianceVtable;
struct SearchSiteConfig;
struct mv;
union IntMv;
...
if (aom_config("CONFIG_HIGHBITDEPTH") eq "yes") {
  {
    add_proto qw/void av1_iht4x4_16_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht4x4_16_add sse2/;

    add_proto qw/void av1_iht4x8_32_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht4x8_32_add sse2/;

    add_proto qw/void av1_iht8x4_32_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht8x4_32_add sse2/;

    add_proto qw/void av1_iht8x16_128_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht8x16_128_add sse2/;

    add_proto qw/void av1_iht16x8_128_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht16x8_128_add sse2/;

    add_proto qw/void av1_iht16x32_512_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht16x32_512_add sse2/;

    add_proto qw/void av1_iht32x16_512_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht32x16_512_add sse2/;

    add_proto qw/void av1_iht4x16_64_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";

    add_proto qw/void av1_iht16x4_64_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";

    add_proto qw/void av1_iht8x32_256_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";

    add_proto qw/void av1_iht32x8_256_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";

    add_proto qw/void av1_iht8x8_64_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
      specialize qw/av1_iht8x8_64_add sse2/;

    add_proto qw/void av1_iht16x16_256_add/, "const TranLowT *input, uint8_t *output, int pitch, int tx_type";
      specialize qw/av1_iht16x16_256_add sse2 avx2/;

    add_proto qw/void av1_iht32x32_1024_add/, "const TranLowT *input, uint8_t *output, int pitch, int tx_type";
  }
} else {
  {
    add_proto qw/void av1_iht4x4_16_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type";
...
if (aom_config("CONFIG_TX64X64") eq "yes") {
  add_proto qw/void av1_iht64x64_4096_add/, "const TranLowT *input, uint8_t *output, int pitch, int tx_type";
}

if (aom_config("CONFIG_NEW_QUANT") eq "yes") {
  add_proto qw/void quantize_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

  add_proto qw/void quantize_fp_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

  add_proto qw/void quantize_32x32_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

  add_proto qw/void quantize_32x32_fp_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

  if (aom_config("CONFIG_TX64X64") eq "yes") {
    add_proto qw/void quantize_64x64_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

    add_proto qw/void quantize_64x64_fp_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";
  }
}
...
if (aom_config("CONFIG_HIGHBITDEPTH") eq "yes") {
  ...
  # dct
  #
  add_proto qw/void av1_highbd_iht4x4_16_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht4x8_32_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht8x4_32_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht8x16_128_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht16x8_128_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht16x32_512_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht32x16_512_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht4x16_64_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht16x4_64_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht8x32_256_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht32x8_256_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht8x8_64_add/, "const TranLowT *input, uint8_t *dest, int dest_stride, int tx_type, int bd";

  add_proto qw/void av1_highbd_iht16x16_256_add/, "const TranLowT *input, uint8_t *output, int pitch, int tx_type, int bd";
}
...
if (aom_config("CONFIG_AOM_QM") eq "yes") {
  if (aom_config("CONFIG_HIGHBITDEPTH") eq "yes") {
    ...
    add_proto qw/int64_t av1_block_error/, "const TranLowT *coeff, const TranLowT *dqcoeff, intptr_t block_size, int64_t *ssz";

    add_proto qw/void av1_quantize_fp/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT *iqm_ptr";

    add_proto qw/void av1_quantize_fp_32x32/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT *iqm_ptr";

    if (aom_config("CONFIG_TX64X64") eq "yes") {
      add_proto qw/void av1_quantize_fp_64x64/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT *iqm_ptr";
    }

    add_proto qw/void av1_fdct8x8_quant/, "const int16_t *input, int stride, TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT *iqm_ptr";
  } else {
    add_proto qw/int64_t av1_block_error/, "const TranLowT *coeff, const TranLowT *dqcoeff, intptr_t block_size, int64_t *ssz";
  ...
  if (aom_config("CONFIG_HIGHBITDEPTH") eq "yes") {
    ...
    add_proto qw/void av1_quantize_fp/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan";
...
add_proto qw/void av1_fht4x4/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht4x4 sse2/;

add_proto qw/void av1_fwht4x4/, "const int16_t *input, TranLowT *output, int stride";

add_proto qw/void av1_fht8x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht8x8 sse2/;

add_proto qw/void av1_fht16x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht16x16 sse2 avx2/;

add_proto qw/void av1_fht32x32/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht32x32 sse2 avx2/;

if (aom_config("CONFIG_TX64X64") eq "yes") {
  add_proto qw/void av1_fht64x64/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
}

add_proto qw/void av1_fht4x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht4x8 sse2/;

add_proto qw/void av1_fht8x4/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht8x4 sse2/;

add_proto qw/void av1_fht8x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht8x16 sse2/;

add_proto qw/void av1_fht16x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht16x8 sse2/;

add_proto qw/void av1_fht16x32/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht16x32 sse2/;

add_proto qw/void av1_fht32x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
specialize qw/av1_fht32x16 sse2/;

add_proto qw/void av1_fht4x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

add_proto qw/void av1_fht16x4/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

add_proto qw/void av1_fht8x32/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

add_proto qw/void av1_fht32x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
...
add_proto qw/void av1_fwd_idtx/, "const int16_t *src_diff, TranLowT *coeff, int stride, int bs, int tx_type";
...
# Motion search
#
add_proto qw/int av1_full_search_sad/, "const struct Macroblock *x, const struct mv *ref_mv, int sad_per_bit, int distance, const struct AomVarianceVtable *fn_ptr, const struct mv *center_mv, struct mv *best_mv";
...
add_proto qw/int av1_diamond_search_sad/, "struct Macroblock *x, const struct SearchSiteConfig *cfg,  struct mv *ref_mv, struct mv *best_mv, int search_param, int sad_per_bit, int *num00, const struct AomVarianceVtable *fn_ptr, const struct mv *center_mv";

add_proto qw/int av1_full_range_search/, "const struct Macroblock *x, const struct SearchSiteConfig *cfg, struct mv *ref_mv, struct mv *best_mv, int search_param, int sad_per_bit, int *num00, const struct AomVarianceVtable *fn_ptr, const struct mv *center_mv";
...
if (aom_config("CONFIG_AOM_QM") eq "yes") {
  add_proto qw/void av1_quantize_b/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT * iqm_ptr, int log_scale";
} else {
  add_proto qw/void av1_quantize_b/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, int log_scale";
}
...
if (aom_config("CONFIG_HIGHBITDEPTH") eq "yes") {
  ...
  # ENCODEMB INVOKE
  if (aom_config("CONFIG_NEW_QUANT") eq "yes") {
    add_proto qw/void highbd_quantize_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

    add_proto qw/void highbd_quantize_fp_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

    add_proto qw/void highbd_quantize_32x32_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

    add_proto qw/void highbd_quantize_32x32_fp_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

    if (aom_config("CONFIG_TX64X64") eq "yes") {
      add_proto qw/void highbd_quantize_64x64_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";

      add_proto qw/void highbd_quantize_64x64_fp_nuq/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *quant_ptr, const int16_t *dequant_ptr, const CumlBinsTypeNuq *cuml_bins_ptr, const DequantValTypeNuq *dequant_val, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, uint16_t *eob_ptr, const int16_t *scan, const uint8_t *band";
    }
  }

  add_proto qw/int64_t av1_highbd_block_error/, "const TranLowT *coeff, const TranLowT *dqcoeff, intptr_t block_size, int64_t *ssz, int bd";
  specialize qw/av1_highbd_block_error sse2/;

  if (aom_config("CONFIG_AOM_QM") eq "yes") {
    add_proto qw/void av1_highbd_quantize_fp/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT * iqm_ptr, int log_scale";

    add_proto qw/void av1_highbd_quantize_fp_32x32/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT * iqm_ptr, int log_scale";

    if (aom_config("CONFIG_TX64X64") eq "yes") {
      add_proto qw/void av1_highbd_quantize_fp_64x64/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT * iqm_ptr, int log_scale";
    }

    add_proto qw/void av1_highbd_quantize_b/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, const QmValT * qm_ptr, const QmValT * iqm_ptr, int log_scale";
  } else {
    add_proto qw/void av1_highbd_quantize_fp/, "const TranLowT *coeff_ptr, intptr_t n_coeffs, int skip_block, const int16_t *zbin_ptr, const int16_t *round_ptr, const int16_t *quant_ptr, const int16_t *quant_shift_ptr, TranLowT *qcoeff_ptr, TranLowT *dqcoeff_ptr, const int16_t *dequant_ptr, uint16_t *eob_ptr, const int16_t *scan, const int16_t *iscan, int log_scale";
  ...
  # fdct functions
  add_proto qw/void av1_highbd_fht4x4/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
  specialize qw/av1_highbd_fht4x4 sse4_1/;

  add_proto qw/void av1_highbd_fht4x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht8x4/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht8x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht16x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht16x32/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht32x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht4x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht16x4/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht8x32/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht32x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht8x8/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht16x16/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  add_proto qw/void av1_highbd_fht32x32/, "const int16_t *input, TranLowT *output, int stride, int tx_type";

  if (aom_config("CONFIG_TX64X64") eq "yes") {
    add_proto qw/void av1_highbd_fht64x64/, "const int16_t *input, TranLowT *output, int stride, int tx_type";
  }

  add_proto qw/void av1_highbd_fwht4x4/, "const int16_t *input, TranLowT *output, int stride";
...
if (aom_config("CONFIG_PVQ") eq "yes") {
  add_proto qw/double pvq_search_rdo_double/, "const OdVal16 *xcoeff, int n, int k, int *ypulse, double g2, double pvq_norm_lambda, int prev_k";
