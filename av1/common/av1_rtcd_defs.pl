...
if (aom_config("CONFIG_IST") eq "yes") {
  add_proto qw/void inv_stxfm/ , "tran_low_t *src, tran_low_t *dst, const PREDICTION_MODE mode, const int8_t stx_idx, const int size";
...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  #fwd txfm
  if (aom_config("CONFIG_IST") eq "yes") {
    add_proto qw/void fwd_stxfm/ , "tran_low_t *src, tran_low_t *dst, const PREDICTION_MODE mode, const int8_t stx_idx, const int size";
