...
typedef void (*cfl_subtract_average_fn)(int16_t *ac_buf_q3, int16_t *recon_buf_q3);

typedef void (*cfl_predict_lbd_fn)(const int16_t *ac_buf_q3, uint8_t *dst,
                                   int dst_stride, int alpha_q3);

typedef void (*cfl_predict_hbd_fn)(const int16_t *ac_buf_q3, uint16_t *dst,
