...
add_proto qw/void av1_build_compound_seg_mask/, "uint8_t *mask, SEG_MASK_TYPE mask_type, const uint8_t *src0, int src0_stride, const uint8_t *src1, int src1_stride, int h, int w";
add_proto qw/void av1_build_compound_seg_mask_highbd/, "uint8_t *mask, SEG_MASK_TYPE mask_type, const uint8_t *src0, int src0_stride, const uint8_t *src1, int src1_stride, int h, int w, int bd";
specialize qw/av1_build_compound_seg_mask sse4_1/;
