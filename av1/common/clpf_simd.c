...
static void clpf_block4(const uint8_t *src, uint8_t *dst, int sstride,
                        int dstride, int x0, int y0, int width, int height,
...

  {
    ...
    uint32_t l0 = *(uint32_t *)(src - !!y0 * sstride);
    ...
    uint32_t l5 = *(uint32_t *)(src + (3 + !!bottom) * sstride);
    ...
    v128 b = v128_add_8(
        c128, v128_from_32(*(uint32_t *)(src - 2 * !!x0),
                           *(uint32_t *)(src + sstride - 2 * !!x0),
                           *(uint32_t *)(src + 2 * sstride - 2 * !!x0),
                           *(uint32_t *)(src + 3 * sstride - 2 * !!x0)));
    v128 c =
        v128_add_8(c128, v128_from_32(*(uint32_t *)(src - !!x0),
                                      *(uint32_t *)(src + sstride - !!x0),
                                      *(uint32_t *)(src + 2 * sstride - !!x0),
                                      *(uint32_t *)(src + 3 * sstride - !!x0)));
    v128 d = v128_add_8(
        c128, v128_from_32(*(uint32_t *)(src + !!right),
                           *(uint32_t *)(src + sstride + !!right),
                           *(uint32_t *)(src + 2 * sstride + !!right),
                           *(uint32_t *)(src + 3 * sstride + !!right)));
    v128 e = v128_add_8(
        c128, v128_from_32(*(uint32_t *)(src + 2 * !!right),
                           *(uint32_t *)(src + sstride + 2 * !!right),
                           *(uint32_t *)(src + 2 * sstride + 2 * !!right),
                           *(uint32_t *)(src + 3 * sstride + 2 * !!right)));
...
void SIMD_FUNC(aom_clpf_block)(const uint8_t *src, uint8_t *dst, int sstride,
  ...
  if (sizex == 4 && sizey == 4)  // chroma 420
    clpf_block4(src, dst, sstride, dstride, x0, y0, width, height, strength);
  else if (sizex == 4) {  // chroma 422
    clpf_block4(src, dst, sstride, dstride, x0, y0, width, height, strength);
    clpf_block4(src + 4 * sstride, dst + 4 * dstride, sstride, dstride, x0, y0,
                width, height, strength);
  } else {  // luma 444 or luma 420
    clpf_block8(src, dst, sstride, dstride, x0, y0, width, height, strength);
  }
}
