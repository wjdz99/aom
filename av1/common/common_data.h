...
static const PARTITION_TYPE partition_map_from_symbol_block_wgth[PARTITION_TYPES_REC] = {
  PARTITION_NONE,
  PARTITION_VERT,
  PARTITION_HORZ,
...
static const PARTITION_TYPE_REC symbol_map_from_partition_block_wgth[EXT_PARTITION_TYPES] = {
  PARTITION_NONE_REC,
...
static const PARTITION_TYPE partition_map_from_symbol_block_hgtw[PARTITION_TYPES_REC] = {
  PARTITION_NONE,
  PARTITION_HORZ,
  PARTITION_VERT,
#if CONFIG_EXT_PARTITIONS
...
static const PARTITION_TYPE_REC symbol_map_from_partition_block_hgtw[EXT_PARTITION_TYPES] = {
  PARTITION_NONE_REC,
  PARTITION_LONG_SIDE_REC,
  PARTITION_SHORT_SIDE_REC,
  PARTITION_INVALID_REC,
