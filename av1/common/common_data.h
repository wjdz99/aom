...
#else
static const BLOCK_SIZE subsize_lookup[EXT_PARTITION_TYPES + 1][BLOCK_SIZES_ALL] = {
#endif  // KEEP_PARTITION_SPLIT
  {     // PARTITION_NONE
    ...
    BLOCK_4X16, BLOCK_INVALID, BLOCK_8X32, BLOCK_64X4, BLOCK_4X32, BLOCK_INVALID,  
#else  // CONFIG_FLEX_PARTITION
    BLOCK_4X8, BLOCK_INVALID, BLOCK_8X16, BLOCK_INVALID, BLOCK_16X32, BLOCK_INVALID,
#endif  // CONFIG_FLEX_PARTITION
  }, {  // PARTITION_VERT
    ...
    BLOCK_INVALID, BLOCK_16X4, BLOCK_4X64, BLOCK_32X8, BLOCK_INVALID, BLOCK_32X4,
#else  // CONFIG_FLEX_PARTITION
    BLOCK_INVALID, BLOCK_8X4, BLOCK_INVALID, BLOCK_16X8, BLOCK_INVALID, BLOCK_32X16,
#endif  // CONFIG_FLEX_PARTITION
#if KEEP_PARTITION_SPLIT
  }, {  // PARTITION_SPLIT
...
#if CONFIG_FLEX_PARTITION
    BLOCK_4X64, BLOCK_16X16, BLOCK_INVALID, BLOCK_8X4, BLOCK_INVALID, BLOCK_16X8,
