...
static const uint8_t num_4x4_blocks_wide_lookup[BLOCK_SIZES_ALL] = {
  ...
  1, 1, 1,
#endif
  1, 1, 2, 2, 2, 4, 4, 4, 8, 8, 8, 16, 16, IF_EXT_PARTITION(16, 32, 32) 1, 4, 2,
  8
};
static const uint8_t num_4x4_blocks_high_lookup[BLOCK_SIZES_ALL] = {
  ...
  1, 1, 1,
#endif
  1, 2, 1, 2, 4, 2, 4, 8, 4, 8, 16, 8, 16, IF_EXT_PARTITION(32, 16, 32) 4, 1, 8,
  2
};
...
static const uint8_t num_pels_log2_lookup[BLOCK_SIZES_ALL] = {
  ...
  2, 3, 3,
#endif
  4, 5, 5, 6, 7, 7, 8, 9, 9, 10, 11, 11, 12, IF_EXT_PARTITION(13, 13, 14) 6, 6,
  8, 8
};
