...
extern __declspec(selectany) const uint8_t mi_size_wide_log2[BLOCK_SIZES_ALL] = {
...
extern __declspec(selectany) const BLOCK_SIZE txsize_to_bsize_aom[TX_SIZES_ALL] = {
  BLOCK_4X4,    // TX_4X4
  BLOCK_8X8,    // TX_8X8
