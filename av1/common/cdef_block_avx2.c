...
static INLINE __m256i fold_mul_and_sum_avx2(__m256i partiala, __m256i partialb,
                                            __m256i const1, __m256i const2) {
  __m256i tmp;
  /* Reverse partial B. */
...
static INLINE __m256i compute_directions_avx2(__m256i lines[8],
  ...
  partial4a = fold_mul_and_sum_avx2(
      partial4a, partial4b,
      _mm256_set_epi32(210, 280, 420, 840, 210, 280, 420, 840),
      _mm256_set_epi32(105, 120, 140, 168, 105, 120, 140, 168));
  partial7a = fold_mul_and_sum_avx2(
      partial7a, partial7b, _mm256_set_epi32(210, 420, 0, 0, 210, 420, 0, 0),
      _mm256_set_epi32(105, 105, 105, 140, 105, 105, 105, 140));
  partial5a = fold_mul_and_sum_avx2(
      partial5a, partial5b, _mm256_set_epi32(210, 420, 0, 0, 210, 420, 0, 0),
      _mm256_set_epi32(105, 105, 105, 140, 105, 105, 105, 140));
