...
void av1_build_prediction_by_above_preds_hp(const AV1_COMMON *cm, MACROBLOCKD *xd,
                                            int mi_row, int mi_col,
                                            int32_t *tmp_buf[MAX_MB_PLANE],
                                            int tmp_stride[MAX_MB_PLANE]);
void av1_build_prediction_by_left_preds_hp(const AV1_COMMON *cm, MACROBLOCKD *xd,
                                           int mi_row, int mi_col,
                                           int32_t *tmp_buf[MAX_MB_PLANE],
                                           int tmp_stride[MAX_MB_PLANE]);
void av1_build_obmc_inter_prediction(const AV1_COMMON *cm,
                                     MACROBLOCKD *xd, int mi_row, int mi_col,
                                     CONV_BUF_TYPE *base[MAX_MB_PLANE],
                                     int base_stride[MAX_MB_PLANE],
                                     CONV_BUF_TYPE *above[MAX_MB_PLANE],
                                     int above_stride[MAX_MB_PLANE],
                                     CONV_BUF_TYPE *left[MAX_MB_PLANE],
