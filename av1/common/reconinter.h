...
int av1_derived_mv_allowed(const AV1_COMMON *const cm, MACROBLOCKD *const xd,
                       MB_MODE_INFO *const  mbmi);

MV av1_refine_mv(const AV1_COMMON *const cm,
                 MACROBLOCKD *xd, MB_MODE_INFO *mbmi, uint8_t *recon_buf,
                 int recon_stride);
