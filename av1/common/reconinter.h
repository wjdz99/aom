...
int illum_mcomp_compute_dc_lowbd(
    const uint8_t *pred, int stride, int bw, int bh);

int illum_mcomp_compute_dc_highbd(
    const uint16_t *pred, int stride, int bw, int bh);
