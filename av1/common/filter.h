...
#if CONFIG_EXT_SKIP
#define NUM_FILTER_LEVELS 2
#define NUM_LEVEL_SYMBOLS 2
#define SWITCHABLE_FILTER_CONTEXTS ((NUM_LEVEL_SYMBOLS + 1) * 4)
#define INTER_FILTER_COMP_OFFSET (NUM_LEVEL_SYMBOLS + 1)
#define INTER_FILTER_DIR_OFFSET ((NUM_LEVEL_SYMBOLS + 1) * 2)
