...
void av1_resize_frame420(const uint8_t *const y, int y_stride, const uint8_t *u,
                         const uint8_t *const v, int uv_stride, int height,
                         int width, uint8_t *oy, int oy_stride, uint8_t *ou,
                         uint8_t *ov, int ouv_stride, int oheight, int owidth);
bool av1_resize_frame422(const uint8_t *const y, int y_stride, const uint8_t *u,
...
bool av1_resize_frame444(const uint8_t *const y, int y_stride,
                         const uint8_t *const u, const uint8_t *v,
