...
// The normative scaler av1_resize_and_extend_frame() can only handle
// scale ratios >= 1/4 and <= 16. See comment in aom_convolve8_c() for detail.
// The normative scaler has quality issue if scale ratio or reciprocal is
// not a multiple of 1/16. SSSE3 and NEON has a specialized 3/4 version that
