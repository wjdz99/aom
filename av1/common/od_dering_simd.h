...
#define _mm_cvtsi128(a) ((uint64_t*)&a)->u64[0]
...
int SIMD_FUNC(od_dir_find8)(const od_dering_in *img, int stride, int32_t *var,
  ...
  __m128i t =
      _mm_packs_epi32(_mm_cmpeq_epi32(_mm_set1_epi32(best_cost), dir03),
                      _mm_cmpeq_epi32(_mm_set1_epi32(best_cost), dir47));
  best_dir = __builtin_ctz(_mm_movemask_epi8(_mm_packs_epi16(t, t)));
#else
  /* Compute "mostly vertical" directions. */
