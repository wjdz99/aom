...
void av1_fdct4_new_sse4_1(const __m128i *input, __m128i *output, int8_t cos_bit,
                          const int8_t *stage_range);
void av1_fdct8_new_sse4_1(const __m128i *input, __m128i *output, int8_t cos_bit,
                          const int8_t *stage_range);
...
void av1_idct4_new_sse4_1(const __m128i *input, __m128i *output, int8_t cos_bit,
                          const int8_t *stage_range);
void av1_idct8_new_sse4_1(const __m128i *input, __m128i *output, int8_t cos_bit,
                          const int8_t *stage_range);
