...
void av1_inv_txfm2d_add_64x64_sse4_1(const int32_t *coeff, uint16_t *output,
  ...
  switch (tx_type) {
    case DCT_DCT:
      ...
      row_cfg = &inv_txfm_1d_row_cfg_dct_64;
      col_cfg = &inv_txfm_1d_col_cfg_dct_64;
      load_buffer_64x64_lower_32x32(coeff, in);
      transpose_64x64(in, out);
      idct64x64_sse4_1(out, in, row_cfg->cos_bit[2]);
      round_shift_64x64(in, -shift[0]);
      transpose_64x64(in, out);
      idct64x64_sse4_1(out, in, col_cfg->cos_bit[2]);
