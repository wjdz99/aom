...
void filter_intra_predictor_sse4_1(uint8_t *dst, ptrdiff_t stride,
  ...
  const __m128i f0 = xx_load_128(filter_intra_taps_4x2procunit[mode][0]);
  const __m128i f1 = xx_load_128(filter_intra_taps_4x2procunit[mode][1]);
  const __m128i f2 = xx_load_128(filter_intra_taps_4x2procunit[mode][2]);
  const __m128i f3 = xx_load_128(filter_intra_taps_4x2procunit[mode][3]);
  const __m128i f4 = xx_load_128(filter_intra_taps_4x2procunit[mode][4]);
  const __m128i f5 = xx_load_128(filter_intra_taps_4x2procunit[mode][5]);
  const __m128i f6 = xx_load_128(filter_intra_taps_4x2procunit[mode][6]);
  const __m128i f7 = xx_load_128(filter_intra_taps_4x2procunit[mode][7]);
