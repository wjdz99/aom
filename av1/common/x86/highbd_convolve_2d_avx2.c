  ...
  /* Horizontal filter */
  {
    ...
    for (i = 0; i < im_h; ++i) {
      for (j = 0; j < w; j += 16) {
        ...
        const __m256i res_2 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 4), coeff_23);
        const __m256i res_4 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 8), coeff_45);
        const __m256i res_6 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 12), coeff_67);
        ...
        const __m256i res_1 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 2), coeff_01);
        const __m256i res_3 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 6), coeff_23);
        const __m256i res_5 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 10), coeff_45);
        const __m256i res_7 = _mm256_madd_epi16(_mm256_alignr_epi8(_mm256_permute2x128_si256(data2, data, 0x13), data, 14), coeff_67);
        ...
        res = _mm256_max_epi16(_mm256_min_epi16(res, maxval), _mm256_setzero_si256());
