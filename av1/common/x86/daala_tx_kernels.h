...
static INLINE void OD_KERNEL_FUNC(od_idct8_asym)(OD_REG *r0, OD_REG *r4,
                                                 OD_REG *r2, OD_REG *r6,
                                                 OD_REG *r1, OD_REG *r1h,
                                                 OD_REG *r5, OD_REG *r5h,
                                                 OD_REG *r3, OD_REG *r3h,
                                                 OD_REG *r7, OD_REG *r7h) {
...
static INLINE void OD_KERNEL_FUNC(od_idct16)(OD_REG *s0, OD_REG *s8, OD_REG *s4,
  ...
  OD_KERNEL_FUNC(od_idct8_asym)(s0, s4, s2, s6, s1, &s1h, s5, &s5h, s3, &s3h,
                                s7, &s7h);
  *s8 = OD_ADD(*s8, s7h);
  *s7 = OD_SUB(*s7, *s8);
