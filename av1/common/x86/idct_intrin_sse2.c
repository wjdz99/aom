...
void av1_iht4x4_16_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                            int tx_type) {
  __m128i in[2];
...
void av1_iht8x8_64_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                            int tx_type) {
  __m128i in[8];
  const __m128i zero = _mm_setzero_si128();
...
void av1_iht16x16_256_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                               int tx_type) {
  __m128i in[32];
  __m128i *in0 = &in[0];
  __m128i *in1 = &in[16];
...
void av1_iht8x16_128_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                              int tx_type) {
  __m128i in[16];
...
void av1_iht16x8_128_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                              int tx_type) {
  __m128i in[16];
...
void av1_iht8x4_32_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                            int tx_type) {
  __m128i in[8];
...
void av1_iht4x8_32_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                            int tx_type) {
  __m128i in[8];
...
void av1_iht16x32_512_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                               int tx_type) {
...
void av1_iht32x16_512_add_sse2(const TranLowT *input, uint8_t *dest, int stride,
                               int tx_type) {
