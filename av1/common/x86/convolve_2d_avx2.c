    ...
    /* Horizontal filter */
    {
      ...
      for (i = 0; i < im_h; ++i) {
        for (j = 0; j < w; j += 16) {
          ...
          __m256i res = _mm256_add_epi16(res_a, res_b);
          res =
              _mm256_sra_epi16(_mm256_add_epi16(res, round_const), round_shift);
    ...
    /* Vertical filter */
    {
      ...
      for (i = 0; i < h; ++i) {
        for (j = 0; j < w; j += 16) {
          ...
          const __m256i res_a = _mm256_add_epi32(
              _mm256_add_epi32(res_0, res_1), _mm256_add_epi32(res_2, res_3));
          ...
          const __m256i res_b = _mm256_add_epi32(
              _mm256_add_epi32(res_4, res_5), _mm256_add_epi32(res_6, res_7));

          // Combine V round and 2F-H-V round into a single rounding
          const __m256i res_a_round = _mm256_sra_epi32(
              _mm256_add_epi32(res_a, round_const), round_shift);
          const __m256i res_b_round = _mm256_sra_epi32(
              _mm256_add_epi32(res_b, round_const), round_shift);
