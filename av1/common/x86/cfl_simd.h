...
void subtract_average_4x4_sse2(int16_t *dst, int16_t *src);
void subtract_average_4x8_sse2(int16_t *dst, int16_t *src);
void subtract_average_4x16_sse2(int16_t *dst, int16_t *src);

// SSE2 version is optimal for with == 8, we reuse them in AVX2
void subtract_average_8x4_sse2(int16_t *dst, int16_t *src);
void subtract_average_8x8_sse2(int16_t *dst, int16_t *src);
void subtract_average_8x16_sse2(int16_t *dst, int16_t *src);
void subtract_average_8x32_sse2(int16_t *dst, int16_t *src);
