  ...
  for (int i = 0; i < p_height; i += 8) {
    for (int j = 0; j < p_width; j += 8) {
      ...
      if (ix4 <= -7) {
        ...
        if (beta == 0 && alpha == 0) {
          ...
          for (int k = -7; k < AOMMIN(8, p_height - i); ++k) {
            ...
            __m256i v_refu =
                _mm256_alignr_epi8(v_ref, v_refl, 2);  // R0R15R14...R2R1

            __m256i v_ref11 = _mm256_unpacklo_epi16(v_refl, v_refu);
            __m256i v_ref12 = _mm256_unpackhi_epi16(v_refl, v_refu);

            __m256i v_ref1 = _mm256_permute2f128_si256(
                v_ref11, v_ref12, 0x20);  // R8R7R7R6R6....R1R1R0
            __m256i v_ref2 = _mm256_permute2f128_si256(
                v_ref11, v_ref12, 0x31);  // R0R15R15....R9R9R8
            ...
            __m256i v_refa = _mm256_inserti128_si256(
                _mm256_set1_epi32(0), _mm256_extracti128_si256(v_ref1, 0), 0);
            v_refa = _mm256_inserti128_si256(
                v_refa, _mm256_extracti128_si256(v_ref1, 1),
                1);  // R12R11R11...R8R4R3..R0

            __m256i v_refb = _mm256_inserti128_si256(
                _mm256_set1_epi32(0), _mm256_extracti128_si256(v_ref1, 1), 0);
            v_refb = _mm256_inserti128_si256(
                v_refb, _mm256_extracti128_si256(v_ref2, 0),
                1);  // R12R11R11...R8R8R7..R4
            ...
            __m256i v_refc = _mm256_inserti128_si256(
                _mm256_set1_epi32(0), _mm256_extracti128_si256(v_ref1, 1), 0);
            v_refc = _mm256_inserti128_si256(
                v_refc, _mm256_extracti128_si256(v_ref2, 0),
                1);  // R15R14R14.R12R8..R5R5R4
          ...
          __m256i v_coeff02 = _mm256_permute2f128_si256(
              v_c02, v_c13, 0x20);  // C7C6A7A6C5C4A5A4C3C2A3A2C1C0A1A0
          __m256i v_coeff13 = _mm256_permute2f128_si256(
              v_c02, v_c13, 0x31);  // D7D6B7B6D5D4B5B4D3D2B3B2D1D0B1B0
          __m256i v_coeff46 = _mm256_permute2f128_si256(
              v_c46, v_c57, 0x20);  // G7G6E7E6G5G4E5E4G3G2E3E2G1G0E1E0
          __m256i v_coeff57 = _mm256_permute2f128_si256(
              v_c46, v_c57, 0x31);  // H7H6F7F6H5H4F5F4H3H2F3F2H1H0F1F0
          ...
          __m256i v_c01 = _mm256_permute2f128_si256(
              v_coeff0123, v_coeff4567,
              0x20);  // H1H0G1G0F1F0E1E0D1D0C1C0B1B0A1A0
          __m256i v_c23 = _mm256_permute2f128_si256(v_coeff0123u, v_coeff4567u,
                                                    0x20);  // H3H2 ... A3A2
          __m256i v_c45 = _mm256_permute2f128_si256(v_coeff0123, v_coeff4567,
                                                    0x31);  // H5H4...A5A4
          __m256i v_c67 = _mm256_permute2f128_si256(v_coeff0123u, v_coeff4567u,
                                                    0x31);  // H7H6 ... A7A6
          ...
          for (int k = -7; k < AOMMIN(8, p_height - i); ++k) {
            ...
            __m256i v_c01 = _mm256_permute2f128_si256(
                v_coeff0123, v_coeff4567,
                0x20);  // H1H0G1G0F1F0E1E0D1D0C1C0B1B0A1A0
            __m256i v_c23 = _mm256_permute2f128_si256(
                v_coeff0123u, v_coeff4567u, 0x20);  // H3H2 ... A3A2
            __m256i v_c45 = _mm256_permute2f128_si256(v_coeff0123, v_coeff4567,
                                                      0x31);  // H5H4...A5A4
            __m256i v_c67 = _mm256_permute2f128_si256(
                v_coeff0123u, v_coeff4567u, 0x31);  // H7H6 ... A7A6
      ...
      for (int k = -4; k < AOMMIN(4, p_height - i - 4); ++k) {
        ...
        __m256i v_c02 = _mm256_unpacklo_epi32(
            v_coeff01, v_coeff23);  // D3D2B3B2D1D0B1B0C3C2A3A2C1C0A1A0
        __m256i v_c13 = _mm256_unpackhi_epi32(
            v_coeff01, v_coeff23);  // D7D6B7B6D5D4B5B4C7C6A7A6C5C4A5A4
        __m256i v_c46 = _mm256_unpacklo_epi32(
            v_coeff45, v_coeff67);  // H3H2F3F2H1H0F1F0G3G2E3E2G1G0E1E0
        __m256i v_c57 = _mm256_unpackhi_epi32(
            v_coeff45, v_coeff67);  // H7H6F7F6H5H4F5F4G7G6E7E6G5G4E5E4
