  ...
  for (int i = 0; i < p_height; i += 8) {
    for (int j = 0; j < p_width; j += 8) {
      ...
      if (ix4 <= -7) {
        ...
        if (beta == 0 && alpha == 0) {
          ...
          __m128i v_01 = _mm_loadu_si128(
              (__m128i *)av1_warped_filter[sx >> WARPEDDIFF_PREC_BITS]); //A7A6A5A4A3A2A1A0
          ...
          for (int k = -7; k < AOMMIN(8, p_height - i); ++k) {
            ...
            __m256i v_refl = _mm256_inserti128_si256(
                        ...
                        v_refl = _mm256_inserti128_si256(v_refl,_mm256_extracti128_si256(v_refu,0),1);
                        v_refu = _mm256_inserti128_si256(v_refu,_mm256_extracti128_si256(v_ref,0),0);

                        __m256i v_sum = _mm256_set1_epi32(ohoriz);
                        __m256i parsum = _mm256_madd_epi16(v_c01, _mm256_alignr_epi8(v_refu, v_refl, 0)); //R8R7R6..R1R7R6R5..R1R0
                        ...
                        parsum = _mm256_madd_epi16(v_c45, _mm256_alignr_epi8(v_refu, v_refl, 8)); //R12R11..R5R11R10..R5R4
                        __m256i v_sum3 = _mm256_add_epi32(v_sum2, parsum);
                        parsum = _mm256_madd_epi16(v_c67, _mm256_alignr_epi8(v_refu, v_refl, 12)); //R14R13..R7R13R12..R7R6
          ...
          __m256i v_coeff01 = _mm256_inserti128_si256(
                      ...
                      __m256i v_c0123 = _mm256_unpacklo_epi32(v_coeff01,
                              ...
                              __m256i v_c23 = _mm256_unpackhi_epi64(
                                  v_c0123, v_c4567);  // H3H2 ... A3A2
                              __m256i v_c45 = _mm256_unpacklo_epi64(
                                  v_c0123u, v_c4567u);  // H5H4 ... A5A4
                              __m256i v_c67 = _mm256_unpackhi_epi64(
                                  v_c0123u, v_c4567u);  // H7H6 ... A7A6
      ...
      for (int k = -4; k < AOMMIN(4, p_height - i - 4); ++k) {
        ...
        __m256i v_src01l = _mm256_unpacklo_epi32(src[0], src[1]); //T13T03T11T01T12T02T10T00
        __m256i v_src01u = _mm256_unpackhi_epi32(src[0], src[1]); //T17T07T15T05T16T06T14T04
        __m256i v_sum = _mm256_madd_epi16(_mm256_packus_epi32(v_src01l, v_src01u), v_c01); //S7S5S3S1S6S4S2S0
