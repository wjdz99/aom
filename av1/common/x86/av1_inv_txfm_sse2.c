...
static inv_txfm_func inv_txfm_func_ls[TX_SIZES_ALL] = {
  ...
  av1_lowbd_inv_txfm2d_add_16x16_sse2,  // 16x16 transform
  av1_lowbd_inv_txfm2d_add_32x32_sse2,  // 32x32 transform
#if CONFIG_TX64X64
  NULL,                                 // 64x64 transform
#endif                                  // CONFIG_TX64X64
  NULL,                                 // 4x8 transform
  NULL,                                 // 8x4 transform
  av1_lowbd_inv_txfm2d_add_8x16_sse2,   // 8x16 transform
  av1_lowbd_inv_txfm2d_add_16x8_sse2,   // 16x8 transform
  av1_lowbd_inv_txfm2d_add_16x32_sse2,  // 16x32 transform
  av1_lowbd_inv_txfm2d_add_32x16_sse2,  // 32x16 transform
#if CONFIG_TX64X64
