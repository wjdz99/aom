...
/* clang-format off */
static const transform_1d_sse2 lowbd_txfm_all_1d_arr[TX_SIZES_LARGEST + 1]
                                                    [TX_TYPES_1D] = {
  { NULL, NULL, NULL, NULL, },
  { idct8_new_sse2, iadst8_new_sse2, iadst8_new_sse2, iidentity8_new_sse2, },
  { idct16_new_sse2, iadst16_new_sse2, iadst16_new_sse2, 
...
void av1_lowbd_inv_txfm2d_add_64x64_sse2(const int32_t *input, uint8_t *output,
  ...
  // Potential optimization to take advatage of zeros outside
