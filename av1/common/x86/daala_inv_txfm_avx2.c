...
static INLINE void od_load_buffer_4x4_epi32(__m128i *q0, __m128i *q1,
 __m128i *q2, __m128i *q3, const tran_low_t *in) {
...
static INLINE void od_load_buffer_4x4_epi16(__m128i *q0, __m128i *q1,
 __m128i *q2, __m128i *q3, const int16_t *in) {
  *q0 = _mm_loadu_si128((const __m128i *)in + 0);
...
/* Loads a 4x8 buffer of 16-bit values into four SSE registers.
   Each register contains two rows of values. */
static INLINE void od_load_buffer_4x8_epi16(__m128i *q0, __m128i *q1,
 __m128i *q2, __m128i *q3, const int16_t *in) {
  *q0 = _mm_loadu_si128((const __m128i *)in + 0);
  *q1 = _mm_loadu_si128((const __m128i *)in + 1);
  *q2 = _mm_loadu_si128((const __m128i *)in + 2);
...
/* Stores a 4x4 buffer of 16-bit values from four SSE registers. */
static INLINE void od_store_buffer_4x4_epi16(int16_t *out, __m128i q0,
 __m128i q1, __m128i q2, __m128i q3) {
  _mm_storeu_si128((__m128i *)out + 0, _mm_unpacklo_epi64(q0, q1));
  _mm_storeu_si128((__m128i *)out + 1, _mm_unpacklo_epi64(q2, q3));
}

/* Stores a 8x4 buffer of 16-bit values from four SSE registers. */
static INLINE void od_store_buffer_8x4_epi16(int16_t *out, __m128i q0,
 __m128i q1, __m128i q2, __m128i q3) {
...
static INLINE void od_add_store_buffer_hbd_4x4_epi16(void *output_pixels,
 int output_stride, __m128i q0, __m128i q1, __m128i q2, __m128i q3, int bd) {
...
static INLINE void od_transpose4x4_impl(__m128i *q0, __m128i *q1, __m128i *q2,
 __m128i *q3, __m128i a, __m128i b) {
  /* Input:
...
static INLINE void od_transpose_pack4x4(__m128i *q0, __m128i *q1, __m128i *q2,
  ...
  */
  ...
  od_transpose4x4_impl(q0, q1, q2, q3, c, d);
}
...
static INLINE void od_transpose4x4(__m128i *q0, __m128i *q1, __m128i *q2,
  ...
  */
  ...
  od_transpose4x4_impl(q0, q1, q2, q3, a, b);
}

static INLINE void od_transpose4x8_impl(__m128i *q0, __m128i *q1, __m128i *q2,
 __m128i *q3, __m128i a, __m128i b, __m128i c, __m128i d) {
  __m128i p;
  __m128i q;
  __m128i r;
  __m128i s;
  ...
  /* Input:
     a: q32 q22 q12 q02 q30 q20 q10 q00
     b: q33 q23 q13 q03 q31 q21 q11 q01
     c: q36 q26 q16 q06 q34 q24 q14 q04
     d: q37 q27 q17 q07 q35 q25 q15 q05 */
  /* p: q31 q30 q21 q20 q11 q10 q01 q00 */
  p = _mm_unpacklo_epi16(a, b);
  /* q: q33 q32 q23 q22 q13 q12 q03 q02 */
  q = _mm_unpackhi_epi16(a, b);
  /* r: q35 q34 q25 q24 q15 q14 q05 q04 */
  r = _mm_unpacklo_epi16(c, d);
  /* s: q37 q36 q27 q26 q17 q16 q07 q06 */
  s = _mm_unpackhi_epi16(c, d);
  /* w: q13 q12 q11 q10 q03 q02 q01 q00 */
  w = _mm_unpacklo_epi32(p, q);
  /* x: q33 q32 q31 q30 q23 q22 q21 q20 */
  x = _mm_unpackhi_epi32(p, q);
  /* y: q17 q16 q15 q14 q07 q06 q05 q04 */
  y = _mm_unpacklo_epi32(r, s);
  /* z: q37 q36 q35 q34 q27 q26 q25 q24 */
  z = _mm_unpackhi_epi32(r, s);
  /* q0: q07 q06 q05 q04 q03 q02 q01 q00 */
  *q0 = _mm_unpacklo_epi64(w, y);
  /* q1: q17 q16 q15 q14 q13 q12 q11 q10 */
  *q1 = _mm_unpackhi_epi64(w, y);
  /* q2: q27 q26 q25 q24 q23 q22 q21 q20 */
  *q2 = _mm_unpacklo_epi64(x, z);
  /* q3: q37 q36 q35 q34 q33 q32 q31 q30 */
  *q3 = _mm_unpackhi_epi64(x, z);
}

static INLINE void od_transpose_pack4x8(__m128i *q0, __m128i *q1, __m128i *q2,
 __m128i *q3, __m128i q4, __m128i q5, __m128i q6, __m128i q7) {
  __m128i a;
  __m128i b;
  __m128i c;
  __m128i d;
  ...
  */
  ...
  b = _mm_packs_epi32(*q1, *q3);
  /* c: q36 q26 q16 q06 q34 q24 q14 q04 */
  c = _mm_packs_epi32(q4, q6);
  /* d: q37 q27 q17 q07 q35 q25 q15 q05 */
  d = _mm_packs_epi32(q5, q7);
  od_transpose4x8_impl(q0, q1, q2, q3, a, b, c, d);
}

static INLINE void od_transpose4x8(__m128i *q0, __m128i *q1, __m128i *q2,
 __m128i *q3) {
  __m128i a;
  __m128i b;
  __m128i c;
  ...
  */
  /* a: q32 q22 q12 q02 q30 q20 q10 q00 */
  a = _mm_unpacklo_epi64(*q0, *q1);
  /* b: q33 q23 q13 q03 q31 q21 q11 q01 */
  b = _mm_unpackhi_epi64(*q0, *q1);
  /* c: q36 q26 q16 q06 q34 q24 q14 q04 */
  c = _mm_unpacklo_epi64(*q2, *q3);
  /* d: q37 q27 q17 q07 q35 q25 q15 q05 */
  d = _mm_unpackhi_epi64(*q2, *q3);
  od_transpose4x8_impl(q0, q1, q2, q3, a, b, c, d);
}
...
static INLINE void od_idct4_kernel8_epi16(__m128i *q0, __m128i *q2,
...
static void od_row_idct4_avx2(int16_t *out, int rows, const tran_low_t *in) {
  ...
  if (rows <= 4) {
    ...
    for (r = 0; r < rows; r += 8) {
      ...
      od_idct4_kernel8_epi16(&q0, &q1, &q2, &q3);
      od_store_buffer_8x4_epi16(out + 4*r, q0, q2, q1, q3);
    }
  }
}
...
static void od_col_idct4_add_hbd_avx2(unsigned char *output_pixels,
  ...
  if (cols <= 4) {
    ...
    od_idct4_kernel8_epi16(&q0, &q1, &q2, &q3);
    od_add_store_buffer_hbd_4x4_epi16(output_pixels, output_stride,
                                      q0, q2, q1, q3, bd);
  } else {
    int c;
    for (c = 0; c < cols ; c += 8) {
      od_load_buffer_4x8_epi16(&q0, &q1, &q2, &q3, in + 4*c);
      od_transpose4x8(&q0, &q1, &q2, &q3);
      od_idct4_kernel8_epi16(&q0, &q1, &q2, &q3);
      od_add_store_buffer_hbd_8x4_epi16(output_pixels + c, output_stride,
                                        q0, q2, q1, q3, bd);
    }
  }
}
    ...
    if (row_tx == NULL || col_tx == NULL) {
      ...
      unsigned char *out_check_buf;
      {
        if (txfm_param->is_hbd) {
          ...
          output_pixels16 = CONVERT_TO_SHORTPTR(output_pixels);
          for (r = 0; r < rows; r++) {
            memcpy(out_check_buf16 + r*cols, output_pixels16 + r*output_stride,
          ...
          for (r = 0; r < rows; r++) {
            memcpy(out_check_buf8 + r*cols, output_pixels8 + r*output_stride,
