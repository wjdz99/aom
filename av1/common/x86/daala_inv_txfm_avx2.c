...
static INLINE __m256i od_mm256_avg_epi16(__m256i a, __m256i b) {
  ...
  return _mm256_xor_si256(
      _mm256_avg_epu16(_mm256_xor_si256(a, sign_bit),
      _mm256_xor_si256(b, sign_bit)), sign_bit);
}
...
static INLINE __m256i od_mm256_hrsub_epi16(__m256i a, __m256i b) {
  ...
  return _mm256_xor_si256(
      _mm256_avg_epu16(_mm256_xor_si256(a, sign_bit),
      _mm256_sub_epi16(sign_bit, b)), sign_bit);
}
...
typedef void (*od_tx8_kernel8_epi16)(__m128i *q0, __m128i *q4, __m128i *q2,
                                     __m128i *q6, __m128i *q1, __m128i *q5,
                                     __m128i *q3, __m128i *q7);

typedef void (*od_tx8_mm256_kernel)(__m256i *q0, __m256i *q4, __m256i *q2,
                                    __m256i *q6, __m256i *q1, __m256i *q5,
                                    __m256i *q3, __m256i *q7);
...
static void od_col_tx8_add_hbd_avx2(unsigned char *output_pixels,
  ...
  if (cols <= 4) {
    ...
    kernel8_epi16(&r0, &r1, &r2, &r3, &r4, &r5, &r6, &r7);
    od_add_store_buffer_hbd_8x4_epi16(output_pixels, output_stride, r0,
                                      r4, r2, r6, bd);
    ...
    for (c = 0; c < cols; c += 16) {
      ...
      od_add_store_buffer_hbd_16x4_epi16(output_pixels, output_stride, rr0,
                                         rr4, rr2, rr6, bd);
