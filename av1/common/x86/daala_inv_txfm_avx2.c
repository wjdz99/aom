...
static void od_col_idtx4_add_hbd_avx2(unsigned char *output_pixels,
                                      int output_stride, int cols,
                                      const int16_t *in, int bd) {
...
static const daala_row_itx TX_ROW_MAP[TX_SIZES][TX_TYPES] = {
  // 4-point transforms
  { od_row_idct4_avx2, od_row_idst4_avx2,
    od_row_flip_idst4_avx2, od_row_iidtx4_avx2 },
  // 8-point transforms
  { NULL, NULL, NULL, NULL },
  // 16-point transforms
  { NULL, NULL, NULL, NULL },
...
static const daala_col_itx_add TX_COL_MAP[2][TX_SIZES][TX_TYPES] = {
  ...
  // High bit depth output
  {
      ...
      { od_col_idct4_add_hbd_avx2, od_col_idst4_add_hbd_avx2,
        od_col_flip_idst4_add_hbd_avx2, od_col_idtx4_add_hbd_avx2 },
      // 8-point transforms
      { NULL, NULL, NULL, NULL },
      // 16-point transforms
      { NULL, NULL, NULL, NULL },
