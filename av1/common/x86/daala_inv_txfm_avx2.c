...
/* Loads an 8x4 buffer of 32-bit values into four AVX registers with a stride
   between rows. */
static INLINE void od_load_rows_8x4_epi32(__m256i *r0, __m256i *r1,
...
typedef void (*od_tx32_kernel8_epi16)(__m128i *t0, __m128i *t4, __m128i *t2,
                                      __m128i *t6, __m128i *t1, __m128i *t5,
                                      __m128i *t3, __m128i *t7, __m128i *t8,
                                      __m128i *t9, __m128i *ta, __m128i *tb,
                                      __m128i *tc, __m128i *td, __m128i *te,
                                      __m128i *tf, __m128i *tg, __m128i *th,
                                      __m128i *ti, __m128i *tj, __m128i *tk,
                                      __m128i *tl, __m128i *tm, __m128i *tn,
                                      __m128i *to, __m128i *tp, __m128i *tq,
                                      __m128i *tr, __m128i *ts, __m128i *tt,
                                      __m128i *tu, __m128i *tv);

typedef void (*od_tx32_mm256_kernel)(__m256i *t0, __m256i *t4, __m256i *t2,
                                     __m256i *t6, __m256i *t1, __m256i *t5,
                                     __m256i *t3, __m256i *t7, __m256i *t8,
                                     __m256i *t9, __m256i *ta, __m256i *tb,
                                     __m256i *tc, __m256i *td, __m256i *te,
                                     __m256i *tf, __m256i *tg, __m256i *th,
                                     __m256i *ti, __m256i *tj, __m256i *tk,
                                     __m256i *tl, __m256i *tm, __m256i *tn,
                                     __m256i *to, __m256i *tp, __m256i *tq,
                                     __m256i *tr, __m256i *ts, __m256i *tt,
...
static void od_row_tx32_avx2(int16_t *out, int rows, const tran_low_t *in,
  ...
  for (r = 0; r < rows; r += 8) {
    ...
    kernel8_epi32(&tt0, &tt1, &tt2, &tt3, &tt4, &tt5, &tt6, &tt7, &tt8, &tt9,
                  ...
                  &ttu, &ttv);
    od_transpose_pack8x16_epi32(&tt0, &ttg, &tt8, &tto, &tt4, &ttk, &ttc,
                                &tts, tt2, tti, tta, ttq, tt6, ttm, tte, ttu);
    ...
    od_transpose_pack8x16_epi32(&tt1, &tth, &tt9, &ttp, &tt5, &ttl, &ttd,
                                &ttt, tt3, ttj, ttb, ttr, tt7, ttn, ttf, ttv);
