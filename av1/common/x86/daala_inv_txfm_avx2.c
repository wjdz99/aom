...
static void od_row_idct32_avx2(int16_t *out, int rows, const tran_low_t *in) {
  od_row_tx32_avx2(out, rows, in, od_idct32_kernel8_epi32);
}
...
#if CONFIG_RECT_TX_EXT
                           od_idct32_kernel8_epi16,
#endif
                           od_idct32_kernel16_epi16);
}
...
static const daala_row_itx TX_ROW_MAP[TX_SIZES][TX_TYPES] = {
  ...
  { od_row_idct16_avx2, od_row_idst16_avx2, od_row_flip_idst16_avx2,
    od_row_iidtx16_avx2 },
  // 32-point transforms
  { od_row_idct32_avx2, NULL, NULL, NULL },
#if CONFIG_TX64X64
  // 64-point transforms
  { NULL, NULL, NULL, NULL },
#endif
...
static const daala_col_itx_add TX_COL_MAP[2][TX_SIZES][TX_TYPES] = {
  ...
  // High bit depth output
  {
      ...
      // 32-point transforms
      { od_col_idct32_add_hbd_avx2, NULL, NULL, NULL },
#if CONFIG_TX64X64
      // 64-point transforms
      { NULL, NULL, NULL, NULL },
#endif
