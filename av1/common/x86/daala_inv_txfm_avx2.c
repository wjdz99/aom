...
static INLINE void od_transpose_pack4x8(__m128i *q0, __m128i *q1, __m128i *q2,
  ...
  */
  ...
  d = _mm_packs_epi32(*q2, q7);
  /* w: q31 q30 q21 q20 q11 q10 q01 q00 */
  w = _mm_unpacklo_epi16(a, b);
  /* x: q35 q34 q25 q24 q15 q14 q05 q04 */
  x = _mm_unpackhi_epi16(a, b);
  /* y: q33 q32 q23 q22 q13 q12 q03 q02 */
  y = _mm_unpacklo_epi16(c, d);
  /* z: q37 q36 q27 q26 q17 q16 q07 q06 */
  z = _mm_unpackhi_epi16(c, d);
  /* q0: q07 q06 q05 q04 q03 q02 q01 q00 */
  *q0 = _mm_unpacklo_epi32(w, y);
  /* q1: q17 q16 q15 q14 q13 q12 q11 q10 */
  *q1 = _mm_unpackhi_epi32(w, y);
  /* q2: q27 q26 q25 q24 q23 q22 q21 q20 */
  *q2 = _mm_unpacklo_epi32(x, z);
  /* q3: q37 q36 q35 q34 q33 q32 q31 q30 */
  *q3 = _mm_unpackhi_epi32(x, z);
}
