...
*/
/* clang-format off */
static const int8_t filter_8bit[WARPEDPIXEL_PREC_SHIFTS * 3 + 1][8] = {
...
static const uint8_t even_mask[16] = {
  0, 2, 2, 4, 4, 6, 6, 8, 8, 10, 10, 12, 12, 14, 14, 0
};
static const uint8_t odd_mask[16] = {
  1, 3, 3, 5, 5, 7, 7, 9, 9, 11, 11, 13, 13, 15, 15, 0
};

/* SSSE3 version of the rotzoom/affine warp filter */
void av1_warp_affine_ssse3(int32_t *mat, uint8_t *ref, int width, int height,
    ...
    for (j = 0; j < p_width; j += 8) {
      ...
      for (k = -7; k < AOMMIN(8, p_height - i); ++k) {
        ...
        if (ix4 <= -7) {
          ...
          __m128i tmp_8 = _mm_unpacklo_epi16(tmp_0, tmp_2);
          // Coeffs 0 2 0 2 4 6 4 6 1 3 1 3 5 7 5 7 for pixels 1 3
          __m128i tmp_9 = _mm_unpacklo_epi16(tmp_1, tmp_3);
          // Coeffs 0 2 0 2 4 6 4 6 1 3 1 3 5 7 5 7 for pixels 4 6
          __m128i tmp_10 = _mm_unpacklo_epi16(tmp_4, tmp_6);
          // Coeffs 0 2 0 2 4 6 4 6 1 3 1 3 5 7 5 7 for pixels 5 7
          __m128i tmp_11 = _mm_unpacklo_epi16(tmp_5, tmp_7);

          // Coeffs 0 2 0 2 0 2 0 2 4 6 4 6 4 6 4 6 for pixels 0 2 4 6
          __m128i tmp_12 = _mm_unpacklo_epi32(tmp_8, tmp_10);
          // Coeffs 1 3 1 3 1 3 1 3 5 7 5 7 5 7 5 7 for pixels 0 2 4 6
          __m128i tmp_13 = _mm_unpackhi_epi32(tmp_8, tmp_10);
          // Coeffs 0 2 0 2 0 2 0 2 4 6 4 6 4 6 4 6 for pixels 1 3 5 7
          __m128i tmp_14 = _mm_unpacklo_epi32(tmp_9, tmp_11);
          // Coeffs 1 3 1 3 1 3 1 3 5 7 5 7 5 7 5 7 for pixels 1 3 5 7
          __m128i tmp_15 = _mm_unpackhi_epi32(tmp_9, tmp_11);

          // Coeffs 0 2 for pixels 0 2 4 6 1 3 5 7
          __m128i coeff_02 = _mm_unpacklo_epi64(tmp_12, tmp_14);
          // Coeffs 4 6 for pixels 0 2 4 6 1 3 5 7
          __m128i coeff_46 = _mm_unpackhi_epi64(tmp_12, tmp_14);
          // Coeffs 1 3 for pixels 0 2 4 6 1 3 5 7
          __m128i coeff_13 = _mm_unpacklo_epi64(tmp_13, tmp_15);
          // Coeffs 5 7 for pixels 0 2 4 6 1 3 5 7
          __m128i coeff_57 = _mm_unpackhi_epi64(tmp_13, tmp_15);

          // The pixel order we need for 'src' is:
          // 0 2 2 4 4 6 6 8 1 3 3 5 5 7 7 9
          __m128i src_02 = _mm_unpacklo_epi64(src_even, src_odd);
          __m128i res_02 = _mm_maddubs_epi16(src_02, coeff_02);
          // 4 6 6 8 8 10 10 12 5 7 7 9 9 11 11 13
          __m128i src_46 = _mm_unpacklo_epi64(_mm_srli_si128(src_even, 4),
                                              _mm_srli_si128(src_odd, 4));
          __m128i res_46 = _mm_maddubs_epi16(src_46, coeff_46);
          // 1 3 3 5 5 7 7 9 2 4 4 6 6 8 8 10
          __m128i src_13 =
              _mm_unpacklo_epi64(src_odd, _mm_srli_si128(src_even, 2));
          __m128i res_13 = _mm_maddubs_epi16(src_13, coeff_13);
          // 5 7 7 9 9 11 11 13 6 8 8 10 10 12 12 14
          __m128i src_57 = _mm_unpacklo_epi64(_mm_srli_si128(src_odd, 4),
                                              _mm_srli_si128(src_even, 6));
          __m128i res_57 = _mm_maddubs_epi16(src_57, coeff_57);

          __m128i round_const =
              _mm_set1_epi16((1 << HORSHEAR_REDUCE_PREC_BITS) >> 1);

          __m128i res = _mm_adds_epi16(_mm_adds_epi16(res_02, res_46),
                                       _mm_adds_epi16(res_13, res_57));
          __m128i res_round = _mm_srai_epi16(_mm_adds_epi16(res, round_const),
