...
OD_SIMD_INLINE void od_store_buffer_8x4_epi32(tran_low_t *out, __m128i q0,
                                             __m128i q1, __m128i q2, __m128i q3,
                                             __m128i q4, __m128i q5, __m128i q6,
                                             __m128i q7) {
  _mm_storeu_si128((__m128i *)out + 0, q0);
  _mm_storeu_si128((__m128i *)out + 1, q1);
  _mm_storeu_si128((__m128i *)out + 2, q2);
...
OD_SIMD_INLINE void od_8x4_cvtepi16_epi32(__m128i *q0, __m128i *q1, __m128i *q2,
                                         __m128i *q3, __m128i *extra) {
...
OD_SIMD_INLINE void od_transpose_unpack4x4(__m128i *q0, __m128i *q1, __m128i *q2,
                                          __m128i *q3) {
  const __m128i zero = _mm_setzero_si128();
  __m128i a;
  __m128i b;
