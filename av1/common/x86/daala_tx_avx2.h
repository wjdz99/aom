...
OD_SIMD_INLINE void od_load_buffer_hbd_4x4_epi16(__m128i *q0, __m128i *q1,
                                                 __m128i *q2, __m128i *q3,
                                                 const int16_t *in,
...
/* Loads a 8x4 buffer of 16-bit values, shifts them up to full bit depth, and
   puts them into four SSE registers. */
OD_SIMD_INLINE void od_load_buffer_hbd_8x4_epi16(__m128i *q0, __m128i *q1,
                                                 __m128i *q2, __m128i *q3,
                                                 const int16_t *in,
                                                 int input_stride, int bd) {
  const int upshift = TX_COEFF_DEPTH - bd;
...
/* Stores a 4x4 buffer of 16-bit values from two SSE registers.
   Each register holds two rows of values. */
OD_SIMD_INLINE void od_store_buffer_compact_4x4_epi16(int16_t *out, __m128i q0,
                                                      __m128i q1) {
  _mm_storeu_si128((__m128i *)out + 0, q0);
  _mm_storeu_si128((__m128i *)out + 1, q1);
}
...
OD_SIMD_INLINE void od_store_buffer_8x4_epi16(int16_t *out, int output_stride,
...
/* Stores a 4x8 buffer of 16-bit values from four SSE registers.
   Each register holds two rows of values. */
OD_SIMD_INLINE void od_store_buffer_compact_4x8_epi16(int16_t *out, __m128i q0,
                                              __m128i q1, __m128i q2,
                                              __m128i q3) {
  _mm_storeu_si128((__m128i *)out + 0, q0);
  _mm_storeu_si128((__m128i *)out + 1, q1);
...
OD_SIMD_INLINE void od_store_buffer_4x4_epi32(tran_low_t *out, __m128i q0,
                                              __m128i q1, __m128i q2,
                                              __m128i q3) {
  _mm_storeu_si128((__m128i *)out + 0, q0);
  _mm_storeu_si128((__m128i *)out + 1, q1);
...
/* Stores a 8x4 buffer of 32-bit values from eight SSE registers. */
...
/* Converts four SSE registers of 16-bit values to four AVX registers of 
   32-bit values.*/
OD_SIMD_INLINE void od_4x8_cvtepi16_epi32(__m128i q0, __m128i q1, __m128i q2,
                                          __m128i q3, __m256i *i32) {
  i32[0] = _mm256_cvtepi16_epi32(q0);
  i32[1] = _mm256_cvtepi16_epi32(q1);
  i32[2] = _mm256_cvtepi16_epi32(q2);
  i32[3] = _mm256_cvtepi16_epi32(q3);
}
...
OD_SIMD_INLINE void od_transpose_compact_out_4x4(__m128i *q0, __m128i q1, __m128i *q2,
                                    __m128i q3) {
  __m128i a;
  __m128i b;
  /* Input:
...
OD_SIMD_INLINE void od_transpose_unpack4x4(__m128i *q0, __m128i *q1,
                                           __m128i *q2, __m128i *q3) {
  ...
  __m128i sign0;
  __m128i sign1;
  od_transpose_compact_out_4x4(q0, *q1, q2, *q3);
  a = *q0;
  b = *q2;
...
OD_SIMD_INLINE void od_transpose_compact_in_4x4(__m128i *q0, __m128i *q1,
                                                __m128i *q2, __m128i *q3) {
  __m128i a;
  __m128i b;
  /* Input:
...
OD_SIMD_INLINE void od_transpose4x8(__m128i *r0, __m128i r1, __m128i *r2,
  ...
  */
  ...
  od_transpose_compact_out_4x4(r0, r1, r2, r3);
  /* r4: r17 r16 15 r14 r07 r06 r05 r04
     r6: r37 r36 35 r34 r27 r26 r25 r24 */
  od_transpose_compact_out_4x4(r4, r5, r6, r7);
  a = *r0;
  b = *r2;
...
OD_SIMD_INLINE void od_transpose_compact_in_4x8(__m128i *q0, __m128i *q1,
                                                __m128i *q2, __m128i *q3) {
  __m128i a;
  __m128i b;
  __m128i c;
...
OD_SIMD_INLINE void od_transpose_compact_out_8x4(__m128i *q0, __m128i *q1, __m128i *q2,
                                    __m128i *q3) {
  __m128i a;
  __m128i b;
  __m128i c;
...
OD_SIMD_INLINE void od_transpose_8x4(__m128i *q0, __m128i *q1,
                                     __m128i *q2, __m128i *q3,
                                     __m128i *q4, __m128i *q5,
                                     __m128i *q6, __m128i *q7) {
  od_transpose_compact_out_8x4(q0, q2, q4, q6);
  /* q0: q31 q21 q11 q01 | q30 q20 q10 q00
     q2: q33 q23 q13 q03 | q32 q22 q12 q02
     q4: q35 q25 q15 q05 | q34 q24 q14 q04
     q6: q37 q27 q17 q07 | q36 q26 q16 q06
  */
  /* q1: ... ... ... ... q13 q12 q11 q10 */
  *q1 = _mm_unpackhi_epi64(*q0, *q0);
  /* q3: ... ... ... ... q33 q32 q31 q30 */
...
OD_SIMD_INLINE void od_transpose_pack4x8(__m128i *q0, __m128i *q1, __m128i *q2,
  ...
  */
  ...
  od_transpose_compact_out_8x4(&a, &b, &c, &d);
  /* q0: q07 q06 q05 q04 q03 q02 q01 q00 */
...
OD_SIMD_INLINE void od_transpose_pack8x4(__m128i *r0, __m128i *r1, __m128i *r2,
  ...
  *r6 = _mm_packs_epi32(*r6, *r7);
  ...
  od_transpose_compact_out_8x4(r0, r2, r4, r6);
  /* We don't care about the contents of the high half of each register. */
