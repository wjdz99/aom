...
int64_t av1_calc_frame_error_avx2(const uint8_t *const ref, int ref_stride,
  ...
  int64_t sum_error_d_0 = (_mm_cvtsi128_si64)(sum_error_q_0);
#if ARCH_X86_64
  int64_t sum_error_d_1 = (uint64_t)_mm_extract_epi64(sum_error_q_0, 1);
#else
  int64_t sum_error_d_1;
  xx_storel_64(&sum_error_d_1, _mm_srli_si128(sum_error_q_0, 8));
#endif
  sum_error = (int64_t)(sum_error + sum_error_d_0 + sum_error_d_1);
