...
static void cfl_luma_subsampling_420_lbd_avx2(const uint8_t *input,
  ...
  do {
    ...
    __m256i top_16x16 = _mm256_maddubs_epi16(top, _mm256_set1_epi8(2));
    __m256i bot_16x16 = _mm256_maddubs_epi16(bot, _mm256_set1_epi8(2));
    __m256i sum_16x16 = _mm256_add_epi16(top_16x16, bot_16x16);

    _mm256_storeu_si256((__m256i *)pred_buf_q3, sum_16x16);
