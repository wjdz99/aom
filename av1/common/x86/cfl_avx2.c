...
static void cfl_luma_subsampling_422_lbd_avx2(const uint8_t *input,
  ...
  do {
    ...
    __m256i bot_16x16 = _mm256_maddubs_epi16(bot, fours);

    _mm256_storeu_si256(row, top_16x16);
    _mm256_storeu_si256(row + CFL_BUF_LINE_I256, bot_16x16);

    input += luma_stride;
  } while ((row += CFL_BUF_LINE_I256) < row_end);
}

CFL_SUBSAMPLE(avx2, 422, lbd, 32, 32)
CFL_SUBSAMPLE(avx2, 422, lbd, 32, 16)
CFL_SUBSAMPLE(avx2, 422, lbd, 32, 8)

cfl_subsample_lbd_fn cfl_get_luma_subsampling_422_lbd_avx2(TX_SIZE tx_size) {
  static const cfl_subsample_lbd_fn subfn_422[TX_SIZES_ALL] = {
    subsample_lbd_422_4x4_ssse3,   /* 4x4 */
    subsample_lbd_422_8x8_ssse3,   /* 8x8 */
    subsample_lbd_422_16x16_ssse3, /* 16x16 */
    subsample_lbd_422_32x32_avx2,  /* 32x32 */
    cfl_subsample_lbd_null,        /* 64x64 (invalid CFL size) */
    subsample_lbd_422_4x8_ssse3,   /* 4x8 */
    subsample_lbd_422_8x4_ssse3,   /* 8x4 */
    subsample_lbd_422_8x16_ssse3,  /* 8x16 */
    subsample_lbd_422_16x8_ssse3,  /* 16x8 */
    subsample_lbd_422_16x32_ssse3, /* 16x32 */
    subsample_lbd_422_32x16_avx2,  /* 32x16 */
    cfl_subsample_lbd_null,        /* 32x64 (invalid CFL size) */
    cfl_subsample_lbd_null,        /* 64x32 (invalid CFL size) */
    subsample_lbd_422_4x16_ssse3,  /* 4x16  */
    subsample_lbd_422_16x4_ssse3,  /* 16x4  */
    subsample_lbd_422_8x32_ssse3,  /* 8x32  */
    subsample_lbd_422_32x8_avx2,   /* 32x8  */
    cfl_subsample_lbd_null,        /* 16x64 (invalid CFL size) */
    cfl_subsample_lbd_null,        /* 64x16 (invalid CFL size) */
  };
...
static void cfl_luma_subsampling_444_lbd_avx2(const uint8_t *input,
  ...
  do {
    ...
    _mm256_storeu_si256(row + 16, row_hi);

    input += luma_stride;
  } while ((row += CFL_BUF_LINE_I256) < row_end);
}

CFL_SUBSAMPLE(avx2, 444, lbd, 32, 32)
CFL_SUBSAMPLE(avx2, 444, lbd, 32, 16)
CFL_SUBSAMPLE(avx2, 444, lbd, 32, 8)

cfl_subsample_lbd_fn cfl_get_luma_subsampling_444_lbd_avx2(TX_SIZE tx_size) {
  static const cfl_subsample_lbd_fn subfn_444[TX_SIZES_ALL] = {
    subsample_lbd_444_4x4_ssse3,   /* 4x4 */
    subsample_lbd_444_8x8_ssse3,   /* 8x8 */
    subsample_lbd_444_16x16_ssse3, /* 16x16 */
    subsample_lbd_444_32x32_avx2,  /* 32x32 */
    cfl_subsample_lbd_null,        /* 64x64 (invalid CFL size) */
    subsample_lbd_444_4x8_ssse3,   /* 4x8 */
    subsample_lbd_444_8x4_ssse3,   /* 8x4 */
    subsample_lbd_444_8x16_ssse3,  /* 8x16 */
    subsample_lbd_444_16x8_ssse3,  /* 16x8 */
    subsample_lbd_444_16x32_ssse3, /* 16x32 */
    subsample_lbd_444_32x16_avx2,  /* 32x16 */
    cfl_subsample_lbd_null,        /* 32x64 (invalid CFL size) */
    cfl_subsample_lbd_null,        /* 64x32 (invalid CFL size) */
    subsample_lbd_444_4x16_ssse3,  /* 4x16  */
    subsample_lbd_444_16x4_ssse3,  /* 16x4  */
    subsample_lbd_444_8x32_ssse3,  /* 8x32  */
    subsample_lbd_444_32x8_avx2,   /* 32x8  */
    cfl_subsample_lbd_null,        /* 16x64 (invalid CFL size) */
    cfl_subsample_lbd_null,        /* 64x16 (invalid CFL size) */
  };
