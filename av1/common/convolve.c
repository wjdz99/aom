...
void av1_convolve_2d_facade(const uint8_t *src, int src_stride, uint8_t *dst,
  ...
  InterpFilterParams filter_params_x =
	  av1_get_interp_filter_params_with_block_size(interp_filter[1 + 2 * conv_params->ref], w);
  InterpFilterParams filter_params_y =
	  av1_get_interp_filter_params_with_block_size(interp_filter[0 + 2 * conv_params->ref], h);
#else
  InterpFilterParams filter_params_x =
...
void av1_highbd_convolve(const uint8_t *src8, int src_stride, uint8_t *dst8,
  ...
  if (ignore_horiz && ignore_vert) {
    ...
    InterpFilterParams filter_params =
#if CONFIG_SHORT_FILTER
		av1_get_interp_filter_params_with_block_size(interp_filter[1 + 2 * ref_idx], w);
#else	
    ...
    InterpFilterParams filter_params =
#if CONFIG_SHORT_FILTER
		av1_get_interp_filter_params_with_block_size(interp_filter[0 + 2 * ref_idx], h);
#else	
