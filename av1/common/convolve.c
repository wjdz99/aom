...
void av1_convolve_2d_facade(const uint8_t *src, int src_stride, uint8_t *dst,
  ...
  av1_get_convolve_filter_params(interp_filters, conv_params->ref, 1,
...
static void convolve_helper(const uint8_t *src, int src_stride, uint8_t *dst,
  ...
  InterpFilterParams filter_params_x, filter_params_y;
  av1_get_convolve_filter_params(interp_filters, conv_params->ref, 0,
                                 &filter_params_x, &filter_params_y);
...
void av1_highbd_convolve(const uint8_t *src8, int src_stride, uint8_t *dst8,
  ...
  InterpFilterParams filter_params_x, filter_params_y;
  av1_get_convolve_filter_params(interp_filters, ref_idx, 0, &filter_params_x,
                                 &filter_params_y);
