...
void od_dering(uint16_t *y, uint16_t *in, int xdec,
  ...
  // TODO(stemidts): We might be good with fewer strengths and different strengths
  // for chroma.  Perhaps reduce CDEF_STRENGTH_BITS to 5 and DERING_STRENGTHS to 8
