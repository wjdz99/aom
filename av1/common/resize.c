...
#define INTERP_SIMPLE_TAPS 2
static const int16_t filter_simple[(1 << SUBPEL_BITS_RS)][INTERP_SIMPLE_TAPS] =
    {
#if SUBPEL_BITS_RS == 5
      { 128, 0 },  { 124, 4 },  { 120, 8 },  { 116, 12 }, { 112, 16 },
      { 108, 20 }, { 104, 24 }, { 100, 28 }, { 96, 32 },  { 92, 36 },
      { 88, 40 },  { 84, 44 },  { 80, 48 },  { 76, 52 },  { 72, 56 },
      { 68, 60 },  { 64, 64 },  { 60, 68 },  { 56, 72 },  { 52, 76 },
      { 48, 80 },  { 44, 84 },  { 40, 88 },  { 36, 92 },  { 32, 96 },
      { 28, 100 }, { 24, 104 }, { 20, 108 }, { 16, 112 }, { 12, 116 },
      { 8, 120 },  { 4, 124 },
#elif SUBPEL_BITS_RS == 6
      { 128, 0 },  { 126, 2 },  { 124, 4 },  { 122, 6 },  { 120, 8 },
      { 118, 10 }, { 116, 12 }, { 114, 14 }, { 112, 16 }, { 110, 18 },
      { 108, 20 }, { 106, 22 }, { 104, 24 }, { 102, 26 }, { 100, 28 },
      { 98, 30 },  { 96, 32 },  { 94, 34 },  { 92, 36 },  { 90, 38 },
      { 88, 40 },  { 86, 42 },  { 84, 44 },  { 82, 46 },  { 80, 48 },
      { 78, 50 },  { 76, 52 },  { 74, 54 },  { 72, 56 },  { 70, 58 },
      { 68, 60 },  { 66, 62 },  { 64, 64 },  { 62, 66 },  { 60, 68 },
      { 58, 70 },  { 56, 72 },  { 54, 74 },  { 52, 76 },  { 50, 78 },
      { 48, 80 },  { 46, 82 },  { 44, 84 },  { 42, 86 },  { 40, 88 },
      { 38, 90 },  { 36, 92 },  { 34, 94 },  { 32, 96 },  { 30, 98 },
      { 28, 100 }, { 26, 102 }, { 24, 104 }, { 22, 106 }, { 20, 108 },
      { 18, 110 }, { 16, 112 }, { 14, 114 }, { 12, 116 }, { 10, 118 },
