...
YV12_BUFFER_CONFIG *av1_realloc_and_scale_if_required(
  ...
  if (scaling_required) {
    ...
    const bool has_optimized_scaler =
        (scaled_width * 4 == unscaled->y_crop_width &&
         scaled_height * 4 == unscaled->y_crop_height) ||
        (scaled_width * 2 == unscaled->y_crop_width &&
         scaled_height * 2 == unscaled->y_crop_height) ||
        (scaled_width * 4 == unscaled->y_crop_width * 3 &&
         scaled_height * 4 == unscaled->y_crop_height * 3);
