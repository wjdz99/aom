...
// denominator.
static void calculate_scaled_size_helper(int *dim, int denom, int nom) {
  if (denom != nom) {
...
void av1_calculate_scaled_size(int *width, int *height, int resize_denom,
                               int resize_nom) {
  calculate_scaled_size_helper(width, resize_denom, resize_nom);
  calculate_scaled_size_helper(height, resize_denom, resize_nom);
}

void av1_calculate_scaled_superres_size(int *width, int *height,
                                        int superres_denom, int superres_nom) {
  calculate_scaled_size_helper(width, superres_denom, superres_nom);
  calculate_scaled_size_helper(height, superres_denom, superres_nom);
}
