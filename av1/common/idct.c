...
void av1_inv_txfm_add(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  switch (tx_size) {
#if CONFIG_TX64X64
    case TX_64X64:
      inv_txfm_add_64x64(input, dest, stride, eob, tx_type);
      break;
#endif  // CONFIG_TX64X64
    case TX_32X32:
      inv_txfm_add_32x32(input, dest, stride, eob, tx_type);
      break;
    case TX_16X16:
      inv_txfm_add_16x16(input, dest, stride, eob, tx_type);
      break;
    case TX_8X8:
      inv_txfm_add_8x8(input, dest, stride, eob, tx_type);
      break;
    case TX_4X8:
    ...
    case TX_8X4:
      ...
      break;
    case TX_8X16:
      inv_txfm_add_8x16(input, dest, stride, eob, tx_type);
      break;
    case TX_16X8:
      inv_txfm_add_16x8(input, dest, stride, eob, tx_type);
      break;
    case TX_16X32:
      inv_txfm_add_16x32(input, dest, stride, eob, tx_type);
      break;
    case TX_32X16:
      inv_txfm_add_32x16(input, dest, stride, eob, tx_type);
      break;
    case TX_4X4:
