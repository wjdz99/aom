...
void av1_iht4x8_32_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  int use_lgt_col =
      get_inv_lgt8(IHT_4x8[tx_type].cols, param, lgtmtx_col, 4);
  int use_lgt_row =
      get_inv_lgt4(IHT_4x8[tx_type].rows, param, lgtmtx_row, 8);
#endif
...
void av1_iht8x4_32_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  const tran_high_t *lgtmtx_row[4];
  int use_lgt_col =
      get_inv_lgt4(IHT_8x4[tx_type].cols, param, lgtmtx_col, 8);
  int use_lgt_row =
      get_inv_lgt8(IHT_8x4[tx_type].rows, param, lgtmtx_row, 4);
#endif
...
void av1_iht4x16_64_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  int use_lgt_row =
      get_inv_lgt4(IHT_4x16[tx_type].rows, param, lgtmtx_row, 16);
#endif
...
void av1_iht16x4_64_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  int use_lgt_col =
      get_inv_lgt4(IHT_16x4[tx_type].cols, param, lgtmtx_col, 16);
#endif
...
void av1_iht8x16_128_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  const tran_high_t *lgtmtx_row[16];
  int use_lgt_row =
      get_inv_lgt8(IHT_8x16[tx_type].rows, param, lgtmtx_row, 16);
#endif
...
void av1_iht16x8_128_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  const tran_high_t *lgtmtx_col[16];
  int use_lgt_col =
      get_inv_lgt8(IHT_16x8[tx_type].cols, param, lgtmtx_col, 16);
#endif
...
void av1_iht8x32_256_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  int use_lgt_row =
      get_inv_lgt8(IHT_8x32[tx_type].rows, param, lgtmtx_row, 32);
#endif
...
void av1_iht32x8_256_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  int use_lgt_col =
      get_inv_lgt4(IHT_32x8[tx_type].cols, param, lgtmtx_col, 32);
#endif
...
#if CONFIG_LGT
  PREDICTION_MODE mode = get_prediction_mode(xd, plane, tx_size, block);
