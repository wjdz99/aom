...
#if CONFIG_MASKED_TX || (CONFIG_RECT_TX && CONFIG_EXT_TX && CONFIG_RECT_TX_EXT)
...
void av1_inv_txfm_add(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  switch (tx_size) {
    ...
    case TX_32X8:
      inv_txfm_add_32x8(input, dest, stride, eob, tx_type); break;
    case TX_8X32:
      inv_txfm_add_8x32(input, dest, stride, eob, tx_type); break;
    case TX_16X4:
      inv_txfm_add_16x4(input, dest, stride, eob, tx_type); break;
    case TX_4X16:
      inv_txfm_add_4x16(input, dest, stride, eob, tx_type); break;
#endif
