...
void av1_highbd_inv_txfm_add_4x4(const tran_low_t *input, uint8_t *dest,
  ...
  switch (tx_type) {
    ...
    case H_FLIPADST:
    case IDTX:
      av1_inv_txfm2d_add_4x4_c(src, CONVERT_TO_SHORTPTR(dest), stride,
                               tx_type, bd);
      break;
#endif  // CONFIG_EXT_TX
    default: assert(0); break;
...
static void highbd_inv_txfm_add_8x8(const tran_low_t *input, uint8_t *dest,
  ...
  switch (tx_type) {
    ...
    case H_FLIPADST:
    case IDTX:
      av1_inv_txfm2d_add_8x8_c(src, CONVERT_TO_SHORTPTR(dest), stride,
                               tx_type, bd);
      break;
#endif  // CONFIG_EXT_TX
    default: assert(0);
...
static void highbd_inv_txfm_add_64x64(const tran_low_t *input, uint8_t *dest,
  ...
  switch (tx_type) {
    case DCT_DCT:
      av1_inv_txfm2d_add_64x64(src, CONVERT_TO_SHORTPTR(dest), stride,
                               DCT_DCT, bd);
      break;
#if CONFIG_EXT_TX
    case ADST_DCT:
