...
static void inv_txfm_add_4x4(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  switch (tx_type) {
    case DCT_DCT:
      av1_idct4x4_add(input, dest, stride, txfm_param);
      break;
    case ADST_DCT:
    case DCT_ADST:
    case ADST_ADST:
...
static void inv_txfm_add_8x8(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  switch (tx_type) {
    case DCT_DCT:
      idct8x8_add(input, dest, stride, txfm_param);
      break;
    case ADST_DCT:
    case DCT_ADST:
    case ADST_ADST:
...
static void inv_txfm_add_16x16(const tran_low_t *input, uint8_t *dest,
  ...
  switch (tx_type) {
    case DCT_DCT:
      idct16x16_add(input, dest, stride, txfm_param);
      break;
    case ADST_DCT:
    case DCT_ADST:
    case ADST_ADST:
...
static void inv_txfm_add_32x32(const tran_low_t *input, uint8_t *dest,
  ...
  switch (tx_type) {
    case DCT_DCT:
      idct32x32_add(input, dest, stride, txfm_param);
      break;
#if CONFIG_EXT_TX
    case ADST_DCT:
    case DCT_ADST:
...
static void inv_txfm_add_64x64(const tran_low_t *input, uint8_t *dest,
  ...
  switch (tx_type) {
    case DCT_DCT:
      idct64x64_add(input, dest, stride, txfm_param);
      break;
#if CONFIG_EXT_TX
    case ADST_DCT:
    case DCT_ADST:
...
#if CONFIG_TX64X64
    case TX_64X64:
      inv_txfm_add_64x64(input, dest, stride, txfm_param);
      break;
#endif  // CONFIG_TX64X64
    case TX_32X32:
      inv_txfm_add_32x32(input, dest, stride, txfm_param);
      break;
    case TX_16X16:
      inv_txfm_add_16x16(input, dest, stride, txfm_param);
      break;
    case TX_8X8:
      inv_txfm_add_8x8(input, dest, stride, txfm_param);
      break;
    case TX_4X8:
      inv_txfm_add_4x8(input, dest, stride, txfm_param);
      break;
    case TX_8X4:
      inv_txfm_add_8x4(input, dest, stride, txfm_param);
      break;
    case TX_8X16:
      inv_txfm_add_8x16(input, dest, stride, txfm_param);
      break;
    case TX_16X8:
      inv_txfm_add_16x8(input, dest, stride, txfm_param);
      break;
    case TX_16X32:
      inv_txfm_add_16x32(input, dest, stride, txfm_param);
      break;
    case TX_32X16:
      inv_txfm_add_32x16(input, dest, stride, txfm_param);
      break;
    case TX_4X4:
...
#if CONFIG_CHROMA_2X2
    case TX_2X2:
      inv_txfm_add_2x2(input, dest, stride, txfm_param);
      break;
#endif
#if CONFIG_EXT_TX && CONFIG_RECT_TX && CONFIG_RECT_TX_EXT
    case TX_32X8:
      inv_txfm_add_32x8(input, dest, stride, txfm_param);
      break;
    case TX_8X32:
      inv_txfm_add_8x32(input, dest, stride, txfm_param);
      break;
    case TX_16X4:
      inv_txfm_add_16x4(input, dest, stride, txfm_param);
      break;
    case TX_4X16:
      inv_txfm_add_4x16(input, dest, stride, txfm_param);
      break;
#endif
