...
/*!\brief Given a spherical motion vector (phi, theta) and a block on the
 * current frame, find the corresponding pixels in the reference frame for each
 * pixel in the given block.
