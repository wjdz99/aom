...
const int32_t *av1_cast_to_int32(const tran_low_t *input);

typedef void(highbd_inv_txfm_add)(const tran_low_t *input, uint8_t *dest,
                                  int stride, const TxfmParam *param);

highbd_inv_txfm_add av1_highbd_inv_txfm_add_4x4_c;
highbd_inv_txfm_add av1_highbd_inv_txfm_add_8x8_c;
highbd_inv_txfm_add av1_highbd_inv_txfm_add_32x32_c;
highbd_inv_txfm_add av1_highbd_inv_txfm_add_16x16_c;
highbd_inv_txfm_add av1_highbd_inv_txfm_add_64x64_c;
