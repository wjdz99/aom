...
#define STORE4_CLAMPED                                     \
  BIAS vint16m1_t clamped = __riscv_vmin_vv_i16m1(         \
...
#define STORE4_UNCLAMPED                                  \
  BIAS vuint8mf2_t vdst = __riscv_vncvt_x_x_w_u8mf2(      \
...
#define STORE16_4_UNCLAMPED                                              \
  BIAS vuint16m1_t vdst = __riscv_vreinterpret_v_i16m1_u16m1(unclamped); \
  STORE16_4
