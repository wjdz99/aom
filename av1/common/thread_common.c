...
static INLINE void loop_filter_block_plane_ver(
    Av1Common *cm, struct MacroblockdPlane planes[MAX_MB_PLANE], int plane,
...
static void loop_filter_rows_mt(Yv12BufferConfig *frame, Av1Common *cm,
...
void av1_loop_filter_frame_mt(Yv12BufferConfig *frame, Av1Common *cm,
                              struct MacroblockdPlane planes[MAX_MB_PLANE],
...
void av1_loop_filter_alloc(AV1LfSync *lf_sync, Av1Common *cm, int rows,
...
void av1_accumulate_frame_counts(FrameCounts *acc_counts, FrameCounts *counts) {
