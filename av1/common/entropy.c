...
#if CONFIG_CB4X4
          av1_copy(fc->coef_head_cdfs[TX_2X2][i][j][k][l], default_coef_head_cdf_4x4[i][j][k][l]);
#endif
          av1_copy(fc->coef_head_cdfs[TX_4X4][i][j][k][l], default_coef_head_cdf_4x4[i][j][k][l]);
          av1_copy(fc->coef_head_cdfs[TX_8X8][i][j][k][l], default_coef_head_cdf_8x8[i][j][k][l]);
          av1_copy(fc->coef_head_cdfs[TX_16X16][i][j][k][l], default_coef_head_cdf_16x16[i][j][k][l]);
          av1_copy(fc->coef_head_cdfs[TX_32X32][i][j][k][l], default_coef_head_cdf_32x32[i][j][k][l]);
#if CONFIG_TX64X64
          av1_copy(fc->coef_head_cdfs[TX_64X64][i][j][k][l], default_coef_head_cdf_64x64[i][j][k][l]);
#endif
        }
}
