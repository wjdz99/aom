...
void av1_reset_cdf_symbol_counters(FRAME_CONTEXT *fc) {
  ...
  RESET_CDF_COUNTER_STRIDE(fc->txfm_partition_cdf[0], TX_PARTITION_TYPES_SQR, CDF_SIZE(TX_PARTITION_TYPES));
  RESET_CDF_COUNTER_STRIDE(fc->txfm_partition_cdf[1], TX_PARTITION_TYPES_RECT, CDF_SIZE(TX_PARTITION_TYPES));
#else
