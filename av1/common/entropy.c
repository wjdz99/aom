...
const aom_cdf_prob av1_cat1_cdf0[CDF_SIZE(2)] = { AOM_ICDF(20352), AOM_ICDF(32768), 0 };
const aom_cdf_prob *av1_cat1_cdf[] = { av1_cat1_cdf0 };

const aom_cdf_prob av1_cat2_cdf0[CDF_SIZE(4)] = { AOM_ICDF(11963), AOM_ICDF(21121), AOM_ICDF(27719), AOM_ICDF(32768),
                                                  0 };
const aom_cdf_prob *av1_cat2_cdf[] = { av1_cat2_cdf0 };
const aom_cdf_prob av1_cat3_cdf0[CDF_SIZE(8)] = {
  AOM_ICDF(7001), AOM_ICDF(12802), AOM_ICDF(17911), AOM_ICDF(22144), AOM_ICDF(25503), AOM_ICDF(28286), AOM_ICDF(30737), AOM_ICDF(32768), 0
};
const aom_cdf_prob *av1_cat3_cdf[] = { av1_cat3_cdf0 };

const aom_cdf_prob av1_cat4_cdf0[CDF_SIZE(16)] = {
  AOM_ICDF(3934),  AOM_ICDF(7460),  AOM_ICDF(10719), AOM_ICDF(13640), AOM_ICDF(16203), AOM_ICDF(18500), AOM_ICDF(20624), AOM_ICDF(22528), AOM_ICDF(24316),
  AOM_ICDF(25919), AOM_ICDF(27401), AOM_ICDF(28729), AOM_ICDF(29894), AOM_ICDF(30938), AOM_ICDF(31903), AOM_ICDF(32768), 0
};
const aom_cdf_prob *av1_cat4_cdf[] = { av1_cat4_cdf0 };

const aom_cdf_prob av1_cat5_cdf0[CDF_SIZE(16)] = {
  AOM_ICDF(2942),  AOM_ICDF(5794),  AOM_ICDF(8473),  AOM_ICDF(11069), AOM_ICDF(13469), AOM_ICDF(15795), AOM_ICDF(17980), AOM_ICDF(20097), AOM_ICDF(21952),
  AOM_ICDF(23750), AOM_ICDF(25439), AOM_ICDF(27076), AOM_ICDF(28589), AOM_ICDF(30056), AOM_ICDF(31434), AOM_ICDF(32768), 0
};
const aom_cdf_prob av1_cat5_cdf1[CDF_SIZE(2)] = { AOM_ICDF(23040), AOM_ICDF(32768), 0 };
const aom_cdf_prob *av1_cat5_cdf[] = { av1_cat5_cdf0, av1_cat5_cdf1 };

const aom_cdf_prob av1_cat6_cdf0[CDF_SIZE(16)] = { AOM_ICDF(2382),  AOM_ICDF(4727),  AOM_ICDF(7036),  AOM_ICDF(9309),
...
const aom_cdf_prob av1_cat6_cdf1[CDF_SIZE(16)] = { AOM_ICDF(9314),  AOM_ICDF(15584), AOM_ICDF(19741), AOM_ICDF(22540),
...
const aom_cdf_prob av1_cat6_cdf2[CDF_SIZE(16)] = { AOM_ICDF(29548), AOM_ICDF(31129), AOM_ICDF(31960), AOM_ICDF(32004),
...
const aom_cdf_prob av1_cat6_cdf3[CDF_SIZE(16)] = { AOM_ICDF(32006), AOM_ICDF(32258), AOM_ICDF(32510), AOM_ICDF(32512),
                                                   AOM_ICDF(32638), AOM_ICDF(32639), AOM_ICDF(32640), AOM_ICDF(32640),
                                                   AOM_ICDF(32761), AOM_ICDF(32762), AOM_ICDF(32763), AOM_ICDF(32764),
                                                   AOM_ICDF(32765), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768) };
const aom_cdf_prob av1_cat6_cdf4[CDF_SIZE(4)] = { AOM_ICDF(32513), AOM_ICDF(32641), AOM_ICDF(32767), AOM_ICDF(32768) };
