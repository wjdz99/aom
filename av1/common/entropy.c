...
#if !CONFIG_Q_ADAPT_PROBS
static const av1_coeff_probs_model default_coef_probs[TX_SIZES][PLANE_TYPES] = {
#if CONFIG_CHROMA_2X2
  { { { { { 98, 34, 156 },
          { 93, 45, 142 },
          { 26, 34, 75 },
  ...
  { { { { { 75, 20, 93 },
      ...
      { { { 158, 19, 174 },
        ...
        { { 48, 249, 245 },
          ...
          { 1, 28, 79 },
          { 1, 28, 16 } } } },
    { // FIXME: UV plane needs to be tuned for cases when TX_64X64 is available.
      // e.g. When using YUV 4:4:4, or when ext-partition is on.
      {   // Intra
        { // Band 0
          { 181, 21, 201 },
          { 61, 37, 123 },
...
#endif  // CONFIG_TX64X64
#else
  av1_copy(cm->fc->coef_probs, default_coef_probs);
