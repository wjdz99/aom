...
const aom_cdf_prob av1_pareto8_tail_probs[COEFF_PROB_MODELS][MODEL_NODES + 1] =
    { { 128, 127, 127, 252, 497, 969, 1839, 3318, 25511 },
      ...
      { 3036, 2724, 2446, 4180, 6170, 6981, 5056, 1871, 304 },
      { 3161, 2823, 2523, 4284, 6247, 6919, 4842, 1708, 261 },
      ...
      { 4776, 4007, 3373, 5262, 6571, 5590, 2610, 536, 43 },
      ...
      { 7463, 5604, 4246, 5742, 5582, 3187, 851, 89, 4 },
      { 7583, 5666, 4272, 5739, 5518, 3097, 808, 82, 3 },
      ...
      { 8546, 6120, 4434, 5655, 4981, 2449, 537, 45, 1 },
      ...
      { 9145, 6372, 4502, 5558, 4637, 2105, 417, 31, 1 },
      ...
      { 11042, 7029, 4572, 5081, 3576, 1271, 186, 10, 1 },
      { 11160, 7062, 4570, 5045, 3513, 1231, 177, 9, 1 },
      { 11277, 7095, 4566, 5009, 3451, 1192, 168, 9, 1 },
      { 11395, 7127, 4562, 4972, 3390, 1153, 160, 8, 1 },
      { 11512, 7158, 4558, 4934, 3329, 1116, 152, 8, 1 },
      { 11629, 7188, 4553, 4896, 3269, 1080, 145, 7, 1 },
      { 11747, 7217, 4546, 4857, 3210, 1045, 138, 7, 1 },
      { 11864, 7245, 4540, 4818, 3151, 1012, 131, 6, 1 },
      { 11981, 7273, 4533, 4778, 3093, 979, 124, 6, 1 },
      { 12098, 7300, 4525, 4738, 3035, 947, 118, 6, 1 },
      { 12215, 7326, 4516, 4698, 2978, 916, 113, 5, 1 },
      { 12332, 7350, 4507, 4658, 2922, 886, 107, 5, 1 },
      { 12448, 7375, 4497, 4617, 2866, 857, 102, 5, 1 },
      { 12565, 7398, 4487, 4575, 2812, 829, 97, 4, 1 },
      { 12681, 7421, 4476, 4534, 2757, 802, 92, 4, 1 },
      { 12798, 7442, 4464, 4492, 2704, 775, 88, 4, 1 },
      { 12914, 7464, 4452, 4450, 2651, 749, 84, 3, 1 },
      { 13030, 7484, 4439, 4408, 2599, 725, 79, 3, 1 },
      { 13146, 7503, 4426, 4365, 2548, 700, 76, 3, 1 },
      { 13263, 7521, 4412, 4322, 2497, 677, 72, 3, 1 },
      { 13379, 7539, 4398, 4280, 2446, 654, 68, 3, 1 },
      { 13494, 7556, 4383, 4237, 2397, 632, 65, 3, 1 },
      { 13610, 7573, 4368, 4193, 2348, 611, 62, 2, 1 },
      { 13726, 7588, 4352, 4150, 2300, 590, 59, 2, 1 },
      { 13842, 7602, 4335, 4106, 2253, 571, 56, 2, 1 },
      { 13957, 7616, 4318, 4063, 2207, 551, 53, 2, 1 },
      { 14073, 7629, 4301, 4019, 2160, 532, 51, 2, 1 },
      { 14188, 7641, 4283, 3976, 2115, 514, 48, 2, 1 },
      { 14303, 7652, 4264, 3932, 2071, 497, 46, 2, 1 },
      { 14419, 7662, 4246, 3888, 2027, 480, 44, 1, 1 },
      { 14534, 7673, 4227, 3844, 1983, 463, 42, 1, 1 },
      { 14649, 7682, 4207, 3800, 1941, 447, 40, 1, 1 },
      { 14764, 7690, 4187, 3756, 1899, 432, 38, 1, 1 },
      { 14879, 7697, 4166, 3713, 1858, 417, 36, 1, 1 },
      { 14994, 7704, 4146, 3669, 1817, 402, 34, 1, 1 },
      { 15109, 7711, 4124, 3625, 1777, 388, 32, 1, 1 },
      { 15223, 7715, 4103, 3581, 1738, 375, 31, 1, 1 },
      { 15338, 7720, 4080, 3538, 1699, 362, 29, 1, 1 },
      { 15452, 7724, 4058, 3494, 1661, 349, 28, 1, 1 },
      { 15567, 7727, 4035, 3450, 1624, 337, 26, 1, 1 },
      { 15681, 7729, 4012, 3407, 1587, 325, 25, 1, 1 },
      { 15796, 7730, 3988, 3364, 1551, 313, 24, 1, 1 },
      { 15910, 7731, 3964, 3320, 1516, 302, 23, 1, 1 },
      { 16024, 7731, 3940, 3277, 1481, 291, 22, 1, 1 },
      { 16139, 7730, 3915, 3234, 1446, 281, 21, 1, 1 },
      { 16253, 7728, 3890, 3191, 1413, 271, 20, 1, 1 },
      { 16367, 7726, 3865, 3148, 1380, 261, 19, 1, 1 },
      { 16481, 7722, 3840, 3106, 1347, 252, 18, 1, 1 },
      { 16595, 7719, 3814, 3063, 1315, 243, 17, 1, 1 },
      { 16709, 7714, 3788, 3021, 1284, 234, 16, 1, 1 },
      { 16822, 7710, 3762, 2979, 1253, 225, 15, 1, 1 },
      { 16936, 7704, 3735, 2937, 1223, 217, 14, 1, 1 },
      { 17050, 7697, 3708, 2895, 1193, 209, 14, 1, 1 },
      { 17163, 7689, 3681, 2854, 1164, 202, 13, 1, 1 },
      { 17277, 7681, 3654, 2812, 1136, 194, 12, 1, 1 },
      { 17391, 7672, 3626, 2771, 1107, 187, 12, 1, 1 },
      { 17504, 7663, 3598, 2730, 1080, 180, 11, 1, 1 },
      { 17618, 7652, 3570, 2689, 1053, 173, 11, 1, 1 },
      { 17731, 7641, 3541, 2649, 1027, 167, 10, 1, 1 },
      { 17844, 7630, 3512, 2608, 1001, 161, 10, 1, 1 },
      { 17958, 7618, 3484, 2568, 975, 154, 9, 1, 1 },
      { 18071, 7604, 3455, 2528, 950, 149, 9, 1, 1 },
      { 18184, 7591, 3425, 2489, 926, 143, 8, 1, 1 },
      { 18297, 7576, 3396, 2449, 902, 138, 8, 1, 1 },
      { 18411, 7561, 3366, 2411, 878, 132, 7, 1, 1 },
      { 18524, 7545, 3336, 2372, 855, 127, 7, 1, 1 },
      { 18637, 7528, 3306, 2333, 833, 122, 7, 1, 1 },
      { 18750, 7510, 3276, 2295, 811, 118, 6, 1, 1 },
      { 18863, 7492, 3246, 2257, 789, 113, 6, 1, 1 },
      { 18976, 7473, 3215, 2219, 768, 109, 6, 1, 1 },
      { 19089, 7455, 3184, 2182, 747, 104, 5, 1, 1 },
      { 19202, 7434, 3154, 2144, 727, 100, 5, 1, 1 },
      { 19315, 7413, 3123, 2107, 707, 96, 5, 1, 1 },
      { 19428, 7392, 3091, 2071, 687, 92, 5, 1, 1 },
      { 19541, 7370, 3060, 2034, 668, 89, 4, 1, 1 },
      { 19654, 7347, 3029, 1998, 649, 85, 4, 1, 1 },
      { 19767, 7323, 2997, 1962, 631, 82, 4, 1, 1 },
      { 19880, 7299, 2965, 1927, 613, 78, 4, 1, 1 },
      { 19993, 7273, 2933, 1892, 596, 75, 4, 1, 1 },
      { 20106, 7247, 2902, 1857, 579, 72, 3, 1, 1 },
      { 20219, 7221, 2870, 1822, 562, 69, 3, 1, 1 },
      { 20332, 7194, 2838, 1788, 545, 66, 3, 1, 1 },
      { 20444, 7166, 2806, 1754, 529, 64, 3, 1, 1 },
      { 20557, 7138, 2773, 1720, 514, 61, 3, 1, 1 },
      { 20670, 7109, 2741, 1687, 498, 58, 3, 1, 1 },
      { 20783, 7079, 2709, 1654, 483, 56, 2, 1, 1 },
      { 20896, 7048, 2676, 1621, 469, 54, 2, 1, 1 },
      { 21009, 7017, 2643, 1589, 455, 51, 2, 1, 1 },
      { 21123, 6984, 2610, 1557, 441, 49, 2, 1, 1 },
      { 21236, 6951, 2578, 1525, 427, 47, 2, 1, 1 },
      { 21349, 6918, 2545, 1493, 414, 45, 2, 1, 1 },
      { 21462, 6884, 2512, 1462, 401, 43, 2, 1, 1 },
      { 21575, 6849, 2480, 1431, 388, 41, 2, 1, 1 },
      { 21688, 6814, 2447, 1401, 375, 39, 2, 1, 1 },
      { 21802, 6777, 2414, 1371, 363, 38, 1, 1, 1 },
      { 21915, 6740, 2381, 1341, 352, 36, 1, 1, 1 },
      { 22029, 6703, 2348, 1311, 340, 34, 1, 1, 1 },
      { 22142, 6664, 2315, 1282, 329, 33, 1, 1, 1 },
      { 22256, 6625, 2282, 1253, 318, 31, 1, 1, 1 },
      { 22369, 6586, 2248, 1225, 307, 30, 1, 1, 1 },
      { 22483, 6545, 2216, 1196, 297, 28, 1, 1, 1 },
      { 22597, 6504, 2183, 1168, 286, 27, 1, 1, 1 },
      { 22711, 6462, 2149, 1141, 276, 26, 1, 1, 1 },
      { 22825, 6419, 2116, 1113, 267, 25, 1, 1, 1 },
      { 22939, 6376, 2083, 1087, 257, 23, 1, 1, 1 },
      { 23053, 6332, 2050, 1060, 248, 22, 1, 1, 1 },
      { 23168, 6286, 2017, 1034, 239, 21, 1, 1, 1 },
      { 23282, 6240, 1984, 1008, 231, 20, 1, 1, 1 },
      { 23397, 6194, 1951, 982, 222, 19, 1, 1, 1 },
      { 23512, 6147, 1917, 957, 214, 18, 1, 1, 1 },
      { 23627, 6099, 1884, 932, 206, 17, 1, 1, 1 },
      { 23742, 6050, 1852, 907, 198, 16, 1, 1, 1 },
      { 23857, 6000, 1819, 883, 190, 16, 1, 1, 1 },
      { 23973, 5950, 1785, 859, 183, 15, 1, 1, 1 },
      { 24089, 5898, 1753, 835, 176, 14, 1, 1, 1 },
      { 24205, 5847, 1720, 811, 169, 13, 1, 1, 1 },
      { 24321, 5794, 1687, 788, 162, 13, 1, 1, 1 },
      { 24437, 5741, 1654, 766, 155, 12, 1, 1, 1 },
      { 24554, 5686, 1622, 743, 149, 11, 1, 1, 1 },
      { 24671, 5630, 1589, 721, 143, 11, 1, 1, 1 },
      { 24788, 5575, 1556, 699, 137, 10, 1, 1, 1 },
      { 24905, 5518, 1523, 678, 131, 10, 1, 1, 1 },
      { 25023, 5460, 1491, 657, 125, 9, 1, 1, 1 },
      { 25141, 5401, 1459, 636, 120, 8, 1, 1, 1 },
      { 25260, 5342, 1426, 615, 114, 8, 1, 1, 1 },
      { 25379, 5281, 1394, 595, 109, 7, 1, 1, 1 },
      { 25498, 5220, 1361, 575, 104, 7, 1, 1, 1 },
      { 25617, 5158, 1329, 555, 99, 7, 1, 1, 1 },
      { 25737, 5095, 1297, 536, 94, 6, 1, 1, 1 },
      { 25858, 5029, 1265, 517, 90, 6, 1, 1, 1 },
      { 25979, 4964, 1233, 499, 85, 5, 1, 1, 1 },
      { 26100, 4898, 1201, 480, 81, 5, 1, 1, 1 },
      { 26222, 4830, 1169, 462, 77, 5, 1, 1, 1 },
      { 26345, 4761, 1138, 444, 73, 4, 1, 1, 1 },
      { 26468, 4691, 1106, 427, 69, 4, 1, 1, 1 },
      { 26592, 4620, 1074, 410, 65, 4, 1, 1, 1 },
      { 26717, 4547, 1042, 393, 62, 4, 1, 1, 1 },
      { 26842, 4475, 1011, 376, 58, 3, 1, 1, 1 },
      { 26968, 4399, 980, 360, 55, 3, 1, 1, 1 },
      { 27095, 4324, 948, 344, 51, 3, 1, 1, 1 },
      { 27223, 4246, 917, 328, 48, 3, 1, 1, 1 },
      { 27352, 4167, 886, 313, 45, 2, 1, 1, 1 },
      { 27481, 4087, 855, 298, 42, 2, 1, 1, 1 },
      { 27613, 4003, 824, 283, 40, 2, 1, 1, 1 },
      { 27745, 3920, 793, 268, 37, 2, 1, 1, 1 },
      { 27878, 3835, 762, 254, 34, 2, 1, 1, 1 },
      { 28013, 3747, 731, 240, 32, 2, 1, 1, 1 },
      { 28150, 3658, 700, 226, 30, 1, 1, 1, 1 },
      { 28288, 3567, 669, 213, 27, 1, 1, 1, 1 },
      { 28429, 3471, 639, 200, 25, 1, 1, 1, 1 },
      { 28571, 3375, 608, 187, 23, 1, 1, 1, 1 },
      { 28716, 3276, 577, 174, 21, 1, 1, 1, 1 },
      { 28863, 3174, 546, 162, 19, 1, 1, 1, 1 },
      { 29013, 3069, 515, 150, 17, 1, 1, 1, 1 },
      { 29167, 2959, 484, 138, 16, 1, 1, 1, 1 },
      { 29324, 2846, 453, 127, 14, 1, 1, 1, 1 },
      { 29486, 2729, 422, 115, 12, 1, 1, 1, 1 },
      { 29653, 2605, 391, 104, 11, 1, 1, 1, 1 },
      { 29826, 2477, 359, 93, 9, 1, 1, 1, 1 },
      { 30006, 2340, 327, 83, 8, 1, 1, 1, 1 },
      { 30196, 2194, 295, 72, 7, 1, 1, 1, 1 },
      { 30397, 2038, 261, 62, 6, 1, 1, 1, 1 },
      { 30615, 1866, 227, 52, 4, 1, 1, 1, 1 },
      { 30856, 1673, 191, 41, 3, 1, 1, 1, 1 },
      { 31134, 1445, 152, 31, 2, 1, 1, 1, 1 },
      { 31489, 1148, 106, 20, 1, 1, 1, 1, 1 } };
...
static const aom_prob av1_default_cbp_probs[TX_SIZES][PLANE_TYPES][REF_TYPES][CBP_CONTEXTS] = {
  { // TX_4x4
    { // Y plane
      { 195, 84, 8, }, //Intra
      { 191, 124, 25, }, //Inter
...
static void build_token_cdfs(const aom_prob *pdf_model,
  ...
  int i, p, phead[6],scaleNZ, scaleEOB_1, scaleEOB_2p, scaleNEOB_1, scaleNEOB_2p, sum = 0;
  int scale_cbp;
  ...
  phead[1+ONE_TOKEN_EOB] = AOMMAX(1,AOMMIN(32767,(p * scaleEOB_1 + (1<<14)) >> 15));
  phead[1+ONE_TOKEN_NEOB] = AOMMAX(1,AOMMIN(32767,(p * scaleNEOB_1 + (1<<14)) >> 15));

  p = AOMMAX(1,AOMMIN(32767,(1<<15) - p - phead[1+ZERO_TOKEN]));

  phead[1+TWO_TOKEN_PLUS_EOB] = AOMMAX(1,AOMMIN(32767,(p * scaleEOB_2p + (1<<14)) >> 15));
  phead[1+TWO_TOKEN_PLUS_NEOB] = AOMMAX(1,AOMMIN(32767,(p * scaleNEOB_2p + (1<<14)) >> 15));
