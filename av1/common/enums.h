...
// Minimum partition size for downsampling residuals
...
#if CONFIG_FLEX_PARTITION
#define PARTITION_BLOCK_SIZES_REC_1to2 5   // 128x64, 64x32, 32x16, 16x8, 8x4
#define PARTITION_BLOCK_SIZES_REC_1to4 3   // 64x16, 32x8, 16x4
#define PARTITION_BLOCK_SIZES_REC_1to8 2   // 64x8, 32x4
#define PARTITION_BLOCK_SIZES_REC_1to16 1  // 64x4
#define PARTITION_BLOCK_SIZES_REC                                    \
  (PARTITION_BLOCK_SIZES_REC_1to2 + PARTITION_BLOCK_SIZES_REC_1to4 + \
   PARTITION_BLOCK_SIZES_REC_1to8 + PARTITION_BLOCK_SIZES_REC_1to16)
#else                                // CONFIG_FLEX_PARTITION
...
#if CONFIG_MODE_DEP_INTER_TX
#define MDTX_LAST_TYPE_INTER FLIPADST_FLIPMDTX_INTER
#endif  // CONFIG_MODE_DEP_INTER_TX
