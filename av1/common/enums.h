...
enum {
  ...
  PARTITION_TYPES_REC = PARTITION_MULTI_WAY_REC + 1,
  PARTITION_INVALID_REC = 255
} UENUM1BYTE(PARTITION_TYPE_REC);

#define PARTITION_BLOCK_SIZES_REC 4  // 128x64, 64x32, 32x16, 16x8
...
#endif  // CONFIG_NEW_INTER_MODES
  COMP_INTER_MODE_END = NEW_NEWMV + 1,
  COMP_INTER_MODE_NUM = COMP_INTER_MODE_END - COMP_INTER_MODE_START,
#if CONFIG_SINGLE_MV_COMPOUND
  // TODO(sarahparker) this is temporary until all uses of COMP_INTER_MODE_NUM
  // are made compatible with SINGLE_MV_COMPOUND
  COMP_SINGLEMV_INTER_MODE_NUM = MB_MODE_COUNT - COMP_INTER_MODE_START,
#endif  // CONFIG_SINGLE_MV_COMPOUND
#if CONFIG_NEW_INTER_MODES
...
#if CONFIG_NEW_INTER_MODES
// drl bits + refmv contexts + inter_mode_contexts
#define DRL_MODE_CONTEXTS 3 + 6 + 8
#else
