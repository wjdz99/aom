...
#define TOTAL_SINGLE_MV_MODES (NEWMV - NEARESTMV + 1)  // 4

// NEAREST_NEARESTMV, NEAR_NEARMV, NEAREST_NEWMV, NEW_NEARESTMV, NEWAR_NEWMV,
// NEW_NEARMV, GLOBAL_GLOBALMV, NEW_NEWMV
#define TOTAL_COMP_MV_MODES (NEW_NEWMV - NEAREST_NEARESTMV + 1)  // 8
