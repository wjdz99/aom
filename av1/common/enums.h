...
#define FIRST_MODE_COUNT 5
#define SECOND_MODE_COUNT 8
#define THIRD_MODE_COUNT 16
#define Y_MODE_CONTEXTS 3
#define UV_MODE_CONTEXTS 2
#define INTRA_MODE_SETS 5
#define INTRA_MODE_SETS_CHROMA 2
#define NON_DIRECTIONAL_MODES_COUNT 5
#define CHROMA_MODE_COUNT 62
