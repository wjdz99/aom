...
OD_EXTERN const unsigned char OD_ZIGZAG8_DCT_DCT[48][2] = {
  { 4, 0 }, { 5, 0 }, { 4, 1 }, { 6, 0 }, { 5, 1 }, { 7, 0 }, { 6, 1 },
  { 7, 1 }, { 0, 4 }, { 0, 5 }, { 1, 4 }, { 0, 6 }, { 1, 5 }, { 0, 7 },
  { 1, 6 }, { 1, 7 }, { 2, 4 }, { 4, 2 }, { 2, 5 }, { 3, 4 }, { 4, 3 },
  { 5, 2 }, { 3, 5 }, { 2, 6 }, { 4, 4 }, { 5, 3 }, { 2, 7 }, { 6, 2 },
  { 3, 6 }, { 4, 5 }, { 7, 2 }, { 5, 4 }, { 6, 3 }, { 3, 7 }, { 5, 5 },
  { 7, 3 }, { 4, 6 }, { 6, 4 }, { 4, 7 }, { 5, 6 }, { 7, 4 }, { 6, 5 },
