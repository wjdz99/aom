...
typedef struct SequenceHeader {
  ...
  uint8_t enable_intra_edge_filter;  // enables/disables corner/edge/upsampling
  ...
  uint8_t enable_warped_motion;      // 0 - disable warped motion for sequence
                                     // 1 - enable it for the sequence
  uint8_t enable_superres;           // 0 - Disable superres for the sequence
                                     //     and not frame level superres flag
