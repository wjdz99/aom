...
typedef struct {
  ...
  // - Total 'n' of the variables / array elements above have value 'k' (that is,
...
// Modify 'idx_ptr' to reference the buffer at 'new_idx', and update the ref counts accordingly.
static INLINE void assign_frame_buffer(RefCntBuffer *bufs, int *idx_ptr, int new_idx) {
