...
static INLINE int get_mi_grid_idx(const AV1_COMMON *cm, int mi_row, int mi_col) {
  return mi_row * cm->mi_stride + mi_col;
}

static INLINE int get_alloc_mi_idx(const AV1_COMMON *cm, int mi_row, int mi_col) {
