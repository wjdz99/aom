...
static const TX_PARTITION_RATIO partition_ratio_bits[2][TX_PARTITION_TYPES] = {
  ...
  // Rectangular
  {
      ...
      { { 1, 1 }, { 0, 0 }, 2 },  // TX_PARTITION_HORZ // TODO(sarahparker) how to differentiate from split partition for rectangular
  },
};
...
//if (partition == TX_PARTITION_HORZ && max_tx_size == TX_32X16)
//  printf("debug\n");
