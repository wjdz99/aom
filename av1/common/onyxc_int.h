...
// Note: All syntax elements of sequence_header_obu that need to be bit-exact
// across multiple sequence headers must be part of this struct, so that
// consistency is checked by are_seq_headers_consistent() function.
