...
static INLINE int frame_might_allow_ref_frame_mvs(const AV1_COMMON *cm) {
  return !cm->error_resilient_mode && cm->seq_params.order_hint.enable_ref_frame_mvs &&
...
static INLINE int av1_num_planes_from_seq(const SequenceHeader *const seq_params) {
