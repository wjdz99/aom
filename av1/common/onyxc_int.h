...
#if 0
  int is_dr_count[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS][2];
  int dr_mode_count[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS][DIRECTIONAL_MODES];
  int none_dr_mode_count[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS][NONE_DIRECTIONAL_MODES];
#endif
} AV1_COMMON;
...
static INLINE aom_cdf_prob *get_kf_none_dr_mode_cdf(FRAME_CONTEXT *tile_ctx,
                                                    const MB_MODE_INFO *above_mi,
                                                    const MB_MODE_INFO *left_mi) {
  const PREDICTION_MODE above = av1_above_block_mode(above_mi);
  const PREDICTION_MODE left = av1_left_block_mode(left_mi);
