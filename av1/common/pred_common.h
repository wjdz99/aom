...
static INLINE vpx_prob av1_get_skip_prob(const AV1_COMMON *cm,
...
static INLINE vpx_prob av1_get_intra_inter_prob(const AV1_COMMON *cm,
                                                 const MACROBLOCKD *xd) {
...
static INLINE vpx_prob av1_get_reference_mode_prob(const AV1_COMMON *cm,
                                                    const MACROBLOCKD *xd) {
...
static INLINE vpx_prob av1_get_pred_prob_comp_ref_p(const AV1_COMMON *cm,
                                                     const MACROBLOCKD *xd) {
...
static INLINE vpx_prob av1_get_pred_prob_single_ref_p1(const AV1_COMMON *cm,
                                                        const MACROBLOCKD *xd) {
...
static INLINE vpx_prob av1_get_pred_prob_single_ref_p2(const AV1_COMMON *cm,
                                                        const MACROBLOCKD *xd) {
