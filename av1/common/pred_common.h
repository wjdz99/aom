...
static INLINE int get_comp_index_context(const RefBuffer *const frame_refs,
  ...
  RefCntBuffer *bck_buf = frame_refs[mbmi->ref_frame[0] - LAST_FRAME].buf;
  RefCntBuffer *fwd_buf = frame_refs[mbmi->ref_frame[1] - LAST_FRAME].buf;
  int bck_frame_index = 0, fwd_frame_index = 0;
  int cur_frame_index = cur_frame->order_hint;
