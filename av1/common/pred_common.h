...
static INLINE int get_n_past_unidir_compound_modes_nrs(NewRefFramesData *ref_data) {
  return ref_data->n_past_refs * (ref_data->n_past_refs - 1); 
}

static INLINE int get_n_future_unidir_compound_modes_nrs(NewRefFramesData *ref_data) {
