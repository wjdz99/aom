...
static void motion_field_projection(AV1_COMMON *cm,
  ...
  int cur_rf_index[TOTAL_REFS_PER_FRAME + 1] = { 0 };
  int ref_rf_idx[TOTAL_REFS_PER_FRAME + 1] = { 0 };
  int cur_offset[TOTAL_REFS_PER_FRAME + 1] = { 0 };
  int ref_offset[TOTAL_REFS_PER_FRAME + 1] = { 0 };
  ...
  for (MV_REFERENCE_FRAME rf = LAST_FRAME; rf <= TOTAL_REFS_PER_FRAME; ++rf) {
