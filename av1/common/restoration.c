...
const sgr_params_type sgr_params[SGRPROJ_PARAMS] = {
  // r1, eps1, r2, eps2
  { 2, 25, 1, 11 }, { 2, 35, 1, 12 }, { 2, 49, 1, 13 }, { 2, 60, 1, 15 },
  { 3, 50, 2, 25 }, { 3, 60, 2, 30 }, { 3, 70, 2, 35 }, { 3, 80, 2, 40 },
};
...
static void boxsumr(int32_t *src, int width, int height, int src_stride,
                    int r, int sqr, int32_t *dst, int dst_stride) {
