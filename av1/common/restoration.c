...
static const int override_y_only[RESTORE_TYPES] = { 0, 0, 0, 0, 0 };
...
int av1_alloc_restoration_struct(RestorationInfo *rst_info,
                                 int width, int height) {
  const int ntiles =
      av1_get_rest_ntiles(width, height, NULL, NULL, NULL, NULL);
