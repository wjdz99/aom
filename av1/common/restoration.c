...
int av1_loop_restoration_corners_in_sb(const struct AV1Common *cm, int plane,
  ...
  // Calculate the number of restoration units in this plane (which might be
  // strictly less than rsi->horz_units and rsi->vert_units)
  const int horz_units = av1_lr_count_units(size, plane_w);
  const int vert_units = av1_lr_count_units(size, plane_h);
