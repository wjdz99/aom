...
#if CONFIG_SHARED_LOOP_RESTORATION
    on_rest_unit(limits, tile_rect, unit_idx, priv, tmpbuf, wiener_stats, rlbs);
#else
...
static void foreach_rest_unit_in_tile(const AV1PixelRect *tile_rect,
  ...
  while (y0 < tile_h) {
    ...
    av1_foreach_rest_unit_in_row(
        ...
        hunits_per_tile, vunits_per_tile, plane, priv, tmpbuf, wiener_stats,
