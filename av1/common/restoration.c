...
const int32_t one_by_x[MAX_NELEM] = {
  4096, 2048, 1365, 1024, 819, 683, 585, 512, 455, 410, 372, 341, 315, 293,
  273,  256,  241,  228, 216, 205, 195, 186, 178, 171, 164,
#if MAX_RADIUS > 2
  158, 152,  146,  141,  137,  132, 128, 124, 120, 117, 114, 111, 108, 105,
...
void av1_selfguided_restoration_c(uint8_t *dgd, int width, int height,
  ...
  int dgd32_stride = width + 2 * SGRPROJ_BORDER_HORZ;
  int32_t *dgd32 =
...
void av1_selfguided_restoration_highbd_c(uint16_t *dgd, int width, int height,
  ...
  av1_selfguided_restoration_internal(
      dgd32 + dgd32_stride * SGRPROJ_BORDER_VERT + SGRPROJ_BORDER_HORZ, width,
      height, dgd32_stride, dst, dst_stride, bit_depth, r, eps);
}
