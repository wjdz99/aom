...
#endif  // SIGNAL_MRC_MASK_INTER

#if SIGNAL_MRC_MASK_INTRA
...
#endif  // SIGNAL_MRC_MASK_INTRA

static INLINE int get_mrc_mask(const int16_t *diff, int diff_stride,
                               const uint8_t *pred, int diff_stride,
                               uint8_t *mask, int mask_stride, int width,
