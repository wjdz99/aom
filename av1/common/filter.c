...
DECLARE_ALIGNED(256, static const InterpKernel,
  ...
  // intfilt 0.65
  { 0, 0, 0, 128, 0, 0, 0, 0 },      { 0, 1, -5, 126, 8, -3, 1, 0 },
  { 0, 2, -10, 122, 18, -6, 2, 0 },  { 0, 3, -13, 118, 27, -9, 2, 0 },
  { 0, 4, -16, 112, 37, -12, 3, 0 }, { 0, 4, -18, 104, 48, -14, 4, 0 },
  { 0, 5, -19, 96, 58, -16, 4, 0 },  { 0, 5, -19, 87, 68, -18, 5, 0 },
  { 0, 5, -19, 78, 78, -19, 5, 0 },  { 0, 5, -18, 68, 87, -19, 5, 0 },
  { 0, 4, -16, 58, 96, -19, 5, 0 },  { 0, 4, -14, 48, 104, -18, 4, 0 },
  { 0, 3, -12, 37, 112, -16, 4, 0 }, { 0, 2, -9, 27, 118, -13, 3, 0 },
  { 0, 2, -6, 18, 122, -10, 2, 0 },  { 0, 1, -3, 8, 126, -5, 1, 0 },
};
...
DECLARE_ALIGNED(256, static const InterpKernel,
  ...
  // freqmultiplier = 0.95
  { 0, 0, 0, 128, 0, 0, 0, 0 },    { 0, 0, 0, 121, 8, -1, 0, 0 },
  { 0, 0, -3, 118, 14, -1, 0, 0 }, { 0, 0, -5, 113, 22, -2, 0, 0 },
  { 0, 0, -6, 106, 30, -2, 0, 0 }, { 0, 0, -6, 98, 39, -3, 0, 0 },
  { 0, 0, -6, 89, 49, -4, 0, 0 },  { 0, 0, -6, 79, 59, -4, 0, 0 },
  { 0, 0, -5, 69, 69, -5, 0, 0 },  { 0, 0, -4, 59, 79, -6, 0, 0 },
  { 0, 0, -4, 49, 89, -6, 0, 0 },  { 0, 0, -3, 39, 98, -6, 0, 0 },
  { 0, 0, -2, 30, 106, -6, 0, 0 }, { 0, 0, -2, 22, 113, -5, 0, 0 },
  { 0, 0, -1, 14, 118, -3, 0, 0 }, { 0, 0, -1, 8, 121, 0, 0, 0 },
};
