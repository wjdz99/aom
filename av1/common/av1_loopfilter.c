      ...
      switch (params.filter_length) {
        ...
        case 4:
          aom_lpf_vertical_4(p, dst_stride, params.mblim, params.lim,
                             params.hev_thr);
          if (no_4x4_lf)
            aom_lpf_vertical_4(p + MI_SIZE * dst_stride, dst_stride,
                               params.mblim, params.lim, params.hev_thr);
          break;
        case 6:  // apply 6-tap filter for chroma plane only
          assert(plane != 0);
          aom_lpf_vertical_6(p, dst_stride, params.mblim, params.lim,
                             params.hev_thr);
          if (no_4x4_lf)
            aom_lpf_vertical_6(p + MI_SIZE * dst_stride, dst_stride,
                               params.mblim, params.lim, params.hev_thr);
          break;
        // apply 8-tap filtering
        case 8:
          aom_lpf_vertical_8(p, dst_stride, params.mblim, params.lim,
                             params.hev_thr);
          if (no_4x4_lf)
            aom_lpf_vertical_8(p + MI_SIZE * dst_stride, dst_stride,
                               params.mblim, params.lim, params.hev_thr);
          break;
        // apply 14-tap filtering
        case 14:
