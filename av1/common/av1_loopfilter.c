...
#else
static const FilterMaskY left_txform_mask[TX_SIZES_ALL] = {
  { { 0x0000000000000001ULL,  // TX_4X4,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
  ...
  { { 0x0001000100010001ULL,  // TX_64X64,
      0x0001000100010001ULL, 0x0001000100010001ULL, 0x0001000100010001ULL } },
#endif
  { { 0x0000000000010001ULL,  // TX_4X8,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0000000000000001ULL,  // TX_8X4,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0001000100010001ULL,  // TX_8X16,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0000000000010001ULL,  // TX_16X8,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0001000100010001ULL,  // TX_16X32,
      0x0001000100010001ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0001000100010001ULL,  // TX_32X16,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#if CONFIG_TX64X64
  { { 0x0001000100010001ULL,  // TX_32X64,
      0x0001000100010001ULL, 0x0001000100010001ULL, 0x0001000100010001ULL } },

  { { 0x0001000100010001ULL,  // TX_64X32
      0x0001000100010001ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#endif
  { { 0x0001000100010001ULL,  // TX_4X16,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0000000000000001ULL,  // TX_16X4,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0001000100010001ULL,  // TX_8X32,
      0x0001000100010001ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0000000000010001ULL,  // TX_32X8,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#if CONFIG_TX64X64
  { { 0x0001000100010001ULL,  // TX_16X64,
      0x0001000100010001ULL, 0x0001000100010001ULL, 0x0001000100010001ULL } },

  { { 0x0001000100010001ULL,  // TX_64X16,
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#endif
};

// 64 bit mask to shift and set for each prediction size.
static const FilterMaskY above_txform_mask[TX_SIZES_ALL] = {
  { { 0x0000000000000001ULL,  // TX_4X4
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
  ...
  { { 0x0000000000000003ULL,  // TX_8X4
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0000000000000003ULL,  // TX_8X16
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x000000000000000fULL,  // TX_16X8
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x000000000000000fULL,  // TX_16X32
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x00000000000000ffULL,  // TX_32X16
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#if CONFIG_TX64X64
  { { 0x00000000000000ffULL,  // TX_32X64
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x000000000000ffffULL,  // TX_64X32
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#endif
  { { 0x0000000000000001ULL,  // TX_4X16
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x000000000000000fULL,  // TX_16X4
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x0000000000000003ULL,  // TX_8X32
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x00000000000000ffULL,  // TX_32X8
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#if CONFIG_TX64X64
  { { 0x000000000000000fULL,  // TX_16X64
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },

  { { 0x000000000000ffffULL,  // TX_64X16
      0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL } },
#endif
};
#endif  // #if 1
...
// TODO(luoyi): We intend to obtain left neighbor TU's tx size in case our
// recursive tx_size walk-through still did not access this neighbor yet.
// The logic need to update after this patch:
// https://aomedia-review.googlesource.com/c/aom/+/44722
//
static TX_SIZE get_y_tx_high(const MB_MODE_INFO *const mbmi, int mi_row,
                             int mi_col) {
  TX_SIZE tx_size = mbmi->tx_size;
...
static void setup_masks(AV1_COMMON *const cm, MODE_INFO **mi, TX_SIZE y_tx_size,
                        int idx, int idy, int mi_row, int mi_col, int lflf_h,
                        int lflf_v, LoopFilterMask *lfm) {
  ...
  const BLOCK_SIZE block_size = mi[0]->mbmi.sb_type;
  ...
  if (lflf_v) {
    // Here we may have a case in which left TU is shorted than current TU.
    // According to recursive method, the first left neighbor is always
    // available since it has been processed. Then the following left neighbors
    // are actually not processed yet. The left_tx array has incorrect neighbor
    // tx size. We use this flag to handling this case.
    int left_neighbor_not_available = 0;
    while (acc_h < tx_unit_h) {
      int ntx_unit_h;
      TX_SIZE tx_w, tx_h;
      if (acc_h > 0 && left_neighbor_not_available) {
        MODE_INFO **left_mi = mi - 1;
        ntx = get_y_tx_high(&left_mi[0]->mbmi, mi_row, mi_col);
      } else {
        ntx = left_tx[mi_row_loc];
      }
      ntx_unit_h = tx_size_high_unit[ntx];
      ...
      TX_SIZE choice_h = tx_high;
      int tx_inc = tx_unit_h;
      if (tx_h < tx_high) {
        left_neighbor_not_available = 1;
        choice_h = tx_h;
        tx_inc = ntx_unit_h;
      }
      ...
      // Update MI for left_neighbor_not_available cases
      if (left_neighbor_not_available) {
        mi_row += tx_inc;
        if (mi_row >= cm->mi_rows) break;
        mi += tx_inc * mi_stride;
      }
...
static void setup_mask_from_tx_size(AV1_COMMON *const cm, MODE_INFO **mi,
  ...
  if (tx_wide == max_tx_wide && tx_high == max_tx_high) {
    ...
    setup_masks(cm, mi, tx_size, idx, idy, mi_row, mi_col, lflf_h, lflf_v, lfm);
...
static void process_y_level(AV1_COMMON *const cm, MODE_INFO **mi, int idx,
  ...
  switch (block_size) {
    ...
    case BLOCK_64X128:
      ...
      break;
    default:
      get_y_level_64x64(cm, mi, BLOCK_INVALID, idx, idy, mi_row, mi_col, lfm,
...
static void build_uv_masks(AV1_COMMON *const cm, MODE_INFO **mi, int plane,
  ...
  int wide = tx_size_wide_unit[tx_uv_size];
  int high = tx_size_high_unit[tx_uv_size];
  ...
  // Get the smaller one to build bit mask
  TX_SIZE tx_w = AOMMIN(tx_width, left_tx[mi_row_pos]);
  TX_SIZE tx_h = AOMMIN(tx_height, top_tx[mi_col_pos]);
  ...
  if (plane == 1) {
    left_uv = &lfm->left_u[tx_w];
    above_uv = &lfm->above_u[tx_h];
  } else {
    left_uv = &lfm->left_v[tx_w];
    above_uv = &lfm->above_v[tx_h];
  }
  ...
  if (plane == 1) {
    ...
    if (tx_w == TX_8X8) {
      if (lfm->left_u[TX_4X4] & single_edge) {
        walk_on = 0;
      }
    }
    if (tx_w == TX_4X4) {
      if (lfm->left_u[TX_8X8] & single_edge) {
        walk_on = 0;
      }
    }

    if (walk_on) {
      mask = left_txform_mask_uv[tx_uv_size] & size_mask_uv[block_size];
      mask <<= shift_uv;
      *left_uv |= mask;
    }
    ...
    // mask that is the same as above TX_4X4
    if (tx_h == TX_8X8) {
      if (lfm->above_u[TX_4X4] & single_edge) {
        walk_on = 0;
      }
    }
    if (tx_h == TX_4X4) {
      if (lfm->above_u[TX_8X8] & single_edge) {
        walk_on = 0;
      }
    }

    if (walk_on) {
      mask = above_txform_mask_uv[tx_uv_size] & size_mask_uv[block_size];
      mask <<= shift_uv;
      *above_uv |= mask;
    }
  ...
  if (plane == 2) {
    ...
    // mask that is the same as above TX_4X4
    if (tx_w == TX_8X8) {
      if (lfm->left_v[TX_4X4] & single_edge) {
        walk_on = 0;
      }
    }
    if (tx_w == TX_4X4) {
      if (lfm->left_v[TX_8X8] & single_edge) {
        walk_on = 0;
      }
    }
    ...
    // mask that is the same as above TX_4X4
    if (tx_h == TX_8X8) {
      if (lfm->above_v[TX_4X4] & single_edge) {
        walk_on = 0;
      }
    }
    if (tx_h == TX_4X4) {
      if (lfm->above_v[TX_8X8] & single_edge) {
        walk_on = 0;
      }
    }
