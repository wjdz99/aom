    ...
    for (int x = 0; x < x_range;) {
      ...
      switch (params.filter_length) {
        ...
        case 4:
          aom_lpf_vertical_4(p, dst_stride, params.mblim, params.lim,
                             params.hev_thr);
          aom_lpf_vertical_4(p + MI_SIZE * dst_stride, dst_stride, params.mblim,
        ...
        case 6:  // apply 6-tap filter for chroma plane only
          ...
          aom_lpf_vertical_6(p, dst_stride, params.mblim, params.lim,
                             params.hev_thr);
          aom_lpf_vertical_6(p + MI_SIZE * dst_stride, dst_stride, params.mblim,
                             params.lim, params.hev_thr);
          break;
        // apply 8-tap filtering
        case 8:
          aom_lpf_vertical_8(p, dst_stride, params.mblim, params.lim,
                             params.hev_thr);
          aom_lpf_vertical_8(p + MI_SIZE * dst_stride, dst_stride, params.mblim,
                             params.lim, params.hev_thr);
          break;
        // apply 14-tap filtering
        case 14:
          aom_lpf_vertical_14(p, dst_stride, params.mblim, params.lim,
                              params.hev_thr);
          aom_lpf_vertical_14(p + MI_SIZE * dst_stride, dst_stride,
                              params.mblim, params.lim, params.hev_thr);
          break;
        // no filtering
        default: break;
    ...
    for (int y = 0; y < y_range;) {
      ...
      switch (params.filter_length) {
        ...
        case 4:
          aom_lpf_horizontal_4(p, dst_stride, params.mblim, params.lim,
                               params.hev_thr);
          aom_lpf_horizontal_4(p + MI_SIZE, dst_stride, params.mblim,
                               params.lim, params.hev_thr);
          break;
        // apply 6-tap filtering
        case 6:
          ...
          aom_lpf_horizontal_6(p, dst_stride, params.mblim, params.lim,
                               params.hev_thr);
          aom_lpf_horizontal_6(p + MI_SIZE, dst_stride, params.mblim,
                               params.lim, params.hev_thr);
          break;
        // apply 8-tap filtering
        case 8:
          aom_lpf_horizontal_8(p, dst_stride, params.mblim, params.lim,
                               params.hev_thr);
          aom_lpf_horizontal_8(p + MI_SIZE, dst_stride, params.mblim,
                               params.lim, params.hev_thr);
          break;
        // apply 14-tap filtering
        case 14:
          aom_lpf_horizontal_14(p, dst_stride, params.mblim, params.lim,
                                params.hev_thr);
          aom_lpf_horizontal_14(p + MI_SIZE, dst_stride, params.mblim,
                                params.lim, params.hev_thr);
          break;
        // no filtering
        default: break;
