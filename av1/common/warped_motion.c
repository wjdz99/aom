...
static const int16_t
    filter_ntap[WARPEDPIXEL_PREC_SHIFTS][WARPEDPIXEL_FILTER_TAPS] = {
      ...
      { 0, -2, 127, 4, -1, 0 },    { 1, -3, 126, 6, -2, 0 },
      { 1, -5, 125, 8, -2, 1 },    { 1, -6, 124, 11, -3, 1 },
      { 1, -7, 124, 13, -4, 1 },   { 1, -8, 123, 15, -4, 1 },
      { 1, -8, 122, 17, -5, 1 },   { 2, -9, 120, 20, -6, 1 },
      { 2, -10, 119, 22, -6, 1 },  { 2, -11, 118, 25, -7, 1 },
      { 2, -11, 116, 27, -8, 2 },  { 2, -12, 115, 29, -8, 2 },
      { 2, -13, 114, 32, -9, 2 },  { 2, -13, 112, 34, -9, 2 },
      { 3, -14, 110, 37, -10, 2 }, { 2, -14, 109, 39, -10, 2 },
      { 3, -15, 107, 42, -11, 2 }, { 3, -15, 105, 44, -11, 2 },
      { 3, -15, 103, 47, -12, 2 }, { 3, -16, 101, 50, -12, 2 },
      { 3, -16, 99, 52, -13, 3 },  { 3, -16, 97, 55, -13, 2 },
      { 3, -16, 95, 57, -14, 3 },  { 3, -16, 93, 59, -14, 3 },
      { 3, -16, 91, 62, -15, 3 },  { 3, -16, 88, 65, -15, 3 },
      { 3, -16, 86, 67, -15, 3 },  { 3, -16, 84, 69, -15, 3 },
      { 3, -16, 82, 72, -16, 3 },  { 3, -16, 79, 75, -16, 3 },
      { 3, -16, 77, 77, -16, 3 },  { 3, -16, 75, 79, -16, 3 },
      { 3, -16, 72, 82, -16, 3 },  { 3, -15, 69, 84, -16, 3 },
      { 3, -15, 67, 86, -16, 3 },  { 3, -15, 65, 88, -16, 3 },
      { 3, -15, 62, 91, -16, 3 },  { 3, -14, 59, 93, -16, 3 },
      { 3, -14, 57, 95, -16, 3 },  { 2, -13, 55, 97, -16, 3 },
      { 3, -13, 52, 99, -16, 3 },  { 2, -12, 50, 101, -16, 3 },
      { 2, -12, 47, 103, -15, 3 }, { 2, -11, 44, 105, -15, 3 },
      { 2, -11, 42, 107, -15, 3 }, { 2, -10, 39, 109, -14, 2 },
      { 2, -10, 37, 110, -14, 3 }, { 2, -9, 34, 112, -13, 2 },
      { 2, -9, 32, 114, -13, 2 },  { 2, -8, 29, 115, -12, 2 },
      { 2, -8, 27, 116, -11, 2 },  { 1, -7, 25, 118, -11, 2 },
      { 1, -6, 22, 119, -10, 2 },  { 1, -6, 20, 120, -9, 2 },
      { 1, -5, 17, 122, -8, 1 },   { 1, -4, 15, 123, -8, 1 },
      { 1, -4, 13, 124, -7, 1 },   { 1, -3, 11, 124, -6, 1 },
      { 1, -2, 8, 125, -5, 1 },    { 0, -2, 6, 126, -3, 1 },
      { 0, -1, 4, 127, -2, 0 },    { 0, -1, 2, 128, -1, 0 },
    };
