...
static int16_t resolve_divisor_64(uint64_t D, int16_t *shift) {
  int64_t e, f;
  *shift = (int16_t)((D >> 32) ? get_msb(D >> 32) + 32 : get_msb(D));
...
int get_shear_params(WarpedMotionParams *wm) {
  ...
  wm->gamma =
      (int)clamp(ROUND_POWER_OF_TWO_SIGNED_64(v, shift), INT16_MIN, INT16_MAX);
  v = ((int64_t)mat[3] * mat[4]) * y;
  wm->delta = (int)clamp(mat[5] - ROUND_POWER_OF_TWO_SIGNED_64(v, shift) -
