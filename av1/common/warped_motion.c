...
static int find_affine_int_2ls(const int np, int *pts1, int *pts2, BLOCK_SIZE bsize,
...
static int find_affine_int_3ls(const int np, int *pts1, int *pts2, BLOCK_SIZE bsize,
                               int mvy, int mvx, WarpedMotionParams *wm, int mi_row,
                               int mi_col) {
