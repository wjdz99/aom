...
const int16_t warped_filter[WARPEDPIXEL_PREC_SHIFTS * 3 + 1][8] = {
  // [-1, 0)
  { 0,   0, 127,   1,   0, 0, 0, 0 }, { 0, - 1, 127,   3, - 1, 0, 0, 0 },
  ...
  { 0, - 1,   4, 127, - 3, 1, 0, 0 }, { 0, - 1,   3, 127, - 1, 0, 0, 0 },

  // [0, 1)
  { 0,  0,   0, 127,   1,   0,  0,  0}, { 0,  1,  -2, 127,   3,  -1,  0,  0},
  ...
  { 0,  1,  -2,   4, 127,  -3,  1,  0}, { 0,  0,  -1,   3, 127,  -2,  1,  0},

  // [1, 2)
  { 0, 0, 0,   1, 127,   0,   0, 0 }, { 0, 0, 0, - 1, 127,   3, - 1, 0 },
  ...
  { 0, 0, 0, - 1,   4, 127, - 3, 1 }, { 0, 0, 0, - 1,   3, 127, - 1, 0 },
