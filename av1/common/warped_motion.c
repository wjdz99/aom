...
// intermediate array.
void av1_highbd_warp_affine_c(int32_t *mat, const uint16_t *const ref,
...
static int64_t highbd_warp_error(
  ...
  gm_sumerr = highbd_frame_error(CONVERT_TO_BYTEPTR(tmp), p_width, dst, p_col,
...
*/
void av1_warp_affine_c(int32_t *mat, const uint8_t *const ref, int width,
...
int64_t av1_frame_error(
    ...
    int use_hbd, int bd,
#endif  // CONFIG_HIGHBITDEPTH
    const uint8_t *const ref, int stride, uint8_t *dst, int p_col, int p_row,
    int p_width, int p_height, int p_stride) {
#if CONFIG_HIGHBITDEPTH
  if (use_hbd)
...
void av1_warp_plane(WarpedMotionParams *wm,
                    ...
                    int use_hbd, int bd,
#endif  // CONFIG_HIGHBITDEPTH
                    const uint8_t *const ref, int width, int height, int stride,
