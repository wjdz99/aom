...
#if CONFIG_MRLS
  uint16_t *const above_row = above_data + 16 + MRL_LINE_NUMBER;
  uint16_t *const left_col = left_data + 16 + MRL_LINE_NUMBER;
#else
...
#if CONFIG_MRLS
  uint8_t *const above_row = above_data + 16 + MRL_LINE_NUMBER;
  uint8_t *const left_col = left_data + 16 + MRL_LINE_NUMBER;
#else
