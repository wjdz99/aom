...
void SIMD_FUNC(cdef_filter_block)(uint8_t *dst8, uint16_t *dst16, int dstride,
                                  ...
                                  int coeff_shift) {
  if (dst8)
    if (bsize == BLOCK_8X8) SIMD_FUNC(cdef_filter_block_8x8_8)
  (dst8, dstride, in, pri_strength, sec_strength, dir, pri_damping, sec_damping,
   max, coeff_shift);
  ...
  else SIMD_FUNC(cdef_filter_block_4x4_8)(dst8, dstride, in, pri_strength,
                                          sec_strength, dir, pri_damping,
                                          sec_damping, max, coeff_shift);
  else if (bsize == BLOCK_8X8) SIMD_FUNC(cdef_filter_block_8x8_16)(
