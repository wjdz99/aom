...
//  (1 / (2^8)) * 4 = 1/64.
// 16 bit integers are used, which have 15 fractional bits, so 16 - 8 = 7
...
//  (1 / (2^9)) * 8 = 1/64
// 16 bit integers are used, which have 15 fractional bits, so 16 - 9 = 6
#define WARP_BETA_PARAM_REDUCE_BITS 6
// 6 bits for 1/64'th pel + 3 bits for center offset up to 4 pixels
