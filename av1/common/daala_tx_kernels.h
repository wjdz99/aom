...
/*  Computes the asymmetric +/- subtract and negate butterfly (unscaled output).
...
static INLINE void od_fdct_2(od_coeff *p0, od_coeff *p1) {
  /* M0 = 46341/32768 ~= Sin[Pi/4] + Cos[Pi/4] ~= 1.4142135623730951 */
  /* M1 = 46341/32768 ~= 2*Cos[Pi/4] ~= 1.4142135623730951 */
...
static INLINE void od_idct_2(od_coeff *p0, od_coeff *p1) {
  /* M0 = 11585/8192 ~= Sin[Pi/4] + Cos[Pi/4] ~= 1.4142135623730951 */
  /* M1 = 11585/16384 ~= Cos[Pi/4] ~= 0.7071067811865475 */
...
static INLINE void od_fdst_2_asym(od_coeff *p0, od_coeff p0h,
 od_coeff *p1) {
  ...
  /* M0 = 15137/16384 ~= (Cos[3*Pi/8] + Sin[3*Pi/8])/Sqrt[2] = 0.923879532511 */
  /* M1 = 3135/4096 ~= (Cos[3*Pi/8] - Sin[3*Pi/8])*Sqrt[2] = 0.76536686473018 */
  /* M2 = 8867/16384 ~= Cos[3*Pi/8]*Sqrt[2] = 0.5411961001461971 */
...
static INLINE void od_fdct_4(od_coeff *q0, od_coeff *q1, od_coeff *q2,
 od_coeff *q3) {
  ...
  /* Embedded 2-point forward transforms with asymmetric input. */
...
static INLINE void od_idct_4(od_coeff *q0, od_coeff *q2,
  ...
  /* Embedded 2-point inverse transforms with asymmetric output */
...
static INLINE void od_idct_4_asym(od_coeff *q0, od_coeff *q2,
  ...
  /* Embedded 2-point orthonormal inverse transforms. */
  od_idst_2(q3, q2);
  od_idct_2(q0, q1);
...
static INLINE void od_idct_16(od_coeff *s0, od_coeff *s8,
  ...
  /* Embedded 8-point inverse transforms with asymmetric output. */
...
static INLINE void od_idct_16_asym(od_coeff *s0, od_coeff *s8,
  ...
  /* Embedded 8-point inverse orthonormal transforms. */
...
static INLINE void od_fdst_16(od_coeff *s0, od_coeff *s1,
  ...
  od_rotate_sub(s8, s7, od_avg_add(*s7, *s8), 9633, 13, 12873, 14, 12785, 15, 0);
...
static INLINE void od_fdct_32(od_coeff *t0, od_coeff *t1,
  ...
  /* Embedded 16-point forward transforms with asymmetric input. */
  od_fdct_16_asym(
...
static INLINE void od_idct_32(od_coeff *t0, od_coeff *tg,
  ...
  /* Embedded 16-point inverse transforms with asymmetric output. */
  od_idst_16_asym(
