...
static INLINE void od_idst_16(od_coeff *s0, od_coeff *s8,
  ...
  /*  8867/16384 = Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /*   3135/4096 = 2*Cos[7*Pi/8]             = 0.7653668647301796 */
  od_rotate_add_avg(sc, s3, 10703, 13, 8867, 14, 3135, 12, NONE);

  /* 10703/8192 = Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3870398453221475 */
  /* 8867/16384 = Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /*  3135/4096 = 2*Cos[3*Pi/8]             = 0.7653668647301796 */
  od_rotate_neg_avg(sd, s2, 10703, 13, 8867, 14, 3135, 12);
  ...
  od_rotate_neg_avg(sa, s5, 11363, 13, 9041, 15, 18205, 14);
...
static INLINE void od_fdst_32_asym(od_coeff *t0, od_coeff t0h, od_coeff *t1,
  ...
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_neg(ta, tl, 42813, 15, 8867, 14, 3135, 13);
...
static INLINE void od_idst_32_asym(od_coeff *t0, od_coeff *tg,
  ...
  /* Sin[Pi/4] + Cos[Pi/4] = 1.4142135623730951 */
  /* Cos[Pi/4]             = 0.7071067811865475 */
  od_rotate_pi4_add(tm, t9, 11585, 13, 11585, 14);

  /* Sin[Pi/4] + Cos[Pi/4] = 1.4142135623730951 */
  /* Cos[Pi/4]             = 0.7071067811865475 */
  od_rotate_pi4_sub(tp, t6, 11585, 13, 11585, 14);

  /* Sin[Pi/4] + Cos[Pi/4] = 1.4142135623730951 */
  /* Cos[Pi/4]             = 0.7071067811865475 */
  od_rotate_pi4_add(tq, t5, 11585, 13, 11585, 14);

  /* Sin[Pi/4] + Cos[Pi/4] = 1.4142135623730951 */
  /* Cos[Pi/4]             = 0.7071067811865475 */
  od_rotate_pi4_add(tu, t1, 11585, 13, 11585, 14);

  /* Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3065629648763766 */
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_neg(td, ti, 21407, 14, 8867, 14, 3135, 13);

  /* Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3065629648763766 */
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_add(tc, tj, 21407, 14, 8867, 14, 3135, 13, NONE);

  /* Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3065629648763766 */
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_add(tk, tb, 42813, 15, 8867, 14, 3135, 13, NONE);

  /* Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3065629648763766 */
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_neg(tl, ta, 21407, 14, 8867, 14, 3135, 13);

  /* Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3065629648763766 */
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_add(ts, t3, 42813, 15, 8867, 14, 3135, 13, NONE);

  /* Sin[3*Pi/8] + Cos[3*Pi/8] = 1.3065629648763766 */
  /* Sin[3*Pi/8] - Cos[3*Pi/8] = 0.5411961001461969 */
  /* Cos[3*Pi/8]               = 0.3826834323650898 */
  od_rotate_neg(tt, t2, 21407, 14, 8867, 14, 3135, 13);
  ...
  /* Sin[7*Pi/16] - Cos[7*Pi/16] = 0.7856949583871022 */
  /* Cos[7*Pi/16]                = 0.1950903220161283 */
  od_rotate_neg(tr, t4, 38531, 15, 12873, 14, 6393, 15);

  /* Sin[5*Pi/16] + Cos[5*Pi/16] = 1.3870398453221475 */
  /* Sin[5*Pi/16] - Cos[5*Pi/16] = 0.2758993792829431 */
  /* Cos[5*Pi/16]                = 0.5555702330196022 */
  od_rotate_neg(tq, t5, 22725, 14, 9041, 15, 4551, 13);

  /* Sin[5*Pi/16] + Cos[5*Pi/16] = 1.3870398453221475 */
  /* Sin[5*Pi/16] - Cos[5*Pi/16] = 0.2758993792829431 */
  /* Cos[5*Pi/16]                = 0.5555702330196022 */
  od_rotate_add(tp, t6, 45451, 15, 9041, 15, 18205, 15, NONE);
  ...
  /* Sin[13*Pi/32] - Cos[13*Pi/32] = 0.6666556584777465 */
  /* Cos[13*Pi/32]                 = 0.2902846772544623 */
  od_rotate_neg(tm, t9, 40869, 15, 21845, 15, 1189, 12);
