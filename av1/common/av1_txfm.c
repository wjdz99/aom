...
const int32_t lgt_inter_16x16[16 * 16] = {
  332,  394,   442,   492,   546,  601,   657,  715,  765,  807,   851,
  891,  921,   938,   934,   854,  -758,  -865, -869, -855, -821,  -752,
  -654, -530,  -376,  -183,  43,   299,   564,  830,  1074, 1098,  952,
  1020, 827,   568,   279,   -32,  -339,  -596, -772, -859, -838,  -676,
  -334, 217,   890,   1201,  -917, -849,  -402, 68,   457,  729,   830,
  756,  483,   48,    -461,  -902, -1089, -689, 401,  1256, -982,  -711,
  72,   709,   960,   814,   363,  -212,  -676, -896, -733, -112,  767,
  1113, 195,   -988,  839,   378,  -489,  -930, -728, -79,  615,   959,
  699,  -103,  -892,  -1004, -47,  1081,  615,  -868, -789, -142,  811,
  886,  88,    -815,  -1002, -275, 746,   1071, 245,  -894, -780,  585,
  767,  -671,  790,   -125,  -995, -495,  677,  1001, 65,   -1012, -727,
  585,  1014,  -158,  -981,  145,  875,   -594, 828,  -401, -1012, 179,
  1075, 126,   -1039, -457,  888,  638,   -774, -593, 824,  225,   -919,
  552,  -783,  666,   710,   -781, -642,  858,  565,  -936, -383,  1044,
  38,   -984,  445,   580,   -943, 493,   792,  -934, -251, 1079,  -365,
  -900, 809,   458,   -1050, 209,  804,   -752, -129, 795,  -831,  394,
  -672, 1009,  -331,  -666,  958,  -161,  -803, 938,  -130, -801,  905,
  -139, -730,  1039,  -818,  344,  -562,  986,  -715, -55,  837,   -972,
  351,  551,   -1015, 802,   -97,  -654,  1026, -944, 632,  -249,  -452,
  921,  -1018, 687,   4,     -668, 983,   -813, 271,  412,  -929,  1095,
  -949, 644,   -346,  121,   298,  -634,  816,  -792, 501,  -56,   -426,
  843,  -1119, 1222,  -1154, 921,  -619,  352,  -161, 47,   235,   -568,
  889,  -1156, 1281,  -1270, 1112, -869,  626,  -417, 240,  -105,  16,
  23,   -33,   19,
};

// self-loop weight 1.5
const int32_t lgt_inter_8x8[8 * 8] = {
  264,  355,  445,  550,  670,  833,  1067, 1103, -827, -922, -844, -710, -472,
  -42,  600,  927,  999,  807,  144,  -549, -986, -780, 114,  794,  875,  184,
  -845, -945, 97,   1025, 450,  -725, -873, 460,  988,  -359, -939, 418,  786,
  -665, 737,  -941, -101, 969,  -589, -431, 975,  -577, -533, 991,  -811, 134,
  633,  -983, 852,  -398, -297, 676,  -952, 1052, -955, 716,  -429, 168,
};

// self-loop weight 2.0 (DST4)
const int32_t lgt_inter_4x4[4 * 4] = {
  347, 572, 870,  945, 712,  895, 87,   -884,
  940, -91, -937, 572, -766, 980, -675, 309,
};
#endif  // CONFIG_LGT
