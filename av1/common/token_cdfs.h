...
static const aom_prob av1_default_dc_sign_cdfs[TOKEN_CDF_Q_CTXS][PLANE_TYPES]
                                              [DC_SIGN_CONTEXTS]
                                              [CDF_SIZE(2)] = {
                                                { {
                                                      { AOM_CDF2(128 * 125) },
...
static const aom_prob av1_default_eob_extra_cdfs[TOKEN_CDF_Q_CTXS][TX_SIZES]
                                                [PLANE_TYPES][EOB_COEF_CONTEXTS]
                                                [CDF_SIZE(2)] = {
                                                  { { {
                                                          { AOM_CDF2(16961) },
                                                          { AOM_CDF2(17223) },
...
static const aom_prob av1_default_coeff_lps_multi_cdfs
