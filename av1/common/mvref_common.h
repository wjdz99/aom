...
int av1_selectSamples(MV *mv, int *pts, int *pts_inref, int len, BLOCK_SIZE bsize);
int av1_findSamples(const AV1_COMMON *cm, MACROBLOCKD *xd, int mi_row, int mi_col,
