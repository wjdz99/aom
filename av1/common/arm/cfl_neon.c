...
static INLINE void subtract_average_neon(int16_t *pred_buf, int width,
  ...
  do {
    ...
    if (width == 4) {
      ...
      const uint16x8_t row0 =
          vaddq_u16(vld1q_u16(sum_buf), vld1q_u16(sum_buf + 8));
      const uint16x8_t row1 = vaddq_u16(vld1q_u16(sum_buf + CFL_BUF_LINE),
                                        vld1q_u16(sum_buf + CFL_BUF_LINE + 8));
      const uint16x8_t row2 =
          vaddq_u16(vld1q_u16(sum_buf + 2 * CFL_BUF_LINE),
                    vld1q_u16(sum_buf + 2 * CFL_BUF_LINE + 8));
      const uint16x8_t row3 =
          vaddq_u16(vld1q_u16(sum_buf + 3 * CFL_BUF_LINE),
      ...
      if (width == 32) {
        const uint16x8_t row0_1 =
            vaddq_u16(vld1q_u16(sum_buf + 16), vld1q_u16(sum_buf + 24));
        const uint16x8_t row1_1 =
            vaddq_u16(vld1q_u16(sum_buf + CFL_BUF_LINE + 16),
                      vld1q_u16(sum_buf + CFL_BUF_LINE + 24));
        const uint16x8_t row2_1 =
            vaddq_u16(vld1q_u16(sum_buf + 2 * CFL_BUF_LINE + 16),
                      vld1q_u16(sum_buf + 2 * CFL_BUF_LINE + 24));
        const uint16x8_t row3_1 =
            vaddq_u16(vld1q_u16(sum_buf + 3 * CFL_BUF_LINE + 16),
  ...
  do {
    if (width == 4) {
      ...
      vst1_s16(pred_buf + CFL_BUF_LINE,
               vsub_s16(vld1_s16(pred_buf + CFL_BUF_LINE), avg_16x4));
      vst1_s16(pred_buf + 2 * CFL_BUF_LINE,
               vsub_s16(vld1_s16(pred_buf + 2 * CFL_BUF_LINE), avg_16x4));
      vst1_s16(pred_buf + 3 * CFL_BUF_LINE,
               vsub_s16(vld1_s16(pred_buf + 3 * CFL_BUF_LINE), avg_16x4));
    } else {
      vst1q_s16(pred_buf, vsubq_s16(vld1q_s16(pred_buf), avg_16x8));
      vst1q_s16(pred_buf + CFL_BUF_LINE,
                vsubq_s16(vld1q_s16(pred_buf + CFL_BUF_LINE), avg_16x8));
      vst1q_s16(pred_buf + 2 * CFL_BUF_LINE,
                vsubq_s16(vld1q_s16(pred_buf + 2 * CFL_BUF_LINE), avg_16x8));
      vst1q_s16(pred_buf + 3 * CFL_BUF_LINE,
                vsubq_s16(vld1q_s16(pred_buf + 3 * CFL_BUF_LINE), avg_16x8));
      if (width > 8) {
        vst1q_s16(pred_buf + 8, vsubq_s16(vld1q_s16(pred_buf + 8), avg_16x8));
        vst1q_s16(pred_buf + CFL_BUF_LINE + 8,
                  vsubq_s16(vld1q_s16(pred_buf + CFL_BUF_LINE + 8), avg_16x8));
        vst1q_s16(
            pred_buf + 2 * CFL_BUF_LINE + 8,
            vsubq_s16(vld1q_s16(pred_buf + 2 * CFL_BUF_LINE + 8), avg_16x8));
        vst1q_s16(
            pred_buf + 3 * CFL_BUF_LINE + 8,
            vsubq_s16(vld1q_s16(pred_buf + 3 * CFL_BUF_LINE + 8), avg_16x8));
      }
      if (width == 32) {
        ...
        vst1q_s16(pred_buf + CFL_BUF_LINE + 16,
                  vsubq_s16(vld1q_s16(pred_buf + CFL_BUF_LINE + 16), avg_16x8));
        vst1q_s16(pred_buf + CFL_BUF_LINE + 24,
                  vsubq_s16(vld1q_s16(pred_buf + CFL_BUF_LINE + 24), avg_16x8));
        vst1q_s16(
            pred_buf + 2 * CFL_BUF_LINE + 16,
            vsubq_s16(vld1q_s16(pred_buf + 2 * CFL_BUF_LINE + 16), avg_16x8));
        vst1q_s16(
            pred_buf + 2 * CFL_BUF_LINE + 24,
            vsubq_s16(vld1q_s16(pred_buf + 2 * CFL_BUF_LINE + 24), avg_16x8));
        vst1q_s16(
            pred_buf + 3 * CFL_BUF_LINE + 16,
            vsubq_s16(vld1q_s16(pred_buf + 3 * CFL_BUF_LINE + 16), avg_16x8));
        vst1q_s16(
            pred_buf + 3 * CFL_BUF_LINE + 24,
            vsubq_s16(vld1q_s16(pred_buf + 3 * CFL_BUF_LINE + 24), avg_16x8));
      }
    }
