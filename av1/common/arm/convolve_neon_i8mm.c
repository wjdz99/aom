...
static INLINE int16x4_t convolve4_4_2d_h(const uint8x16_t samples,
  ...
  int32x4_t sum = vusdotq_lane_s32(offset, permuted_samples, filters, 0);
...
static INLINE int16x8_t convolve4_8_2d_h(const uint8x16_t samples,
  ...
  int32x4_t sum0123 = vusdotq_lane_s32(offset, permuted_samples[0], filters, 0);
  int32x4_t sum4567 = vusdotq_lane_s32(offset, permuted_samples[1], filters, 0);
