  ...
  if (!(h & 7)) {
    ...
    do {
      ...
      do {
        ...
        res4 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
        ...
        res5 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                            bd, conv_params->round_0);
        ...
        res6 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                            bd, conv_params->round_0);
        ...
        res7 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                            bd, conv_params->round_0);
        ...
        res8 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                            bd, conv_params->round_0);
        ...
        res9 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                            bd, conv_params->round_0);
        ...
        res10 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                             bd, conv_params->round_0);
        ...
        res11 = wiener_convolve8_horiz_h8_w8(res0, res1, res2, res3, filter_x,
                                             bd, conv_params->round_0);
    ...
    do {
      ...
      do {
        ...
        res0 = wiener_convolve8_horiz_h4_w8(s0, s1, s2, s3, s4, s5, s6,
                                            filter_x, bd, conv_params->round_0);
        res1 = wiener_convolve8_horiz_h4_w8(s1, s2, s3, s4, s5, s6, s7,
                                            filter_x, bd, conv_params->round_0);
        res2 = wiener_convolve8_horiz_h4_w8(s2, s3, s4, s5, s6, s7, s8,
                                            filter_x, bd, conv_params->round_0);
        res3 = wiener_convolve8_horiz_h4_w8(s3, s4, s5, s6, s7, s8, s9,
                                            filter_x, bd, conv_params->round_0);
        res4 = wiener_convolve8_horiz_h4_w8(s4, s5, s6, s7, s8, s9, s10,
                                            filter_x, bd, conv_params->round_0);
        res5 = wiener_convolve8_horiz_h4_w8(s5, s6, s7, s8, s9, s10, s11,
                                            filter_x, bd, conv_params->round_0);
        res6 = wiener_convolve8_horiz_h4_w8(s6, s7, s8, s9, s10, s11, s12,
                                            filter_x, bd, conv_params->round_0);
        res7 = wiener_convolve8_horiz_h4_w8(s7, s8, s9, s10, s11, s12, s13,
                                            filter_x, bd, conv_params->round_0);
...

  {
    ...
    do {
      ...
      do {
        ...
        t0 = wiener_convolve8_vert_h4_w8(s0, s1, s2, s3, s4, s5, s6, filter_y,
                                         bd, conv_params->round_1);
        t1 = wiener_convolve8_vert_h4_w8(s1, s2, s3, s4, s5, s6, s7, filter_y,
                                         bd, conv_params->round_1);
        t2 = wiener_convolve8_vert_h4_w8(s2, s3, s4, s5, s6, s7, s8, filter_y,
                                         bd, conv_params->round_1);
        t3 = wiener_convolve8_vert_h4_w8(s3, s4, s5, s6, s7, s8, s9, filter_y,
                                         bd, conv_params->round_1);
