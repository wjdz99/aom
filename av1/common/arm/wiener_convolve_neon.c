  ...
  if (!(h & 7)) {
    ...
    do {
      ...
      do {
        ...
        t1 = vext_u8(sum, t7, 1);  // a1 a2 a3 a4 a5 a6 a7 a8
        t2 = vext_u8(sum, t7, 2);  // a2 a3 a4 a5 a6 a7 a8 a9
        t3 = vext_u8(sum, t7, 3);  // a3 a4 a5 a6 a7 a8 a9 a10
        t4 = vext_u8(sum, t7, 4);  // a4 a5 a6 a7 a8 a9 a10 a11
        t5 = vext_u8(sum, t7, 5);  // a5 a6 a7 a8 a9 a10 a11 a12
        t6 = vext_u8(sum, t7, 6);  // a6 a7 a8 a9 a10 a11 a12 a13
        t7 = vext_u8(sum, t7, 7);  // a7 a8 a9 a10 a11 a12 a13 a14

        res0 = vreinterpretq_s16_u16(vaddl_u8(sum, t6));
        res1 = vreinterpretq_s16_u16(vaddl_u8(t1, t5));
        res2 = vreinterpretq_s16_u16(vaddl_u8(t2, t4));
        res3 = vreinterpretq_s16_u16(vmovl_u8(t3));
        res4 = wiener_convolve8_horiz_8x8(res0, res1, res2, res3, filter_x_tmp,
    ...
    do {
      ...
      do {
        ...
        tt0 = vreinterpretq_s16_u16(vaddl_u8(sum, t6));
