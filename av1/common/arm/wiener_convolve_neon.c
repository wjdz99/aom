...
/*Wiener filter 2D
        First it does Horz_Filtering &
        apply Vert_filtering to the o/p of Horz_filter
*/
void av1_wiener_convolve_add_src_neon(const uint8_t *src, ptrdiff_t src_stride,
  ...
  int width, height;
  const int bd = 8;
  const int16x8_t filters_x = vld1q_s16(filter_x);
  ...
  assert(!(w & 7)); /*width  must be multiples of 8*/
  assert(!(h & 3)); /*hieght must be multiples of 4*/
  assert(w <= MAX_SB_SIZE);
  assert(h <= MAX_SB_SIZE);

  /* assumption of filter_coeff_8 will be zero */
  assert(filter_x[7] == 0);
  assert(filter_y[7] == 0);

  /* assumption of Horz_Filt output will not exceed 15 bit.
  ...
  /*Horz-tap filtering :START */
  filters_lo = vget_low_s16(filters_x);

  /*if height multiples of 8*/
  if (!(h & 7)) {
    ...
    do {
      ...
      do {
        ...
        res4 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                      conv_params->round_0);
        ...
        res5 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                      conv_params->round_0);
        ...
        res6 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                      conv_params->round_0);
        ...
        res7 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                      conv_params->round_0);
        ...
        res8 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                      conv_params->round_0);
        ...
        res9 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                      conv_params->round_0);
        ...
        res10 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                       conv_params->round_0);
        ...
        res11 = wiener_convolve_u8_8_8(res0, res1, res2, res3, filters_lo, bd,
                                       conv_params->round_0);
    ...
    do {
      ...
      do {
        ...
        res0 = wiener_convolve_u8_8_4(s0, s1, s2, s3, s4, s5, s6, s7,
                                      filters_lo, bd, conv_params->round_0);
        res1 = wiener_convolve_u8_8_4(s1, s2, s3, s4, s5, s6, s7, s8,
                                      filters_lo, bd, conv_params->round_0);
        res2 = wiener_convolve_u8_8_4(s2, s3, s4, s5, s6, s7, s8, s9,
                                      filters_lo, bd, conv_params->round_0);
        res3 = wiener_convolve_u8_8_4(s3, s4, s5, s6, s7, s8, s9, s10,
                                      filters_lo, bd, conv_params->round_0);
        res4 = wiener_convolve_u8_8_4(s4, s5, s6, s7, s8, s9, s10, s11,
                                      filters_lo, bd, conv_params->round_0);
        res5 = wiener_convolve_u8_8_4(s5, s6, s7, s8, s9, s10, s11, s12,
                                      filters_lo, bd, conv_params->round_0);
        res6 = wiener_convolve_u8_8_4(s6, s7, s8, s9, s10, s11, s12, s13,
                                      filters_lo, bd, conv_params->round_0);
        res7 = wiener_convolve_u8_8_4(s7, s8, s9, s10, s11, s12, s13, s14,
                                      filters_lo, bd, conv_params->round_0);
  ...
  /*vert_tap filtering : START*/
  {
    int16x8_t s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10;
    uint8x8_t t0, t1, t2, t3;
    int16_t *src_tmp_ptr, *s;
    uint8_t *dst_tmp_ptr;
    const int16x8_t filters_y = vld1q_s16(filter_y);
    height = h;
    width = w;
    ...
    do {
      ...
      do {
        ...
        t0 = wiener_convolve_s16_8_8(s0, s1, s2, s3, s4, s5, s6, s7, filters_y,
                                     bd, conv_params->round_1);
        t1 = wiener_convolve_s16_8_8(s1, s2, s3, s4, s5, s6, s7, s8, filters_y,
                                     bd, conv_params->round_1);
        t2 = wiener_convolve_s16_8_8(s2, s3, s4, s5, s6, s7, s8, s9, filters_y,
                                     bd, conv_params->round_1);
        t3 = wiener_convolve_s16_8_8(s3, s4, s5, s6, s7, s8, s9, s10, filters_y,
                                     bd, conv_params->round_1);
