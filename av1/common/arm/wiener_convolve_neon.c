...
void av1_wiener_convolve_add_src_neon(const uint8_t *src, ptrdiff_t src_stride,
  ...
  /* assumption of Horiz_Filt output will not exceed 15 bit.
  ...
  if (!(h & 7)) {
    ...
    do {
      ...
      do {
        ...
        res0 = wiener_convolve_u8_8_4(s0, s1, s2, s3, s4, s5, s6, filters_lo,
                                      bd, conv_params->round_0);
        res1 = wiener_convolve_u8_8_4(s1, s2, s3, s4, s5, s6, s7, filters_lo,
                                      bd, conv_params->round_0);
        res2 = wiener_convolve_u8_8_4(s2, s3, s4, s5, s6, s7, s8, filters_lo,
                                      bd, conv_params->round_0);
        res3 = wiener_convolve_u8_8_4(s3, s4, s5, s6, s7, s8, s9, filters_lo,
                                      bd, conv_params->round_0);
        res4 = wiener_convolve_u8_8_4(s4, s5, s6, s7, s8, s9, s10, filters_lo,
                                      bd, conv_params->round_0);
        res5 = wiener_convolve_u8_8_4(s5, s6, s7, s8, s9, s10, s11, filters_lo,
                                      bd, conv_params->round_0);
        res6 = wiener_convolve_u8_8_4(s6, s7, s8, s9, s10, s11, s12, filters_lo,
                                      bd, conv_params->round_0);
        res7 = wiener_convolve_u8_8_4(s7, s8, s9, s10, s11, s12, s13,
  ...
  /* vert_tap filtering : START */
  {
    ...
    do {
      ...
      do {
        ...
        t0 = wiener_convolve_s16_8_8(s0, s1, s2, s3, s4, s5, s6, filters_y, bd,
                                     conv_params->round_1);
        t1 = wiener_convolve_s16_8_8(s1, s2, s3, s4, s5, s6, s7, filters_y, bd,
                                     conv_params->round_1);
        t2 = wiener_convolve_s16_8_8(s2, s3, s4, s5, s6, s7, s8, filters_y, bd,
                                     conv_params->round_1);
        t3 = wiener_convolve_s16_8_8(s3, s4, s5, s6, s7, s8, s9, filters_y, bd,
                                     conv_params->round_1);
