...
static INLINE void dist_wtd_convolve_2d_vert_6tap_neon(
  ...
  if (w == 4) {
    ...
    do {
      ...
      d0 = convolve6_4_s32(s0, s1, s2, s3, s4, s5, y_filter,
                           round_shift_vec, offset_const);
      d1 = convolve6_4_s32(s1, s2, s3, s4, s5, s6, y_filter,
                           round_shift_vec, offset_const);
      d2 = convolve6_4_s32(s2, s3, s4, s5, s6, s7, y_filter,
                           round_shift_vec, offset_const);
      d3 = convolve6_4_s32(s3, s4, s5, s6, s7, s8, y_filter,
                           round_shift_vec, offset_const);
    ...
    do {
      ...
      do {
        ...
        d0 = convolve6_8_s32(s0, s1, s2, s3, s4, s5, y_filter,
                             round_shift_vec, offset_const);
        d1 = convolve6_8_s32(s1, s2, s3, s4, s5, s6, y_filter,
                             round_shift_vec, offset_const);
        d2 = convolve6_8_s32(s2, s3, s4, s5, s6, s7, y_filter,
                             round_shift_vec, offset_const);
        d3 = convolve6_8_s32(s3, s4, s5, s6, s7, s8, y_filter,
                             round_shift_vec, offset_const);
        ...
        if (do_average) {
          ...
          compute_avg_8x4(dd0, dd1, dd2, dd3, d0, d1, d2, d3, fwd_offset,
                          bck_offset, sub_const_vec, round_bits,
                          use_dist_wtd_comp_avg, &d0_u8, &d1_u8, &d2_u8, &d3_u8);
