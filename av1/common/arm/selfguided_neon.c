  ...
  do {
    ...
    if (!(count & 1)) {
      do {
        ...
        a_res0 = vrshrq_n_s32(
            a_res0, SGRPROJ_SGR_BITS + NB_EVEN - SGRPROJ_RST_BITS(bd));
        a_res1 = vrshrq_n_s32(
            a_res1, SGRPROJ_SGR_BITS + NB_EVEN - SGRPROJ_RST_BITS(bd));
      ...
      do {
        ...
        a_res0 = vrshrq_n_s32(a_res0,
                              SGRPROJ_SGR_BITS + NB_ODD - SGRPROJ_RST_BITS(bd));
...
void final_filter_internal(uint16_t *A, int32_t *B, const int buf_stride,
  ...
  do {
    ...
    do {
      ...
      a_res0 = vrshrq_n_s32(a_res0,
                            SGRPROJ_SGR_BITS + NB_EVEN - SGRPROJ_RST_BITS(bd));
      a_res1 = vrshrq_n_s32(a_res1,
                            SGRPROJ_SGR_BITS + NB_EVEN - SGRPROJ_RST_BITS(bd));
      vst1q_s32(dst_ptr, a_res0);
      vst1q_s32(dst_ptr + 4, a_res1);
