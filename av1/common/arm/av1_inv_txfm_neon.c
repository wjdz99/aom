...
static INLINE void btf_16_neon_pos(const int16x8_t in0, int16_t coef1,
...
static INLINE void round_shift_for_rect(int16x8_t *input, int16x8_t *output,
                                       int size) {
  const int32_t scale = NewInvSqrt2;
  const int32_t shift = NewSqrt2Bits;
  ...
  for (int z = 0; z < size; ++z) {
    ...
    low = vqrshrn_n_s32(out_low, shift);
    high = vqrshrn_n_s32(out_high, shift);

    output[z] = vcombine_s16(low, high);
  }
}

static INLINE void identity16_new_neon(int16x8_t *input,
...
static INLINE void av1_identity32_new_neon(int16x8_t *input, int16x8_t *output,
                                           int8_t cos_bit, int bit) {
  (void)bit;
  (void)cos_bit;
...
static INLINE void idct16_low8_new_neon(int16x8_t *in, int16x8_t *out,
  ...
  btf_16_neon_pos(in[1], cospi[60], cospi[4], &step2[8], &step2[15]);
  btf_16_neon_pos(in[7], -cospi[36], cospi[28], &step2[9], &step2[14]);
  btf_16_neon_pos(in[5], cospi[44], cospi[20], &step2[10], &step2[13]);
  btf_16_neon_pos(in[3], -cospi[52], cospi[12], &step2[11], &step2[12]);
  
  // stage 3
  
  btf_16_neon_pos(step2[4], cospi[56], cospi[8], &step1[4], &step1[7]);
  btf_16_neon_pos(step2[6], -cospi[40], cospi[24], &step1[5], &step1[6]);
  ...
  btf_16_neon_pos(step1[0], cospi[32], cospi[32], &step2[0], &step2[1]);
  btf_16_neon_pos(step1[2], cospi[48], cospi[16], &step2[2], &step2[3]);
...
static INLINE void iadst16_low8_new_neon(int16x8_t *const in, int16x8_t *out,
  ...
  btf_16_neon_pos(x[8], cospi[34], cospi[30], &s8, &s9);
  btf_16_neon_pos(x[10], cospi[42], cospi[22], &s10, &s11);
  btf_16_neon_pos(x[12], cospi[50], cospi[14], &s12, &s13);
  btf_16_neon_pos(x[14], cospi[58], cospi[6], &s14, &s15);
...
static INLINE void idct32_low8_new_neon(int16x8_t *in, int16x8_t *out,
  ...
  btf_16_neon_pos(in[1], cospi[62], cospi[2], &step2[16], &step2[31]);
  btf_16_neon_pos(in[7], -cospi[50], cospi[14], &step2[19], &step2[28]);
  btf_16_neon_pos(in[5], cospi[54], cospi[10], &step2[20], &step2[27]);
  btf_16_neon_pos(in[3], -cospi[58], cospi[6], &step2[23], &step2[24]);
  ...
  btf_16_neon_pos(step2[8], cospi[60], cospi[4], &step1[8], &step1[15]);
  btf_16_neon_pos(step2[12], -cospi[52], cospi[12], &step1[11], &step1[12]);
  ...
  btf_16_neon_pos(step1[4], cospi[56], cospi[8], &step2[4], &step2[7]);
...
static INLINE void idct32_low16_new_neon(int16x8_t *in, int16x8_t *out,
  ...
  btf_16_neon_pos(in[1], cospi[62], cospi[2], &step2[16], &step2[31]);
  btf_16_neon_pos(in[15], -cospi[34], cospi[30], &step2[17], &step2[30]);
  btf_16_neon_pos(in[9], cospi[46], cospi[18], &step2[18], &step2[29]);
  btf_16_neon_pos(in[7], -cospi[50], cospi[14], &step2[19], &step2[28]);
  btf_16_neon_pos(in[5], cospi[54], cospi[10], &step2[20], &step2[27]);
  btf_16_neon_pos(in[11], -cospi[42], cospi[22], &step2[21], &step2[26]);
  btf_16_neon_pos(in[13], cospi[38], cospi[26], &step2[22], &step2[25]);
  btf_16_neon_pos(in[3], -cospi[58], cospi[6], &step2[23], &step2[24]);
  ...
  btf_16_neon_pos(step2[8], cospi[60], cospi[4], &step1[8], &step1[15]);
  btf_16_neon_pos(step2[14], -cospi[36], cospi[28], &step1[9], &step1[14]);
  btf_16_neon_pos(step2[10], cospi[44], cospi[20], &step1[10], &step1[13]);
  btf_16_neon_pos(step2[12], -cospi[52], cospi[12], &step1[11], &step1[12]);
  ...
  btf_16_neon_pos(step1[4], cospi[56], cospi[8], &step2[4], &step2[7]);
  btf_16_neon_pos(step1[6], -cospi[40], cospi[24], &step2[5], &step2[6]);
  btf_16_lane_0_1_neon(step1[30], step1[17], c0, &step2[30], &step2[17]);
  btf_16_lane_1_0_neon(vnegq_s16(step1[18]), vnegq_s16(step1[29]), c0,
                       &step2[18], &step2[29]);
  btf_16_lane_2_3_neon(step1[26], step1[21], c0, &step2[26], &step2[21]);
  ...
  btf_16_neon_pos(step2[2], cospi[48], cospi[16], &step1[2], &step1[3]);
  btf_16_lane_2_3_neon(step2[14], step2[9], c1, &step1[14], &step1[9]);
  btf_16_lane_3_2_neon(vnegq_s16(step2[10]), vnegq_s16(step2[13]), c1,
                       &step1[10], &step1[13]);
    ...
    lowbd_txfm_all_1d_zeros_w_arr[TX_SIZES][ITX_TYPES_1D][4] = {
        ...
        { identity8_new_neon, identity8_new_neon, NULL, NULL } },
      {
          ...
          { iadst16_low1_new_neon, iadst16_low8_new_neon, iadst16_new_neon,
            NULL },
          { identity16_new_neon, identity16_new_neon,
            identity16_new_neon, NULL },
      },
      { { idct32_low1_new_neon, idct32_low8_new_neon, idct32_low16_new_neon,
          idct32_new_neon },
        { NULL, NULL, NULL, NULL },
        { av1_identity32_new_neon, av1_identity32_new_neon,
          av1_identity32_new_neon, av1_identity32_new_neon } },
      { { NULL, NULL, NULL, NULL },
        { NULL, NULL, NULL, NULL },
        { NULL, NULL, NULL, NULL } }
