...
static INLINE void highbd_dist_wtd_convolve_y_8tap_neon(
  ...
  if (w <= 4) {
    ...
    do {
      ...
      uint16x4_t d0 = highbd_convolve8_4_y(s0, s1, s2, s3, s4, s5, s6, s7,
                                           y_filter, shift, offset_vec);
      uint16x4_t d1 = highbd_convolve8_4_y(s1, s2, s3, s4, s5, s6, s7, s8,
                                           y_filter, shift, offset_vec);
      uint16x4_t d2 = highbd_convolve8_4_y(s2, s3, s4, s5, s6, s7, s8, s9,
                                           y_filter, shift, offset_vec);
      uint16x4_t d3 = highbd_convolve8_4_y(s3, s4, s5, s6, s7, s8, s9, s10,
                                           y_filter, shift, offset_vec);
    ...
    do {
      ...
      do {
        ...
        uint16x8_t d0 = highbd_convolve8_8_y(s0, s1, s2, s3, s4, s5, s6, s7,
                                             y_filter, shift, offset_vec);
        uint16x8_t d1 = highbd_convolve8_8_y(s1, s2, s3, s4, s5, s6, s7, s8,
                                             y_filter, shift, offset_vec);
        uint16x8_t d2 = highbd_convolve8_8_y(s2, s3, s4, s5, s6, s7, s8, s9,
                                             y_filter, shift, offset_vec);
...
static INLINE void highbd_dist_wtd_convolve_2d_horiz_8tap_neon(
  ...
  if (w == 4) {
    ...
    do {
      ...
      uint16x4_t d0 = highbd_convolve8_4_2d_h(s0, x_filter, shift, offset_vec);
      uint16x4_t d1 = highbd_convolve8_4_2d_h(s1, x_filter, shift, offset_vec);
      uint16x4_t d2 = highbd_convolve8_4_2d_h(s2, x_filter, shift, offset_vec);
      uint16x4_t d3 = highbd_convolve8_4_2d_h(s3, x_filter, shift, offset_vec);
    ...
    do {
      ...
      do {
        ...
        uint16x8_t d0 =
            highbd_convolve8_8_2d_h(s0, x_filter, shift, offset_vec);
        uint16x8_t d1 =
            highbd_convolve8_8_2d_h(s1, x_filter, shift, offset_vec);
        uint16x8_t d2 =
            highbd_convolve8_8_2d_h(s2, x_filter, shift, offset_vec);
        uint16x8_t d3 =
            highbd_convolve8_8_2d_h(s3, x_filter, shift, offset_vec);
