...
#define OD_FDST_2_ASYM_FLAT(p0, p1) \
  /* Embedded 2-point asymmetric Type-IV fDST with flattened rotations. */ \
  do { \
    int t_; \
    int u_; \
    t_ = OD_RSHIFT1(p0) - p1; \
    /* 3135/8192 ~= (Cos[3*Pi/8] - Sin[3*Pi/8])/Sqrt[2] = 0.3826834323650897 */ \
    u_ = (p0*3135 + 4096) >> 13; \
    /* 60547/32768 ~= (Cos[3*Pi/8] + Sin[3*Pi/8])*Sqrt[2] = 1.84775906502257 */ \
...
#define OD_FDST_4_ASYM_FLAT(q0, q1, q2, q3) \
...
#define OD_FDCT_8_FLAT(r0, r1, r2, r3, r4, r5, r6, r7) \
  ...
  do { \
    ...
    OD_FDST_4_ASYM_FLAT(r7, r6, r5, r4); \
  } \
  while (0)
