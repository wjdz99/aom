...
typedef double OdVal16;
typedef double OdVal32;
...
#else
typedef int16_t OdVal16;
typedef int32_t OdVal32;
/** Compile-time conversion of float constant to 32-bit value */
# define OD_QCONST32(x, bits) ((OdVal32)(.5 + (x)*(((OdVal32)1) << (bits))))
...
/* (OdVal32)(OdVal16) gives TI compiler a hint that it's 16x16->32 multiply */
/** 16x16 multiplication where the result fits in 32 bits */
# define OD_MULT16_16(a, b) \
 (((OdVal32)(OdVal16)(a))*((OdVal32)(OdVal16)(b)))
