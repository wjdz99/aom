...
typedef struct {
  ...
  aom_cdf_prob class_cdf[MV_CLASSES + 1];
#endif
...
#if CONFIG_EC_MULTISYMBOL
  aom_cdf_prob class0_fp_cdf[CLASS0_SIZE][MV_FP_SIZE + 1];
  aom_cdf_prob fp_cdf[MV_FP_SIZE + 1];
#endif
  aom_prob class0_hp;
  aom_prob hp;
} nmv_component;
...
#if CONFIG_EC_MULTISYMBOL
  aom_cdf_prob joint_cdf[MV_JOINTS + 1];
#endif
