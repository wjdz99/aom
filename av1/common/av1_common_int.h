...
// Struct containing params related to MB_MODE_INFO struct.
...
struct CommonModeInfoParams {
  ...
  // We allocate a MB_MODE_INFO struct for each macroblock in the frame,
  // together with an extra row on top and an extra column on the left to
  // simplify prediction.
  int mi_alloc_size;
...
typedef struct AV1Common {
  ...
  // Params related to MB_MODE_INFO struct.
