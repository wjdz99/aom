...
static INLINE int txfm_partition_split4_inter_context(const TXFM_CONTEXT *const above_ctx,
...
static INLINE int txfm_partition_split4_intra_context(const TXFM_CONTEXT *const above_ctx,
                                         const TXFM_CONTEXT *const left_ctx,
                                         BLOCK_SIZE bsize, TX_SIZE tx_size) {
  (void)above_ctx;
  (void)left_ctx;
