...
typedef struct {
  ...
  size_t prev_colbuf_size[MAX_MB_PLANE];  /*!< CDEF column line buffer sizes*/
  size_t prev_linebuf_size[MAX_MB_PLANE]; /*!< CDEF top & bottom line buffer
                                             sizes*/
  size_t prev_srcbuf_size;                /*!< CDEF intermediate buffer size*/
