...
typedef struct {
  ...
  size_t allocated_colbuf_size[MAX_MB_PLANE];   // CDEF column line buffer sizes
  size_t allocated_linebuf_size[MAX_MB_PLANE];  // CDEF top and bottom line
                                                // buffer sizes
  size_t allocated_srcbuf_size;                 // CDEF intermediate buffer size
  ...
  int cdef_uv_strengths[CDEF_MAX_STRENGTHS];  // CDEF strength values for chroma
