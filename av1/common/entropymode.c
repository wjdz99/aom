...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(12839), AOM_ICDF(13635), AOM_ICDF(14685), AOM_ICDF(15762),
        AOM_ICDF(16309), AOM_ICDF(16939), AOM_ICDF(17560), AOM_ICDF(18587),
        AOM_ICDF(19194), AOM_ICDF(21079), AOM_ICDF(23814), AOM_ICDF(26155),
        AOM_ICDF(30831), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6940), AOM_ICDF(9883), AOM_ICDF(10873), AOM_ICDF(12231),
        AOM_ICDF(13149), AOM_ICDF(14697), AOM_ICDF(15505), AOM_ICDF(16494),
        AOM_ICDF(17921), AOM_ICDF(19841), AOM_ICDF(21896), AOM_ICDF(25024),
        AOM_ICDF(30788), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7528), AOM_ICDF(8240), AOM_ICDF(11354), AOM_ICDF(12247),
        AOM_ICDF(12959), AOM_ICDF(13605), AOM_ICDF(14758), AOM_ICDF(16601),
        AOM_ICDF(17261), AOM_ICDF(19142), AOM_ICDF(22546), AOM_ICDF(24426),
        AOM_ICDF(30750), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5417), AOM_ICDF(7254), AOM_ICDF(8998), AOM_ICDF(12246),
        AOM_ICDF(13808), AOM_ICDF(15445), AOM_ICDF(16992), AOM_ICDF(18983),
        AOM_ICDF(20956), AOM_ICDF(23035), AOM_ICDF(25320), AOM_ICDF(27697),
        AOM_ICDF(30418), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5466), AOM_ICDF(7193), AOM_ICDF(9082), AOM_ICDF(10845),
        AOM_ICDF(14352), AOM_ICDF(16341), AOM_ICDF(18604), AOM_ICDF(20379),
        AOM_ICDF(21827), AOM_ICDF(24115), AOM_ICDF(26477), AOM_ICDF(28821),
        AOM_ICDF(30937), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4958), AOM_ICDF(6918), AOM_ICDF(8647), AOM_ICDF(10462),
        AOM_ICDF(12617), AOM_ICDF(16049), AOM_ICDF(17728), AOM_ICDF(19432),
        AOM_ICDF(21056), AOM_ICDF(23285), AOM_ICDF(25593), AOM_ICDF(28197),
        AOM_ICDF(30788), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5677), AOM_ICDF(7171), AOM_ICDF(9358), AOM_ICDF(10937),
        AOM_ICDF(12772), AOM_ICDF(14233), AOM_ICDF(17647), AOM_ICDF(19341),
        AOM_ICDF(20700), AOM_ICDF(22986), AOM_ICDF(25740), AOM_ICDF(28063),
        AOM_ICDF(30842), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6492), AOM_ICDF(7824), AOM_ICDF(9633), AOM_ICDF(11443),
        AOM_ICDF(12694), AOM_ICDF(13906), AOM_ICDF(15256), AOM_ICDF(18645),
        AOM_ICDF(19939), AOM_ICDF(21970), AOM_ICDF(24749), AOM_ICDF(26936),
        AOM_ICDF(30351), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5675), AOM_ICDF(7559), AOM_ICDF(9109), AOM_ICDF(11439),
        AOM_ICDF(12868), AOM_ICDF(14383), AOM_ICDF(15774), AOM_ICDF(17387),
        AOM_ICDF(20489), AOM_ICDF(22556), AOM_ICDF(24793), AOM_ICDF(27348),
        AOM_ICDF(30441), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8874), AOM_ICDF(9846), AOM_ICDF(11034), AOM_ICDF(12263),
        AOM_ICDF(13134), AOM_ICDF(14016), AOM_ICDF(14935), AOM_ICDF(16205),
        AOM_ICDF(17087), AOM_ICDF(19787), AOM_ICDF(23032), AOM_ICDF(25954),
        AOM_ICDF(30237), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6744), AOM_ICDF(8224), AOM_ICDF(9830), AOM_ICDF(11424),
        AOM_ICDF(12727), AOM_ICDF(14063), AOM_ICDF(15436), AOM_ICDF(17054),
        AOM_ICDF(18402), AOM_ICDF(20787), AOM_ICDF(24291), AOM_ICDF(26631),
        AOM_ICDF(30382), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7015), AOM_ICDF(8419), AOM_ICDF(9993), AOM_ICDF(11578),
        AOM_ICDF(12889), AOM_ICDF(14214), AOM_ICDF(15544), AOM_ICDF(17145),
        AOM_ICDF(18459), AOM_ICDF(20851), AOM_ICDF(23358), AOM_ICDF(26661),
        AOM_ICDF(30384), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6427), AOM_ICDF(8074), AOM_ICDF(9834), AOM_ICDF(11283),
        AOM_ICDF(12464), AOM_ICDF(13727), AOM_ICDF(14967), AOM_ICDF(16507),
        AOM_ICDF(17813), AOM_ICDF(19776), AOM_ICDF(22340), AOM_ICDF(24710),
        AOM_ICDF(30900), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
