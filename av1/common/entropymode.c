...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(196),   AOM_ICDF(2753),  AOM_ICDF(6070),  AOM_ICDF(13643),
  AOM_ICDF(21919), AOM_ICDF(23485), AOM_ICDF(25497), AOM_ICDF(26705),
  AOM_ICDF(27629), AOM_ICDF(28781), AOM_ICDF(31460), AOM_ICDF(31780),
  AOM_ICDF(32143), AOM_ICDF(32548), AOM_ICDF(32768), 0
};
#endif
