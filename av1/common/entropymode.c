...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(12947), AOM_ICDF(13726), AOM_ICDF(14766), AOM_ICDF(15837),
        AOM_ICDF(16391), AOM_ICDF(17020), AOM_ICDF(17638), AOM_ICDF(18675),
        AOM_ICDF(19282), AOM_ICDF(21195), AOM_ICDF(23962), AOM_ICDF(26332),
        AOM_ICDF(30987), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6943), AOM_ICDF(9889), AOM_ICDF(10867), AOM_ICDF(12219),
        AOM_ICDF(13123), AOM_ICDF(14662), AOM_ICDF(15464), AOM_ICDF(16453),
        AOM_ICDF(17868), AOM_ICDF(19802), AOM_ICDF(21877), AOM_ICDF(24970),
        AOM_ICDF(30705), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7566), AOM_ICDF(8272), AOM_ICDF(11359), AOM_ICDF(12260),
        AOM_ICDF(12977), AOM_ICDF(13625), AOM_ICDF(14758), AOM_ICDF(16606),
        AOM_ICDF(17256), AOM_ICDF(19124), AOM_ICDF(22517), AOM_ICDF(24411),
        AOM_ICDF(30668), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5439), AOM_ICDF(7271), AOM_ICDF(9002), AOM_ICDF(12257),
        AOM_ICDF(13832), AOM_ICDF(15457), AOM_ICDF(16999), AOM_ICDF(18991),
        AOM_ICDF(20963), AOM_ICDF(23039), AOM_ICDF(25315), AOM_ICDF(27681),
        AOM_ICDF(30374), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5484), AOM_ICDF(7184), AOM_ICDF(9069), AOM_ICDF(10836),
        AOM_ICDF(14309), AOM_ICDF(16285), AOM_ICDF(18527), AOM_ICDF(20281),
        AOM_ICDF(21740), AOM_ICDF(24013), AOM_ICDF(26368), AOM_ICDF(28718),
        AOM_ICDF(30808), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4967), AOM_ICDF(6930), AOM_ICDF(8635), AOM_ICDF(10448),
        AOM_ICDF(12600), AOM_ICDF(15984), AOM_ICDF(17651), AOM_ICDF(19343),
        AOM_ICDF(20970), AOM_ICDF(23204), AOM_ICDF(25498), AOM_ICDF(28102),
        AOM_ICDF(30692), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5676), AOM_ICDF(7151), AOM_ICDF(9326), AOM_ICDF(10912),
        AOM_ICDF(12746), AOM_ICDF(14210), AOM_ICDF(17593), AOM_ICDF(19305),
        AOM_ICDF(20663), AOM_ICDF(22951), AOM_ICDF(25683), AOM_ICDF(27994),
        AOM_ICDF(30748), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6498), AOM_ICDF(7828), AOM_ICDF(9628), AOM_ICDF(11412),
        AOM_ICDF(12653), AOM_ICDF(13869), AOM_ICDF(15201), AOM_ICDF(18606),
        AOM_ICDF(19892), AOM_ICDF(21918), AOM_ICDF(24677), AOM_ICDF(26864),
        AOM_ICDF(30245), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5675), AOM_ICDF(7548), AOM_ICDF(9092), AOM_ICDF(11404),
        AOM_ICDF(12818), AOM_ICDF(14329), AOM_ICDF(15710), AOM_ICDF(17323),
        AOM_ICDF(20404), AOM_ICDF(22469), AOM_ICDF(24710), AOM_ICDF(27255),
        AOM_ICDF(30333), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8922), AOM_ICDF(9894), AOM_ICDF(11083), AOM_ICDF(12313),
        AOM_ICDF(13161), AOM_ICDF(14034), AOM_ICDF(14944), AOM_ICDF(16212),
        AOM_ICDF(17097), AOM_ICDF(19813), AOM_ICDF(23042), AOM_ICDF(25941),
        AOM_ICDF(30178), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6753), AOM_ICDF(8225), AOM_ICDF(9827), AOM_ICDF(11403),
        AOM_ICDF(12704), AOM_ICDF(14026), AOM_ICDF(15398), AOM_ICDF(17043),
        AOM_ICDF(18392), AOM_ICDF(20784), AOM_ICDF(24266), AOM_ICDF(26597),
        AOM_ICDF(30304), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7052), AOM_ICDF(8445), AOM_ICDF(9999), AOM_ICDF(11569),
        AOM_ICDF(12858), AOM_ICDF(14173), AOM_ICDF(15512), AOM_ICDF(17120),
        AOM_ICDF(18435), AOM_ICDF(20820), AOM_ICDF(23359), AOM_ICDF(26610),
        AOM_ICDF(30276), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6407), AOM_ICDF(8045), AOM_ICDF(9795), AOM_ICDF(11234),
        AOM_ICDF(12409), AOM_ICDF(13663), AOM_ICDF(14889), AOM_ICDF(16419),
        AOM_ICDF(17720), AOM_ICDF(19700), AOM_ICDF(22272), AOM_ICDF(24638),
        AOM_ICDF(30842), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(3828),  AOM_ICDF(8363),  AOM_ICDF(12440), AOM_ICDF(14128),
  AOM_ICDF(17929), AOM_ICDF(20173), AOM_ICDF(21100), AOM_ICDF(23112),
  AOM_ICDF(24975), AOM_ICDF(26709), AOM_ICDF(28549), AOM_ICDF(29795),
  AOM_ICDF(30850), AOM_ICDF(31813), AOM_ICDF(32768), 0
};
#endif
