...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(21850), AOM_ICDF(22210), AOM_ICDF(22884), AOM_ICDF(23346),
        AOM_ICDF(23587), AOM_ICDF(23832), AOM_ICDF(24125), AOM_ICDF(24671),
        AOM_ICDF(24931), AOM_ICDF(26133), AOM_ICDF(27170), AOM_ICDF(27931),
        AOM_ICDF(30047), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8005), AOM_ICDF(16594), AOM_ICDF(16888), AOM_ICDF(17349),
        AOM_ICDF(17670), AOM_ICDF(18618), AOM_ICDF(18820), AOM_ICDF(19087),
        AOM_ICDF(20058), AOM_ICDF(21744), AOM_ICDF(22697), AOM_ICDF(24246),
        AOM_ICDF(29391), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9403), AOM_ICDF(9531), AOM_ICDF(17697), AOM_ICDF(17945),
        AOM_ICDF(18168), AOM_ICDF(18299), AOM_ICDF(19063), AOM_ICDF(20218),
        AOM_ICDF(20354), AOM_ICDF(21875), AOM_ICDF(23442), AOM_ICDF(24218),
        AOM_ICDF(29491), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8028), AOM_ICDF(9072), AOM_ICDF(9952), AOM_ICDF(15469),
        AOM_ICDF(16331), AOM_ICDF(17175), AOM_ICDF(17937), AOM_ICDF(19816),
        AOM_ICDF(21499), AOM_ICDF(23685), AOM_ICDF(25128), AOM_ICDF(26626),
        AOM_ICDF(28377), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5896), AOM_ICDF(6848), AOM_ICDF(8089), AOM_ICDF(8878),
        AOM_ICDF(18823), AOM_ICDF(20457), AOM_ICDF(22406), AOM_ICDF(23268),
        AOM_ICDF(23915), AOM_ICDF(25878), AOM_ICDF(26960), AOM_ICDF(28000),
        AOM_ICDF(28866), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5333), AOM_ICDF(7136), AOM_ICDF(8010), AOM_ICDF(8886),
        AOM_ICDF(10997), AOM_ICDF(19976), AOM_ICDF(20881), AOM_ICDF(21704),
        AOM_ICDF(22599), AOM_ICDF(24717), AOM_ICDF(26143), AOM_ICDF(27559),
        AOM_ICDF(29033), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6875), AOM_ICDF(7485), AOM_ICDF(9456), AOM_ICDF(10108),
        AOM_ICDF(11829), AOM_ICDF(12514), AOM_ICDF(21473), AOM_ICDF(22346),
        AOM_ICDF(22886), AOM_ICDF(25050), AOM_ICDF(26411), AOM_ICDF(27624),
        AOM_ICDF(29054), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9834), AOM_ICDF(10212), AOM_ICDF(11588), AOM_ICDF(12711),
        AOM_ICDF(13208), AOM_ICDF(13571), AOM_ICDF(14181), AOM_ICDF(20811),
        AOM_ICDF(21297), AOM_ICDF(23451), AOM_ICDF(24991), AOM_ICDF(26093),
        AOM_ICDF(28173), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7675), AOM_ICDF(9096), AOM_ICDF(9690), AOM_ICDF(11390),
        AOM_ICDF(12039), AOM_ICDF(12792), AOM_ICDF(13329), AOM_ICDF(14217),
        AOM_ICDF(21115), AOM_ICDF(23328), AOM_ICDF(24693), AOM_ICDF(26208),
        AOM_ICDF(28148), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15273), AOM_ICDF(15771), AOM_ICDF(16678), AOM_ICDF(17251),
        AOM_ICDF(17706), AOM_ICDF(18110), AOM_ICDF(18633), AOM_ICDF(19434),
        AOM_ICDF(19869), AOM_ICDF(22954), AOM_ICDF(24672), AOM_ICDF(26117),
        AOM_ICDF(28591), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11405), AOM_ICDF(12438), AOM_ICDF(13612), AOM_ICDF(14456),
        AOM_ICDF(15201), AOM_ICDF(15933), AOM_ICDF(16714), AOM_ICDF(17791),
        AOM_ICDF(18592), AOM_ICDF(21431), AOM_ICDF(24268), AOM_ICDF(25513),
        AOM_ICDF(28305), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12344), AOM_ICDF(13087), AOM_ICDF(14538), AOM_ICDF(15365),
        AOM_ICDF(16065), AOM_ICDF(16693), AOM_ICDF(17491), AOM_ICDF(18597),
        AOM_ICDF(19269), AOM_ICDF(21990), AOM_ICDF(23365), AOM_ICDF(25795),
        AOM_ICDF(28229), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8290), AOM_ICDF(10223), AOM_ICDF(12681), AOM_ICDF(13364),
        AOM_ICDF(13883), AOM_ICDF(14447), AOM_ICDF(15032), AOM_ICDF(15939),
        AOM_ICDF(16629), AOM_ICDF(18359), AOM_ICDF(19907), AOM_ICDF(21241),
        AOM_ICDF(29814), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
