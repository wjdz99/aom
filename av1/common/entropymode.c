...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(18243), AOM_ICDF(18754), AOM_ICDF(19736), AOM_ICDF(20284),
        AOM_ICDF(20631), AOM_ICDF(20960), AOM_ICDF(21390), AOM_ICDF(22153),
        AOM_ICDF(22521), AOM_ICDF(24289), AOM_ICDF(25639), AOM_ICDF(26701),
        AOM_ICDF(28944), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6204), AOM_ICDF(15389), AOM_ICDF(15743), AOM_ICDF(16228),
        AOM_ICDF(16614), AOM_ICDF(17792), AOM_ICDF(18030), AOM_ICDF(18338),
        AOM_ICDF(19509), AOM_ICDF(21486), AOM_ICDF(22604), AOM_ICDF(24292),
        AOM_ICDF(28594), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7432), AOM_ICDF(7571), AOM_ICDF(16550), AOM_ICDF(16821),
        AOM_ICDF(17097), AOM_ICDF(17243), AOM_ICDF(18265), AOM_ICDF(19683),
        AOM_ICDF(19838), AOM_ICDF(21700), AOM_ICDF(23334), AOM_ICDF(24330),
        AOM_ICDF(28668), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6723), AOM_ICDF(7783), AOM_ICDF(8656), AOM_ICDF(14171),
        AOM_ICDF(15053), AOM_ICDF(15897), AOM_ICDF(16671), AOM_ICDF(18643),
        AOM_ICDF(20503), AOM_ICDF(22842), AOM_ICDF(24381), AOM_ICDF(25959),
        AOM_ICDF(27624), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4656), AOM_ICDF(5668), AOM_ICDF(6974), AOM_ICDF(7736),
        AOM_ICDF(17284), AOM_ICDF(19100), AOM_ICDF(21271), AOM_ICDF(22165),
        AOM_ICDF(22829), AOM_ICDF(24851), AOM_ICDF(25996), AOM_ICDF(27107),
        AOM_ICDF(27925), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4347), AOM_ICDF(6328), AOM_ICDF(7187), AOM_ICDF(8028),
        AOM_ICDF(10356), AOM_ICDF(19292), AOM_ICDF(20209), AOM_ICDF(21017),
        AOM_ICDF(21931), AOM_ICDF(24075), AOM_ICDF(25543), AOM_ICDF(27003),
        AOM_ICDF(28366), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5446), AOM_ICDF(6052), AOM_ICDF(8261), AOM_ICDF(8880),
        AOM_ICDF(10846), AOM_ICDF(11544), AOM_ICDF(20517), AOM_ICDF(21434),
        AOM_ICDF(21962), AOM_ICDF(24228), AOM_ICDF(25643), AOM_ICDF(26942),
        AOM_ICDF(28238), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8057), AOM_ICDF(8427), AOM_ICDF(10022), AOM_ICDF(11160),
        AOM_ICDF(11690), AOM_ICDF(12049), AOM_ICDF(12717), AOM_ICDF(19713),
        AOM_ICDF(20223), AOM_ICDF(22593), AOM_ICDF(24222), AOM_ICDF(25443),
        AOM_ICDF(27344), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6173), AOM_ICDF(7756), AOM_ICDF(8335), AOM_ICDF(10129),
        AOM_ICDF(10802), AOM_ICDF(11590), AOM_ICDF(12126), AOM_ICDF(13060),
        AOM_ICDF(20090), AOM_ICDF(22454), AOM_ICDF(23981), AOM_ICDF(25568),
        AOM_ICDF(27368), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12281), AOM_ICDF(12924), AOM_ICDF(14142), AOM_ICDF(14788),
        AOM_ICDF(15380), AOM_ICDF(15891), AOM_ICDF(16588), AOM_ICDF(17578),
        AOM_ICDF(18117), AOM_ICDF(21617), AOM_ICDF(23550), AOM_ICDF(25247),
        AOM_ICDF(27600), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9580), AOM_ICDF(10751), AOM_ICDF(12057), AOM_ICDF(12899),
        AOM_ICDF(13712), AOM_ICDF(14518), AOM_ICDF(15358), AOM_ICDF(16541),
        AOM_ICDF(17439), AOM_ICDF(20587), AOM_ICDF(23450), AOM_ICDF(24841),
        AOM_ICDF(27425), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10245), AOM_ICDF(11056), AOM_ICDF(12747), AOM_ICDF(13575),
        AOM_ICDF(14345), AOM_ICDF(15001), AOM_ICDF(15905), AOM_ICDF(17157),
        AOM_ICDF(17881), AOM_ICDF(20965), AOM_ICDF(22500), AOM_ICDF(25044),
        AOM_ICDF(27303), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6807), AOM_ICDF(9092), AOM_ICDF(12056), AOM_ICDF(12775),
        AOM_ICDF(13331), AOM_ICDF(13943), AOM_ICDF(14591), AOM_ICDF(15619),
        AOM_ICDF(16379), AOM_ICDF(18420), AOM_ICDF(20119), AOM_ICDF(21603),
        AOM_ICDF(29211), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(290),   AOM_ICDF(4084),  AOM_ICDF(7914),  AOM_ICDF(13300),
  AOM_ICDF(19458), AOM_ICDF(21294), AOM_ICDF(23641), AOM_ICDF(25060),
  AOM_ICDF(26195), AOM_ICDF(27456), AOM_ICDF(30098), AOM_ICDF(31022),
  AOM_ICDF(31732), AOM_ICDF(32304), AOM_ICDF(32768), 0,
};
#endif
