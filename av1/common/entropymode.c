...
static const aom_prob default_inter_singleref_comp_mode_probs
    [INTER_MODE_CONTEXTS][INTER_SINGLEREF_COMP_MODES - 1] = {
      { 2, 173, 180 },  // 0 = both zero mv
      { 7, 145, 80 },   // 1 = 1 zero + 1 predicted
      { 7, 166, 130 },  // 2 = two predicted mvs
      { 7, 94, 126 },   // 3 = 1 pred/zero, 1 new
      { 8, 64, 180 },   // 4 = two new mvs
      { 17, 81, 170 },  // 5 = one intra neighbour
      { 25, 29, 170 },  // 6 = two intra neighbours
    };
