...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(202),   AOM_ICDF(2673),  AOM_ICDF(5812),  AOM_ICDF(14457),
  AOM_ICDF(20789), AOM_ICDF(22141), AOM_ICDF(25439), AOM_ICDF(26522),
  AOM_ICDF(27327), AOM_ICDF(28278), AOM_ICDF(31139), AOM_ICDF(31603),
  AOM_ICDF(32111), AOM_ICDF(32538), AOM_ICDF(32768), 0
};
#endif
