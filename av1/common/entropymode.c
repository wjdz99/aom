...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21007), AOM_ICDF(24352), AOM_ICDF(25895), AOM_ICDF(27339),
  AOM_ICDF(28375), AOM_ICDF(29268), AOM_ICDF(29877), AOM_ICDF(30407),
  AOM_ICDF(30908), AOM_ICDF(31321), AOM_ICDF(31718), AOM_ICDF(32066),
  AOM_ICDF(32330), AOM_ICDF(32543), AOM_ICDF(32669), AOM_ICDF(32768)
};
#endif
