...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(9597), AOM_ICDF(10870), AOM_ICDF(12782), AOM_ICDF(13973),
        AOM_ICDF(14971), AOM_ICDF(15908), AOM_ICDF(17046), AOM_ICDF(18594),
        AOM_ICDF(19560), AOM_ICDF(22224), AOM_ICDF(24309), AOM_ICDF(26217),
        AOM_ICDF(28337), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4745), AOM_ICDF(10978), AOM_ICDF(11930), AOM_ICDF(13000),
        AOM_ICDF(13915), AOM_ICDF(15780), AOM_ICDF(16457), AOM_ICDF(17263),
        AOM_ICDF(19095), AOM_ICDF(21592), AOM_ICDF(23390), AOM_ICDF(25339),
        AOM_ICDF(28467), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5293), AOM_ICDF(5862), AOM_ICDF(12224), AOM_ICDF(12947),
        AOM_ICDF(13735), AOM_ICDF(14260), AOM_ICDF(16053), AOM_ICDF(18298),
        AOM_ICDF(18817), AOM_ICDF(21395), AOM_ICDF(23411), AOM_ICDF(25227),
        AOM_ICDF(28436), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4554), AOM_ICDF(6306), AOM_ICDF(7877), AOM_ICDF(11872),
        AOM_ICDF(13299), AOM_ICDF(14682), AOM_ICDF(15994), AOM_ICDF(18033),
        AOM_ICDF(20191), AOM_ICDF(22681), AOM_ICDF(24562), AOM_ICDF(26451),
        AOM_ICDF(28270), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3992), AOM_ICDF(5546), AOM_ICDF(7317), AOM_ICDF(8576),
        AOM_ICDF(14067), AOM_ICDF(16229), AOM_ICDF(18592), AOM_ICDF(20030),
        AOM_ICDF(21253), AOM_ICDF(23583), AOM_ICDF(25238), AOM_ICDF(26857),
        AOM_ICDF(28182), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3566), AOM_ICDF(5957), AOM_ICDF(7379), AOM_ICDF(8740),
        AOM_ICDF(11263), AOM_ICDF(16801), AOM_ICDF(18233), AOM_ICDF(19561),
        AOM_ICDF(21028), AOM_ICDF(23388), AOM_ICDF(25269), AOM_ICDF(27033),
        AOM_ICDF(28644), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4143), AOM_ICDF(5332), AOM_ICDF(7932), AOM_ICDF(9055),
        AOM_ICDF(11434), AOM_ICDF(12664), AOM_ICDF(18233), AOM_ICDF(19757),
        AOM_ICDF(20810), AOM_ICDF(23260), AOM_ICDF(25027), AOM_ICDF(26816),
        AOM_ICDF(28403), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5152), AOM_ICDF(6115), AOM_ICDF(8603), AOM_ICDF(10082),
        AOM_ICDF(11189), AOM_ICDF(12059), AOM_ICDF(13359), AOM_ICDF(18344),
        AOM_ICDF(19360), AOM_ICDF(22035), AOM_ICDF(23986), AOM_ICDF(25771),
        AOM_ICDF(27754), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4528), AOM_ICDF(6765), AOM_ICDF(8034), AOM_ICDF(10169),
        AOM_ICDF(11383), AOM_ICDF(12729), AOM_ICDF(13792), AOM_ICDF(15151),
        AOM_ICDF(19747), AOM_ICDF(22292), AOM_ICDF(24200), AOM_ICDF(26071),
        AOM_ICDF(27957), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6884), AOM_ICDF(8254), AOM_ICDF(10273), AOM_ICDF(11458),
        AOM_ICDF(12693), AOM_ICDF(13780), AOM_ICDF(15180), AOM_ICDF(16874),
        AOM_ICDF(17973), AOM_ICDF(21247), AOM_ICDF(23498), AOM_ICDF(25618),
        AOM_ICDF(27745), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5774), AOM_ICDF(7564), AOM_ICDF(9481), AOM_ICDF(10822),
        AOM_ICDF(12211), AOM_ICDF(13576), AOM_ICDF(14972), AOM_ICDF(16689),
        AOM_ICDF(18131), AOM_ICDF(21188), AOM_ICDF(23789), AOM_ICDF(25676),
        AOM_ICDF(27895), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5996), AOM_ICDF(7447), AOM_ICDF(9633), AOM_ICDF(10981),
        AOM_ICDF(12339), AOM_ICDF(13538), AOM_ICDF(15046), AOM_ICDF(16878),
        AOM_ICDF(18150), AOM_ICDF(21166), AOM_ICDF(23142), AOM_ICDF(25622),
        AOM_ICDF(27778), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4560), AOM_ICDF(7301), AOM_ICDF(10621), AOM_ICDF(11877),
        AOM_ICDF(13008), AOM_ICDF(14188), AOM_ICDF(15421), AOM_ICDF(17083),
        AOM_ICDF(18405), AOM_ICDF(20924), AOM_ICDF(22971), AOM_ICDF(24901),
        AOM_ICDF(29150), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
