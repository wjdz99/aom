...
#if CONFIG_REDUCED_SEPTX_SET && 0
      // For those disabled transforms, we reduce the overhead to minimal
      {
          {
              { AOM_CDF7(1, 8035, 8036, 12751, 23467, 27825) },
              { AOM_CDF7(1, 3335, 9709, 9710, 18143, 28094) },
              { AOM_CDF7(1, 3247, 3248, 11982, 19415, 23127) },
              { AOM_CDF7(5279, 13885, 13886, 13887, 23527, 30252) },
              { AOM_CDF7(1, 6074, 6075, 10416, 25693, 29298) },
              { AOM_CDF7(1, 4241, 9460, 9461, 16456, 27694) },
              { AOM_CDF7(1, 2838, 2839, 6737, 18058, 23754) },
              { AOM_CDF7(1, 4233, 4234, 11670, 20281, 24377) },
              { AOM_CDF7(1, 4312, 8647, 8648, 18644, 29335) },
              { AOM_CDF7(1, 3734, 3735, 7298, 17127, 24016) },
              { AOM_CDF7(1, 4312, 6819, 6820, 16010, 23858) },
              { AOM_CDF7(1, 4369, 4370, 8905, 16465, 22271) },
              { AOM_CDF7(1, 2, 10599, 15599, 19687, 24040) },
          },
          {
              { AOM_CDF7(1, 13742, 13743, 16498, 23770, 27698) },
              { AOM_CDF7(1, 8796, 14632, 14633, 19272, 27486) },
              { AOM_CDF7(1, 7576, 7577, 14443, 19159, 22591) },
              { AOM_CDF7(1126, 15340, 15341, 15342, 20896, 30279) },
              { AOM_CDF7(1, 4854, 4855, 5913, 22099, 27138) },
              { AOM_CDF7(1, 6458, 8885, 8886, 14851, 25497) },
              { AOM_CDF7(1, 5295, 5296, 6885, 16107, 22672) },
              { AOM_CDF7(1, 8059, 8060, 11258, 17289, 21549) },
              { AOM_CDF7(1, 7580, 9318, 9319, 16688, 29046) },
              { AOM_CDF7(1, 7406, 7407, 9195, 16041, 23329) },
              { AOM_CDF7(1, 7974, 9357, 9358, 15629, 24474) },
              { AOM_CDF7(1, 7647, 7648, 9936, 15307, 19996) },
              { AOM_CDF7(1, 2, 11165, 15335, 19323, 23594) },
          },
          {
