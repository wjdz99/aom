...
static const aom_cdf_prob default_if_y_mode_cdf[BLOCK_SIZE_GROUPS][CDF_SIZE(
    INTRA_MODES)] = {{AOM_CDF13(24975, 25352, 25654, 26033, 26771, 27386, 27801,
                                28309, 28921, 29694, 30117, 30490)},
                     {AOM_CDF13(20453, 21881, 23149, 23878, 24884, 26167, 27021,
                                27805, 28959, 29864, 30223, 30609)},
                     {AOM_CDF13(22761, 23722, 24738, 25172, 25575, 26266, 26705,
                                27243, 27938, 28787, 29203, 29632)},
                     {AOM_CDF13(21237, 22210, 23020, 23199, 23335, 23897, 24154,
                                24508, 24926, 25972, 26483, 27019)}};
...
static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_ALPHA_CONTEXTS][CDF_SIZE(CFL_ALPHABET_SIZE)] = {
        ...
        {AOM_CDF16(14044, 23806, 27936, 31184, 32281, 32481, 32553, 32615,
                   32654, 32671, 32675, 32679, 32683, 32687, 32691)},
        {AOM_CDF16(11595, 22138, 28230, 31272, 32368, 32550, 32608, 32680,
                   32684, 32688, 32692, 32696, 32700, 32704, 32708)},
        {AOM_CDF16(27495, 31600, 32363, 32609, 32692, 32696, 32700, 32704,
                   32708, 32712, 32716, 32720, 32724, 32728, 32732)},
        {AOM_CDF16(16832, 26229, 29023, 30684, 31357, 31918, 32176, 32330,
                   32398, 32445, 32479, 32512, 32524, 32536, 32559)},
        {AOM_CDF16(14660, 21151, 25650, 27722, 28652, 30259, 30908, 31838,
                   32088, 32456, 32523, 32586, 32634, 32656, 32660)}};
...
static const aom_cdf_prob default_interintra_cdf[BLOCK_SIZE_GROUPS][CDF_SIZE(
    2)] = {
    {AOM_CDF2(16384)}, {AOM_CDF2(27607)}, {AOM_CDF2(29105)}, {AOM_CDF2(30255)}};
...
static const aom_cdf_prob default_compound_type_cdf[BLOCK_SIZES_ALL][CDF_SIZE(
    COMPOUND_TYPES - 1)] = {
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(25417)},
    {AOM_CDF2(15692)}, {AOM_CDF2(13385)}, {AOM_CDF2(12225)}, {AOM_CDF2(11603)},
    {AOM_CDF2(9812)},  {AOM_CDF2(8010)},  {AOM_CDF2(16384)}, {AOM_CDF2(16384)},
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)},
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(14303)}, {AOM_CDF2(9897)},
...
static const aom_cdf_prob default_wedge_idx_cdf[BLOCK_SIZES_ALL][CDF_SIZE(16)] =
    {{AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
     ...
     {AOM_CDF16(1495, 3627, 5853, 7232, 9360, 11472, 14685, 17633, 19324, 20866,
                22920, 24360, 26572, 28524, 30885)},
     ...
     {AOM_CDF16(1570, 3636, 5830, 7422, 9625, 12444, 15841, 19097, 20525, 21747,
                24030, 25346, 27055, 28800, 31179)},
     {AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                20480, 22528, 24576, 26624, 28672, 30720)},
     {AOM_CDF16(2048, 4096, 6144, 8192, 10240, 12288, 14336, 16384, 18432,
                20480, 22528, 24576, 26624, 28672, 30720)},
...
static const aom_cdf_prob default_obmc_cdf[BLOCK_SIZES_ALL][CDF_SIZE(2)] = {
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16763)},
    {AOM_CDF2(9986)},  {AOM_CDF2(7171)},  {AOM_CDF2(24515)}, {AOM_CDF2(9319)},
    {AOM_CDF2(10944)}, {AOM_CDF2(29115)}, {AOM_CDF2(21683)}, {AOM_CDF2(22739)},
    {AOM_CDF2(30959)}, {AOM_CDF2(29509)}, {AOM_CDF2(31401)}, {AOM_CDF2(32706)},
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(25171)}, {AOM_CDF2(26100)},
    {AOM_CDF2(25536)}, {AOM_CDF2(29364)}};
...
const aom_cdf_prob default_palette_y_size_cdf[PALATTE_BSIZE_CTXS][CDF_SIZE(
...
static const aom_cdf_prob default_intrabc_cdf[CDF_SIZE(2)] = {AOM_CDF2(30461)};
...
static const aom_cdf_prob default_filter_intra_cdfs[BLOCK_SIZES_ALL][CDF_SIZE(
    2)] = {
    {AOM_CDF2(3641)},  {AOM_CDF2(6651)},  {AOM_CDF2(6067)},  {AOM_CDF2(8525)},
    {AOM_CDF2(12952)}, {AOM_CDF2(11751)}, {AOM_CDF2(14349)}, {AOM_CDF2(14609)},
    {AOM_CDF2(14573)}, {AOM_CDF2(22184)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)},
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)}, {AOM_CDF2(16384)},
    {AOM_CDF2(13619)}, {AOM_CDF2(10567)}, {AOM_CDF2(21537)}, {AOM_CDF2(18888)},
    {AOM_CDF2(16384)}, {AOM_CDF2(16384)}};
