...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_ICDF(931),   AOM_ICDF(1657),  AOM_ICDF(6819),
  AOM_ICDF(11015), AOM_ICDF(24515), AOM_ICDF(25251),
  AOM_ICDF(32393), AOM_ICDF(32768), 0
};
...
static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_JOINT_SIGNS][CFL_PRED_PLANES][CDF_SIZE(
        UV_ALPHABET_SIZE)] = {
      { { 0 },
        { AOM_ICDF(12018), AOM_ICDF(23159), AOM_ICDF(28187), AOM_ICDF(30402),
          AOM_ICDF(31294), AOM_ICDF(31904), AOM_ICDF(32189), AOM_ICDF(32390),
          AOM_ICDF(32477), AOM_ICDF(32635), AOM_ICDF(32718), AOM_ICDF(32742),
          AOM_ICDF(32758), AOM_ICDF(32761), AOM_ICDF(32766), AOM_ICDF(32768),
          0 } },
      { { 0 },
        { AOM_ICDF(20502), AOM_ICDF(27482), AOM_ICDF(29915), AOM_ICDF(31278),
          AOM_ICDF(31907), AOM_ICDF(32096), AOM_ICDF(32161), AOM_ICDF(32427),
          AOM_ICDF(32449), AOM_ICDF(32500), AOM_ICDF(32548), AOM_ICDF(32557),
          AOM_ICDF(32586), AOM_ICDF(32591), AOM_ICDF(32602), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(5421), AOM_ICDF(13741), AOM_ICDF(19297), AOM_ICDF(26651),
          AOM_ICDF(30726), AOM_ICDF(31982), AOM_ICDF(32501), AOM_ICDF(32694),
          AOM_ICDF(32735), AOM_ICDF(32754), AOM_ICDF(32761), AOM_ICDF(32762),
          AOM_ICDF(32764), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768),
          0 },
        { 0 } },
      { { AOM_ICDF(5100), AOM_ICDF(10269), AOM_ICDF(15683), AOM_ICDF(20801),
          AOM_ICDF(25256), AOM_ICDF(28444), AOM_ICDF(30421), AOM_ICDF(32129),
          AOM_ICDF(32503), AOM_ICDF(32656), AOM_ICDF(32704), AOM_ICDF(32728),
          AOM_ICDF(32737), AOM_ICDF(32741), AOM_ICDF(32746), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(14639), AOM_ICDF(23450), AOM_ICDF(27051), AOM_ICDF(29126),
          AOM_ICDF(30268), AOM_ICDF(30902), AOM_ICDF(31321), AOM_ICDF(31884),
          AOM_ICDF(32089), AOM_ICDF(32415), AOM_ICDF(32582), AOM_ICDF(32652),
          AOM_ICDF(32689), AOM_ICDF(32707), AOM_ICDF(32721), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(2373), AOM_ICDF(10569), AOM_ICDF(17456), AOM_ICDF(22895),
          AOM_ICDF(26348), AOM_ICDF(28551), AOM_ICDF(29820), AOM_ICDF(31748),
          AOM_ICDF(32253), AOM_ICDF(32456), AOM_ICDF(32553), AOM_ICDF(32609),
          AOM_ICDF(32638), AOM_ICDF(32655), AOM_ICDF(32674), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(10839), AOM_ICDF(20341), AOM_ICDF(24793), AOM_ICDF(27751),
          AOM_ICDF(29366), AOM_ICDF(30239), AOM_ICDF(30758), AOM_ICDF(31547),
          AOM_ICDF(31754), AOM_ICDF(31958), AOM_ICDF(32097), AOM_ICDF(32228),
          AOM_ICDF(32293), AOM_ICDF(32340), AOM_ICDF(32392), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(11691), AOM_ICDF(23665), AOM_ICDF(27819), AOM_ICDF(30715),
          AOM_ICDF(31931), AOM_ICDF(32294), AOM_ICDF(32481), AOM_ICDF(32657),
          AOM_ICDF(32687), AOM_ICDF(32714), AOM_ICDF(32734), AOM_ICDF(32738),
          AOM_ICDF(32761), AOM_ICDF(32763), AOM_ICDF(32764), AOM_ICDF(32768),
          0 },
        { 0 } },
      { { AOM_ICDF(9973), AOM_ICDF(19089), AOM_ICDF(24097), AOM_ICDF(27393),
          AOM_ICDF(29105), AOM_ICDF(30162), AOM_ICDF(30775), AOM_ICDF(31563),
          AOM_ICDF(31798), AOM_ICDF(31996), AOM_ICDF(32134), AOM_ICDF(32267),
          AOM_ICDF(32329), AOM_ICDF(32375), AOM_ICDF(32439), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(6215), AOM_ICDF(15188), AOM_ICDF(21147), AOM_ICDF(25326),
          AOM_ICDF(27636), AOM_ICDF(28871), AOM_ICDF(29685), AOM_ICDF(31017),
          AOM_ICDF(31478), AOM_ICDF(32142), AOM_ICDF(32423), AOM_ICDF(32541),
          AOM_ICDF(32585), AOM_ICDF(32613), AOM_ICDF(32641), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(6158), AOM_ICDF(14522), AOM_ICDF(20099), AOM_ICDF(23931),
          AOM_ICDF(26350), AOM_ICDF(27943), AOM_ICDF(29006), AOM_ICDF(30076),
          AOM_ICDF(30551), AOM_ICDF(31018), AOM_ICDF(31301), AOM_ICDF(31560),
          AOM_ICDF(31651), AOM_ICDF(31751), AOM_ICDF(31896), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(13953), AOM_ICDF(22087), AOM_ICDF(25532), AOM_ICDF(27586),
          AOM_ICDF(29115), AOM_ICDF(29879), AOM_ICDF(30436), AOM_ICDF(31104),
          AOM_ICDF(31370), AOM_ICDF(31673), AOM_ICDF(31848), AOM_ICDF(32050),
          AOM_ICDF(32150), AOM_ICDF(32216), AOM_ICDF(32286), AOM_ICDF(32768),
          0 } }
    };
#endif
