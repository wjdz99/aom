...
/*static const aom_cdf_prob
default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
  { AOM_ICDF(18443), AOM_ICDF(20246), AOM_ICDF(22594), AOM_ICDF(22902), AOM_ICDF(23322), AOM_ICDF(23950), AOM_ICDF(24632), AOM_ICDF(25716), AOM_ICDF(26299), AOM_ICDF(29355), AOM_ICDF(30638), AOM_ICDF(31672), AOM_ICDF(32768), 0 },
  { AOM_ICDF(5887), AOM_ICDF(24265), AOM_ICDF(24883), AOM_ICDF(25064), AOM_ICDF(25244), AOM_ICDF(26186), AOM_ICDF(26309), AOM_ICDF(26521), AOM_ICDF(27306), AOM_ICDF(29374), AOM_ICDF(30097), AOM_ICDF(31611), AOM_ICDF(32768), 0 },
  { AOM_ICDF(7975), AOM_ICDF(8364), AOM_ICDF(25623), AOM_ICDF(25787), AOM_ICDF(25978), AOM_ICDF(26140), AOM_ICDF(26892), AOM_ICDF(28380), AOM_ICDF(28544), AOM_ICDF(30069), AOM_ICDF(31130), AOM_ICDF(31718), AOM_ICDF(32768), 0 },
  { AOM_ICDF(15565), AOM_ICDF(17000), AOM_ICDF(17885), AOM_ICDF(23238), AOM_ICDF(23573), AOM_ICDF(24044), AOM_ICDF(24281), AOM_ICDF(26043), AOM_ICDF(28497), AOM_ICDF(30759), AOM_ICDF(31497), AOM_ICDF(32354), AOM_ICDF(32768), 0 },
  { AOM_ICDF(14429), AOM_ICDF(15019), AOM_ICDF(15770), AOM_ICDF(15904), AOM_ICDF(26017), AOM_ICDF(27765), AOM_ICDF(29371), AOM_ICDF(29856), AOM_ICDF(30090), AOM_ICDF(31585), AOM_ICDF(32125), AOM_ICDF(32629), AOM_ICDF(32768), 0 },
  { AOM_ICDF(12629), AOM_ICDF(15073), AOM_ICDF(15701), AOM_ICDF(15867), AOM_ICDF(17806), AOM_ICDF(29059), AOM_ICDF(29420), AOM_ICDF(29805), AOM_ICDF(30214), AOM_ICDF(31448), AOM_ICDF(31906), AOM_ICDF(32425), AOM_ICDF(32768), 0 },
  { AOM_ICDF(14965), AOM_ICDF(15629), AOM_ICDF(18499), AOM_ICDF(18648), AOM_ICDF(20601), AOM_ICDF(21064), AOM_ICDF(28553), AOM_ICDF(29222), AOM_ICDF(29480), AOM_ICDF(31202), AOM_ICDF(31882), AOM_ICDF(32499), AOM_ICDF(32768), 0 },
  { AOM_ICDF(14534), AOM_ICDF(15117), AOM_ICDF(18411), AOM_ICDF(19240), AOM_ICDF(19595), AOM_ICDF(19882), AOM_ICDF(20328), AOM_ICDF(27454), AOM_ICDF(28035), AOM_ICDF(30493), AOM_ICDF(31614), AOM_ICDF(32248), AOM_ICDF(32768), 0 },
  { AOM_ICDF(12137), AOM_ICDF(15165), AOM_ICDF(15885), AOM_ICDF(17110), AOM_ICDF(17442), AOM_ICDF(18062), AOM_ICDF(18298), AOM_ICDF(18991), AOM_ICDF(27683), AOM_ICDF(30297), AOM_ICDF(31058), AOM_ICDF(32197), AOM_ICDF(32768), 0 },
  { AOM_ICDF(16403), AOM_ICDF(18230), AOM_ICDF(19915), AOM_ICDF(20382), AOM_ICDF(20888), AOM_ICDF(21306), AOM_ICDF(21892), AOM_ICDF(23212), AOM_ICDF(24019), AOM_ICDF(28738), AOM_ICDF(30492), AOM_ICDF(32198), AOM_ICDF(32768), 0 },
  { AOM_ICDF(15824), AOM_ICDF(18864), AOM_ICDF(20472), AOM_ICDF(20918), AOM_ICDF(21424), AOM_ICDF(21878), AOM_ICDF(22330), AOM_ICDF(23275), AOM_ICDF(24266), AOM_ICDF(28423), AOM_ICDF(30881), AOM_ICDF(32123), AOM_ICDF(32768), 0 },
  { AOM_ICDF(16138), AOM_ICDF(17693), AOM_ICDF(20553), AOM_ICDF(20998), AOM_ICDF(21457), AOM_ICDF(21734), AOM_ICDF(22436), AOM_ICDF(23967), AOM_ICDF(24576), AOM_ICDF(28674), AOM_ICDF(29923), AOM_ICDF(32178), AOM_ICDF(32768), 0 },
  { AOM_ICDF(15489), AOM_ICDF(19881), AOM_ICDF(23803), AOM_ICDF(23954), AOM_ICDF(24088), AOM_ICDF(24425), AOM_ICDF(24661), AOM_ICDF(25235), AOM_ICDF(25715), AOM_ICDF(27337), AOM_ICDF(28150), AOM_ICDF(29051), AOM_ICDF(32768), 0 }
};*/

static const aom_cdf_prob
default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
  { AOM_ICDF(17902), AOM_ICDF(18828), AOM_ICDF(21117), AOM_ICDF(21487), AOM_ICDF(21924), AOM_ICDF(22484), AOM_ICDF(23588), AOM_ICDF(24669), AOM_ICDF(25177), AOM_ICDF(28731), AOM_ICDF(29903), AOM_ICDF(31509), AOM_ICDF(32768), 0 },
  { AOM_ICDF(9654), AOM_ICDF(23559), AOM_ICDF(23873), AOM_ICDF(24050), AOM_ICDF(24203), AOM_ICDF(24929), AOM_ICDF(25057), AOM_ICDF(25286), AOM_ICDF(26027), AOM_ICDF(28172), AOM_ICDF(28716), AOM_ICDF(30913), AOM_ICDF(32768), 0 },
  { AOM_ICDF(10012), AOM_ICDF(10124), AOM_ICDF(25394), AOM_ICDF(25540), AOM_ICDF(25665), AOM_ICDF(25752), AOM_ICDF(26567), AOM_ICDF(27761), AOM_ICDF(27876), AOM_ICDF(29497), AOM_ICDF(30581), AOM_ICDF(31179), AOM_ICDF(32768), 0 },
  { AOM_ICDF(15143), AOM_ICDF(15859), AOM_ICDF(16581), AOM_ICDF(21567), AOM_ICDF(21968), AOM_ICDF(22430), AOM_ICDF(22867), AOM_ICDF(24953), AOM_ICDF(26969), AOM_ICDF(30310), AOM_ICDF(31125), AOM_ICDF(32329), AOM_ICDF(32768), 0 },
  { AOM_ICDF(14063), AOM_ICDF(14416), AOM_ICDF(14921), AOM_ICDF(15022), AOM_ICDF(25164), AOM_ICDF(26720), AOM_ICDF(28661), AOM_ICDF(29083), AOM_ICDF(29277), AOM_ICDF(31337), AOM_ICDF(31882), AOM_ICDF(32565), AOM_ICDF(32768), 0 },
  { AOM_ICDF(12942), AOM_ICDF(14713), AOM_ICDF(15178), AOM_ICDF(15325), AOM_ICDF(16964), AOM_ICDF(27421), AOM_ICDF(27834), AOM_ICDF(28306), AOM_ICDF(28645), AOM_ICDF(30804), AOM_ICDF(31322), AOM_ICDF(32387), AOM_ICDF(32768), 0 },
  { AOM_ICDF(13687), AOM_ICDF(13993), AOM_ICDF(16776), AOM_ICDF(16912), AOM_ICDF(18338), AOM_ICDF(18648), AOM_ICDF(27557), AOM_ICDF(28140), AOM_ICDF(28359), AOM_ICDF(30820), AOM_ICDF(31669), AOM_ICDF(32443), AOM_ICDF(32768), 0 },
  { AOM_ICDF(14180), AOM_ICDF(14439), AOM_ICDF(16582), AOM_ICDF(17373), AOM_ICDF(17675), AOM_ICDF(17931), AOM_ICDF(18453), AOM_ICDF(26308), AOM_ICDF(26761), AOM_ICDF(30058), AOM_ICDF(31293), AOM_ICDF(32156), AOM_ICDF(32768), 0 },
  { AOM_ICDF(12480), AOM_ICDF(14300), AOM_ICDF(14838), AOM_ICDF(16085), AOM_ICDF(16434), AOM_ICDF(17023), AOM_ICDF(17426), AOM_ICDF(18313), AOM_ICDF(26041), AOM_ICDF(29653), AOM_ICDF(30347), AOM_ICDF(32067), AOM_ICDF(32768), 0 },
  { AOM_ICDF(17202), AOM_ICDF(18093), AOM_ICDF(19414), AOM_ICDF(19910), AOM_ICDF(20311), AOM_ICDF(20837), AOM_ICDF(21554), AOM_ICDF(22830), AOM_ICDF(23572), AOM_ICDF(28770), AOM_ICDF(30259), AOM_ICDF(32145), AOM_ICDF(32768), 0 },
  { AOM_ICDF(16336), AOM_ICDF(18149), AOM_ICDF(19485), AOM_ICDF(19927), AOM_ICDF(20365), AOM_ICDF(20924), AOM_ICDF(21524), AOM_ICDF(22561), AOM_ICDF(23421), AOM_ICDF(28141), AOM_ICDF(30701), AOM_ICDF(32020), AOM_ICDF(32768), 0 },
  { AOM_ICDF(16485), AOM_ICDF(17366), AOM_ICDF(19874), AOM_ICDF(20364), AOM_ICDF(20713), AOM_ICDF(21057), AOM_ICDF(21773), AOM_ICDF(23100), AOM_ICDF(23685), AOM_ICDF(28079), AOM_ICDF(29091), AOM_ICDF(32028), AOM_ICDF(32768), 0 },
  { AOM_ICDF(13638), AOM_ICDF(16789), AOM_ICDF(19763), AOM_ICDF(19903), AOM_ICDF(19995), AOM_ICDF(20201), AOM_ICDF(20405), AOM_ICDF(20861), AOM_ICDF(21174), AOM_ICDF(22802), AOM_ICDF(23566), AOM_ICDF(24754), AOM_ICDF(32768), 0 }
};
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
/*      { { AOM_ICDF(13847), AOM_ICDF(15972), AOM_ICDF(18546), AOM_ICDF(19109),
      ...
      { { AOM_ICDF(10085), AOM_ICDF(14580), AOM_ICDF(17195), AOM_ICDF(17500),
        ...
        { AOM_ICDF(6958), AOM_ICDF(10404), AOM_ICDF(14086), AOM_ICDF(14401),
          ...
          AOM_ICDF(32768), 0 } }*/
        {
          { AOM_ICDF(14683), AOM_ICDF(16164), AOM_ICDF(18655), AOM_ICDF(19530), AOM_ICDF(20058), AOM_ICDF(20712), AOM_ICDF(21844), AOM_ICDF(23569), AOM_ICDF(24762), AOM_ICDF(29323), AOM_ICDF(30502), AOM_ICDF(32305), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12656), AOM_ICDF(20348), AOM_ICDF(21294), AOM_ICDF(21804), AOM_ICDF(22202), AOM_ICDF(23095), AOM_ICDF(23587), AOM_ICDF(24461), AOM_ICDF(25907), AOM_ICDF(29190), AOM_ICDF(30652), AOM_ICDF(31811), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9503), AOM_ICDF(9951), AOM_ICDF(23007), AOM_ICDF(23314), AOM_ICDF(23541), AOM_ICDF(23705), AOM_ICDF(24951), AOM_ICDF(26524), AOM_ICDF(26849), AOM_ICDF(29605), AOM_ICDF(30141), AOM_ICDF(31999), AOM_ICDF(32768), 0 },
          { AOM_ICDF(13260), AOM_ICDF(14061), AOM_ICDF(15139), AOM_ICDF(17906), AOM_ICDF(18255), AOM_ICDF(18765), AOM_ICDF(19485), AOM_ICDF(22590), AOM_ICDF(24686), AOM_ICDF(29535), AOM_ICDF(30788), AOM_ICDF(32556), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9636), AOM_ICDF(10707), AOM_ICDF(11584), AOM_ICDF(12180), AOM_ICDF(19805), AOM_ICDF(22417), AOM_ICDF(24821), AOM_ICDF(25934), AOM_ICDF(26829), AOM_ICDF(30447), AOM_ICDF(31325), AOM_ICDF(32571), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11503), AOM_ICDF(14182), AOM_ICDF(15005), AOM_ICDF(15716), AOM_ICDF(17312), AOM_ICDF(22822), AOM_ICDF(23813), AOM_ICDF(24939), AOM_ICDF(26485), AOM_ICDF(30176), AOM_ICDF(31386), AOM_ICDF(32491), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10780), AOM_ICDF(11415), AOM_ICDF(14363), AOM_ICDF(14834), AOM_ICDF(16619), AOM_ICDF(17205), AOM_ICDF(23514), AOM_ICDF(24954), AOM_ICDF(25580), AOM_ICDF(29808), AOM_ICDF(30651), AOM_ICDF(32535), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10987), AOM_ICDF(11732), AOM_ICDF(14421), AOM_ICDF(15496), AOM_ICDF(15957), AOM_ICDF(16409), AOM_ICDF(17580), AOM_ICDF(23241), AOM_ICDF(24331), AOM_ICDF(29195), AOM_ICDF(30353), AOM_ICDF(32508), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12508), AOM_ICDF(14242), AOM_ICDF(15162), AOM_ICDF(16631), AOM_ICDF(17071), AOM_ICDF(17984), AOM_ICDF(18776), AOM_ICDF(20784), AOM_ICDF(24151), AOM_ICDF(29108), AOM_ICDF(30867), AOM_ICDF(32444), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12829), AOM_ICDF(14161), AOM_ICDF(16064), AOM_ICDF(16898), AOM_ICDF(17478), AOM_ICDF(18230), AOM_ICDF(19432), AOM_ICDF(21587), AOM_ICDF(22866), AOM_ICDF(28544), AOM_ICDF(30194), AOM_ICDF(32428), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12573), AOM_ICDF(14467), AOM_ICDF(16431), AOM_ICDF(17241), AOM_ICDF(17858), AOM_ICDF(18791), AOM_ICDF(19760), AOM_ICDF(21697), AOM_ICDF(22982), AOM_ICDF(28322), AOM_ICDF(30394), AOM_ICDF(32214), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12584), AOM_ICDF(13813), AOM_ICDF(16632), AOM_ICDF(17412), AOM_ICDF(17891), AOM_ICDF(18453), AOM_ICDF(19775), AOM_ICDF(21906), AOM_ICDF(22973), AOM_ICDF(28492), AOM_ICDF(29852), AOM_ICDF(32414), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10371), AOM_ICDF(13033), AOM_ICDF(17420), AOM_ICDF(17894), AOM_ICDF(18176), AOM_ICDF(18567), AOM_ICDF(19210), AOM_ICDF(20319), AOM_ICDF(21090), AOM_ICDF(24048), AOM_ICDF(25125), AOM_ICDF(26632), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(9051), AOM_ICDF(21642), AOM_ICDF(22328), AOM_ICDF(22666), AOM_ICDF(22990), AOM_ICDF(24191), AOM_ICDF(24466), AOM_ICDF(25094), AOM_ICDF(26458), AOM_ICDF(29094), AOM_ICDF(30542), AOM_ICDF(31304), AOM_ICDF(32768), 0 },
          { AOM_ICDF(5783), AOM_ICDF(26271), AOM_ICDF(26458), AOM_ICDF(26655), AOM_ICDF(26792), AOM_ICDF(27507), AOM_ICDF(27595), AOM_ICDF(27910), AOM_ICDF(29012), AOM_ICDF(30270), AOM_ICDF(31322), AOM_ICDF(31740), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9084), AOM_ICDF(14570), AOM_ICDF(20536), AOM_ICDF(20922), AOM_ICDF(21174), AOM_ICDF(21685), AOM_ICDF(22190), AOM_ICDF(23274), AOM_ICDF(24293), AOM_ICDF(26854), AOM_ICDF(27998), AOM_ICDF(29451), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9162), AOM_ICDF(15547), AOM_ICDF(16132), AOM_ICDF(18428), AOM_ICDF(19036), AOM_ICDF(19961), AOM_ICDF(20253), AOM_ICDF(22111), AOM_ICDF(25468), AOM_ICDF(28977), AOM_ICDF(31151), AOM_ICDF(32108), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6626), AOM_ICDF(15650), AOM_ICDF(16281), AOM_ICDF(16696), AOM_ICDF(20419), AOM_ICDF(23826), AOM_ICDF(24669), AOM_ICDF(25188), AOM_ICDF(26709), AOM_ICDF(29561), AOM_ICDF(31203), AOM_ICDF(31811), AOM_ICDF(32768), 0 },
          { AOM_ICDF(5946), AOM_ICDF(17790), AOM_ICDF(18063), AOM_ICDF(18339), AOM_ICDF(19049), AOM_ICDF(25701), AOM_ICDF(25942), AOM_ICDF(26289), AOM_ICDF(28224), AOM_ICDF(30501), AOM_ICDF(31732), AOM_ICDF(32192), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8247), AOM_ICDF(15710), AOM_ICDF(16700), AOM_ICDF(17083), AOM_ICDF(18600), AOM_ICDF(19891), AOM_ICDF(23303), AOM_ICDF(24149), AOM_ICDF(25418), AOM_ICDF(28745), AOM_ICDF(30205), AOM_ICDF(31229), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7414), AOM_ICDF(14790), AOM_ICDF(16103), AOM_ICDF(17056), AOM_ICDF(17437), AOM_ICDF(18332), AOM_ICDF(18797), AOM_ICDF(23279), AOM_ICDF(25024), AOM_ICDF(28630), AOM_ICDF(30385), AOM_ICDF(31627), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7886), AOM_ICDF(17142), AOM_ICDF(17377), AOM_ICDF(18228), AOM_ICDF(18517), AOM_ICDF(19566), AOM_ICDF(19789), AOM_ICDF(20477), AOM_ICDF(26467), AOM_ICDF(29451), AOM_ICDF(31424), AOM_ICDF(32074), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8251), AOM_ICDF(19430), AOM_ICDF(19998), AOM_ICDF(20426), AOM_ICDF(20782), AOM_ICDF(22155), AOM_ICDF(22488), AOM_ICDF(23281), AOM_ICDF(25037), AOM_ICDF(28791), AOM_ICDF(30593), AOM_ICDF(31614), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8042), AOM_ICDF(19117), AOM_ICDF(19777), AOM_ICDF(20139), AOM_ICDF(20462), AOM_ICDF(21878), AOM_ICDF(22212), AOM_ICDF(23083), AOM_ICDF(24811), AOM_ICDF(28090), AOM_ICDF(30592), AOM_ICDF(31308), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8268), AOM_ICDF(19518), AOM_ICDF(20406), AOM_ICDF(20756), AOM_ICDF(21064), AOM_ICDF(22108), AOM_ICDF(22552), AOM_ICDF(23405), AOM_ICDF(25111), AOM_ICDF(28731), AOM_ICDF(30343), AOM_ICDF(31534), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6521), AOM_ICDF(21472), AOM_ICDF(22603), AOM_ICDF(22915), AOM_ICDF(23041), AOM_ICDF(23480), AOM_ICDF(23618), AOM_ICDF(24110), AOM_ICDF(25099), AOM_ICDF(26516), AOM_ICDF(27883), AOM_ICDF(28449), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(12527), AOM_ICDF(13076), AOM_ICDF(21835), AOM_ICDF(22214), AOM_ICDF(22492), AOM_ICDF(22728), AOM_ICDF(23978), AOM_ICDF(25665), AOM_ICDF(26165), AOM_ICDF(29466), AOM_ICDF(30247), AOM_ICDF(32239), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12377), AOM_ICDF(16820), AOM_ICDF(21011), AOM_ICDF(21631), AOM_ICDF(21960), AOM_ICDF(22438), AOM_ICDF(23031), AOM_ICDF(24350), AOM_ICDF(25400), AOM_ICDF(28539), AOM_ICDF(29714), AOM_ICDF(31154), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6712), AOM_ICDF(6862), AOM_ICDF(26853), AOM_ICDF(26972), AOM_ICDF(27060), AOM_ICDF(27103), AOM_ICDF(27826), AOM_ICDF(29143), AOM_ICDF(29267), AOM_ICDF(30799), AOM_ICDF(31064), AOM_ICDF(32294), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11320), AOM_ICDF(11776), AOM_ICDF(15386), AOM_ICDF(17447), AOM_ICDF(17768), AOM_ICDF(18066), AOM_ICDF(18973), AOM_ICDF(23664), AOM_ICDF(25022), AOM_ICDF(29029), AOM_ICDF(30158), AOM_ICDF(32267), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10773), AOM_ICDF(11905), AOM_ICDF(15020), AOM_ICDF(15656), AOM_ICDF(20247), AOM_ICDF(21640), AOM_ICDF(24465), AOM_ICDF(25777), AOM_ICDF(26419), AOM_ICDF(29685), AOM_ICDF(30762), AOM_ICDF(32481), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12323), AOM_ICDF(14046), AOM_ICDF(17449), AOM_ICDF(18101), AOM_ICDF(19214), AOM_ICDF(22210), AOM_ICDF(23345), AOM_ICDF(24975), AOM_ICDF(26412), AOM_ICDF(29729), AOM_ICDF(30931), AOM_ICDF(32336), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9944), AOM_ICDF(10198), AOM_ICDF(17726), AOM_ICDF(18052), AOM_ICDF(18893), AOM_ICDF(19155), AOM_ICDF(25498), AOM_ICDF(26898), AOM_ICDF(27176), AOM_ICDF(30160), AOM_ICDF(30652), AOM_ICDF(32510), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8721), AOM_ICDF(8970), AOM_ICDF(16785), AOM_ICDF(17446), AOM_ICDF(17649), AOM_ICDF(17826), AOM_ICDF(18746), AOM_ICDF(25927), AOM_ICDF(26396), AOM_ICDF(29702), AOM_ICDF(30461), AOM_ICDF(32528), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11404), AOM_ICDF(12417), AOM_ICDF(15834), AOM_ICDF(17066), AOM_ICDF(17441), AOM_ICDF(18014), AOM_ICDF(18966), AOM_ICDF(21819), AOM_ICDF(24083), AOM_ICDF(29077), AOM_ICDF(30376), AOM_ICDF(32213), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11450), AOM_ICDF(11958), AOM_ICDF(18297), AOM_ICDF(18820), AOM_ICDF(19165), AOM_ICDF(19479), AOM_ICDF(20809), AOM_ICDF(23280), AOM_ICDF(23916), AOM_ICDF(28662), AOM_ICDF(29933), AOM_ICDF(32364), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10920), AOM_ICDF(11607), AOM_ICDF(17980), AOM_ICDF(18561), AOM_ICDF(18921), AOM_ICDF(19301), AOM_ICDF(20390), AOM_ICDF(22706), AOM_ICDF(23413), AOM_ICDF(28156), AOM_ICDF(30004), AOM_ICDF(31872), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11462), AOM_ICDF(11962), AOM_ICDF(19642), AOM_ICDF(20131), AOM_ICDF(20369), AOM_ICDF(20530), AOM_ICDF(21898), AOM_ICDF(24152), AOM_ICDF(24686), AOM_ICDF(28899), AOM_ICDF(29656), AOM_ICDF(32424), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8171), AOM_ICDF(9219), AOM_ICDF(21810), AOM_ICDF(22146), AOM_ICDF(22350), AOM_ICDF(22480), AOM_ICDF(22930), AOM_ICDF(24054), AOM_ICDF(24405), AOM_ICDF(26437), AOM_ICDF(27109), AOM_ICDF(28397), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(12474), AOM_ICDF(13429), AOM_ICDF(14740), AOM_ICDF(17535), AOM_ICDF(18021), AOM_ICDF(18752), AOM_ICDF(19551), AOM_ICDF(22163), AOM_ICDF(24563), AOM_ICDF(29410), AOM_ICDF(30687), AOM_ICDF(32505), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9862), AOM_ICDF(15025), AOM_ICDF(15766), AOM_ICDF(18942), AOM_ICDF(19321), AOM_ICDF(20031), AOM_ICDF(20492), AOM_ICDF(21747), AOM_ICDF(25671), AOM_ICDF(29272), AOM_ICDF(30926), AOM_ICDF(32270), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8764), AOM_ICDF(9426), AOM_ICDF(17676), AOM_ICDF(19605), AOM_ICDF(19945), AOM_ICDF(20174), AOM_ICDF(21106), AOM_ICDF(24312), AOM_ICDF(25470), AOM_ICDF(29242), AOM_ICDF(30066), AOM_ICDF(31831), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8566), AOM_ICDF(9030), AOM_ICDF(9692), AOM_ICDF(18683), AOM_ICDF(18787), AOM_ICDF(18968), AOM_ICDF(19155), AOM_ICDF(23451), AOM_ICDF(26278), AOM_ICDF(30299), AOM_ICDF(31208), AOM_ICDF(32537), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7535), AOM_ICDF(8616), AOM_ICDF(9353), AOM_ICDF(13056), AOM_ICDF(18938), AOM_ICDF(21199), AOM_ICDF(22627), AOM_ICDF(23971), AOM_ICDF(26022), AOM_ICDF(30131), AOM_ICDF(31243), AOM_ICDF(32618), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9138), AOM_ICDF(11001), AOM_ICDF(11570), AOM_ICDF(14638), AOM_ICDF(16000), AOM_ICDF(20926), AOM_ICDF(21803), AOM_ICDF(23237), AOM_ICDF(26287), AOM_ICDF(30063), AOM_ICDF(31128), AOM_ICDF(32599), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9729), AOM_ICDF(10184), AOM_ICDF(11919), AOM_ICDF(13759), AOM_ICDF(15439), AOM_ICDF(16099), AOM_ICDF(20564), AOM_ICDF(22949), AOM_ICDF(24424), AOM_ICDF(29313), AOM_ICDF(30373), AOM_ICDF(32518), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8615), AOM_ICDF(9090), AOM_ICDF(10462), AOM_ICDF(14832), AOM_ICDF(15157), AOM_ICDF(15466), AOM_ICDF(16143), AOM_ICDF(22773), AOM_ICDF(24815), AOM_ICDF(29574), AOM_ICDF(30593), AOM_ICDF(32635), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9258), AOM_ICDF(10308), AOM_ICDF(10884), AOM_ICDF(15905), AOM_ICDF(16092), AOM_ICDF(16466), AOM_ICDF(16802), AOM_ICDF(19277), AOM_ICDF(25235), AOM_ICDF(29804), AOM_ICDF(31328), AOM_ICDF(32508), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10403), AOM_ICDF(11313), AOM_ICDF(12386), AOM_ICDF(15442), AOM_ICDF(15884), AOM_ICDF(16549), AOM_ICDF(17269), AOM_ICDF(20362), AOM_ICDF(22913), AOM_ICDF(28783), AOM_ICDF(30284), AOM_ICDF(32578), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9620), AOM_ICDF(10894), AOM_ICDF(11874), AOM_ICDF(14923), AOM_ICDF(15398), AOM_ICDF(16326), AOM_ICDF(17076), AOM_ICDF(20069), AOM_ICDF(23137), AOM_ICDF(28656), AOM_ICDF(30608), AOM_ICDF(32331), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10095), AOM_ICDF(10981), AOM_ICDF(12537), AOM_ICDF(15703), AOM_ICDF(16165), AOM_ICDF(16741), AOM_ICDF(17550), AOM_ICDF(20754), AOM_ICDF(22975), AOM_ICDF(29162), AOM_ICDF(30500), AOM_ICDF(32582), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8858), AOM_ICDF(11204), AOM_ICDF(14847), AOM_ICDF(18228), AOM_ICDF(18741), AOM_ICDF(19060), AOM_ICDF(19629), AOM_ICDF(21234), AOM_ICDF(24400), AOM_ICDF(27622), AOM_ICDF(29011), AOM_ICDF(30627), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(9911), AOM_ICDF(10689), AOM_ICDF(11787), AOM_ICDF(12138), AOM_ICDF(19892), AOM_ICDF(22168), AOM_ICDF(24984), AOM_ICDF(26365), AOM_ICDF(27052), AOM_ICDF(30676), AOM_ICDF(31618), AOM_ICDF(32577), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10405), AOM_ICDF(14007), AOM_ICDF(14667), AOM_ICDF(15051), AOM_ICDF(20542), AOM_ICDF(23567), AOM_ICDF(25261), AOM_ICDF(26243), AOM_ICDF(27418), AOM_ICDF(30244), AOM_ICDF(31480), AOM_ICDF(32398), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7972), AOM_ICDF(8563), AOM_ICDF(16778), AOM_ICDF(17053), AOM_ICDF(20474), AOM_ICDF(21431), AOM_ICDF(24348), AOM_ICDF(26064), AOM_ICDF(26466), AOM_ICDF(29456), AOM_ICDF(30241), AOM_ICDF(31822), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10502), AOM_ICDF(10858), AOM_ICDF(11637), AOM_ICDF(13369), AOM_ICDF(16831), AOM_ICDF(18528), AOM_ICDF(20122), AOM_ICDF(23814), AOM_ICDF(25350), AOM_ICDF(29741), AOM_ICDF(31151), AOM_ICDF(32539), AOM_ICDF(32768), 0 },
          { AOM_ICDF(4993), AOM_ICDF(5184), AOM_ICDF(5393), AOM_ICDF(5580), AOM_ICDF(25670), AOM_ICDF(27769), AOM_ICDF(29927), AOM_ICDF(30768), AOM_ICDF(31020), AOM_ICDF(32139), AOM_ICDF(32371), AOM_ICDF(32721), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6994), AOM_ICDF(8042), AOM_ICDF(8425), AOM_ICDF(8775), AOM_ICDF(18573), AOM_ICDF(26670), AOM_ICDF(27998), AOM_ICDF(29060), AOM_ICDF(29741), AOM_ICDF(31512), AOM_ICDF(32140), AOM_ICDF(32705), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6608), AOM_ICDF(6893), AOM_ICDF(7917), AOM_ICDF(8137), AOM_ICDF(18180), AOM_ICDF(19484), AOM_ICDF(27302), AOM_ICDF(28268), AOM_ICDF(28648), AOM_ICDF(31184), AOM_ICDF(31688), AOM_ICDF(32604), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7758), AOM_ICDF(8381), AOM_ICDF(9673), AOM_ICDF(10202), AOM_ICDF(15951), AOM_ICDF(17361), AOM_ICDF(19451), AOM_ICDF(26253), AOM_ICDF(26891), AOM_ICDF(30394), AOM_ICDF(31343), AOM_ICDF(32571), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9961), AOM_ICDF(11581), AOM_ICDF(12003), AOM_ICDF(12812), AOM_ICDF(17402), AOM_ICDF(19995), AOM_ICDF(21609), AOM_ICDF(23735), AOM_ICDF(25957), AOM_ICDF(29973), AOM_ICDF(31339), AOM_ICDF(32560), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10245), AOM_ICDF(10965), AOM_ICDF(11887), AOM_ICDF(12326), AOM_ICDF(18409), AOM_ICDF(20778), AOM_ICDF(23127), AOM_ICDF(24779), AOM_ICDF(25560), AOM_ICDF(30046), AOM_ICDF(31167), AOM_ICDF(32588), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9047), AOM_ICDF(10157), AOM_ICDF(11136), AOM_ICDF(11600), AOM_ICDF(17607), AOM_ICDF(20541), AOM_ICDF(22746), AOM_ICDF(24278), AOM_ICDF(25239), AOM_ICDF(29844), AOM_ICDF(31296), AOM_ICDF(32466), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10318), AOM_ICDF(11227), AOM_ICDF(12470), AOM_ICDF(12792), AOM_ICDF(17742), AOM_ICDF(19600), AOM_ICDF(22120), AOM_ICDF(24346), AOM_ICDF(25079), AOM_ICDF(29588), AOM_ICDF(30917), AOM_ICDF(32593), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8281), AOM_ICDF(10602), AOM_ICDF(15452), AOM_ICDF(15940), AOM_ICDF(19120), AOM_ICDF(20702), AOM_ICDF(22521), AOM_ICDF(23526), AOM_ICDF(24236), AOM_ICDF(27829), AOM_ICDF(28776), AOM_ICDF(29973), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(9850), AOM_ICDF(12693), AOM_ICDF(13536), AOM_ICDF(13937), AOM_ICDF(16080), AOM_ICDF(23341), AOM_ICDF(24177), AOM_ICDF(25258), AOM_ICDF(26372), AOM_ICDF(30167), AOM_ICDF(31506), AOM_ICDF(32425), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8537), AOM_ICDF(15828), AOM_ICDF(16155), AOM_ICDF(16425), AOM_ICDF(17738), AOM_ICDF(25313), AOM_ICDF(25706), AOM_ICDF(26423), AOM_ICDF(27642), AOM_ICDF(30290), AOM_ICDF(31795), AOM_ICDF(32372), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8805), AOM_ICDF(10168), AOM_ICDF(16679), AOM_ICDF(17136), AOM_ICDF(18480), AOM_ICDF(21724), AOM_ICDF(22707), AOM_ICDF(24501), AOM_ICDF(25226), AOM_ICDF(28734), AOM_ICDF(29582), AOM_ICDF(31015), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11887), AOM_ICDF(13456), AOM_ICDF(14000), AOM_ICDF(16402), AOM_ICDF(17550), AOM_ICDF(20969), AOM_ICDF(21942), AOM_ICDF(24081), AOM_ICDF(26141), AOM_ICDF(29735), AOM_ICDF(31365), AOM_ICDF(32610), AOM_ICDF(32768), 0 },
          { AOM_ICDF(5462), AOM_ICDF(6783), AOM_ICDF(7085), AOM_ICDF(7427), AOM_ICDF(16960), AOM_ICDF(26746), AOM_ICDF(27970), AOM_ICDF(28609), AOM_ICDF(29343), AOM_ICDF(31379), AOM_ICDF(32138), AOM_ICDF(32593), AOM_ICDF(32768), 0 },
          { AOM_ICDF(4786), AOM_ICDF(7121), AOM_ICDF(7242), AOM_ICDF(7469), AOM_ICDF(9622), AOM_ICDF(28427), AOM_ICDF(28700), AOM_ICDF(29374), AOM_ICDF(30121), AOM_ICDF(31764), AOM_ICDF(32356), AOM_ICDF(32637), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9172), AOM_ICDF(10388), AOM_ICDF(11156), AOM_ICDF(11527), AOM_ICDF(15483), AOM_ICDF(20332), AOM_ICDF(24727), AOM_ICDF(25954), AOM_ICDF(26870), AOM_ICDF(30198), AOM_ICDF(31246), AOM_ICDF(32352), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8102), AOM_ICDF(9847), AOM_ICDF(11124), AOM_ICDF(11911), AOM_ICDF(13567), AOM_ICDF(18203), AOM_ICDF(19081), AOM_ICDF(24364), AOM_ICDF(25695), AOM_ICDF(29586), AOM_ICDF(31057), AOM_ICDF(32380), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10488), AOM_ICDF(13506), AOM_ICDF(14020), AOM_ICDF(14824), AOM_ICDF(16307), AOM_ICDF(20899), AOM_ICDF(21549), AOM_ICDF(22906), AOM_ICDF(25886), AOM_ICDF(29488), AOM_ICDF(31408), AOM_ICDF(32369), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9407), AOM_ICDF(11928), AOM_ICDF(12529), AOM_ICDF(12941), AOM_ICDF(14674), AOM_ICDF(20905), AOM_ICDF(21782), AOM_ICDF(23113), AOM_ICDF(24351), AOM_ICDF(29073), AOM_ICDF(31009), AOM_ICDF(32410), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8764), AOM_ICDF(11728), AOM_ICDF(12298), AOM_ICDF(12713), AOM_ICDF(14609), AOM_ICDF(21424), AOM_ICDF(22115), AOM_ICDF(23419), AOM_ICDF(24779), AOM_ICDF(29206), AOM_ICDF(31355), AOM_ICDF(32390), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9517), AOM_ICDF(11912), AOM_ICDF(12950), AOM_ICDF(13401), AOM_ICDF(15075), AOM_ICDF(20426), AOM_ICDF(21436), AOM_ICDF(23153), AOM_ICDF(24539), AOM_ICDF(29531), AOM_ICDF(31132), AOM_ICDF(32469), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8253), AOM_ICDF(12956), AOM_ICDF(16212), AOM_ICDF(16664), AOM_ICDF(17756), AOM_ICDF(22714), AOM_ICDF(23216), AOM_ICDF(24249), AOM_ICDF(25321), AOM_ICDF(28440), AOM_ICDF(29620), AOM_ICDF(30259), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(11792), AOM_ICDF(12317), AOM_ICDF(15563), AOM_ICDF(16032), AOM_ICDF(17398), AOM_ICDF(17977), AOM_ICDF(23384), AOM_ICDF(25171), AOM_ICDF(25807), AOM_ICDF(29850), AOM_ICDF(30737), AOM_ICDF(32541), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10922), AOM_ICDF(14049), AOM_ICDF(15834), AOM_ICDF(16386), AOM_ICDF(17629), AOM_ICDF(18873), AOM_ICDF(22496), AOM_ICDF(24451), AOM_ICDF(25744), AOM_ICDF(29328), AOM_ICDF(30878), AOM_ICDF(32141), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8243), AOM_ICDF(8431), AOM_ICDF(19690), AOM_ICDF(19885), AOM_ICDF(20402), AOM_ICDF(20560), AOM_ICDF(25644), AOM_ICDF(27470), AOM_ICDF(27737), AOM_ICDF(30291), AOM_ICDF(30701), AOM_ICDF(32380), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11266), AOM_ICDF(11746), AOM_ICDF(13215), AOM_ICDF(15105), AOM_ICDF(15916), AOM_ICDF(16497), AOM_ICDF(19044), AOM_ICDF(22912), AOM_ICDF(24422), AOM_ICDF(29451), AOM_ICDF(30565), AOM_ICDF(32543), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7970), AOM_ICDF(8353), AOM_ICDF(8989), AOM_ICDF(9324), AOM_ICDF(18715), AOM_ICDF(20136), AOM_ICDF(27478), AOM_ICDF(28360), AOM_ICDF(28854), AOM_ICDF(31356), AOM_ICDF(31910), AOM_ICDF(32687), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9835), AOM_ICDF(10905), AOM_ICDF(11896), AOM_ICDF(12507), AOM_ICDF(15383), AOM_ICDF(20329), AOM_ICDF(25102), AOM_ICDF(26520), AOM_ICDF(27487), AOM_ICDF(30879), AOM_ICDF(31709), AOM_ICDF(32540), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6779), AOM_ICDF(6957), AOM_ICDF(9270), AOM_ICDF(9436), AOM_ICDF(11553), AOM_ICDF(11824), AOM_ICDF(27958), AOM_ICDF(28747), AOM_ICDF(29030), AOM_ICDF(31268), AOM_ICDF(31664), AOM_ICDF(32666), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9125), AOM_ICDF(9475), AOM_ICDF(12773), AOM_ICDF(13383), AOM_ICDF(14285), AOM_ICDF(14691), AOM_ICDF(18620), AOM_ICDF(24633), AOM_ICDF(25338), AOM_ICDF(29728), AOM_ICDF(30582), AOM_ICDF(32548), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11721), AOM_ICDF(12709), AOM_ICDF(14065), AOM_ICDF(15136), AOM_ICDF(16224), AOM_ICDF(17044), AOM_ICDF(20019), AOM_ICDF(22634), AOM_ICDF(24974), AOM_ICDF(29533), AOM_ICDF(30976), AOM_ICDF(32540), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11134), AOM_ICDF(11581), AOM_ICDF(13908), AOM_ICDF(14421), AOM_ICDF(15715), AOM_ICDF(16407), AOM_ICDF(20884), AOM_ICDF(23365), AOM_ICDF(24142), AOM_ICDF(29151), AOM_ICDF(30333), AOM_ICDF(32546), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10621), AOM_ICDF(11354), AOM_ICDF(13725), AOM_ICDF(14331), AOM_ICDF(15697), AOM_ICDF(16435), AOM_ICDF(20811), AOM_ICDF(23061), AOM_ICDF(23916), AOM_ICDF(29068), AOM_ICDF(30630), AOM_ICDF(32382), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11037), AOM_ICDF(11497), AOM_ICDF(14490), AOM_ICDF(14987), AOM_ICDF(16009), AOM_ICDF(16447), AOM_ICDF(21140), AOM_ICDF(23683), AOM_ICDF(24312), AOM_ICDF(28995), AOM_ICDF(30105), AOM_ICDF(32639), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9605), AOM_ICDF(11018), AOM_ICDF(17444), AOM_ICDF(17875), AOM_ICDF(18709), AOM_ICDF(19288), AOM_ICDF(22633), AOM_ICDF(24723), AOM_ICDF(25518), AOM_ICDF(28726), AOM_ICDF(29835), AOM_ICDF(31394), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(12284), AOM_ICDF(12942), AOM_ICDF(15497), AOM_ICDF(16898), AOM_ICDF(17400), AOM_ICDF(17937), AOM_ICDF(19136), AOM_ICDF(23012), AOM_ICDF(24306), AOM_ICDF(29247), AOM_ICDF(30360), AOM_ICDF(32526), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11749), AOM_ICDF(15601), AOM_ICDF(16892), AOM_ICDF(18207), AOM_ICDF(18593), AOM_ICDF(19416), AOM_ICDF(20162), AOM_ICDF(22890), AOM_ICDF(24773), AOM_ICDF(28978), AOM_ICDF(30525), AOM_ICDF(32157), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8357), AOM_ICDF(8590), AOM_ICDF(18591), AOM_ICDF(19354), AOM_ICDF(19529), AOM_ICDF(19661), AOM_ICDF(20764), AOM_ICDF(25434), AOM_ICDF(25938), AOM_ICDF(29380), AOM_ICDF(29919), AOM_ICDF(32290), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9307), AOM_ICDF(9623), AOM_ICDF(10609), AOM_ICDF(15340), AOM_ICDF(15587), AOM_ICDF(15878), AOM_ICDF(16422), AOM_ICDF(22905), AOM_ICDF(25106), AOM_ICDF(29604), AOM_ICDF(30579), AOM_ICDF(32561), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9511), AOM_ICDF(10303), AOM_ICDF(11146), AOM_ICDF(12396), AOM_ICDF(19000), AOM_ICDF(20742), AOM_ICDF(22883), AOM_ICDF(25043), AOM_ICDF(26322), AOM_ICDF(30216), AOM_ICDF(31156), AOM_ICDF(32668), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11525), AOM_ICDF(12965), AOM_ICDF(13992), AOM_ICDF(15314), AOM_ICDF(16559), AOM_ICDF(21108), AOM_ICDF(22323), AOM_ICDF(24844), AOM_ICDF(26765), AOM_ICDF(30376), AOM_ICDF(31351), AOM_ICDF(32576), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9919), AOM_ICDF(10382), AOM_ICDF(13106), AOM_ICDF(14128), AOM_ICDF(15212), AOM_ICDF(15741), AOM_ICDF(20216), AOM_ICDF(23213), AOM_ICDF(24169), AOM_ICDF(29046), AOM_ICDF(29869), AOM_ICDF(32570), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8056), AOM_ICDF(8456), AOM_ICDF(10218), AOM_ICDF(11714), AOM_ICDF(12070), AOM_ICDF(12383), AOM_ICDF(12849), AOM_ICDF(26222), AOM_ICDF(27079), AOM_ICDF(30222), AOM_ICDF(30828), AOM_ICDF(32606), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10700), AOM_ICDF(11453), AOM_ICDF(12659), AOM_ICDF(15291), AOM_ICDF(15677), AOM_ICDF(16240), AOM_ICDF(16902), AOM_ICDF(20777), AOM_ICDF(24142), AOM_ICDF(29325), AOM_ICDF(30729), AOM_ICDF(32560), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10863), AOM_ICDF(11450), AOM_ICDF(13506), AOM_ICDF(14976), AOM_ICDF(15428), AOM_ICDF(15869), AOM_ICDF(17051), AOM_ICDF(21294), AOM_ICDF(22705), AOM_ICDF(28406), AOM_ICDF(29836), AOM_ICDF(32553), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10357), AOM_ICDF(11196), AOM_ICDF(13312), AOM_ICDF(14910), AOM_ICDF(15380), AOM_ICDF(15977), AOM_ICDF(16957), AOM_ICDF(20978), AOM_ICDF(22542), AOM_ICDF(28263), AOM_ICDF(30186), AOM_ICDF(32369), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10325), AOM_ICDF(10858), AOM_ICDF(13637), AOM_ICDF(15045), AOM_ICDF(15455), AOM_ICDF(15809), AOM_ICDF(17144), AOM_ICDF(21700), AOM_ICDF(22936), AOM_ICDF(28610), AOM_ICDF(29747), AOM_ICDF(32558), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10032), AOM_ICDF(11356), AOM_ICDF(16324), AOM_ICDF(17851), AOM_ICDF(18191), AOM_ICDF(18525), AOM_ICDF(19241), AOM_ICDF(22933), AOM_ICDF(24078), AOM_ICDF(27949), AOM_ICDF(29094), AOM_ICDF(31080), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(11187), AOM_ICDF(13518), AOM_ICDF(14554), AOM_ICDF(16266), AOM_ICDF(16753), AOM_ICDF(17679), AOM_ICDF(18282), AOM_ICDF(19923), AOM_ICDF(24195), AOM_ICDF(29274), AOM_ICDF(30823), AOM_ICDF(32442), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7948), AOM_ICDF(15152), AOM_ICDF(15579), AOM_ICDF(16934), AOM_ICDF(17200), AOM_ICDF(18121), AOM_ICDF(18405), AOM_ICDF(19130), AOM_ICDF(26141), AOM_ICDF(29589), AOM_ICDF(31275), AOM_ICDF(32270), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8418), AOM_ICDF(9721), AOM_ICDF(16634), AOM_ICDF(18137), AOM_ICDF(18405), AOM_ICDF(18791), AOM_ICDF(19607), AOM_ICDF(22197), AOM_ICDF(24804), AOM_ICDF(28838), AOM_ICDF(29667), AOM_ICDF(31725), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9661), AOM_ICDF(10767), AOM_ICDF(11231), AOM_ICDF(16796), AOM_ICDF(16918), AOM_ICDF(17285), AOM_ICDF(17685), AOM_ICDF(20433), AOM_ICDF(25515), AOM_ICDF(29910), AOM_ICDF(31128), AOM_ICDF(32611), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7447), AOM_ICDF(9631), AOM_ICDF(10071), AOM_ICDF(11463), AOM_ICDF(16405), AOM_ICDF(18681), AOM_ICDF(19977), AOM_ICDF(21135), AOM_ICDF(25724), AOM_ICDF(30089), AOM_ICDF(31371), AOM_ICDF(32429), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7732), AOM_ICDF(11142), AOM_ICDF(11643), AOM_ICDF(13157), AOM_ICDF(14285), AOM_ICDF(19050), AOM_ICDF(19568), AOM_ICDF(20445), AOM_ICDF(26278), AOM_ICDF(30197), AOM_ICDF(31552), AOM_ICDF(32543), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8655), AOM_ICDF(9972), AOM_ICDF(11341), AOM_ICDF(12647), AOM_ICDF(14152), AOM_ICDF(15009), AOM_ICDF(18424), AOM_ICDF(20317), AOM_ICDF(23903), AOM_ICDF(29129), AOM_ICDF(30367), AOM_ICDF(32348), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8905), AOM_ICDF(10161), AOM_ICDF(11295), AOM_ICDF(14376), AOM_ICDF(14751), AOM_ICDF(15334), AOM_ICDF(15861), AOM_ICDF(20676), AOM_ICDF(24144), AOM_ICDF(29140), AOM_ICDF(30559), AOM_ICDF(32518), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7230), AOM_ICDF(9455), AOM_ICDF(9769), AOM_ICDF(12237), AOM_ICDF(12385), AOM_ICDF(12718), AOM_ICDF(12941), AOM_ICDF(14070), AOM_ICDF(26774), AOM_ICDF(30020), AOM_ICDF(31689), AOM_ICDF(32544), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9676), AOM_ICDF(11840), AOM_ICDF(12666), AOM_ICDF(14444), AOM_ICDF(14854), AOM_ICDF(15790), AOM_ICDF(16395), AOM_ICDF(18289), AOM_ICDF(23074), AOM_ICDF(28546), AOM_ICDF(30570), AOM_ICDF(32500), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8954), AOM_ICDF(11507), AOM_ICDF(12411), AOM_ICDF(14262), AOM_ICDF(14736), AOM_ICDF(15800), AOM_ICDF(16324), AOM_ICDF(17931), AOM_ICDF(23370), AOM_ICDF(28692), AOM_ICDF(30899), AOM_ICDF(32304), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9604), AOM_ICDF(11709), AOM_ICDF(12728), AOM_ICDF(14391), AOM_ICDF(14817), AOM_ICDF(15784), AOM_ICDF(16426), AOM_ICDF(18627), AOM_ICDF(22984), AOM_ICDF(28781), AOM_ICDF(30290), AOM_ICDF(32507), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8037), AOM_ICDF(12362), AOM_ICDF(14711), AOM_ICDF(16445), AOM_ICDF(16662), AOM_ICDF(17238), AOM_ICDF(17667), AOM_ICDF(18883), AOM_ICDF(24405), AOM_ICDF(27873), AOM_ICDF(29300), AOM_ICDF(30676), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(12742), AOM_ICDF(13944), AOM_ICDF(16005), AOM_ICDF(16901), AOM_ICDF(17483), AOM_ICDF(18249), AOM_ICDF(19462), AOM_ICDF(21457), AOM_ICDF(22908), AOM_ICDF(28575), AOM_ICDF(30017), AOM_ICDF(32411), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11299), AOM_ICDF(16882), AOM_ICDF(17822), AOM_ICDF(18576), AOM_ICDF(19025), AOM_ICDF(20145), AOM_ICDF(20676), AOM_ICDF(21738), AOM_ICDF(23779), AOM_ICDF(28608), AOM_ICDF(30479), AOM_ICDF(32163), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9373), AOM_ICDF(9807), AOM_ICDF(20454), AOM_ICDF(20912), AOM_ICDF(21134), AOM_ICDF(21315), AOM_ICDF(22536), AOM_ICDF(24523), AOM_ICDF(25027), AOM_ICDF(28824), AOM_ICDF(29546), AOM_ICDF(31958), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10839), AOM_ICDF(11634), AOM_ICDF(12609), AOM_ICDF(15747), AOM_ICDF(16076), AOM_ICDF(16521), AOM_ICDF(17368), AOM_ICDF(20813), AOM_ICDF(23179), AOM_ICDF(28736), AOM_ICDF(30250), AOM_ICDF(32547), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10018), AOM_ICDF(11043), AOM_ICDF(11846), AOM_ICDF(12631), AOM_ICDF(18703), AOM_ICDF(21106), AOM_ICDF(23223), AOM_ICDF(24327), AOM_ICDF(25655), AOM_ICDF(29908), AOM_ICDF(31108), AOM_ICDF(32633), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10447), AOM_ICDF(12670), AOM_ICDF(13370), AOM_ICDF(14274), AOM_ICDF(15751), AOM_ICDF(20138), AOM_ICDF(21082), AOM_ICDF(22289), AOM_ICDF(24356), AOM_ICDF(29308), AOM_ICDF(30721), AOM_ICDF(32473), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10304), AOM_ICDF(10858), AOM_ICDF(13242), AOM_ICDF(13826), AOM_ICDF(15409), AOM_ICDF(16080), AOM_ICDF(21225), AOM_ICDF(22983), AOM_ICDF(23924), AOM_ICDF(29128), AOM_ICDF(30162), AOM_ICDF(32556), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9909), AOM_ICDF(10554), AOM_ICDF(12924), AOM_ICDF(14243), AOM_ICDF(14636), AOM_ICDF(15075), AOM_ICDF(16202), AOM_ICDF(21806), AOM_ICDF(23067), AOM_ICDF(28721), AOM_ICDF(29942), AOM_ICDF(32552), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10896), AOM_ICDF(12565), AOM_ICDF(13376), AOM_ICDF(14948), AOM_ICDF(15378), AOM_ICDF(16154), AOM_ICDF(16898), AOM_ICDF(19033), AOM_ICDF(22710), AOM_ICDF(28465), AOM_ICDF(30461), AOM_ICDF(32462), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11659), AOM_ICDF(12724), AOM_ICDF(14290), AOM_ICDF(15241), AOM_ICDF(15795), AOM_ICDF(16545), AOM_ICDF(17729), AOM_ICDF(20065), AOM_ICDF(21669), AOM_ICDF(28045), AOM_ICDF(29829), AOM_ICDF(32507), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11351), AOM_ICDF(12806), AOM_ICDF(14382), AOM_ICDF(15343), AOM_ICDF(15955), AOM_ICDF(16885), AOM_ICDF(17916), AOM_ICDF(20033), AOM_ICDF(21718), AOM_ICDF(28093), AOM_ICDF(30166), AOM_ICDF(32319), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11522), AOM_ICDF(12494), AOM_ICDF(14590), AOM_ICDF(15496), AOM_ICDF(15977), AOM_ICDF(16665), AOM_ICDF(17908), AOM_ICDF(20267), AOM_ICDF(21743), AOM_ICDF(28115), AOM_ICDF(29581), AOM_ICDF(32452), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9913), AOM_ICDF(12241), AOM_ICDF(17367), AOM_ICDF(18136), AOM_ICDF(18433), AOM_ICDF(18985), AOM_ICDF(19700), AOM_ICDF(21136), AOM_ICDF(22405), AOM_ICDF(26910), AOM_ICDF(28302), AOM_ICDF(30379), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(12772), AOM_ICDF(14653), AOM_ICDF(16651), AOM_ICDF(17429), AOM_ICDF(17957), AOM_ICDF(18854), AOM_ICDF(19886), AOM_ICDF(21672), AOM_ICDF(23234), AOM_ICDF(28792), AOM_ICDF(30500), AOM_ICDF(32399), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10718), AOM_ICDF(18074), AOM_ICDF(18913), AOM_ICDF(19509), AOM_ICDF(19880), AOM_ICDF(20951), AOM_ICDF(21443), AOM_ICDF(22467), AOM_ICDF(24411), AOM_ICDF(28546), AOM_ICDF(30812), AOM_ICDF(32079), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8668), AOM_ICDF(9307), AOM_ICDF(20783), AOM_ICDF(21169), AOM_ICDF(21531), AOM_ICDF(21743), AOM_ICDF(22862), AOM_ICDF(24771), AOM_ICDF(25364), AOM_ICDF(29059), AOM_ICDF(29920), AOM_ICDF(31878), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11352), AOM_ICDF(12585), AOM_ICDF(13504), AOM_ICDF(16428), AOM_ICDF(16801), AOM_ICDF(17365), AOM_ICDF(17969), AOM_ICDF(21427), AOM_ICDF(23868), AOM_ICDF(29321), AOM_ICDF(30836), AOM_ICDF(32622), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9076), AOM_ICDF(10636), AOM_ICDF(11637), AOM_ICDF(12524), AOM_ICDF(18204), AOM_ICDF(20593), AOM_ICDF(22842), AOM_ICDF(23921), AOM_ICDF(25465), AOM_ICDF(29951), AOM_ICDF(31401), AOM_ICDF(32575), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9924), AOM_ICDF(12861), AOM_ICDF(13519), AOM_ICDF(14327), AOM_ICDF(15700), AOM_ICDF(20596), AOM_ICDF(21434), AOM_ICDF(22592), AOM_ICDF(24521), AOM_ICDF(29177), AOM_ICDF(30937), AOM_ICDF(32569), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9975), AOM_ICDF(10926), AOM_ICDF(13127), AOM_ICDF(13658), AOM_ICDF(15283), AOM_ICDF(16041), AOM_ICDF(21277), AOM_ICDF(23058), AOM_ICDF(24139), AOM_ICDF(29093), AOM_ICDF(30305), AOM_ICDF(32527), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9782), AOM_ICDF(10733), AOM_ICDF(12976), AOM_ICDF(14251), AOM_ICDF(14721), AOM_ICDF(15295), AOM_ICDF(16279), AOM_ICDF(22181), AOM_ICDF(23520), AOM_ICDF(29134), AOM_ICDF(30459), AOM_ICDF(32591), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10910), AOM_ICDF(13136), AOM_ICDF(13939), AOM_ICDF(15246), AOM_ICDF(15760), AOM_ICDF(16621), AOM_ICDF(17278), AOM_ICDF(19097), AOM_ICDF(23321), AOM_ICDF(28756), AOM_ICDF(31030), AOM_ICDF(32520), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11508), AOM_ICDF(13079), AOM_ICDF(14662), AOM_ICDF(15543), AOM_ICDF(16088), AOM_ICDF(16964), AOM_ICDF(18013), AOM_ICDF(20126), AOM_ICDF(21886), AOM_ICDF(28317), AOM_ICDF(30284), AOM_ICDF(32446), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11588), AOM_ICDF(13894), AOM_ICDF(15463), AOM_ICDF(16360), AOM_ICDF(16934), AOM_ICDF(17975), AOM_ICDF(18878), AOM_ICDF(20699), AOM_ICDF(22408), AOM_ICDF(28392), AOM_ICDF(30519), AOM_ICDF(32360), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11198), AOM_ICDF(12680), AOM_ICDF(14726), AOM_ICDF(15620), AOM_ICDF(16098), AOM_ICDF(16861), AOM_ICDF(18056), AOM_ICDF(20172), AOM_ICDF(21896), AOM_ICDF(28252), AOM_ICDF(29839), AOM_ICDF(32437), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9832), AOM_ICDF(13268), AOM_ICDF(17993), AOM_ICDF(18757), AOM_ICDF(19173), AOM_ICDF(19664), AOM_ICDF(20264), AOM_ICDF(21689), AOM_ICDF(23011), AOM_ICDF(27552), AOM_ICDF(29216), AOM_ICDF(30566), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(12350), AOM_ICDF(13494), AOM_ICDF(16423), AOM_ICDF(17219), AOM_ICDF(17721), AOM_ICDF(18280), AOM_ICDF(19569), AOM_ICDF(21557), AOM_ICDF(22752), AOM_ICDF(28182), AOM_ICDF(29360), AOM_ICDF(32304), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10022), AOM_ICDF(16315), AOM_ICDF(17409), AOM_ICDF(18094), AOM_ICDF(18533), AOM_ICDF(19487), AOM_ICDF(20138), AOM_ICDF(21179), AOM_ICDF(22977), AOM_ICDF(27630), AOM_ICDF(29129), AOM_ICDF(31612), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9089), AOM_ICDF(9522), AOM_ICDF(20772), AOM_ICDF(21117), AOM_ICDF(21321), AOM_ICDF(21492), AOM_ICDF(22623), AOM_ICDF(24717), AOM_ICDF(25118), AOM_ICDF(28517), AOM_ICDF(28979), AOM_ICDF(31962), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9995), AOM_ICDF(10496), AOM_ICDF(11749), AOM_ICDF(15264), AOM_ICDF(15578), AOM_ICDF(15986), AOM_ICDF(16825), AOM_ICDF(20949), AOM_ICDF(23073), AOM_ICDF(28353), AOM_ICDF(29869), AOM_ICDF(32482), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9679), AOM_ICDF(10801), AOM_ICDF(11768), AOM_ICDF(12705), AOM_ICDF(18527), AOM_ICDF(20477), AOM_ICDF(22915), AOM_ICDF(24165), AOM_ICDF(25268), AOM_ICDF(29848), AOM_ICDF(30931), AOM_ICDF(32576), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9567), AOM_ICDF(11899), AOM_ICDF(12955), AOM_ICDF(13828), AOM_ICDF(15192), AOM_ICDF(19318), AOM_ICDF(20367), AOM_ICDF(21537), AOM_ICDF(23628), AOM_ICDF(28952), AOM_ICDF(30125), AOM_ICDF(32358), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9977), AOM_ICDF(10470), AOM_ICDF(13391), AOM_ICDF(14019), AOM_ICDF(15325), AOM_ICDF(15830), AOM_ICDF(21218), AOM_ICDF(23133), AOM_ICDF(23836), AOM_ICDF(28927), AOM_ICDF(29755), AOM_ICDF(32513), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9850), AOM_ICDF(10345), AOM_ICDF(13290), AOM_ICDF(14602), AOM_ICDF(14927), AOM_ICDF(15251), AOM_ICDF(16355), AOM_ICDF(22136), AOM_ICDF(23237), AOM_ICDF(28655), AOM_ICDF(29584), AOM_ICDF(32430), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10404), AOM_ICDF(11783), AOM_ICDF(12735), AOM_ICDF(14400), AOM_ICDF(14849), AOM_ICDF(15513), AOM_ICDF(16394), AOM_ICDF(18648), AOM_ICDF(22370), AOM_ICDF(28254), AOM_ICDF(30174), AOM_ICDF(32416), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11468), AOM_ICDF(12380), AOM_ICDF(14466), AOM_ICDF(15450), AOM_ICDF(15969), AOM_ICDF(16598), AOM_ICDF(17836), AOM_ICDF(20272), AOM_ICDF(21618), AOM_ICDF(27769), AOM_ICDF(29346), AOM_ICDF(32367), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10553), AOM_ICDF(11978), AOM_ICDF(13832), AOM_ICDF(14829), AOM_ICDF(15388), AOM_ICDF(16214), AOM_ICDF(17380), AOM_ICDF(19633), AOM_ICDF(21295), AOM_ICDF(27909), AOM_ICDF(29723), AOM_ICDF(32101), AOM_ICDF(32768), 0 },
          { AOM_ICDF(11458), AOM_ICDF(12316), AOM_ICDF(15258), AOM_ICDF(16119), AOM_ICDF(16504), AOM_ICDF(16926), AOM_ICDF(18261), AOM_ICDF(20678), AOM_ICDF(21757), AOM_ICDF(27964), AOM_ICDF(29206), AOM_ICDF(32426), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9827), AOM_ICDF(12420), AOM_ICDF(17601), AOM_ICDF(18357), AOM_ICDF(18643), AOM_ICDF(19019), AOM_ICDF(19747), AOM_ICDF(21072), AOM_ICDF(22058), AOM_ICDF(25919), AOM_ICDF(27042), AOM_ICDF(29550), AOM_ICDF(32768), 0 }
        },
        {
          { AOM_ICDF(9582), AOM_ICDF(13804), AOM_ICDF(16310), AOM_ICDF(16612), AOM_ICDF(16855), AOM_ICDF(17317), AOM_ICDF(17804), AOM_ICDF(18740), AOM_ICDF(19414), AOM_ICDF(21959), AOM_ICDF(22938), AOM_ICDF(24178), AOM_ICDF(32768), 0 },
          { AOM_ICDF(7931), AOM_ICDF(20318), AOM_ICDF(21429), AOM_ICDF(21817), AOM_ICDF(21997), AOM_ICDF(22345), AOM_ICDF(22526), AOM_ICDF(23105), AOM_ICDF(23829), AOM_ICDF(25586), AOM_ICDF(26598), AOM_ICDF(27385), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6461), AOM_ICDF(7883), AOM_ICDF(22735), AOM_ICDF(22941), AOM_ICDF(23061), AOM_ICDF(23170), AOM_ICDF(23671), AOM_ICDF(24830), AOM_ICDF(25109), AOM_ICDF(26711), AOM_ICDF(27168), AOM_ICDF(28668), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9870), AOM_ICDF(12532), AOM_ICDF(14896), AOM_ICDF(17822), AOM_ICDF(18219), AOM_ICDF(18649), AOM_ICDF(19079), AOM_ICDF(23162), AOM_ICDF(24634), AOM_ICDF(28800), AOM_ICDF(30057), AOM_ICDF(31098), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8170), AOM_ICDF(13942), AOM_ICDF(15674), AOM_ICDF(16236), AOM_ICDF(20928), AOM_ICDF(22526), AOM_ICDF(24154), AOM_ICDF(25027), AOM_ICDF(26567), AOM_ICDF(29246), AOM_ICDF(29882), AOM_ICDF(31110), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9833), AOM_ICDF(16669), AOM_ICDF(17894), AOM_ICDF(18429), AOM_ICDF(19535), AOM_ICDF(23506), AOM_ICDF(24053), AOM_ICDF(25052), AOM_ICDF(26466), AOM_ICDF(29379), AOM_ICDF(30616), AOM_ICDF(31424), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9558), AOM_ICDF(13127), AOM_ICDF(16722), AOM_ICDF(16945), AOM_ICDF(18404), AOM_ICDF(18965), AOM_ICDF(23157), AOM_ICDF(24785), AOM_ICDF(25444), AOM_ICDF(28879), AOM_ICDF(29715), AOM_ICDF(31451), AOM_ICDF(32768), 0 },
          { AOM_ICDF(8656), AOM_ICDF(11218), AOM_ICDF(15859), AOM_ICDF(16851), AOM_ICDF(17205), AOM_ICDF(17565), AOM_ICDF(18231), AOM_ICDF(24622), AOM_ICDF(25273), AOM_ICDF(28496), AOM_ICDF(29332), AOM_ICDF(31266), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9768), AOM_ICDF(14291), AOM_ICDF(15838), AOM_ICDF(16981), AOM_ICDF(17225), AOM_ICDF(18107), AOM_ICDF(18654), AOM_ICDF(20335), AOM_ICDF(24118), AOM_ICDF(28540), AOM_ICDF(30170), AOM_ICDF(31448), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10347), AOM_ICDF(15055), AOM_ICDF(17791), AOM_ICDF(18218), AOM_ICDF(18600), AOM_ICDF(19290), AOM_ICDF(19932), AOM_ICDF(21554), AOM_ICDF(22592), AOM_ICDF(26896), AOM_ICDF(28359), AOM_ICDF(30358), AOM_ICDF(32768), 0 },
          { AOM_ICDF(9093), AOM_ICDF(14028), AOM_ICDF(17143), AOM_ICDF(17521), AOM_ICDF(17893), AOM_ICDF(18675), AOM_ICDF(19203), AOM_ICDF(20715), AOM_ICDF(21674), AOM_ICDF(25422), AOM_ICDF(28036), AOM_ICDF(29528), AOM_ICDF(32768), 0 },
          { AOM_ICDF(10719), AOM_ICDF(15009), AOM_ICDF(18593), AOM_ICDF(19033), AOM_ICDF(19256), AOM_ICDF(19708), AOM_ICDF(20387), AOM_ICDF(22033), AOM_ICDF(22877), AOM_ICDF(26524), AOM_ICDF(27841), AOM_ICDF(30214), AOM_ICDF(32768), 0 },
          { AOM_ICDF(6775), AOM_ICDF(10524), AOM_ICDF(14225), AOM_ICDF(14551), AOM_ICDF(14761), AOM_ICDF(14914), AOM_ICDF(15132), AOM_ICDF(16033), AOM_ICDF(16477), AOM_ICDF(17963), AOM_ICDF(18795), AOM_ICDF(19673), AOM_ICDF(32768), 0 }
        }
#else
      {
          {
