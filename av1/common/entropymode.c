...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(25158), AOM_ICDF(25338), AOM_ICDF(25725), AOM_ICDF(25963),
        AOM_ICDF(26107), AOM_ICDF(26247), AOM_ICDF(26421), AOM_ICDF(26746),
        AOM_ICDF(26910), AOM_ICDF(27794), AOM_ICDF(28365), AOM_ICDF(28732),
        AOM_ICDF(30281), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7946), AOM_ICDF(19524), AOM_ICDF(19638), AOM_ICDF(19826),
        AOM_ICDF(19998), AOM_ICDF(20623), AOM_ICDF(20718), AOM_ICDF(20840),
        AOM_ICDF(21502), AOM_ICDF(22874), AOM_ICDF(23353), AOM_ICDF(24497),
        AOM_ICDF(29175), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9919), AOM_ICDF(9967), AOM_ICDF(20571), AOM_ICDF(20682),
        AOM_ICDF(20802), AOM_ICDF(20865), AOM_ICDF(21388), AOM_ICDF(22073),
        AOM_ICDF(22142), AOM_ICDF(23259), AOM_ICDF(24307), AOM_ICDF(24658),
        AOM_ICDF(29385), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10044), AOM_ICDF(10513), AOM_ICDF(10857), AOM_ICDF(17845),
        AOM_ICDF(18289), AOM_ICDF(18701), AOM_ICDF(19043), AOM_ICDF(20782),
        AOM_ICDF(22201), AOM_ICDF(24354), AOM_ICDF(25312), AOM_ICDF(26304),
        AOM_ICDF(27487), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5006), AOM_ICDF(5544), AOM_ICDF(6308), AOM_ICDF(6705),
        AOM_ICDF(21451), AOM_ICDF(22786), AOM_ICDF(24323), AOM_ICDF(24764),
        AOM_ICDF(25067), AOM_ICDF(26684), AOM_ICDF(27245), AOM_ICDF(27778),
        AOM_ICDF(28148), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5099), AOM_ICDF(6595), AOM_ICDF(6975), AOM_ICDF(7363),
        AOM_ICDF(9253), AOM_ICDF(22618), AOM_ICDF(23085), AOM_ICDF(23450),
        AOM_ICDF(23907), AOM_ICDF(25815), AOM_ICDF(26693), AOM_ICDF(27542),
        AOM_ICDF(28343), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6825), AOM_ICDF(7045), AOM_ICDF(8611), AOM_ICDF(8866),
        AOM_ICDF(10275), AOM_ICDF(10615), AOM_ICDF(23602), AOM_ICDF(24035),
        AOM_ICDF(24244), AOM_ICDF(26266), AOM_ICDF(27025), AOM_ICDF(27679),
        AOM_ICDF(28452), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10562), AOM_ICDF(10670), AOM_ICDF(11510), AOM_ICDF(12279),
        AOM_ICDF(12512), AOM_ICDF(12649), AOM_ICDF(12958), AOM_ICDF(22312),
        AOM_ICDF(22544), AOM_ICDF(24678), AOM_ICDF(25703), AOM_ICDF(26287),
        AOM_ICDF(27676), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8368), AOM_ICDF(9304), AOM_ICDF(9491), AOM_ICDF(10654),
        AOM_ICDF(10971), AOM_ICDF(11355), AOM_ICDF(11585), AOM_ICDF(12152),
        AOM_ICDF(21823), AOM_ICDF(24135), AOM_ICDF(24984), AOM_ICDF(26023),
        AOM_ICDF(27394), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18289), AOM_ICDF(18561), AOM_ICDF(19143), AOM_ICDF(19465),
        AOM_ICDF(19747), AOM_ICDF(19992), AOM_ICDF(20336), AOM_ICDF(20875),
        AOM_ICDF(21162), AOM_ICDF(24625), AOM_ICDF(25729), AOM_ICDF(26604),
        AOM_ICDF(28532), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14558), AOM_ICDF(15217), AOM_ICDF(15966), AOM_ICDF(16400),
        AOM_ICDF(16841), AOM_ICDF(17259), AOM_ICDF(17714), AOM_ICDF(18433),
        AOM_ICDF(18964), AOM_ICDF(22008), AOM_ICDF(24639), AOM_ICDF(25349),
        AOM_ICDF(27821), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15779), AOM_ICDF(16179), AOM_ICDF(17130), AOM_ICDF(17576),
        AOM_ICDF(17973), AOM_ICDF(18293), AOM_ICDF(18778), AOM_ICDF(19504),
        AOM_ICDF(19916), AOM_ICDF(22871), AOM_ICDF(23670), AOM_ICDF(25716),
        AOM_ICDF(27807), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3889), AOM_ICDF(5517), AOM_ICDF(7790), AOM_ICDF(8097),
        AOM_ICDF(8324), AOM_ICDF(8572), AOM_ICDF(8831), AOM_ICDF(9321),
        AOM_ICDF(9671), AOM_ICDF(11055), AOM_ICDF(12071), AOM_ICDF(12886),
        AOM_ICDF(29704), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
