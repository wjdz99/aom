...
static const aom_cdf_prob default_bf_is_dr_mode_cdf[BLOCK_SIZE_GROUPS]
                                                   [CDF_SIZE(2)] = {
                                                     { AOM_CDF2(27868) },
                                                     { AOM_CDF2(22605) },
                                                     { AOM_CDF2(23714) },
...
static const aom_cdf_prob
    default_bf_dr_mode_cdf[BLOCK_SIZE_GROUPS][CDF_SIZE(DIRECTIONAL_MODES)] = {
      { AOM_CDF8(2604, 6718, 9262, 13833, 18024, 22222, 28042) },
      { AOM_CDF8(3693, 14186, 16338, 18510, 20932, 24616, 30160) },
      { AOM_CDF8(5142, 15093, 17174, 18496, 20558, 22723, 29665) },
      { AOM_CDF8(8294, 16812, 18295, 19077, 21982, 23216, 29345) },
    };

static const aom_cdf_prob
    default_bf_none_dr_mode_cdf[BLOCK_SIZE_GROUPS]
                               [CDF_SIZE(NONE_DIRECTIONAL_MODES)] = {
                                 { AOM_CDF5(28385, 29756, 30290, 31103) },
                                 { AOM_CDF5(28033, 30337, 30743, 31992) },
                                 { AOM_CDF5(27735, 29847, 30304, 31572) },
                                 { AOM_CDF5(25895, 27481, 27853, 28909) },
                               };
#else
...
#if !CONFIG_INTRA_ENTROPY
#if CONFIG_DERIVED_INTRA_MODE
aom_cdf_prob default_kf_is_dr_mode_cdf[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS]
                                      [CDF_SIZE(2)] = {
                                        {
                                            { AOM_CDF2(23130) },
                                            { AOM_CDF2(20057) },
...
aom_cdf_prob
    default_kf_dr_mode_cdf[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS][CDF_SIZE(
        DIRECTIONAL_MODES)] = {
      {
          { AOM_CDF8(6701, 14766, 17090, 19654, 22251, 25286, 29816) },
          { AOM_CDF8(13923, 17522, 20580, 21750, 23785, 24907, 28270) },
          { AOM_CDF8(2870, 5409, 6485, 16330, 22812, 29118, 31193) },
          { AOM_CDF8(1647, 20546, 21766, 22711, 23436, 25650, 31764) },
          { AOM_CDF8(6197, 13553, 16459, 18459, 20944, 23475, 29162) },
          { AOM_CDF8(10162, 23186, 24646, 25460, 26676, 27942, 30508) },
      },
      {
          { AOM_CDF8(16605, 19096, 22192, 23134, 25254, 25881, 27756) },
          { AOM_CDF8(17187, 19002, 22712, 23091, 24159, 24385, 25758) },
          { AOM_CDF8(9588, 10904, 13124, 17612, 24115, 26364, 27712) },
          { AOM_CDF8(6978, 14135, 19162, 19898, 21036, 22044, 28877) },
          { AOM_CDF8(14000, 16137, 20373, 21301, 23419, 24040, 26587) },
          { AOM_CDF8(21037, 24084, 25604, 26028, 27173, 27529, 28860) },
      },
      {
          { AOM_CDF8(2410, 5143, 5846, 15779, 23715, 29277, 31596) },
          { AOM_CDF8(7404, 9140, 10478, 15835, 24082, 26970, 30084) },
          { AOM_CDF8(848, 1751, 2011, 17026, 26039, 31389, 32324) },
          { AOM_CDF8(1208, 10583, 11295, 16010, 19269, 24994, 31929) },
          { AOM_CDF8(3617, 6693, 7852, 14789, 22427, 27493, 30854) },
          { AOM_CDF8(6657, 14837, 15794, 19253, 25104, 28402, 30626) },
      },
      {
          { AOM_CDF8(2412, 18769, 20771, 22046, 23206, 25803, 31115) },
          { AOM_CDF8(6734, 13543, 18717, 19729, 21194, 22463, 29035) },
          { AOM_CDF8(2352, 9511, 10934, 17125, 21525, 27947, 31404) },
          { AOM_CDF8(628, 22398, 23372, 23849, 24173, 25459, 32261) },
          { AOM_CDF8(2343, 16905, 19478, 20505, 21615, 23988, 30805) },
          { AOM_CDF8(4639, 25150, 26379, 26833, 27362, 28361, 31429) },
      },
      {
          { AOM_CDF8(5337, 13431, 16693, 18683, 21126, 23636, 28816) },
          { AOM_CDF8(10629, 13731, 18228, 19324, 21350, 22388, 26483) },
          { AOM_CDF8(3616, 6781, 8700, 15582, 22310, 27403, 30159) },
          { AOM_CDF8(1500, 18984, 20938, 21803, 22503, 24472, 31245) },
          { AOM_CDF8(5671, 13081, 16662, 18204, 20388, 22436, 28325) },
          { AOM_CDF8(8241, 20852, 22881, 23976, 25256, 26554, 29451) },
      },
      {
          { AOM_CDF8(13828, 23149, 24331, 25407, 26932, 28042, 30616) },
          { AOM_CDF8(20307, 24364, 25561, 26063, 27405, 27970, 30085) },
          { AOM_CDF8(9134, 12806, 13607, 19310, 25472, 28912, 30857) },
          { AOM_CDF8(3229, 26259, 26746, 27120, 27591, 28290, 31975) },
          { AOM_CDF8(12982, 21101, 22674, 23640, 25305, 26465, 30060) },
          { AOM_CDF8(11737, 25832, 26543, 26957, 28154, 28531, 30925) },
      },
    };

aom_cdf_prob
    default_kf_none_dr_mode_cdf[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS]
                               [CDF_SIZE(NONE_DIRECTIONAL_MODES)] = {
                                 {
                                     { AOM_CDF5(21657, 27930, 29812, 32019) },
                                     { AOM_CDF5(20857, 27401, 30102, 31878) },
                                     { AOM_CDF5(23180, 28813, 30498, 32424) },
                                     { AOM_CDF5(20494, 26555, 28003, 31421) },
                                     { AOM_CDF5(20403, 27455, 29707, 32124) },
                                     { AOM_CDF5(19527, 24377, 26468, 28376) },
                                 },
                                 {
                                     { AOM_CDF5(19312, 26111, 29353, 31144) },
                                     { AOM_CDF5(18416, 25362, 29557, 30991) },
                                     { AOM_CDF5(19806, 26524, 29789, 31572) },
                                     { AOM_CDF5(17942, 24637, 27144, 30024) },
                                     { AOM_CDF5(18267, 25681, 29572, 31387) },
                                     { AOM_CDF5(14457, 18228, 21494, 22607) },
                                 },
                                 {
                                     { AOM_CDF5(23280, 28703, 30604, 32363) },
                                     { AOM_CDF5(21486, 27690, 30729, 32204) },
                                     { AOM_CDF5(26666, 30137, 31385, 32544) },
                                     { AOM_CDF5(21859, 27322, 28811, 31688) },
                                     { AOM_CDF5(21936, 28181, 30437, 32373) },
                                     { AOM_CDF5(20525, 25083, 27255, 28710) },
                                 },
                                 {
                                     { AOM_CDF5(21146, 27557, 29076, 32055) },
                                     { AOM_CDF5(19395, 26932, 29171, 31623) },
                                     { AOM_CDF5(22686, 28293, 29603, 32349) },
                                     { AOM_CDF5(19960, 25797, 26904, 31315) },
                                     { AOM_CDF5(19814, 26966, 28787, 32113) },
                                     { AOM_CDF5(19662, 24495, 26052, 28768) },
                                 },
                                 {
                                     { AOM_CDF5(20322, 27464, 29454, 32122) },
                                     { AOM_CDF5(19206, 26800, 29707, 31944) },
                                     { AOM_CDF5(21486, 28130, 30029, 32404) },
                                     { AOM_CDF5(19325, 25976, 27478, 31572) },
                                     { AOM_CDF5(19544, 27168, 29480, 32183) },
                                     { AOM_CDF5(18439, 24206, 26108, 28647) },
                                 },
                                 {
                                     { AOM_CDF5(19181, 23922, 25834, 27786) },
                                     { AOM_CDF5(18493, 23535, 26429, 28048) },
                                     { AOM_CDF5(21944, 26968, 28841, 30502) },
                                     { AOM_CDF5(17568, 21652, 22972, 26484) },
                                     { AOM_CDF5(18281, 23966, 26762, 29205) },
                                     { AOM_CDF5(14858, 17427, 19573, 21186) },
                                 },
                               };
#else
static const aom_cdf_prob
...
static const aom_cdf_prob
    default_partition_cdf[PARTITION_CONTEXTS][CDF_SIZE(EXT_PARTITION_TYPES)] = {
      ...
      // 16x16
      { AOM_CDF6(15597, 20929, 24571, 26706, 27664) },
      { AOM_CDF6(7925, 11043, 16785, 22470, 23971) },
      { AOM_CDF6(5414, 13269, 15111, 20488, 22360) },
      { AOM_CDF6(2662, 6362, 8614, 20860, 23053) },
      // 32x32
      { AOM_CDF6(18462, 20920, 23124, 27647, 28227) },
      { AOM_CDF6(7689, 9060, 12056, 24992, 25660) },
      { AOM_CDF6(6015, 9009, 10062, 24544, 25409) },
      { AOM_CDF6(1394, 2208, 2796, 28614, 29061) },
      // 64x64
      { AOM_CDF6(20137, 21547, 23078, 29566, 29837) },
      { AOM_CDF6(6732, 7490, 9497, 27944, 28250) },
      { AOM_CDF6(5945, 7663, 8348, 28683, 29117) },
      { AOM_CDF6(870, 1212, 1487, 31198, 31394) },
      // 128x128
      { AOM_CDF4(27899, 28219, 28529) },
      { AOM_CDF4(6607, 6990, 8268) },
      { AOM_CDF4(5429, 6676, 7122) },
      { AOM_CDF4(711, 966, 1172) },
    };
#else
static const aom_cdf_prob
    default_partition_cdf[PARTITION_CONTEXTS][CDF_SIZE(EXT_PARTITION_TYPES)] = {
...
static const aom_cdf_prob
    default_inter_compound_mode_cdf[INTER_MODE_CONTEXTS][CDF_SIZE(
      ...
      { AOM_CDF9(23325, 25708, 28258, 30758, 31058, 31758, 32058, 32758) },
      { AOM_CDF9(17454, 21499, 25168, 26046, 27046, 28046, 29046, 30046) },
      { AOM_CDF9(24273, 26536, 28704, 30592, 31092, 31592, 32092, 32592) },
      { AOM_CDF9(23214, 25998, 28442, 29330, 30330, 31330, 31930, 32330) }
    };
...
#if CONFIG_ILLUM_MCOMP && CONFIG_INTERINTRA_ML
static const aom_cdf_prob
    default_interintra_mode_cdf[BLOCK_SIZE_GROUPS][CDF_SIZE(
        INTERINTRA_MODES)] = { { AOM_CDF5(8192, 16384, 24576, 31000) },
...
static const aom_cdf_prob
    default_interintra_ml_mode_cdf[BLOCK_SIZE_GROUPS][CDF_SIZE(
        INTERINTRA_MODES)] = {
      { AOM_CDF15(1082, 4372, 11544, 14335, 16384, 18024, 19664, 21304, 22944,
                  24584, 26224, 27864, 29504, 31144) },
      { AOM_CDF15(1082, 4372, 11544, 14335, 16384, 18024, 19664, 21304, 22944,
                  24584, 26224, 27864, 29504, 31144) },
      { AOM_CDF15(1082, 4372, 11544, 14335, 16384, 18024, 19664, 21304, 22944,
                  24584, 26224, 27864, 29504, 31144) },
...
static const aom_cdf_prob
    default_comp_motion_mode_cdf[BLOCK_SIZES_ALL][CDF_SIZE(MOTION_MODES)] = {
      { AOM_CDF3(21845, 21845) }, { AOM_CDF3(21845, 21845) },
      { AOM_CDF3(21845, 21845) }, { AOM_CDF3(24760, 24760) },
      { AOM_CDF3(24765, 24765) },  { AOM_CDF3(25528, 25528) },
      { AOM_CDF3(26810, 26810) }, { AOM_CDF3(23606, 23606) },
      { AOM_CDF3(24308, 24308) }, { AOM_CDF3(29116, 29116) },
      { AOM_CDF3(28062, 28062) }, { AOM_CDF3(26830, 26830) },
      { AOM_CDF3(30701, 30701) }, { AOM_CDF3(30397, 30397) },
      { AOM_CDF3(31335, 31335) }, { AOM_CDF3(32558, 32558) },
      { AOM_CDF3(21845, 21845) }, { AOM_CDF3(21845, 21845) },
      { AOM_CDF3(31390, 31390) }, { AOM_CDF3(30774, 30774) },
      { AOM_CDF3(31594, 31594) }, { AOM_CDF3(31203, 31203) },
#if CONFIG_FLEX_PARTITION
      { AOM_CDF3(16384, 24576) }, { AOM_CDF3(16384, 24576) },
      { AOM_CDF3(16384, 27000) }, { AOM_CDF3(16384, 27000) },
      { AOM_CDF3(16384, 27000) }, { AOM_CDF3(16384, 27000) },
...
static void init_entropy_models(FRAME_CONTEXT *const fc) {
  ...
  av1_zero(*intra_y_mode);
  intra_y_mode->lr = intra_y_mode_lr;
  intra_y_mode->num_hidden_layers = 0;
  intra_y_mode->num_logits = INTRA_MODES;
  intra_y_mode->loss = SOFTMAX_CROSS_ENTROPY_LOSS;
  FC_INPUT_LAYER_EM *const intra_y_mode_input_layer =
      &intra_y_mode->input_layer;
  intra_y_mode_input_layer->num_sparse_inputs = EM_NUM_Y_SPARSE_FEATURES;
  intra_y_mode_input_layer->num_dense_inputs = EM_NUM_Y_DENSE_FEATURES;
  memcpy(intra_y_mode_input_layer->sparse_input_size, intra_y_sparse_feat_sizes,
         sizeof(intra_y_sparse_feat_sizes));
  intra_y_mode_input_layer->num_outputs = INTRA_MODES;
  intra_y_mode_input_layer->activation = ACTN_NONE;
  float *const intra_y_mode_sprse_weights[2] = {
    fc->intra_y_mode_input_layer_sparse_0_weights,
    fc->intra_y_mode_input_layer_sparse_1_weights,
  };
  for (int idx = 0; idx < intra_y_mode_input_layer->num_sparse_inputs; idx++) {
    const int arr_size = intra_y_mode_input_layer->sparse_input_size[idx] *
                         intra_y_mode_input_layer->num_outputs;
    av1_copy_array(intra_y_mode_sprse_weights[idx],
                   intra_y_mode_input_layer_sparse_weights[idx], arr_size);
  }
  if (intra_y_mode->input_layer.num_dense_inputs > 0) {
    memcpy(fc->intra_y_mode_input_layer_dense_weights,
           intra_y_mode_input_layer_dense_weights,
           sizeof(intra_y_mode_input_layer_dense_weights));
  }
  memcpy(fc->intra_y_mode_input_layer_bias, intra_y_mode_input_layer_bias,
         sizeof(intra_y_mode_input_layer_bias));

  // Intra UV mode model.
  NN_CONFIG_EM *intra_uv_mode = &fc->intra_uv_mode;
  av1_zero(*intra_uv_mode);
  intra_uv_mode->lr = intra_uv_mode_lr;
  intra_uv_mode->num_hidden_layers = 0;
  intra_uv_mode->num_logits = UV_INTRA_MODES;
  intra_uv_mode->loss = SOFTMAX_CROSS_ENTROPY_LOSS;
  FC_INPUT_LAYER_EM *const intra_uv_mode_input_layer =
      &intra_uv_mode->input_layer;
  intra_uv_mode_input_layer->num_sparse_inputs = EM_NUM_UV_SPARSE_FEATURES;
  intra_uv_mode_input_layer->num_dense_inputs = 0;
  memcpy(intra_uv_mode_input_layer->sparse_input_size,
         intra_uv_sparse_feat_sizes, sizeof(intra_uv_sparse_feat_sizes));
  intra_uv_mode_input_layer->num_outputs = UV_INTRA_MODES;
  intra_uv_mode_input_layer->activation = ACTN_NONE;
  float *const intra_uv_mode_sprse_weights[2] = {
    fc->intra_uv_mode_input_layer_sparse_0_weights,
    fc->intra_uv_mode_input_layer_sparse_1_weights,
  };
  for (int idx = 0; idx < intra_uv_mode_input_layer->num_sparse_inputs; idx++) {
    const int arr_size = intra_uv_mode_input_layer->sparse_input_size[idx] *
                         intra_uv_mode_input_layer->num_outputs;
    av1_copy_array(intra_uv_mode_sprse_weights[idx],
                   intra_uv_mode_input_layer_sparse_weights[idx], arr_size);
  }
  if (intra_uv_mode_input_layer->num_dense_inputs > 0) {
    memcpy(fc->intra_y_mode_input_layer_dense_weights,
           intra_uv_mode_input_layer_dense_weights,
           sizeof(intra_uv_mode_input_layer_dense_weights));
  }
...
static void init_mode_probs(FRAME_CONTEXT *fc) {
...
#if CONFIG_DERIVED_INTRA_MODE
  av1_copy(fc->kf_is_dr_mode_cdf, default_kf_is_dr_mode_cdf);
  av1_copy(fc->kf_dr_mode_cdf, default_kf_dr_mode_cdf);
  av1_copy(fc->kf_none_dr_mode_cdf, default_kf_none_dr_mode_cdf);
#else
...
#if CONFIG_ENHANCED_WARPED_MOTION
  av1_copy(fc->comp_motion_mode_cdf, default_comp_motion_mode_cdf);
#endif  // CONFIG_ENHANCED_WARPED_MOTION
  ...
  av1_copy(fc->bf_none_dr_mode_cdf, default_bf_none_dr_mode_cdf);
#else
