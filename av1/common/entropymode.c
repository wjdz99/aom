...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(11019), AOM_ICDF(12095), AOM_ICDF(13706), AOM_ICDF(14857),
        AOM_ICDF(15599), AOM_ICDF(16359), AOM_ICDF(17243), AOM_ICDF(18582),
        AOM_ICDF(19373), AOM_ICDF(21690), AOM_ICDF(24031), AOM_ICDF(26108),
        AOM_ICDF(28968), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5216), AOM_ICDF(10539), AOM_ICDF(11432), AOM_ICDF(12588),
        AOM_ICDF(13439), AOM_ICDF(15235), AOM_ICDF(15896), AOM_ICDF(16709),
        AOM_ICDF(18387), AOM_ICDF(20644), AOM_ICDF(22581), AOM_ICDF(24957),
        AOM_ICDF(29009), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5985), AOM_ICDF(6530), AOM_ICDF(12050), AOM_ICDF(12757),
        AOM_ICDF(13432), AOM_ICDF(13915), AOM_ICDF(15474), AOM_ICDF(17627),
        AOM_ICDF(18110), AOM_ICDF(20366), AOM_ICDF(22851), AOM_ICDF(24687),
        AOM_ICDF(28933), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4748), AOM_ICDF(6492), AOM_ICDF(8086), AOM_ICDF(12025),
        AOM_ICDF(13430), AOM_ICDF(14856), AOM_ICDF(16208), AOM_ICDF(18235),
        AOM_ICDF(20342), AOM_ICDF(22629), AOM_ICDF(24661), AOM_ICDF(26732),
        AOM_ICDF(28794), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4392), AOM_ICDF(5959), AOM_ICDF(7773), AOM_ICDF(9149),
        AOM_ICDF(14238), AOM_ICDF(16390), AOM_ICDF(18826), AOM_ICDF(20352),
        AOM_ICDF(21613), AOM_ICDF(23829), AOM_ICDF(25672), AOM_ICDF(27493),
        AOM_ICDF(28950), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3939), AOM_ICDF(6117), AOM_ICDF(7615), AOM_ICDF(9089),
        AOM_ICDF(11546), AOM_ICDF(16595), AOM_ICDF(18095), AOM_ICDF(19497),
        AOM_ICDF(20961), AOM_ICDF(23251), AOM_ICDF(25292), AOM_ICDF(27336),
        AOM_ICDF(29228), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4613), AOM_ICDF(5842), AOM_ICDF(8288), AOM_ICDF(9527),
        AOM_ICDF(11728), AOM_ICDF(13012), AOM_ICDF(18157), AOM_ICDF(19710),
        AOM_ICDF(20808), AOM_ICDF(23120), AOM_ICDF(25222), AOM_ICDF(27216),
        AOM_ICDF(29098), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5558), AOM_ICDF(6585), AOM_ICDF(8779), AOM_ICDF(10372),
        AOM_ICDF(11418), AOM_ICDF(12331), AOM_ICDF(13583), AOM_ICDF(18321),
        AOM_ICDF(19369), AOM_ICDF(21706), AOM_ICDF(23977), AOM_ICDF(25960),
        AOM_ICDF(28350), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4805), AOM_ICDF(6879), AOM_ICDF(8172), AOM_ICDF(10469),
        AOM_ICDF(11681), AOM_ICDF(13022), AOM_ICDF(14126), AOM_ICDF(15545),
        AOM_ICDF(19789), AOM_ICDF(22102), AOM_ICDF(24145), AOM_ICDF(26285),
        AOM_ICDF(28514), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7715), AOM_ICDF(8867), AOM_ICDF(10548), AOM_ICDF(11705),
        AOM_ICDF(12739), AOM_ICDF(13694), AOM_ICDF(14833), AOM_ICDF(16343),
        AOM_ICDF(17300), AOM_ICDF(20382), AOM_ICDF(22992), AOM_ICDF(25421),
        AOM_ICDF(28203), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6062), AOM_ICDF(7704), AOM_ICDF(9471), AOM_ICDF(10881),
        AOM_ICDF(12196), AOM_ICDF(13517), AOM_ICDF(14886), AOM_ICDF(16540),
        AOM_ICDF(17892), AOM_ICDF(20665), AOM_ICDF(23670), AOM_ICDF(25756),
        AOM_ICDF(28457), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6477), AOM_ICDF(7827), AOM_ICDF(9743), AOM_ICDF(11144),
        AOM_ICDF(12406), AOM_ICDF(13595), AOM_ICDF(14996), AOM_ICDF(16720),
        AOM_ICDF(17938), AOM_ICDF(20691), AOM_ICDF(22886), AOM_ICDF(25706),
        AOM_ICDF(28344), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4960), AOM_ICDF(7259), AOM_ICDF(9987), AOM_ICDF(11301),
        AOM_ICDF(12409), AOM_ICDF(13622), AOM_ICDF(14840), AOM_ICDF(16465),
        AOM_ICDF(17772), AOM_ICDF(20050), AOM_ICDF(22313), AOM_ICDF(24412),
        AOM_ICDF(29608), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
