...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(14940), AOM_ICDF(15682), AOM_ICDF(17014), AOM_ICDF(17696),
        AOM_ICDF(18238), AOM_ICDF(18723), AOM_ICDF(19399), AOM_ICDF(20426),
        AOM_ICDF(20962), AOM_ICDF(23290), AOM_ICDF(24977), AOM_ICDF(26298),
        AOM_ICDF(28324), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5216), AOM_ICDF(14513), AOM_ICDF(14973), AOM_ICDF(15536),
        AOM_ICDF(16030), AOM_ICDF(17454), AOM_ICDF(17762), AOM_ICDF(18161),
        AOM_ICDF(19544), AOM_ICDF(21803), AOM_ICDF(23080), AOM_ICDF(24757),
        AOM_ICDF(28120), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6175), AOM_ICDF(6357), AOM_ICDF(15450), AOM_ICDF(15792),
        AOM_ICDF(16196), AOM_ICDF(16403), AOM_ICDF(17737), AOM_ICDF(19469),
        AOM_ICDF(19677), AOM_ICDF(21884), AOM_ICDF(23593), AOM_ICDF(24794),
        AOM_ICDF(28214), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6059), AOM_ICDF(7195), AOM_ICDF(8129), AOM_ICDF(13433),
        AOM_ICDF(14376), AOM_ICDF(15273), AOM_ICDF(16079), AOM_ICDF(18069),
        AOM_ICDF(20084), AOM_ICDF(22617), AOM_ICDF(24193), AOM_ICDF(25772),
        AOM_ICDF(27283), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4006), AOM_ICDF(5070), AOM_ICDF(6400), AOM_ICDF(7199),
        AOM_ICDF(15996), AOM_ICDF(17986), AOM_ICDF(20247), AOM_ICDF(21204),
        AOM_ICDF(21935), AOM_ICDF(24073), AOM_ICDF(25279), AOM_ICDF(26445),
        AOM_ICDF(27258), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3780), AOM_ICDF(6007), AOM_ICDF(6889), AOM_ICDF(7725),
        AOM_ICDF(10233), AOM_ICDF(18765), AOM_ICDF(19722), AOM_ICDF(20534),
        AOM_ICDF(21525), AOM_ICDF(23761), AOM_ICDF(25281), AOM_ICDF(26662),
        AOM_ICDF(27884), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4527), AOM_ICDF(5161), AOM_ICDF(7624), AOM_ICDF(8251),
        AOM_ICDF(10458), AOM_ICDF(11216), AOM_ICDF(19758), AOM_ICDF(20784),
        AOM_ICDF(21351), AOM_ICDF(23750), AOM_ICDF(25129), AOM_ICDF(26510),
        AOM_ICDF(27688), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6828), AOM_ICDF(7235), AOM_ICDF(9189), AOM_ICDF(10317),
        AOM_ICDF(10949), AOM_ICDF(11359), AOM_ICDF(12172), AOM_ICDF(18998),
        AOM_ICDF(19574), AOM_ICDF(22253), AOM_ICDF(23880), AOM_ICDF(25252),
        AOM_ICDF(26979), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5417), AOM_ICDF(7249), AOM_ICDF(7871), AOM_ICDF(9662),
        AOM_ICDF(10435), AOM_ICDF(11311), AOM_ICDF(11915), AOM_ICDF(12906),
        AOM_ICDF(19654), AOM_ICDF(22269), AOM_ICDF(23859), AOM_ICDF(25425),
        AOM_ICDF(27017), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10190), AOM_ICDF(11049), AOM_ICDF(12573), AOM_ICDF(13295),
        AOM_ICDF(14094), AOM_ICDF(14760), AOM_ICDF(15687), AOM_ICDF(16918),
        AOM_ICDF(17600), AOM_ICDF(21337), AOM_ICDF(23353), AOM_ICDF(25200),
        AOM_ICDF(27168), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8242), AOM_ICDF(9603), AOM_ICDF(11079), AOM_ICDF(11963),
        AOM_ICDF(12909), AOM_ICDF(13831), AOM_ICDF(14796), AOM_ICDF(16126),
        AOM_ICDF(17147), AOM_ICDF(20528), AOM_ICDF(23321), AOM_ICDF(24812),
        AOM_ICDF(27058), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8731), AOM_ICDF(9665), AOM_ICDF(11607), AOM_ICDF(12501),
        AOM_ICDF(13389), AOM_ICDF(14124), AOM_ICDF(15219), AOM_ICDF(16625),
        AOM_ICDF(17455), AOM_ICDF(20783), AOM_ICDF(22392), AOM_ICDF(24922),
        AOM_ICDF(26908), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5930), AOM_ICDF(8627), AOM_ICDF(12143), AOM_ICDF(12909),
        AOM_ICDF(13557), AOM_ICDF(14241), AOM_ICDF(14974), AOM_ICDF(16146),
        AOM_ICDF(16999), AOM_ICDF(19336), AOM_ICDF(21101), AOM_ICDF(22652),
        AOM_ICDF(28840), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
