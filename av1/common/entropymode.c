...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(28698), AOM_ICDF(28768), AOM_ICDF(28887), AOM_ICDF(29033),
        AOM_ICDF(29104), AOM_ICDF(29181), AOM_ICDF(29259), AOM_ICDF(29383),
        AOM_ICDF(29452), AOM_ICDF(29610), AOM_ICDF(29942), AOM_ICDF(30156),
        AOM_ICDF(31796), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16357), AOM_ICDF(18680), AOM_ICDF(18772), AOM_ICDF(19034),
        AOM_ICDF(19163), AOM_ICDF(19629), AOM_ICDF(19725), AOM_ICDF(19852),
        AOM_ICDF(20282), AOM_ICDF(20642), AOM_ICDF(21032), AOM_ICDF(22423),
        AOM_ICDF(31234), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16901), AOM_ICDF(16962), AOM_ICDF(19353), AOM_ICDF(19459),
        AOM_ICDF(19543), AOM_ICDF(19608), AOM_ICDF(19864), AOM_ICDF(20374),
        AOM_ICDF(20435), AOM_ICDF(20710), AOM_ICDF(22160), AOM_ICDF(22408),
        AOM_ICDF(31226), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14541), AOM_ICDF(15224), AOM_ICDF(15827), AOM_ICDF(20432),
        AOM_ICDF(21048), AOM_ICDF(21713), AOM_ICDF(22293), AOM_ICDF(23507),
        AOM_ICDF(24560), AOM_ICDF(25548), AOM_ICDF(26727), AOM_ICDF(28065),
        AOM_ICDF(30487), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17180), AOM_ICDF(17647), AOM_ICDF(18264), AOM_ICDF(18993),
        AOM_ICDF(23958), AOM_ICDF(24978), AOM_ICDF(26305), AOM_ICDF(26885),
        AOM_ICDF(27310), AOM_ICDF(28235), AOM_ICDF(29248), AOM_ICDF(30237),
        AOM_ICDF(31333), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14019), AOM_ICDF(14899), AOM_ICDF(15558), AOM_ICDF(16395),
        AOM_ICDF(17753), AOM_ICDF(22963), AOM_ICDF(23675), AOM_ICDF(24334),
        AOM_ICDF(24983), AOM_ICDF(26062), AOM_ICDF(27232), AOM_ICDF(29019),
        AOM_ICDF(31143), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16677), AOM_ICDF(17071), AOM_ICDF(18024), AOM_ICDF(18579),
        AOM_ICDF(19458), AOM_ICDF(19928), AOM_ICDF(24759), AOM_ICDF(25323),
        AOM_ICDF(25705), AOM_ICDF(26618), AOM_ICDF(28255), AOM_ICDF(29210),
        AOM_ICDF(31264), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17357), AOM_ICDF(17635), AOM_ICDF(18127), AOM_ICDF(18949),
        AOM_ICDF(19243), AOM_ICDF(19526), AOM_ICDF(19872), AOM_ICDF(24068),
        AOM_ICDF(24395), AOM_ICDF(25054), AOM_ICDF(26540), AOM_ICDF(27249),
        AOM_ICDF(30441), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15337), AOM_ICDF(16018), AOM_ICDF(16447), AOM_ICDF(17936),
        AOM_ICDF(18389), AOM_ICDF(18907), AOM_ICDF(19331), AOM_ICDF(19939),
        AOM_ICDF(24193), AOM_ICDF(25031), AOM_ICDF(25991), AOM_ICDF(27428),
        AOM_ICDF(30434), AOM_ICDF(32768), 0 },
      { AOM_ICDF(23347), AOM_ICDF(23474), AOM_ICDF(23630), AOM_ICDF(23910),
        AOM_ICDF(24063), AOM_ICDF(24218), AOM_ICDF(24383), AOM_ICDF(24663),
        AOM_ICDF(24815), AOM_ICDF(25610), AOM_ICDF(26737), AOM_ICDF(27563),
        AOM_ICDF(30612), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18501), AOM_ICDF(18877), AOM_ICDF(19325), AOM_ICDF(19921),
        AOM_ICDF(20294), AOM_ICDF(20667), AOM_ICDF(21091), AOM_ICDF(21718),
        AOM_ICDF(22110), AOM_ICDF(23063), AOM_ICDF(25917), AOM_ICDF(26769),
        AOM_ICDF(30553), AOM_ICDF(32768), 0 },
      { AOM_ICDF(19829), AOM_ICDF(20167), AOM_ICDF(20536), AOM_ICDF(21086),
        AOM_ICDF(21445), AOM_ICDF(21816), AOM_ICDF(22188), AOM_ICDF(22750),
        AOM_ICDF(23121), AOM_ICDF(24017), AOM_ICDF(24993), AOM_ICDF(27190),
        AOM_ICDF(30571), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14287), AOM_ICDF(14861), AOM_ICDF(15513), AOM_ICDF(15908),
        AOM_ICDF(16163), AOM_ICDF(16463), AOM_ICDF(16750), AOM_ICDF(17184),
        AOM_ICDF(17514), AOM_ICDF(18067), AOM_ICDF(19128), AOM_ICDF(20011),
        AOM_ICDF(31509), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
...
#if CONFIG_CFL
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(25397), AOM_ICDF(25578), AOM_ICDF(25979), AOM_ICDF(26180),
        AOM_ICDF(26343), AOM_ICDF(26504), AOM_ICDF(26695), AOM_ICDF(26983),
        AOM_ICDF(27158), AOM_ICDF(27986), AOM_ICDF(28586), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13538), AOM_ICDF(19263), AOM_ICDF(19364), AOM_ICDF(19490),
        AOM_ICDF(19646), AOM_ICDF(20070), AOM_ICDF(20169), AOM_ICDF(20268),
        AOM_ICDF(20691), AOM_ICDF(21573), AOM_ICDF(25100), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14609), AOM_ICDF(14665), AOM_ICDF(20733), AOM_ICDF(20823),
        AOM_ICDF(20942), AOM_ICDF(21015), AOM_ICDF(21369), AOM_ICDF(21796),
        AOM_ICDF(21868), AOM_ICDF(22588), AOM_ICDF(25500), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15853), AOM_ICDF(16041), AOM_ICDF(16188), AOM_ICDF(22037),
        AOM_ICDF(22235), AOM_ICDF(22441), AOM_ICDF(22620), AOM_ICDF(23666),
        AOM_ICDF(24461), AOM_ICDF(26163), AOM_ICDF(26598), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16031), AOM_ICDF(16165), AOM_ICDF(16506), AOM_ICDF(16691),
        AOM_ICDF(24593), AOM_ICDF(25560), AOM_ICDF(26646), AOM_ICDF(26862),
        AOM_ICDF(27091), AOM_ICDF(28012), AOM_ICDF(28318), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13521), AOM_ICDF(14318), AOM_ICDF(14613), AOM_ICDF(14764),
        AOM_ICDF(16058), AOM_ICDF(25031), AOM_ICDF(25256), AOM_ICDF(25391),
        AOM_ICDF(25584), AOM_ICDF(26446), AOM_ICDF(26577), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15674), AOM_ICDF(15757), AOM_ICDF(16707), AOM_ICDF(16847),
        AOM_ICDF(17798), AOM_ICDF(17993), AOM_ICDF(24905), AOM_ICDF(25079),
        AOM_ICDF(25220), AOM_ICDF(26184), AOM_ICDF(26406), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15636), AOM_ICDF(15724), AOM_ICDF(16226), AOM_ICDF(16746),
        AOM_ICDF(16905), AOM_ICDF(17012), AOM_ICDF(17215), AOM_ICDF(23325),
        AOM_ICDF(23482), AOM_ICDF(25174), AOM_ICDF(25521), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14743), AOM_ICDF(15209), AOM_ICDF(15333), AOM_ICDF(16079),
        AOM_ICDF(16280), AOM_ICDF(16536), AOM_ICDF(16683), AOM_ICDF(17011),
        AOM_ICDF(22806), AOM_ICDF(24279), AOM_ICDF(25013), AOM_ICDF(32768), 0 },
      { AOM_ICDF(19412), AOM_ICDF(19632), AOM_ICDF(20042), AOM_ICDF(20251),
        AOM_ICDF(20484), AOM_ICDF(20688), AOM_ICDF(20959), AOM_ICDF(21334),
        AOM_ICDF(21593), AOM_ICDF(23746), AOM_ICDF(25129), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13761), AOM_ICDF(14646), AOM_ICDF(15962), AOM_ICDF(16120),
        AOM_ICDF(16265), AOM_ICDF(16424), AOM_ICDF(16567), AOM_ICDF(16801),
        AOM_ICDF(16979), AOM_ICDF(17882), AOM_ICDF(26211), AOM_ICDF(32768), 0 },
    };
#else
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(4142),  AOM_ICDF(9302),  AOM_ICDF(14227), AOM_ICDF(15503),
  AOM_ICDF(19550), AOM_ICDF(21889), AOM_ICDF(22477), AOM_ICDF(24487),
  AOM_ICDF(26251), AOM_ICDF(27954), AOM_ICDF(29559), AOM_ICDF(30556),
  AOM_ICDF(31309), AOM_ICDF(32042), AOM_ICDF(32768), 0,
};
#endif
