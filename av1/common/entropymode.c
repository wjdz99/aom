...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(27554), AOM_ICDF(27671), AOM_ICDF(27920), AOM_ICDF(28084),
        AOM_ICDF(28187), AOM_ICDF(28284), AOM_ICDF(28405), AOM_ICDF(28620),
        AOM_ICDF(28735), AOM_ICDF(29357), AOM_ICDF(29762), AOM_ICDF(30008),
        AOM_ICDF(31111), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9980), AOM_ICDF(21205), AOM_ICDF(21292), AOM_ICDF(21434),
        AOM_ICDF(21576), AOM_ICDF(22056), AOM_ICDF(22139), AOM_ICDF(22247),
        AOM_ICDF(22769), AOM_ICDF(23903), AOM_ICDF(24268), AOM_ICDF(25260),
        AOM_ICDF(29868), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12217), AOM_ICDF(12263), AOM_ICDF(22231), AOM_ICDF(22320),
        AOM_ICDF(22420), AOM_ICDF(22478), AOM_ICDF(22868), AOM_ICDF(23381),
        AOM_ICDF(23443), AOM_ICDF(24347), AOM_ICDF(25245), AOM_ICDF(25507),
        AOM_ICDF(30090), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11707), AOM_ICDF(12087), AOM_ICDF(12351), AOM_ICDF(19329),
        AOM_ICDF(19692), AOM_ICDF(20025), AOM_ICDF(20295), AOM_ICDF(21895),
        AOM_ICDF(23163), AOM_ICDF(25274), AOM_ICDF(26073), AOM_ICDF(26921),
        AOM_ICDF(27920), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5799), AOM_ICDF(6239), AOM_ICDF(6865), AOM_ICDF(7189),
        AOM_ICDF(22971), AOM_ICDF(24147), AOM_ICDF(25445), AOM_ICDF(25814),
        AOM_ICDF(26064), AOM_ICDF(27522), AOM_ICDF(27988), AOM_ICDF(28424),
        AOM_ICDF(28718), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5941), AOM_ICDF(7275), AOM_ICDF(7574), AOM_ICDF(7870),
        AOM_ICDF(9576), AOM_ICDF(23816), AOM_ICDF(24209), AOM_ICDF(24491),
        AOM_ICDF(24869), AOM_ICDF(26610), AOM_ICDF(27346), AOM_ICDF(28060),
        AOM_ICDF(28724), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8190), AOM_ICDF(8360), AOM_ICDF(9754), AOM_ICDF(9956),
        AOM_ICDF(11213), AOM_ICDF(11495), AOM_ICDF(24731), AOM_ICDF(25084),
        AOM_ICDF(25257), AOM_ICDF(27108), AOM_ICDF(27754), AOM_ICDF(28301),
        AOM_ICDF(28926), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11682), AOM_ICDF(11775), AOM_ICDF(12484), AOM_ICDF(13156),
        AOM_ICDF(13359), AOM_ICDF(13476), AOM_ICDF(13743), AOM_ICDF(23495),
        AOM_ICDF(23700), AOM_ICDF(25767), AOM_ICDF(26641), AOM_ICDF(27142),
        AOM_ICDF(28319), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9652), AOM_ICDF(10487), AOM_ICDF(10644), AOM_ICDF(11624),
        AOM_ICDF(11906), AOM_ICDF(12230), AOM_ICDF(12433), AOM_ICDF(12932),
        AOM_ICDF(22931), AOM_ICDF(25168), AOM_ICDF(25894), AOM_ICDF(26778),
        AOM_ICDF(27963), AOM_ICDF(32768), 0 },
      { AOM_ICDF(21020), AOM_ICDF(21226), AOM_ICDF(21639), AOM_ICDF(21889),
        AOM_ICDF(22105), AOM_ICDF(22297), AOM_ICDF(22551), AOM_ICDF(22960),
        AOM_ICDF(23188), AOM_ICDF(26334), AOM_ICDF(27183), AOM_ICDF(27861),
        AOM_ICDF(29537), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16748), AOM_ICDF(17302), AOM_ICDF(17920), AOM_ICDF(18280),
        AOM_ICDF(18632), AOM_ICDF(18980), AOM_ICDF(19360), AOM_ICDF(19974),
        AOM_ICDF(20417), AOM_ICDF(23218), AOM_ICDF(25713), AOM_ICDF(26289),
        AOM_ICDF(28527), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17844), AOM_ICDF(18171), AOM_ICDF(18958), AOM_ICDF(19326),
        AOM_ICDF(19659), AOM_ICDF(19937), AOM_ICDF(20345), AOM_ICDF(20963),
        AOM_ICDF(21309), AOM_ICDF(24120), AOM_ICDF(24796), AOM_ICDF(26687),
        AOM_ICDF(28580), AOM_ICDF(32768), 0 },
      { AOM_ICDF(2998), AOM_ICDF(4349), AOM_ICDF(6229), AOM_ICDF(6471),
        AOM_ICDF(6652), AOM_ICDF(6836), AOM_ICDF(7030), AOM_ICDF(7411),
        AOM_ICDF(7683), AOM_ICDF(8824), AOM_ICDF(9657), AOM_ICDF(10318),
        AOM_ICDF(30225), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(196),   AOM_ICDF(2849),  AOM_ICDF(6322),  AOM_ICDF(13152),
  AOM_ICDF(21916), AOM_ICDF(23711), AOM_ICDF(25438), AOM_ICDF(26700),
  AOM_ICDF(27669), AOM_ICDF(28890), AOM_ICDF(31520), AOM_ICDF(31823),
  AOM_ICDF(32155), AOM_ICDF(32538), AOM_ICDF(32768), 0
};
#endif
