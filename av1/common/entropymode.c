...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(342),   AOM_ICDF(3488),  AOM_ICDF(6882),  AOM_ICDF(12688),
  AOM_ICDF(17304), AOM_ICDF(18971), AOM_ICDF(22612), AOM_ICDF(23972),
  AOM_ICDF(25175), AOM_ICDF(26357), AOM_ICDF(29047), AOM_ICDF(30431),
  AOM_ICDF(31415), AOM_ICDF(32099), AOM_ICDF(32768),
};
#endif
