...
static const aom_cdf_prob default_eob_multi16[PLANE_TYPES][2][CDF_SIZE(5)] = {
  { { AOM_CDF5(11095, 14048, 19186, 25676) },
    { AOM_CDF5(3358, 5390, 8734, 17448) } },
  { { AOM_CDF5(16097, 19034, 24096, 29183) },
    { AOM_CDF5(6554, 13107, 19661, 26214) } }
};

static const aom_cdf_prob default_eob_multi32[PLANE_TYPES][2][CDF_SIZE(6)] = {
  { { AOM_CDF6(3697, 4786, 6738, 10126, 18089) },
    { AOM_CDF6(998, 1545, 3634, 6981, 14066) } },
  { { AOM_CDF6(15534, 17679, 20895, 25069, 30257) },
    { AOM_CDF6(5461, 10923, 16384, 21845, 27307) } }
};

static const aom_cdf_prob default_eob_multi64[PLANE_TYPES][2][CDF_SIZE(7)] = {
  { { AOM_CDF7(8529, 10115, 12760, 15971, 19983, 25144) },
    { AOM_CDF7(3008, 4256, 6364, 9124, 13594, 20972) } },
  { { AOM_CDF7(19761, 21572, 24130, 26766, 29212, 31545) },
    { AOM_CDF7(4681, 9362, 14043, 18725, 23406, 28087) } }
};

static const aom_cdf_prob default_eob_multi128[PLANE_TYPES][2][CDF_SIZE(8)] = {
  { { AOM_CDF8(4594, 5611, 7481, 9536, 12665, 17234, 23446) },
    { AOM_CDF8(1008, 1777, 3376, 9573, 16104, 21229, 26208) } },
  { { AOM_CDF8(21600, 22966, 25178, 27087, 29025, 30805, 32105) },
    { AOM_CDF8(4096, 8192, 12288, 16384, 20480, 24576, 28672) } }
};

static const aom_cdf_prob default_eob_multi256[PLANE_TYPES][2][CDF_SIZE(9)] = {
  { { AOM_CDF9(7102, 8713, 11218, 14324, 18255, 22201, 25726, 28852) },
    { AOM_CDF9(3641, 7282, 10923, 14564, 18204, 21845, 25486, 29127) } },
  { { AOM_CDF9(21021, 22382, 24380, 26521, 28511, 29961, 31083, 32097) },
    { AOM_CDF9(3641, 7282, 10923, 14564, 18204, 21845, 25486, 29127) } }
};

static const aom_cdf_prob default_eob_multi512[PLANE_TYPES][2][CDF_SIZE(10)] = {
  { { AOM_CDF10(4993, 5945, 8202, 10702, 14231, 17974, 22322, 26132, 28893) },
    { AOM_CDF10(3277, 6554, 9830, 13107, 16384, 19661, 22938, 26214, 29491) } },
  { { AOM_CDF10(21536, 23137, 26012, 28180, 29891, 30903, 31577, 32086,
                32520) },
    { AOM_CDF10(3277, 6554, 9830, 13107, 16384, 19661, 22938, 26214, 29491) } }
};

static const aom_cdf_prob default_eob_multi1024[PLANE_TYPES][2][CDF_SIZE(11)] =
    { { { AOM_CDF11(6104, 7529, 10668, 13589, 16985, 20550, 23911, 26382, 28525,
                    30353) },
        { AOM_CDF11(2979, 5958, 8937, 11916, 14895, 17873, 20852, 23831, 26810,
                    29789) } },
      { { AOM_CDF11(18220, 19652, 22458, 24235, 25832, 27351, 28513, 29426,
                    30474, 31637) },
        { AOM_CDF11(2979, 5958, 8937, 11916, 14895, 17873, 20852, 23831, 26810,
                    29789) } } };
...
static const aom_cdf_prob
    default_coeff_base_multi[TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS]
                            [CDF_SIZE(NUM_BASE_LEVELS + 2)] = {
                              { { { AOM_CDF4(7192, 17765, 24039) },
                                  { AOM_CDF4(23495, 31879, 32645) },
                                  { AOM_CDF4(16341, 29164, 31933) },
                                  { AOM_CDF4(9183, 21432, 27891) },
                                  { AOM_CDF4(5539, 14523, 21737) },
                                  { AOM_CDF4(3422, 9299, 14917) },
                                  { AOM_CDF4(26091, 32336, 32701) },
                                  { AOM_CDF4(19412, 30456, 32289) },
                                  { AOM_CDF4(10242, 22753, 28867) },
                                  { AOM_CDF4(6539, 16024, 23367) },
                                  { AOM_CDF4(4275, 11063, 17227) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(25883, 32174, 32650) },
                                  { AOM_CDF4(20729, 30487, 32248) },
                                  { AOM_CDF4(10319, 20869, 27192) },
                                  { AOM_CDF4(8721, 15772, 21885) },
                                  { AOM_CDF4(5772, 11200, 15508) },
                                  { AOM_CDF4(24672, 31859, 32521) },
                                  { AOM_CDF4(16962, 29361, 31795) },
                                  { AOM_CDF4(8312, 19486, 26064) },
                                  { AOM_CDF4(3236, 9901, 17070) },
                                  { AOM_CDF4(1587, 4916, 8967) },
                                  { AOM_CDF4(28096, 32472, 32703) },
                                  { AOM_CDF4(19818, 29743, 31854) },
                                  { AOM_CDF4(9236, 20175, 26572) },
                                  { AOM_CDF4(4151, 11816, 18665) },
                                  { AOM_CDF4(2420, 7396, 12433) },
                                  { AOM_CDF4(28940, 32428, 32676) },
                                  { AOM_CDF4(21213, 30129, 31970) },
                                  { AOM_CDF4(9004, 19691, 25978) },
                                  { AOM_CDF4(3570, 9600, 16333) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(11722, 24489, 29246) },
                                  { AOM_CDF4(26274, 32399, 32728) },
                                  { AOM_CDF4(21483, 31290, 32487) },
                                  { AOM_CDF4(12408, 25059, 29815) },
                                  { AOM_CDF4(6071, 15626, 22767) },
                                  { AOM_CDF4(3387, 9491, 15569) },
                                  { AOM_CDF4(28415, 32617, 32748) },
                                  { AOM_CDF4(23640, 31930, 32628) },
                                  { AOM_CDF4(13995, 26739, 30670) },
                                  { AOM_CDF4(6625, 17608, 25009) },
                                  { AOM_CDF4(4136, 12172, 19296) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(27929, 32612, 32748) },
                                  { AOM_CDF4(24993, 32282, 32699) },
                                  { AOM_CDF4(14462, 27448, 31102) },
                                  { AOM_CDF4(6554, 17476, 24758) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } } },
                              { { { AOM_CDF4(5989, 15057, 20804) },
                                  { AOM_CDF4(24449, 31852, 32547) },
                                  { AOM_CDF4(16310, 28879, 31662) },
                                  { AOM_CDF4(9281, 21613, 27712) },
                                  { AOM_CDF4(5769, 15186, 22059) },
                                  { AOM_CDF4(3248, 9059, 14355) },
                                  { AOM_CDF4(26106, 32393, 32718) },
                                  { AOM_CDF4(18852, 30444, 32294) },
                                  { AOM_CDF4(11267, 24420, 29758) },
                                  { AOM_CDF4(6845, 17592, 24755) },
                                  { AOM_CDF4(3963, 11071, 17218) },
                                  { AOM_CDF4(26744, 32381, 32693) },
                                  { AOM_CDF4(18151, 29704, 31991) },
                                  { AOM_CDF4(9841, 22137, 28135) },
                                  { AOM_CDF4(5892, 15315, 22271) },
                                  { AOM_CDF4(3367, 9270, 14636) },
                                  { AOM_CDF4(25027, 32199, 32666) },
                                  { AOM_CDF4(17612, 29494, 31907) },
                                  { AOM_CDF4(9873, 22028, 27916) },
                                  { AOM_CDF4(5756, 15026, 21832) },
                                  { AOM_CDF4(3252, 8995, 14224) },
                                  { AOM_CDF4(28451, 32641, 32748) },
                                  { AOM_CDF4(22884, 31730, 32586) },
                                  { AOM_CDF4(13787, 26593, 30889) },
                                  { AOM_CDF4(8112, 19511, 26632) },
                                  { AOM_CDF4(4842, 13028, 19928) },
                                  { AOM_CDF4(26759, 32208, 32645) },
                                  { AOM_CDF4(17420, 29603, 31935) },
                                  { AOM_CDF4(10157, 22373, 27965) },
                                  { AOM_CDF4(4931, 13443, 20286) },
                                  { AOM_CDF4(2178, 6285, 10588) },
                                  { AOM_CDF4(29159, 32616, 32745) },
                                  { AOM_CDF4(21439, 31165, 32392) },
                                  { AOM_CDF4(13217, 25919, 30078) },
                                  { AOM_CDF4(7231, 18157, 24651) },
                                  { AOM_CDF4(3454, 9914, 15426) },
                                  { AOM_CDF4(29440, 32640, 32745) },
                                  { AOM_CDF4(22463, 31375, 32439) },
                                  { AOM_CDF4(13195, 25508, 29856) },
                                  { AOM_CDF4(6903, 17415, 24204) },
                                  { AOM_CDF4(3805, 10697, 16615) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(11256, 23568, 28492) },
                                  { AOM_CDF4(26540, 32281, 32648) },
                                  { AOM_CDF4(20503, 30740, 32308) },
                                  { AOM_CDF4(11984, 25038, 29910) },
                                  { AOM_CDF4(6955, 17982, 25011) },
                                  { AOM_CDF4(4166, 11334, 17645) },
                                  { AOM_CDF4(28418, 32627, 32748) },
                                  { AOM_CDF4(23782, 32014, 32654) },
                                  { AOM_CDF4(15236, 28106, 31402) },
                                  { AOM_CDF4(8418, 20267, 26838) },
                                  { AOM_CDF4(4434, 12732, 19078) },
                                  { AOM_CDF4(29185, 32645, 32748) },
                                  { AOM_CDF4(22944, 31661, 32554) },
                                  { AOM_CDF4(13870, 26377, 30344) },
                                  { AOM_CDF4(6852, 17012, 23426) },
                                  { AOM_CDF4(3165, 9425, 15500) },
                                  { AOM_CDF4(28085, 32475, 32728) },
                                  { AOM_CDF4(21547, 31194, 32480) },
                                  { AOM_CDF4(13148, 26182, 30619) },
                                  { AOM_CDF4(8099, 19483, 26209) },
                                  { AOM_CDF4(4583, 12131, 18251) },
                                  { AOM_CDF4(30359, 32737, 32748) },
                                  { AOM_CDF4(26533, 32533, 32743) },
                                  { AOM_CDF4(18866, 30522, 32282) },
                                  { AOM_CDF4(10322, 23216, 29098) },
                                  { AOM_CDF4(6090, 15503, 23166) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } } },
                              { { { AOM_CDF4(5411, 13994, 19557) },
                                  { AOM_CDF4(23739, 31753, 32557) },
                                  { AOM_CDF4(15336, 28083, 31280) },
                                  { AOM_CDF4(8362, 20137, 26457) },
                                  { AOM_CDF4(5034, 13742, 20265) },
                                  { AOM_CDF4(2656, 7473, 11867) },
                                  { AOM_CDF4(26962, 32425, 32720) },
                                  { AOM_CDF4(18449, 30079, 32125) },
                                  { AOM_CDF4(10433, 23427, 29019) },
                                  { AOM_CDF4(6328, 16703, 23639) },
                                  { AOM_CDF4(3527, 9909, 15450) },
                                  { AOM_CDF4(29152, 32592, 32734) },
                                  { AOM_CDF4(19211, 30289, 32170) },
                                  { AOM_CDF4(10497, 23197, 28785) },
                                  { AOM_CDF4(6158, 16192, 23019) },
                                  { AOM_CDF4(3286, 9315, 14596) },
                                  { AOM_CDF4(27911, 32535, 32729) },
                                  { AOM_CDF4(19179, 30369, 32193) },
                                  { AOM_CDF4(10784, 23479, 28886) },
                                  { AOM_CDF4(6050, 15844, 22618) },
                                  { AOM_CDF4(3016, 8457, 13375) },
                                  { AOM_CDF4(30348, 32734, 32748) },
                                  { AOM_CDF4(24584, 32172, 32680) },
                                  { AOM_CDF4(15185, 28295, 31615) },
                                  { AOM_CDF4(8961, 21693, 28227) },
                                  { AOM_CDF4(5258, 14368, 21285) },
                                  { AOM_CDF4(27390, 32288, 32675) },
                                  { AOM_CDF4(17264, 29367, 31825) },
                                  { AOM_CDF4(9087, 20742, 26421) },
                                  { AOM_CDF4(4132, 11609, 17843) },
                                  { AOM_CDF4(1691, 5058, 8673) },
                                  { AOM_CDF4(29772, 32637, 32741) },
                                  { AOM_CDF4(22678, 31436, 32431) },
                                  { AOM_CDF4(14046, 26682, 30349) },
                                  { AOM_CDF4(7739, 18778, 25215) },
                                  { AOM_CDF4(3414, 9838, 14924) },
                                  { AOM_CDF4(30591, 32740, 32748) },
                                  { AOM_CDF4(25634, 32264, 32673) },
                                  { AOM_CDF4(15922, 28084, 31188) },
                                  { AOM_CDF4(7608, 18907, 25461) },
                                  { AOM_CDF4(3554, 10425, 16005) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(8804, 19659, 25023) },
                                  { AOM_CDF4(25938, 32004, 32573) },
                                  { AOM_CDF4(18536, 29619, 31752) },
                                  { AOM_CDF4(10433, 23163, 28748) },
                                  { AOM_CDF4(6855, 17613, 24735) },
                                  { AOM_CDF4(4337, 11705, 17493) },
                                  { AOM_CDF4(28626, 32616, 32748) },
                                  { AOM_CDF4(21576, 31392, 32538) },
                                  { AOM_CDF4(12418, 26294, 30827) },
                                  { AOM_CDF4(7851, 20111, 27012) },
                                  { AOM_CDF4(4688, 13149, 19661) },
                                  { AOM_CDF4(30527, 32645, 32736) },
                                  { AOM_CDF4(22242, 31076, 32244) },
                                  { AOM_CDF4(11552, 24255, 29025) },
                                  { AOM_CDF4(6417, 16395, 22959) },
                                  { AOM_CDF4(3547, 9901, 15693) },
                                  { AOM_CDF4(29584, 32635, 32745) },
                                  { AOM_CDF4(22131, 31417, 32465) },
                                  { AOM_CDF4(12895, 26175, 30481) },
                                  { AOM_CDF4(7575, 19221, 25873) },
                                  { AOM_CDF4(4428, 12517, 18764) },
                                  { AOM_CDF4(31193, 32750, 32754) },
                                  { AOM_CDF4(26049, 32367, 32719) },
                                  { AOM_CDF4(15747, 28950, 31898) },
                                  { AOM_CDF4(9821, 23107, 29166) },
                                  { AOM_CDF4(6084, 16175, 23489) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } } },
                              { { { AOM_CDF4(5020, 13224, 18617) },
                                  { AOM_CDF4(22100, 31210, 32415) },
                                  { AOM_CDF4(14054, 27224, 30806) },
                                  { AOM_CDF4(7781, 19396, 25910) },
                                  { AOM_CDF4(4899, 13653, 20041) },
                                  { AOM_CDF4(2134, 6135, 9670) },
                                  { AOM_CDF4(27325, 32428, 32724) },
                                  { AOM_CDF4(17720, 29735, 32015) },
                                  { AOM_CDF4(9694, 22629, 28429) },
                                  { AOM_CDF4(5858, 15729, 22597) },
                                  { AOM_CDF4(2764, 8001, 12541) },
                                  { AOM_CDF4(30162, 32626, 32737) },
                                  { AOM_CDF4(18749, 30134, 32048) },
                                  { AOM_CDF4(10000, 22776, 28351) },
                                  { AOM_CDF4(5860, 15568, 22253) },
                                  { AOM_CDF4(2903, 8330, 12900) },
                                  { AOM_CDF4(29082, 32613, 32745) },
                                  { AOM_CDF4(19182, 30591, 32308) },
                                  { AOM_CDF4(10903, 24333, 29687) },
                                  { AOM_CDF4(6577, 17489, 24552) },
                                  { AOM_CDF4(3249, 9295, 14482) },
                                  { AOM_CDF4(31478, 32751, 32755) },
                                  { AOM_CDF4(24851, 32090, 32658) },
                                  { AOM_CDF4(13929, 27551, 31258) },
                                  { AOM_CDF4(8348, 21028, 27530) },
                                  { AOM_CDF4(4532, 12752, 18934) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(7996, 18774, 23952) },
                                  { AOM_CDF4(25365, 31551, 32371) },
                                  { AOM_CDF4(15143, 26152, 29634) },
                                  { AOM_CDF4(7232, 17332, 22198) },
                                  { AOM_CDF4(4877, 12525, 17518) },
                                  { AOM_CDF4(2840, 8232, 12654) },
                                  { AOM_CDF4(28411, 32421, 32703) },
                                  { AOM_CDF4(18737, 29678, 31859) },
                                  { AOM_CDF4(10030, 22880, 28417) },
                                  { AOM_CDF4(6775, 17657, 24307) },
                                  { AOM_CDF4(4390, 12476, 18511) },
                                  { AOM_CDF4(30936, 32685, 32748) },
                                  { AOM_CDF4(21476, 31188, 32434) },
                                  { AOM_CDF4(11672, 25366, 30283) },
                                  { AOM_CDF4(7506, 17924, 25038) },
                                  { AOM_CDF4(4606, 12249, 18111) },
                                  { AOM_CDF4(30415, 32682, 32748) },
                                  { AOM_CDF4(22421, 31506, 32507) },
                                  { AOM_CDF4(12143, 25304, 30385) },
                                  { AOM_CDF4(7780, 17802, 24263) },
                                  { AOM_CDF4(4180, 12945, 19418) },
                                  { AOM_CDF4(31822, 32752, 32756) },
                                  { AOM_CDF4(26215, 32374, 32719) },
                                  { AOM_CDF4(15421, 29176, 31994) },
                                  { AOM_CDF4(10067, 23997, 29674) },
                                  { AOM_CDF4(6341, 17289, 24250) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) } } },
#if CONFIG_TX64X64
                              { { { AOM_CDF4(4137, 10814, 15794) },
                                  { AOM_CDF4(20491, 29990, 31765) },
                                  { AOM_CDF4(12143, 24274, 28510) },
                                  { AOM_CDF4(6570, 16580, 22649) },
                                  { AOM_CDF4(4201, 11331, 16468) },
                                  { AOM_CDF4(1293, 4010, 6262) },
                                  { AOM_CDF4(27634, 32353, 32711) },
                                  { AOM_CDF4(16922, 28831, 31559) },
                                  { AOM_CDF4(8922, 20821, 26675) },
                                  { AOM_CDF4(5261, 14154, 20192) },
                                  { AOM_CDF4(2010, 5922, 9173) },
                                  { AOM_CDF4(30472, 32617, 32745) },
                                  { AOM_CDF4(19679, 30265, 32112) },
                                  { AOM_CDF4(11309, 24154, 29139) },
                                  { AOM_CDF4(6821, 17756, 23995) },
                                  { AOM_CDF4(3149, 9345, 14304) },
                                  { AOM_CDF4(29679, 32494, 32715) },
                                  { AOM_CDF4(18353, 29651, 31957) },
                                  { AOM_CDF4(10651, 23701, 29293) },
                                  { AOM_CDF4(7133, 18105, 25047) },
                                  { AOM_CDF4(4060, 11166, 17123) },
                                  { AOM_CDF4(31694, 32752, 32756) },
                                  { AOM_CDF4(25504, 32173, 32668) },
                                  { AOM_CDF4(14398, 27589, 31189) },
                                  { AOM_CDF4(8218, 20573, 27049) },
                                  { AOM_CDF4(3840, 10665, 16066) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
...
static const aom_cdf_prob
    default_coeff_base_eob_multi[TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS_EOB]
                                [CDF_SIZE(NUM_BASE_LEVELS + 1)] = {
                                  { { { AOM_CDF3(26462, 31416) },
                                      { AOM_CDF3(31559, 32674) },
                                      { AOM_CDF3(31829, 32676) },
                                      { AOM_CDF3(31780, 32620) } },
                                    { { AOM_CDF3(28768, 32072) },
                                      { AOM_CDF3(31945, 32729) },
                                      { AOM_CDF3(32420, 32754) },
                                      { AOM_CDF3(32523, 32756) } } },
                                  { { { AOM_CDF3(25771, 31194) },
                                      { AOM_CDF3(32124, 32715) },
                                      { AOM_CDF3(32405, 32743) },
                                      { AOM_CDF3(32297, 32718) } },
                                    { { AOM_CDF3(29274, 32109) },
                                      { AOM_CDF3(31990, 32703) },
                                      { AOM_CDF3(32414, 32754) },
                                      { AOM_CDF3(32630, 32756) } } },
                                  { { { AOM_CDF3(24759, 30900) },
                                      { AOM_CDF3(32215, 32717) },
                                      { AOM_CDF3(32647, 32756) },
                                      { AOM_CDF3(32646, 32756) } },
                                    { { AOM_CDF3(27949, 31439) },
                                      { AOM_CDF3(32350, 32727) },
                                      { AOM_CDF3(32700, 32756) },
                                      { AOM_CDF3(32729, 32756) } } },
                                  { { { AOM_CDF3(26611, 31707) },
                                      { AOM_CDF3(32404, 32735) },
                                      { AOM_CDF3(32655, 32756) },
                                      { AOM_CDF3(32719, 32756) } },
                                    { { AOM_CDF3(29619, 32124) },
                                      { AOM_CDF3(32011, 32602) },
                                      { AOM_CDF3(32752, 32756) },
                                      { AOM_CDF3(32712, 32756) } } },
#if CONFIG_TX64X64
                                  { { { AOM_CDF3(26010, 31549) },
                                      { AOM_CDF3(30953, 32067) },
                                      { AOM_CDF3(32105, 32752) },
                                      { AOM_CDF3(32320, 32740) } },
...
static const aom_cdf_prob
    default_coeff_lps_multi[TX_SIZES][PLANE_TYPES][LEVEL_CONTEXTS][CDF_SIZE(
        BR_CDF_SIZE)] = {
      { { { AOM_CDF4(21464, 28094, 30564) }, { AOM_CDF4(16027, 23891, 27903) },
          { AOM_CDF4(10700, 17973, 22916) }, { AOM_CDF4(7349, 13420, 18259) },
          { AOM_CDF4(5513, 10455, 14735) },  { AOM_CDF4(4328, 8453, 12181) },
          { AOM_CDF4(2752, 5465, 8126) },    { AOM_CDF4(23360, 29116, 31073) },
          { AOM_CDF4(21496, 28353, 30834) }, { AOM_CDF4(16580, 24817, 28732) },
          { AOM_CDF4(12229, 20144, 25111) }, { AOM_CDF4(9261, 16398, 21581) },
          { AOM_CDF4(7631, 13832, 18955) },  { AOM_CDF4(5482, 10295, 14601) },
          { AOM_CDF4(24629, 30344, 31841) }, { AOM_CDF4(22499, 28990, 31207) },
          { AOM_CDF4(18012, 26067, 29546) }, { AOM_CDF4(13895, 21993, 26705) },
          { AOM_CDF4(10498, 18403, 23590) }, { AOM_CDF4(9632, 16152, 21197) },
          { AOM_CDF4(6619, 12651, 17322) } },
        { { AOM_CDF4(23740, 29550, 31318) }, { AOM_CDF4(18485, 25999, 29270) },
          { AOM_CDF4(11949, 19297, 23958) }, { AOM_CDF4(7240, 13240, 17715) },
          { AOM_CDF4(5364, 10117, 14461) },  { AOM_CDF4(4419, 8438, 12048) },
          { AOM_CDF4(2674, 5424, 8119) },    { AOM_CDF4(27407, 31196, 32208) },
          { AOM_CDF4(23456, 29533, 31476) }, { AOM_CDF4(17190, 25191, 28905) },
          { AOM_CDF4(12632, 20540, 25398) }, { AOM_CDF4(9608, 16968, 22079) },
          { AOM_CDF4(7986, 13967, 19553) },  { AOM_CDF4(6680, 12824, 18042) },
          { AOM_CDF4(26801, 31250, 32325) }, { AOM_CDF4(24925, 30614, 32069) },
          { AOM_CDF4(19105, 27591, 30477) }, { AOM_CDF4(14659, 24058, 28331) },
          { AOM_CDF4(10958, 18405, 23193) }, { AOM_CDF4(9230, 19845, 24461) },
          { AOM_CDF4(10012, 15474, 22756) } } },
      { { { AOM_CDF4(19526, 26571, 29510) }, { AOM_CDF4(14241, 21894, 26121) },
          { AOM_CDF4(9056, 15745, 20548) },  { AOM_CDF4(6301, 11604, 15969) },
          { AOM_CDF4(4757, 9042, 12935) },   { AOM_CDF4(3915, 7482, 10811) },
          { AOM_CDF4(2409, 4663, 6892) },    { AOM_CDF4(19351, 25874, 28631) },
          { AOM_CDF4(18716, 26097, 29307) }, { AOM_CDF4(14661, 22614, 26938) },
          { AOM_CDF4(10985, 18444, 23364) }, { AOM_CDF4(8631, 15252, 20163) },
          { AOM_CDF4(7156, 13037, 17724) },  { AOM_CDF4(4807, 9005, 12695) },
          { AOM_CDF4(24494, 29918, 31603) }, { AOM_CDF4(22066, 28665, 30978) },
          { AOM_CDF4(17857, 25687, 29249) }, { AOM_CDF4(13828, 21929, 26489) },
          { AOM_CDF4(11052, 18636, 23660) }, { AOM_CDF4(9261, 16215, 21238) },
          { AOM_CDF4(6540, 11986, 16508) } },
        { { AOM_CDF4(21876, 28594, 30856) }, { AOM_CDF4(17648, 25386, 28940) },
          { AOM_CDF4(12157, 19833, 24546) }, { AOM_CDF4(8484, 14770, 19626) },
          { AOM_CDF4(5954, 11035, 15345) },  { AOM_CDF4(4584, 8897, 12477) },
          { AOM_CDF4(2611, 5321, 7810) },    { AOM_CDF4(24993, 30174, 31700) },
          { AOM_CDF4(23207, 29348, 31349) }, { AOM_CDF4(18163, 25940, 29337) },
          { AOM_CDF4(13146, 20737, 25495) }, { AOM_CDF4(9825, 16595, 21487) },
          { AOM_CDF4(8056, 14351, 18823) },  { AOM_CDF4(4994, 9834, 13496) },
          { AOM_CDF4(27367, 31727, 32432) }, { AOM_CDF4(25154, 30585, 32031) },
          { AOM_CDF4(19816, 27316, 30315) }, { AOM_CDF4(14158, 22307, 26962) },
          { AOM_CDF4(10852, 18260, 24090) }, { AOM_CDF4(9380, 16176, 20803) },
          { AOM_CDF4(6909, 13091, 18626) } } },
      { { { AOM_CDF4(19556, 26325, 29229) }, { AOM_CDF4(13678, 21295, 25587) },
          { AOM_CDF4(8613, 14974, 19625) },  { AOM_CDF4(5787, 10712, 14800) },
          { AOM_CDF4(4397, 8335, 11840) },   { AOM_CDF4(3480, 6728, 9740) },
          { AOM_CDF4(1888, 3696, 5448) },    { AOM_CDF4(15420, 21324, 24416) },
          { AOM_CDF4(15456, 22227, 25568) }, { AOM_CDF4(12309, 19557, 23863) },
          { AOM_CDF4(9299, 15929, 20713) },  { AOM_CDF4(7327, 13195, 17756) },
          { AOM_CDF4(6027, 11147, 15383) },  { AOM_CDF4(3731, 7110, 10196) },
          { AOM_CDF4(24670, 30086, 31704) }, { AOM_CDF4(21939, 28532, 30892) },
          { AOM_CDF4(17729, 25448, 29015) }, { AOM_CDF4(13632, 21565, 26054) },
          { AOM_CDF4(10770, 18124, 23018) }, { AOM_CDF4(8801, 15418, 20233) },
          { AOM_CDF4(5814, 10664, 14721) } },
        { { AOM_CDF4(18115, 25309, 28616) }, { AOM_CDF4(13347, 20912, 25239) },
          { AOM_CDF4(8816, 15404, 20161) },  { AOM_CDF4(6403, 11694, 16108) },
          { AOM_CDF4(5000, 9093, 13241) },   { AOM_CDF4(4398, 8380, 11367) },
          { AOM_CDF4(2195, 4486, 6628) },    { AOM_CDF4(15171, 21755, 25718) },
          { AOM_CDF4(15655, 21918, 25118) }, { AOM_CDF4(12599, 19528, 23373) },
          { AOM_CDF4(11160, 17855, 22003) }, { AOM_CDF4(8841, 15822, 20089) },
          { AOM_CDF4(8370, 14825, 19440) },  { AOM_CDF4(5557, 9812, 13703) },
          { AOM_CDF4(26173, 30465, 31747) }, { AOM_CDF4(23899, 29812, 31699) },
          { AOM_CDF4(20174, 27804, 30664) }, { AOM_CDF4(16049, 24223, 28216) },
          { AOM_CDF4(12707, 20791, 25701) }, { AOM_CDF4(10537, 18193, 23177) },
          { AOM_CDF4(7890, 13476, 18246) } } },
      { { { AOM_CDF4(16066, 22436, 25481) }, { AOM_CDF4(14413, 22281, 26409) },
          { AOM_CDF4(9501, 16528, 21475) },  { AOM_CDF4(6554, 12173, 16858) },
          { AOM_CDF4(4924, 9417, 13393) },   { AOM_CDF4(3976, 7735, 11241) },
          { AOM_CDF4(1685, 3277, 4878) },    { AOM_CDF4(14237, 21628, 25537) },
          { AOM_CDF4(13077, 19385, 23067) }, { AOM_CDF4(10535, 16878, 20941) },
          { AOM_CDF4(8057, 13925, 18065) },  { AOM_CDF4(6333, 11331, 15355) },
          { AOM_CDF4(5264, 9680, 13301) },   { AOM_CDF4(2665, 5056, 7237) },
          { AOM_CDF4(22219, 28289, 30508) }, { AOM_CDF4(20043, 26766, 29579) },
          { AOM_CDF4(16303, 23802, 27585) }, { AOM_CDF4(12523, 20056, 24593) },
          { AOM_CDF4(9958, 16865, 21607) },  { AOM_CDF4(8207, 14407, 19069) },
          { AOM_CDF4(4549, 8476, 11854) } },
        { { AOM_CDF4(15578, 20530, 23372) }, { AOM_CDF4(17386, 24661, 28087) },
          { AOM_CDF4(10949, 18519, 23678) }, { AOM_CDF4(8210, 14369, 19092) },
          { AOM_CDF4(5531, 11157, 15129) },  { AOM_CDF4(4483, 8419, 12301) },
          { AOM_CDF4(2043, 4078, 6007) },    { AOM_CDF4(16148, 22578, 26006) },
          { AOM_CDF4(12349, 18737, 22911) }, { AOM_CDF4(8857, 14674, 18945) },
          { AOM_CDF4(7250, 12286, 16296) },  { AOM_CDF4(5683, 10252, 14297) },
          { AOM_CDF4(5156, 9340, 13242) },   { AOM_CDF4(3562, 6784, 9886) },
          { AOM_CDF4(22227, 28191, 30167) }, { AOM_CDF4(21781, 27924, 30208) },
          { AOM_CDF4(19057, 26455, 29474) }, { AOM_CDF4(15839, 23965, 27988) },
          { AOM_CDF4(13368, 21175, 25792) }, { AOM_CDF4(11463, 19072, 24033) },
          { AOM_CDF4(7619, 14004, 18938) } } },
#if CONFIG_TX64X64
