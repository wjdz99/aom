...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(851),   AOM_ICDF(4527),  AOM_ICDF(7888),  AOM_ICDF(10950),
  AOM_ICDF(15122), AOM_ICDF(17268), AOM_ICDF(19143), AOM_ICDF(21116),
  AOM_ICDF(22984), AOM_ICDF(24776), AOM_ICDF(27327), AOM_ICDF(28903),
  AOM_ICDF(30322), AOM_ICDF(31574), AOM_ICDF(32768), 0,
};
#endif
