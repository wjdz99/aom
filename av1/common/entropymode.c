...
static const aom_cdf_prob default_inter_2way_txfm_partition_cdf[CDF_SIZE(2)] = { AOM_CDF2(
    30531) };
static const aom_cdf_prob default_inter_2way_rect_txfm_partition_cdf[CDF_SIZE(2)] = { AOM_CDF2(
    30531) };
