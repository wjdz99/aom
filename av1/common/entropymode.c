...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(12153), AOM_ICDF(13064), AOM_ICDF(14372), AOM_ICDF(15503),
        AOM_ICDF(16129), AOM_ICDF(16824), AOM_ICDF(17554), AOM_ICDF(18755),
        AOM_ICDF(19446), AOM_ICDF(21477), AOM_ICDF(24022), AOM_ICDF(26206),
        AOM_ICDF(29996), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6091), AOM_ICDF(10150), AOM_ICDF(11062), AOM_ICDF(12345),
        AOM_ICDF(13197), AOM_ICDF(14894), AOM_ICDF(15596), AOM_ICDF(16479),
        AOM_ICDF(18022), AOM_ICDF(20069), AOM_ICDF(22056), AOM_ICDF(24802),
        AOM_ICDF(29879), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6882), AOM_ICDF(7479), AOM_ICDF(11694), AOM_ICDF(12487),
        AOM_ICDF(13147), AOM_ICDF(13686), AOM_ICDF(14978), AOM_ICDF(17017),
        AOM_ICDF(17560), AOM_ICDF(19590), AOM_ICDF(22540), AOM_ICDF(24373),
        AOM_ICDF(29828), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5128), AOM_ICDF(6916), AOM_ICDF(8591), AOM_ICDF(12248),
        AOM_ICDF(13723), AOM_ICDF(15239), AOM_ICDF(16661), AOM_ICDF(18659),
        AOM_ICDF(20696), AOM_ICDF(22874), AOM_ICDF(25028), AOM_ICDF(27250),
        AOM_ICDF(29658), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5005), AOM_ICDF(6639), AOM_ICDF(8511), AOM_ICDF(10100),
        AOM_ICDF(14450), AOM_ICDF(16541), AOM_ICDF(18921), AOM_ICDF(20589),
        AOM_ICDF(21930), AOM_ICDF(24143), AOM_ICDF(26212), AOM_ICDF(28276),
        AOM_ICDF(30014), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4540), AOM_ICDF(6593), AOM_ICDF(8190), AOM_ICDF(9855),
        AOM_ICDF(12166), AOM_ICDF(16390), AOM_ICDF(17972), AOM_ICDF(19526),
        AOM_ICDF(21053), AOM_ICDF(23296), AOM_ICDF(25482), AOM_ICDF(27821),
        AOM_ICDF(30061), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5253), AOM_ICDF(6605), AOM_ICDF(8907), AOM_ICDF(10324),
        AOM_ICDF(12328), AOM_ICDF(13695), AOM_ICDF(17986), AOM_ICDF(19619),
        AOM_ICDF(20839), AOM_ICDF(23108), AOM_ICDF(25525), AOM_ICDF(27703),
        AOM_ICDF(30048), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6178), AOM_ICDF(7339), AOM_ICDF(9278), AOM_ICDF(10995),
        AOM_ICDF(12112), AOM_ICDF(13140), AOM_ICDF(14400), AOM_ICDF(18489),
        AOM_ICDF(19637), AOM_ICDF(21809), AOM_ICDF(24314), AOM_ICDF(26379),
        AOM_ICDF(29366), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5334), AOM_ICDF(7261), AOM_ICDF(8660), AOM_ICDF(11025),
        AOM_ICDF(12304), AOM_ICDF(13719), AOM_ICDF(14931), AOM_ICDF(16439),
        AOM_ICDF(20095), AOM_ICDF(22260), AOM_ICDF(24410), AOM_ICDF(26764),
        AOM_ICDF(29461), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8438), AOM_ICDF(9467), AOM_ICDF(10872), AOM_ICDF(12088),
        AOM_ICDF(13007), AOM_ICDF(13886), AOM_ICDF(14888), AOM_ICDF(16246),
        AOM_ICDF(17141), AOM_ICDF(20021), AOM_ICDF(22967), AOM_ICDF(25636),
        AOM_ICDF(29178), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6452), AOM_ICDF(7994), AOM_ICDF(9657), AOM_ICDF(11193),
        AOM_ICDF(12498), AOM_ICDF(13810), AOM_ICDF(15164), AOM_ICDF(16797),
        AOM_ICDF(18132), AOM_ICDF(20706), AOM_ICDF(23959), AOM_ICDF(26156),
        AOM_ICDF(29432), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6900), AOM_ICDF(8252), AOM_ICDF(9963), AOM_ICDF(11462),
        AOM_ICDF(12721), AOM_ICDF(13958), AOM_ICDF(15282), AOM_ICDF(16926),
        AOM_ICDF(18168), AOM_ICDF(20700), AOM_ICDF(23047), AOM_ICDF(26120),
        AOM_ICDF(29369), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5735), AOM_ICDF(7663), AOM_ICDF(9811), AOM_ICDF(11190),
        AOM_ICDF(12310), AOM_ICDF(13524), AOM_ICDF(14727), AOM_ICDF(16307),
        AOM_ICDF(17585), AOM_ICDF(19663), AOM_ICDF(22064), AOM_ICDF(24287),
        AOM_ICDF(30259), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(376),   AOM_ICDF(3673),  AOM_ICDF(7000),  AOM_ICDF(12599),
  AOM_ICDF(17407), AOM_ICDF(18986), AOM_ICDF(22340), AOM_ICDF(23737),
  AOM_ICDF(24899), AOM_ICDF(26137), AOM_ICDF(28925), AOM_ICDF(30337),
  AOM_ICDF(31371), AOM_ICDF(32132), AOM_ICDF(32768),
};
#endif
