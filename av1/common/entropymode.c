...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(21786), AOM_ICDF(22066), AOM_ICDF(22677), AOM_ICDF(22995),
        AOM_ICDF(23229), AOM_ICDF(23434), AOM_ICDF(23717), AOM_ICDF(24217),
        AOM_ICDF(24460), AOM_ICDF(25875), AOM_ICDF(26726), AOM_ICDF(27316),
        AOM_ICDF(29105), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6235), AOM_ICDF(18132), AOM_ICDF(18278), AOM_ICDF(18500),
        AOM_ICDF(18733), AOM_ICDF(19572), AOM_ICDF(19699), AOM_ICDF(19858),
        AOM_ICDF(20691), AOM_ICDF(22429), AOM_ICDF(23068), AOM_ICDF(24411),
        AOM_ICDF(28374), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7824), AOM_ICDF(7883), AOM_ICDF(19198), AOM_ICDF(19336),
        AOM_ICDF(19501), AOM_ICDF(19584), AOM_ICDF(20333), AOM_ICDF(21265),
        AOM_ICDF(21354), AOM_ICDF(22837), AOM_ICDF(24061), AOM_ICDF(24566),
        AOM_ICDF(28539), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8470), AOM_ICDF(8988), AOM_ICDF(9351), AOM_ICDF(16222),
        AOM_ICDF(16699), AOM_ICDF(17147), AOM_ICDF(17517), AOM_ICDF(19432),
        AOM_ICDF(21040), AOM_ICDF(23393), AOM_ICDF(24461), AOM_ICDF(25569),
        AOM_ICDF(26802), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4143), AOM_ICDF(4744), AOM_ICDF(5605), AOM_ICDF(6012),
        AOM_ICDF(19540), AOM_ICDF(21086), AOM_ICDF(22891), AOM_ICDF(23404),
        AOM_ICDF(23757), AOM_ICDF(25554), AOM_ICDF(26193), AOM_ICDF(26805),
        AOM_ICDF(27199), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4232), AOM_ICDF(5889), AOM_ICDF(6292), AOM_ICDF(6687),
        AOM_ICDF(8787), AOM_ICDF(21535), AOM_ICDF(22057), AOM_ICDF(22446),
        AOM_ICDF(22942), AOM_ICDF(24946), AOM_ICDF(25920), AOM_ICDF(26857),
        AOM_ICDF(27664), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5490), AOM_ICDF(5731), AOM_ICDF(7537), AOM_ICDF(7811),
        AOM_ICDF(9480), AOM_ICDF(9861), AOM_ICDF(22347), AOM_ICDF(22829),
        AOM_ICDF(23055), AOM_ICDF(25240), AOM_ICDF(26104), AOM_ICDF(26855),
        AOM_ICDF(27645), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8535), AOM_ICDF(8659), AOM_ICDF(9696), AOM_ICDF(10536),
        AOM_ICDF(10813), AOM_ICDF(10973), AOM_ICDF(11346), AOM_ICDF(20842),
        AOM_ICDF(21124), AOM_ICDF(23554), AOM_ICDF(24741), AOM_ICDF(25446),
        AOM_ICDF(26885), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6776), AOM_ICDF(7872), AOM_ICDF(8077), AOM_ICDF(9347),
        AOM_ICDF(9708), AOM_ICDF(10139), AOM_ICDF(10404), AOM_ICDF(11065),
        AOM_ICDF(20551), AOM_ICDF(23094), AOM_ICDF(24086), AOM_ICDF(25255),
        AOM_ICDF(26644), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14947), AOM_ICDF(15331), AOM_ICDF(16176), AOM_ICDF(16551),
        AOM_ICDF(16958), AOM_ICDF(17301), AOM_ICDF(17796), AOM_ICDF(18510),
        AOM_ICDF(18889), AOM_ICDF(22984), AOM_ICDF(24344), AOM_ICDF(25456),
        AOM_ICDF(27511), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12144), AOM_ICDF(12958), AOM_ICDF(13854), AOM_ICDF(14332),
        AOM_ICDF(14851), AOM_ICDF(15363), AOM_ICDF(15908), AOM_ICDF(16761),
        AOM_ICDF(17390), AOM_ICDF(20816), AOM_ICDF(23634), AOM_ICDF(24478),
        AOM_ICDF(26962), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13089), AOM_ICDF(13558), AOM_ICDF(14748), AOM_ICDF(15242),
        AOM_ICDF(15738), AOM_ICDF(16110), AOM_ICDF(16711), AOM_ICDF(17587),
        AOM_ICDF(18053), AOM_ICDF(21447), AOM_ICDF(22403), AOM_ICDF(24685),
        AOM_ICDF(26847), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3881), AOM_ICDF(5894), AOM_ICDF(8682), AOM_ICDF(9039),
        AOM_ICDF(9322), AOM_ICDF(9614), AOM_ICDF(9938), AOM_ICDF(10534),
        AOM_ICDF(10956), AOM_ICDF(12640), AOM_ICDF(13837), AOM_ICDF(14806),
        AOM_ICDF(29034), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
