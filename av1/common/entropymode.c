...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(680),   AOM_ICDF(4440),  AOM_ICDF(7884),  AOM_ICDF(11430),
  AOM_ICDF(15951), AOM_ICDF(17935), AOM_ICDF(19966), AOM_ICDF(21807),
  AOM_ICDF(23518), AOM_ICDF(25188), AOM_ICDF(27872), AOM_ICDF(29341),
  AOM_ICDF(30651), AOM_ICDF(31765), AOM_ICDF(32768), 0,
};
#endif
