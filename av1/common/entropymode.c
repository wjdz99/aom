...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(471),   AOM_ICDF(4034),  AOM_ICDF(7470),  AOM_ICDF(12233),
  AOM_ICDF(17085), AOM_ICDF(18795), AOM_ICDF(21472), AOM_ICDF(23049),
  AOM_ICDF(24398), AOM_ICDF(25816), AOM_ICDF(28611), AOM_ICDF(29994),
  AOM_ICDF(31132), AOM_ICDF(32032), AOM_ICDF(32768), 0
};
#endif
