...
static const aom_prob
    default_inter_ref0_probs[REF0_CONTEXTS][INTER_REFS_PER_FRAME - 1] = {
...
#endif  // CONFIG_EXT_REFS
#if CONFIG_EXT_COMP_REFS
  av1_copy(fc->inter_ref0_probs, default_inter_ref0_probs);
#else
...
void av1_adapt_inter_frame_probs(AV1_COMMON *cm) {
  ...
  for (i = 0; i < REF0_CONTEXTS; i++) {
    aom_tree_merge_probs(av1_single_or_comp_ref0_tree,
                         pre_fc->inter_ref0_probs[i], counts->inter_ref0[i],
                         fc->inter_ref0_probs[i]);
  }
#else
  for (i = 0; i < REF_CONTEXTS; i++)
