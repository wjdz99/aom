...
#endif  // CONFIG_MODEDEP_TX && USE_NSTX_INTRA
    };
...
#endif  // CONFIG_MODEDEP_TX && USE_NSTX_INTER
    };

#if CONFIG_MODEDEP_TX
#if USE_NSTX_INTER
static const aom_cdf_prob
    default_nstx_type_inter_cdf[EXT_TX_SIZES][CDF_SIZE(NSTX_TYPES_INTER)] = {
...
static const aom_cdf_prob default_use_nstx_inter_cdf[EXT_TX_SIZES]
                                                    [CDF_SIZE(2)] = {
                                                      { AOM_CDF2(16384) },
                                                      { AOM_CDF2(16384) },
                                                      { AOM_CDF2(16384) },
...
#endif  // USE_NSTX_INTER
#if USE_NSTX_INTRA
static const aom_cdf_prob
    default_nstx_type_intra_cdf[EXT_TX_SIZES][INTRA_MODES]
                               [CDF_SIZE(NSTX_TYPES_INTRA)] = {
                                 {
...
static const aom_cdf_prob default_use_nstx_intra_cdf[EXT_TX_SIZES]
                                                    [CDF_SIZE(2)] = {
                                                      { AOM_CDF2(16384) },
                                                      { AOM_CDF2(16384) },
                                                      { AOM_CDF2(16384) },
...
#if CONFIG_MODEDEP_TX
#if USE_NSTX_INTER
  av1_copy(fc->nstx_type_inter_cdf, default_nstx_type_inter_cdf);
  av1_copy(fc->use_nstx_inter_cdf, default_use_nstx_inter_cdf);
#endif
#if USE_NSTX_INTRA
  av1_copy(fc->nstx_type_intra_cdf, default_nstx_type_intra_cdf);
  av1_copy(fc->use_nstx_intra_cdf, default_use_nstx_intra_cdf);
#endif
#endif
