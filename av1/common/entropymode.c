...
#if CONFIG_AIMC
static const aom_cdf_prob default_y_mode_set_cdf[Y_MODE_CONTEXTS][CDF_SIZE(
    INTRA_MODE_SETS)] = { { AOM_CDF5(8000, 15000, 21000, 27000) },
                          { AOM_CDF5(8000, 15000, 21000, 27000) },
                          { AOM_CDF5(8000, 15000, 21000, 27000) } };
static const aom_cdf_prob default_y_first_mode_cdf[Y_MODE_CONTEXTS][CDF_SIZE(
    FIRST_MODE_COUNT)] = { { AOM_CDF5(7000, 13000, 19000, 26000) },
                           { AOM_CDF5(7000, 13000, 19000, 26000) },
                           { AOM_CDF5(7000, 13000, 19000, 26000) } };
static const aom_cdf_prob
    default_y_second_mode_cdf[Y_MODE_CONTEXTS][CDF_SIZE(SECOND_MODE_COUNT)] = {
      { AOM_CDF8(6000, 12000, 18000, 22000, 25000, 28000, 30500) },
      { AOM_CDF8(6000, 12000, 18000, 22000, 25000, 28000, 30500) },
      { AOM_CDF8(6000, 12000, 18000, 22000, 25000, 28000, 30500) }
    };
static const aom_cdf_prob
    default_y_third_mode_cdf[Y_MODE_CONTEXTS][CDF_SIZE(THIRD_MODE_COUNT)] = {
...
static const aom_cdf_prob
    default_uv_first_mode_cdf[UV_MODE_CONTEXTS][CDF_SIZE(UV_INTRA_MODES)] = {
...
static void init_mode_probs(FRAME_CONTEXT *fc) {
  ...
  av1_copy(fc->y_first_mode_cdf, default_y_first_mode_cdf);
  av1_copy(fc->y_second_mode_cdf, default_y_second_mode_cdf);
  av1_copy(fc->y_third_mode_cdf, default_y_third_mode_cdf);

  av1_copy(fc->uv_first_mode_cdf, default_uv_first_mode_cdf);
#endif  // CONFIG_AIMC
