...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(231),   AOM_ICDF(2896),  AOM_ICDF(6027),  AOM_ICDF(14601),
  AOM_ICDF(20356), AOM_ICDF(21678), AOM_ICDF(25395), AOM_ICDF(26467),
  AOM_ICDF(27228), AOM_ICDF(28145), AOM_ICDF(30918), AOM_ICDF(31498),
  AOM_ICDF(32078), AOM_ICDF(32524), AOM_ICDF(32768), 0
};
#endif
