...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(227),   AOM_ICDF(3289),  AOM_ICDF(6985),  AOM_ICDF(13859),
  AOM_ICDF(21226), AOM_ICDF(22982), AOM_ICDF(25237), AOM_ICDF(26489),
  AOM_ICDF(27418), AOM_ICDF(28553), AOM_ICDF(31202), AOM_ICDF(31663),
  AOM_ICDF(32095), AOM_ICDF(32509), AOM_ICDF(32768), 0
};
#endif
