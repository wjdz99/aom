...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(651), AOM_ICDF(1080), AOM_ICDF(1716), AOM_ICDF(2155),
        AOM_ICDF(2481), AOM_ICDF(2803), AOM_ICDF(3179), AOM_ICDF(3693),
        AOM_ICDF(4039), AOM_ICDF(4670), AOM_ICDF(5276), AOM_ICDF(5802),
        AOM_ICDF(6654), AOM_ICDF(32768), 0 },
      { AOM_ICDF(564), AOM_ICDF(3635), AOM_ICDF(4151), AOM_ICDF(4803),
        AOM_ICDF(5333), AOM_ICDF(6315), AOM_ICDF(6767), AOM_ICDF(7246),
        AOM_ICDF(8226), AOM_ICDF(9182), AOM_ICDF(9974), AOM_ICDF(10959),
        AOM_ICDF(13059), AOM_ICDF(32768), 0 },
      { AOM_ICDF(510), AOM_ICDF(834), AOM_ICDF(3903), AOM_ICDF(4299),
        AOM_ICDF(4719), AOM_ICDF(5053), AOM_ICDF(5871), AOM_ICDF(6987),
        AOM_ICDF(7323), AOM_ICDF(8188), AOM_ICDF(9145), AOM_ICDF(9817),
        AOM_ICDF(11869), AOM_ICDF(32768), 0 },
      { AOM_ICDF(1083), AOM_ICDF(2299), AOM_ICDF(3420), AOM_ICDF(6185),
        AOM_ICDF(7264), AOM_ICDF(8347), AOM_ICDF(9391), AOM_ICDF(10761),
        AOM_ICDF(12250), AOM_ICDF(13600), AOM_ICDF(14827), AOM_ICDF(16059),
        AOM_ICDF(17364), AOM_ICDF(32768), 0 },
      { AOM_ICDF(842), AOM_ICDF(1826), AOM_ICDF(2893), AOM_ICDF(3802),
        AOM_ICDF(6709), AOM_ICDF(8018), AOM_ICDF(9440), AOM_ICDF(10392),
        AOM_ICDF(11286), AOM_ICDF(12454), AOM_ICDF(13466), AOM_ICDF(14475),
        AOM_ICDF(15441), AOM_ICDF(32768), 0 },
      { AOM_ICDF(1088), AOM_ICDF(2636), AOM_ICDF(3780), AOM_ICDF(4924),
        AOM_ICDF(6562), AOM_ICDF(9699), AOM_ICDF(10870), AOM_ICDF(11980),
        AOM_ICDF(13155), AOM_ICDF(14542), AOM_ICDF(15820), AOM_ICDF(17107),
        AOM_ICDF(18394), AOM_ICDF(32768), 0 },
      { AOM_ICDF(914), AOM_ICDF(1832), AOM_ICDF(3372), AOM_ICDF(4284),
        AOM_ICDF(5670), AOM_ICDF(6627), AOM_ICDF(9611), AOM_ICDF(10649),
        AOM_ICDF(11538), AOM_ICDF(12787), AOM_ICDF(13928), AOM_ICDF(15030),
        AOM_ICDF(16162), AOM_ICDF(32768), 0 },
      { AOM_ICDF(803), AOM_ICDF(1537), AOM_ICDF(2837), AOM_ICDF(3842),
        AOM_ICDF(4623), AOM_ICDF(5331), AOM_ICDF(6187), AOM_ICDF(8935),
        AOM_ICDF(9703), AOM_ICDF(10870), AOM_ICDF(11980), AOM_ICDF(12951),
        AOM_ICDF(14193), AOM_ICDF(32768), 0 },
      { AOM_ICDF(956), AOM_ICDF(2380), AOM_ICDF(3346), AOM_ICDF(4828),
        AOM_ICDF(5799), AOM_ICDF(6824), AOM_ICDF(7746), AOM_ICDF(8761),
        AOM_ICDF(11427), AOM_ICDF(12733), AOM_ICDF(13887), AOM_ICDF(15094),
        AOM_ICDF(16407), AOM_ICDF(32768), 0 },
      { AOM_ICDF(471), AOM_ICDF(1034), AOM_ICDF(1823), AOM_ICDF(2358),
        AOM_ICDF(2879), AOM_ICDF(3371), AOM_ICDF(3938), AOM_ICDF(4613),
        AOM_ICDF(5120), AOM_ICDF(6173), AOM_ICDF(7031), AOM_ICDF(7838),
        AOM_ICDF(8859), AOM_ICDF(32768), 0 },
      { AOM_ICDF(839), AOM_ICDF(1906), AOM_ICDF(3009), AOM_ICDF(3930),
        AOM_ICDF(4836), AOM_ICDF(5745), AOM_ICDF(6664), AOM_ICDF(7693),
        AOM_ICDF(8633), AOM_ICDF(9955), AOM_ICDF(11322), AOM_ICDF(12353),
        AOM_ICDF(13724), AOM_ICDF(32768), 0 },
      { AOM_ICDF(773), AOM_ICDF(1663), AOM_ICDF(2789), AOM_ICDF(3652),
        AOM_ICDF(4502), AOM_ICDF(5313), AOM_ICDF(6209), AOM_ICDF(7213),
        AOM_ICDF(8048), AOM_ICDF(9300), AOM_ICDF(10317), AOM_ICDF(11540),
        AOM_ICDF(12806), AOM_ICDF(32768), 0 },
      { AOM_ICDF(1020), AOM_ICDF(2534), AOM_ICDF(4277), AOM_ICDF(5171),
        AOM_ICDF(6011), AOM_ICDF(6881), AOM_ICDF(7759), AOM_ICDF(8811),
        AOM_ICDF(9736), AOM_ICDF(10942), AOM_ICDF(12136), AOM_ICDF(13262),
        AOM_ICDF(16258), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
