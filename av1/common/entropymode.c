...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(14876), AOM_ICDF(15605), AOM_ICDF(16933), AOM_ICDF(17612),
        AOM_ICDF(18139), AOM_ICDF(18624), AOM_ICDF(19302), AOM_ICDF(20320),
        AOM_ICDF(20862), AOM_ICDF(23178), AOM_ICDF(24843), AOM_ICDF(26149),
        AOM_ICDF(28177), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5165), AOM_ICDF(14436), AOM_ICDF(14887), AOM_ICDF(15452),
        AOM_ICDF(15938), AOM_ICDF(17345), AOM_ICDF(17661), AOM_ICDF(18053),
        AOM_ICDF(19433), AOM_ICDF(21677), AOM_ICDF(22958), AOM_ICDF(24617),
        AOM_ICDF(28005), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6119), AOM_ICDF(6306), AOM_ICDF(15369), AOM_ICDF(15707),
        AOM_ICDF(16100), AOM_ICDF(16304), AOM_ICDF(17636), AOM_ICDF(19352),
        AOM_ICDF(19569), AOM_ICDF(21780), AOM_ICDF(23463), AOM_ICDF(24660),
        AOM_ICDF(28076), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5996), AOM_ICDF(7126), AOM_ICDF(8051), AOM_ICDF(13316),
        AOM_ICDF(14273), AOM_ICDF(15170), AOM_ICDF(15980), AOM_ICDF(17979),
        AOM_ICDF(19994), AOM_ICDF(22525), AOM_ICDF(24079), AOM_ICDF(25660),
        AOM_ICDF(27180), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3973), AOM_ICDF(5049), AOM_ICDF(6392), AOM_ICDF(7188),
        AOM_ICDF(15969), AOM_ICDF(17950), AOM_ICDF(20216), AOM_ICDF(21155),
        AOM_ICDF(21886), AOM_ICDF(24014), AOM_ICDF(25211), AOM_ICDF(26365),
        AOM_ICDF(27167), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3742), AOM_ICDF(5998), AOM_ICDF(6867), AOM_ICDF(7695),
        AOM_ICDF(10198), AOM_ICDF(18762), AOM_ICDF(19709), AOM_ICDF(20510),
        AOM_ICDF(21483), AOM_ICDF(23709), AOM_ICDF(25226), AOM_ICDF(26597),
        AOM_ICDF(27809), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4475), AOM_ICDF(5111), AOM_ICDF(7562), AOM_ICDF(8189),
        AOM_ICDF(10396), AOM_ICDF(11164), AOM_ICDF(19656), AOM_ICDF(20684),
        AOM_ICDF(21247), AOM_ICDF(23635), AOM_ICDF(25014), AOM_ICDF(26360),
        AOM_ICDF(27526), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6747), AOM_ICDF(7152), AOM_ICDF(9109), AOM_ICDF(10229),
        AOM_ICDF(10862), AOM_ICDF(11271), AOM_ICDF(12078), AOM_ICDF(18876),
        AOM_ICDF(19458), AOM_ICDF(22157), AOM_ICDF(23780), AOM_ICDF(25141),
        AOM_ICDF(26843), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5330), AOM_ICDF(7155), AOM_ICDF(7778), AOM_ICDF(9569),
        AOM_ICDF(10329), AOM_ICDF(11220), AOM_ICDF(11803), AOM_ICDF(12803),
        AOM_ICDF(19550), AOM_ICDF(22150), AOM_ICDF(23735), AOM_ICDF(25297),
        AOM_ICDF(26889), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10111), AOM_ICDF(10955), AOM_ICDF(12484), AOM_ICDF(13209),
        AOM_ICDF(14002), AOM_ICDF(14669), AOM_ICDF(15594), AOM_ICDF(16832),
        AOM_ICDF(17508), AOM_ICDF(21230), AOM_ICDF(23253), AOM_ICDF(25086),
        AOM_ICDF(27050), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8171), AOM_ICDF(9535), AOM_ICDF(11019), AOM_ICDF(11888),
        AOM_ICDF(12831), AOM_ICDF(13749), AOM_ICDF(14719), AOM_ICDF(16032),
        AOM_ICDF(17057), AOM_ICDF(20434), AOM_ICDF(23230), AOM_ICDF(24714),
        AOM_ICDF(26914), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8627), AOM_ICDF(9566), AOM_ICDF(11477), AOM_ICDF(12358),
        AOM_ICDF(13260), AOM_ICDF(14002), AOM_ICDF(15079), AOM_ICDF(16498),
        AOM_ICDF(17328), AOM_ICDF(20657), AOM_ICDF(22255), AOM_ICDF(24779),
        AOM_ICDF(26757), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5851), AOM_ICDF(8555), AOM_ICDF(12061), AOM_ICDF(12827),
        AOM_ICDF(13472), AOM_ICDF(14144), AOM_ICDF(14879), AOM_ICDF(16063),
        AOM_ICDF(16919), AOM_ICDF(19239), AOM_ICDF(21002), AOM_ICDF(22554),
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(288),   AOM_ICDF(3313),  AOM_ICDF(6550),  AOM_ICDF(14149),
  AOM_ICDF(19514), AOM_ICDF(20870), AOM_ICDF(24710), AOM_ICDF(25839),
  AOM_ICDF(26697), AOM_ICDF(27667), AOM_ICDF(30339), AOM_ICDF(31244),
  AOM_ICDF(31935), AOM_ICDF(32440), AOM_ICDF(32768), 0,
};
#endif
