...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_CDF8(2011, 2372, 12087, 14323, 26097, 26856, 32524)
};

static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_ALPHA_CONTEXTS][CDF_SIZE(CFL_ALPHABET_SIZE)] = {
      { AOM_CDF16(18248, 28707, 32033, 32638, 32743, 32752, 32756, 32758, 32760,
                  32761, 32762, 32763, 32765, 32766, 32767) },
      { AOM_CDF16(17115, 25477, 29692, 31775, 32526, 32674, 32708, 32740, 32747,
                  32753, 32756, 32759, 32762, 32765, 32766) },
      { AOM_CDF16(13080, 23290, 27778, 31316, 32308, 32529, 32620, 32712, 32731,
                  32740, 32746, 32751, 32755, 32758, 32761) },
      { AOM_CDF16(25070, 30881, 32101, 32485, 32635, 32694, 32720, 32729, 32741,
                  32748, 32751, 32755, 32758, 32764, 32765) },
      { AOM_CDF16(18782, 26231, 29155, 30849, 31537, 31982, 32163, 32414, 32476,
                  32529, 32564, 32623, 32641, 32660, 32682) },
      { AOM_CDF16(17813, 25229, 28312, 29975, 30959, 31473, 31714, 32002, 32100,
                  32208, 32314, 32405, 32449, 32518, 32643) }
    };
#endif
