...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(2341), AOM_ICDF(4681), AOM_ICDF(7022), AOM_ICDF(9362),
        AOM_ICDF(11703), AOM_ICDF(14043), AOM_ICDF(16384), AOM_ICDF(18725),
        AOM_ICDF(21065), AOM_ICDF(23406), AOM_ICDF(25746), AOM_ICDF(28087),
        AOM_ICDF(30427), AOM_ICDF(32768), 0 },
      { AOM_ICDF(2341), AOM_ICDF(4681), AOM_ICDF(7022), AOM_ICDF(9362),
        AOM_ICDF(11703), AOM_ICDF(14043), AOM_ICDF(16384), AOM_ICDF(18725),
        AOM_ICDF(21065), AOM_ICDF(23406), AOM_ICDF(25746), AOM_ICDF(28087),
        AOM_ICDF(30427), AOM_ICDF(32768), 0 },
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(1021),  AOM_ICDF(4614),  AOM_ICDF(7893),  AOM_ICDF(10471),
  AOM_ICDF(14293), AOM_ICDF(16601), AOM_ICDF(18319), AOM_ICDF(20426),
  AOM_ICDF(22449), AOM_ICDF(24363), AOM_ICDF(26782), AOM_ICDF(28465),
  AOM_ICDF(29993), AOM_ICDF(31382), AOM_ICDF(32768), 0
};
#endif
