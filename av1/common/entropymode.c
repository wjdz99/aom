...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24321), AOM_ICDF(24551), AOM_ICDF(25020), AOM_ICDF(25306),
        AOM_ICDF(25471), AOM_ICDF(25627), AOM_ICDF(25837), AOM_ICDF(26225),
        AOM_ICDF(26403), AOM_ICDF(27357), AOM_ICDF(28085), AOM_ICDF(28555),
        AOM_ICDF(30252), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8018), AOM_ICDF(18651), AOM_ICDF(18805), AOM_ICDF(19063),
        AOM_ICDF(19266), AOM_ICDF(19990), AOM_ICDF(20105), AOM_ICDF(20257),
        AOM_ICDF(20999), AOM_ICDF(22450), AOM_ICDF(23070), AOM_ICDF(24357),
        AOM_ICDF(29239), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9700), AOM_ICDF(9761), AOM_ICDF(19610), AOM_ICDF(19755),
        AOM_ICDF(19899), AOM_ICDF(19975), AOM_ICDF(20568), AOM_ICDF(21388),
        AOM_ICDF(21466), AOM_ICDF(22681), AOM_ICDF(23922), AOM_ICDF(24394),
        AOM_ICDF(29411), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9310), AOM_ICDF(9980), AOM_ICDF(10497), AOM_ICDF(16986),
        AOM_ICDF(17563), AOM_ICDF(18119), AOM_ICDF(18602), AOM_ICDF(20386),
        AOM_ICDF(21901), AOM_ICDF(24075), AOM_ICDF(25208), AOM_ICDF(26388),
        AOM_ICDF(27746), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5377), AOM_ICDF(6042), AOM_ICDF(6955), AOM_ICDF(7476),
        AOM_ICDF(20619), AOM_ICDF(22061), AOM_ICDF(23751), AOM_ICDF(24333),
        AOM_ICDF(24743), AOM_ICDF(26462), AOM_ICDF(27195), AOM_ICDF(27890),
        AOM_ICDF(28411), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5315), AOM_ICDF(6912), AOM_ICDF(7454), AOM_ICDF(8002),
        AOM_ICDF(10003), AOM_ICDF(21720), AOM_ICDF(22339), AOM_ICDF(22851),
        AOM_ICDF(23475), AOM_ICDF(25450), AOM_ICDF(26531), AOM_ICDF(27570),
        AOM_ICDF(28576), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6920), AOM_ICDF(7248), AOM_ICDF(8970), AOM_ICDF(9347),
        AOM_ICDF(10865), AOM_ICDF(11305), AOM_ICDF(22920), AOM_ICDF(23504),
        AOM_ICDF(23802), AOM_ICDF(25848), AOM_ICDF(26808), AOM_ICDF(27666),
        AOM_ICDF(28654), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11044), AOM_ICDF(11218), AOM_ICDF(12256), AOM_ICDF(13127),
        AOM_ICDF(13426), AOM_ICDF(13617), AOM_ICDF(14015), AOM_ICDF(21826),
        AOM_ICDF(22117), AOM_ICDF(24210), AOM_ICDF(25391), AOM_ICDF(26155),
        AOM_ICDF(27787), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8207), AOM_ICDF(9318), AOM_ICDF(9613), AOM_ICDF(10974),
        AOM_ICDF(11396), AOM_ICDF(11886), AOM_ICDF(12205), AOM_ICDF(12860),
        AOM_ICDF(21562), AOM_ICDF(23807), AOM_ICDF(24855), AOM_ICDF(26043),
        AOM_ICDF(27603), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17526), AOM_ICDF(17868), AOM_ICDF(18538), AOM_ICDF(18924),
        AOM_ICDF(19255), AOM_ICDF(19540), AOM_ICDF(19924), AOM_ICDF(20533),
        AOM_ICDF(20848), AOM_ICDF(24079), AOM_ICDF(25395), AOM_ICDF(26463),
        AOM_ICDF(28502), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13577), AOM_ICDF(14351), AOM_ICDF(15250), AOM_ICDF(15812),
        AOM_ICDF(16339), AOM_ICDF(16859), AOM_ICDF(17414), AOM_ICDF(18266),
        AOM_ICDF(18871), AOM_ICDF(21767), AOM_ICDF(24523), AOM_ICDF(25437),
        AOM_ICDF(27934), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14741), AOM_ICDF(15236), AOM_ICDF(16364), AOM_ICDF(16937),
        AOM_ICDF(17411), AOM_ICDF(17812), AOM_ICDF(18397), AOM_ICDF(19239),
        AOM_ICDF(19717), AOM_ICDF(22508), AOM_ICDF(23511), AOM_ICDF(25755),
        AOM_ICDF(27917), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5422), AOM_ICDF(7206), AOM_ICDF(9607), AOM_ICDF(10043),
        AOM_ICDF(10358), AOM_ICDF(10699), AOM_ICDF(11058), AOM_ICDF(11699),
        AOM_ICDF(12155), AOM_ICDF(13649), AOM_ICDF(14872), AOM_ICDF(15870),
        AOM_ICDF(29729), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
