...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_ICDF(921),   AOM_ICDF(4184),  AOM_ICDF(9130),
  AOM_ICDF(13383), AOM_ICDF(24716), AOM_ICDF(26399),
  AOM_ICDF(32268), AOM_ICDF(32768), 0
};

static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_JOINT_SIGNS][CFL_PRED_PLANES][CDF_SIZE(
        UV_ALPHABET_SIZE)] = {
      { { 0 },
        { AOM_ICDF(12777), AOM_ICDF(23093), AOM_ICDF(27778), AOM_ICDF(30339),
          AOM_ICDF(31356), AOM_ICDF(31885), AOM_ICDF(32158), AOM_ICDF(32389),
          AOM_ICDF(32478), AOM_ICDF(32631), AOM_ICDF(32711), AOM_ICDF(32737),
          AOM_ICDF(32756), AOM_ICDF(32761), AOM_ICDF(32764), AOM_ICDF(32768),
          0 } },
      { { 0 },
        { AOM_ICDF(23415), AOM_ICDF(28823), AOM_ICDF(30557), AOM_ICDF(31530),
          AOM_ICDF(32011), AOM_ICDF(32165), AOM_ICDF(32234), AOM_ICDF(32439),
          AOM_ICDF(32457), AOM_ICDF(32507), AOM_ICDF(32559), AOM_ICDF(32569),
          AOM_ICDF(32596), AOM_ICDF(32600), AOM_ICDF(32606), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(6620), AOM_ICDF(15274), AOM_ICDF(21032), AOM_ICDF(27153),
          AOM_ICDF(30685), AOM_ICDF(31909), AOM_ICDF(32430), AOM_ICDF(32690),
          AOM_ICDF(32735), AOM_ICDF(32753), AOM_ICDF(32761), AOM_ICDF(32762),
          AOM_ICDF(32764), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768),
          0 },
        { 0 } },
      { { AOM_ICDF(5962), AOM_ICDF(11375), AOM_ICDF(16573), AOM_ICDF(21610),
          AOM_ICDF(25730), AOM_ICDF(28790), AOM_ICDF(30638), AOM_ICDF(32141),
          AOM_ICDF(32494), AOM_ICDF(32645), AOM_ICDF(32692), AOM_ICDF(32717),
          AOM_ICDF(32725), AOM_ICDF(32730), AOM_ICDF(32736), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(15429), AOM_ICDF(23996), AOM_ICDF(27485), AOM_ICDF(29408),
          AOM_ICDF(30470), AOM_ICDF(31055), AOM_ICDF(31453), AOM_ICDF(31979),
          AOM_ICDF(32171), AOM_ICDF(32441), AOM_ICDF(32590), AOM_ICDF(32662),
          AOM_ICDF(32691), AOM_ICDF(32707), AOM_ICDF(32718), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(2566), AOM_ICDF(10443), AOM_ICDF(17391), AOM_ICDF(22931),
          AOM_ICDF(26485), AOM_ICDF(28638), AOM_ICDF(29959), AOM_ICDF(31693),
          AOM_ICDF(32225), AOM_ICDF(32444), AOM_ICDF(32547), AOM_ICDF(32606),
          AOM_ICDF(32637), AOM_ICDF(32657), AOM_ICDF(32678), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(10728), AOM_ICDF(20247), AOM_ICDF(24800), AOM_ICDF(27764),
          AOM_ICDF(29394), AOM_ICDF(30272), AOM_ICDF(30829), AOM_ICDF(31555),
          AOM_ICDF(31781), AOM_ICDF(31995), AOM_ICDF(32143), AOM_ICDF(32265),
          AOM_ICDF(32329), AOM_ICDF(32381), AOM_ICDF(32435), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(12482), AOM_ICDF(23270), AOM_ICDF(27445), AOM_ICDF(30328),
          AOM_ICDF(31705), AOM_ICDF(32173), AOM_ICDF(32389), AOM_ICDF(32636),
          AOM_ICDF(32666), AOM_ICDF(32696), AOM_ICDF(32724), AOM_ICDF(32730),
          AOM_ICDF(32758), AOM_ICDF(32762), AOM_ICDF(32764), AOM_ICDF(32768),
          0 },
        { 0 } },
      { { AOM_ICDF(9354), AOM_ICDF(18692), AOM_ICDF(24049), AOM_ICDF(27361),
          AOM_ICDF(29128), AOM_ICDF(30164), AOM_ICDF(30794), AOM_ICDF(31564),
          AOM_ICDF(31823), AOM_ICDF(32021), AOM_ICDF(32158), AOM_ICDF(32282),
          AOM_ICDF(32346), AOM_ICDF(32395), AOM_ICDF(32462), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(6103), AOM_ICDF(14865), AOM_ICDF(20899), AOM_ICDF(25143),
          AOM_ICDF(27498), AOM_ICDF(28799), AOM_ICDF(29691), AOM_ICDF(30950),
          AOM_ICDF(31487), AOM_ICDF(32109), AOM_ICDF(32396), AOM_ICDF(32529),
          AOM_ICDF(32576), AOM_ICDF(32606), AOM_ICDF(32637), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(6919), AOM_ICDF(15466), AOM_ICDF(20790), AOM_ICDF(24486),
          AOM_ICDF(26781), AOM_ICDF(28209), AOM_ICDF(29186), AOM_ICDF(30224),
          AOM_ICDF(30687), AOM_ICDF(31107), AOM_ICDF(31335), AOM_ICDF(31549),
          AOM_ICDF(31636), AOM_ICDF(31713), AOM_ICDF(31834), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(15058), AOM_ICDF(23296), AOM_ICDF(26669), AOM_ICDF(28578),
          AOM_ICDF(29796), AOM_ICDF(30444), AOM_ICDF(30913), AOM_ICDF(31426),
          AOM_ICDF(31635), AOM_ICDF(31879), AOM_ICDF(32032), AOM_ICDF(32172),
          AOM_ICDF(32251), AOM_ICDF(32305), AOM_ICDF(32372), AOM_ICDF(32768),
          0 } },
    };
#endif
