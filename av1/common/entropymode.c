...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24296), AOM_ICDF(24575), AOM_ICDF(25077), AOM_ICDF(25449),
        AOM_ICDF(25633), AOM_ICDF(25825), AOM_ICDF(26049), AOM_ICDF(26457),
        AOM_ICDF(26658), AOM_ICDF(27569), AOM_ICDF(28413), AOM_ICDF(29024),
        AOM_ICDF(30839), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10069), AOM_ICDF(17592), AOM_ICDF(17906), AOM_ICDF(18371),
        AOM_ICDF(18683), AOM_ICDF(19498), AOM_ICDF(19715), AOM_ICDF(19992),
        AOM_ICDF(20866), AOM_ICDF(22332), AOM_ICDF(23171), AOM_ICDF(24620),
        AOM_ICDF(30086), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11419), AOM_ICDF(11567), AOM_ICDF(18634), AOM_ICDF(18883),
        AOM_ICDF(19104), AOM_ICDF(19248), AOM_ICDF(19893), AOM_ICDF(20888),
        AOM_ICDF(21033), AOM_ICDF(22315), AOM_ICDF(23826), AOM_ICDF(24525),
        AOM_ICDF(30179), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9189), AOM_ICDF(10281), AOM_ICDF(11230), AOM_ICDF(16405),
        AOM_ICDF(17311), AOM_ICDF(18197), AOM_ICDF(19006), AOM_ICDF(20724),
        AOM_ICDF(22333), AOM_ICDF(24386), AOM_ICDF(25785), AOM_ICDF(27242),
        AOM_ICDF(28966), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7147), AOM_ICDF(8107), AOM_ICDF(9311), AOM_ICDF(10136),
        AOM_ICDF(19792), AOM_ICDF(21308), AOM_ICDF(23054), AOM_ICDF(23925),
        AOM_ICDF(24607), AOM_ICDF(26515), AOM_ICDF(27604), AOM_ICDF(28656),
        AOM_ICDF(29559), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6365), AOM_ICDF(8081), AOM_ICDF(9004), AOM_ICDF(9938),
        AOM_ICDF(11895), AOM_ICDF(20421), AOM_ICDF(21345), AOM_ICDF(22202),
        AOM_ICDF(23152), AOM_ICDF(25230), AOM_ICDF(26650), AOM_ICDF(28079),
        AOM_ICDF(29572), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8250), AOM_ICDF(8912), AOM_ICDF(10731), AOM_ICDF(11427),
        AOM_ICDF(13007), AOM_ICDF(13716), AOM_ICDF(22033), AOM_ICDF(22930),
        AOM_ICDF(23513), AOM_ICDF(25585), AOM_ICDF(26953), AOM_ICDF(28164),
        AOM_ICDF(29628), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11323), AOM_ICDF(11774), AOM_ICDF(13130), AOM_ICDF(14204),
        AOM_ICDF(14740), AOM_ICDF(15149), AOM_ICDF(15802), AOM_ICDF(21726),
        AOM_ICDF(22242), AOM_ICDF(24238), AOM_ICDF(25756), AOM_ICDF(26846),
        AOM_ICDF(28871), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8890), AOM_ICDF(10301), AOM_ICDF(10977), AOM_ICDF(12641),
        AOM_ICDF(13349), AOM_ICDF(14139), AOM_ICDF(14734), AOM_ICDF(15619),
        AOM_ICDF(22046), AOM_ICDF(24098), AOM_ICDF(25429), AOM_ICDF(26906),
        AOM_ICDF(28828), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17708), AOM_ICDF(18145), AOM_ICDF(18884), AOM_ICDF(19425),
        AOM_ICDF(19815), AOM_ICDF(20176), AOM_ICDF(20623), AOM_ICDF(21298),
        AOM_ICDF(21685), AOM_ICDF(24368), AOM_ICDF(25911), AOM_ICDF(27197),
        AOM_ICDF(29509), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13037), AOM_ICDF(14010), AOM_ICDF(15130), AOM_ICDF(15964),
        AOM_ICDF(16679), AOM_ICDF(17386), AOM_ICDF(18141), AOM_ICDF(19178),
        AOM_ICDF(19964), AOM_ICDF(22512), AOM_ICDF(25234), AOM_ICDF(26435),
        AOM_ICDF(29054), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13975), AOM_ICDF(14718), AOM_ICDF(16002), AOM_ICDF(16816),
        AOM_ICDF(17513), AOM_ICDF(18144), AOM_ICDF(18901), AOM_ICDF(19946),
        AOM_ICDF(20623), AOM_ICDF(23072), AOM_ICDF(24378), AOM_ICDF(26706),
        AOM_ICDF(29044), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9674), AOM_ICDF(11360), AOM_ICDF(13478), AOM_ICDF(14162),
        AOM_ICDF(14690), AOM_ICDF(15250), AOM_ICDF(15831), AOM_ICDF(16698),
        AOM_ICDF(17371), AOM_ICDF(18986), AOM_ICDF(20457), AOM_ICDF(21724),
