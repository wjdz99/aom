...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(25578), AOM_ICDF(25742), AOM_ICDF(26086), AOM_ICDF(26302),
        AOM_ICDF(26443), AOM_ICDF(26577), AOM_ICDF(26750), AOM_ICDF(27064),
        AOM_ICDF(27220), AOM_ICDF(28092), AOM_ICDF(28624), AOM_ICDF(28952),
        AOM_ICDF(30305), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8010), AOM_ICDF(20053), AOM_ICDF(20141), AOM_ICDF(20297),
        AOM_ICDF(20454), AOM_ICDF(21036), AOM_ICDF(21123), AOM_ICDF(21240),
        AOM_ICDF(21851), AOM_ICDF(23221), AOM_ICDF(23635), AOM_ICDF(24748),
        AOM_ICDF(29181), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10060), AOM_ICDF(10106), AOM_ICDF(21177), AOM_ICDF(21278),
        AOM_ICDF(21390), AOM_ICDF(21454), AOM_ICDF(21946), AOM_ICDF(22575),
        AOM_ICDF(22640), AOM_ICDF(23729), AOM_ICDF(24714), AOM_ICDF(25012),
        AOM_ICDF(29420), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10445), AOM_ICDF(10825), AOM_ICDF(11074), AOM_ICDF(18353),
        AOM_ICDF(18718), AOM_ICDF(19048), AOM_ICDF(19312), AOM_ICDF(21063),
        AOM_ICDF(22416), AOM_ICDF(24654), AOM_ICDF(25476), AOM_ICDF(26353),
        AOM_ICDF(27399), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4799), AOM_ICDF(5268), AOM_ICDF(5941), AOM_ICDF(6281),
        AOM_ICDF(21940), AOM_ICDF(23222), AOM_ICDF(24671), AOM_ICDF(25054),
        AOM_ICDF(25311), AOM_ICDF(26873), AOM_ICDF(27349), AOM_ICDF(27796),
        AOM_ICDF(28093), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5024), AOM_ICDF(6427), AOM_ICDF(6715), AOM_ICDF(7006),
        AOM_ICDF(8843), AOM_ICDF(23147), AOM_ICDF(23546), AOM_ICDF(23832),
        AOM_ICDF(24205), AOM_ICDF(26054), AOM_ICDF(26813), AOM_ICDF(27550),
        AOM_ICDF(28239), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6843), AOM_ICDF(7007), AOM_ICDF(8498), AOM_ICDF(8708),
        AOM_ICDF(10076), AOM_ICDF(10364), AOM_ICDF(24043), AOM_ICDF(24399),
        AOM_ICDF(24568), AOM_ICDF(26578), AOM_ICDF(27233), AOM_ICDF(27782),
        AOM_ICDF(28412), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10095), AOM_ICDF(10183), AOM_ICDF(10886), AOM_ICDF(11628),
        AOM_ICDF(11833), AOM_ICDF(11949), AOM_ICDF(12219), AOM_ICDF(22518),
        AOM_ICDF(22721), AOM_ICDF(24984), AOM_ICDF(25893), AOM_ICDF(26392),
        AOM_ICDF(27704), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8431), AOM_ICDF(9277), AOM_ICDF(9419), AOM_ICDF(10451),
        AOM_ICDF(10731), AOM_ICDF(11059), AOM_ICDF(11255), AOM_ICDF(11787),
        AOM_ICDF(22009), AOM_ICDF(24436), AOM_ICDF(25176), AOM_ICDF(26105),
        AOM_ICDF(27358), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18461), AOM_ICDF(18710), AOM_ICDF(19231), AOM_ICDF(19521),
        AOM_ICDF(19795), AOM_ICDF(20023), AOM_ICDF(20346), AOM_ICDF(20863),
        AOM_ICDF(21142), AOM_ICDF(24903), AOM_ICDF(25869), AOM_ICDF(26646),
        AOM_ICDF(28556), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14917), AOM_ICDF(15511), AOM_ICDF(16191), AOM_ICDF(16574),
        AOM_ICDF(16964), AOM_ICDF(17342), AOM_ICDF(17755), AOM_ICDF(18422),
        AOM_ICDF(18917), AOM_ICDF(22095), AOM_ICDF(24714), AOM_ICDF(25332),
        AOM_ICDF(27789), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16133), AOM_ICDF(16482), AOM_ICDF(17329), AOM_ICDF(17724),
        AOM_ICDF(18085), AOM_ICDF(18381), AOM_ICDF(18829), AOM_ICDF(19501),
        AOM_ICDF(19881), AOM_ICDF(23007), AOM_ICDF(23718), AOM_ICDF(25727),
        AOM_ICDF(27799), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3113), AOM_ICDF(4631), AOM_ICDF(6784), AOM_ICDF(7050),
        AOM_ICDF(7242), AOM_ICDF(7446), AOM_ICDF(7657), AOM_ICDF(8087),
        AOM_ICDF(8387), AOM_ICDF(9663), AOM_ICDF(10566), AOM_ICDF(11287),
        AOM_ICDF(29742), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
