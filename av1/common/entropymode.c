...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_CDF8(2181, 2512, 13364, 15711, 26007, 26768, 32508)
};

static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_ALPHA_CONTEXTS][CDF_SIZE(CFL_ALPHABET_SIZE)] = {
      { AOM_CDF16(19866, 29558, 32309, 32686, 32746, 32753, 32756, 32758, 32759,
                  32761, 32762, 32763, 32765, 32766, 32767) },
      { AOM_CDF16(18341, 26353, 30216, 32056, 32611, 32703, 32731, 32748, 32752,
                  32757, 32759, 32762, 32763, 32765, 32766) },
      { AOM_CDF16(15246, 25483, 29260, 31823, 32497, 32618, 32671, 32718, 32733,
                  32740, 32746, 32750, 32754, 32758, 32761) },
      { AOM_CDF16(25908, 31255, 32268, 32569, 32668, 32713, 32742, 32748, 32752,
                  32756, 32757, 32760, 32761, 32763, 32765) },
      { AOM_CDF16(21419, 28235, 30439, 31560, 31978, 32262, 32368, 32536, 32569,
                  32607, 32628, 32677, 32686, 32700, 32711) },
      { AOM_CDF16(18647, 25978, 28948, 30376, 31218, 31648, 31871, 32081, 32184,
                  32267, 32343, 32459, 32491, 32559, 32644) },
    };
#endif
