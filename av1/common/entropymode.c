...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(27199), AOM_ICDF(27332), AOM_ICDF(27608), AOM_ICDF(27787),
        AOM_ICDF(27893), AOM_ICDF(27993), AOM_ICDF(28118), AOM_ICDF(28343),
        AOM_ICDF(28459), AOM_ICDF(29103), AOM_ICDF(29540), AOM_ICDF(29824),
        AOM_ICDF(31107), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9915), AOM_ICDF(20614), AOM_ICDF(20723), AOM_ICDF(20895),
        AOM_ICDF(21043), AOM_ICDF(21569), AOM_ICDF(21659), AOM_ICDF(21773),
        AOM_ICDF(22329), AOM_ICDF(23485), AOM_ICDF(23918), AOM_ICDF(24946),
        AOM_ICDF(29893), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12067), AOM_ICDF(12116), AOM_ICDF(21660), AOM_ICDF(21760),
        AOM_ICDF(21866), AOM_ICDF(21926), AOM_ICDF(22338), AOM_ICDF(22921),
        AOM_ICDF(22985), AOM_ICDF(23914), AOM_ICDF(24883), AOM_ICDF(25191),
        AOM_ICDF(30098), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11316), AOM_ICDF(11804), AOM_ICDF(12169), AOM_ICDF(18851),
        AOM_ICDF(19298), AOM_ICDF(19716), AOM_ICDF(20060), AOM_ICDF(21662),
        AOM_ICDF(22983), AOM_ICDF(24995), AOM_ICDF(25932), AOM_ICDF(26901),
        AOM_ICDF(28018), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6128), AOM_ICDF(6633), AOM_ICDF(7352), AOM_ICDF(7739),
        AOM_ICDF(22479), AOM_ICDF(23708), AOM_ICDF(25085), AOM_ICDF(25516),
        AOM_ICDF(25814), AOM_ICDF(27334), AOM_ICDF(27886), AOM_ICDF(28415),
        AOM_ICDF(28793), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6057), AOM_ICDF(7483), AOM_ICDF(7872), AOM_ICDF(8264),
        AOM_ICDF(10006), AOM_ICDF(23265), AOM_ICDF(23730), AOM_ICDF(24103),
        AOM_ICDF(24568), AOM_ICDF(26379), AOM_ICDF(27242), AOM_ICDF(28075),
        AOM_ICDF(28858), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8271), AOM_ICDF(8500), AOM_ICDF(9952), AOM_ICDF(10210),
        AOM_ICDF(11509), AOM_ICDF(11843), AOM_ICDF(24359), AOM_ICDF(24794),
        AOM_ICDF(25004), AOM_ICDF(26851), AOM_ICDF(27593), AOM_ICDF(28247),
        AOM_ICDF(29000), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12292), AOM_ICDF(12411), AOM_ICDF(13230), AOM_ICDF(13938),
        AOM_ICDF(14170), AOM_ICDF(14314), AOM_ICDF(14625), AOM_ICDF(23302),
        AOM_ICDF(23535), AOM_ICDF(25476), AOM_ICDF(26457), AOM_ICDF(27044),
        AOM_ICDF(28361), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9584), AOM_ICDF(10519), AOM_ICDF(10731), AOM_ICDF(11835),
        AOM_ICDF(12165), AOM_ICDF(12546), AOM_ICDF(12788), AOM_ICDF(13336),
        AOM_ICDF(22758), AOM_ICDF(24875), AOM_ICDF(25719), AOM_ICDF(26692),
        AOM_ICDF(27993), AOM_ICDF(32768), 0 },
      { AOM_ICDF(20837), AOM_ICDF(21067), AOM_ICDF(21523), AOM_ICDF(21800),
        AOM_ICDF(22032), AOM_ICDF(22237), AOM_ICDF(22508), AOM_ICDF(22945),
        AOM_ICDF(23180), AOM_ICDF(26124), AOM_ICDF(27094), AOM_ICDF(27857),
        AOM_ICDF(29524), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16386), AOM_ICDF(17005), AOM_ICDF(17700), AOM_ICDF(18111),
        AOM_ICDF(18504), AOM_ICDF(18896), AOM_ICDF(19317), AOM_ICDF(19999),
        AOM_ICDF(20479), AOM_ICDF(23152), AOM_ICDF(25646), AOM_ICDF(26326),
        AOM_ICDF(28590), AOM_ICDF(32768), 0 },
      { AOM_ICDF(17503), AOM_ICDF(17882), AOM_ICDF(18749), AOM_ICDF(19179),
        AOM_ICDF(19550), AOM_ICDF(19861), AOM_ICDF(20304), AOM_ICDF(20975),
        AOM_ICDF(21356), AOM_ICDF(23992), AOM_ICDF(24756), AOM_ICDF(26684),
        AOM_ICDF(28613), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3832), AOM_ICDF(5262), AOM_ICDF(7223), AOM_ICDF(7521),
        AOM_ICDF(7735), AOM_ICDF(7967), AOM_ICDF(8213), AOM_ICDF(8668),
        AOM_ICDF(8994), AOM_ICDF(10227), AOM_ICDF(11159), AOM_ICDF(11927),
        AOM_ICDF(30218), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(227),   AOM_ICDF(3102),  AOM_ICDF(6583),  AOM_ICDF(14205),
  AOM_ICDF(21349), AOM_ICDF(22883), AOM_ICDF(25355), AOM_ICDF(26545),
  AOM_ICDF(27438), AOM_ICDF(28515), AOM_ICDF(31195), AOM_ICDF(31646),
  AOM_ICDF(32102), AOM_ICDF(32523), AOM_ICDF(32768), 0,
};
#endif
