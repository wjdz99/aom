...
#if 1
    FILTER_INTRA_MODES)] = { { AOM_CDF5( 9227, 13101, 17118, 29458 ) },
...
default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
  {AOM_CDF14( 17437,18180,19901,20404,20827,21170,21809,22902,23342,25909,26558,27699,28450 )},
  {AOM_CDF14( 2938,22383,22559,22724,22878,23416,23523,23781,24406,26589,27078,28716,30622 )},
  {AOM_CDF14( 2682,2759,21635,21749,21854,21901,22349,23173,23260,24741,25399,25979,27448 )},
  {AOM_CDF14( 7482,7890,8174,15640,16018,16318,16579,18509,20085,23762,24444,25503,26162 )},
  {AOM_CDF14( 3729,4095,4722,4892,19543,20646,22295,22879,23060,25693,26120,26804,27082 )},
  {AOM_CDF14( 3857,5172,5436,5628,7017,22171,22488,23023,23302,26151,26749,27692,28171 )},
  {AOM_CDF14( 3647,3811,6205,6351,7354,7531,20931,21469,21595,24323,24800,25616,26056 )},
  {AOM_CDF14( 4499,4638,6160,6846,7109,7231,7560,20608,20897,24209,24971,25752,26452 )},
  {AOM_CDF14( 4301,5468,5683,6788,7122,7478,7708,8467,20576,24401,25058,26415,27348 )},
  {AOM_CDF14( 7604,8732,11897,12271,12909,13344,14237,15146,15626,22187,23059,24588,25859 )},
  {AOM_CDF14( 11337,12338,13272,13783,14219,14697,15148,16282,17114,22004,24324,25293,27226 )},
  {AOM_CDF14( 10920,11495,14036,14510,14874,15172,15687,16859,17374,21831,22457,25131,26610 )},
  {AOM_CDF14( 2120,4317,7106,7334,7505,7703,7945,8491,8827,10901,11797,12881,28846 )}
};
#else
#if CONFIG_FILTER_INTRA
static const aom_cdf_prob
...
const aom_cdf_prob
#if 1
default_kf_y_mode_cdf[KF_MODE_CONTEXTS][KF_MODE_CONTEXTS][CDF_SIZE(INTRA_MODES)] = {
  {
    {AOM_CDF13( 6270,7611,9876,10651,11349,11933,12932,14573,15607,29628,30694,32348 )},
    {AOM_CDF13( 5150,10716,12022,12767,13333,14190,14763,15973,17436,28865,30538,31982 )},
    {AOM_CDF13( 3013,3707,13133,13584,13974,14229,15337,17074,17614,29504,30212,32183 )},
    {AOM_CDF13( 7660,9056,10048,11952,12485,13066,13653,15779,18377,29047,30698,32458 )},
    {AOM_CDF13( 4320,5320,7418,8176,10315,11685,14010,16929,17791,29924,30888,32523 )}
  },
  {
    {AOM_CDF13( 3046,12351,13441,14012,14506,15492,15914,16898,18276,29184,30720,31839 )},
    {AOM_CDF13( 1876,20505,20884,21213,21424,22120,22264,22757,23854,30017,31365,31944 )},
    {AOM_CDF13( 2525,7723,13393,13939,14355,14922,15549,16905,17965,27903,29209,30937 )},
    {AOM_CDF13( 4634,10809,11465,12987,13443,14283,14578,15978,20268,28669,30886,32186 )},
    {AOM_CDF13( 2690,9012,10190,10906,12462,14954,16223,18638,20072,29267,30769,32002 )}
  },
  {
    {AOM_CDF13( 4420,5170,11813,12364,12819,13141,14258,16096,16768,29254,30109,32275 )},
    {AOM_CDF13( 4949,8665,12733,13459,13999,14617,15333,16861,18044,27705,29263,31409 )},
    {AOM_CDF13( 2058,2310,19484,19700,19852,19930,20693,22026,22230,30263,30646,32290 )},
    {AOM_CDF13( 6204,7277,9934,12000,12476,12912,13661,16540,18791,28398,29955,32214 )},
    {AOM_CDF13( 3722,4304,10032,10690,11814,12505,14897,18719,19296,29516,30335,32421 )}
  },
  {
    {AOM_CDF13( 5930,7743,8831,11024,11556,12236,12743,14512,17929,29260,30746,32457 )},
    {AOM_CDF13( 4006,9469,10179,12329,12718,13497,13816,14909,20415,29025,30934,32262 )},
    {AOM_CDF13( 3949,5283,10023,12147,12575,13014,13725,16122,18825,28619,29829,32044 )},
    {AOM_CDF13( 5522,7017,7531,12436,12595,12842,13027,14848,22788,29662,31248,32503 )},
    {AOM_CDF13( 4516,6006,7145,9881,11116,12474,13547,16686,19651,29285,30650,32459 )}
  },
  {
    {AOM_CDF13( 4678,5616,7660,8378,10584,12389,14451,16637,17435,29847,30902,32515 )},
    {AOM_CDF13( 4573,8261,9592,10333,12269,15320,16656,18481,19656,29178,30903,32256 )},
    {AOM_CDF13( 3094,3605,11296,11873,12878,13626,15773,18576,19104,29435,30233,32268 )},
    {AOM_CDF13( 6532,7534,8657,10952,11923,13084,13982,17236,19137,28812,30545,32441 )},
    {AOM_CDF13( 3489,4187,5579,6100,11424,14863,18156,22400,22839,30853,31513,32589 )}
  }
};
#else
