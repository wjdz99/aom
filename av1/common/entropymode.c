...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(11776), AOM_ICDF(11884), AOM_ICDF(14268), AOM_ICDF(16955),
        AOM_ICDF(17317), AOM_ICDF(17814), AOM_ICDF(18224), AOM_ICDF(18689),
        AOM_ICDF(19049), AOM_ICDF(19702), AOM_ICDF(20312), AOM_ICDF(20625),
        AOM_ICDF(20992), AOM_ICDF(32768), 0 },
...
#if CONFIG_CFL
// Based on the average probabilities of QPs 20, 32, 43, 55, 63 on Subset3 (1st
// Iteration)
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(683), AOM_ICDF(832), AOM_ICDF(931), AOM_ICDF(1159),
        AOM_ICDF(1215), AOM_ICDF(1329), AOM_ICDF(1452), AOM_ICDF(1644),
        AOM_ICDF(1757), AOM_ICDF(3961), AOM_ICDF(4561), AOM_ICDF(32768), 0 },
      { AOM_ICDF(438), AOM_ICDF(1450), AOM_ICDF(6281), AOM_ICDF(6749),
        AOM_ICDF(6837), AOM_ICDF(7252), AOM_ICDF(7349), AOM_ICDF(7582),
        AOM_ICDF(7874), AOM_ICDF(10517), AOM_ICDF(11968), AOM_ICDF(32768), 0 },
      { AOM_ICDF(482), AOM_ICDF(552), AOM_ICDF(1026), AOM_ICDF(4891),
        AOM_ICDF(4956), AOM_ICDF(5035), AOM_ICDF(5301), AOM_ICDF(5837),
        AOM_ICDF(5937), AOM_ICDF(8756), AOM_ICDF(10296), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5853), AOM_ICDF(6033), AOM_ICDF(7214), AOM_ICDF(9053),
        AOM_ICDF(9189), AOM_ICDF(9442), AOM_ICDF(10330), AOM_ICDF(11029),
        AOM_ICDF(11342), AOM_ICDF(13182), AOM_ICDF(13633), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4757), AOM_ICDF(4907), AOM_ICDF(5500), AOM_ICDF(6446),
        AOM_ICDF(7743), AOM_ICDF(8471), AOM_ICDF(8942), AOM_ICDF(9191),
        AOM_ICDF(9710), AOM_ICDF(12153), AOM_ICDF(12793), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5423), AOM_ICDF(5717), AOM_ICDF(7508), AOM_ICDF(8301),
        AOM_ICDF(9086), AOM_ICDF(12970), AOM_ICDF(13177), AOM_ICDF(13466),
        AOM_ICDF(13754), AOM_ICDF(15547), AOM_ICDF(15759), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4643), AOM_ICDF(4724), AOM_ICDF(5093), AOM_ICDF(7531),
        AOM_ICDF(7947), AOM_ICDF(8151), AOM_ICDF(9110), AOM_ICDF(9315),
        AOM_ICDF(10588), AOM_ICDF(12842), AOM_ICDF(13267), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3782), AOM_ICDF(3886), AOM_ICDF(4265), AOM_ICDF(7330),
        AOM_ICDF(7468), AOM_ICDF(7624), AOM_ICDF(7833), AOM_ICDF(8850),
        AOM_ICDF(9070), AOM_ICDF(11856), AOM_ICDF(12460), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4527), AOM_ICDF(4847), AOM_ICDF(6595), AOM_ICDF(7879),
        AOM_ICDF(8088), AOM_ICDF(8508), AOM_ICDF(8966), AOM_ICDF(10552),
        AOM_ICDF(11434), AOM_ICDF(13380), AOM_ICDF(14132), AOM_ICDF(32768), 0 },
      { AOM_ICDF(1310), AOM_ICDF(1505), AOM_ICDF(1891), AOM_ICDF(2334),
        AOM_ICDF(2472), AOM_ICDF(2612), AOM_ICDF(2812), AOM_ICDF(3099),
        AOM_ICDF(3292), AOM_ICDF(6770), AOM_ICDF(7776), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4262), AOM_ICDF(4603), AOM_ICDF(5999), AOM_ICDF(6998),
        AOM_ICDF(7076), AOM_ICDF(7326), AOM_ICDF(7439), AOM_ICDF(7742),
        AOM_ICDF(7908), AOM_ICDF(10071), AOM_ICDF(11746), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
#if CONFIG_CFL
// TODO(ltrudeau) Redo probabilities now that CFL is a mode (probably fewer
// zeros)
