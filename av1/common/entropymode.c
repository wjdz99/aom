...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(26513), AOM_ICDF(26682), AOM_ICDF(27019), AOM_ICDF(27240),
        AOM_ICDF(27361), AOM_ICDF(27481), AOM_ICDF(27627), AOM_ICDF(27899),
        AOM_ICDF(28035), AOM_ICDF(28731), AOM_ICDF(29304), AOM_ICDF(29667),
        AOM_ICDF(31056), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10026), AOM_ICDF(19738), AOM_ICDF(19899), AOM_ICDF(20146),
        AOM_ICDF(20331), AOM_ICDF(20947), AOM_ICDF(21060), AOM_ICDF(21210),
        AOM_ICDF(21855), AOM_ICDF(23085), AOM_ICDF(23647), AOM_ICDF(24806),
        AOM_ICDF(29956), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11789), AOM_ICDF(11854), AOM_ICDF(20650), AOM_ICDF(20786),
        AOM_ICDF(20919), AOM_ICDF(20995), AOM_ICDF(21484), AOM_ICDF(22185),
        AOM_ICDF(22262), AOM_ICDF(23278), AOM_ICDF(24422), AOM_ICDF(24844),
        AOM_ICDF(30139), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10539), AOM_ICDF(11234), AOM_ICDF(11790), AOM_ICDF(17991),
        AOM_ICDF(18585), AOM_ICDF(19162), AOM_ICDF(19662), AOM_ICDF(21300),
        AOM_ICDF(22722), AOM_ICDF(24781), AOM_ICDF(25896), AOM_ICDF(27041),
        AOM_ICDF(28346), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6583), AOM_ICDF(7226), AOM_ICDF(8099), AOM_ICDF(8617),
        AOM_ICDF(21628), AOM_ICDF(22953), AOM_ICDF(24479), AOM_ICDF(25053),
        AOM_ICDF(25465), AOM_ICDF(27091), AOM_ICDF(27839), AOM_ICDF(28531),
        AOM_ICDF(29066), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6310), AOM_ICDF(7850), AOM_ICDF(8413), AOM_ICDF(8979),
        AOM_ICDF(10824), AOM_ICDF(22305), AOM_ICDF(22928), AOM_ICDF(23457),
        AOM_ICDF(24097), AOM_ICDF(25993), AOM_ICDF(27058), AOM_ICDF(28093),
        AOM_ICDF(29097), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8383), AOM_ICDF(8735), AOM_ICDF(10337), AOM_ICDF(10728),
        AOM_ICDF(12130), AOM_ICDF(12573), AOM_ICDF(23588), AOM_ICDF(24178),
        AOM_ICDF(24495), AOM_ICDF(26417), AOM_ICDF(27363), AOM_ICDF(28216),
        AOM_ICDF(29222), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12631), AOM_ICDF(12828), AOM_ICDF(13848), AOM_ICDF(14669),
        AOM_ICDF(14981), AOM_ICDF(15188), AOM_ICDF(15596), AOM_ICDF(22788),
        AOM_ICDF(23089), AOM_ICDF(25017), AOM_ICDF(26173), AOM_ICDF(26936),
        AOM_ICDF(28479), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9490), AOM_ICDF(10587), AOM_ICDF(10926), AOM_ICDF(12234),
        AOM_ICDF(12677), AOM_ICDF(13180), AOM_ICDF(13522), AOM_ICDF(14170),
        AOM_ICDF(22533), AOM_ICDF(24606), AOM_ICDF(25648), AOM_ICDF(26785),
        AOM_ICDF(28269), AOM_ICDF(32768), 0 },
      { AOM_ICDF(20061), AOM_ICDF(20354), AOM_ICDF(20888), AOM_ICDF(21238),
        AOM_ICDF(21513), AOM_ICDF(21759), AOM_ICDF(22072), AOM_ICDF(22572),
        AOM_ICDF(22840), AOM_ICDF(25566), AOM_ICDF(26752), AOM_ICDF(27700),
        AOM_ICDF(29523), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15314), AOM_ICDF(16045), AOM_ICDF(16889), AOM_ICDF(17435),
        AOM_ICDF(17928), AOM_ICDF(18410), AOM_ICDF(18930), AOM_ICDF(19732),
        AOM_ICDF(20301), AOM_ICDF(22886), AOM_ICDF(25515), AOM_ICDF(26379),
        AOM_ICDF(28719), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16424), AOM_ICDF(16910), AOM_ICDF(17933), AOM_ICDF(18491),
        AOM_ICDF(18955), AOM_ICDF(19350), AOM_ICDF(19899), AOM_ICDF(20691),
        AOM_ICDF(21151), AOM_ICDF(23676), AOM_ICDF(24635), AOM_ICDF(26741),
        AOM_ICDF(28722), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5774), AOM_ICDF(7319), AOM_ICDF(9396), AOM_ICDF(9817),
        AOM_ICDF(10124), AOM_ICDF(10450), AOM_ICDF(10796), AOM_ICDF(11390),
        AOM_ICDF(11820), AOM_ICDF(13185), AOM_ICDF(14319), AOM_ICDF(15254),
        AOM_ICDF(30223), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(259),   AOM_ICDF(3305),  AOM_ICDF(6749),  AOM_ICDF(14287),
  AOM_ICDF(20234), AOM_ICDF(21660), AOM_ICDF(24964), AOM_ICDF(26109),
  AOM_ICDF(26957), AOM_ICDF(27939), AOM_ICDF(30706), AOM_ICDF(31425),
  AOM_ICDF(32016), AOM_ICDF(32476), AOM_ICDF(32768), 0
};
#endif
