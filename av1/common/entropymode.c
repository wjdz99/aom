...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(20734), AOM_ICDF(21085), AOM_ICDF(21800), AOM_ICDF(22174),
        AOM_ICDF(22434), AOM_ICDF(22664), AOM_ICDF(22986), AOM_ICDF(23559),
        AOM_ICDF(23828), AOM_ICDF(25307), AOM_ICDF(26340), AOM_ICDF(27072),
        AOM_ICDF(29082), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6240), AOM_ICDF(17312), AOM_ICDF(17508), AOM_ICDF(17800),
        AOM_ICDF(18060), AOM_ICDF(19004), AOM_ICDF(19153), AOM_ICDF(19350),
        AOM_ICDF(20274), AOM_ICDF(22041), AOM_ICDF(22836), AOM_ICDF(24306),
        AOM_ICDF(28421), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7671), AOM_ICDF(7744), AOM_ICDF(18300), AOM_ICDF(18471),
        AOM_ICDF(18662), AOM_ICDF(18760), AOM_ICDF(19597), AOM_ICDF(20677),
        AOM_ICDF(20777), AOM_ICDF(22349), AOM_ICDF(23739), AOM_ICDF(24401),
        AOM_ICDF(28580), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7807), AOM_ICDF(8522), AOM_ICDF(9057), AOM_ICDF(15477),
        AOM_ICDF(16091), AOM_ICDF(16669), AOM_ICDF(17171), AOM_ICDF(19076),
        AOM_ICDF(20775), AOM_ICDF(23135), AOM_ICDF(24386), AOM_ICDF(25669),
        AOM_ICDF(27053), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4375), AOM_ICDF(5099), AOM_ICDF(6110), AOM_ICDF(6652),
        AOM_ICDF(18815), AOM_ICDF(20456), AOM_ICDF(22386), AOM_ICDF(23010),
        AOM_ICDF(23453), AOM_ICDF(25299), AOM_ICDF(26128), AOM_ICDF(26910),
        AOM_ICDF(27444), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4307), AOM_ICDF(6079), AOM_ICDF(6635), AOM_ICDF(7175),
        AOM_ICDF(9391), AOM_ICDF(20692), AOM_ICDF(21354), AOM_ICDF(21880),
        AOM_ICDF(22529), AOM_ICDF(24594), AOM_ICDF(25743), AOM_ICDF(26843),
        AOM_ICDF(27872), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5491), AOM_ICDF(5833), AOM_ICDF(7782), AOM_ICDF(8159),
        AOM_ICDF(9926), AOM_ICDF(10408), AOM_ICDF(21720), AOM_ICDF(22360),
        AOM_ICDF(22673), AOM_ICDF(24852), AOM_ICDF(25923), AOM_ICDF(26871),
        AOM_ICDF(27836), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8989), AOM_ICDF(9168), AOM_ICDF(10397), AOM_ICDF(11331),
        AOM_ICDF(11677), AOM_ICDF(11885), AOM_ICDF(12349), AOM_ICDF(20451),
        AOM_ICDF(20794), AOM_ICDF(23130), AOM_ICDF(24468), AOM_ICDF(25356),
        AOM_ICDF(26987), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6656), AOM_ICDF(7918), AOM_ICDF(8226), AOM_ICDF(9677),
        AOM_ICDF(10135), AOM_ICDF(10683), AOM_ICDF(11025), AOM_ICDF(11758),
        AOM_ICDF(20320), AOM_ICDF(22769), AOM_ICDF(23968), AOM_ICDF(25273),
        AOM_ICDF(26819), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14290), AOM_ICDF(14761), AOM_ICDF(15713), AOM_ICDF(16156),
        AOM_ICDF(16602), AOM_ICDF(16983), AOM_ICDF(17518), AOM_ICDF(18309),
        AOM_ICDF(18722), AOM_ICDF(22506), AOM_ICDF(24050), AOM_ICDF(25362),
        AOM_ICDF(27459), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11253), AOM_ICDF(12171), AOM_ICDF(13207), AOM_ICDF(13802),
        AOM_ICDF(14417), AOM_ICDF(15010), AOM_ICDF(15649), AOM_ICDF(16599),
        AOM_ICDF(17289), AOM_ICDF(20578), AOM_ICDF(23483), AOM_ICDF(24533),
        AOM_ICDF(27039), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12207), AOM_ICDF(12775), AOM_ICDF(14129), AOM_ICDF(14732),
        AOM_ICDF(15298), AOM_ICDF(15753), AOM_ICDF(16451), AOM_ICDF(17444),
        AOM_ICDF(17981), AOM_ICDF(21200), AOM_ICDF(22378), AOM_ICDF(24775),
        AOM_ICDF(26924), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4928), AOM_ICDF(7093), AOM_ICDF(10030), AOM_ICDF(10500),
        AOM_ICDF(10864), AOM_ICDF(11255), AOM_ICDF(11667), AOM_ICDF(12401),
        AOM_ICDF(12932), AOM_ICDF(14748), AOM_ICDF(16147), AOM_ICDF(17316),
