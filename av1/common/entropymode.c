...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_CDF8(2058, 2401, 12580, 15049, 25848, 26612, 32508)
};

static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_ALPHA_CONTEXTS][CDF_SIZE(CFL_ALPHABET_SIZE)] = {
      { AOM_CDF16(18142, 28859, 32112, 32666, 32745, 32753, 32757, 32758, 32760,
                  32761, 32762, 32764, 32765, 32766, 32767) },
      { AOM_CDF16(17521, 26162, 30282, 32093, 32592, 32696, 32727, 32748, 32753,
                  32756, 32759, 32761, 32763, 32765, 32766) },
      { AOM_CDF16(14618, 25431, 29406, 31809, 32476, 32614, 32659, 32720, 32734,
                  32741, 32746, 32751, 32754, 32758, 32760) },
      { AOM_CDF16(25451, 31112, 32207, 32548, 32669, 32713, 32738, 32748, 32750,
                  32755, 32757, 32760, 32762, 32765, 32767) },
      { AOM_CDF16(20896, 28022, 30410, 31549, 31986, 32254, 32358, 32534, 32579,
                  32611, 32635, 32673, 32686, 32697, 32712) },
      { AOM_CDF16(17739, 25526, 28722, 30302, 31122, 31600, 31800, 32063, 32171,
                  32242, 32327, 32418, 32449, 32499, 32603) }
    };
#endif
