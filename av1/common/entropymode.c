...
static const aom_cdf_prob default_eob_multi16[PLANE_TYPES][2][CDF_SIZE(5)] = {
  { { AOM_CDF5(11372, 14175, 19149, 25227) },
    { AOM_CDF5(3444, 5532, 8941, 17801) } },
  { { AOM_CDF5(17691, 20547, 25157, 29605) },
    { AOM_CDF5(6554, 13107, 19661, 26214) } }
};

static const aom_cdf_prob default_eob_multi32[PLANE_TYPES][2][CDF_SIZE(6)] = {
  { { AOM_CDF6(4450, 5712, 7811, 11383, 19226) },
    { AOM_CDF6(1282, 1964, 4083, 7621, 14827) } },
  { { AOM_CDF6(15536, 17616, 20787, 24861, 30242) },
    { AOM_CDF6(5461, 10923, 16384, 21845, 27307) } }
};

static const aom_cdf_prob default_eob_multi64[PLANE_TYPES][2][CDF_SIZE(7)] = {
  { { AOM_CDF7(8701, 10292, 12975, 16167, 20153, 25273) },
    { AOM_CDF7(3030, 4310, 6462, 9274, 13877, 21196) } },
  { { AOM_CDF7(19975, 21714, 24130, 26638, 29160, 31495) },
    { AOM_CDF7(4681, 9362, 14043, 18725, 23406, 28087) } }
};

static const aom_cdf_prob default_eob_multi128[PLANE_TYPES][2][CDF_SIZE(8)] = {
  { { AOM_CDF8(4593, 5635, 7525, 9569, 12638, 17098, 23237) },
    { AOM_CDF8(1118, 1888, 3509, 9651, 16097, 21143, 26097) } },
  { { AOM_CDF8(20954, 22189, 24224, 26166, 28237, 30194, 31898) },
    { AOM_CDF8(4096, 8192, 12288, 16384, 20480, 24576, 28672) } }
};

static const aom_cdf_prob default_eob_multi256[PLANE_TYPES][2][CDF_SIZE(9)] = {
  { { AOM_CDF9(6953, 8513, 10965, 13998, 17841, 21756, 25315, 28579) },
    { AOM_CDF9(3641, 7282, 10923, 14564, 18204, 21845, 25486, 29127) } },
  { { AOM_CDF9(20515, 21884, 23830, 25943, 27953, 29527, 30801, 32013) },
    { AOM_CDF9(3641, 7282, 10923, 14564, 18204, 21845, 25486, 29127) } }
};

static const aom_cdf_prob default_eob_multi512[PLANE_TYPES][2][CDF_SIZE(10)] = {
  { { AOM_CDF10(4611, 5545, 7670, 10086, 13479, 17180, 21590, 25546, 28545) },
    { AOM_CDF10(3277, 6554, 9830, 13107, 16384, 19661, 22938, 26214, 29491) } },
  { { AOM_CDF10(20645, 22233, 24947, 27151, 29106, 30442, 31329, 32042,
                32503) },
    { AOM_CDF10(3277, 6554, 9830, 13107, 16384, 19661, 22938, 26214, 29491) } }
};

static const aom_cdf_prob default_eob_multi1024[PLANE_TYPES][2][CDF_SIZE(11)] =
    { { { AOM_CDF11(5541, 6853, 9854, 12605, 15854, 19512, 23040, 25761, 28119,
                    30144) },
        { AOM_CDF11(2979, 5958, 8937, 11916, 14895, 17873, 20852, 23831, 26810,
                    29789) } },
      { { AOM_CDF11(17003, 18462, 21373, 23235, 25024, 26778, 28140, 29189,
                    30395, 31572) },
        { AOM_CDF11(2979, 5958, 8937, 11916, 14895, 17873, 20852, 23831, 26810,
                    29789) } } };
...
static const aom_cdf_prob
    default_coeff_base_multi[TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS]
                            [CDF_SIZE(NUM_BASE_LEVELS + 2)] = {
                              { { { AOM_CDF4(7484, 18306, 24503) },
                                  { AOM_CDF4(23916, 32058, 32675) },
                                  { AOM_CDF4(16700, 29334, 31978) },
                                  { AOM_CDF4(9174, 21373, 27793) },
                                  { AOM_CDF4(5507, 14513, 21657) },
                                  { AOM_CDF4(3463, 9354, 14895) },
                                  { AOM_CDF4(26247, 32347, 32702) },
                                  { AOM_CDF4(19478, 30371, 32248) },
                                  { AOM_CDF4(10093, 22537, 28648) },
                                  { AOM_CDF4(6488, 15958, 23161) },
                                  { AOM_CDF4(4311, 11007, 16993) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(26009, 32166, 32639) },
                                  { AOM_CDF4(20761, 30435, 32209) },
                                  { AOM_CDF4(10230, 20566, 26694) },
                                  { AOM_CDF4(8558, 15592, 21594) },
                                  { AOM_CDF4(5453, 10812, 15629) },
                                  { AOM_CDF4(24267, 31783, 32500) },
                                  { AOM_CDF4(16882, 29208, 31689) },
                                  { AOM_CDF4(8131, 19126, 25700) },
                                  { AOM_CDF4(3391, 9781, 16632) },
                                  { AOM_CDF4(1574, 4859, 8915) },
                                  { AOM_CDF4(27832, 32448, 32703) },
                                  { AOM_CDF4(19818, 29712, 31863) },
                                  { AOM_CDF4(9148, 20011, 26397) },
                                  { AOM_CDF4(3997, 11738, 18622) },
                                  { AOM_CDF4(2530, 7428, 12517) },
                                  { AOM_CDF4(28822, 32412, 32674) },
                                  { AOM_CDF4(21321, 30112, 31974) },
                                  { AOM_CDF4(9167, 19710, 25903) },
                                  { AOM_CDF4(3375, 9658, 16593) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(12346, 25191, 29645) },
                                  { AOM_CDF4(26746, 32449, 32733) },
                                  { AOM_CDF4(21778, 31358, 32502) },
                                  { AOM_CDF4(12625, 25236, 29917) },
                                  { AOM_CDF4(6039, 15980, 23176) },
                                  { AOM_CDF4(3309, 9567, 15550) },
                                  { AOM_CDF4(28643, 32634, 32748) },
                                  { AOM_CDF4(23937, 31995, 32636) },
                                  { AOM_CDF4(14615, 27218, 30872) },
                                  { AOM_CDF4(6895, 18266, 25313) },
                                  { AOM_CDF4(3910, 12295, 19441) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(28213, 32632, 32748) },
                                  { AOM_CDF4(25227, 32352, 32712) },
                                  { AOM_CDF4(15385, 27800, 31032) },
                                  { AOM_CDF4(6275, 20219, 26842) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } } },
                              { { { AOM_CDF4(5997, 15074, 20868) },
                                  { AOM_CDF4(24422, 31838, 32540) },
                                  { AOM_CDF4(16225, 28859, 31641) },
                                  { AOM_CDF4(9185, 21465, 27599) },
                                  { AOM_CDF4(5702, 14976, 21872) },
                                  { AOM_CDF4(3222, 8913, 14160) },
                                  { AOM_CDF4(26152, 32395, 32720) },
                                  { AOM_CDF4(18879, 30439, 32295) },
                                  { AOM_CDF4(11244, 24363, 29738) },
                                  { AOM_CDF4(6871, 17544, 24692) },
                                  { AOM_CDF4(3979, 11032, 17187) },
                                  { AOM_CDF4(26924, 32387, 32693) },
                                  { AOM_CDF4(18103, 29675, 31967) },
                                  { AOM_CDF4(9890, 22182, 28122) },
                                  { AOM_CDF4(5843, 15323, 22286) },
                                  { AOM_CDF4(3358, 9309, 14708) },
                                  { AOM_CDF4(25160, 32216, 32671) },
                                  { AOM_CDF4(17643, 29536, 31929) },
                                  { AOM_CDF4(9985, 22190, 28060) },
                                  { AOM_CDF4(5807, 15177, 21980) },
                                  { AOM_CDF4(3264, 9092, 14330) },
                                  { AOM_CDF4(28532, 32643, 32748) },
                                  { AOM_CDF4(22897, 31737, 32589) },
                                  { AOM_CDF4(13864, 26662, 30930) },
                                  { AOM_CDF4(8112, 19553, 26683) },
                                  { AOM_CDF4(4854, 13042, 19988) },
                                  { AOM_CDF4(26598, 32185, 32640) },
                                  { AOM_CDF4(17371, 29536, 31893) },
                                  { AOM_CDF4(10092, 22205, 27752) },
                                  { AOM_CDF4(4909, 13329, 20102) },
                                  { AOM_CDF4(2185, 6304, 10519) },
                                  { AOM_CDF4(29071, 32614, 32745) },
                                  { AOM_CDF4(21474, 31155, 32393) },
                                  { AOM_CDF4(13402, 25970, 30098) },
                                  { AOM_CDF4(7289, 17986, 24477) },
                                  { AOM_CDF4(3541, 9887, 15361) },
                                  { AOM_CDF4(29347, 32641, 32746) },
                                  { AOM_CDF4(22492, 31399, 32450) },
                                  { AOM_CDF4(13267, 25532, 29862) },
                                  { AOM_CDF4(6872, 17307, 24109) },
                                  { AOM_CDF4(3805, 10599, 16497) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(10944, 23054, 28095) },
                                  { AOM_CDF4(26476, 32222, 32626) },
                                  { AOM_CDF4(20114, 30514, 32241) },
                                  { AOM_CDF4(11450, 24538, 29636) },
                                  { AOM_CDF4(6774, 17675, 24574) },
                                  { AOM_CDF4(3959, 11187, 17213) },
                                  { AOM_CDF4(28387, 32619, 32748) },
                                  { AOM_CDF4(23482, 31921, 32638) },
                                  { AOM_CDF4(14785, 27751, 31269) },
                                  { AOM_CDF4(8329, 20189, 26766) },
                                  { AOM_CDF4(4393, 12674, 19080) },
                                  { AOM_CDF4(29153, 32637, 32748) },
                                  { AOM_CDF4(23106, 31694, 32553) },
                                  { AOM_CDF4(14124, 26464, 30250) },
                                  { AOM_CDF4(6812, 16457, 23054) },
                                  { AOM_CDF4(3122, 9490, 15501) },
                                  { AOM_CDF4(28098, 32475, 32727) },
                                  { AOM_CDF4(21372, 31109, 32462) },
                                  { AOM_CDF4(12990, 25959, 30494) },
                                  { AOM_CDF4(7917, 19084, 25902) },
                                  { AOM_CDF4(4525, 12150, 18434) },
                                  { AOM_CDF4(30279, 32736, 32748) },
                                  { AOM_CDF4(26458, 32516, 32740) },
                                  { AOM_CDF4(18577, 30349, 32214) },
                                  { AOM_CDF4(10179, 23292, 29170) },
                                  { AOM_CDF4(5688, 14896, 22251) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } } },
                              { { { AOM_CDF4(5316, 13632, 19129) },
                                  { AOM_CDF4(23709, 31751, 32557) },
                                  { AOM_CDF4(15299, 28084, 31273) },
                                  { AOM_CDF4(8378, 20152, 26499) },
                                  { AOM_CDF4(5102, 13741, 20195) },
                                  { AOM_CDF4(2568, 7240, 11498) },
                                  { AOM_CDF4(26944, 32423, 32718) },
                                  { AOM_CDF4(18322, 30002, 32103) },
                                  { AOM_CDF4(10279, 23231, 28902) },
                                  { AOM_CDF4(6249, 16510, 23451) },
                                  { AOM_CDF4(3403, 9599, 15004) },
                                  { AOM_CDF4(29138, 32594, 32735) },
                                  { AOM_CDF4(19052, 30240, 32156) },
                                  { AOM_CDF4(10409, 23118, 28716) },
                                  { AOM_CDF4(6049, 15999, 22859) },
                                  { AOM_CDF4(3275, 9226, 14430) },
                                  { AOM_CDF4(27879, 32529, 32728) },
                                  { AOM_CDF4(19048, 30327, 32186) },
                                  { AOM_CDF4(10678, 23375, 28837) },
                                  { AOM_CDF4(6000, 15771, 22533) },
                                  { AOM_CDF4(2936, 8274, 13078) },
                                  { AOM_CDF4(30298, 32731, 32748) },
                                  { AOM_CDF4(24384, 32129, 32673) },
                                  { AOM_CDF4(14953, 28111, 31547) },
                                  { AOM_CDF4(8824, 21421, 28035) },
                                  { AOM_CDF4(5133, 14079, 20938) },
                                  { AOM_CDF4(27415, 32287, 32675) },
                                  { AOM_CDF4(17333, 29409, 31849) },
                                  { AOM_CDF4(9318, 20929, 26491) },
                                  { AOM_CDF4(4108, 11564, 17933) },
                                  { AOM_CDF4(1658, 4955, 8538) },
                                  { AOM_CDF4(29796, 32636, 32739) },
                                  { AOM_CDF4(22626, 31443, 32425) },
                                  { AOM_CDF4(13988, 26552, 30305) },
                                  { AOM_CDF4(7754, 18679, 25091) },
                                  { AOM_CDF4(3487, 9196, 14346) },
                                  { AOM_CDF4(30574, 32737, 32748) },
                                  { AOM_CDF4(25514, 32229, 32668) },
                                  { AOM_CDF4(15561, 27880, 31025) },
                                  { AOM_CDF4(7494, 18694, 25221) },
                                  { AOM_CDF4(3410, 9903, 15494) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(8074, 18543, 24005) },
                                  { AOM_CDF4(26035, 32033, 32593) },
                                  { AOM_CDF4(18381, 29571, 31749) },
                                  { AOM_CDF4(10328, 23159, 28715) },
                                  { AOM_CDF4(6795, 17727, 24700) },
                                  { AOM_CDF4(4395, 11675, 17432) },
                                  { AOM_CDF4(28547, 32600, 32748) },
                                  { AOM_CDF4(21091, 31285, 32512) },
                                  { AOM_CDF4(12371, 26210, 30809) },
                                  { AOM_CDF4(7903, 19917, 26947) },
                                  { AOM_CDF4(4766, 13195, 19696) },
                                  { AOM_CDF4(30378, 32629, 32732) },
                                  { AOM_CDF4(21733, 30904, 32159) },
                                  { AOM_CDF4(11400, 24078, 28822) },
                                  { AOM_CDF4(6484, 16225, 22233) },
                                  { AOM_CDF4(3827, 10240, 15935) },
                                  { AOM_CDF4(29262, 32621, 32744) },
                                  { AOM_CDF4(21624, 31303, 32449) },
                                  { AOM_CDF4(12846, 26252, 30564) },
                                  { AOM_CDF4(7898, 19549, 26122) },
                                  { AOM_CDF4(4464, 12261, 18644) },
                                  { AOM_CDF4(31044, 32748, 32752) },
                                  { AOM_CDF4(25536, 32312, 32713) },
                                  { AOM_CDF4(15487, 28899, 31909) },
                                  { AOM_CDF4(9758, 23135, 29222) },
                                  { AOM_CDF4(5948, 16164, 23348) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } } },
                              { { { AOM_CDF4(4797, 12587, 17870) },
                                  { AOM_CDF4(21742, 31108, 32393) },
                                  { AOM_CDF4(13863, 26930, 30636) },
                                  { AOM_CDF4(7837, 19297, 25690) },
                                  { AOM_CDF4(4942, 13615, 20050) },
                                  { AOM_CDF4(2154, 6068, 9658) },
                                  { AOM_CDF4(27189, 32414, 32725) },
                                  { AOM_CDF4(17446, 29606, 31967) },
                                  { AOM_CDF4(9508, 22401, 28301) },
                                  { AOM_CDF4(5818, 15704, 22583) },
                                  { AOM_CDF4(2725, 7856, 12372) },
                                  { AOM_CDF4(30175, 32630, 32738) },
                                  { AOM_CDF4(18751, 30125, 32052) },
                                  { AOM_CDF4(10125, 22874, 28449) },
                                  { AOM_CDF4(5992, 15786, 22460) },
                                  { AOM_CDF4(2953, 8365, 13062) },
                                  { AOM_CDF4(29054, 32613, 32746) },
                                  { AOM_CDF4(19123, 30565, 32302) },
                                  { AOM_CDF4(10856, 24394, 29710) },
                                  { AOM_CDF4(6662, 17605, 24582) },
                                  { AOM_CDF4(3199, 9134, 14192) },
                                  { AOM_CDF4(31403, 32750, 32754) },
                                  { AOM_CDF4(24515, 32048, 32652) },
                                  { AOM_CDF4(13847, 27549, 31268) },
                                  { AOM_CDF4(8366, 21090, 27595) },
                                  { AOM_CDF4(4551, 12793, 18962) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) } },
                                { { AOM_CDF4(7506, 18103, 23419) },
                                  { AOM_CDF4(24716, 31436, 32331) },
                                  { AOM_CDF4(15202, 26280, 29769) },
                                  { AOM_CDF4(7662, 17828, 22900) },
                                  { AOM_CDF4(5190, 13353, 18478) },
                                  { AOM_CDF4(3010, 8975, 13445) },
                                  { AOM_CDF4(27931, 32384, 32699) },
                                  { AOM_CDF4(18523, 29721, 31900) },
                                  { AOM_CDF4(10028, 23156, 28646) },
                                  { AOM_CDF4(6794, 17892, 24427) },
                                  { AOM_CDF4(4260, 12269, 18518) },
                                  { AOM_CDF4(30832, 32685, 32748) },
                                  { AOM_CDF4(21287, 31159, 32397) },
                                  { AOM_CDF4(12107, 25167, 30247) },
                                  { AOM_CDF4(8109, 19383, 25881) },
                                  { AOM_CDF4(3792, 13127, 20128) },
                                  { AOM_CDF4(30137, 32670, 32748) },
                                  { AOM_CDF4(22293, 31503, 32521) },
                                  { AOM_CDF4(12105, 25883, 30652) },
                                  { AOM_CDF4(7237, 18977, 25815) },
                                  { AOM_CDF4(4503, 12315, 19097) },
                                  { AOM_CDF4(31721, 32752, 32756) },
                                  { AOM_CDF4(25885, 32349, 32716) },
                                  { AOM_CDF4(15350, 29167, 31999) },
                                  { AOM_CDF4(9998, 23899, 29597) },
                                  { AOM_CDF4(6269, 17132, 24195) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  ...
                                  { AOM_CDF4(8192, 16384, 24576) } } },
#if CONFIG_TX64X64
                              { { { AOM_CDF4(4217, 10785, 15764) },
                                  { AOM_CDF4(20157, 30667, 32280) },
                                  { AOM_CDF4(12833, 25868, 30339) },
                                  { AOM_CDF4(7422, 19439, 25843) },
                                  { AOM_CDF4(5588, 14929, 21805) },
                                  { AOM_CDF4(2748, 7569, 12315) },
                                  { AOM_CDF4(27242, 32403, 32728) },
                                  { AOM_CDF4(17083, 29356, 31875) },
                                  { AOM_CDF4(9454, 22302, 28235) },
                                  { AOM_CDF4(5836, 16022, 22683) },
                                  { AOM_CDF4(2584, 7460, 11498) },
                                  { AOM_CDF4(30300, 32597, 32724) },
                                  { AOM_CDF4(20086, 30172, 31937) },
                                  { AOM_CDF4(10960, 23459, 28524) },
                                  { AOM_CDF4(6278, 16617, 22914) },
                                  { AOM_CDF4(2649, 7446, 11471) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(31643, 32752, 32756) },
                                  { AOM_CDF4(25360, 32195, 32679) },
                                  { AOM_CDF4(14480, 27849, 31366) },
                                  { AOM_CDF4(8379, 20915, 27414) },
                                  { AOM_CDF4(3971, 11058, 16624) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
                                  { AOM_CDF4(8192, 16384, 24576) },
...
static const aom_cdf_prob
    default_coeff_base_eob_multi[TX_SIZES][PLANE_TYPES][SIG_COEF_CONTEXTS_EOB]
                                [CDF_SIZE(NUM_BASE_LEVELS + 1)] = {
                                  { { { AOM_CDF3(26497, 31523) },
                                      { AOM_CDF3(31764, 32687) },
                                      { AOM_CDF3(31906, 32683) },
                                      { AOM_CDF3(31741, 32596) } },
                                    { { AOM_CDF3(29474, 32244) },
                                      { AOM_CDF3(32042, 32732) },
                                      { AOM_CDF3(32410, 32751) },
                                      { AOM_CDF3(32555, 32756) } } },
                                  { { { AOM_CDF3(25225, 30986) },
                                      { AOM_CDF3(32101, 32714) },
                                      { AOM_CDF3(32406, 32746) },
                                      { AOM_CDF3(32303, 32724) } },
                                    { { AOM_CDF3(29280, 32090) },
                                      { AOM_CDF3(31971, 32697) },
                                      { AOM_CDF3(32411, 32753) },
                                      { AOM_CDF3(32621, 32756) } } },
                                  { { { AOM_CDF3(24419, 30819) },
                                      { AOM_CDF3(32220, 32721) },
                                      { AOM_CDF3(32643, 32756) },
                                      { AOM_CDF3(32641, 32756) } },
                                    { { AOM_CDF3(27515, 31256) },
                                      { AOM_CDF3(32323, 32721) },
                                      { AOM_CDF3(32687, 32756) },
                                      { AOM_CDF3(32721, 32756) } } },
                                  { { { AOM_CDF3(26572, 31689) },
                                      { AOM_CDF3(32385, 32735) },
                                      { AOM_CDF3(32665, 32756) },
                                      { AOM_CDF3(32718, 32756) } },
                                    { { AOM_CDF3(29418, 32089) },
                                      { AOM_CDF3(32035, 32614) },
                                      { AOM_CDF3(32747, 32756) },
                                      { AOM_CDF3(32724, 32756) } } },
#if CONFIG_TX64X64
                                  { { { AOM_CDF3(26005, 31497) },
                                      { AOM_CDF3(31229, 32182) },
                                      { AOM_CDF3(32349, 32756) },
                                      { AOM_CDF3(32392, 32737) } },
...
static const aom_cdf_prob
    default_coeff_lps_multi[TX_SIZES][PLANE_TYPES][LEVEL_CONTEXTS][CDF_SIZE(
        BR_CDF_SIZE)] = {
      { { { AOM_CDF4(21931, 28400, 30821) }, { AOM_CDF4(16613, 24535, 28398) },
          { AOM_CDF4(10955, 18390, 23341) }, { AOM_CDF4(7457, 13595, 18519) },
          { AOM_CDF4(5636, 10665, 15038) },  { AOM_CDF4(4330, 8469, 12319) },
          { AOM_CDF4(2849, 5563, 8270) },    { AOM_CDF4(23089, 29004, 31003) },
          { AOM_CDF4(21397, 28318, 30769) }, { AOM_CDF4(16504, 24629, 28569) },
          { AOM_CDF4(12108, 20029, 24997) }, { AOM_CDF4(9329, 16585, 21692) },
          { AOM_CDF4(7846, 14042, 19134) },  { AOM_CDF4(5585, 10388, 14529) },
          { AOM_CDF4(24637, 30354, 31810) }, { AOM_CDF4(22441, 28968, 31168) },
          { AOM_CDF4(18251, 26105, 29568) }, { AOM_CDF4(13866, 21919, 26743) },
          { AOM_CDF4(10471, 18536, 23561) }, { AOM_CDF4(9571, 16137, 21149) },
          { AOM_CDF4(6349, 12161, 16866) } },
        { { AOM_CDF4(24124, 29704, 31439) }, { AOM_CDF4(18773, 26176, 29303) },
          { AOM_CDF4(11757, 19134, 23768) }, { AOM_CDF4(7256, 13246, 17845) },
          { AOM_CDF4(5294, 9761, 13607) },   { AOM_CDF4(4000, 7824, 11228) },
          { AOM_CDF4(2791, 5622, 8360) },    { AOM_CDF4(26785, 31160, 32121) },
          { AOM_CDF4(23446, 29584, 31448) }, { AOM_CDF4(17034, 25090, 28861) },
          { AOM_CDF4(12403, 20130, 24886) }, { AOM_CDF4(8751, 15931, 21085) },
          { AOM_CDF4(7466, 14343, 19381) },  { AOM_CDF4(5913, 11826, 16852) },
          { AOM_CDF4(27303, 31382, 32372) }, { AOM_CDF4(25214, 30299, 31896) },
          { AOM_CDF4(19974, 27444, 30312) }, { AOM_CDF4(14898, 23816, 28531) },
          { AOM_CDF4(13244, 21008, 26146) }, { AOM_CDF4(9800, 16231, 21131) },
          { AOM_CDF4(5825, 14564, 22574) } } },
      { { { AOM_CDF4(19824, 26769, 29633) }, { AOM_CDF4(14318, 22123, 26388) },
          { AOM_CDF4(9191, 15930, 20785) },  { AOM_CDF4(6340, 11669, 16089) },
          { AOM_CDF4(4837, 9183, 13077) },   { AOM_CDF4(3926, 7516, 10826) },
          { AOM_CDF4(2407, 4678, 6901) },    { AOM_CDF4(19222, 25868, 28639) },
          { AOM_CDF4(18803, 26174, 29339) }, { AOM_CDF4(14668, 22598, 26911) },
          { AOM_CDF4(10936, 18413, 23355) }, { AOM_CDF4(8583, 15221, 20165) },
          { AOM_CDF4(7162, 12989, 17651) },  { AOM_CDF4(4822, 8991, 12662) },
          { AOM_CDF4(24281, 29891, 31584) }, { AOM_CDF4(22036, 28688, 30979) },
          { AOM_CDF4(17718, 25632, 29223) }, { AOM_CDF4(13682, 21799, 26408) },
          { AOM_CDF4(11007, 18573, 23617) }, { AOM_CDF4(9243, 16175, 21194) },
          { AOM_CDF4(6586, 11964, 16450) } },
        { { AOM_CDF4(21626, 28357, 30686) }, { AOM_CDF4(17309, 24996, 28667) },
          { AOM_CDF4(12106, 19646, 24418) }, { AOM_CDF4(8266, 14574, 19463) },
          { AOM_CDF4(5834, 11110, 15490) },  { AOM_CDF4(4741, 8782, 12505) },
          { AOM_CDF4(2496, 5023, 7414) },    { AOM_CDF4(24489, 29865, 31642) },
          { AOM_CDF4(22535, 28972, 31088) }, { AOM_CDF4(17960, 25605, 29117) },
          { AOM_CDF4(13209, 20818, 25455) }, { AOM_CDF4(9452, 16267, 21446) },
          { AOM_CDF4(7879, 13949, 18424) },  { AOM_CDF4(4601, 9314, 13259) },
          { AOM_CDF4(27310, 31507, 32354) }, { AOM_CDF4(24572, 30311, 31923) },
          { AOM_CDF4(19737, 27121, 30208) }, { AOM_CDF4(14912, 22996, 27398) },
          { AOM_CDF4(10642, 18107, 23504) }, { AOM_CDF4(8967, 16529, 21115) },
          { AOM_CDF4(5815, 10725, 15879) } } },
      { { { AOM_CDF4(19446, 26244, 29170) }, { AOM_CDF4(13624, 21210, 25550) },
          { AOM_CDF4(8564, 14913, 19512) },  { AOM_CDF4(5753, 10616, 14682) },
          { AOM_CDF4(4376, 8219, 11758) },   { AOM_CDF4(3472, 6706, 9770) },
          { AOM_CDF4(1816, 3559, 5273) },    { AOM_CDF4(15208, 21164, 24265) },
          { AOM_CDF4(15310, 22010, 25376) }, { AOM_CDF4(12121, 19251, 23565) },
          { AOM_CDF4(9200, 15744, 20426) },  { AOM_CDF4(7164, 12910, 17457) },
          { AOM_CDF4(5887, 10909, 15099) },  { AOM_CDF4(3594, 6877, 9865) },
          { AOM_CDF4(24472, 29968, 31630) }, { AOM_CDF4(21650, 28336, 30762) },
          { AOM_CDF4(17489, 25239, 28823) }, { AOM_CDF4(13379, 21214, 25770) },
          { AOM_CDF4(10484, 17772, 22666) }, { AOM_CDF4(8627, 15144, 19965) },
          { AOM_CDF4(5610, 10356, 14297) } },
        { { AOM_CDF4(18209, 25227, 28508) }, { AOM_CDF4(12940, 20397, 24745) },
          { AOM_CDF4(8848, 15407, 20020) },  { AOM_CDF4(6429, 11755, 16117) },
          { AOM_CDF4(4945, 9125, 13280) },   { AOM_CDF4(4168, 8319, 11479) },
          { AOM_CDF4(2280, 4598, 6819) },    { AOM_CDF4(15779, 22491, 26012) },
          { AOM_CDF4(15743, 22252, 25307) }, { AOM_CDF4(13178, 20137, 23796) },
          { AOM_CDF4(11524, 18433, 22582) }, { AOM_CDF4(9506, 16754, 21219) },
          { AOM_CDF4(8346, 14316, 19481) },  { AOM_CDF4(5522, 10482, 14535) },
          { AOM_CDF4(26062, 30443, 31762) }, { AOM_CDF4(23918, 29827, 31684) },
          { AOM_CDF4(19904, 27552, 30371) }, { AOM_CDF4(16425, 24444, 28404) },
          { AOM_CDF4(12801, 20923, 25763) }, { AOM_CDF4(10299, 18149, 22839) },
          { AOM_CDF4(7671, 14162, 18497) } } },
      { { { AOM_CDF4(16132, 22581, 25439) }, { AOM_CDF4(14093, 21989, 26165) },
          { AOM_CDF4(9282, 16204, 21241) },  { AOM_CDF4(6356, 11963, 16569) },
          { AOM_CDF4(4855, 9225, 13198) },   { AOM_CDF4(3964, 7652, 11098) },
          { AOM_CDF4(1676, 3306, 4916) },    { AOM_CDF4(13987, 21346, 25456) },
          { AOM_CDF4(13011, 19383, 23079) }, { AOM_CDF4(10434, 16894, 20998) },
          { AOM_CDF4(8151, 14073, 18236) },  { AOM_CDF4(6334, 11446, 15504) },
          { AOM_CDF4(5228, 9692, 13425) },   { AOM_CDF4(2650, 5073, 7327) },
          { AOM_CDF4(22222, 28169, 30425) }, { AOM_CDF4(20054, 26842, 29638) },
          { AOM_CDF4(16386, 23919, 27668) }, { AOM_CDF4(12588, 20113, 24659) },
          { AOM_CDF4(10012, 16882, 21655) }, { AOM_CDF4(8221, 14389, 19113) },
          { AOM_CDF4(4538, 8487, 11875) } },
        { { AOM_CDF4(14923, 19792, 22889) }, { AOM_CDF4(16856, 24287, 27855) },
          { AOM_CDF4(11182, 18931, 23884) }, { AOM_CDF4(7831, 14151, 19043) },
          { AOM_CDF4(6057, 11559, 15611) },  { AOM_CDF4(4473, 8649, 12513) },
          { AOM_CDF4(2112, 4113, 6077) },    { AOM_CDF4(16213, 22241, 25803) },
          { AOM_CDF4(12685, 19080, 23050) }, { AOM_CDF4(9309, 15181, 19326) },
          { AOM_CDF4(7756, 12752, 16823) },  { AOM_CDF4(5822, 10570, 14684) },
          { AOM_CDF4(5356, 9612, 13784) },   { AOM_CDF4(3870, 7321, 10269) },
          { AOM_CDF4(22276, 28108, 29822) }, { AOM_CDF4(22047, 28015, 30443) },
          { AOM_CDF4(19370, 26555, 29588) }, { AOM_CDF4(15998, 24061, 28102) },
          { AOM_CDF4(13190, 21120, 25673) }, { AOM_CDF4(11227, 18466, 23737) },
          { AOM_CDF4(7662, 14179, 18938) } } },
#if CONFIG_TX64X64
