...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(288),   AOM_ICDF(3470),  AOM_ICDF(6899),  AOM_ICDF(13999),
  AOM_ICDF(19894), AOM_ICDF(21333), AOM_ICDF(24529), AOM_ICDF(25729),
  AOM_ICDF(26632), AOM_ICDF(27692), AOM_ICDF(30408), AOM_ICDF(31227),
  AOM_ICDF(31920), AOM_ICDF(32437), AOM_ICDF(32768), 0,
};
#endif
