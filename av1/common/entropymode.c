...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(17235), AOM_ICDF(17749), AOM_ICDF(18821), AOM_ICDF(19322),
        AOM_ICDF(19742), AOM_ICDF(20105), AOM_ICDF(20616), AOM_ICDF(21433),
        AOM_ICDF(21848), AOM_ICDF(24000), AOM_ICDF(25335), AOM_ICDF(26367),
        AOM_ICDF(28351), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5281), AOM_ICDF(16062), AOM_ICDF(16352), AOM_ICDF(16724),
        AOM_ICDF(17099), AOM_ICDF(18302), AOM_ICDF(18517), AOM_ICDF(18798),
        AOM_ICDF(19964), AOM_ICDF(22083), AOM_ICDF(23086), AOM_ICDF(24591),
        AOM_ICDF(27941), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6502), AOM_ICDF(6608), AOM_ICDF(16980), AOM_ICDF(17206),
        AOM_ICDF(17502), AOM_ICDF(17640), AOM_ICDF(18756), AOM_ICDF(20163),
        AOM_ICDF(20312), AOM_ICDF(22336), AOM_ICDF(23821), AOM_ICDF(24715),
        AOM_ICDF(28070), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6939), AOM_ICDF(7738), AOM_ICDF(8353), AOM_ICDF(14400),
        AOM_ICDF(15100), AOM_ICDF(15749), AOM_ICDF(16303), AOM_ICDF(18280),
        AOM_ICDF(20185), AOM_ICDF(22702), AOM_ICDF(24054), AOM_ICDF(25418),
        AOM_ICDF(26751), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3832), AOM_ICDF(4662), AOM_ICDF(5771), AOM_ICDF(6360),
        AOM_ICDF(17152), AOM_ICDF(19014), AOM_ICDF(21110), AOM_ICDF(21820),
        AOM_ICDF(22338), AOM_ICDF(24367), AOM_ICDF(25296), AOM_ICDF(26191),
        AOM_ICDF(26767), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3725), AOM_ICDF(5802), AOM_ICDF(6410), AOM_ICDF(6982),
        AOM_ICDF(9408), AOM_ICDF(19917), AOM_ICDF(20630), AOM_ICDF(21193),
        AOM_ICDF(21911), AOM_ICDF(24072), AOM_ICDF(25348), AOM_ICDF(26500),
        AOM_ICDF(27483), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4597), AOM_ICDF(5005), AOM_ICDF(7295), AOM_ICDF(7701),
        AOM_ICDF(9770), AOM_ICDF(10322), AOM_ICDF(20641), AOM_ICDF(21393),
        AOM_ICDF(21758), AOM_ICDF(24121), AOM_ICDF(25231), AOM_ICDF(26319),
        AOM_ICDF(27265), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7577), AOM_ICDF(7806), AOM_ICDF(9386), AOM_ICDF(10350),
        AOM_ICDF(10807), AOM_ICDF(11077), AOM_ICDF(11682), AOM_ICDF(19429),
        AOM_ICDF(19860), AOM_ICDF(22565), AOM_ICDF(24006), AOM_ICDF(25083),
        AOM_ICDF(26641), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5738), AOM_ICDF(7293), AOM_ICDF(7672), AOM_ICDF(9205),
        AOM_ICDF(9771), AOM_ICDF(10424), AOM_ICDF(10840), AOM_ICDF(11681),
        AOM_ICDF(19719), AOM_ICDF(22383), AOM_ICDF(23712), AOM_ICDF(25093),
        AOM_ICDF(26545), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11639), AOM_ICDF(12281), AOM_ICDF(13583), AOM_ICDF(14117),
        AOM_ICDF(14757), AOM_ICDF(15276), AOM_ICDF(16047), AOM_ICDF(17091),
        AOM_ICDF(17638), AOM_ICDF(21744), AOM_ICDF(23532), AOM_ICDF(25093),
        AOM_ICDF(27014), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9578), AOM_ICDF(10736), AOM_ICDF(11979), AOM_ICDF(12636),
        AOM_ICDF(13381), AOM_ICDF(14113), AOM_ICDF(14878), AOM_ICDF(16003),
        AOM_ICDF(16859), AOM_ICDF(20441), AOM_ICDF(23244), AOM_ICDF(24444),
        AOM_ICDF(26709), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10146), AOM_ICDF(10861), AOM_ICDF(12524), AOM_ICDF(13195),
        AOM_ICDF(13899), AOM_ICDF(14455), AOM_ICDF(15332), AOM_ICDF(16523),
        AOM_ICDF(17183), AOM_ICDF(20758), AOM_ICDF(22092), AOM_ICDF(24528),
        AOM_ICDF(26564), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4791), AOM_ICDF(7374), AOM_ICDF(10863), AOM_ICDF(11404),
        AOM_ICDF(11851), AOM_ICDF(12326), AOM_ICDF(12838), AOM_ICDF(13746),
        AOM_ICDF(14385), AOM_ICDF(16554), AOM_ICDF(18071), AOM_ICDF(19364),
        AOM_ICDF(28655), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(228),   AOM_ICDF(2940),  AOM_ICDF(6182),  AOM_ICDF(14448),
  AOM_ICDF(20936), AOM_ICDF(22324), AOM_ICDF(25414), AOM_ICDF(26531),
  AOM_ICDF(27338), AOM_ICDF(28330), AOM_ICDF(31084), AOM_ICDF(31580),
  AOM_ICDF(32092), AOM_ICDF(32530), AOM_ICDF(32768), 0
};
#endif
