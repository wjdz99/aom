...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(12803), AOM_ICDF(13596), AOM_ICDF(14638), AOM_ICDF(15706),
        AOM_ICDF(16246), AOM_ICDF(16876), AOM_ICDF(17490), AOM_ICDF(18527),
        AOM_ICDF(19135), AOM_ICDF(21048), AOM_ICDF(23797), AOM_ICDF(26158),
        AOM_ICDF(30818), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6862), AOM_ICDF(9796), AOM_ICDF(10775), AOM_ICDF(12142),
        AOM_ICDF(13040), AOM_ICDF(14583), AOM_ICDF(15390), AOM_ICDF(16380),
        AOM_ICDF(17797), AOM_ICDF(19725), AOM_ICDF(21788), AOM_ICDF(24893),
        AOM_ICDF(30661), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7507), AOM_ICDF(8220), AOM_ICDF(11306), AOM_ICDF(12211),
        AOM_ICDF(12920), AOM_ICDF(13564), AOM_ICDF(14699), AOM_ICDF(16547),
        AOM_ICDF(17199), AOM_ICDF(19083), AOM_ICDF(22477), AOM_ICDF(24360),
        AOM_ICDF(30633), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5407), AOM_ICDF(7229), AOM_ICDF(8965), AOM_ICDF(12231),
        AOM_ICDF(13800), AOM_ICDF(15422), AOM_ICDF(16963), AOM_ICDF(18960),
        AOM_ICDF(20949), AOM_ICDF(23020), AOM_ICDF(25301), AOM_ICDF(27649),
        AOM_ICDF(30338), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5458), AOM_ICDF(7155), AOM_ICDF(9043), AOM_ICDF(10798),
        AOM_ICDF(14276), AOM_ICDF(16270), AOM_ICDF(18495), AOM_ICDF(20267),
        AOM_ICDF(21729), AOM_ICDF(24010), AOM_ICDF(26351), AOM_ICDF(28683),
        AOM_ICDF(30782), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4922), AOM_ICDF(6894), AOM_ICDF(8613), AOM_ICDF(10410),
        AOM_ICDF(12570), AOM_ICDF(15975), AOM_ICDF(17659), AOM_ICDF(19356),
        AOM_ICDF(20980), AOM_ICDF(23222), AOM_ICDF(25523), AOM_ICDF(28103),
        AOM_ICDF(30673), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5639), AOM_ICDF(7121), AOM_ICDF(9299), AOM_ICDF(10882),
        AOM_ICDF(12701), AOM_ICDF(14162), AOM_ICDF(17521), AOM_ICDF(19228),
        AOM_ICDF(20581), AOM_ICDF(22869), AOM_ICDF(25629), AOM_ICDF(27949),
        AOM_ICDF(30704), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6487), AOM_ICDF(7815), AOM_ICDF(9621), AOM_ICDF(11413),
        AOM_ICDF(12655), AOM_ICDF(13864), AOM_ICDF(15197), AOM_ICDF(18574),
        AOM_ICDF(19863), AOM_ICDF(21888), AOM_ICDF(24675), AOM_ICDF(26849),
        AOM_ICDF(30233), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5653), AOM_ICDF(7517), AOM_ICDF(9059), AOM_ICDF(11375),
        AOM_ICDF(12792), AOM_ICDF(14298), AOM_ICDF(15686), AOM_ICDF(17288),
        AOM_ICDF(20367), AOM_ICDF(22427), AOM_ICDF(24668), AOM_ICDF(27231),
        AOM_ICDF(30286), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8840), AOM_ICDF(9802), AOM_ICDF(10989), AOM_ICDF(12214),
        AOM_ICDF(13063), AOM_ICDF(13939), AOM_ICDF(14844), AOM_ICDF(16106),
        AOM_ICDF(16989), AOM_ICDF(19701), AOM_ICDF(22917), AOM_ICDF(25840),
        AOM_ICDF(30101), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6711), AOM_ICDF(8170), AOM_ICDF(9762), AOM_ICDF(11336),
        AOM_ICDF(12643), AOM_ICDF(13974), AOM_ICDF(15347), AOM_ICDF(16988),
        AOM_ICDF(18330), AOM_ICDF(20727), AOM_ICDF(24211), AOM_ICDF(26535),
        AOM_ICDF(30259), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7010), AOM_ICDF(8394), AOM_ICDF(9967), AOM_ICDF(11546),
        AOM_ICDF(12852), AOM_ICDF(14160), AOM_ICDF(15484), AOM_ICDF(17085),
        AOM_ICDF(18403), AOM_ICDF(20805), AOM_ICDF(23324), AOM_ICDF(26591),
        AOM_ICDF(30264), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6351), AOM_ICDF(7992), AOM_ICDF(9761), AOM_ICDF(11198),
        AOM_ICDF(12378), AOM_ICDF(13641), AOM_ICDF(14861), AOM_ICDF(16386),
        AOM_ICDF(17692), AOM_ICDF(19658), AOM_ICDF(22224), AOM_ICDF(24605),
        AOM_ICDF(30814), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
