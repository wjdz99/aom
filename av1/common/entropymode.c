...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_ICDF(1930),  AOM_ICDF(2329),  AOM_ICDF(11079),
  AOM_ICDF(14021), AOM_ICDF(25542), AOM_ICDF(26290),
  AOM_ICDF(32500), AOM_ICDF(32768), 0
};
...
static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_JOINT_SIGNS][CFL_PRED_PLANES][CDF_SIZE(
        UV_ALPHABET_SIZE)] = {
      { { 0 },
        { AOM_ICDF(22139), AOM_ICDF(29601), AOM_ICDF(31493), AOM_ICDF(32163),
          AOM_ICDF(32632), AOM_ICDF(32733), AOM_ICDF(32754), AOM_ICDF(32758),
          AOM_ICDF(32761), AOM_ICDF(32762), AOM_ICDF(32763), AOM_ICDF(32764),
          AOM_ICDF(32765), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768),
          0 } },
      { { 0 },
        { AOM_ICDF(25627), AOM_ICDF(30924), AOM_ICDF(32020), AOM_ICDF(32400),
          AOM_ICDF(32578), AOM_ICDF(32640), AOM_ICDF(32670), AOM_ICDF(32716),
          AOM_ICDF(32722), AOM_ICDF(32739), AOM_ICDF(32748), AOM_ICDF(32755),
          AOM_ICDF(32759), AOM_ICDF(32760), AOM_ICDF(32765), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(14735), AOM_ICDF(27094), AOM_ICDF(31456), AOM_ICDF(32626),
          AOM_ICDF(32746), AOM_ICDF(32755), AOM_ICDF(32758), AOM_ICDF(32760),
          AOM_ICDF(32761), AOM_ICDF(32762), AOM_ICDF(32763), AOM_ICDF(32764),
          AOM_ICDF(32765), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768),
          0 },
        { 0 } },
      { { AOM_ICDF(11169), AOM_ICDF(22131), AOM_ICDF(29289), AOM_ICDF(32163),
          AOM_ICDF(32627), AOM_ICDF(32703), AOM_ICDF(32729), AOM_ICDF(32754),
          AOM_ICDF(32758), AOM_ICDF(32759), AOM_ICDF(32760), AOM_ICDF(32762),
          AOM_ICDF(32764), AOM_ICDF(32765), AOM_ICDF(32767), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(22454), AOM_ICDF(28608), AOM_ICDF(30541), AOM_ICDF(31643),
          AOM_ICDF(32412), AOM_ICDF(32628), AOM_ICDF(32685), AOM_ICDF(32732),
          AOM_ICDF(32742), AOM_ICDF(32749), AOM_ICDF(32755), AOM_ICDF(32758),
          AOM_ICDF(32760), AOM_ICDF(32764), AOM_ICDF(32765), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(11471), AOM_ICDF(23873), AOM_ICDF(29076), AOM_ICDF(31815),
          AOM_ICDF(32438), AOM_ICDF(32584), AOM_ICDF(32630), AOM_ICDF(32717),
          AOM_ICDF(32735), AOM_ICDF(32742), AOM_ICDF(32748), AOM_ICDF(32752),
          AOM_ICDF(32755), AOM_ICDF(32758), AOM_ICDF(32761), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(19717), AOM_ICDF(27377), AOM_ICDF(29991), AOM_ICDF(31307),
          AOM_ICDF(31835), AOM_ICDF(32121), AOM_ICDF(32242), AOM_ICDF(32492),
          AOM_ICDF(32547), AOM_ICDF(32584), AOM_ICDF(32609), AOM_ICDF(32650),
          AOM_ICDF(32666), AOM_ICDF(32679), AOM_ICDF(32698), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(23446), AOM_ICDF(30446), AOM_ICDF(31950), AOM_ICDF(32482),
          AOM_ICDF(32664), AOM_ICDF(32716), AOM_ICDF(32740), AOM_ICDF(32750),
          AOM_ICDF(32756), AOM_ICDF(32760), AOM_ICDF(32761), AOM_ICDF(32764),
          AOM_ICDF(32765), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768),
          0 },
        { 0 } },
      { { AOM_ICDF(18757), AOM_ICDF(27083), AOM_ICDF(29993), AOM_ICDF(31349),
          AOM_ICDF(31888), AOM_ICDF(32185), AOM_ICDF(32307), AOM_ICDF(32515),
          AOM_ICDF(32576), AOM_ICDF(32611), AOM_ICDF(32639), AOM_ICDF(32672),
          AOM_ICDF(32687), AOM_ICDF(32698), AOM_ICDF(32713), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(15529), AOM_ICDF(25432), AOM_ICDF(28854), AOM_ICDF(30986),
          AOM_ICDF(32226), AOM_ICDF(32515), AOM_ICDF(32587), AOM_ICDF(32680),
          AOM_ICDF(32699), AOM_ICDF(32719), AOM_ICDF(32728), AOM_ICDF(32737),
          AOM_ICDF(32742), AOM_ICDF(32745), AOM_ICDF(32751), AOM_ICDF(32768),
          0 } },
      { { AOM_ICDF(13526), AOM_ICDF(22796), AOM_ICDF(27173), AOM_ICDF(29355),
          AOM_ICDF(30454), AOM_ICDF(31115), AOM_ICDF(31339), AOM_ICDF(31716),
          AOM_ICDF(31874), AOM_ICDF(31965), AOM_ICDF(32056), AOM_ICDF(32179),
          AOM_ICDF(32234), AOM_ICDF(32278), AOM_ICDF(32409), AOM_ICDF(32768),
          0 },
        { AOM_ICDF(19590), AOM_ICDF(26222), AOM_ICDF(28764), AOM_ICDF(30271),
          AOM_ICDF(31121), AOM_ICDF(31619), AOM_ICDF(31865), AOM_ICDF(32168),
          AOM_ICDF(32243), AOM_ICDF(32301), AOM_ICDF(32358), AOM_ICDF(32447),
          AOM_ICDF(32502), AOM_ICDF(32563), AOM_ICDF(32650), AOM_ICDF(32768),
          0 } }
    };
#endif
