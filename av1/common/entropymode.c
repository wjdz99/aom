...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(18883), AOM_ICDF(19295), AOM_ICDF(20179), AOM_ICDF(20587),
        AOM_ICDF(20959), AOM_ICDF(21281), AOM_ICDF(21731), AOM_ICDF(22464),
        AOM_ICDF(22853), AOM_ICDF(24859), AOM_ICDF(25973), AOM_ICDF(26799),
        AOM_ICDF(28425), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5406), AOM_ICDF(17171), AOM_ICDF(17346), AOM_ICDF(17614),
        AOM_ICDF(17929), AOM_ICDF(18968), AOM_ICDF(19152), AOM_ICDF(19406),
        AOM_ICDF(20435), AOM_ICDF(22522), AOM_ICDF(23274), AOM_ICDF(24746),
        AOM_ICDF(27929), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6729), AOM_ICDF(6813), AOM_ICDF(18211), AOM_ICDF(18385),
        AOM_ICDF(18637), AOM_ICDF(18755), AOM_ICDF(19758), AOM_ICDF(20930),
        AOM_ICDF(21068), AOM_ICDF(22995), AOM_ICDF(24344), AOM_ICDF(24985),
        AOM_ICDF(28123), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7783), AOM_ICDF(8301), AOM_ICDF(8636), AOM_ICDF(15344),
        AOM_ICDF(15853), AOM_ICDF(16297), AOM_ICDF(16653), AOM_ICDF(18689),
        AOM_ICDF(20476), AOM_ICDF(23166), AOM_ICDF(24228), AOM_ICDF(25346),
        AOM_ICDF(26500), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3593), AOM_ICDF(4247), AOM_ICDF(5148), AOM_ICDF(5576),
        AOM_ICDF(18220), AOM_ICDF(19959), AOM_ICDF(21900), AOM_ICDF(22448),
        AOM_ICDF(22829), AOM_ICDF(24794), AOM_ICDF(25494), AOM_ICDF(26154),
        AOM_ICDF(26539), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3689), AOM_ICDF(5575), AOM_ICDF(5945), AOM_ICDF(6290),
        AOM_ICDF(8645), AOM_ICDF(21072), AOM_ICDF(21596), AOM_ICDF(21960),
        AOM_ICDF(22454), AOM_ICDF(24536), AOM_ICDF(25515), AOM_ICDF(26417),
        AOM_ICDF(27163), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4706), AOM_ICDF(4944), AOM_ICDF(7034), AOM_ICDF(7304),
        AOM_ICDF(9272), AOM_ICDF(9684), AOM_ICDF(21501), AOM_ICDF(22041),
        AOM_ICDF(22284), AOM_ICDF(24698), AOM_ICDF(25593), AOM_ICDF(26406),
        AOM_ICDF(27105), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7070), AOM_ICDF(7214), AOM_ICDF(8459), AOM_ICDF(9329),
        AOM_ICDF(9688), AOM_ICDF(9881), AOM_ICDF(10356), AOM_ICDF(19984),
        AOM_ICDF(20330), AOM_ICDF(23230), AOM_ICDF(24458), AOM_ICDF(25248),
        AOM_ICDF(26656), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6034), AOM_ICDF(7329), AOM_ICDF(7551), AOM_ICDF(8822),
        AOM_ICDF(9262), AOM_ICDF(9760), AOM_ICDF(10056), AOM_ICDF(10807),
        AOM_ICDF(19960), AOM_ICDF(22865), AOM_ICDF(23919), AOM_ICDF(25139),
        AOM_ICDF(26465), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12409), AOM_ICDF(12911), AOM_ICDF(14021), AOM_ICDF(14459),
        AOM_ICDF(15012), AOM_ICDF(15463), AOM_ICDF(16149), AOM_ICDF(17088),
        AOM_ICDF(17586), AOM_ICDF(22281), AOM_ICDF(23828), AOM_ICDF(25147),
        AOM_ICDF(27109), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10571), AOM_ICDF(11541), AOM_ICDF(12550), AOM_ICDF(13041),
        AOM_ICDF(13658), AOM_ICDF(14256), AOM_ICDF(14891), AOM_ICDF(15838),
        AOM_ICDF(16582), AOM_ICDF(20532), AOM_ICDF(23383), AOM_ICDF(24302),
        AOM_ICDF(26619), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11165), AOM_ICDF(11711), AOM_ICDF(13145), AOM_ICDF(13661),
        AOM_ICDF(14229), AOM_ICDF(14687), AOM_ICDF(15439), AOM_ICDF(16478),
        AOM_ICDF(17047), AOM_ICDF(20999), AOM_ICDF(22044), AOM_ICDF(24496),
        AOM_ICDF(26553), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3567), AOM_ICDF(5961), AOM_ICDF(9248), AOM_ICDF(9633),
        AOM_ICDF(9967), AOM_ICDF(10306), AOM_ICDF(10658), AOM_ICDF(11358),
        AOM_ICDF(11847), AOM_ICDF(13814), AOM_ICDF(15097), AOM_ICDF(16143),
        AOM_ICDF(28614), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
