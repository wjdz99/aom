...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(24780), AOM_ICDF(24934), AOM_ICDF(25204), AOM_ICDF(25541),
        AOM_ICDF(25666), AOM_ICDF(25806), AOM_ICDF(25952), AOM_ICDF(26221),
        AOM_ICDF(26349), AOM_ICDF(26785), AOM_ICDF(27697), AOM_ICDF(28348),
        AOM_ICDF(31569), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12739), AOM_ICDF(15333), AOM_ICDF(15608), AOM_ICDF(16193),
        AOM_ICDF(16499), AOM_ICDF(17301), AOM_ICDF(17546), AOM_ICDF(17880),
        AOM_ICDF(18600), AOM_ICDF(19414), AOM_ICDF(20325), AOM_ICDF(22553),
        AOM_ICDF(31040), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13415), AOM_ICDF(13583), AOM_ICDF(16276), AOM_ICDF(16554),
        AOM_ICDF(16754), AOM_ICDF(16922), AOM_ICDF(17394), AOM_ICDF(18336),
        AOM_ICDF(18499), AOM_ICDF(19166), AOM_ICDF(21551), AOM_ICDF(22223),
        AOM_ICDF(31042), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10291), AOM_ICDF(11427), AOM_ICDF(12462), AOM_ICDF(16609),
        AOM_ICDF(17594), AOM_ICDF(18639), AOM_ICDF(19594), AOM_ICDF(21184),
        AOM_ICDF(22652), AOM_ICDF(24111), AOM_ICDF(25815), AOM_ICDF(27677),
        AOM_ICDF(30404), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11763), AOM_ICDF(12670), AOM_ICDF(13794), AOM_ICDF(14979),
        AOM_ICDF(19517), AOM_ICDF(20969), AOM_ICDF(22768), AOM_ICDF(23815),
        AOM_ICDF(24601), AOM_ICDF(26133), AOM_ICDF(27810), AOM_ICDF(29467),
        AOM_ICDF(31105), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9575), AOM_ICDF(10914), AOM_ICDF(11991), AOM_ICDF(13253),
        AOM_ICDF(15015), AOM_ICDF(19516), AOM_ICDF(20611), AOM_ICDF(21681),
        AOM_ICDF(22716), AOM_ICDF(24322), AOM_ICDF(26052), AOM_ICDF(28385),
        AOM_ICDF(30933), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11565), AOM_ICDF(12332), AOM_ICDF(13849), AOM_ICDF(14814),
        AOM_ICDF(16085), AOM_ICDF(16916), AOM_ICDF(21238), AOM_ICDF(22247),
        AOM_ICDF(22969), AOM_ICDF(24478), AOM_ICDF(26803), AOM_ICDF(28384),
        AOM_ICDF(31035), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12671), AOM_ICDF(13281), AOM_ICDF(14224), AOM_ICDF(15450),
        AOM_ICDF(16049), AOM_ICDF(16625), AOM_ICDF(17295), AOM_ICDF(21359),
        AOM_ICDF(21999), AOM_ICDF(23171), AOM_ICDF(25339), AOM_ICDF(26646),
        AOM_ICDF(30309), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10922), AOM_ICDF(12069), AOM_ICDF(12887), AOM_ICDF(14820),
        AOM_ICDF(15609), AOM_ICDF(16494), AOM_ICDF(17255), AOM_ICDF(18270),
        AOM_ICDF(22101), AOM_ICDF(23436), AOM_ICDF(24971), AOM_ICDF(27005),
        AOM_ICDF(30357), AOM_ICDF(32768), 0 },
      { AOM_ICDF(18256), AOM_ICDF(18541), AOM_ICDF(18899), AOM_ICDF(19432),
        AOM_ICDF(19716), AOM_ICDF(20011), AOM_ICDF(20323), AOM_ICDF(20863),
        AOM_ICDF(21160), AOM_ICDF(22580), AOM_ICDF(24627), AOM_ICDF(26232),
        AOM_ICDF(30429), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13378), AOM_ICDF(14113), AOM_ICDF(14953), AOM_ICDF(15929),
        AOM_ICDF(16605), AOM_ICDF(17294), AOM_ICDF(18029), AOM_ICDF(19046),
        AOM_ICDF(19757), AOM_ICDF(21300), AOM_ICDF(24733), AOM_ICDF(26202),
        AOM_ICDF(30411), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14335), AOM_ICDF(15009), AOM_ICDF(15761), AOM_ICDF(16695),
        AOM_ICDF(17352), AOM_ICDF(18027), AOM_ICDF(18705), AOM_ICDF(19667),
        AOM_ICDF(20343), AOM_ICDF(21820), AOM_ICDF(23500), AOM_ICDF(26396),
        AOM_ICDF(30399), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11142), AOM_ICDF(12100), AOM_ICDF(13161), AOM_ICDF(13914),
        AOM_ICDF(14450), AOM_ICDF(15053), AOM_ICDF(15632), AOM_ICDF(16445),
        AOM_ICDF(17092), AOM_ICDF(18145), AOM_ICDF(19867), AOM_ICDF(21354),
