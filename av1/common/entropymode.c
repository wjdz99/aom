...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_CDF8(2153, 2488, 13256, 15637, 25975, 26734, 32507)
};

static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_ALPHA_CONTEXTS][CDF_SIZE(CFL_ALPHABET_SIZE)] = {
      { AOM_CDF16(19571, 29475, 32282, 32685, 32746, 32753, 32756, 32758, 32759,
                  32761, 32762, 32763, 32765, 32766, 32767) },
      { AOM_CDF16(18327, 26421, 30270, 32061, 32607, 32704, 32731, 32748, 32753,
                  32756, 32759, 32761, 32763, 32764, 32766) },
      { AOM_CDF16(15220, 25505, 29288, 31826, 32496, 32619, 32668, 32719, 32733,
                  32740, 32746, 32750, 32754, 32758, 32761) },
      { AOM_CDF16(25839, 31244, 32278, 32572, 32669, 32713, 32739, 32745, 32749,
                  32754, 32756, 32759, 32761, 32765, 32766) },
      { AOM_CDF16(21399, 28236, 30441, 31563, 31986, 32265, 32371, 32539, 32573,
                  32607, 32630, 32675, 32686, 32699, 32712) },
      { AOM_CDF16(18513, 25941, 28960, 30394, 31240, 31688, 31911, 32120, 32215,
                  32295, 32373, 32470, 32502, 32562, 32651) }
    };
#endif
