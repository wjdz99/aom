...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_CDF8(2131, 2470, 13071, 15477, 25934, 26700, 32507)
};

static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_ALPHA_CONTEXTS][CDF_SIZE(CFL_ALPHABET_SIZE)] = {
      { AOM_CDF16(18997, 29321, 32229, 32680, 32746, 32754, 32757, 32758, 32760,
                  32761, 32762, 32764, 32765, 32766, 32767) },
      { AOM_CDF16(18188, 26442, 30328, 32074, 32606, 32704, 32730, 32748, 32752,
                  32756, 32759, 32761, 32763, 32765, 32766) },
      { AOM_CDF16(15096, 25505, 29331, 31813, 32487, 32618, 32666, 32719, 32733,
                  32740, 32746, 32751, 32754, 32757, 32760) },
      { AOM_CDF16(25777, 31215, 32265, 32559, 32671, 32713, 32737, 32743, 32747,
                  32753, 32755, 32758, 32761, 32764, 32765) },
      { AOM_CDF16(21294, 28198, 30445, 31559, 31982, 32260, 32365, 32535, 32574,
                  32608, 32631, 32673, 32685, 32697, 32711) },
      { AOM_CDF16(18330, 25848, 28906, 30378, 31228, 31666, 31863, 32111, 32208,
                  32281, 32359, 32448, 32482, 32540, 32647) }
    };
#endif
