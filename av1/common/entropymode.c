...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(9602), AOM_ICDF(10871), AOM_ICDF(12785), AOM_ICDF(13992),
        AOM_ICDF(14988), AOM_ICDF(15924), AOM_ICDF(17066), AOM_ICDF(18600),
        AOM_ICDF(19575), AOM_ICDF(22249), AOM_ICDF(24344), AOM_ICDF(26256),
        AOM_ICDF(28357), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4753), AOM_ICDF(10976), AOM_ICDF(11946), AOM_ICDF(13025),
        AOM_ICDF(13935), AOM_ICDF(15790), AOM_ICDF(16474), AOM_ICDF(17287),
        AOM_ICDF(19123), AOM_ICDF(21637), AOM_ICDF(23428), AOM_ICDF(25360),
        AOM_ICDF(28501), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5305), AOM_ICDF(5878), AOM_ICDF(12213), AOM_ICDF(12925),
        AOM_ICDF(13724), AOM_ICDF(14249), AOM_ICDF(16040), AOM_ICDF(18299),
        AOM_ICDF(18827), AOM_ICDF(21395), AOM_ICDF(23417), AOM_ICDF(25220),
        AOM_ICDF(28445), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4541), AOM_ICDF(6299), AOM_ICDF(7879), AOM_ICDF(11876),
        AOM_ICDF(13310), AOM_ICDF(14695), AOM_ICDF(16006), AOM_ICDF(18046),
        AOM_ICDF(20223), AOM_ICDF(22699), AOM_ICDF(24575), AOM_ICDF(26460),
        AOM_ICDF(28286), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3999), AOM_ICDF(5543), AOM_ICDF(7318), AOM_ICDF(8581),
        AOM_ICDF(14076), AOM_ICDF(16226), AOM_ICDF(18612), AOM_ICDF(20043),
        AOM_ICDF(21257), AOM_ICDF(23589), AOM_ICDF(25242), AOM_ICDF(26868),
        AOM_ICDF(28176), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3580), AOM_ICDF(5983), AOM_ICDF(7412), AOM_ICDF(8768),
        AOM_ICDF(11280), AOM_ICDF(16828), AOM_ICDF(18253), AOM_ICDF(19572),
        AOM_ICDF(21040), AOM_ICDF(23394), AOM_ICDF(25268), AOM_ICDF(27030),
        AOM_ICDF(28648), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4119), AOM_ICDF(5313), AOM_ICDF(7918), AOM_ICDF(9047),
        AOM_ICDF(11422), AOM_ICDF(12660), AOM_ICDF(18234), AOM_ICDF(19764),
        AOM_ICDF(20827), AOM_ICDF(23277), AOM_ICDF(25044), AOM_ICDF(26839),
        AOM_ICDF(28430), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5182), AOM_ICDF(6147), AOM_ICDF(8647), AOM_ICDF(10131),
        AOM_ICDF(11241), AOM_ICDF(12091), AOM_ICDF(13396), AOM_ICDF(18377),
        AOM_ICDF(19386), AOM_ICDF(22045), AOM_ICDF(23988), AOM_ICDF(25796),
        AOM_ICDF(27782), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4542), AOM_ICDF(6790), AOM_ICDF(8045), AOM_ICDF(10160),
        AOM_ICDF(11398), AOM_ICDF(12766), AOM_ICDF(13832), AOM_ICDF(15186),
        AOM_ICDF(19782), AOM_ICDF(22329), AOM_ICDF(24237), AOM_ICDF(26105),
        AOM_ICDF(27982), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6904), AOM_ICDF(8262), AOM_ICDF(10283), AOM_ICDF(11471),
        AOM_ICDF(12704), AOM_ICDF(13797), AOM_ICDF(15173), AOM_ICDF(16852),
        AOM_ICDF(17947), AOM_ICDF(21243), AOM_ICDF(23492), AOM_ICDF(25631),
        AOM_ICDF(27760), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5756), AOM_ICDF(7553), AOM_ICDF(9469), AOM_ICDF(10822),
        AOM_ICDF(12207), AOM_ICDF(13564), AOM_ICDF(14975), AOM_ICDF(16689),
        AOM_ICDF(18132), AOM_ICDF(21185), AOM_ICDF(23792), AOM_ICDF(25686),
        AOM_ICDF(27923), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6014), AOM_ICDF(7453), AOM_ICDF(9640), AOM_ICDF(10990),
        AOM_ICDF(12343), AOM_ICDF(13546), AOM_ICDF(15049), AOM_ICDF(16863),
        AOM_ICDF(18131), AOM_ICDF(21149), AOM_ICDF(23124), AOM_ICDF(25613),
        AOM_ICDF(27780), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4559), AOM_ICDF(7316), AOM_ICDF(10642), AOM_ICDF(11896),
        AOM_ICDF(13023), AOM_ICDF(14198), AOM_ICDF(15427), AOM_ICDF(17074),
        AOM_ICDF(18399), AOM_ICDF(20932), AOM_ICDF(22985), AOM_ICDF(24901),
        AOM_ICDF(29158), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(288),   AOM_ICDF(3830),  AOM_ICDF(7486),  AOM_ICDF(13724),
  AOM_ICDF(19973), AOM_ICDF(21587), AOM_ICDF(24169), AOM_ICDF(25470),
  AOM_ICDF(26502), AOM_ICDF(27671), AOM_ICDF(30375), AOM_ICDF(31191),
  AOM_ICDF(31862), AOM_ICDF(32391), AOM_ICDF(32768), 0,
};
#endif
