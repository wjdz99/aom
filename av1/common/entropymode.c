...
static const aom_prob default_inter_compound_mode_probs
    [INTER_MODE_CONTEXTS][INTER_COMPOUND_MODES - 1] = {
      { 2, 173, 68, 192, 64, 192, 128 },   // 0 = both zero mv
      { 7, 145, 160, 192, 64, 192, 128 },  // 1 = 1 zero + 1 predicted
      { 7, 166, 126, 192, 64, 192, 128 },  // 2 = two predicted mvs
      { 7, 94, 132, 192, 64, 192, 128 },   // 3 = 1 pred/zero, 1 new
      { 8, 64, 64, 192, 64, 192, 128 },    // 4 = two new mvs
      { 17, 81, 52, 192, 64, 192, 128 },   // 5 = one intra neighbour
      { 25, 29, 50, 192, 64, 192, 128 },   // 6 = two intra neighbours
    };
