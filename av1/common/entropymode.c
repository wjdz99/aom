...
#elif CONFIG_EXT_REFS && CONFIG_TRIPRED
static const aom_prob
    default_compound_type_probs[BLOCK_SIZES][COMPOUND_TYPES - 1] = {
      { 208, 136 }, { 208, 136 }, { 208, 136 }, { 208, 136 }, { 208, 136 },
      { 208, 136 }, { 216, 144 }, { 216, 144 }, { 216, 144 }, { 224, 152 },
      { 224, 152 }, { 240, 160 }, { 240, 160 },
#if CONFIG_EXT_PARTITION
      { 255, 176 }, { 255, 176 }, { 255, 176 },
#endif  // CONFIG_EXT_PARTITION
    };
#endif  // CONFIG_EXT_INTER
...
/* clang-format off */
const aom_tree_index av1_compound_type_tree[TREE_SIZE(COMPOUND_TYPES)] = {
  -COMPOUND_AVERAGE, 2, -COMPOUND_WEDGE, -COMPOUND_TRIPRED
};
/* clang-format on */
#endif  // CONFIG_EXT_INTER
