...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(3229),  AOM_ICDF(6771),  AOM_ICDF(9935),  AOM_ICDF(12060),
  AOM_ICDF(15269), AOM_ICDF(17437), AOM_ICDF(18898), AOM_ICDF(20944),
  AOM_ICDF(22945), AOM_ICDF(24799), AOM_ICDF(26874), AOM_ICDF(28516),
  AOM_ICDF(30026), AOM_ICDF(31402), AOM_ICDF(32768), 0
};
#endif
