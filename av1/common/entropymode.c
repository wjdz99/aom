...
static const aom_cdf_prob
    default_partition_rec_cdf[PARTITION_CONTEXTS_REC]
                             [CDF_SIZE(PARTITION_TYPES_REC)] = {
                               ...
                               // 32x16, 16x32
                               { AOM_CDF5(13648, 24298, 31008, 31888) },
                               { AOM_CDF5(6941, 18823, 31326, 32047) },
                               { AOM_CDF5(8081, 19947, 30935, 31851) },
                               { AOM_CDF5(4728, 17352, 30577, 31672) },
                               // 64x32, 32x64
                               { AOM_CDF5(14004, 23614, 30662, 31715) },
                               { AOM_CDF5(5530, 18449, 30965, 31866) },
                               { AOM_CDF5(6144, 19185, 31435, 32101) },
                               { AOM_CDF5(7382, 19434, 30389, 31578) },
...
#if CONFIG_FLEX_PARTITION
                               // 16x4, 4x16
                               { AOM_CDF3(19986, 29676) },
                               { AOM_CDF3(12672, 24996) },
                               { AOM_CDF3(16895, 30097) },
...
static const aom_cdf_prob
    default_inter_compound_mode_cdf[INTER_MODE_CONTEXTS][CDF_SIZE(
      ...
      { AOM_CDF6(13823, 17323, 20666, 26891, 28891) },
      { AOM_CDF6(19452, 22435, 25131, 28724, 30724) },
      { AOM_CDF6(20221, 22977, 25387, 28436, 30436) },
      { AOM_CDF6(16984, 21356, 25736, 26422, 28422) },
      { AOM_CDF6(23325, 25708, 28258, 30758, 31758) },
      { AOM_CDF6(17454, 21499, 25168, 26046, 28046) },
      { AOM_CDF6(24273, 26536, 28704, 30592, 31592) },
      { AOM_CDF6(23214, 25998, 28442, 29330, 31330) }
    };
#else
static const aom_cdf_prob
    default_inter_compound_mode_cdf[INTER_MODE_CONTEXTS][CDF_SIZE(
