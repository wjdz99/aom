...
static const aom_prob
    default_single_ref0_probs[REF0_CONTEXTS][INTER_REFS_PER_FRAME - 1] = {
...
av1_single_or_comp_ref0_tree[TREE_SIZE(INTER_REFS_PER_FRAME)] = {
  -INTER_REF_OFFSET(LAST_FRAME), 2,
  4, 8,
  -INTER_REF_OFFSET(LAST2_FRAME), 6,
  -INTER_REF_OFFSET(LAST3_FRAME), -INTER_REF_OFFSET(GOLDEN_FRAME),
  -INTER_REF_OFFSET(BWDREF_FRAME), -INTER_REF_OFFSET(ALTREF_FRAME)
};

const aom_tree_index
av1_comp_last_ref1_tree[TREE_SIZE(INTER_REFS_PER_FRAME - 1)] = {
  -INTER_REF_OFFSET(LAST2_FRAME), 2,
  4, 6,
  -INTER_REF_OFFSET(LAST3_FRAME), -INTER_REF_OFFSET(GOLDEN_FRAME),
  -INTER_REF_OFFSET(BWDREF_FRAME), -INTER_REF_OFFSET(ALTREF_FRAME)
};
...
av1_comp_last2_ref1_tree[TREE_SIZE(INTER_REFS_PER_FRAME - 2)] = {
  -INTER_REF_OFFSET(LAST3_FRAME), 2,
  -INTER_REF_OFFSET(GOLDEN_FRAME), 4,
  -INTER_REF_OFFSET(BWDREF_FRAME), -INTER_REF_OFFSET(ALTREF_FRAME)
};

const aom_tree_index
av1_comp_last3_ref1_tree[TREE_SIZE(INTER_REFS_PER_FRAME - 3)] = {
  -INTER_REF_OFFSET(GOLDEN_FRAME), 2,
  -INTER_REF_OFFSET(BWDREF_FRAME), -INTER_REF_OFFSET(ALTREF_FRAME)
};
...
#endif  // CONFIG_EXT_REFS
#if CONFIG_EXT_COMP_REFS
  av1_copy(fc->single_ref0_probs, default_single_ref0_probs);
#else
...
void av1_adapt_inter_frame_probs(AV1_COMMON *cm) {
  ...
  for (i = 0; i < REF0_CONTEXTS; i++) {
    aom_tree_merge_probs(av1_single_or_comp_ref0_tree,
                         pre_fc->single_ref0_probs[i], counts->single_ref0[i],
                         fc->single_ref0_probs[i]);
  }
#else
  for (i = 0; i < REF_CONTEXTS; i++)
