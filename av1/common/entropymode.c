...
const aom_tree_index av1_interintra_mode_tree[TREE_SIZE(INTERINTRA_MODES)] = {
  -II_DC_PRED,   2,            /* 0 = DC_NODE */
  -II_TM_PRED,   4,            /* 1 = TM_NODE */
  -II_V_PRED,    6,            /* 2 = V_NODE */
  8,          12,           /* 3 = COM_NODE */
  -II_H_PRED,    10,           /* 4 = H_NODE */
  -II_D135_PRED, -II_D117_PRED,   /* 5 = D135_NODE */
  -II_D45_PRED,  14,           /* 6 = D45_NODE */
  -II_D63_PRED,  16,           /* 7 = D63_NODE */
  -II_D153_PRED, 18,           /* 8 = D153_NODE */
  -II_D207_PRED, -II_SMOOTH_PRED, /* 9 = D207_NODE */
};
#else
const aom_tree_index av1_interintra_mode_tree[TREE_SIZE(INTERINTRA_MODES)] = {
