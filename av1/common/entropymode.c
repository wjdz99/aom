...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(22248), AOM_ICDF(22503), AOM_ICDF(23071), AOM_ICDF(23366),
        AOM_ICDF(23586), AOM_ICDF(23789), AOM_ICDF(24066), AOM_ICDF(24548),
        AOM_ICDF(24794), AOM_ICDF(26194), AOM_ICDF(27023), AOM_ICDF(27556),
        AOM_ICDF(29149), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6355), AOM_ICDF(18641), AOM_ICDF(18748), AOM_ICDF(18943),
        AOM_ICDF(19164), AOM_ICDF(19956), AOM_ICDF(20074), AOM_ICDF(20235),
        AOM_ICDF(21027), AOM_ICDF(22732), AOM_ICDF(23290), AOM_ICDF(24616),
        AOM_ICDF(28391), AOM_ICDF(32768), 0 },
      { AOM_ICDF(7973), AOM_ICDF(8030), AOM_ICDF(19768), AOM_ICDF(19893),
        AOM_ICDF(20051), AOM_ICDF(20130), AOM_ICDF(20846), AOM_ICDF(21704),
        AOM_ICDF(21793), AOM_ICDF(23251), AOM_ICDF(24428), AOM_ICDF(24858),
        AOM_ICDF(28602), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8825), AOM_ICDF(9240), AOM_ICDF(9508), AOM_ICDF(16652),
        AOM_ICDF(17060), AOM_ICDF(17429), AOM_ICDF(17721), AOM_ICDF(19648),
        AOM_ICDF(21209), AOM_ICDF(23684), AOM_ICDF(24610), AOM_ICDF(25616),
        AOM_ICDF(26740), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4002), AOM_ICDF(4542), AOM_ICDF(5328), AOM_ICDF(5689),
        AOM_ICDF(20021), AOM_ICDF(21531), AOM_ICDF(23249), AOM_ICDF(23696),
        AOM_ICDF(24003), AOM_ICDF(25759), AOM_ICDF(26326), AOM_ICDF(26858),
        AOM_ICDF(27183), AOM_ICDF(32768), 0 },
      { AOM_ICDF(4209), AOM_ICDF(5794), AOM_ICDF(6115), AOM_ICDF(6428),
        AOM_ICDF(8509), AOM_ICDF(22067), AOM_ICDF(22518), AOM_ICDF(22830),
        AOM_ICDF(23247), AOM_ICDF(25220), AOM_ICDF(26058), AOM_ICDF(26866),
        AOM_ICDF(27594), AOM_ICDF(32768), 0 },
      { AOM_ICDF(5486), AOM_ICDF(5671), AOM_ICDF(7426), AOM_ICDF(7657),
        AOM_ICDF(9268), AOM_ICDF(9608), AOM_ICDF(22719), AOM_ICDF(23129),
        AOM_ICDF(23322), AOM_ICDF(25544), AOM_ICDF(26304), AOM_ICDF(26955),
        AOM_ICDF(27616), AOM_ICDF(32768), 0 },
      { AOM_ICDF(8258), AOM_ICDF(8358), AOM_ICDF(9240), AOM_ICDF(10049),
        AOM_ICDF(10303), AOM_ICDF(10448), AOM_ICDF(10784), AOM_ICDF(21079),
        AOM_ICDF(21336), AOM_ICDF(23872), AOM_ICDF(24941), AOM_ICDF(25534),
        AOM_ICDF(26928), AOM_ICDF(32768), 0 },
      { AOM_ICDF(6926), AOM_ICDF(7935), AOM_ICDF(8092), AOM_ICDF(9255),
        AOM_ICDF(9584), AOM_ICDF(9968), AOM_ICDF(10204), AOM_ICDF(10827),
        AOM_ICDF(20749), AOM_ICDF(23457), AOM_ICDF(24324), AOM_ICDF(25402),
        AOM_ICDF(26670), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15200), AOM_ICDF(15554), AOM_ICDF(16332), AOM_ICDF(16679),
        AOM_ICDF(17054), AOM_ICDF(17378), AOM_ICDF(17843), AOM_ICDF(18529),
        AOM_ICDF(18894), AOM_ICDF(23267), AOM_ICDF(24473), AOM_ICDF(25498),
        AOM_ICDF(27556), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12452), AOM_ICDF(13191), AOM_ICDF(14014), AOM_ICDF(14442),
        AOM_ICDF(14920), AOM_ICDF(15385), AOM_ICDF(15885), AOM_ICDF(16652),
        AOM_ICDF(17238), AOM_ICDF(20831), AOM_ICDF(23688), AOM_ICDF(24427),
        AOM_ICDF(26939), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13455), AOM_ICDF(13867), AOM_ICDF(14952), AOM_ICDF(15392),
        AOM_ICDF(15839), AOM_ICDF(16198), AOM_ICDF(16764), AOM_ICDF(17579),
        AOM_ICDF(18017), AOM_ICDF(21596), AOM_ICDF(22444), AOM_ICDF(24711),
        AOM_ICDF(26863), AOM_ICDF(32768), 0 },
      { AOM_ICDF(3276), AOM_ICDF(5187), AOM_ICDF(7889), AOM_ICDF(8200),
        AOM_ICDF(8441), AOM_ICDF(8694), AOM_ICDF(8963), AOM_ICDF(9490),
        AOM_ICDF(9860), AOM_ICDF(11455), AOM_ICDF(12531), AOM_ICDF(13418),
        AOM_ICDF(29044), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
