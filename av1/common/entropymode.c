...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(257),   AOM_ICDF(4327),  AOM_ICDF(8420),  AOM_ICDF(13316),
  AOM_ICDF(20784), AOM_ICDF(22802), AOM_ICDF(24472), AOM_ICDF(25869),
  AOM_ICDF(26989), AOM_ICDF(28297), AOM_ICDF(30838), AOM_ICDF(31469),
  AOM_ICDF(31943), AOM_ICDF(32392), AOM_ICDF(32768)
};
#endif
