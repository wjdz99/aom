...
void av1_cfl_subtract_sse2(int16_t *pred_buf_q3, int width, int height,
                           int16_t avg_q3) {
  const __m128i _8_averages = _mm_set1_epi16(avg_q3);
  ...
  do {
    __m128i _8_values = _mm_loadu_si128((__m128i *)pred_buf_q3);
    __m128i next_8_values = _mm_loadu_si128((__m128i *)(pred_buf_q3 + next));

    _mm_storeu_si128((__m128i *)pred_buf_q3,
                     _mm_sub_epi16(_8_values, _8_averages));
    _mm_storeu_si128((__m128i *)(pred_buf_q3 + next),
                     _mm_sub_epi16(next_8_values, _8_averages));
