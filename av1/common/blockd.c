...
const int wienerns_coeff[WIENERNS_YUV][4] = {
  { 5, -3, 4, 128 },  { 6, -10, 4, 128 },  { 4, -9, 3, 128 },
  { 4, -12, 3, 128 }, { 5, -20, 3, 128 }, { 4, -13, 3, 128 },
  { 3, -4, 3, 128 },  { 3, -4, 3, 128 },  { 3, -3, 3, 128 },
  { 3, -3, 3, 128 },  { 3, -3, 3, 256 },  { 3, -3, 3, 256 },

  { 5, -2, 4, 128 },  { 5, 4, 4, 128 },  { 4, -5, 3, 128 },
  { 4, -8, 3, 128 }, { 5, -17, 3, 128 }, { 4, -11, 3, 128 },
  { 3, -4, 3, 256 },  { 3, -3, 3, 256 },
  // { 3, -3, 3, 128 },
  // { 3, -3, 3, 128 },  { 3, -4, 3, 128 },  { 3, -4, 3, 128 }
};
