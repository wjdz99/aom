...
#define INTER_REF_OFFSET(ref) ((ref)-LAST_FRAME)
...
#if CONFIG_EXT_COMP_REFS
  aom_prob single_ref0_probs[REF0_CONTEXTS][INTER_REFS_PER_FRAME - 1];
#else
...
#if CONFIG_EXT_COMP_REFS
  unsigned int single_ref0[REF0_CONTEXTS][INTER_REFS_PER_FRAME];
#else
