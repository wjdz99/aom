...
// TODO(angiebird): try aom_prob
  ...
  aom_prob comp_ref_type_prob[COMP_INTER_CONTEXTS];
  aom_prob uni_comp_ref_prob[REF_CONTEXTS];
...
#if CONFIG_EXT_COMP_REFS
  unsigned int comp_ref_type[COMP_INTER_CONTEXTS][2];
  unsigned int uni_comp_ref[REF_CONTEXTS][2];
#endif  // CONFIG_EXT_COMP_REFS
