...
#if CONFIG_EXT_SEGMENT
#define SPATIAL_PRED_CTX 2
#define SPATIAL_PRED_PROBS 2
#endif
...
#if CONFIG_EXT_SEGMENT
#if CONFIG_EC_MULTISYMBOL
  aom_cdf_prob spatial_pred_cdf[SPATIAL_PRED_CTX]
      [CDF_SIZE(SPATIAL_PRED_PROBS + 1)];
#endif
  aom_prob spatial_pred_probs[SPATIAL_PRED_CTX][SPATIAL_PRED_PROBS];
#endif
...
int av1_is_segfeature_enabled(const struct segmentation *seg,
                              SEG_LVL_FEATURES feature_id);
extern const aom_tree_index av1_segment_tree[MAX_SEGMENTS - 1]
