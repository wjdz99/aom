...
// Null function used for invalid tx_sizes
static INLINE void cfl_subtract_average_null(int16_t *dst, int16_t *src) {
  (void)dst;
  (void)src;
  assert(0);
}
...
#define CFL_SUB_AVG_X(arch, width, height, round_offset, num_pel_log2) \
  void subtract_average_##width##x##height##_##arch(int16_t *dst,      \
                                                    int16_t *src) {    \
    subtract_average_##arch(dst, src, width, height, round_offset,     \
                            num_pel_log2);                             \
  }
...
void subtract_average_4x4_c(int16_t *dst, int16_t *src);
void subtract_average_4x8_c(int16_t *dst, int16_t *src);
void subtract_average_4x16_c(int16_t *dst, int16_t *src);
