...
static const nmv_context default_nmv_context = {
  ...
  { AOM_ICDF(4096), AOM_ICDF(11264), AOM_ICDF(19328), AOM_ICDF(32768), 0 },  // joint_cdf
#endif
  { {
        // Vertical component
        128,                                                   // sign
...
#if CONFIG_EC_MULTISYMBOL
        { AOM_ICDF(28672), AOM_ICDF(30976), AOM_ICDF(31858), AOM_ICDF(32320), AOM_ICDF(32551), AOM_ICDF(32656), AOM_ICDF(32740), AOM_ICDF(32757), AOM_ICDF(32762), AOM_ICDF(32767),
          AOM_ICDF(32768), 0 },  // class_cdf
#endif
        { 216 },                                               // class0
        ...
        { 64, 96, 64 },                                        // fp
#if CONFIG_EC_MULTISYMBOL
        { { AOM_ICDF(16384), AOM_ICDF(24576), AOM_ICDF(26624), AOM_ICDF(32768), 0 },
          { AOM_ICDF(12288), AOM_ICDF(21248), AOM_ICDF(24128), AOM_ICDF(32768), 0 } },  // class0_fp_cdf
        { AOM_ICDF(8192), AOM_ICDF(17408), AOM_ICDF(21248), AOM_ICDF(32768), 0 },       // fp_cdf
#endif
        160,  // class0_hp bit
        128,  // hp
    },
