...
function(setup_av1_targets)
  ...
  if(HAVE_SSE2)
    ...
    add_intrinsics_object_library(
      "-msse2" "sse2" "aom_av1_common" "AOM_AV1_COMMON_INTRIN_SSE2" "aom")
    if(CONFIG_AV1_DECODER)
      ...
      if(AOM_AV1_DECODER_INTRIN_SSE2)
        add_intrinsics_object_library(
          "-msse2" "sse2" "aom_av1_decoder" "AOM_AV1_DECODER_INTRIN_SSE2" "aom")
      endif()
    endif()
    ...
    if(CONFIG_AV1_ENCODER)
      ...
      add_intrinsics_object_library(
        "-msse2" "sse2" "aom_av1_encoder" "AOM_AV1_ENCODER_INTRIN_SSE2" "aom")
    endif()
  endif()
  ...
  if(HAVE_SSE3)
    ...
    if(CONFIG_AV1_ENCODER)
      add_intrinsics_object_library(
        "-msse3" "sse3" "aom_av1_encoder" "AOM_AV1_ENCODER_INTRIN_SSE3" "aom")
    endif()
  endif()
  ...
  if(HAVE_SSSE3)
    ...
    add_intrinsics_object_library(
      "-mssse3" "ssse3" "aom_av1_common" "AOM_AV1_COMMON_INTRIN_SSSE3" "aom")

    if(CONFIG_AV1_DECODER)
      if(AOM_AV1_DECODER_INTRIN_SSSE3)
        add_intrinsics_object_library("-mssse3"
                                      "ssse3"
                                      "aom_av1_decoder"
  ...
  if(HAVE_SSE4_1)
    ...
    add_intrinsics_object_library(
      "-msse4.1" "sse4" "aom_av1_common" "AOM_AV1_COMMON_INTRIN_SSE4_1" "aom")
    ...
    if(CONFIG_AV1_ENCODER)
      ...
      if(AOM_AV1_ENCODER_INTRIN_SSE4_1)
        add_intrinsics_object_library("-msse4.1"
                                      "sse4"
                                      "aom_av1_encoder"
  ...
  if(HAVE_SSE4_2)
    ...
    if(CONFIG_AV1_ENCODER)
      if(AOM_AV1_ENCODER_INTRIN_SSE4_2)
        add_intrinsics_object_library("-msse4.2"
                                      "sse42"
                                      "aom_av1_encoder"
  ...
  if(HAVE_AVX2)
    ...
    add_intrinsics_object_library(
      "-mavx2" "avx2" "aom_av1_common" "AOM_AV1_COMMON_INTRIN_AVX2" "aom")

    if(CONFIG_AV1_ENCODER)
      add_intrinsics_object_library(
        "-mavx2" "avx2" "aom_av1_encoder" "AOM_AV1_ENCODER_INTRIN_AVX2" "aom")
    endif()
  endif()
  ...
  if(HAVE_MSA)
    add_intrinsics_object_library(
      "" "msa" "aom_av1_encoder" "AOM_AV1_ENCODER_INTRIN_MSA" "aom")
  endif()
