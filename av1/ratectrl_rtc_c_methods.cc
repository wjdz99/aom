...
bool UpdateRateControl_AV1(void *controller,
                           const AV1RateControlRtcConfig &rc_cfg) {
  return static_cast<AV1RateControlRTC *>(controller)
...
FrameDropDecision ComputeQP_AV1(void *controller,
...
bool GetSegmentationData_AV1(void *controller,
