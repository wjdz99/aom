...
class RefFrameManager {
 public:
  // max_ref_frames is the maximum number of references for a single frame.
  // ref_frame_table_size is the number of references the encoder supports
  // in its decoded picture buffer.
  explicit RefFrameManager(int max_ref_frames, int ref_frame_table_size)
      : max_ref_frames_(max_ref_frames),
        ref_frame_table_size_(ref_frame_table_size),
