...
EncodeFrameResult DuckyEncode::EncodeFrame() {
  ...
  // TODO(angiebird): Set bitstream_buf's size properly.
  encode_frame_result.bitstream_buf = std::vector<uint8_t>(352 * 288 * 3, 0);
  ...
  cpi_data.frame_size = 0;
  // TODO(angiebird): flush = 1?
  cpi_data.flush = 1;
  // TODO(angiebird): Set cpi_data.ts_frame_start
  cpi_data.ts_frame_start = 0;
  cpi_data.ts_frame_end = 1;
  // TODO(angiebird): pop_lookahead = 1?
  cpi_data.pop_lookahead = 1;
