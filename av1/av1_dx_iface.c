...
static aom_codec_err_t ctrl_get_frame_type_kf(aom_codec_alg_priv_t *ctx,
                                              va_list args) {
  int *const arg = va_arg(args, int *);
  if (arg == NULL) return AOM_CODEC_INVALID_PARAM;
  AV1Decoder *pbi = ((FrameWorkerData *)ctx->frame_worker->data1)->pbi;
  *arg = pbi->common.current_frame.frame_type == KEY_FRAME &&
...
static aom_codec_ctrl_fn_map_t decoder_ctrl_maps[] = {
  ...
  { AOMD_GET_FRAME_TYPE_KF, ctrl_get_frame_type_kf },
