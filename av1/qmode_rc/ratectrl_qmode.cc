...
StatusOr<GopEncodeInfo> GetGopEncodeInfoFp(
    ...
    const FirstpassInfo &firstpass_info) {
  // TODO(bohanli): This is currently a placeholder. Should use the fp stats to
...
StatusOr<GopEncodeInfo> AV1RateControlQMode::GetGopEncodeInfo(
  ...
  // TODO(bohanli): Currently firstpass stats are used as a fall-back, but we
  // could also combine it with tpl results in the future for more stable qp
  // determination.
