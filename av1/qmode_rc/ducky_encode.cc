...
int GetCurKeyFrameOrderIndex(const std::vector<int> &key_frame_list,
  ...
  const auto iter = std::lower_bound(key_frame_list.begin(),
          key_frame_list.end(), global_order_idx, std::greater<int>());
...
void DuckyEncode::SetRelativeKeyFrameLocation(const std::vector<int>& key_frame_list,
                                              int global_order_idx,
