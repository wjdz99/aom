...
static aom_codec_err_t set_encoder_config(
  ...
  if (extra_cfg->timing_info_type == AOM_TIMING_EQUAL ||
      extra_cfg->timing_info_type == AOM_TIMING_VARIABLE ||
