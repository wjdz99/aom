...
static aom_codec_err_t set_encoder_config(AV1EncoderConfig *oxcf,
  ...
  // For allintra encoding mode, motion estimation is not performed and the
  // intraBC motion vectors are restricted within the tile boundary. Hence a
  // smaller frame border size (AOM_ENC_ALLINTRA_BORDER) is used in this case.
