...
static aom_codec_err_t validate_config(aom_codec_alg_priv_t *ctx,
  ...
  RANGE_CHECK(cfg, rc_max_quantizer,
              -(cfg->g_bit_depth - AOM_BITS_8) * MAXQ_OFFSET, 255);
  RANGE_CHECK(cfg, rc_min_quantizer,
              -(cfg->g_bit_depth - AOM_BITS_8) * MAXQ_OFFSET, 255);
  RANGE_CHECK(extra_cfg, qp, -(cfg->g_bit_depth - AOM_BITS_8) * MAXQ_OFFSET,
              255);
#else
...
#if CONFIG_EXTQUANT
  int offset_qp = (cfg->g_bit_depth - AOM_BITS_8) * MAXQ_OFFSET;
