...
static aom_codec_err_t create_context_and_bufferpool(AV1_COMP **p_cpi,
...
static aom_codec_err_t encoder_init(aom_codec_ctx_t *ctx,
  ...
  if (ctx->priv == NULL) {
    ...
    if (res == AOM_CODEC_OK) {
      ...
      res = create_context_and_bufferpool(&priv->cpi, &priv->buffer_pool, &priv->oxcf,
                             &priv->pkt_list.head);
    }
  }
...
static void destroy_context_and_bufferpool(AV1_COMP *cpi, BufferPool *buffer_pool) {
