...
static aom_codec_err_t ctrl_set_ref_frame_config(aom_codec_alg_priv_t *ctx,
                                                 va_list args) {
  AV1_COMP *const cpi = ctx->cpi;
  aom_ref_frame_config_t *const data = va_arg(args, aom_ref_frame_config_t *);
...
static aom_codec_ctrl_fn_map_t encoder_ctrl_maps[] = {
  ...
  { AV1E_SET_REF_FRAME_CONFIG, ctrl_set_ref_frame_config },
