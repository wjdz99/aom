...
static aom_codec_err_t ctrl_enable_sb_qp_sweep_unit_test(
    aom_codec_alg_priv_t *ctx, va_list args) {
  struct av1_extracfg extra_cfg = ctx->extra_cfg;
  extra_cfg.sb_qp_sweep = CAST(AV1E_ENABLE_SB_QP_SWEEP_UNIT_TEST, args);
  return update_extra_cfg(ctx, &extra_cfg);
}
...
static aom_codec_ctrl_fn_map_t encoder_ctrl_maps[] = {
  ...
  { AV1E_ENABLE_SB_QP_SWEEP_UNIT_TEST, ctrl_enable_sb_qp_sweep_unit_test },
