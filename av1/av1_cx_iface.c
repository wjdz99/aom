...
static aom_codec_err_t set_encoder_config(AV1EncoderConfig *oxcf,
  ...
  FrameDimensionCfg *const frame_dim_cfg = &oxcf->frame_dim_cfg;
  ...
  frame_dim_cfg->width = cfg->g_w;
  frame_dim_cfg->height = cfg->g_h;
  frame_dim_cfg->forced_max_frame_width = cfg->g_forced_max_frame_width;
  frame_dim_cfg->forced_max_frame_height = cfg->g_forced_max_frame_height;
  frame_dim_cfg->render_width = extra_cfg->render_width;
  frame_dim_cfg->render_height = extra_cfg->render_height;
    ...
    if (img != NULL) {
      ...
      if (!cpi->lookahead) {
        ...
        cpi->lookahead = av1_lookahead_init(
            cpi->oxcf.frame_dim_cfg.width, cpi->oxcf.frame_dim_cfg.height,
