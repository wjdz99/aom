...
static VPX_REFFRAME ref_frame_to_av1_reframe(vpx_ref_frame_type_t frame) {
  switch (frame) {
...
static vpx_codec_err_t set_encoder_config(
    AV1EncoderConfig *oxcf, const vpx_codec_enc_cfg_t *cfg,
    const struct av1_extracfg *extra_cfg) {
...
static vpx_codec_frame_flags_t get_frame_pkt_flags(const AV1_COMP *cpi,
...
#endif
CODEC_INTERFACE(vpx_codec_av1_cx) = {
