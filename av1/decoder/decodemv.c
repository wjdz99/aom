  ...
  if (segfeature_active(&cm->seg, segment_id, SEG_LVL_REF_FRAME)) {
    ...
    if (mode == COMPOUND_REFERENCE) {
#if CONFIG_LOWDELAY_COMPOUND || CONFIG_VAR_REFS  // Normative in decoder (for low delay)
      const int idx = 1;
#else
#if CONFIG_EXT_REFS
      ...
      if ((cm->frame_refs[GOLDEN_FRAME-1].is_valid ||
        ...
        bit = (cm->frame_refs[GOLDEN_FRAME-1].is_valid ||
               cm->frame_refs[LAST3_FRAME-1].is_valid);
      ...
      if (!bit) {
        ...
        if (cm->frame_refs[LAST_FRAME-1].is_valid &&
          ...
          bit1 = cm->frame_refs[LAST_FRAME-1].is_valid;
#else   // !CONFIG_VAR_REFS
        ...
        if (cm->frame_refs[GOLDEN_FRAME-1].is_valid &&
          ...
          bit2 = cm->frame_refs[GOLDEN_FRAME-1].is_valid;
#else   // !CONFIG_VAR_REFS
      ...
      // Decode backward references.
      {
        ...
        if (cm->frame_refs[ALTREF_FRAME-1].is_valid &&
          ...
          bit_bwd = cm->frame_refs[ALTREF_FRAME-1].is_valid;
#else   // !CONFIG_VAR_REFS
        const int bit_bwd =
            aom_read(r, fc->comp_bwdref_prob[ctx_bwd][0], ACCT_STR);
#endif  // CONFIG_VAR_REFS
      ...
      if ((cm->frame_refs[ALTREF_FRAME-1].is_valid ||
        ...
        bit0 = (cm->frame_refs[ALTREF_FRAME-1].is_valid ||
                cm->frame_refs[BWDREF_FRAME-1].is_valid);
#else   // !CONFIG_VAR_REFS
      ...
      if (bit0) {
        ...
        if (cm->frame_refs[ALTREF_FRAME-1].is_valid &&
          ...
          bit1 = cm->frame_refs[ALTREF_FRAME-1].is_valid;
#else   // !CONFIG_VAR_REFS
        ...
        if ((cm->frame_refs[LAST_FRAME-1].is_valid ||
          ...
          bit2 = (cm->frame_refs[LAST3_FRAME-1].is_valid ||
                  cm->frame_refs[GOLDEN_FRAME-1].is_valid);
#else   // !CONFIG_VAR_REFS
        ...
        if (bit2) {
          ...
          if (cm->frame_refs[LAST3_FRAME-1].is_valid &&
            ...
            bit4 = cm->frame_refs[GOLDEN_FRAME-1].is_valid;
#else   // !CONFIG_VAR_REFS
          ...
          if (cm->frame_refs[LAST_FRAME-1].is_valid &&
            ...
            bit3 = cm->frame_refs[LAST2_FRAME-1].is_valid;
#else   // !CONFIG_VAR_REFS
