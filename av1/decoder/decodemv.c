...
static int read_cfl_alphas(
  ...
  if (cfl_alpha_codes[ind][CFL_PRED_U] != 0.0)
    signs[CFL_PRED_U] = aom_read_bit(r, "cfl:sign");
  if (cfl_alpha_codes[ind][CFL_PRED_V] != 0.0)
    signs[CFL_PRED_V] = aom_read_bit(r, "cfl:sign");
