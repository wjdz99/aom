...
static void read_intra_frame_mode_info(AV1_COMMON *const cm,
  ...
  mbmi->ref_frame_nrs[0] = convert_named_ref_to_ranked_ref_index(mbmi->ref_frame[0]);
  mbmi->ref_frame_nrs[1] = convert_named_ref_to_ranked_ref_index(mbmi->ref_frame[1]);
...
#if CONFIG_NEW_REF_SIGNALING
  mbmi->ref_frame_nrs[0] = convert_named_ref_to_ranked_ref_index(mbmi->ref_frames[0]);
  mbmi->ref_frame_nrs[1] = convert_named_ref_to_ranked_ref_index(mbmi->ref_frames[1]);
#endif  // CONFIG_NEW_REF_SIGNALING
