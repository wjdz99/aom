...
AOM_INLINE void dec_calc_subpel_params(
  ...
  if (is_scaled) {
    ...
    int pos_y = av1_scaled_x(orig_pos_y, sf);
    int pos_x = av1_scaled_y(orig_pos_x, sf);
...
AOM_INLINE void dec_calc_subpel_params_and_extend(
    const MV *const src_mv, InterPredParams *const inter_pred_params,
...
#define IS_ENC (0)
#define CALC_SUBPEL_PARAMS_FN dec_calc_subpel_params_and_extend
#include "av1/common/reconinter_template.h"
#undef IS_ENC
#undef CALC_SUBPEL_PARAMS_FN
