...
#if CONFIG_PVQ
static int av1_pvq_decode_helper(macroblockd_plane *xd, tran_low_t *ref_coeff,
...
static int av1_pvq_decode_helper2(AV1_COMMON *cm, MACROBLOCKD *const xd,
  ...
  if (ac_dc_coded) {
    ...
    eob = av1_pvq_decode_helper(xd, pvq_ref_coeff, dqcoeff, quant,
