...
typedef void (*palette_visitor)(MACROBLOCKD *const xd, int plane,
                                aom_reader *r);
...
static void visit_palette_fn(AV1Decoder *const pbi, MACROBLOCKD *const xd,
                             int mi_row, int mi_col, aom_reader *r,
                             BLOCK_SIZE bsize, palette_visitor visit) {
...
static void decode_token_and_recon_block(AV1Decoder *const pbi,
  ...
  visit_palette_fn(pbi, xd, mi_row, mi_col, r, bsize,
