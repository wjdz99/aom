...
static void decode_block(AV1Decoder *const pbi, MACROBLOCKD *const xd,
...

  {
    ...
    const int tu_num_w_y = max_4x4_w_y < tx_sz_y ? 1 : max_4x4_w_y / tx_sz_y;
    const int tu_num_h_y = max_4x4_h_y < tx_sz_y ? 1 : max_4x4_h_y / tx_sz_y;
    const int tu_num_w_c = max_4x4_w_c < tx_sz_c ? 1 : max_4x4_w_c / tx_sz_c;
    const int tu_num_h_c = max_4x4_h_c < tx_sz_c ? 1 : max_4x4_h_c / tx_sz_c;
