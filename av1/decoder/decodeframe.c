...
#if CONFIG_FRAME_SIZE
static void setup_frame_size(AV1_COMMON *cm, int frame_size_override_flag, struct aom_read_bit_buffer *rb) {
#else
...
#else
void av1_read_frame_size(struct aom_read_bit_buffer *rb, int *width, int *height) {
