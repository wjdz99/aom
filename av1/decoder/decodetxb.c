...
#if CONFIG_AOM_QM
        v =
          av1_dequant_abscoeff_nuq(level, dequant[!!c], dq_profile, !!c, nq_shift);
#else
...
#if CONFIG_AOM_QM
        t =
          av1_dequant_abscoeff_nuq(*level, dequant[!!pos], dq_profile, !!pos, nq_shift);
#else
        dqv_val = &dq_val[pos != 0][0];
...
#if CONFIG_AOM_QM
      t =
        av1_dequant_abscoeff_nuq(t, dequant[!!pos], dq_profile, !!pos, nq_shift);
#else
      dqv_val = &dq_val[pos != 0][0];
