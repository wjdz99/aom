...
uint8_t av1_read_coeffs_txb(const AV1_COMMON *const cm, MACROBLOCKD *const xd,
  ...
  *eob = 0;
  ...
  switch (eob_multi_size) {
    ...
    case 2:
      eob_pt =
          aom_read_symbol(r, ec_ctx->eob_flag_cdf64[eob_context][plane_type][eob_multi_ctx],
                          7, ACCT_STR) +
                          1;
      break;
    case 3:
      eob_pt =
          aom_read_symbol(r, ec_ctx->eob_flag_cdf128[eob_context][plane_type][eob_multi_ctx],
                          8, ACCT_STR) +
                          1;
      break;
    case 4:
      eob_pt =
          aom_read_symbol(r, ec_ctx->eob_flag_cdf256[eob_context][plane_type][eob_multi_ctx],
                          9, ACCT_STR) +
                          1;
      break;
    case 5:
      eob_pt =
          aom_read_symbol(r, ec_ctx->eob_flag_cdf512[eob_context][plane_type][eob_multi_ctx],
                          10, ACCT_STR) +
                          1;
      break;
    case 6:
    default:
      eob_pt = aom_read_symbol(
          r, ec_ctx->eob_flag_cdf1024[eob_context][plane_type][eob_multi_ctx], 11,
          ACCT_STR) +
          1;
      break;
  }
