...
AV1Decoder *av1_decoder_create(BufferPool *const pool) {
  AV1Decoder *volatile const pbi = vpx_memalign(32, sizeof(*pbi));
...
vpx_codec_err_t av1_copy_reference_dec(AV1Decoder *pbi,
...
vpx_codec_err_t av1_set_reference_dec(AV1_COMMON *cm,
                                       VPX_REFFRAME ref_frame_flag,
                                       YV12_BUFFER_CONFIG *sd) {
