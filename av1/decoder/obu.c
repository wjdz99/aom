...
const uint32_t kObuExtEnhancementIdBitsMask = 0x3;
const uint32_t kObuExtEnhancementIdBitsShift = 3;
#endif
...
#if CONFIG_SCALABILITY
    cm->temporal_layer_id = (obu_extension_header >> kObuExtTemporalIdBitsShift) &
		                     kObuExtTemporalIdBitsMask;
    cm->enhancement_layer_id = (obu_extension_header >> kObuExtEnhancementIdBitsShift) & kObuExtEnhancementIdBitsMask;;
#endif
