...
static void av1_decode_color_map_tokens(MACROBLOCKD *const xd,
                                        ColorMapParam *param,
                                        aom_reader *r) {
...
#if CONFIG_MRC_TX
static void get_mrc_params(const MACROBLOCK *const xd, int plane,
                           BLOCK_SIZE bsize, ColorMapParam *params) {
  // TODO(sarahparker)
  (void)xd;
  (void)plane;
...
void av1_decode_palette_tokens(MACROBLOCKD *const xd, int plane,
  ...
  get_palette_params(xd, plane, bsize, &color_map_params);
  av1_decode_color_map_tokens(xd, &param, r);
}

#if CONFIG_MRC_TX
void av1_decode_mrc_tokens(MACROBLOCKD *const xd, int plane, aom_reader *r) {
  ColorMapParam color_map_params;
  get_mrc_params(xd, plane, bsize, &color_map_params);
  av1_decode_color_map_tokens(xd, &param, plane, r);
}
#endif  // CONFIG_MRC_TX
