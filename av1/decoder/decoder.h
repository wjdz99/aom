...
typedef struct AV1Decoder {
  ...
  uint32_t frame_header_capacity;     // Size of the frame_header buffer
  uint32_t frame_header_size;         // Size of the original frame_buffer_obu
  uint32_t frame_header_unused_bits;  // Number of unused bits in the last byte
                                      // of the original frame_buffer_obu
