...
int main(int argc, const char **argv_) {
  ...
  // TODO move tx_size_totals to where only encoder will use
  skip_stats(statsfile, TX_SIZES);
  // TODO av1_tx_size_tree has variable size
  ...
  skip_stats(statsfile, EXT_TX_SETS_INTRA * EXT_TX_SIZES * INTRA_MODES *
             TX_TYPES);
#else
  // TODO intra_ext_tx use different trees depending on the context
