...
static const arg_def_t *all_args[] = {
  ...
  &isannexb,   &oppointarg, &outallarg,     &skipfilmgrain, &toplayeronly,
  NULL
};
...
static int main_loop(int argc, const char **argv_) {
  ...
  int top_spatial_layer_width = aom_input_ctx.width;
  int top_spatial_layer_height = aom_input_ctx.height;
