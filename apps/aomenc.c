...
static const arg_def_t use_inter_4way_tx_split =
    ARG_DEF(NULL, "use-inter-4way-tx-split", 1, "Use 4 way split for inter tx partition");
static const arg_def_t use_intra_4way_tx_split =
    ARG_DEF(NULL, "use-intra-4way-tx-split", 1, "Use 4 way split for intra tx partition");
