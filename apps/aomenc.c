...
const arg_def_t *main_args[] = { &av1CodecArgDefs.help,
                                 &av1CodecArgDefs.use_cfg,
                                 &av1CodecArgDefs.debugmode,
                                 &av1CodecArgDefs.outputfile,
                                 &av1CodecArgDefs.codecarg,
                                 &av1CodecArgDefs.passes,
                                 &av1CodecArgDefs.pass_arg,
                                 &av1CodecArgDefs.fpf_name,
                                 &av1CodecArgDefs.limit,
                                 &av1CodecArgDefs.skip,
                                 &av1CodecArgDefs.good_dl,
                                 &av1CodecArgDefs.rt_dl,
                                 &av1CodecArgDefs.quietarg,
                                 &av1CodecArgDefs.verbosearg,
                                 &av1CodecArgDefs.psnrarg,
                                 &av1CodecArgDefs.use_webm,
                                 &av1CodecArgDefs.use_ivf,
                                 &av1CodecArgDefs.use_obu,
                                 &av1CodecArgDefs.q_hist_n,
                                 &av1CodecArgDefs.rate_hist_n,
                                 &av1CodecArgDefs.disable_warnings,
                                 &av1CodecArgDefs.disable_warning_prompt,
                                 &av1CodecArgDefs.recontest,
                                 NULL };

const arg_def_t *global_args[] = { &av1CodecArgDefs.use_yv12,
                                   &av1CodecArgDefs.use_i420,
                                   &av1CodecArgDefs.use_i422,
                                   &av1CodecArgDefs.use_i444,
                                   &av1CodecArgDefs.usage,
                                   &av1CodecArgDefs.threads,
                                   &av1CodecArgDefs.profile,
                                   &av1CodecArgDefs.width,
                                   &av1CodecArgDefs.height,
                                   &av1CodecArgDefs.forced_max_frame_width,
                                   &av1CodecArgDefs.forced_max_frame_height,
#if CONFIG_WEBM_IO
                                   &av1CodecArgDefs.stereo_mode,
#endif
                                   &av1CodecArgDefs.timebase,
                                   &av1CodecArgDefs.framerate,
                                   &av1CodecArgDefs.global_error_resilient,
                                   &av1CodecArgDefs.bitdeptharg,
                                   &av1CodecArgDefs.lag_in_frames,
                                   &av1CodecArgDefs.large_scale_tile,
                                   &av1CodecArgDefs.monochrome,
                                   &av1CodecArgDefs.full_still_picture_hdr,
                                   &av1CodecArgDefs.use_16bit_internal,
                                   NULL };

const arg_def_t *rc_args[] = { &av1CodecArgDefs.dropframe_thresh,
                               &av1CodecArgDefs.resize_mode,
                               &av1CodecArgDefs.resize_denominator,
                               &av1CodecArgDefs.resize_kf_denominator,
                               &av1CodecArgDefs.superres_mode,
                               &av1CodecArgDefs.superres_denominator,
                               &av1CodecArgDefs.superres_kf_denominator,
                               &av1CodecArgDefs.superres_qthresh,
                               &av1CodecArgDefs.superres_kf_qthresh,
                               &av1CodecArgDefs.end_usage,
                               &av1CodecArgDefs.target_bitrate,
                               &av1CodecArgDefs.min_quantizer,
                               &av1CodecArgDefs.max_quantizer,
                               &av1CodecArgDefs.undershoot_pct,
                               &av1CodecArgDefs.overshoot_pct,
                               &av1CodecArgDefs.buf_sz,
                               &av1CodecArgDefs.buf_initial_sz,
                               &av1CodecArgDefs.buf_optimal_sz,
                               &av1CodecArgDefs.bias_pct,
                               &av1CodecArgDefs.minsection_pct,
                               &av1CodecArgDefs.maxsection_pct,
                               NULL };

const arg_def_t *kf_args[] = { &av1CodecArgDefs.fwd_kf_enabled,
                               &av1CodecArgDefs.kf_min_dist,
                               &av1CodecArgDefs.kf_max_dist,
                               &av1CodecArgDefs.kf_disabled, NULL };

const arg_def_t *av1_args[] = { &av1CodecArgDefs.cpu_used_av1,
                                &av1CodecArgDefs.auto_altref,
                                &av1CodecArgDefs.sharpness,
                                &av1CodecArgDefs.static_thresh,
                                &av1CodecArgDefs.rowmtarg,
                                &av1CodecArgDefs.tile_cols,
                                &av1CodecArgDefs.tile_rows,
                                &av1CodecArgDefs.enable_tpl_model,
                                &av1CodecArgDefs.enable_keyframe_filtering,
                                &av1CodecArgDefs.arnr_maxframes,
                                &av1CodecArgDefs.arnr_strength,
                                &av1CodecArgDefs.tune_metric,
                                &av1CodecArgDefs.cq_level,
                                &av1CodecArgDefs.max_intra_rate_pct,
                                &av1CodecArgDefs.max_inter_rate_pct,
                                &av1CodecArgDefs.gf_cbr_boost_pct,
                                &av1CodecArgDefs.lossless,
                                &av1CodecArgDefs.enable_cdef,
                                &av1CodecArgDefs.enable_restoration,
                                &av1CodecArgDefs.enable_rect_partitions,
                                &av1CodecArgDefs.enable_ab_partitions,
                                &av1CodecArgDefs.enable_1to4_partitions,
                                &av1CodecArgDefs.min_partition_size,
                                &av1CodecArgDefs.max_partition_size,
                                &av1CodecArgDefs.enable_dual_filter,
                                &av1CodecArgDefs.enable_chroma_deltaq,
                                &av1CodecArgDefs.enable_intra_edge_filter,
                                &av1CodecArgDefs.enable_order_hint,
                                &av1CodecArgDefs.enable_tx64,
                                &av1CodecArgDefs.enable_flip_idtx,
                                &av1CodecArgDefs.enable_rect_tx,
                                &av1CodecArgDefs.enable_dist_wtd_comp,
                                &av1CodecArgDefs.enable_masked_comp,
                                &av1CodecArgDefs.enable_onesided_comp,
                                &av1CodecArgDefs.enable_interintra_comp,
                                &av1CodecArgDefs.enable_smooth_interintra,
                                &av1CodecArgDefs.enable_diff_wtd_comp,
                                &av1CodecArgDefs.enable_interinter_wedge,
                                &av1CodecArgDefs.enable_interintra_wedge,
                                &av1CodecArgDefs.enable_global_motion,
                                &av1CodecArgDefs.enable_warped_motion,
                                &av1CodecArgDefs.enable_filter_intra,
                                &av1CodecArgDefs.enable_smooth_intra,
                                &av1CodecArgDefs.enable_paeth_intra,
                                &av1CodecArgDefs.enable_cfl_intra,
                                &av1CodecArgDefs.force_video_mode,
                                &av1CodecArgDefs.enable_obmc,
                                &av1CodecArgDefs.enable_overlay,
                                &av1CodecArgDefs.enable_palette,
                                &av1CodecArgDefs.enable_intrabc,
                                &av1CodecArgDefs.enable_angle_delta,
                                &av1CodecArgDefs.disable_trellis_quant,
                                &av1CodecArgDefs.enable_qm,
                                &av1CodecArgDefs.qm_min,
                                &av1CodecArgDefs.qm_max,
                                &av1CodecArgDefs.reduced_tx_type_set,
                                &av1CodecArgDefs.use_intra_dct_only,
                                &av1CodecArgDefs.use_inter_dct_only,
                                &av1CodecArgDefs.use_intra_default_tx_only,
                                &av1CodecArgDefs.quant_b_adapt,
                                &av1CodecArgDefs.coeff_cost_upd_freq,
                                &av1CodecArgDefs.mode_cost_upd_freq,
                                &av1CodecArgDefs.mv_cost_upd_freq,
                                &av1CodecArgDefs.frame_parallel_decoding,
                                &av1CodecArgDefs.error_resilient_mode,
                                &av1CodecArgDefs.aq_mode,
                                &av1CodecArgDefs.deltaq_mode,
                                &av1CodecArgDefs.deltalf_mode,
                                &av1CodecArgDefs.frame_periodic_boost,
                                &av1CodecArgDefs.noise_sens,
                                &av1CodecArgDefs.tune_content,
                                &av1CodecArgDefs.cdf_update_mode,
                                &av1CodecArgDefs.input_color_primaries,
                                &av1CodecArgDefs.input_transfer_characteristics,
                                &av1CodecArgDefs.input_matrix_coefficients,
                                &av1CodecArgDefs.input_chroma_sample_position,
                                &av1CodecArgDefs.min_gf_interval,
                                &av1CodecArgDefs.max_gf_interval,
                                &av1CodecArgDefs.gf_min_pyr_height,
                                &av1CodecArgDefs.gf_max_pyr_height,
                                &av1CodecArgDefs.superblock_size,
                                &av1CodecArgDefs.num_tg,
                                &av1CodecArgDefs.mtu_size,
                                &av1CodecArgDefs.timing_info,
                                &av1CodecArgDefs.film_grain_test,
                                &av1CodecArgDefs.film_grain_table,
#if CONFIG_DENOISE
                                &av1CodecArgDefs.denoise_noise_level,
                                &av1CodecArgDefs.denoise_block_size,
#endif  // CONFIG_DENOISE
                                &av1CodecArgDefs.max_reference_frames,
                                &av1CodecArgDefs.reduced_reference_set,
                                &av1CodecArgDefs.enable_ref_frame_mvs,
                                &av1CodecArgDefs.target_seq_level_idx,
                                &av1CodecArgDefs.set_tier_mask,
                                &av1CodecArgDefs.set_min_cr,
                                &av1CodecArgDefs.vbr_corpus_complexity_lap,
                                &av1CodecArgDefs.bitdeptharg,
                                &av1CodecArgDefs.inbitdeptharg,
                                &av1CodecArgDefs.input_chroma_subsampling_x,
                                &av1CodecArgDefs.input_chroma_subsampling_y,
                                &av1CodecArgDefs.sframe_dist,
                                &av1CodecArgDefs.sframe_mode,
                                &av1CodecArgDefs.save_as_annexb,
#if CONFIG_TUNE_VMAF
                                &av1CodecArgDefs.vmaf_model_path,
#endif
                                NULL };
...
static void parse_global_config(struct AvxEncoderConfig *global, char ***argv) {
  ...
  for (argi = argj = argv_local; (*argj = *argi); argi += arg.argv_step) {
    ...
    if (arg_match(&arg, &av1CodecArgDefs.use_cfg, argi)) {
      if (!cfg_included) {
        parse_cfg(arg.val, &global->encoder_config);
        cfg_included = 1;
      }
    } else if (arg_match(&arg, &av1CodecArgDefs.help, argi)) {
      show_help(stdout, 0);
      exit(EXIT_SUCCESS);
    } else if (arg_match(&arg, &av1CodecArgDefs.codecarg, argi)) {
      global->codec = get_aom_encoder_by_short_name(arg.val);
      if (!global->codec)
        die("Error: Unrecognized argument (%s) to --codec\n", arg.val);
    } else if (arg_match(&arg, &av1CodecArgDefs.passes, argi)) {
      global->passes = arg_parse_uint(&arg);

      if (global->passes < 1 || global->passes > 2)
        die("Error: Invalid number of passes (%d)\n", global->passes);
    } else if (arg_match(&arg, &av1CodecArgDefs.pass_arg, argi)) {
      global->pass = arg_parse_uint(&arg);

      if (global->pass < 1 || global->pass > 2)
        die("Error: Invalid pass selected (%d)\n", global->pass);
    } else if (arg_match(&arg, &av1CodecArgDefs.input_chroma_sample_position,
                         argi)) {
      global->csp = arg_parse_enum(&arg);
      /* Flag is used by later code as well, preserve it. */
      argj++;
    } else if (arg_match(&arg, &av1CodecArgDefs.usage, argi)) {
      global->usage = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.good_dl, argi)) {
      global->usage = AOM_USAGE_GOOD_QUALITY;  // Good quality usage
    } else if (arg_match(&arg, &av1CodecArgDefs.rt_dl, argi)) {
      global->usage = AOM_USAGE_REALTIME;  // Real-time usage
    } else if (arg_match(&arg, &av1CodecArgDefs.use_yv12, argi)) {
      global->color_type = YV12;
    } else if (arg_match(&arg, &av1CodecArgDefs.use_i420, argi)) {
      global->color_type = I420;
    } else if (arg_match(&arg, &av1CodecArgDefs.use_i422, argi)) {
      global->color_type = I422;
    } else if (arg_match(&arg, &av1CodecArgDefs.use_i444, argi)) {
      global->color_type = I444;
    } else if (arg_match(&arg, &av1CodecArgDefs.quietarg, argi)) {
      global->quiet = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.verbosearg, argi)) {
      global->verbose = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.limit, argi)) {
      global->limit = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.skip, argi)) {
      global->skip_frames = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.psnrarg, argi)) {
      if (arg.val)
        global->show_psnr = arg_parse_int(&arg);
      else
        global->show_psnr = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.recontest, argi)) {
      global->test_decode = arg_parse_enum_or_int(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.framerate, argi)) {
      global->framerate = arg_parse_rational(&arg);
      validate_positive_rational(arg.name, &global->framerate);
      global->have_framerate = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.debugmode, argi)) {
      global->debug = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.q_hist_n, argi)) {
      global->show_q_hist_buckets = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.rate_hist_n, argi)) {
      global->show_rate_hist_buckets = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.disable_warnings, argi)) {
      global->disable_warnings = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.disable_warning_prompt, argi)) {
...
static int parse_stream_params(struct AvxEncoderConfig *global,
  ...
  for (argi = argj = argv; (*argj = *argi); argi += arg.argv_step) {
    ...
    if (arg_match(&arg, &av1CodecArgDefs.outputfile, argi)) {
    ...
    } else if (arg_match(&arg, &av1CodecArgDefs.fpf_name, argi)) {
      config->stats_fn = arg.val;
    } else if (arg_match(&arg, &av1CodecArgDefs.use_webm, argi)) {
#if CONFIG_WEBM_IO
      config->write_webm = 1;
      webm_forced = 1;
#else
...
#endif
    } else if (arg_match(&arg, &av1CodecArgDefs.use_ivf, argi)) {
      config->write_webm = 0;
      config->write_ivf = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.use_obu, argi)) {
      config->write_webm = 0;
      config->write_ivf = 0;
    } else if (arg_match(&arg, &av1CodecArgDefs.threads, argi)) {
      config->cfg.g_threads = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.profile, argi)) {
      config->cfg.g_profile = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.width, argi)) {
      config->cfg.g_w = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.height, argi)) {
      config->cfg.g_h = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.forced_max_frame_width, argi)) {
      config->cfg.g_forced_max_frame_width = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.forced_max_frame_height,
                         argi)) {
      config->cfg.g_forced_max_frame_height = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.bitdeptharg, argi)) {
      config->cfg.g_bit_depth = arg_parse_enum_or_int(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.inbitdeptharg, argi)) {
      config->cfg.g_input_bit_depth = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.input_chroma_subsampling_x,
                         argi)) {
      stream->chroma_subsampling_x = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.input_chroma_subsampling_y,
                         argi)) {
      stream->chroma_subsampling_y = arg_parse_uint(&arg);
#if CONFIG_WEBM_IO
    } else if (arg_match(&arg, &av1CodecArgDefs.stereo_mode, argi)) {
      config->stereo_fmt = arg_parse_enum_or_int(&arg);
#endif
    } else if (arg_match(&arg, &av1CodecArgDefs.timebase, argi)) {
      config->cfg.g_timebase = arg_parse_rational(&arg);
      validate_positive_rational(arg.name, &config->cfg.g_timebase);
    } else if (arg_match(&arg, &av1CodecArgDefs.global_error_resilient, argi)) {
      config->cfg.g_error_resilient = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.lag_in_frames, argi)) {
      config->cfg.g_lag_in_frames = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.large_scale_tile, argi)) {
    ...
    } else if (arg_match(&arg, &av1CodecArgDefs.monochrome, argi)) {
      config->cfg.monochrome = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.full_still_picture_hdr, argi)) {
      config->cfg.full_still_picture_hdr = 1;
    } else if (arg_match(&arg, &av1CodecArgDefs.use_16bit_internal, argi)) {
    ...
    } else if (arg_match(&arg, &av1CodecArgDefs.dropframe_thresh, argi)) {
      config->cfg.rc_dropframe_thresh = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.resize_mode, argi)) {
      config->cfg.rc_resize_mode = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.resize_denominator, argi)) {
      config->cfg.rc_resize_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.resize_kf_denominator, argi)) {
      config->cfg.rc_resize_kf_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.superres_mode, argi)) {
      config->cfg.rc_superres_mode = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.superres_denominator, argi)) {
      config->cfg.rc_superres_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.superres_kf_denominator,
                         argi)) {
      config->cfg.rc_superres_kf_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.superres_qthresh, argi)) {
      config->cfg.rc_superres_qthresh = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.superres_kf_qthresh, argi)) {
      config->cfg.rc_superres_kf_qthresh = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.end_usage, argi)) {
      config->cfg.rc_end_usage = arg_parse_enum_or_int(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.target_bitrate, argi)) {
      config->cfg.rc_target_bitrate = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.min_quantizer, argi)) {
      config->cfg.rc_min_quantizer = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.max_quantizer, argi)) {
      config->cfg.rc_max_quantizer = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.undershoot_pct, argi)) {
      config->cfg.rc_undershoot_pct = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.overshoot_pct, argi)) {
      config->cfg.rc_overshoot_pct = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.buf_sz, argi)) {
      config->cfg.rc_buf_sz = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.buf_initial_sz, argi)) {
      config->cfg.rc_buf_initial_sz = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.buf_optimal_sz, argi)) {
      config->cfg.rc_buf_optimal_sz = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.bias_pct, argi)) {
      config->cfg.rc_2pass_vbr_bias_pct = arg_parse_uint(&arg);
      if (global->passes < 2)
        warn("option %s ignored in one-pass mode.\n", arg.name);
    } else if (arg_match(&arg, &av1CodecArgDefs.minsection_pct, argi)) {
      config->cfg.rc_2pass_vbr_minsection_pct = arg_parse_uint(&arg);

      if (global->passes < 2)
        warn("option %s ignored in one-pass mode.\n", arg.name);
    } else if (arg_match(&arg, &av1CodecArgDefs.maxsection_pct, argi)) {
      config->cfg.rc_2pass_vbr_maxsection_pct = arg_parse_uint(&arg);

      if (global->passes < 2)
        warn("option %s ignored in one-pass mode.\n", arg.name);
    } else if (arg_match(&arg, &av1CodecArgDefs.fwd_kf_enabled, argi)) {
      config->cfg.fwd_kf_enabled = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.kf_min_dist, argi)) {
      config->cfg.kf_min_dist = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.kf_max_dist, argi)) {
      config->cfg.kf_max_dist = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.kf_disabled, argi)) {
      config->cfg.kf_mode = AOM_KF_DISABLED;
    } else if (arg_match(&arg, &av1CodecArgDefs.sframe_dist, argi)) {
      config->cfg.sframe_dist = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.sframe_mode, argi)) {
      config->cfg.sframe_mode = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.save_as_annexb, argi)) {
      config->cfg.save_as_annexb = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.tile_width, argi)) {
      config->cfg.tile_width_count =
          arg_parse_list(&arg, config->cfg.tile_widths, MAX_TILE_WIDTHS);
    } else if (arg_match(&arg, &av1CodecArgDefs.tile_height, argi)) {
...
#endif
    } else if (arg_match(&arg, &av1CodecArgDefs.use_fixed_qp_offsets, argi)) {
      config->cfg.use_fixed_qp_offsets = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &av1CodecArgDefs.fixed_qp_offsets, argi)) {
      ...
      config->cfg.use_fixed_qp_offsets = 1;
               ...
               arg_match(&arg, &av1CodecArgDefs.enable_restoration, argi)) {
