...
const arg_def_t *main_args[] = { &codecArgDefs.help,
                                 &codecArgDefs.use_cfg,
                                 &codecArgDefs.debugmode,
                                 &codecArgDefs.outputfile,
                                 &codecArgDefs.codecarg,
                                 &codecArgDefs.passes,
                                 &codecArgDefs.pass_arg,
                                 &codecArgDefs.fpf_name,
                                 &codecArgDefs.limit,
                                 &codecArgDefs.skip,
                                 &codecArgDefs.good_dl,
                                 &codecArgDefs.rt_dl,
                                 &codecArgDefs.quietarg,
                                 &codecArgDefs.verbosearg,
                                 &codecArgDefs.psnrarg,
                                 &codecArgDefs.use_webm,
                                 &codecArgDefs.use_ivf,
                                 &codecArgDefs.use_obu,
                                 &codecArgDefs.q_hist_n,
                                 &codecArgDefs.rate_hist_n,
                                 &codecArgDefs.disable_warnings,
                                 &codecArgDefs.disable_warning_prompt,
                                 &codecArgDefs.recontest,
                                 NULL };

const arg_def_t *global_args[] = { &codecArgDefs.use_yv12,
                                   &codecArgDefs.use_i420,
                                   &codecArgDefs.use_i422,
                                   &codecArgDefs.use_i444,
                                   &codecArgDefs.usage,
                                   &codecArgDefs.threads,
                                   &codecArgDefs.profile,
                                   &codecArgDefs.width,
                                   &codecArgDefs.height,
                                   &codecArgDefs.forced_max_frame_width,
                                   &codecArgDefs.forced_max_frame_height,
#if CONFIG_WEBM_IO
                                   &codecArgDefs.stereo_mode,
#endif
                                   &codecArgDefs.timebase,
                                   &codecArgDefs.framerate,
                                   &codecArgDefs.global_error_resilient,
                                   &codecArgDefs.bitdeptharg,
                                   &codecArgDefs.lag_in_frames,
                                   &codecArgDefs.large_scale_tile,
                                   &codecArgDefs.monochrome,
                                   &codecArgDefs.full_still_picture_hdr,
                                   &codecArgDefs.use_16bit_internal,
                                   NULL };

const arg_def_t *rc_args[] = { &codecArgDefs.dropframe_thresh,
                               &codecArgDefs.resize_mode,
                               &codecArgDefs.resize_denominator,
                               &codecArgDefs.resize_kf_denominator,
                               &codecArgDefs.superres_mode,
                               &codecArgDefs.superres_denominator,
                               &codecArgDefs.superres_kf_denominator,
                               &codecArgDefs.superres_qthresh,
                               &codecArgDefs.superres_kf_qthresh,
                               &codecArgDefs.end_usage,
                               &codecArgDefs.target_bitrate,
                               &codecArgDefs.min_quantizer,
                               &codecArgDefs.max_quantizer,
                               &codecArgDefs.undershoot_pct,
                               &codecArgDefs.overshoot_pct,
                               &codecArgDefs.buf_sz,
                               &codecArgDefs.buf_initial_sz,
                               &codecArgDefs.buf_optimal_sz,
                               &codecArgDefs.bias_pct,
                               &codecArgDefs.minsection_pct,
                               &codecArgDefs.maxsection_pct,
                               NULL };

const arg_def_t *kf_args[] = { &codecArgDefs.fwd_kf_enabled,
                               &codecArgDefs.kf_min_dist,
                               &codecArgDefs.kf_max_dist,
                               &codecArgDefs.kf_disabled, NULL };

const arg_def_t *av1_args[] = { &codecArgDefs.cpu_used_av1,
                                &codecArgDefs.auto_altref,
                                &codecArgDefs.sharpness,
                                &codecArgDefs.static_thresh,
                                &codecArgDefs.rowmtarg,
                                &codecArgDefs.tile_cols,
                                &codecArgDefs.tile_rows,
                                &codecArgDefs.enable_tpl_model,
                                &codecArgDefs.enable_keyframe_filtering,
                                &codecArgDefs.arnr_maxframes,
                                &codecArgDefs.arnr_strength,
                                &codecArgDefs.tune_metric,
                                &codecArgDefs.cq_level,
                                &codecArgDefs.max_intra_rate_pct,
                                &codecArgDefs.max_inter_rate_pct,
                                &codecArgDefs.gf_cbr_boost_pct,
                                &codecArgDefs.lossless,
                                &codecArgDefs.enable_cdef,
                                &codecArgDefs.enable_restoration,
                                &codecArgDefs.enable_rect_partitions,
                                &codecArgDefs.enable_ab_partitions,
                                &codecArgDefs.enable_1to4_partitions,
                                &codecArgDefs.min_partition_size,
                                &codecArgDefs.max_partition_size,
                                &codecArgDefs.enable_dual_filter,
                                &codecArgDefs.enable_chroma_deltaq,
                                &codecArgDefs.enable_intra_edge_filter,
                                &codecArgDefs.enable_order_hint,
                                &codecArgDefs.enable_tx64,
                                &codecArgDefs.enable_flip_idtx,
                                &codecArgDefs.enable_rect_tx,
                                &codecArgDefs.enable_dist_wtd_comp,
                                &codecArgDefs.enable_masked_comp,
                                &codecArgDefs.enable_onesided_comp,
                                &codecArgDefs.enable_interintra_comp,
                                &codecArgDefs.enable_smooth_interintra,
                                &codecArgDefs.enable_diff_wtd_comp,
                                &codecArgDefs.enable_interinter_wedge,
                                &codecArgDefs.enable_interintra_wedge,
                                &codecArgDefs.enable_global_motion,
                                &codecArgDefs.enable_warped_motion,
                                &codecArgDefs.enable_filter_intra,
                                &codecArgDefs.enable_smooth_intra,
                                &codecArgDefs.enable_paeth_intra,
                                &codecArgDefs.enable_cfl_intra,
                                &codecArgDefs.force_video_mode,
                                &codecArgDefs.enable_obmc,
                                &codecArgDefs.enable_overlay,
                                &codecArgDefs.enable_palette,
                                &codecArgDefs.enable_intrabc,
                                &codecArgDefs.enable_angle_delta,
                                &codecArgDefs.disable_trellis_quant,
                                &codecArgDefs.enable_qm,
                                &codecArgDefs.qm_min,
                                &codecArgDefs.qm_max,
                                &codecArgDefs.reduced_tx_type_set,
                                &codecArgDefs.use_intra_dct_only,
                                &codecArgDefs.use_inter_dct_only,
                                &codecArgDefs.use_intra_default_tx_only,
                                &codecArgDefs.quant_b_adapt,
                                &codecArgDefs.coeff_cost_upd_freq,
                                &codecArgDefs.mode_cost_upd_freq,
                                &codecArgDefs.mv_cost_upd_freq,
                                &codecArgDefs.frame_parallel_decoding,
                                &codecArgDefs.error_resilient_mode,
                                &codecArgDefs.aq_mode,
                                &codecArgDefs.deltaq_mode,
                                &codecArgDefs.deltalf_mode,
                                &codecArgDefs.frame_periodic_boost,
                                &codecArgDefs.noise_sens,
                                &codecArgDefs.tune_content,
                                &codecArgDefs.cdf_update_mode,
                                &codecArgDefs.input_color_primaries,
                                &codecArgDefs.input_transfer_characteristics,
                                &codecArgDefs.input_matrix_coefficients,
                                &codecArgDefs.input_chroma_sample_position,
                                &codecArgDefs.min_gf_interval,
                                &codecArgDefs.max_gf_interval,
                                &codecArgDefs.gf_min_pyr_height,
                                &codecArgDefs.gf_max_pyr_height,
                                &codecArgDefs.superblock_size,
                                &codecArgDefs.num_tg,
                                &codecArgDefs.mtu_size,
                                &codecArgDefs.timing_info,
                                &codecArgDefs.film_grain_test,
                                &codecArgDefs.film_grain_table,
#if CONFIG_DENOISE
                                &codecArgDefs.denoise_noise_level,
                                &codecArgDefs.denoise_block_size,
#endif  // CONFIG_DENOISE
                                &codecArgDefs.max_reference_frames,
                                &codecArgDefs.reduced_reference_set,
                                &codecArgDefs.enable_ref_frame_mvs,
                                &codecArgDefs.target_seq_level_idx,
                                &codecArgDefs.set_tier_mask,
                                &codecArgDefs.set_min_cr,
                                &codecArgDefs.vbr_corpus_complexity_lap,
                                &codecArgDefs.bitdeptharg,
                                &codecArgDefs.inbitdeptharg,
                                &codecArgDefs.input_chroma_subsampling_x,
                                &codecArgDefs.input_chroma_subsampling_y,
                                &codecArgDefs.sframe_dist,
                                &codecArgDefs.sframe_mode,
                                &codecArgDefs.save_as_annexb,
#if CONFIG_TUNE_VMAF
                                &codecArgDefs.vmaf_model_path,
#endif
                                NULL };
...
static void parse_global_config(struct AvxEncoderConfig *global, char ***argv) {
  ...
  for (argi = argj = argv_local; (*argj = *argi); argi += arg.argv_step) {
    ...
    if (arg_match(&arg, &codecArgDefs.use_cfg, argi)) {
      if (!cfg_included) {
        parse_cfg(arg.val, &global->encoder_config);
        cfg_included = 1;
      }
    } else if (arg_match(&arg, &codecArgDefs.help, argi)) {
      show_help(stdout, 0);
      exit(EXIT_SUCCESS);
    } else if (arg_match(&arg, &codecArgDefs.codecarg, argi)) {
      global->codec = get_aom_encoder_by_short_name(arg.val);
      if (!global->codec)
        die("Error: Unrecognized argument (%s) to --codec\n", arg.val);
    } else if (arg_match(&arg, &codecArgDefs.passes, argi)) {
      global->passes = arg_parse_uint(&arg);

      if (global->passes < 1 || global->passes > 2)
        die("Error: Invalid number of passes (%d)\n", global->passes);
    } else if (arg_match(&arg, &codecArgDefs.pass_arg, argi)) {
      global->pass = arg_parse_uint(&arg);

      if (global->pass < 1 || global->pass > 2)
        die("Error: Invalid pass selected (%d)\n", global->pass);
    } else if (arg_match(&arg, &codecArgDefs.input_chroma_sample_position,
                         argi)) {
      global->csp = arg_parse_enum(&arg);
      /* Flag is used by later code as well, preserve it. */
      argj++;
    } else if (arg_match(&arg, &codecArgDefs.usage, argi))
      global->usage = arg_parse_uint(&arg);
    else if (arg_match(&arg, &codecArgDefs.good_dl, argi))
      global->usage = AOM_USAGE_GOOD_QUALITY;  // Good quality usage
    else if (arg_match(&arg, &codecArgDefs.rt_dl, argi))
      global->usage = AOM_USAGE_REALTIME;  // Real-time usage
    else if (arg_match(&arg, &codecArgDefs.use_yv12, argi))
      global->color_type = YV12;
    else if (arg_match(&arg, &codecArgDefs.use_i420, argi))
      global->color_type = I420;
    else if (arg_match(&arg, &codecArgDefs.use_i422, argi))
      global->color_type = I422;
    else if (arg_match(&arg, &codecArgDefs.use_i444, argi))
      global->color_type = I444;
    else if (arg_match(&arg, &codecArgDefs.quietarg, argi))
      global->quiet = 1;
    else if (arg_match(&arg, &codecArgDefs.verbosearg, argi))
      global->verbose = 1;
    else if (arg_match(&arg, &codecArgDefs.limit, argi))
      global->limit = arg_parse_uint(&arg);
    else if (arg_match(&arg, &codecArgDefs.skip, argi))
      global->skip_frames = arg_parse_uint(&arg);
    else if (arg_match(&arg, &codecArgDefs.psnrarg, argi)) {
      if (arg.val)
        global->show_psnr = arg_parse_int(&arg);
      else
        global->show_psnr = 1;
    } else if (arg_match(&arg, &codecArgDefs.recontest, argi)) {
      global->test_decode = arg_parse_enum_or_int(&arg);
    } else if (arg_match(&arg, &codecArgDefs.framerate, argi)) {
      global->framerate = arg_parse_rational(&arg);
      validate_positive_rational(arg.name, &global->framerate);
      global->have_framerate = 1;
    } else if (arg_match(&arg, &codecArgDefs.debugmode, argi))
      global->debug = 1;
    else if (arg_match(&arg, &codecArgDefs.q_hist_n, argi))
      global->show_q_hist_buckets = arg_parse_uint(&arg);
    else if (arg_match(&arg, &codecArgDefs.rate_hist_n, argi))
      global->show_rate_hist_buckets = arg_parse_uint(&arg);
    else if (arg_match(&arg, &codecArgDefs.disable_warnings, argi))
      global->disable_warnings = 1;
    else if (arg_match(&arg, &codecArgDefs.disable_warning_prompt, argi))
...
static int parse_stream_params(struct AvxEncoderConfig *global,
  ...
  for (argi = argj = argv; (*argj = *argi); argi += arg.argv_step) {
    ...
    if (arg_match(&arg, &codecArgDefs.outputfile, argi)) {
    ...
    } else if (arg_match(&arg, &codecArgDefs.fpf_name, argi)) {
      config->stats_fn = arg.val;
    } else if (arg_match(&arg, &codecArgDefs.use_webm, argi)) {
#if CONFIG_WEBM_IO
      config->write_webm = 1;
      webm_forced = 1;
#else
...
#endif
    } else if (arg_match(&arg, &codecArgDefs.use_ivf, argi)) {
      config->write_webm = 0;
      config->write_ivf = 1;
    } else if (arg_match(&arg, &codecArgDefs.use_obu, argi)) {
      config->write_webm = 0;
      config->write_ivf = 0;
    } else if (arg_match(&arg, &codecArgDefs.threads, argi)) {
      config->cfg.g_threads = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.profile, argi)) {
      config->cfg.g_profile = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.width, argi)) {
      config->cfg.g_w = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.height, argi)) {
      config->cfg.g_h = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.forced_max_frame_width, argi)) {
      config->cfg.g_forced_max_frame_width = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.forced_max_frame_height, argi)) {
      config->cfg.g_forced_max_frame_height = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.bitdeptharg, argi)) {
      config->cfg.g_bit_depth = arg_parse_enum_or_int(&arg);
    } else if (arg_match(&arg, &codecArgDefs.inbitdeptharg, argi)) {
      config->cfg.g_input_bit_depth = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.input_chroma_subsampling_x,
                         argi)) {
      stream->chroma_subsampling_x = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.input_chroma_subsampling_y,
                         argi)) {
      stream->chroma_subsampling_y = arg_parse_uint(&arg);
#if CONFIG_WEBM_IO
    } else if (arg_match(&arg, &codecArgDefs.stereo_mode, argi)) {
      config->stereo_fmt = arg_parse_enum_or_int(&arg);
#endif
    } else if (arg_match(&arg, &codecArgDefs.timebase, argi)) {
      config->cfg.g_timebase = arg_parse_rational(&arg);
      validate_positive_rational(arg.name, &config->cfg.g_timebase);
    } else if (arg_match(&arg, &codecArgDefs.global_error_resilient, argi)) {
      config->cfg.g_error_resilient = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.lag_in_frames, argi)) {
      config->cfg.g_lag_in_frames = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.large_scale_tile, argi)) {
    ...
    } else if (arg_match(&arg, &codecArgDefs.monochrome, argi)) {
      config->cfg.monochrome = 1;
    } else if (arg_match(&arg, &codecArgDefs.full_still_picture_hdr, argi)) {
      config->cfg.full_still_picture_hdr = 1;
    } else if (arg_match(&arg, &codecArgDefs.use_16bit_internal, argi)) {
    ...
    } else if (arg_match(&arg, &codecArgDefs.dropframe_thresh, argi)) {
      config->cfg.rc_dropframe_thresh = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.resize_mode, argi)) {
      config->cfg.rc_resize_mode = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.resize_denominator, argi)) {
      config->cfg.rc_resize_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.resize_kf_denominator, argi)) {
      config->cfg.rc_resize_kf_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.superres_mode, argi)) {
      config->cfg.rc_superres_mode = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.superres_denominator, argi)) {
      config->cfg.rc_superres_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.superres_kf_denominator, argi)) {
      config->cfg.rc_superres_kf_denominator = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.superres_qthresh, argi)) {
      config->cfg.rc_superres_qthresh = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.superres_kf_qthresh, argi)) {
      config->cfg.rc_superres_kf_qthresh = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.end_usage, argi)) {
      config->cfg.rc_end_usage = arg_parse_enum_or_int(&arg);
    } else if (arg_match(&arg, &codecArgDefs.target_bitrate, argi)) {
      config->cfg.rc_target_bitrate = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.min_quantizer, argi)) {
      config->cfg.rc_min_quantizer = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.max_quantizer, argi)) {
      config->cfg.rc_max_quantizer = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.undershoot_pct, argi)) {
      config->cfg.rc_undershoot_pct = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.overshoot_pct, argi)) {
      config->cfg.rc_overshoot_pct = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.buf_sz, argi)) {
      config->cfg.rc_buf_sz = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.buf_initial_sz, argi)) {
      config->cfg.rc_buf_initial_sz = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.buf_optimal_sz, argi)) {
      config->cfg.rc_buf_optimal_sz = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.bias_pct, argi)) {
      config->cfg.rc_2pass_vbr_bias_pct = arg_parse_uint(&arg);
      if (global->passes < 2)
        warn("option %s ignored in one-pass mode.\n", arg.name);
    } else if (arg_match(&arg, &codecArgDefs.minsection_pct, argi)) {
      config->cfg.rc_2pass_vbr_minsection_pct = arg_parse_uint(&arg);

      if (global->passes < 2)
        warn("option %s ignored in one-pass mode.\n", arg.name);
    } else if (arg_match(&arg, &codecArgDefs.maxsection_pct, argi)) {
      config->cfg.rc_2pass_vbr_maxsection_pct = arg_parse_uint(&arg);

      if (global->passes < 2)
        warn("option %s ignored in one-pass mode.\n", arg.name);
    } else if (arg_match(&arg, &codecArgDefs.fwd_kf_enabled, argi)) {
      config->cfg.fwd_kf_enabled = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.kf_min_dist, argi)) {
      config->cfg.kf_min_dist = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.kf_max_dist, argi)) {
      config->cfg.kf_max_dist = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.kf_disabled, argi)) {
      config->cfg.kf_mode = AOM_KF_DISABLED;
    } else if (arg_match(&arg, &codecArgDefs.sframe_dist, argi)) {
      config->cfg.sframe_dist = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.sframe_mode, argi)) {
      config->cfg.sframe_mode = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.save_as_annexb, argi)) {
      config->cfg.save_as_annexb = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.tile_width, argi)) {
      config->cfg.tile_width_count =
          arg_parse_list(&arg, config->cfg.tile_widths, MAX_TILE_WIDTHS);
    } else if (arg_match(&arg, &codecArgDefs.tile_height, argi)) {
...
#endif
    } else if (arg_match(&arg, &codecArgDefs.use_fixed_qp_offsets, argi)) {
      config->cfg.use_fixed_qp_offsets = arg_parse_uint(&arg);
    } else if (arg_match(&arg, &codecArgDefs.fixed_qp_offsets, argi)) {
      ...
      config->cfg.use_fixed_qp_offsets = 1;
               ...
               arg_match(&arg, &codecArgDefs.enable_restoration, argi)) {
