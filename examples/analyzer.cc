...
void AnalyzerPanel::render() {
  ...
  for (int j = 0; j < decoder.getHeight(); j++) {
    ...
    for (int i = 0; i < decoder.getWidth(); i++) {
      ...
      rval = OD_CLAMPI(0, (int32_t)OD_DIV_ROUND(2916394880000LL * yval +
                                                    4490222169144LL * crval,
                                                9745792000LL),
                       65535);
      gval = OD_CLAMPI(0, (int32_t)OD_DIV_ROUND(2916394880000LL * yval -
                                                ...
                                                9745792000LL),
                       65535);
      bval = OD_CLAMPI(0, (int32_t)OD_DIV_ROUND(2916394880000LL * yval +
                                                    5290866304968LL * cbval,
                                                9745792000LL),
                       65535);
