...
static void usage_and_exit(char *prog) {
  ...
  printf("          <c> is optional compression level in [0, 2].\n");
  printf("      <y4m_output>\n");
  printf("      \n");
  exit(EXIT_FAILURE);
}
...
const unsigned char *tflite_data[NUM_MODELS][NUM_LEVELS] = {
  { _tmp_sr2by1_tflite, _tmp_sr2by1_tflite, _tmp_sr2by1_tflite },
  { _tmp_sr3by2_tflite, _tmp_sr3by2_tflite, _tmp_sr3by2_tflite },
  { _tmp_sr4by3_tflite, _tmp_sr4by3_tflite, _tmp_sr4by3_tflite },
  { _tmp_sr5by4_tflite, _tmp_sr5by4_tflite, _tmp_sr5by4_tflite },
  { _tmp_sr6by5_tflite, _tmp_sr6by5_tflite, _tmp_sr6by5_tflite },
  { _tmp_sr7by6_tflite, _tmp_sr7by6_tflite, _tmp_sr7by6_tflite },
};
