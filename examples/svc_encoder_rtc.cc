...
static aom_codec_err_t parse_layer_options_from_string(
  ...
  input_string = static_cast<char *>(malloc(input_length + 1));
...
static void parse_command_line(int argc, const char **argv_,
  ...
  open_input_file(&app_input->input_ctx,
                  static_cast<aom_chroma_sample_position_t>(0));
...
int main(int argc, const char **argv) {
  ...
  app_input.input_ctx.bit_depth = static_cast<aom_bit_depth_t>(0);
  app_input.speed = 7;
  exec_name = argv[0];
