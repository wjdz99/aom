...
int main(int argc, char **argv) {
  ...
  aom_codec_control_set_int(&codec, AV1_SET_TILE_MODE, 0);
  ...
  aom_codec_control_set_int(&codec, AV1_SET_TILE_MODE, 1);

  // Set external references.
  av1_ext_ref_frame_t set_ext_ref = { &reference_images[0], num_references };
  aom_codec_control_set_ptr(&codec, AV1D_SET_EXT_REF_PTR, &set_ext_ref,
                            sizeof(set_ext_ref));
