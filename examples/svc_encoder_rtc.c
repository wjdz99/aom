...
static void set_layer_pattern(
  ...
  *use_svc_control = 1;
  ...
  ref_frame_comp_pred->svc_use_comp_pred[0] = 0;  // GOLDEN_LAST
  ref_frame_comp_pred->svc_use_comp_pred[1] = 0;  // LAST2_LAST
  ref_frame_comp_pred->svc_use_comp_pred[2] = 0;  // ALTREF_LAST
  ...
  switch (layering_mode) {
    ...
    case 3:
      ...
      if (speed >= 7) ref_frame_comp_pred->svc_use_comp_pred[2] = 1;
      break;
    case 4:
