...
static void parse_command_line(int argc, char **argv_, AppInput *app_input,
  ...
  printf(
      ...
      "gop size: %d\n",
      aom_codec_iface_name(aom_codec_av1_cx()), app_input->frames_to_skip,
