...
function (require_c_flag c_flag)
  ...
  if (${C_FLAG_FOUND} EQUAL -1)
    unset(AOM_HAVE_C_FLAG CACHE)
    message("Checking C compiler flag support for: " ${c_flag})
    check_c_compiler_flag("${c_flag}" AOM_HAVE_C_FLAG)
    if (NOT AOM_HAVE_C_FLAG)
      message(FATAL_ERROR
...
function (require_cxx_flag cxx_flag)
  ...
  if (${CXX_FLAG_FOUND} EQUAL -1)
    unset(AOM_HAVE_CXX_FLAG CACHE)
    message("Checking CXX compiler flag support for: " ${cxx_flag})
    check_cxx_compiler_flag("${cxx_flag}" AOM_HAVE_CXX_FLAG)
    if (NOT AOM_HAVE_CXX_FLAG)
      message(FATAL_ERROR
