...
# build configuration types is built, and flags are applied to the flag lists
...
# CMake list variables that contain flags for the currently available
# configuration(s).
unset(AOM_C_CONFIGS)
...
foreach (config ${AOM_LINKER_CONFIGS})
  message("-----LINKER ${config}=${${config}}")
endforeach ()

message(FATAL_ERROR "shame and regret are ok.")
