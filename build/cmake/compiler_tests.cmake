...
# CMake passes command line flags like this: $compiler $lang_flags
# $lang_flags_config ... To ensure the flags tested here and elsewhere are
# obeyed a list of active build configuration types is built, and flags are
# applied to the flag strings for each configuration currently active for C and
# CXX builds as determined by reading $CMAKE_CONFIGURATION_TYPES and
# $CMAKE_BUILD_TYPE. When $CMAKE_CONFIGURATION_TYPES is non-empty a multi-
# configuration generator is in use: currently this includes MSVC and Xcode. For
# other generators $CMAKE_BUILD_TYPE is used. For both cases AOM_<LANG>_CONFIGS
# is populated with CMake string variable names that contain flags for the
# currently available configuration(s).
unset(AOM_C_CONFIGS)
