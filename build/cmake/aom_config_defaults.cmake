...
set_aom_detected_var(INLINE "" STRING "Sets INLINE value for current target.")

# CPUs.
set_aom_detected_var(ARCH_ARM 0 NUMBER "Enables ARM architecture.")
set_aom_detected_var(ARCH_MIPS 0 NUMBER "Enables MIPS architecture.")
set_aom_detected_var(ARCH_PPC 0 NUMBER "Enables PPC architecture.")
set_aom_detected_var(ARCH_X86 0 NUMBER "Enables X86 architecture.")
set_aom_detected_var(ARCH_X86_64 0 NUMBER "Enables X86_64 architecture.")

# ARM optimization flags.
set_aom_detected_var(HAVE_NEON 0 NUMBER
                     "Enables NEON intrinsics optimizations.")

# MIPS optimization flags.
set_aom_detected_var(HAVE_DSPR2 0 NUMBER "Enables DSPR2 optimizations.")
set_aom_detected_var(HAVE_MIPS32 0 NUMBER "Enables MIPS32 optimizations.")
set_aom_detected_var(HAVE_MIPS64 0 NUMBER "Enables MIPS64 optimizations. ")
set_aom_detected_var(HAVE_MSA 0 NUMBER "Enables MSA optimizations.")

# PPC optimization flags.
set_aom_detected_var(HAVE_VSX 0 NUMBER "Enables VSX optimizations.")

# x86/x86_64 optimization flags.
set_aom_detected_var(HAVE_AVX 0 NUMBER "Enables AVX optimizations.")
set_aom_detected_var(HAVE_AVX2 0 NUMBER "Enables AVX2 optimizations.")
set_aom_detected_var(HAVE_MMX 0 NUMBER "Enables MMX optimizations. ")
set_aom_detected_var(HAVE_SSE 0 NUMBER "Enables SSE optimizations.")
set_aom_detected_var(HAVE_SSE2 0 NUMBER "Enables SSE2 optimizations.")
set_aom_detected_var(HAVE_SSE3 0 NUMBER "Enables SSE3 optimizations.")
set_aom_detected_var(HAVE_SSE4_1 0 NUMBER "Enables SSE 4.1 optimizations.")
set_aom_detected_var(HAVE_SSE4_2 0 NUMBER "Enables SSE 4.2 optimizations.")
set_aom_detected_var(HAVE_SSSE3 0 NUMBER "Enables SSSE3 optimizations.")

# Flags describing the build environment.
set_aom_detected_var(HAVE_FEXCEPT 0 NUMBER
                     "Internal flag, GNU fenv.h present for target.")
set_aom_detected_var(HAVE_PTHREAD_H 0 NUMBER
                     "Internal flag, target pthread support.")
set_aom_detected_var(HAVE_UNISTD_H 0 NUMBER
                     "Internal flag, unistd.h present for target.")
set_aom_detected_var(HAVE_WXWIDGETS 0 NUMBER "WxWidgets present.")
...
set_aom_config_var(CONFIG_GCC 0 NUMBER "Building with GCC (detected).")
