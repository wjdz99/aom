...
#
# The variables in this section of the file are detect at configuration time.
#
...
#
set_aom_option_var(ENABLE_CCACHE "Enable ccache support." 0)
set_aom_option_var(ENABLE_DECODE_PERF_TESTS "Enables decoder performance tests"
                   0)
set_aom_option_var(ENABLE_DISTCC "Enable distcc support." 0)
set_aom_option_var(ENABLE_DOCS
                   "Enable documentation generation (doxygen required)." 1)
set_aom_option_var(ENABLE_ENCODE_PERF_TESTS "Enables encoder performance tests"
                   0)
set_aom_option_var(ENABLE_EXAMPLES "Enables build of example code." 1)
set_aom_option_var(ENABLE_GOMA "Enable goma support." 0)
set_aom_option_var(
  ENABLE_IDE_TEST_HOSTING
  "Enables running tests within IDEs like Visual Studio and Xcode." 0)
set_aom_option_var(ENABLE_NASM "Use nasm instead of yasm for x86 assembly." 0)
set_aom_option_var(ENABLE_TESTDATA "Enables unit test data download targets." 1)
set_aom_option_var(ENABLE_TESTS "Enables unit tests." 1)
set_aom_option_var(ENABLE_TOOLS "Enable applications in tools sub directory." 1)
set_aom_option_var(ENABLE_WERROR "Converts warnings to errors at compile time."
                   0)

# ARM assembly/intrinsics flags.
set_aom_option_var(ENABLE_NEON "Enables NEON optimizations on ARM targets." 1)

# MIPS assembly/intrinsics flags.
set_aom_option_var(ENABLE_DSPR2 "Enables DSPR2 optimizations on MIPS targets."
                   0)
set_aom_option_var(ENABLE_MSA "Enables MSA optimizations on MIPS targets." 0)

# VSX intrinsics flags.
set_aom_option_var(ENABLE_VSX "Enables VSX optimizations on PowerPC targets." 1)

# x86/x86_64 assembly/intrinsics flags.
set_aom_option_var(ENABLE_MMX
                   "Enables MMX optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_SSE
                   "Enables SSE optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_SSE2
                   "Enables SSE2 optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_SSE3
                   "Enables SSE3 optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_SSSE3
                   "Enables SSSE3 optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_SSE4_1
                   "Enables SSE4_1 optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_SSE4_2
                   "Enables SSE4_2 optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_AVX
                   "Enables AVX optimizations on x86/x86_64 targets." 1)
set_aom_option_var(ENABLE_AVX2
                   "Enables AVX2 optimizations on x86/x86_64 targets." 1)
