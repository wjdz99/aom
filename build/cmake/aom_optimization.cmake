...
function(add_asm_library lib_name asm_sources)
  ...
  if(XCODE)
    # CMake's generator does not output a build rule for Nasm files.
    # Moreover, it makes Xcode believe Nasm files are of type
    # "sourcecode" instead of "sourcecode.nasm", which prevents even
    # the default rule from applying. This default rule is broken,
    # though, because it doesn't apply any of the flags specified for ASM_NASM.
    # See https://discourse.cmake.org/t/building-nasm-files-with-xcode/7934
    ...
    foreach(asm_config ${asm_configs})
      ...
      # the LINKER_LANGUAGE property on the library target because
      # Xcode does not obey it.
    ...
    # For non-Xcode generators, CMake does not need extra help. The
    # language support takes care of it.
