...
function(add_asm_library lib_name asm_sources)
  ...
  target_include_directories(${asm_lib_name} PRIVATE
    ${AOM_ROOT}
    ${AOM_CONFIG_DIR}
  )
  target_compile_options(${asm_lib_name} PRIVATE
    ${AOM_AS_FLAGS}
  )
  ...
  # The linker needs no extra help, we're relying on CMake's ASM_NASM language.
...
function(test_nasm)
  execute_process(COMMAND ${CMAKE_ASM_NASM_COMPILER} -hf OUTPUT_VARIABLE nasm_helptext)
