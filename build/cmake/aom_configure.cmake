...
if (CONFIG_DAALA_TX_RECT)
  if (NOT CONFIG_DAALA_DCT4)
    change_config_and_warn(CONFIG_DAALA_DCT4 1 CONFIG_DAALA_DCTx)
  endif()
  if (NOT CONFIG_DAALA_DCT8)
    change_config_and_warn(CONFIG_DAALA_DCT8 1 CONFIG_DAALA_DCTx)
  endif()
  if (NOT CONFIG_DAALA_DCT16)
    change_config_and_warn(CONFIG_DAALA_DCT16 1 CONFIG_DAALA_DCTx)
  endif()
  if (NOT CONFIG_DAALA_DCT32)
    change_config_and_warn(CONFIG_DAALA_DCT32 1 CONFIG_DAALA_DCTx)
  endif()
endif()
  
if (CONFIG_DAALA_DCT4 OR CONFIG_DAALA_DCT8 OR CONFIG_DAALA_DCT16 OR
    CONFIG_DAALA_DCT32 OR CONFIG_DAALA_DCT64)
  if (NOT CONFIG_DAALA_TX_RECT)
    if (CONFIG_LGT)
      change_config_and_warn(CONFIG_LGT 0 CONFIG_DAALA_DCTx)
    endif()
    if (CONFIG_MRC_TX)
      change_config_and_warn(CONFIG_MRC_TX 0 CONFIG_DAALA_DCTx)
    endif()
  endif()
