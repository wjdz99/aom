...
if (NOT AOM_BUILD_CMAKE_AOM_CONFIGURE_CMAKE_)
  ...
  foreach (cache_var ${cmake_cache_vars})
    ...
    if ("${cache_var_helpstring}" STREQUAL "${cmdline_helpstring}")
      set (AOM_CMAKE_CONFIG
           "${AOM_CMAKE_CONFIG} -D${cache_var}=${${cache_var}}")
    endif ()
  endforeach ()
  ...
  if (NOT MSVC)
    ...
    if (CONFIG_PIC)
      ...
      if ("${AOM_TARGET_SYSTEM}" STREQUAL "Linux" AND "${AOM_TARGET_CPU}"
          MATCHES "^armv7")
...
#include <fenv.h>
  ...
  if (CONFIG_SIZE_LIMIT)
    if (NOT DECODE_HEIGHT_LIMIT OR NOT DECODE_WIDTH_LIMIT)
      message (FATAL_ERROR
                 "When setting CONFIG_SIZE_LIMIT, DECODE_HEIGHT_LIMIT "
  ...
  if (MSVC)
    ...
    add_compiler_flag_if_supported ("-Wvla") # TODO(jzern): this could be added
                                             # as a cxx flags for test/*.cc
                                             # only,  avoiding third_party.
