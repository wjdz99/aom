...
set(
  AOM_RTCD_SOURCE_FILE_LIST "${AOM_ROOT}/aom_dsp/aom_dsp_rtcd.c"
  "${AOM_ROOT}/aom_scale/aom_scale_rtcd.c" "${AOM_ROOT}/av1/common/av1_rtcd.c")
...
foreach(NUM RANGE ${AOM_RTCD_CUSTOM_COMMAND_COUNT})
  ...
  execute_process(COMMAND ${PERL_EXECUTABLE} "${AOM_ROOT}/build/make/rtcd.pl"
                          --arch=${AOM_TARGET_CPU} --sym=${AOM_RTCD_SYMBOL}
                          ${AOM_RTCD_FLAGS}
