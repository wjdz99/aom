...
configure_file(
  "${AOM_ROOT}/build/cmake/aom_config.h.cmake"
...
if (GIT_FOUND)
  ...
  EXECUTE_PROCESS(COMMAND ${GIT_EXECUTABLE} rev-parse HEAD OUTPUT_VARIABLE AOM_GIT_HASH)
...
configure_file(
  "${AOM_ROOT}/build/cmake/aom_config.c.cmake"
