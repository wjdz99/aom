...
macro(set_aom_detected_var name value type helpstring)
  unset(list_index)
  list(FIND AOM_DETECTED_VARS ${name} list_index)
  if(${list_index} EQUAL -1)
    list(APPEND AOM_DETECTED_VARS ${name})
  endif()
...
macro(set_aom_option_var name value helpstring)
  unset(list_index)
