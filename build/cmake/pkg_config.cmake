...
set(REQUIRED_ARGS "AOM_ROOT" "AOM_CONFIG_DIR" "CMAKE_INSTALL_PREFIX"
    "INCLUDE_INSTALL_DIR" "LIB_INSTALL_DIR" "CMAKE_PROJECT_NAME"
...
file(APPEND "${pkgconfig_file}" "libdir=${libdir}\n")
file(APPEND "${pkgconfig_file}" "includedir=${includedir}\n\n")
...
if(CONFIG_MULTITHREAD AND HAVE_PTHREAD_H)
  file(APPEND "${pkgconfig_file}"
              "Libs: -L${libdir} -l${pkg_name} -lm -lpthread\n")
  file(APPEND "${pkgconfig_file}" "Libs.private: -lm -lpthread\n")
else()
  file(APPEND "${pkgconfig_file}" "Libs: -L${libdir} -l${pkg_name} -lm\n")
